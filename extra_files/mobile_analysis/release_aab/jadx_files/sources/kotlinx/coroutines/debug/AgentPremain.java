...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m5166constructorimpl = Result.m5166constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m5166constructorimpl = Result.m5166constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m5172isFailureimpl(m5166constructorimpl) ? null : m5166constructorimpl);
