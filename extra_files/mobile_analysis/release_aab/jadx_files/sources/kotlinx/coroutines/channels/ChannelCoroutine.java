...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo6671receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo6671receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo6672tryReceivePtdJZtk() {
        return this._channel.mo6672tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo6667trySendJP2dKIU(E element) {
        return this._channel.mo6667trySendJP2dKIU(element);
    }
