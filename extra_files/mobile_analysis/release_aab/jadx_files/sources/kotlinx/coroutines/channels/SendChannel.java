...
public interface SendChannel<E> {
    ...
    Object mo6667trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo6667trySendJP2dKIU = sendChannel.mo6667trySendJP2dKIU(e);
            if (ChannelResult.m6687isSuccessimpl(mo6667trySendJP2dKIU)) {
                return true;
            }
            Throwable m6681exceptionOrNullimpl = ChannelResult.m6681exceptionOrNullimpl(mo6667trySendJP2dKIU);
