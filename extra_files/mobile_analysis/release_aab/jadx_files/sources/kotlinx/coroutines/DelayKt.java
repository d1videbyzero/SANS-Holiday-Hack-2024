...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo6724scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m6655delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m6656toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m6656toDelayMillisLRDsOJo(long j) {
        if (Duration.m6490compareToLRDsOJo(j, Duration.INSTANCE.m6594getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m6509getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
