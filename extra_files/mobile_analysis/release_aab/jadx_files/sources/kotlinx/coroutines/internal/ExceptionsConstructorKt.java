...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                m5166constructorimpl = Result.m5166constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
        ...
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$safeCtor$1
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    ...
                    m5166constructorimpl = Result.m5166constructorimpl(invoke);
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.INSTANCE;
                    m5166constructorimpl = Result.m5166constructorimpl(ResultKt.createFailure(th2));
                }
                return (Throwable) (Result.m5172isFailureimpl(m5166constructorimpl) ? null : m5166constructorimpl);
            }
        };
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            m5166constructorimpl = Result.m5166constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m5166constructorimpl = Result.m5166constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m5172isFailureimpl(m5166constructorimpl)) {
            m5166constructorimpl = valueOf;
        }
        return ((Number) m5166constructorimpl).intValue();
    }
