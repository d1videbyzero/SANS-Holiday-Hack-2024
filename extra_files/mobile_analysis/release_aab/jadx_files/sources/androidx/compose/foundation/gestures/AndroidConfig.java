...
final class AndroidConfig implements ScrollConfig {
    ...
    public long mo245calculateMouseWheelScroll8xgXZGE(Density calculateMouseWheelScroll, PointerEvent event, long j) {
        Intrinsics.checkNotNullParameter(calculateMouseWheelScroll, "$this$calculateMouseWheelScroll");
        Intrinsics.checkNotNullParameter(event, "event");
        List<PointerInputChange> changes = event.getChanges();
        Offset m2380boximpl = Offset.m2380boximpl(Offset.INSTANCE.m2407getZeroF1C5BW0());
        int size = changes.size();
        for (int i = 0; i < size; i++) {
            m2380boximpl = Offset.m2380boximpl(Offset.m2396plusMKHz9U(m2380boximpl.getPackedValue(), changes.get(i).getScrollDelta()));
        }
        return Offset.m2398timestuRUvjQ(m2380boximpl.getPackedValue(), -calculateMouseWheelScroll.mo327toPx0680j_4(Dp.m4878constructorimpl(64)));
    }
}
