    ...
    private static final class DefaultDebugIndicationInstance implements IndicationInstance {
        ...
        public void drawIndication(ContentDrawScope contentDrawScope) {
            ...
            if (this.isPressed.getValue().booleanValue()) {
                DrawScope.m3169drawRectnJ9OG0$default(contentDrawScope, Color.m2629copywmQWz5c$default(Color.INSTANCE.m2656getBlack0d7_KjU(), 0.3f, 0.0f, 0.0f, 0.0f, 14, null), 0L, contentDrawScope.mo3174getSizeNHjbRc(), 0.0f, null, null, 0, 122, null);
            } else if (this.isHovered.getValue().booleanValue() || this.isFocused.getValue().booleanValue()) {
                DrawScope.m3169drawRectnJ9OG0$default(contentDrawScope, Color.m2629copywmQWz5c$default(Color.INSTANCE.m2656getBlack0d7_KjU(), 0.1f, 0.0f, 0.0f, 0.0f, 14, null), 0L, contentDrawScope.mo3174getSizeNHjbRc(), 0.0f, null, null, 0, 122, null);
            }
        }
    }
