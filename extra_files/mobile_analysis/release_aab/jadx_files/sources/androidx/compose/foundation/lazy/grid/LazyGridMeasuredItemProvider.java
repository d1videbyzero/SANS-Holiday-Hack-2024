...
public abstract class LazyGridMeasuredItemProvider {
    ...
    public static /* synthetic */ LazyGridMeasuredItem m620getAndMeasure3p2s80s$default(LazyGridMeasuredItemProvider lazyGridMeasuredItemProvider, int i, int i2, long j, int i3, Object obj) {
        if (obj != null) {
        ...
        return lazyGridMeasuredItemProvider.m621getAndMeasure3p2s80s(i, i2, j);
    }

    /* renamed from: getAndMeasure-3p2s80s, reason: not valid java name */
    public final LazyGridMeasuredItem m621getAndMeasure3p2s80s(int index, int mainAxisSpacing, long constraints) {
        ...
        List<Placeable> mo640measure0kLqBqw = this.measureScope.mo640measure0kLqBqw(index, constraints);
        if (Constraints.m4832getHasFixedWidthimpl(constraints)) {
            m4835getMinHeightimpl = Constraints.m4836getMinWidthimpl(constraints);
        } else {
            if (!Constraints.m4831getHasFixedHeightimpl(constraints)) {
                throw new IllegalArgumentException("Failed requirement.".toString());
            }
            m4835getMinHeightimpl = Constraints.m4835getMinHeightimpl(constraints);
        }
        return createItem(index, key, contentType, m4835getMinHeightimpl, mainAxisSpacing, mo640measure0kLqBqw);
    }
