    ...
    private static final Function2<LazyLayoutMeasureScope, Constraints, MeasureResult> rememberLazyGridMeasurePolicy(final Function0<? extends LazyGridItemProvider> function0, final LazyGridState lazyGridState, final Function2<? super Density, ? super Constraints, LazyGridSlots> function2, final PaddingValues paddingValues, final boolean z, final boolean z2, Arrangement.Horizontal horizontal, Arrangement.Vertical vertical, Composer composer, int i, int i2) {
        ...
        if (z3 || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = (Function2) new Function2<LazyLayoutMeasureScope, Constraints, LazyGridMeasureResult>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1
                ...
                public final LazyGridMeasureResult m616invoke0kLqBqw(final LazyLayoutMeasureScope lazyLayoutMeasureScope, final long j) {
                    int i4;
                    int i5;
                    int i6;
                    float spacing;
                    ...
                    CheckScrollableContainerConstraintsKt.m189checkScrollableContainerConstraintsK40F9xA(j, z2 ? Orientation.Vertical : Orientation.Horizontal);
                    if (z2) {
                        i4 = lazyLayoutMeasureScope.mo321roundToPx0680j_4(paddingValues.mo433calculateLeftPaddingu2uoSUM(lazyLayoutMeasureScope.getLayoutDirection()));
                    } else {
                        i4 = lazyLayoutMeasureScope.mo321roundToPx0680j_4(PaddingKt.calculateStartPadding(paddingValues, lazyLayoutMeasureScope.getLayoutDirection()));
                    }
                    if (z2) {
                        i5 = lazyLayoutMeasureScope.mo321roundToPx0680j_4(paddingValues.mo434calculateRightPaddingu2uoSUM(lazyLayoutMeasureScope.getLayoutDirection()));
                    } else {
                        i5 = lazyLayoutMeasureScope.mo321roundToPx0680j_4(PaddingKt.calculateEndPadding(paddingValues, lazyLayoutMeasureScope.getLayoutDirection()));
                    }
                    int i8 = lazyLayoutMeasureScope.mo321roundToPx0680j_4(paddingValues.getTop());
                    int i9 = lazyLayoutMeasureScope.mo321roundToPx0680j_4(paddingValues.getBottom());
                    final int i10 = i8 + i9;
                    final int i11 = i4 + i5;
                    boolean z4 = z2;
                    int i12 = z4 ? i10 : i11;
                    ...
                    final LazyGridSlots invoke2 = function2.invoke(lazyLayoutMeasureScope, Constraints.m4822boximpl(j));
                    ...
                    final int i14 = lazyLayoutMeasureScope.mo321roundToPx0680j_4(spacing);
                    ...
                    lazyGridState.setPrefetchInfoRetriever$foundation_release(new Function1<Integer, ArrayList<Pair<? extends Integer, ? extends Constraints>>>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1.1
                        ...
                        public final ArrayList<Pair<Integer, Constraints>> invoke(int i17) {
                            ...
                            for (int i19 = 0; i19 < size; i19++) {
                                int m601getCurrentLineSpanimpl = GridItemSpan.m601getCurrentLineSpanimpl(spans.get(i19).getPackedValue());
                                arrayList.add(TuplesKt.to(Integer.valueOf(firstItemIndex), Constraints.m4822boximpl(lazyGridKt$rememberLazyGridMeasurePolicy$1$1$measuredLineProvider$1.m622childConstraintsJhjzzOo$foundation_release(i18, m601getCurrentLineSpanimpl))));
                                firstItemIndex++;
                                i18 += m601getCurrentLineSpanimpl;
                            }
                            return arrayList;
                        }
                    });
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (updateScrollPositionIfTheFirstItemWasMoved$foundation_release >= itemCount && itemCount > 0) {
                                ...
                                LazyGridMeasureResult m617measureLazyGridZRKPzZ8 = LazyGridMeasureKt.m617measureLazyGridZRKPzZ8(itemCount, (LazyGridMeasuredLineProvider) r2, (LazyGridMeasuredItemProvider) r18, i15, i6, i13, i14, i7, firstVisibleItemScrollOffset, lazyGridState.getScrollToBeConsumed(), m4850offsetNN6EwU, z2, vertical2, horizontal2, z, lazyLayoutMeasureScope2, lazyGridState.getPlacementAnimator(), spanLayoutProvider, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(invoke, lazyGridState.getPinnedItems(), lazyGridState.getBeyondBoundsInfo()), new Function3<Integer, Integer, Function1<? super Placeable.PlacementScope, ? extends Unit>, MeasureResult>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1.3
                                    ...
                                    public final MeasureResult invoke(int i17, int i18, Function1<? super Placeable.PlacementScope, Unit> placement) {
                                        ...
                                        return LazyLayoutMeasureScope.this.layout(ConstraintsKt.m4848constrainWidthK40F9xA(j, i17 + i11), ConstraintsKt.m4847constrainHeightK40F9xA(j, i18 + i10), MapsKt.emptyMap(), placement);
                                    }
                                });
                                lazyGridState.applyMeasureResult$foundation_release(m617measureLazyGridZRKPzZ8);
                                return m617measureLazyGridZRKPzZ8;
                            }
                            ...
                            createNonObservableSnapshot.dispose();
                            LazyGridMeasureResult m617measureLazyGridZRKPzZ82 = LazyGridMeasureKt.m617measureLazyGridZRKPzZ8(itemCount, (LazyGridMeasuredLineProvider) r2, (LazyGridMeasuredItemProvider) r18, i15, i6, i13, i14, i7, firstVisibleItemScrollOffset, lazyGridState.getScrollToBeConsumed(), m4850offsetNN6EwU, z2, vertical2, horizontal2, z, lazyLayoutMeasureScope2, lazyGridState.getPlacementAnimator(), spanLayoutProvider, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(invoke, lazyGridState.getPinnedItems(), lazyGridState.getBeyondBoundsInfo()), new Function3<Integer, Integer, Function1<? super Placeable.PlacementScope, ? extends Unit>, MeasureResult>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1.3
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                {
                                    super(3);
                                }
                            ...
                            lazyGridState.applyMeasureResult$foundation_release(m617measureLazyGridZRKPzZ82);
                            return m617measureLazyGridZRKPzZ82;
                        } finally {
