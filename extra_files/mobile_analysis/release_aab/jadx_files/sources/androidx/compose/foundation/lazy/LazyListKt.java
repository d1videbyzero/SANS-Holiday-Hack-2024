        ...
        if (z3 || rememberedValue == Composer.INSTANCE.getEmpty()) {
            ...
            rememberedValue = (Function2) new Function2<LazyLayoutMeasureScope, Constraints, LazyListMeasureResult>() { // from class: androidx.compose.foundation.lazy.LazyListKt$rememberLazyListMeasurePolicy$1$1
                ...
                public /* bridge */ /* synthetic */ LazyListMeasureResult invoke(LazyLayoutMeasureScope lazyLayoutMeasureScope, Constraints constraints) {
                    return m586invoke0kLqBqw(lazyLayoutMeasureScope, constraints.getValue());
                }

                /* renamed from: invoke-0kLqBqw, reason: not valid java name */
                public final LazyListMeasureResult m586invoke0kLqBqw(final LazyLayoutMeasureScope lazyLayoutMeasureScope, final long j) {
                    int i5;
                    int i6;
                    int i7;
                    float spacing;
                    ...
                    if (z2) {
                        i5 = lazyLayoutMeasureScope.mo321roundToPx0680j_4(paddingValues.mo433calculateLeftPaddingu2uoSUM(lazyLayoutMeasureScope.getLayoutDirection()));
                    } else {
                        i5 = lazyLayoutMeasureScope.mo321roundToPx0680j_4(PaddingKt.calculateStartPadding(paddingValues, lazyLayoutMeasureScope.getLayoutDirection()));
                    }
                    if (z2) {
                        i6 = lazyLayoutMeasureScope.mo321roundToPx0680j_4(paddingValues.mo434calculateRightPaddingu2uoSUM(lazyLayoutMeasureScope.getLayoutDirection()));
                    } else {
                        i6 = lazyLayoutMeasureScope.mo321roundToPx0680j_4(PaddingKt.calculateEndPadding(paddingValues, lazyLayoutMeasureScope.getLayoutDirection()));
                    }
                    ...
                    final long m4850offsetNN6EwU = ConstraintsKt.m4850offsetNN6EwU(j, -i11, -i10);
                    ...
                    invoke.getItemScope().setMaxSize(Constraints.m4834getMaxWidthimpl(m4850offsetNN6EwU), Constraints.m4833getMaxHeightimpl(m4850offsetNN6EwU));
                    if (z2) {
                    ...
                    lazyListState.m595setPremeasureConstraintsBRTryo0$foundation_release(lazyListMeasuredItemProvider.getChildConstraints());
                    ...
                    try {
                        ...
                        try {
                            ...
                            LazyListMeasureResult m589measureLazyListCD5nmq0 = LazyListMeasureKt.m589measureLazyListCD5nmq0(itemCount, lazyListMeasuredItemProvider, i15, i7, i13, i14, updateScrollPositionIfTheFirstItemWasMoved$foundation_release, firstVisibleItemScrollOffset, lazyListState.getScrollToBeConsumed(), m4850offsetNN6EwU, z2, invoke.getHeaderIndexes(), vertical5, horizontal5, z, lazyLayoutMeasureScope2, lazyListState.getPlacementAnimator(), i, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(invoke, lazyListState.getPinnedItems(), lazyListState.getBeyondBoundsInfo()), new Function3<Integer, Integer, Function1<? super Placeable.PlacementScope, ? extends Unit>, MeasureResult>() { // from class: androidx.compose.foundation.lazy.LazyListKt$rememberLazyListMeasurePolicy$1$1.2
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                {
                                    super(3);
                                }
                            ...
                            lazyListState.applyMeasureResult$foundation_release(m589measureLazyListCD5nmq0);
                            return m589measureLazyListCD5nmq0;
                        } finally {
