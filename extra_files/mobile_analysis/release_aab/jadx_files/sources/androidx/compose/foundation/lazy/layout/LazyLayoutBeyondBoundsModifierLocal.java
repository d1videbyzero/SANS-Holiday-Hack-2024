...
public final class LazyLayoutBeyondBoundsModifierLocal implements ModifierLocalProvider<BeyondBoundsLayout>, BeyondBoundsLayout {
    ...
    public <T> T mo636layouto7g1Pn8(final int direction, Function1<? super BeyondBoundsLayout.BeyondBoundsScope, ? extends T> block) {
        ...
        if (m634isForward4vf7U8o(direction)) {
        ...
        T t = null;
        while (t == null && m633hasMoreContentFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element, direction)) {
            T t2 = (T) m632addNextIntervalFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element, direction);
            ...
            t = block.invoke(new BeyondBoundsLayout.BeyondBoundsScope() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutBeyondBoundsModifierLocal$layout$2
                @Override // androidx.compose.ui.layout.BeyondBoundsLayout.BeyondBoundsScope
                public boolean getHasMoreContent() {
                    boolean m633hasMoreContentFR3nfPY;
                    m633hasMoreContentFR3nfPY = LazyLayoutBeyondBoundsModifierLocal.this.m633hasMoreContentFR3nfPY(objectRef.element, direction);
                    return m633hasMoreContentFR3nfPY;
                }
            });
        }
        this.beyondBoundsInfo.removeInterval((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element);
    ...
    private final boolean m634isForward4vf7U8o(int i) {
        if (BeyondBoundsLayout.LayoutDirection.m3848equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3854getBeforehoxUOeE())) {
            return false;
        }
        if (!BeyondBoundsLayout.LayoutDirection.m3848equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3853getAfterhoxUOeE())) {
            if (BeyondBoundsLayout.LayoutDirection.m3848equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3852getAbovehoxUOeE())) {
                return this.reverseLayout;
            }
            if (BeyondBoundsLayout.LayoutDirection.m3848equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3855getBelowhoxUOeE())) {
                if (this.reverseLayout) {
                    return false;
                }
            } else if (BeyondBoundsLayout.LayoutDirection.m3848equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3856getLefthoxUOeE())) {
                ...
                if (!BeyondBoundsLayout.LayoutDirection.m3848equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3857getRighthoxUOeE())) {
    ...
    private final LazyLayoutBeyondBoundsInfo.Interval m632addNextIntervalFR3nfPY(LazyLayoutBeyondBoundsInfo.Interval currentInterval, int direction) {
    ...
    public final boolean m633hasMoreContentFR3nfPY(LazyLayoutBeyondBoundsInfo.Interval interval, int i) {
        if (m635isOppositeToOrientation4vf7U8o(i)) {
            return false;
        }
        if (m634isForward4vf7U8o(i)) {
    ...
    private final boolean m635isOppositeToOrientation4vf7U8o(int i) {
        if (BeyondBoundsLayout.LayoutDirection.m3848equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3852getAbovehoxUOeE()) || BeyondBoundsLayout.LayoutDirection.m3848equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3855getBelowhoxUOeE())) {
            if (this.orientation == Orientation.Horizontal) {
                return true;
            }
        } else if (BeyondBoundsLayout.LayoutDirection.m3848equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3856getLefthoxUOeE()) || BeyondBoundsLayout.LayoutDirection.m3848equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3857getRighthoxUOeE())) {
            if (this.orientation == Orientation.Vertical) {
                return true;
            }
        } else if (!BeyondBoundsLayout.LayoutDirection.m3848equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3854getBeforehoxUOeE()) && !BeyondBoundsLayout.LayoutDirection.m3848equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3853getAfterhoxUOeE())) {
            LazyLayoutBeyondBoundsModifierLocalKt.unsupportedDirection();
            throw new KotlinNothingValueException();
        }
        return false;
