...
public final class PagerLayoutInfoKt {
    ...
    public static final int getMainAxisViewportSize(PagerLayoutInfo pagerLayoutInfo) {
        ...
        return pagerLayoutInfo.getOrientation() == Orientation.Vertical ? IntSize.m5037getHeightimpl(pagerLayoutInfo.mo696getViewportSizeYbymL2g()) : IntSize.m5038getWidthimpl(pagerLayoutInfo.mo696getViewportSizeYbymL2g());
    }
}
