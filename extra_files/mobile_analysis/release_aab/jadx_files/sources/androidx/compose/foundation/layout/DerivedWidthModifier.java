...
final class DerivedWidthModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer {
    ...
    public MeasureResult mo39measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        final Placeable mo3868measureBRTryo0 = measurable.mo3868measureBRTryo0(Constraints.m4825copyZbe2FdA$default(j, intValue, intValue, 0, 0, 12, null));
        return MeasureScope.layout$default(measure, intValue, mo3868measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.DerivedWidthModifier$measure$2
            {
                super(1);
            }
