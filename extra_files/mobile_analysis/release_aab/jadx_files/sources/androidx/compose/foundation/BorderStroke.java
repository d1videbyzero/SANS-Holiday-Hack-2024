...
public final class BorderStroke {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m4883equalsimpl0(this.width, borderStroke.width) && Intrinsics.areEqual(this.brush, borderStroke.brush);
    }

    public int hashCode() {
        return (Dp.m4884hashCodeimpl(this.width) * 31) + this.brush.hashCode();
    }

    public String toString() {
        return "BorderStroke(width=" + ((Object) Dp.m4889toStringimpl(this.width)) + ", brush=" + this.brush + ')';
    }
