                                ...
                                if ((i7 & 11) != 2 || !composer3.getSkipping()) {
                                    ...
                                    if (TouchMode_androidKt.isInTouchMode() && selectionManager2.getHasFocus() && (selection2 = selectionManager2.getSelection()) != null) {
                                        ...
                                        for (int i8 = 0; i8 < size; i8++) {
                                            ...
                                            if (booleanValue) {
                                                m920getEndHandlePosition_m7T9E = selectionManager3.m921getStartHandlePosition_m7T9E();
                                            } else {
                                                m920getEndHandlePosition_m7T9E = selectionManager3.m920getEndHandlePosition_m7T9E();
                                            }
                                            if (booleanValue) {
