...
interface IntrinsicSizeModifier extends LayoutModifier {
    ...
    long mo436calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j);
    ...
    default MeasureResult mo39measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measure, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        long mo436calculateContentConstraintsl58MMJ0 = mo436calculateContentConstraintsl58MMJ0(measure, measurable, j);
        if (getEnforceIncoming()) {
            mo436calculateContentConstraintsl58MMJ0 = ConstraintsKt.m4846constrainN9IONVI(j, mo436calculateContentConstraintsl58MMJ0);
        }
        final Placeable mo3868measureBRTryo0 = measurable.mo3868measureBRTryo0(mo436calculateContentConstraintsl58MMJ0);
        return MeasureScope.layout$default(measure, mo3868measureBRTryo0.getWidth(), mo3868measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.IntrinsicSizeModifier$measure$1
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.m3926placeRelative70tqf50$default(layout, Placeable.this, IntOffset.INSTANCE.m5006getZeronOccac(), 0.0f, 2, null);
            }
        }, 4, null);
    }
