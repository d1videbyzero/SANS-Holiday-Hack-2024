...
final class BackgroundNode extends Modifier.Node implements DrawModifierNode {
    ...
    public final void m163setColor8_81llA(long j) {
        this.color = j;
    }
    ...
    private final void drawRect(ContentDrawScope contentDrawScope) {
        if (!Color.m2631equalsimpl0(this.color, Color.INSTANCE.m2666getUnspecified0d7_KjU())) {
            DrawScope.m3169drawRectnJ9OG0$default(contentDrawScope, this.color, 0L, 0L, 0.0f, null, null, 0, 126, null);
        }
        Brush brush = this.brush;
        if (brush != null) {
            DrawScope.m3168drawRectAsUm42w$default(contentDrawScope, brush, 0L, 0L, this.alpha, null, null, 0, 118, null);
        }
    }

    private final void drawOutline(ContentDrawScope contentDrawScope) {
        Outline mo210createOutlinePq9zytI;
        if (Size.m2455equalsimpl(contentDrawScope.mo3174getSizeNHjbRc(), this.lastSize) && contentDrawScope.getLayoutDirection() == this.lastLayoutDirection && Intrinsics.areEqual(this.lastShape, this.shape)) {
            mo210createOutlinePq9zytI = this.lastOutline;
            Intrinsics.checkNotNull(mo210createOutlinePq9zytI);
        } else {
            mo210createOutlinePq9zytI = this.shape.mo210createOutlinePq9zytI(contentDrawScope.mo3174getSizeNHjbRc(), contentDrawScope.getLayoutDirection(), contentDrawScope);
        }
        if (!Color.m2631equalsimpl0(this.color, Color.INSTANCE.m2666getUnspecified0d7_KjU())) {
            OutlineKt.m2883drawOutlinewDX37Ww(contentDrawScope, mo210createOutlinePq9zytI, this.color, (r17 & 4) != 0 ? 1.0f : 0.0f, (r17 & 8) != 0 ? Fill.INSTANCE : null, (r17 & 16) != 0 ? null : null, (r17 & 32) != 0 ? DrawScope.INSTANCE.m3175getDefaultBlendMode0nO6VwU() : 0);
        }
        Brush brush = this.brush;
        if (brush != null) {
            OutlineKt.m2882drawOutlinehn5TExg$default(contentDrawScope, mo210createOutlinePq9zytI, brush, this.alpha, null, null, 0, 56, null);
        }
        this.lastOutline = mo210createOutlinePq9zytI;
        this.lastSize = Size.m2448boximpl(contentDrawScope.mo3174getSizeNHjbRc());
