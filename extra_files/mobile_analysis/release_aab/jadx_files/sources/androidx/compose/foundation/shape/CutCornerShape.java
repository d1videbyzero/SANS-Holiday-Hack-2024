...
public final class CutCornerShape extends CornerBasedShape {
    ...
    public Outline mo718createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        ...
        Path.lineTo(Size.m2460getWidthimpl(size) - topStart, 0.0f);
        Path.lineTo(Size.m2460getWidthimpl(size), topStart);
        float f2 = layoutDirection == LayoutDirection.Ltr ? bottomEnd : bottomStart;
        Path.lineTo(Size.m2460getWidthimpl(size), Size.m2457getHeightimpl(size) - f2);
        Path.lineTo(Size.m2460getWidthimpl(size) - f2, Size.m2457getHeightimpl(size));
        if (layoutDirection == LayoutDirection.Ltr) {
            bottomEnd = bottomStart;
        }
        Path.lineTo(bottomEnd, Size.m2457getHeightimpl(size));
        Path.lineTo(0.0f, Size.m2457getHeightimpl(size) - bottomEnd);
        Path.close();
