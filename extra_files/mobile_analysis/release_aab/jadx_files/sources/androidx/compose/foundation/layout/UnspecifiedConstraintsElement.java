...
final class UnspecifiedConstraintsElement extends ModifierNodeElement<UnspecifiedConstraintsNode> {
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("minWidth", Dp.m4876boximpl(this.minWidth));
        inspectorInfo.getProperties().set("minHeight", Dp.m4876boximpl(this.minHeight));
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m4883equalsimpl0(this.minWidth, unspecifiedConstraintsElement.minWidth) && Dp.m4883equalsimpl0(this.minHeight, unspecifiedConstraintsElement.minHeight);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (Dp.m4884hashCodeimpl(this.minWidth) * 31) + Dp.m4884hashCodeimpl(this.minHeight);
    }
}
