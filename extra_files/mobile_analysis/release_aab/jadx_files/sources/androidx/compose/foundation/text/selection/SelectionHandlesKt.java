...
public final class SelectionHandlesKt {
    ...
    public static final long m896getAdjustedCoordinatesk4lQ0M(long j) {
        return OffsetKt.Offset(Offset.m2391getXimpl(j), Offset.m2392getYimpl(j) - 1.0f);
    }

    static {
        float f = 25;
        HandleWidth = Dp.m4878constructorimpl(f);
        HandleHeight = Dp.m4878constructorimpl(f);
    }
}
