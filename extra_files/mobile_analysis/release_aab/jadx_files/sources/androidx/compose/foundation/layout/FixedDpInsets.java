...
final class FixedDpInsets implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        ...
        return density.mo321roundToPx0680j_4(this.leftDp);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getTop(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.mo321roundToPx0680j_4(this.topDp);
    }
    ...
    public int getRight(Density density, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        return density.mo321roundToPx0680j_4(this.rightDp);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getBottom(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.mo321roundToPx0680j_4(this.bottomDp);
    }

    public String toString() {
        return "Insets(left=" + ((Object) Dp.m4889toStringimpl(this.leftDp)) + ", top=" + ((Object) Dp.m4889toStringimpl(this.topDp)) + ", right=" + ((Object) Dp.m4889toStringimpl(this.rightDp)) + ", bottom=" + ((Object) Dp.m4889toStringimpl(this.bottomDp)) + ')';
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m4883equalsimpl0(this.leftDp, fixedDpInsets.leftDp) && Dp.m4883equalsimpl0(this.topDp, fixedDpInsets.topDp) && Dp.m4883equalsimpl0(this.rightDp, fixedDpInsets.rightDp) && Dp.m4883equalsimpl0(this.bottomDp, fixedDpInsets.bottomDp);
    }

    public int hashCode() {
        return (((((Dp.m4884hashCodeimpl(this.leftDp) * 31) + Dp.m4884hashCodeimpl(this.topDp)) * 31) + Dp.m4884hashCodeimpl(this.rightDp)) * 31) + Dp.m4884hashCodeimpl(this.bottomDp);
    }
}
