...
public final class KeyboardOptions {
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m4593getNoneIUNYP9k() : i, (i4 & 2) != 0 ? true : z, (i4 & 4) != 0 ? KeyboardType.INSTANCE.m4619getTextPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.INSTANCE.m4566getDefaulteUduSuo() : i3, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return KeyboardCapitalization.m4584equalsimpl0(this.capitalization, keyboardOptions.capitalization) && this.autoCorrect == keyboardOptions.autoCorrect && KeyboardType.m4599equalsimpl0(this.keyboardType, keyboardOptions.keyboardType) && ImeAction.m4554equalsimpl0(this.imeAction, keyboardOptions.imeAction);
    }

    public int hashCode() {
        return (((((KeyboardCapitalization.m4585hashCodeimpl(this.capitalization) * 31) + Boolean.hashCode(this.autoCorrect)) * 31) + KeyboardType.m4600hashCodeimpl(this.keyboardType)) * 31) + ImeAction.m4555hashCodeimpl(this.imeAction);
    }

    public String toString() {
        return "KeyboardOptions(capitalization=" + ((Object) KeyboardCapitalization.m4586toStringimpl(this.capitalization)) + ", autoCorrect=" + this.autoCorrect + ", keyboardType=" + ((Object) KeyboardType.m4601toStringimpl(this.keyboardType)) + ", imeAction=" + ((Object) ImeAction.m4556toStringimpl(this.imeAction)) + ')';
    }
}
