...
final class MarqueeModifierNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, FocusEventModifierNode {
    ...
    private MarqueeModifierNode(int i, int i2, int i3, int i4, final MarqueeSpacing spacing, float f) {
        ...
        this.animationMode = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(MarqueeAnimationMode.m223boximpl(i2), null, 2, null);
    ...
    public final void m240setAnimationMode97h66l8(int i) {
        this.animationMode.setValue(MarqueeAnimationMode.m223boximpl(i));
    }
    ...
    public final void m241updatelWfNwf4(int iterations, int animationMode, int delayMillis, int initialDelayMillis, MarqueeSpacing spacing, float velocity) {
        ...
        if (this.iterations == iterations && this.delayMillis == delayMillis && this.initialDelayMillis == initialDelayMillis && Dp.m4883equalsimpl0(this.velocity, velocity)) {
            return;
        }
    ...
    public MeasureResult mo239measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        final Placeable mo3868measureBRTryo0 = measurable.mo3868measureBRTryo0(Constraints.m4825copyZbe2FdA$default(j, 0, Integer.MAX_VALUE, 0, 0, 13, null));
        setContainerWidth(ConstraintsKt.m4848constrainWidthK40F9xA(j, mo3868measureBRTryo0.getWidth()));
        setContentWidth(mo3868measureBRTryo0.getWidth());
        return MeasureScope.layout$default(measure, getContainerWidth(), mo3868measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.MarqueeModifierNode$measure$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        float m2457getHeightimpl = Size.m2457getHeightimpl(contentDrawScope2.mo3174getSizeNHjbRc());
        ...
        drawContext.getTransform().mo3102clipRectN_I0leg(floatValue, 0.0f, floatValue + getContainerWidth(), m2457getHeightimpl, m2619getIntersectrtfAjoo);
        if (z) {
