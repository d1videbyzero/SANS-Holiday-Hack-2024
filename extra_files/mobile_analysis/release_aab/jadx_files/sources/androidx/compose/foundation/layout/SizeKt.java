...
public final class SizeKt {
    ...
    public static final Modifier m534width3ABfNKs(Modifier width, final float f) {
        ...
        return width.then(new SizeElement(f, 0.0f, f, 0.0f, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$width-3ABfNKs$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.setValue(Dp.m4876boximpl(f));
            }
        } : InspectableValueKt.getNoInspectorInfo(), 10, null));
    }

    /* renamed from: height-3ABfNKs, reason: not valid java name */
    public static final Modifier m515height3ABfNKs(Modifier height, final float f) {
    ...
    public static final Modifier m530size6HolHcs(Modifier size, long j) {
        Intrinsics.checkNotNullParameter(size, "$this$size");
        return m531sizeVpY3zN4(size, DpSize.m4976getWidthD9Ej5fM(j), DpSize.m4974getHeightD9Ej5fM(j));
    }
    ...
    public static /* synthetic */ Modifier m536widthInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m4898getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
            f2 = Dp.INSTANCE.m4898getUnspecifiedD9Ej5fM();
        }
        return m535widthInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: widthIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m535widthInVpY3zN4(Modifier widthIn, final float f, final float f2) {
        ...
        return widthIn.then(new SizeElement(f, 0.0f, f2, 0.0f, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$widthIn-VpY3zN4$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("min", Dp.m4876boximpl(f));
                inspectorInfo.getProperties().set("max", Dp.m4876boximpl(f2));
            }
        } : InspectableValueKt.getNoInspectorInfo(), 10, null));
    }
    ...
    public static final Modifier m516heightInVpY3zN4(Modifier heightIn, final float f, final float f2) {
    ...
    public static /* synthetic */ Modifier m533sizeInqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        ...
        if ((i & 4) != 0) {
            f3 = Dp.INSTANCE.m4898getUnspecifiedD9Ej5fM();
        }
        if ((i & 8) != 0) {
            f4 = Dp.INSTANCE.m4898getUnspecifiedD9Ej5fM();
        }
        return m532sizeInqDBjuR0(modifier, f, f2, f3, f4);
    }

    /* renamed from: sizeIn-qDBjuR0, reason: not valid java name */
    public static final Modifier m532sizeInqDBjuR0(Modifier sizeIn, final float f, final float f2, final float f3, final float f4) {
        ...
        return sizeIn.then(new SizeElement(f, f2, f3, f4, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$sizeIn-qDBjuR0$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("minWidth", Dp.m4876boximpl(f));
                inspectorInfo.getProperties().set("minHeight", Dp.m4876boximpl(f2));
                inspectorInfo.getProperties().set("maxWidth", Dp.m4876boximpl(f3));
                inspectorInfo.getProperties().set("maxHeight", Dp.m4876boximpl(f4));
            }
        } : InspectableValueKt.getNoInspectorInfo(), null));
    }

    /* renamed from: requiredWidth-3ABfNKs, reason: not valid java name */
    public static final Modifier m526requiredWidth3ABfNKs(Modifier requiredWidth, final float f) {
    ...
    public static final Modifier m518requiredHeight3ABfNKs(Modifier requiredHeight, final float f) {
    ...
    public static final Modifier m522requiredSize6HolHcs(Modifier requiredSize, long j) {
        Intrinsics.checkNotNullParameter(requiredSize, "$this$requiredSize");
        return m523requiredSizeVpY3zN4(requiredSize, DpSize.m4976getWidthD9Ej5fM(j), DpSize.m4974getHeightD9Ej5fM(j));
    }
    ...
    public static final Modifier m527requiredWidthInVpY3zN4(Modifier requiredWidthIn, final float f, final float f2) {
    ...
    public static final Modifier m519requiredHeightInVpY3zN4(Modifier requiredHeightIn, final float f, final float f2) {
    ...
    public static final Modifier m524requiredSizeInqDBjuR0(Modifier requiredSizeIn, final float f, final float f2, final float f3, final float f4) {
    ...
    public static final Modifier wrapContentWidth(Modifier modifier, Alignment.Horizontal align, boolean z) {
        ...
        if (Intrinsics.areEqual(align, Alignment.INSTANCE.getCenterHorizontally()) && !z) {
            ...
            width = WrapContentElement.INSTANCE.width(align, z);
        }
    ...
    public static final Modifier wrapContentHeight(Modifier modifier, Alignment.Vertical align, boolean z) {
        ...
        if (Intrinsics.areEqual(align, Alignment.INSTANCE.getCenterVertically()) && !z) {
            ...
            height = WrapContentElement.INSTANCE.height(align, z);
        }
    ...
    public static final Modifier wrapContentSize(Modifier modifier, Alignment align, boolean z) {
        ...
        if (Intrinsics.areEqual(align, Alignment.INSTANCE.getCenter()) && !z) {
            ...
            size = WrapContentElement.INSTANCE.size(align, z);
        }
    ...
    public static final Modifier m513defaultMinSizeVpY3zN4(Modifier defaultMinSize, float f, float f2) {
        Intrinsics.checkNotNullParameter(defaultMinSize, "$this$defaultMinSize");
        return defaultMinSize.then(new UnspecifiedConstraintsElement(f, f2, null));
    }

    /* renamed from: size-3ABfNKs, reason: not valid java name */
    public static final Modifier m529size3ABfNKs(Modifier size, final float f) {
        Intrinsics.checkNotNullParameter(size, "$this$size");
    ...
    public static final Modifier m531sizeVpY3zN4(Modifier size, final float f, final float f2) {
        Intrinsics.checkNotNullParameter(size, "$this$size");
        return size.then(new SizeElement(f, f2, f, f2, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$size-VpY3zN4$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                Intrinsics.checkNotNullParameter(inspectorInfo, "$this$null");
                inspectorInfo.setName("size");
                inspectorInfo.getProperties().set("width", Dp.m4876boximpl(f));
                inspectorInfo.getProperties().set("height", Dp.m4876boximpl(f2));
            }
        } : InspectableValueKt.getNoInspectorInfo(), null));
    }

    /* renamed from: requiredSize-3ABfNKs, reason: not valid java name */
    public static final Modifier m521requiredSize3ABfNKs(Modifier requiredSize, final float f) {
        Intrinsics.checkNotNullParameter(requiredSize, "$this$requiredSize");
    ...
    public static final Modifier m523requiredSizeVpY3zN4(Modifier requiredSize, final float f, final float f2) {
        Intrinsics.checkNotNullParameter(requiredSize, "$this$requiredSize");
