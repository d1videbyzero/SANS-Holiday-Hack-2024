...
public final class BorderModifierNode extends DelegatingNode {
    ...
    private BorderModifierNode(float f, Brush brushParameter, Shape shapeParameter) {
        ...
        this.drawWithCacheModifierNode = (CacheDrawModifierNode) delegate(DrawModifierKt.CacheDrawModifierNode(new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.BorderModifierNode$drawWithCacheModifierNode$1
            ...
            public final DrawResult invoke(CacheDrawScope CacheDrawModifierNode) {
                ...
                if (CacheDrawModifierNode.mo327toPx0680j_4(BorderModifierNode.this.getWidth()) < 0.0f || Size.m2459getMinDimensionimpl(CacheDrawModifierNode.m2297getSizeNHjbRc()) <= 0.0f) {
                    drawContentWithoutBorder = BorderKt.drawContentWithoutBorder(CacheDrawModifierNode);
                    return drawContentWithoutBorder;
                }
                float f2 = 2;
                float min = Math.min(Dp.m4883equalsimpl0(BorderModifierNode.this.getWidth(), Dp.INSTANCE.m4896getHairlineD9Ej5fM()) ? 1.0f : (float) Math.ceil(CacheDrawModifierNode.mo327toPx0680j_4(BorderModifierNode.this.getWidth())), (float) Math.ceil(Size.m2459getMinDimensionimpl(CacheDrawModifierNode.m2297getSizeNHjbRc()) / f2));
                float f3 = min / f2;
                long Offset = OffsetKt.Offset(f3, f3);
                long Size = SizeKt.Size(Size.m2460getWidthimpl(CacheDrawModifierNode.m2297getSizeNHjbRc()) - min, Size.m2457getHeightimpl(CacheDrawModifierNode.m2297getSizeNHjbRc()) - min);
                boolean z = f2 * min > Size.m2459getMinDimensionimpl(CacheDrawModifierNode.m2297getSizeNHjbRc());
                Outline mo210createOutlinePq9zytI = BorderModifierNode.this.getShape().mo210createOutlinePq9zytI(CacheDrawModifierNode.m2297getSizeNHjbRc(), CacheDrawModifierNode.getLayoutDirection(), CacheDrawModifierNode);
                if (mo210createOutlinePq9zytI instanceof Outline.Generic) {
                    BorderModifierNode borderModifierNode = BorderModifierNode.this;
                    drawGenericBorder = borderModifierNode.drawGenericBorder(CacheDrawModifierNode, borderModifierNode.getBrush(), (Outline.Generic) mo210createOutlinePq9zytI, z, min);
                    return drawGenericBorder;
                }
                if (mo210createOutlinePq9zytI instanceof Outline.Rounded) {
                    BorderModifierNode borderModifierNode2 = BorderModifierNode.this;
                    m178drawRoundRectBorderJqoCqck = borderModifierNode2.m178drawRoundRectBorderJqoCqck(CacheDrawModifierNode, borderModifierNode2.getBrush(), (Outline.Rounded) mo210createOutlinePq9zytI, Offset, Size, z, min);
                    return m178drawRoundRectBorderJqoCqck;
                }
                if (!(mo210createOutlinePq9zytI instanceof Outline.Rectangle)) {
                    throw new NoWhenBranchMatchedException();
                }
                m175drawRectBorderNsqcLGU = BorderKt.m175drawRectBorderNsqcLGU(CacheDrawModifierNode, BorderModifierNode.this.getBrush(), Offset, Size, z, min);
    ...
    public final void m180setWidth0680j_4(float f) {
        if (Dp.m4883equalsimpl0(this.width, f)) {
            return;
        }
        this.width = f;
    ...
    */
    ...
    public final DrawResult m178drawRoundRectBorderJqoCqck(CacheDrawScope cacheDrawScope, final Brush brush, Outline.Rounded rounded, final long j, final long j2, final boolean z, final float f) {
        final Path createRoundRectPath;
        if (RoundRectKt.isSimple(rounded.getRoundRect())) {
            final long m2441getTopLeftCornerRadiuskKHJgLs = rounded.getRoundRect().m2441getTopLeftCornerRadiuskKHJgLs();
            final float f2 = f / 2;
            ...
            return cacheDrawScope.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.BorderModifierNode$drawRoundRectBorder$1
                ...
                public final void invoke2(ContentDrawScope onDrawWithContent) {
                    long m176shrinkKibmq7A;
                    Intrinsics.checkNotNullParameter(onDrawWithContent, "$this$onDrawWithContent");
                    onDrawWithContent.drawContent();
                    if (z) {
                        DrawScope.m3170drawRoundRectZuiqVtQ$default(onDrawWithContent, brush, 0L, 0L, m2441getTopLeftCornerRadiuskKHJgLs, 0.0f, null, null, 0, 246, null);
                        return;
                    }
                    float m2366getXimpl = CornerRadius.m2366getXimpl(m2441getTopLeftCornerRadiuskKHJgLs);
                    float f3 = f2;
                    if (m2366getXimpl < f3) {
                        ContentDrawScope contentDrawScope = onDrawWithContent;
                        float f4 = f;
                        float m2460getWidthimpl = Size.m2460getWidthimpl(onDrawWithContent.mo3174getSizeNHjbRc()) - f;
                        float m2457getHeightimpl = Size.m2457getHeightimpl(onDrawWithContent.mo3174getSizeNHjbRc()) - f;
                        int m2618getDifferencertfAjoo = ClipOp.INSTANCE.m2618getDifferencertfAjoo();
                        Brush brush2 = brush;
                        long j3 = m2441getTopLeftCornerRadiuskKHJgLs;
                        DrawContext drawContext = contentDrawScope.getDrawContext();
                        long mo3099getSizeNHjbRc = drawContext.mo3099getSizeNHjbRc();
                        drawContext.getCanvas().save();
                        drawContext.getTransform().mo3102clipRectN_I0leg(f4, f4, m2460getWidthimpl, m2457getHeightimpl, m2618getDifferencertfAjoo);
                        DrawScope.m3170drawRoundRectZuiqVtQ$default(contentDrawScope, brush2, 0L, 0L, j3, 0.0f, null, null, 0, 246, null);
                    ...
                    long j4 = j;
                    long j5 = j2;
                    m176shrinkKibmq7A = BorderKt.m176shrinkKibmq7A(m2441getTopLeftCornerRadiuskKHJgLs, f3);
                    DrawScope.m3170drawRoundRectZuiqVtQ$default(onDrawWithContent, brush3, j4, j5, m176shrinkKibmq7A, 0.0f, stroke, null, 0, 208, null);
                }
            });
        }
        ...
        return cacheDrawScope.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.BorderModifierNode$drawRoundRectBorder$2
            ...
            public final void invoke2(ContentDrawScope onDrawWithContent) {
                Intrinsics.checkNotNullParameter(onDrawWithContent, "$this$onDrawWithContent");
                onDrawWithContent.drawContent();
                DrawScope.m3164drawPathGBMwjPU$default(onDrawWithContent, Path.this, brush, 0.0f, null, null, 0, 60, null);
            }
        });
    }
}
