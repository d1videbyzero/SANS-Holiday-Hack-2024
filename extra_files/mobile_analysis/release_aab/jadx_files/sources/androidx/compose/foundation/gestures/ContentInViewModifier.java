...
public final class ContentInViewModifier implements BringIntoViewResponder, OnRemeasuredModifier, OnPlacedModifier {
    ...
    public ContentInViewModifier(CoroutineScope scope, Orientation orientation, ScrollableState scrollState, boolean z) {
        ...
        this.viewportSize = IntSize.INSTANCE.m5043getZeroYbymL2g();
    ...
    public Rect calculateRectForParent(Rect localRect) {
        ...
        if (!(!IntSize.m5036equalsimpl0(this.viewportSize, IntSize.INSTANCE.m5043getZeroYbymL2g()))) {
    ...
    public void mo252onRemeasuredozmzZPI(long size) {
        ...
        if (m246compareToTemP2vQ(size, j) < 0 && (focusedChildBounds = getFocusedChildBounds()) != null) {
            Rect rect = this.focusedChildBoundsFromPreviousRemeasure;
            if (rect == null) {
                rect = focusedChildBounds;
            }
            if (!this.isAnimationRunning && !this.trackingFocusedChild && m249isMaxVisibleO0kMr_c(rect, j) && !m249isMaxVisibleO0kMr_c(focusedChildBounds, size)) {
    ...
    public final float calculateScrollDelta() {
        ...
        long m5048toSizeozmzZPI = IntSizeKt.m5048toSizeozmzZPI(this.viewportSize);
        int i = WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()];
        if (i == 1) {
            return relocationDistance(findBringIntoViewRequest.getTop(), findBringIntoViewRequest.getBottom(), Size.m2457getHeightimpl(m5048toSizeozmzZPI));
        }
        if (i == 2) {
            return relocationDistance(findBringIntoViewRequest.getLeft(), findBringIntoViewRequest.getRight(), Size.m2460getWidthimpl(m5048toSizeozmzZPI));
        }
    ...
    private final Rect findBringIntoViewRequest() {
        ...
        if (size > 0) {
            ...
            do {
                ...
                if (invoke != null) {
                    if (m247compareToiLBOSCw(invoke.m2424getSizeNHjbRc(), IntSizeKt.m5048toSizeozmzZPI(this.viewportSize)) > 0) {
                        return rect;
                    }
                    rect = invoke;
                }
    ...
    private final Rect m248computeDestinationO0kMr_c(Rect childBounds, long containerSize) {
        return childBounds.m2428translatek4lQ0M(Offset.m2400unaryMinusF1C5BW0(m251relocationOffsetBMxPBkI(childBounds, containerSize)));
    }
    ...
    private final boolean m249isMaxVisibleO0kMr_c(Rect rect, long j) {
        return Offset.m2388equalsimpl0(m251relocationOffsetBMxPBkI(rect, j), Offset.INSTANCE.m2407getZeroF1C5BW0());
    }

    /* renamed from: relocationOffset-BMxPBkI, reason: not valid java name */
    private final long m251relocationOffsetBMxPBkI(Rect childBounds, long containerSize) {
        long m5048toSizeozmzZPI = IntSizeKt.m5048toSizeozmzZPI(containerSize);
        int i = WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()];
        if (i == 1) {
            return OffsetKt.Offset(0.0f, relocationDistance(childBounds.getTop(), childBounds.getBottom(), Size.m2457getHeightimpl(m5048toSizeozmzZPI)));
        }
        if (i == 2) {
            return OffsetKt.Offset(relocationDistance(childBounds.getLeft(), childBounds.getRight(), Size.m2460getWidthimpl(m5048toSizeozmzZPI)), 0.0f);
        }
        throw new NoWhenBranchMatchedException();
    }
    ...
    private final int m246compareToTemP2vQ(long j, long j2) {
        int i = WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()];
        if (i == 1) {
            return Intrinsics.compare(IntSize.m5037getHeightimpl(j), IntSize.m5037getHeightimpl(j2));
        }
        if (i == 2) {
            return Intrinsics.compare(IntSize.m5038getWidthimpl(j), IntSize.m5038getWidthimpl(j2));
        }
        throw new NoWhenBranchMatchedException();
    }

    /* renamed from: compareTo-iLBOSCw, reason: not valid java name */
    private final int m247compareToiLBOSCw(long j, long j2) {
        int i = WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()];
        if (i == 1) {
            return Float.compare(Size.m2457getHeightimpl(j), Size.m2457getHeightimpl(j2));
        }
        if (i == 2) {
            return Float.compare(Size.m2460getWidthimpl(j), Size.m2460getWidthimpl(j2));
        }
        throw new NoWhenBranchMatchedException();
    }
