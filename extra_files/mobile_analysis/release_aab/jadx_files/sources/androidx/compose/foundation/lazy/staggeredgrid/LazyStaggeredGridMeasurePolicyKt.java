...
public final class LazyStaggeredGridMeasurePolicyKt {
    ...
    public static final Function2<LazyLayoutMeasureScope, Constraints, LazyStaggeredGridMeasureResult> m667rememberStaggeredGridMeasurePolicynbWgWpA(final LazyStaggeredGridState state, final Function0<? extends LazyStaggeredGridItemProvider> itemProviderLambda, final PaddingValues contentPadding, final boolean z, final Orientation orientation, final float f, float f2, final Function2<? super Density, ? super Constraints, LazyStaggeredGridSlots> slots, Composer composer, int i) {
        ...
        Object[] objArr = {state, itemProviderLambda, contentPadding, Boolean.valueOf(z), orientation, Dp.m4876boximpl(f), Dp.m4876boximpl(f2), slots};
        ...
        if (z2 || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = (Function2) new Function2<LazyLayoutMeasureScope, Constraints, LazyStaggeredGridMeasureResult>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasurePolicyKt$rememberStaggeredGridMeasurePolicy$1$1
                ...
                public /* bridge */ /* synthetic */ LazyStaggeredGridMeasureResult invoke(LazyLayoutMeasureScope lazyLayoutMeasureScope, Constraints constraints) {
                    return m668invoke0kLqBqw(lazyLayoutMeasureScope, constraints.getValue());
                }

                /* renamed from: invoke-0kLqBqw, reason: not valid java name */
                public final LazyStaggeredGridMeasureResult m668invoke0kLqBqw(LazyLayoutMeasureScope lazyLayoutMeasureScope, long j) {
                    float beforePadding;
                    float afterPadding;
                    float startPadding;
                    long IntOffset;
                    Intrinsics.checkNotNullParameter(lazyLayoutMeasureScope, "$this$null");
                    CheckScrollableContainerConstraintsKt.m189checkScrollableContainerConstraintsK40F9xA(j, Orientation.this);
                    LazyStaggeredGridSlots invoke = slots.invoke(lazyLayoutMeasureScope, Constraints.m4822boximpl(j));
                    ...
                    int i3 = lazyLayoutMeasureScope.mo321roundToPx0680j_4(beforePadding);
                    ...
                    int i4 = lazyLayoutMeasureScope.mo321roundToPx0680j_4(afterPadding);
                    ...
                    int i5 = lazyLayoutMeasureScope.mo321roundToPx0680j_4(startPadding);
                    int m4833getMaxHeightimpl = ((z3 ? Constraints.m4833getMaxHeightimpl(j) : Constraints.m4834getMaxWidthimpl(j)) - i3) - i4;
                    if (z3) {
                    ...
                    int i6 = lazyLayoutMeasureScope.mo321roundToPx0680j_4(Dp.m4878constructorimpl(PaddingKt.calculateStartPadding(paddingValues, lazyLayoutMeasureScope.getLayoutDirection()) + PaddingKt.calculateEndPadding(paddingValues, lazyLayoutMeasureScope.getLayoutDirection())));
                    PaddingValues paddingValues2 = contentPadding;
                    LazyStaggeredGridMeasureResult m666measureStaggeredGriddSVRQoE = LazyStaggeredGridMeasureKt.m666measureStaggeredGriddSVRQoE(lazyLayoutMeasureScope, state, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(invoke2, state.getPinnedItems(), state.getBeyondBoundsInfo()), invoke2, invoke, Constraints.m4825copyZbe2FdA$default(j, ConstraintsKt.m4848constrainWidthK40F9xA(j, i6), 0, ConstraintsKt.m4847constrainHeightK40F9xA(j, lazyLayoutMeasureScope.mo321roundToPx0680j_4(Dp.m4878constructorimpl(paddingValues2.getTop() + paddingValues2.getBottom()))), 0, 10, null), z3, z, j2, m4833getMaxHeightimpl, lazyLayoutMeasureScope.mo321roundToPx0680j_4(f), i3, i4);
                    state.applyMeasureResult$foundation_release(m666measureStaggeredGriddSVRQoE);
                    return m666measureStaggeredGriddSVRQoE;
                }
            };
