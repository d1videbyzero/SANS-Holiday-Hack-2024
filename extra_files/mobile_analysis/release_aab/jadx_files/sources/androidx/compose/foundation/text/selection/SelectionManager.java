...
public final class SelectionManager {
    ...
    public SelectionManager(SelectionRegistrarImpl selectionRegistrar) {
        ...
        this.dragBeginPosition = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m2380boximpl(Offset.INSTANCE.m2407getZeroF1C5BW0()), null, 2, null);
        this.dragTotalDistance = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m2380boximpl(Offset.INSTANCE.m2407getZeroF1C5BW0()), null, 2, null);
        ...
        selectionRegistrar.setOnSelectionUpdateStartCallback$foundation_release(new Function3<LayoutCoordinates, Offset, SelectionAdjustment, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.2
            ...
            public /* bridge */ /* synthetic */ Unit invoke(LayoutCoordinates layoutCoordinates, Offset offset, SelectionAdjustment selectionAdjustment) {
                m924invoked4ec7I(layoutCoordinates, offset.getPackedValue(), selectionAdjustment);
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-d-4ec7I, reason: not valid java name */
            public final void m924invoked4ec7I(LayoutCoordinates layoutCoordinates, long j, SelectionAdjustment selectionMode) {
                Intrinsics.checkNotNullParameter(layoutCoordinates, "layoutCoordinates");
                Intrinsics.checkNotNullParameter(selectionMode, "selectionMode");
                Offset m909convertToContainerCoordinatesQ7Q5hAU = SelectionManager.this.m909convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, j);
                if (m909convertToContainerCoordinatesQ7Q5hAU != null) {
                    SelectionManager.this.m915startSelection9KIMszo(m909convertToContainerCoordinatesQ7Q5hAU.getPackedValue(), false, selectionMode);
        ...
        selectionRegistrar.setOnSelectionUpdateCallback$foundation_release(new Function5<LayoutCoordinates, Offset, Offset, Boolean, SelectionAdjustment, Boolean>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.4
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(LayoutCoordinates layoutCoordinates, Offset offset, Offset offset2, Boolean bool, SelectionAdjustment selectionAdjustment) {
                return m925invoke5iVPX68(layoutCoordinates, offset.getPackedValue(), offset2.getPackedValue(), bool.booleanValue(), selectionAdjustment);
            }

            /* renamed from: invoke-5iVPX68, reason: not valid java name */
            public final Boolean m925invoke5iVPX68(LayoutCoordinates layoutCoordinates, long j, long j2, boolean z, SelectionAdjustment selectionMode) {
                Intrinsics.checkNotNullParameter(layoutCoordinates, "layoutCoordinates");
                Intrinsics.checkNotNullParameter(selectionMode, "selectionMode");
                return Boolean.valueOf(SelectionManager.this.m923updateSelectionRHHTvR4$foundation_release(SelectionManager.this.m909convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, j), SelectionManager.this.m909convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, j2), z, selectionMode));
            }
        });
        selectionRegistrar.setOnSelectionUpdateEndCallback$foundation_release(new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.5
            ...
            public final void invoke2() {
                ...
                SelectionManager.this.m910setCurrentDragPosition_kEHs6E(null);
            }
        });
        ...
        selectionRegistrar.setAfterSelectableUnsubscribe$foundation_release(new Function1<Long, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.7
            ...
            public final void invoke(long j) {
                ...
                SelectionManager.this.m914setStartHandlePosition_kEHs6E(null);
                SelectionManager.this.m913setEndHandlePosition_kEHs6E(null);
            }
        });
    }
    ...
    public final Modifier getModifier() {
        return KeyInputModifierKt.onKeyEvent(FocusableKt.focusable$default(FocusChangedModifierKt.onFocusChanged(FocusRequesterModifierKt.focusRequester(OnGloballyPositionedModifierKt.onGloballyPositioned(onClearSelectionRequested(Modifier.INSTANCE, new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager$modifier$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m926invokeZmokQxo(keyEvent.m3606unboximpl());
            }

            /* renamed from: invoke-ZmokQxo, reason: not valid java name */
            public final Boolean m926invokeZmokQxo(android.view.KeyEvent it) {
                boolean z;
                Intrinsics.checkNotNullParameter(it, "it");
                if (SelectionManager_androidKt.m930isCopyKeyEventZmokQxo(it)) {
    ...
    public final void setContainerLayoutCoordinates(LayoutCoordinates layoutCoordinates) {
        ...
        Offset m2380boximpl = layoutCoordinates != null ? Offset.m2380boximpl(LayoutCoordinatesKt.positionInWindow(layoutCoordinates)) : null;
        if (Intrinsics.areEqual(this.previousPosition, m2380boximpl)) {
            return;
        }
        this.previousPosition = m2380boximpl;
        updateHandleOffsets();
    ...
    public final void m911setDragBeginPositionk4lQ0M(long j) {
        this.dragBeginPosition.setValue(Offset.m2380boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getDragBeginPosition-F1C5BW0$foundation_release, reason: not valid java name */
    public final long m918getDragBeginPositionF1C5BW0$foundation_release() {
    ...
    public final void m912setDragTotalDistancek4lQ0M(long j) {
        this.dragTotalDistance.setValue(Offset.m2380boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getDragTotalDistance-F1C5BW0$foundation_release, reason: not valid java name */
    public final long m919getDragTotalDistanceF1C5BW0$foundation_release() {
        return ((Offset) this.dragTotalDistance.getValue()).getPackedValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: setStartHandlePosition-_kEHs6E, reason: not valid java name */
    public final void m914setStartHandlePosition_kEHs6E(Offset offset) {
        this.startHandlePosition.setValue(offset);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getStartHandlePosition-_m7T9-E, reason: not valid java name */
    public final Offset m921getStartHandlePosition_m7T9E() {
        return (Offset) this.startHandlePosition.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: setEndHandlePosition-_kEHs6E, reason: not valid java name */
    public final void m913setEndHandlePosition_kEHs6E(Offset offset) {
        this.endHandlePosition.setValue(offset);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getEndHandlePosition-_m7T9-E, reason: not valid java name */
    public final Offset m920getEndHandlePosition_m7T9E() {
    ...
    public final void m910setCurrentDragPosition_kEHs6E(Offset offset) {
        this.currentDragPosition.setValue(offset);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getCurrentDragPosition-_m7T9-E, reason: not valid java name */
    public final Offset m917getCurrentDragPosition_m7T9E() {
    ...
    public final void updateHandleOffsets() {
        ...
        if (selection == null || layoutCoordinates == null || !layoutCoordinates.isAttached() || layoutCoordinates2 == null || layoutCoordinates3 == null) {
            m914setStartHandlePosition_kEHs6E(null);
            m913setEndHandlePosition_kEHs6E(null);
            return;
        }
        long mo3876localPositionOfR5De75A = layoutCoordinates.mo3876localPositionOfR5De75A(layoutCoordinates2, anchorSelectable$foundation_release.mo877getHandlePositiondBAh8RU(selection, true));
        long mo3876localPositionOfR5De75A2 = layoutCoordinates.mo3876localPositionOfR5De75A(layoutCoordinates3, anchorSelectable$foundation_release2.mo877getHandlePositiondBAh8RU(selection, false));
        Rect visibleBounds = SelectionManagerKt.visibleBounds(layoutCoordinates);
        Offset m2380boximpl = Offset.m2380boximpl(mo3876localPositionOfR5De75A);
        m2380boximpl.getPackedValue();
        if (!SelectionManagerKt.m929containsInclusiveUv8p0NA(visibleBounds, mo3876localPositionOfR5De75A) && getDraggingHandle() != Handle.SelectionStart) {
            m2380boximpl = null;
        }
        m914setStartHandlePosition_kEHs6E(m2380boximpl);
        Offset m2380boximpl2 = Offset.m2380boximpl(mo3876localPositionOfR5De75A2);
        m2380boximpl2.getPackedValue();
        m913setEndHandlePosition_kEHs6E((SelectionManagerKt.m929containsInclusiveUv8p0NA(visibleBounds, mo3876localPositionOfR5De75A2) || getDraggingHandle() == Handle.SelectionEnd) ? m2380boximpl2 : null);
    }
    ...
    private final Rect getContentRect() {
        ...
        if (layoutCoordinates3 != null && layoutCoordinates3.isAttached()) {
            long mo3876localPositionOfR5De75A = layoutCoordinates3.mo3876localPositionOfR5De75A(layoutCoordinates, anchorSelectable$foundation_release.mo877getHandlePositiondBAh8RU(selection, true));
            long mo3876localPositionOfR5De75A2 = layoutCoordinates3.mo3876localPositionOfR5De75A(layoutCoordinates2, anchorSelectable$foundation_release2.mo877getHandlePositiondBAh8RU(selection, false));
            long mo3877localToRootMKHz9U = layoutCoordinates3.mo3877localToRootMKHz9U(mo3876localPositionOfR5De75A);
            long mo3877localToRootMKHz9U2 = layoutCoordinates3.mo3877localToRootMKHz9U(mo3876localPositionOfR5De75A2);
            return new Rect(Math.min(Offset.m2391getXimpl(mo3877localToRootMKHz9U), Offset.m2391getXimpl(mo3877localToRootMKHz9U2)), Math.min(Offset.m2392getYimpl(layoutCoordinates3.mo3877localToRootMKHz9U(layoutCoordinates3.mo3876localPositionOfR5De75A(layoutCoordinates, OffsetKt.Offset(0.0f, anchorSelectable$foundation_release.getBoundingBox(selection.getStart().getOffset()).getTop())))), Offset.m2392getYimpl(layoutCoordinates3.mo3877localToRootMKHz9U(layoutCoordinates3.mo3876localPositionOfR5De75A(layoutCoordinates2, OffsetKt.Offset(0.0f, anchorSelectable$foundation_release2.getBoundingBox(selection.getEnd().getOffset()).getTop()))))), Math.max(Offset.m2391getXimpl(mo3877localToRootMKHz9U), Offset.m2391getXimpl(mo3877localToRootMKHz9U2)), Math.max(Offset.m2392getYimpl(mo3877localToRootMKHz9U), Offset.m2392getYimpl(mo3877localToRootMKHz9U2)) + ((float) (SelectionHandlesKt.getHandleHeight() * 4.0d)));
        }
        return Rect.INSTANCE.getZero();
    }
    ...
    public final TextDragObserver handleDragObserver(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.SelectionManager$handleDragObserver$1
            ...
            public void mo803onDownk4lQ0M(long point) {
                ...
                long m896getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m896getAdjustedCoordinatesk4lQ0M(anchorSelectable$foundation_release.mo877getHandlePositiondBAh8RU(selection, isStartHandle));
                SelectionManager selectionManager = SelectionManager.this;
                selectionManager.m910setCurrentDragPosition_kEHs6E(Offset.m2380boximpl(selectionManager.requireContainerCoordinates$foundation_release().mo3876localPositionOfR5De75A(layoutCoordinates, m896getAdjustedCoordinatesk4lQ0M)));
            ...
            public void mo805onStartk4lQ0M(long startPoint) {
                LayoutCoordinates layoutCoordinates;
                long mo877getHandlePositiondBAh8RU;
                SelectionManager.this.hideSelectionToolbar$foundation_release();
                Selection selection = SelectionManager.this.getSelection();
                ...
                if (isStartHandle) {
                    ...
                    mo877getHandlePositiondBAh8RU = selectable.mo877getHandlePositiondBAh8RU(selection, true);
                } else {
                    Intrinsics.checkNotNull(selectable2);
                    mo877getHandlePositiondBAh8RU = selectable2.mo877getHandlePositiondBAh8RU(selection, false);
                }
                long m896getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m896getAdjustedCoordinatesk4lQ0M(mo877getHandlePositiondBAh8RU);
                SelectionManager selectionManager = SelectionManager.this;
                selectionManager.m911setDragBeginPositionk4lQ0M(selectionManager.requireContainerCoordinates$foundation_release().mo3876localPositionOfR5De75A(layoutCoordinates, m896getAdjustedCoordinatesk4lQ0M));
                SelectionManager.this.m912setDragTotalDistancek4lQ0M(Offset.INSTANCE.m2407getZeroF1C5BW0());
            }
            ...
            public void mo804onDragk4lQ0M(long delta) {
                SelectionManager selectionManager = SelectionManager.this;
                selectionManager.m912setDragTotalDistancek4lQ0M(Offset.m2396plusMKHz9U(selectionManager.m919getDragTotalDistanceF1C5BW0$foundation_release(), delta));
                long m2396plusMKHz9U = Offset.m2396plusMKHz9U(SelectionManager.this.m918getDragBeginPositionF1C5BW0$foundation_release(), SelectionManager.this.m919getDragTotalDistanceF1C5BW0$foundation_release());
                if (SelectionManager.this.m923updateSelectionRHHTvR4$foundation_release(Offset.m2380boximpl(m2396plusMKHz9U), Offset.m2380boximpl(SelectionManager.this.m918getDragBeginPositionF1C5BW0$foundation_release()), isStartHandle, SelectionAdjustment.INSTANCE.getCharacterWithWordAccelerate())) {
                    SelectionManager.this.m911setDragBeginPositionk4lQ0M(m2396plusMKHz9U);
                    SelectionManager.this.m912setDragTotalDistancek4lQ0M(Offset.INSTANCE.m2407getZeroF1C5BW0());
                }
            }
    ...
    public final Offset m909convertToContainerCoordinatesQ7Q5hAU(LayoutCoordinates layoutCoordinates, long offset) {
        LayoutCoordinates layoutCoordinates2 = this.containerLayoutCoordinates;
        if (layoutCoordinates2 == null || !layoutCoordinates2.isAttached()) {
            return null;
        }
        return Offset.m2380boximpl(requireContainerCoordinates$foundation_release().mo3876localPositionOfR5De75A(layoutCoordinates, offset));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: startSelection-9KIMszo, reason: not valid java name */
    public final void m915startSelection9KIMszo(long position, boolean isStartHandle, SelectionAdjustment adjustment) {
        m922updateSelection3R_tFg$foundation_release(position, position, null, isStartHandle, adjustment);
    }

    /* renamed from: updateSelection-RHHTvR4$foundation_release, reason: not valid java name */
    public final boolean m923updateSelectionRHHTvR4$foundation_release(Offset newPosition, Offset previousPosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        Selection selection;
        long selectableId;
        Offset m909convertToContainerCoordinatesQ7Q5hAU;
        ...
        if (selectable == null) {
            m909convertToContainerCoordinatesQ7Q5hAU = null;
        } else {
            LayoutCoordinates layoutCoordinates = selectable.getLayoutCoordinates();
            Intrinsics.checkNotNull(layoutCoordinates);
            m909convertToContainerCoordinatesQ7Q5hAU = m909convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, SelectionHandlesKt.m896getAdjustedCoordinatesk4lQ0M(selectable.mo877getHandlePositiondBAh8RU(selection, !isStartHandle)));
        }
        if (m909convertToContainerCoordinatesQ7Q5hAU == null) {
            return false;
        }
        long packedValue = m909convertToContainerCoordinatesQ7Q5hAU.getPackedValue();
        long packedValue2 = isStartHandle ? newPosition.getPackedValue() : packedValue;
        if (!isStartHandle) {
            packedValue = newPosition.getPackedValue();
        }
        return m922updateSelection3R_tFg$foundation_release(packedValue2, packedValue, previousPosition, isStartHandle, adjustment);
    }

    /* renamed from: updateSelection-3R_-tFg$foundation_release, reason: not valid java name */
    public final boolean m922updateSelection3R_tFg$foundation_release(long startHandlePosition, long endHandlePosition, Offset previousHandlePosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        Intrinsics.checkNotNullParameter(adjustment, "adjustment");
        setDraggingHandle(isStartHandle ? Handle.SelectionStart : Handle.SelectionEnd);
        m910setCurrentDragPosition_kEHs6E(isStartHandle ? Offset.m2380boximpl(startHandlePosition) : Offset.m2380boximpl(endHandlePosition));
        LinkedHashMap linkedHashMap = new LinkedHashMap();
        List<Selectable> sort = this.selectionRegistrar.sort(requireContainerCoordinates$foundation_release());
        int size = sort.size();
        Selection selection = null;
    ...
    public final void m916contextMenuOpenAdjustmentk4lQ0M(long position) {
        Selection selection = getSelection();
        if (selection == null || TextRange.m4402getCollapsedimpl(selection.m886toTextRanged9O1mEE())) {
            m915startSelection9KIMszo(position, true, SelectionAdjustment.INSTANCE.getWord());
        }
    }
}
