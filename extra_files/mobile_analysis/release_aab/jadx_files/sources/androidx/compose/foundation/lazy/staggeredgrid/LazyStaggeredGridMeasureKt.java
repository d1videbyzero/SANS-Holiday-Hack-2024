...
public final class LazyStaggeredGridMeasureKt {
        ...
        try {
            ...
            try {
                ...
                if (updateScrollPositionIfTheFirstItemWasMoved$foundation_release.length == lazyStaggeredGridMeasureContext.getLaneCount()) {
                    ...
                    int i6 = 0;
                    while (i6 < laneCount) {
                        if (i6 >= updateScrollPositionIfTheFirstItemWasMoved$foundation_release.length || (m665maxInRangejy6DScQ = updateScrollPositionIfTheFirstItemWasMoved$foundation_release[i6]) == -1) {
                            m665maxInRangejy6DScQ = i6 == 0 ? 0 : m665maxInRangejy6DScQ(iArr, SpanRange.m675constructorimpl(0, i6)) + 1;
                        }
                        iArr[i6] = m665maxInRangejy6DScQ;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:108:0x06b4, code lost:
        ...
        r25 = r3;
        r3 = r11;
        r10 = r14.m662getSpanRangelOCCd4c(r38.getItemProvider(), r1, r5);
        r2 = r38.getLaneInfo();
        r15 = r6;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:111:0x06e4, code lost:
        ...
        r2.setLane(r1, r6);
        r2 = r38.getMeasuredItemProvider().m670getAndMeasurejy6DScQ(r1, r10);
        r6 = m665maxInRangejy6DScQ(r12, r10);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:317:0x032e, code lost:
        ...
        r39 = r10;
        r24 = r11;
        r10 = r0.m662getSpanRangelOCCd4c(r38.getItemProvider(), r7, r5);
        r5 = r38.getLaneInfo();
        r26 = r15;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:320:0x035d, code lost:
        ...
        r5.setLane(r7, r15);
        r5 = r38.getMeasuredItemProvider().m670getAndMeasurejy6DScQ(r7, r10);
        r10 = m665maxInRangejy6DScQ(r4, r10);
     */
    ...
    */
    ...
    private static final List<LazyStaggeredGridMeasuredItem> calculateExtraItems(LazyStaggeredGridMeasureContext lazyStaggeredGridMeasureContext, Function1<? super LazyStaggeredGridMeasuredItem, Unit> function1, Function1<? super Integer, Boolean> function12) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (function12.invoke(Integer.valueOf(intValue)).booleanValue()) {
                long m662getSpanRangelOCCd4c = lazyStaggeredGridMeasureContext.m662getSpanRangelOCCd4c(lazyStaggeredGridMeasureContext.getItemProvider(), intValue, 0);
                if (arrayList == null) {
                    arrayList = new ArrayList();
                }
                LazyStaggeredGridMeasuredItem m670getAndMeasurejy6DScQ = lazyStaggeredGridMeasureContext.getMeasuredItemProvider().m670getAndMeasurejy6DScQ(intValue, m662getSpanRangelOCCd4c);
                function1.invoke(m670getAndMeasurejy6DScQ);
                arrayList.add(m670getAndMeasurejy6DScQ);
            }
        }
    ...
    private static final void m664forEachnIS5qE8(long j, Function1<? super Integer, Unit> function1) {
    ...
    private static final int m665maxInRangejy6DScQ(int[] iArr, long j) {
        int i = (int) (j & 4294967295L);
