...
public final class RowColumnMeasurementHelper {
    ...
    public final RowColumnMeasureHelperResult m509measureWithoutPlacing_EkL_Y(MeasureScope measureScope, long constraints, int startIndex, int endIndex) {
        ...
        long m451constructorimpl = OrientationIndependentConstraints.m451constructorimpl(constraints, this.orientation);
        int i11 = measureScope.mo321roundToPx0680j_4(this.arrangementSpacing);
        ...
        while (true) {
            ...
            if (weight > f) {
                ...
                int m4834getMaxWidthimpl = Constraints.m4834getMaxWidthimpl(m451constructorimpl);
                Placeable placeable = this.placeables[i14];
                if (placeable == null) {
                    i7 = m4834getMaxWidthimpl;
                    i8 = i16;
                    i9 = i14;
                    i10 = i13;
                    placeable = measurable.mo3868measureBRTryo0(OrientationIndependentConstraints.m464toBoxConstraintsOenEA2s(OrientationIndependentConstraints.m453copyyUG9Ft0$default(m451constructorimpl, 0, m4834getMaxWidthimpl == Integer.MAX_VALUE ? Integer.MAX_VALUE : m4834getMaxWidthimpl - i18, 0, 0, 8, null), this.orientation));
                } else {
                    i7 = m4834getMaxWidthimpl;
                    i8 = i16;
                    i9 = i14;
        ...
        if (i17 == 0) {
            ...
            if (f2 > 0.0f && Constraints.m4834getMaxWidthimpl(m451constructorimpl) != Integer.MAX_VALUE) {
                m4836getMinWidthimpl = Constraints.m4834getMaxWidthimpl(m451constructorimpl);
            } else {
                m4836getMinWidthimpl = Constraints.m4836getMinWidthimpl(m451constructorimpl);
            }
            int i23 = i11 * (i17 - 1);
            int i24 = (m4836getMinWidthimpl - i18) - i23;
            ...
            while (i27 < endIndex) {
                if (this.placeables[i27] == null) {
                    ...
                    Placeable mo3868measureBRTryo0 = measurable2.mo3868measureBRTryo0(OrientationIndependentConstraints.m464toBoxConstraintsOenEA2s(OrientationIndependentConstraints.m449constructorimpl(i3, max3, i21, Constraints.m4833getMaxHeightimpl(m451constructorimpl)), this.orientation));
                    i28 += mainAxisSize(mo3868measureBRTryo0);
                    i2 = Math.max(i2, crossAxisSize(mo3868measureBRTryo0));
                    int i30 = (i19 != 0 || RowColumnImplKt.isRelative(rowColumnParentData2)) ? 1 : i21;
                    this.placeables[i27] = mo3868measureBRTryo0;
                    i26 = i4;
                    i19 = i30;
                }
                i27++;
            ...
            coerceAtMost = RangesKt.coerceAtMost(i28 + i23, Constraints.m4834getMaxWidthimpl(m451constructorimpl) - i18);
        }
        if (i19 != 0) {
            int i31 = i21;
            int i32 = i31;
        ...
        int max4 = Math.max(i18 + coerceAtMost, Constraints.m4836getMinWidthimpl(m451constructorimpl));
        if (Constraints.m4833getMaxHeightimpl(m451constructorimpl) == Integer.MAX_VALUE || this.crossAxisSize != SizeMode.Expand) {
            max = Math.max(i2, Math.max(Constraints.m4835getMinHeightimpl(m451constructorimpl), i5 + i6));
        } else {
            max = Constraints.m4833getMaxHeightimpl(m451constructorimpl);
        }
