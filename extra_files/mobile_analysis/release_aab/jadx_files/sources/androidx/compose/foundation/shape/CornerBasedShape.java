...
public abstract class CornerBasedShape implements Shape {
    ...
    public final Outline mo210createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        ...
        float mo726toPxTmRCtEA = this.topStart.mo726toPxTmRCtEA(size, density);
        float mo726toPxTmRCtEA2 = this.topEnd.mo726toPxTmRCtEA(size, density);
        float mo726toPxTmRCtEA3 = this.bottomEnd.mo726toPxTmRCtEA(size, density);
        float mo726toPxTmRCtEA4 = this.bottomStart.mo726toPxTmRCtEA(size, density);
        float m2459getMinDimensionimpl = Size.m2459getMinDimensionimpl(size);
        float f = mo726toPxTmRCtEA + mo726toPxTmRCtEA4;
        if (f > m2459getMinDimensionimpl) {
            float f2 = m2459getMinDimensionimpl / f;
            mo726toPxTmRCtEA *= f2;
            mo726toPxTmRCtEA4 *= f2;
        }
        float f3 = mo726toPxTmRCtEA4;
        float f4 = mo726toPxTmRCtEA2 + mo726toPxTmRCtEA3;
        if (f4 > m2459getMinDimensionimpl) {
            float f5 = m2459getMinDimensionimpl / f4;
            mo726toPxTmRCtEA2 *= f5;
            mo726toPxTmRCtEA3 *= f5;
        }
        if (mo726toPxTmRCtEA < 0.0f || mo726toPxTmRCtEA2 < 0.0f || mo726toPxTmRCtEA3 < 0.0f || f3 < 0.0f) {
            throw new IllegalArgumentException(("Corner size in Px can't be negative(topStart = " + mo726toPxTmRCtEA + ", topEnd = " + mo726toPxTmRCtEA2 + ", bottomEnd = " + mo726toPxTmRCtEA3 + ", bottomStart = " + f3 + ")!").toString());
        }
        return mo718createOutlineLjSzlW0(size, mo726toPxTmRCtEA, mo726toPxTmRCtEA2, mo726toPxTmRCtEA3, f3, layoutDirection);
    }
