...
public abstract class PagerState implements ScrollableState {
    ...
    public PagerState(int i, float f) {
        ...
        double d = f;
        if (-0.5d <= d && d <= 0.5d) {
            this.upDownDifference = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m2380boximpl(Offset.INSTANCE.m2407getZeroF1C5BW0()), null, 2, null);
    ...
    public final long m703getUpDownDifferenceF1C5BW0$foundation_release() {
    ...
    public final void m705setUpDownDifferencek4lQ0M$foundation_release(long j) {
        this.upDownDifference.setValue(Offset.m2380boximpl(j));
    }
    ...
    public final float getPositionThresholdFraction() {
        return Math.min(this.density.mo327toPx0680j_4(PagerStateKt.getDefaultPositionThreshold()), getPageSize$foundation_release() / 2.0f) / getPageSize$foundation_release();
    }
    ...
    public final void m704setPremeasureConstraintsBRTryo0$foundation_release(long j) {
    ...
    private final void notifyPrefetch(float delta) {
        ...
        if (this.prefetchingEnabled) {
            ...
            if (!layoutInfo$foundation_release.getVisiblePagesInfo().isEmpty()) {
                ...
                this.currentPrefetchHandle = this.prefetchState.m641schedulePrefetch0kLqBqw(index, this.premeasureConstraints);
            }
        }
    }
