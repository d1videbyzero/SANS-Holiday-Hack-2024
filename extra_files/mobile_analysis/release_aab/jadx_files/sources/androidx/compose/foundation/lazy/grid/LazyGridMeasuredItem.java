...
public final class LazyGridMeasuredItem implements LazyGridItemInfo {
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        for (int i = 0; i < placeablesCount; i++) {
            ...
            if (lazyLayoutAnimateItemModifierNode != null) {
                ...
                if ((m619getMainAxisgyyYBs(offset) <= mainAxisSize && m619getMainAxisgyyYBs(IntOffset) <= mainAxisSize) || (m619getMainAxisgyyYBs(offset) >= i2 && m619getMainAxisgyyYBs(IntOffset) >= i2)) {
                    lazyLayoutAnimateItemModifierNode.cancelAnimation();
                }
                offset = IntOffset;
            }
            if (this.reverseLayout) {
                int m4996getXimpl = this.isVertical ? IntOffset.m4996getXimpl(offset) : (this.mainAxisLayoutSize - IntOffset.m4996getXimpl(offset)) - getMainAxisSize(placeable);
                if (this.isVertical) {
                    m4997getYimpl = (this.mainAxisLayoutSize - IntOffset.m4997getYimpl(offset)) - getMainAxisSize(placeable);
                } else {
            ...
            long IntOffset2 = IntOffsetKt.IntOffset(IntOffset.m4996getXimpl(offset) + IntOffset.m4996getXimpl(j), IntOffset.m4997getYimpl(offset) + IntOffset.m4997getYimpl(j));
            if (this.isVertical) {
    ...
    private final int m619getMainAxisgyyYBs(long j) {
    ...
    private final long m618copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
