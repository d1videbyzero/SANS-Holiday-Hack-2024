...
final /* data */ class VerticalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo39measure3p2s80s(final MeasureScope measure, Measurable measurable, long j) {
        ...
        final Placeable mo3868measureBRTryo0 = measurable.mo3868measureBRTryo0(Constraints.m4825copyZbe2FdA$default(j, 0, 0, 0, Integer.MAX_VALUE, 7, null));
        final int min = Math.min(mo3868measureBRTryo0.getHeight(), Constraints.m4833getMaxHeightimpl(j));
        return MeasureScope.layout$default(measure, mo3868measureBRTryo0.getWidth(), min, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.VerticalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                cursorRectInScroller = TextFieldScrollKt.getCursorRectInScroller(measureScope, cursorOffset, transformedText, invoke != null ? invoke.getValue() : null, false, mo3868measureBRTryo0.getWidth());
                this.getScrollerPosition().update(Orientation.Vertical, cursorRectInScroller, min, mo3868measureBRTryo0.getHeight());
                Placeable.PlacementScope.placeRelative$default(layout, mo3868measureBRTryo0, 0, MathKt.roundToInt(-this.getScrollerPosition().getOffset()), 0.0f, 4, null);
            }
        }, 4, null);
    }
}
