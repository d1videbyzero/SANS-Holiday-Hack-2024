...
public final class MeasuredPage implements PageInfo {
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            long m689getOffsetBjo55l4 = m689getOffsetBjo55l4(i);
            if (this.reverseLayout) {
                int m4996getXimpl = this.isVertical ? IntOffset.m4996getXimpl(m689getOffsetBjo55l4) : (this.mainAxisLayoutSize - IntOffset.m4996getXimpl(m689getOffsetBjo55l4)) - getMainAxisSize(placeable);
                if (this.isVertical) {
                    m4997getYimpl = (this.mainAxisLayoutSize - IntOffset.m4997getYimpl(m689getOffsetBjo55l4)) - getMainAxisSize(placeable);
                } else {
                    m4997getYimpl = IntOffset.m4997getYimpl(m689getOffsetBjo55l4);
                }
                m689getOffsetBjo55l4 = IntOffsetKt.IntOffset(m4996getXimpl, m4997getYimpl);
            }
            long j = this.visualOffset;
            long IntOffset = IntOffsetKt.IntOffset(IntOffset.m4996getXimpl(m689getOffsetBjo55l4) + IntOffset.m4996getXimpl(j), IntOffset.m4997getYimpl(m689getOffsetBjo55l4) + IntOffset.m4997getYimpl(j));
            if (this.isVertical) {
                Placeable.PlacementScope.m3928placeWithLayeraW9wM$default(scope, placeable, IntOffset, 0.0f, null, 6, null);
            } else {
                Placeable.PlacementScope.m3927placeRelativeWithLayeraW9wM$default(scope, placeable, IntOffset, 0.0f, null, 6, null);
            }
        }
    }
    ...
    private final long m688copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
