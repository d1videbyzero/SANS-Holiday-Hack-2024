...
public final class TextFieldSelectionManager {
    ...
    public TextFieldSelectionManager(UndoManager undoManager) {
        ...
        this.dragBeginPosition = Offset.INSTANCE.m2407getZeroF1C5BW0();
        this.dragTotalDistance = Offset.INSTANCE.m2407getZeroF1C5BW0();
        ...
        this.touchSelectionObserver = new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$touchSelectionObserver$1
            ...
            public void mo803onDownk4lQ0M(long point) {
            }
            ...
            public void mo805onStartk4lQ0M(long startPoint) {
                TextFieldState state;
                TextLayoutResultProxy layoutResult;
                TextFieldValue m941createTextFieldValueFDrldGo;
                long j;
                ...
                if ((state2 == null || (layoutResult3 = state2.getLayoutResult()) == null || !layoutResult3.m838isPositionOnTextk4lQ0M(startPoint)) && (state = TextFieldSelectionManager.this.getState()) != null && (layoutResult = state.getLayoutResult()) != null) {
                    TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                    int transformedToOriginal = textFieldSelectionManager.getOffsetMapping().transformedToOriginal(TextLayoutResultProxy.getLineEnd$default(layoutResult, layoutResult.getLineForVerticalPosition(Offset.m2392getYimpl(startPoint)), false, 2, null));
                    HapticFeedback hapticFeedBack = textFieldSelectionManager.getHapticFeedBack();
                    if (hapticFeedBack != null) {
                        hapticFeedBack.mo3280performHapticFeedbackCdsT49E(HapticFeedbackType.INSTANCE.m3289getTextHandleMove5zf0vsI());
                    }
                    m941createTextFieldValueFDrldGo = textFieldSelectionManager.m941createTextFieldValueFDrldGo(textFieldSelectionManager.getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(transformedToOriginal, transformedToOriginal));
                    textFieldSelectionManager.enterSelectionMode$foundation_release();
                    textFieldSelectionManager.getOnValueChange$foundation_release().invoke(m941createTextFieldValueFDrldGo);
                    return;
                }
                ...
                if (state3 != null && (layoutResult2 = state3.getLayoutResult()) != null) {
                    ...
                    int m835getOffsetForPosition3MmeM6k$default = TextLayoutResultProxy.m835getOffsetForPosition3MmeM6k$default(layoutResult2, startPoint, false, 2, null);
                    textFieldSelectionManager2.updateSelection(textFieldSelectionManager2.getValue$foundation_release(), m835getOffsetForPosition3MmeM6k$default, m835getOffsetForPosition3MmeM6k$default, false, SelectionAdjustment.INSTANCE.getWord());
                    textFieldSelectionManager2.dragBeginOffsetInText = Integer.valueOf(m835getOffsetForPosition3MmeM6k$default);
                }
                ...
                textFieldSelectionManager3.m943setCurrentDragPosition_kEHs6E(Offset.m2380boximpl(j));
                TextFieldSelectionManager.this.dragTotalDistance = Offset.INSTANCE.m2407getZeroF1C5BW0();
            }

            @Override // androidx.compose.foundation.text.TextDragObserver
            /* renamed from: onDrag-k-4lQ0M */
            public void mo804onDragk4lQ0M(long delta) {
                long j;
                TextLayoutResultProxy layoutResult;
                long j2;
                long j3;
                Integer num;
                long j4;
                int m837getOffsetForPosition3MmeM6k;
                if (TextFieldSelectionManager.this.getValue$foundation_release().getText().length() == 0) {
                    return;
                }
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                j = textFieldSelectionManager.dragTotalDistance;
                textFieldSelectionManager.dragTotalDistance = Offset.m2396plusMKHz9U(j, delta);
                ...
                if (state != null && (layoutResult = state.getLayoutResult()) != null) {
                    ...
                    textFieldSelectionManager2.m943setCurrentDragPosition_kEHs6E(Offset.m2380boximpl(Offset.m2396plusMKHz9U(j2, j3)));
                    num = textFieldSelectionManager2.dragBeginOffsetInText;
                    if (num != null) {
                        m837getOffsetForPosition3MmeM6k = num.intValue();
                    } else {
                        j4 = textFieldSelectionManager2.dragBeginPosition;
                        m837getOffsetForPosition3MmeM6k = layoutResult.m837getOffsetForPosition3MmeM6k(j4, false);
                    }
                    int i = m837getOffsetForPosition3MmeM6k;
                    Offset m946getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m946getCurrentDragPosition_m7T9E();
                    Intrinsics.checkNotNull(m946getCurrentDragPosition_m7T9E);
                    textFieldSelectionManager2.updateSelection(textFieldSelectionManager2.getValue$foundation_release(), i, layoutResult.m837getOffsetForPosition3MmeM6k(m946getCurrentDragPosition_m7T9E.getPackedValue(), false), false, SelectionAdjustment.INSTANCE.getWord());
                }
                TextFieldState state2 = TextFieldSelectionManager.this.getState();
                if (state2 == null) {
                    return;
            ...
            public void onStop() {
                ...
                TextFieldSelectionManager.this.m943setCurrentDragPosition_kEHs6E(null);
                TextFieldState state = TextFieldSelectionManager.this.getState();
                if (state != null) {
        ...
        this.mouseSelectionObserver = new MouseSelectionObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$mouseSelectionObserver$1
            ...
            public boolean mo865onExtendk4lQ0M(long downPosition) {
                TextLayoutResultProxy layoutResult;
                TextFieldState state = TextFieldSelectionManager.this.getState();
                if (state == null || (layoutResult = state.getLayoutResult()) == null) {
                    return false;
                ...
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                textFieldSelectionManager.updateSelection(textFieldSelectionManager.getValue$foundation_release(), textFieldSelectionManager.getOffsetMapping().originalToTransformed(TextRange.m4408getStartimpl(textFieldSelectionManager.getValue$foundation_release().getSelection())), TextLayoutResultProxy.m835getOffsetForPosition3MmeM6k$default(layoutResult, downPosition, false, 2, null), false, SelectionAdjustment.INSTANCE.getNone());
                return true;
            }

            @Override // androidx.compose.foundation.text.selection.MouseSelectionObserver
            /* renamed from: onExtendDrag-k-4lQ0M */
            public boolean mo866onExtendDragk4lQ0M(long dragPosition) {
                TextFieldState state;
                TextLayoutResultProxy layoutResult;
                ...
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                textFieldSelectionManager.updateSelection(textFieldSelectionManager.getValue$foundation_release(), textFieldSelectionManager.getOffsetMapping().originalToTransformed(TextRange.m4408getStartimpl(textFieldSelectionManager.getValue$foundation_release().getSelection())), layoutResult.m837getOffsetForPosition3MmeM6k(dragPosition, false), false, SelectionAdjustment.INSTANCE.getNone());
                return true;
            }

            @Override // androidx.compose.foundation.text.selection.MouseSelectionObserver
            /* renamed from: onStart-3MmeM6k */
            public boolean mo867onStart3MmeM6k(long downPosition, SelectionAdjustment adjustment) {
                TextLayoutResultProxy layoutResult;
                long j;
                ...
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                textFieldSelectionManager.dragBeginOffsetInText = Integer.valueOf(TextLayoutResultProxy.m835getOffsetForPosition3MmeM6k$default(layoutResult, downPosition, false, 2, null));
                j = textFieldSelectionManager.dragBeginPosition;
                int m835getOffsetForPosition3MmeM6k$default = TextLayoutResultProxy.m835getOffsetForPosition3MmeM6k$default(layoutResult, j, false, 2, null);
                textFieldSelectionManager.updateSelection(textFieldSelectionManager.getValue$foundation_release(), m835getOffsetForPosition3MmeM6k$default, m835getOffsetForPosition3MmeM6k$default, false, adjustment);
                return true;
            }

            @Override // androidx.compose.foundation.text.selection.MouseSelectionObserver
            /* renamed from: onDrag-3MmeM6k */
            public boolean mo864onDrag3MmeM6k(long dragPosition, SelectionAdjustment adjustment) {
                TextFieldState state;
                TextLayoutResultProxy layoutResult;
                Integer num;
                Intrinsics.checkNotNullParameter(adjustment, "adjustment");
                ...
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                int m837getOffsetForPosition3MmeM6k = layoutResult.m837getOffsetForPosition3MmeM6k(dragPosition, false);
                ...
                textFieldSelectionManager.updateSelection(value$foundation_release, num.intValue(), m837getOffsetForPosition3MmeM6k, false, adjustment);
                return true;
            }
        };
    }
    ...
    public final TextDragObserver handleDragObserver$foundation_release(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$handleDragObserver$1
            ...
            public void mo803onDownk4lQ0M(long point) {
                ...
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                textFieldSelectionManager.m943setCurrentDragPosition_kEHs6E(Offset.m2380boximpl(SelectionHandlesKt.m896getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m948getHandlePositiontuRUvjQ$foundation_release(isStartHandle))));
            }
            ...
            public void mo805onStartk4lQ0M(long startPoint) {
                long j;
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                textFieldSelectionManager.dragBeginPosition = SelectionHandlesKt.m896getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m948getHandlePositiontuRUvjQ$foundation_release(isStartHandle));
                TextFieldSelectionManager textFieldSelectionManager2 = TextFieldSelectionManager.this;
                j = textFieldSelectionManager2.dragBeginPosition;
                textFieldSelectionManager2.m943setCurrentDragPosition_kEHs6E(Offset.m2380boximpl(j));
                TextFieldSelectionManager.this.dragTotalDistance = Offset.INSTANCE.m2407getZeroF1C5BW0();
                TextFieldSelectionManager.this.setDraggingHandle(isStartHandle ? Handle.SelectionStart : Handle.SelectionEnd);
                TextFieldState state = TextFieldSelectionManager.this.getState();
                if (state == null) {
            ...
            public void mo804onDragk4lQ0M(long delta) {
                ...
                int m4380getOffsetForPositionk4lQ0M;
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                j = textFieldSelectionManager.dragTotalDistance;
                textFieldSelectionManager.dragTotalDistance = Offset.m2396plusMKHz9U(j, delta);
                TextFieldState state = TextFieldSelectionManager.this.getState();
                if (state != null && (layoutResult = state.getLayoutResult()) != null && (value = layoutResult.getValue()) != null) {
                    ...
                    if (z) {
                        Offset m946getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m946getCurrentDragPosition_m7T9E();
                        Intrinsics.checkNotNull(m946getCurrentDragPosition_m7T9E);
                        originalToTransformed = value.m4380getOffsetForPositionk4lQ0M(m946getCurrentDragPosition_m7T9E.getPackedValue());
                    } else {
                        originalToTransformed = textFieldSelectionManager2.getOffsetMapping().originalToTransformed(TextRange.m4408getStartimpl(textFieldSelectionManager2.getValue$foundation_release().getSelection()));
                    }
                    int i = originalToTransformed;
                    if (z) {
                        m4380getOffsetForPositionk4lQ0M = textFieldSelectionManager2.getOffsetMapping().originalToTransformed(TextRange.m4403getEndimpl(textFieldSelectionManager2.getValue$foundation_release().getSelection()));
                    } else {
                        Offset m946getCurrentDragPosition_m7T9E2 = textFieldSelectionManager2.m946getCurrentDragPosition_m7T9E();
                        Intrinsics.checkNotNull(m946getCurrentDragPosition_m7T9E2);
                        m4380getOffsetForPositionk4lQ0M = value.m4380getOffsetForPositionk4lQ0M(m946getCurrentDragPosition_m7T9E2.getPackedValue());
                    }
                    textFieldSelectionManager2.updateSelection(textFieldSelectionManager2.getValue$foundation_release(), i, m4380getOffsetForPositionk4lQ0M, z, SelectionAdjustment.INSTANCE.getCharacter());
                }
                TextFieldState state2 = TextFieldSelectionManager.this.getState();
                if (state2 == null) {
                    return;
    ...
    public final TextDragObserver cursorDragObserver$foundation_release() {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$cursorDragObserver$1
            ...
            public void mo803onDownk4lQ0M(long point) {
                ...
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                textFieldSelectionManager.m943setCurrentDragPosition_kEHs6E(Offset.m2380boximpl(SelectionHandlesKt.m896getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m948getHandlePositiontuRUvjQ$foundation_release(true))));
            }
            ...
            public void mo805onStartk4lQ0M(long startPoint) {
                long j;
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                textFieldSelectionManager.dragBeginPosition = SelectionHandlesKt.m896getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m948getHandlePositiontuRUvjQ$foundation_release(true));
                TextFieldSelectionManager textFieldSelectionManager2 = TextFieldSelectionManager.this;
                j = textFieldSelectionManager2.dragBeginPosition;
                textFieldSelectionManager2.m943setCurrentDragPosition_kEHs6E(Offset.m2380boximpl(j));
                TextFieldSelectionManager.this.dragTotalDistance = Offset.INSTANCE.m2407getZeroF1C5BW0();
            ...
            public void mo804onDragk4lQ0M(long delta) {
                ...
                Offset m946getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m946getCurrentDragPosition_m7T9E();
                Intrinsics.checkNotNull(m946getCurrentDragPosition_m7T9E);
                int transformedToOriginal = offsetMapping.transformedToOriginal(value.m4380getOffsetForPositionk4lQ0M(m946getCurrentDragPosition_m7T9E.getPackedValue()));
                long TextRange = TextRangeKt.TextRange(transformedToOriginal, transformedToOriginal);
                if (TextRange.m4401equalsimpl0(TextRange, textFieldSelectionManager2.getValue$foundation_release().getSelection())) {
                    return;
                }
                ...
                m941createTextFieldValueFDrldGo = textFieldSelectionManager2.m941createTextFieldValueFDrldGo(textFieldSelectionManager2.getValue$foundation_release().getAnnotatedString(), TextRange);
                onValueChange$foundation_release.invoke(m941createTextFieldValueFDrldGo);
            }
    ...
    public final void m945deselect_kEHs6E$foundation_release(Offset position) {
        HandleState handleState;
        int m4405getMaximpl;
        if (!TextRange.m4402getCollapsedimpl(getValue$foundation_release().getSelection())) {
            TextFieldState textFieldState = this.state;
            ...
            if (position != null && layoutResult != null) {
                m4405getMaximpl = this.offsetMapping.transformedToOriginal(TextLayoutResultProxy.m835getOffsetForPosition3MmeM6k$default(layoutResult, position.getPackedValue(), false, 2, null));
            } else {
                m4405getMaximpl = TextRange.m4405getMaximpl(getValue$foundation_release().getSelection());
            }
            this.onValueChange.invoke(TextFieldValue.m4621copy3r_uNRQ$default(getValue$foundation_release(), (AnnotatedString) null, TextRangeKt.TextRange(m4405getMaximpl), (TextRange) null, 5, (Object) null));
        }
    ...
    public final void copy$foundation_release(boolean cancelSelection) {
        ...
        if (cancelSelection) {
            int m4405getMaximpl = TextRange.m4405getMaximpl(getValue$foundation_release().getSelection());
            this.onValueChange.invoke(m941createTextFieldValueFDrldGo(getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(m4405getMaximpl, m4405getMaximpl)));
            setHandleState(HandleState.None);
        }
    }
    ...
    public final void paste$foundation_release() {
        ...
        int m4406getMinimpl = TextRange.m4406getMinimpl(getValue$foundation_release().getSelection()) + text.length();
        this.onValueChange.invoke(m941createTextFieldValueFDrldGo(plus, TextRangeKt.TextRange(m4406getMinimpl, m4406getMinimpl)));
        setHandleState(HandleState.None);
    ...
    public final void cut$foundation_release() {
        ...
        int m4406getMinimpl = TextRange.m4406getMinimpl(getValue$foundation_release().getSelection());
        this.onValueChange.invoke(m941createTextFieldValueFDrldGo(plus, TextRangeKt.TextRange(m4406getMinimpl, m4406getMinimpl)));
        setHandleState(HandleState.None);
        UndoManager undoManager = this.undoManager;
        if (undoManager != null) {
    ...
    public final void selectAll$foundation_release() {
        TextFieldValue m941createTextFieldValueFDrldGo = m941createTextFieldValueFDrldGo(getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(0, getValue$foundation_release().getText().length()));
        this.onValueChange.invoke(m941createTextFieldValueFDrldGo);
        this.oldValue = TextFieldValue.m4621copy3r_uNRQ$default(this.oldValue, (AnnotatedString) null, m941createTextFieldValueFDrldGo.getSelection(), (TextRange) null, 5, (Object) null);
        TextFieldState textFieldState = this.state;
        if (textFieldState == null) {
            return;
        }
    ...
    public final long m948getHandlePositiontuRUvjQ$foundation_release(boolean isStartHandle) {
        ...
        int m4408getStartimpl = isStartHandle ? TextRange.m4408getStartimpl(selection) : TextRange.m4403getEndimpl(selection);
        TextFieldState textFieldState = this.state;
        TextLayoutResultProxy layoutResult = textFieldState != null ? textFieldState.getLayoutResult() : null;
        Intrinsics.checkNotNull(layoutResult);
        return TextSelectionDelegateKt.getSelectionHandleCoordinates(layoutResult.getValue(), this.offsetMapping.originalToTransformed(m4408getStartimpl), isStartHandle, TextRange.m4407getReversedimpl(getValue$foundation_release().getSelection()));
    }

    /* renamed from: getCursorPosition-tuRUvjQ$foundation_release, reason: not valid java name */
    public final long m947getCursorPositiontuRUvjQ$foundation_release(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        int originalToTransformed = this.offsetMapping.originalToTransformed(TextRange.m4408getStartimpl(getValue$foundation_release().getSelection()));
        TextFieldState textFieldState = this.state;
        TextLayoutResultProxy layoutResult = textFieldState != null ? textFieldState.getLayoutResult() : null;
        Intrinsics.checkNotNull(layoutResult);
        ...
        return OffsetKt.Offset(cursorRect.getLeft() + (density.mo327toPx0680j_4(TextFieldCursorKt.getDefaultCursorThickness()) / 2), cursorRect.getBottom());
    }

    public final void showSelectionToolbar$foundation_release() {
        ClipboardManager clipboardManager;
        boolean z = this.visualTransformation instanceof PasswordVisualTransformation;
        Function0<Unit> function0 = (TextRange.m4402getCollapsedimpl(getValue$foundation_release().getSelection()) || z) ? null : new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$showSelectionToolbar$copy$1
            {
                super(0);
            }
        ...
        Function0<Unit> function02 = (TextRange.m4402getCollapsedimpl(getValue$foundation_release().getSelection()) || !getEditable() || z) ? null : new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$showSelectionToolbar$cut$1
            {
                super(0);
            }
        ...
        Function0<Unit> function04 = TextRange.m4404getLengthimpl(getValue$foundation_release().getSelection()) != getValue$foundation_release().getText().length() ? new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$showSelectionToolbar$selectAll$1
            {
                super(0);
            }
    ...
    public final void m944contextMenuOpenAdjustmentk4lQ0M(long position) {
        ...
        int m835getOffsetForPosition3MmeM6k$default = TextLayoutResultProxy.m835getOffsetForPosition3MmeM6k$default(layoutResult, position, false, 2, null);
        if (TextRange.m4399containsimpl(getValue$foundation_release().getSelection(), m835getOffsetForPosition3MmeM6k$default)) {
            return;
        }
        updateSelection(getValue$foundation_release(), m835getOffsetForPosition3MmeM6k$default, m835getOffsetForPosition3MmeM6k$default, false, SelectionAdjustment.INSTANCE.getWord());
    }
    ...
    private final Rect getContentRect() {
        ...
        if (textFieldState != null) {
            ...
            if (textFieldState != null) {
                int originalToTransformed = this.offsetMapping.originalToTransformed(TextRange.m4408getStartimpl(getValue$foundation_release().getSelection()));
                int originalToTransformed2 = this.offsetMapping.originalToTransformed(TextRange.m4403getEndimpl(getValue$foundation_release().getSelection()));
                TextFieldState textFieldState2 = this.state;
                long m2407getZeroF1C5BW0 = (textFieldState2 == null || (layoutCoordinates4 = textFieldState2.getLayoutCoordinates()) == null) ? Offset.INSTANCE.m2407getZeroF1C5BW0() : layoutCoordinates4.mo3877localToRootMKHz9U(m948getHandlePositiontuRUvjQ$foundation_release(true));
                TextFieldState textFieldState3 = this.state;
                long m2407getZeroF1C5BW02 = (textFieldState3 == null || (layoutCoordinates3 = textFieldState3.getLayoutCoordinates()) == null) ? Offset.INSTANCE.m2407getZeroF1C5BW0() : layoutCoordinates3.mo3877localToRootMKHz9U(m948getHandlePositiontuRUvjQ$foundation_release(false));
                ...
                if (textFieldState4 == null || (layoutCoordinates2 = textFieldState4.getLayoutCoordinates()) == null) {
                    ...
                    f = Offset.m2392getYimpl(layoutCoordinates2.mo3877localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult == null || (value2 = layoutResult.getValue()) == null || (cursorRect2 = value2.getCursorRect(originalToTransformed)) == null) ? 0.0f : cursorRect2.getTop())));
                }
                ...
                if (textFieldState5 != null && (layoutCoordinates = textFieldState5.getLayoutCoordinates()) != null) {
                    ...
                    f2 = Offset.m2392getYimpl(layoutCoordinates.mo3877localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult2 == null || (value = layoutResult2.getValue()) == null || (cursorRect = value.getCursorRect(originalToTransformed2)) == null) ? 0.0f : cursorRect.getTop())));
                }
                return new Rect(Math.min(Offset.m2391getXimpl(m2407getZeroF1C5BW0), Offset.m2391getXimpl(m2407getZeroF1C5BW02)), Math.min(f, f2), Math.max(Offset.m2391getXimpl(m2407getZeroF1C5BW0), Offset.m2391getXimpl(m2407getZeroF1C5BW02)), Math.max(Offset.m2392getYimpl(m2407getZeroF1C5BW0), Offset.m2392getYimpl(m2407getZeroF1C5BW02)) + (Dp.m4878constructorimpl(25) * textFieldState.getTextDelegate().getDensity().getDensity()));
            }
        }
    ...
    public final void updateSelection(TextFieldValue value, int transformedStartOffset, int transformedEndOffset, boolean isStartHandle, SelectionAdjustment adjustment) {
        TextLayoutResultProxy layoutResult;
        long TextRange = TextRangeKt.TextRange(this.offsetMapping.originalToTransformed(TextRange.m4408getStartimpl(value.getSelection())), this.offsetMapping.originalToTransformed(TextRange.m4403getEndimpl(value.getSelection())));
        TextFieldState textFieldState = this.state;
        long m938getTextFieldSelectionbb3KNj8 = TextFieldSelectionDelegateKt.m938getTextFieldSelectionbb3KNj8((textFieldState == null || (layoutResult = textFieldState.getLayoutResult()) == null) ? null : layoutResult.getValue(), transformedStartOffset, transformedEndOffset, TextRange.m4402getCollapsedimpl(TextRange) ? null : TextRange.m4396boximpl(TextRange), isStartHandle, adjustment);
        long TextRange2 = TextRangeKt.TextRange(this.offsetMapping.transformedToOriginal(TextRange.m4408getStartimpl(m938getTextFieldSelectionbb3KNj8)), this.offsetMapping.transformedToOriginal(TextRange.m4403getEndimpl(m938getTextFieldSelectionbb3KNj8)));
        if (TextRange.m4401equalsimpl0(TextRange2, value.getSelection())) {
            return;
        }
        ...
        this.onValueChange.invoke(m941createTextFieldValueFDrldGo(value.getAnnotatedString(), TextRange2));
        TextFieldState textFieldState2 = this.state;
        if (textFieldState2 != null) {
