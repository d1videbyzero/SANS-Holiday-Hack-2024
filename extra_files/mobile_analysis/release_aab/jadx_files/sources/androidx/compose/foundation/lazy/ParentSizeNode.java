...
final class ParentSizeNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo239measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        int m4836getMinWidthimpl = roundToInt != Integer.MAX_VALUE ? roundToInt : Constraints.m4836getMinWidthimpl(j);
        int m4835getMinHeightimpl = roundToInt2 != Integer.MAX_VALUE ? roundToInt2 : Constraints.m4835getMinHeightimpl(j);
        if (roundToInt == Integer.MAX_VALUE) {
            roundToInt = Constraints.m4834getMaxWidthimpl(j);
        }
        if (roundToInt2 == Integer.MAX_VALUE) {
            roundToInt2 = Constraints.m4833getMaxHeightimpl(j);
        }
        final Placeable mo3868measureBRTryo0 = measurable.mo3868measureBRTryo0(ConstraintsKt.Constraints(m4836getMinWidthimpl, roundToInt, m4835getMinHeightimpl, roundToInt2));
        return MeasureScope.layout$default(measure, mo3868measureBRTryo0.getWidth(), mo3868measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.ParentSizeNode$measure$1
            {
                super(1);
            }
