...
public final class LazyLayoutAnimateItemModifierNode extends Modifier.Node {
    ...
    public LazyLayoutAnimateItemModifierNode(FiniteAnimationSpec<IntOffset> placementAnimationSpec) {
        ...
        this.placementDeltaAnimation = new Animatable<>(IntOffset.m4987boximpl(IntOffset.INSTANCE.m5006getZeronOccac()), VectorConvertersKt.getVectorConverter(IntOffset.INSTANCE), null, null, 12, null);
        this.placementDelta = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m4987boximpl(IntOffset.INSTANCE.m5006getZeronOccac()), null, 2, null);
    }
    ...
    public final void m625setPlacementDeltagyyYBs(long j) {
        this.placementDelta.setValue(IntOffset.m4987boximpl(j));
    }
    ...
    public final void m626animatePlacementDeltagyyYBs(long delta) {
        long m627getPlacementDeltanOccac = m627getPlacementDeltanOccac();
        long IntOffset = IntOffsetKt.IntOffset(IntOffset.m4996getXimpl(m627getPlacementDeltanOccac) - IntOffset.m4996getXimpl(delta), IntOffset.m4997getYimpl(m627getPlacementDeltanOccac) - IntOffset.m4997getYimpl(delta));
        m625setPlacementDeltagyyYBs(IntOffset);
    ...
    public void onDetach() {
        m625setPlacementDeltagyyYBs(IntOffset.INSTANCE.m5006getZeronOccac());
