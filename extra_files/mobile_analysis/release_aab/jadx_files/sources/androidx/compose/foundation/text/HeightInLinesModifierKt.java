        ...
        return ComposedModifierKt.composed(modifier, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.text.HeightInLinesModifierKt$heightInLines$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier composed, Composer composer, int i3) {
                ...
                if (changed2 || rememberedValue2 == Composer.INSTANCE.getEmpty()) {
                    ...
                    FontStyle m4431getFontStyle4Lr2A7w = textStyle3.m4431getFontStyle4Lr2A7w();
                    int m4506unboximpl = m4431getFontStyle4Lr2A7w != null ? m4431getFontStyle4Lr2A7w.m4506unboximpl() : FontStyle.INSTANCE.m4508getNormal_LCdwA();
                    FontSynthesis m4432getFontSynthesisZQGJjVo = textStyle3.m4432getFontSynthesisZQGJjVo();
                    rememberedValue2 = resolver.mo4478resolveDPcqOEQ(fontFamily, fontWeight, m4506unboximpl, m4432getFontSynthesisZQGJjVo != null ? m4432getFontSynthesisZQGJjVo.getValue() : FontSynthesis.INSTANCE.m4518getAllGVVA2EU());
                ...
                if (z || rememberedValue3 == Composer.INSTANCE.getEmpty()) {
                    rememberedValue3 = Integer.valueOf(IntSize.m5037getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText(textStyle3, density, resolver, TextFieldDelegateKt.getEmptyTextReplacement(), 1)));
                ...
                if (z2 || rememberedValue4 == Composer.INSTANCE.getEmpty()) {
                    rememberedValue4 = Integer.valueOf(IntSize.m5037getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText(textStyle3, density, resolver, TextFieldDelegateKt.getEmptyTextReplacement() + '\n' + TextFieldDelegateKt.getEmptyTextReplacement(), 2)));
                ...
                Modifier m516heightInVpY3zN4 = SizeKt.m516heightInVpY3zN4(Modifier.INSTANCE, valueOf != null ? density.mo324toDpu2uoSUM(valueOf.intValue()) : Dp.INSTANCE.m4898getUnspecifiedD9Ej5fM(), valueOf2 != null ? density.mo324toDpu2uoSUM(valueOf2.intValue()) : Dp.INSTANCE.m4898getUnspecifiedD9Ej5fM());
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                composer.endReplaceableGroup();
