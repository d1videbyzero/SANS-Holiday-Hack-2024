...
final class LazyStaggeredGridSlotCache implements Function2<Density, Constraints, LazyStaggeredGridSlots> {
    ...
    public LazyStaggeredGridSlots m673invoke0kLqBqw(Density density, long constraints) {
        ...
        if (this.cachedSizes != null && Constraints.m4827equalsimpl0(this.cachedConstraints, constraints) && this.cachedDensity == density.getDensity()) {
        ...
        LazyStaggeredGridSlots invoke = this.calculation.invoke(density, Constraints.m4822boximpl(constraints));
