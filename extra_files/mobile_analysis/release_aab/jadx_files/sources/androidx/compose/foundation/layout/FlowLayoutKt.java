...
public final class FlowLayoutKt {
    ...
    public static final void FlowRow(Modifier modifier, Arrangement.Horizontal horizontal, Arrangement.Vertical vertical, int i, Function3<? super FlowRowScope, ? super Composer, ? super Integer, Unit> content, Composer composer, int i2, int i3) {
        ...
        Updater.m2271setimpl(m2264constructorimpl, rowMeasurementHelper, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
        Updater.m2271setimpl(m2264constructorimpl, currentCompositionLocalMap, ComposeUiNode.INSTANCE.getSetResolvedCompositionLocals());
        Function2<ComposeUiNode, Integer, Unit> setCompositeKeyHash = ComposeUiNode.INSTANCE.getSetCompositeKeyHash();
        if (m2264constructorimpl.getInserting() || !Intrinsics.areEqual(m2264constructorimpl.rememberedValue(), Integer.valueOf(currentCompositeKeyHash))) {
            m2264constructorimpl.updateRememberedValue(Integer.valueOf(currentCompositeKeyHash));
            m2264constructorimpl.apply(Integer.valueOf(currentCompositeKeyHash), setCompositeKeyHash);
        }
        modifierMaterializerOf.invoke(SkippableUpdater.m2255boximpl(SkippableUpdater.m2256constructorimpl(composer)), composer, 0);
    ...
    public static final void FlowColumn(Modifier modifier, Arrangement.Vertical vertical, Arrangement.Horizontal horizontal, int i, Function3<? super FlowColumnScope, ? super Composer, ? super Integer, Unit> content, Composer composer, int i2, int i3) {
        ...
        Composer m2264constructorimpl = Updater.m2264constructorimpl(composer);
        Updater.m2271setimpl(m2264constructorimpl, columnMeasurementHelper, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
        Updater.m2271setimpl(m2264constructorimpl, currentCompositionLocalMap, ComposeUiNode.INSTANCE.getSetResolvedCompositionLocals());
        Function2<ComposeUiNode, Integer, Unit> setCompositeKeyHash = ComposeUiNode.INSTANCE.getSetCompositeKeyHash();
        if (m2264constructorimpl.getInserting() || !Intrinsics.areEqual(m2264constructorimpl.rememberedValue(), Integer.valueOf(currentCompositeKeyHash))) {
            m2264constructorimpl.updateRememberedValue(Integer.valueOf(currentCompositeKeyHash));
    ...
    public static final MeasurePolicy rowMeasurementHelper(Arrangement.Horizontal horizontalArrangement, Arrangement.Vertical verticalArrangement, int i, Composer composer, int i2) {
        ...
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = m430flowMeasurePolicybs7tms(LayoutOrientation.Horizontal, getHorizontalArrangement(horizontalArrangement), horizontalArrangement.getSpacing(), SizeMode.Wrap, CROSS_AXIS_ALIGNMENT_TOP, getVerticalArrangement(verticalArrangement), verticalArrangement.getSpacing(), i);
    ...
    public static final MeasurePolicy columnMeasurementHelper(Arrangement.Vertical verticalArrangement, Arrangement.Horizontal horizontalArrangement, int i, Composer composer, int i2) {
        ...
        Object rememberedValue = composer.rememberedValue();
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = m430flowMeasurePolicybs7tms(LayoutOrientation.Vertical, getVerticalArrangement(verticalArrangement), verticalArrangement.getSpacing(), SizeMode.Wrap, CROSS_AXIS_ALIGNMENT_START, getHorizontalArrangement(horizontalArrangement), horizontalArrangement.getSpacing(), i);
            composer.updateRememberedValue(rememberedValue);
        }
        composer.endReplaceableGroup();
        MeasurePolicy measurePolicy = (MeasurePolicy) rememberedValue;
    ...
    public static final MeasurePolicy m430flowMeasurePolicybs7tms(final LayoutOrientation layoutOrientation, final Function5<? super Integer, ? super int[], ? super LayoutDirection, ? super Density, ? super int[], Unit> function5, final float f, final SizeMode sizeMode, final CrossAxisAlignment crossAxisAlignment, final Function5<? super Integer, ? super int[], ? super LayoutDirection, ? super Density, ? super int[], Unit> function52, final float f2, final int i) {
        return new MeasurePolicy(function5, f, sizeMode, crossAxisAlignment, i, f2, function52) { // from class: androidx.compose.foundation.layout.FlowLayoutKt$flowMeasurePolicy$1
            ...
            public MeasureResult mo13measure3p2s80s(final MeasureScope measure, List<? extends Measurable> measurables, long j) {
                ...
                final FlowResult m429breakDownItemsw1Onq5I = FlowLayoutKt.m429breakDownItemsw1Onq5I(measure, rowColumnMeasurementHelper, LayoutOrientation.this, OrientationIndependentConstraints.m451constructorimpl(j, LayoutOrientation.this), this.$maxItemsInMainAxis);
                MutableVector<RowColumnMeasureHelperResult> items = m429breakDownItemsw1Onq5I.getItems();
                ...
                int crossAxisTotalSize = m429breakDownItemsw1Onq5I.getCrossAxisTotalSize() + (measure.mo321roundToPx0680j_4(this.$crossAxisArrangementSpacing) * (items.getSize() - 1));
                ...
                if (LayoutOrientation.this == LayoutOrientation.Horizontal) {
                    crossAxisTotalSize = m429breakDownItemsw1Onq5I.getMainAxisTotalSize();
                    mainAxisTotalSize = crossAxisTotalSize;
                } else {
                    mainAxisTotalSize = m429breakDownItemsw1Onq5I.getMainAxisTotalSize();
                }
                return MeasureScope.layout$default(measure, ConstraintsKt.m4848constrainWidthK40F9xA(j, crossAxisTotalSize), ConstraintsKt.m4847constrainHeightK40F9xA(j, mainAxisTotalSize), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutKt$flowMeasurePolicy$1$measure$2
            ...
            public int minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> measurables, int i2) {
                ...
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                if (LayoutOrientation.this == LayoutOrientation.Horizontal) {
                    return minIntrinsicMainAxisSize(measurables, i2, intrinsicMeasureScope.mo321roundToPx0680j_4(this.$mainAxisArrangementSpacing), intrinsicMeasureScope.mo321roundToPx0680j_4(this.$crossAxisArrangementSpacing));
                }
                return intrinsicCrossAxisSize(measurables, i2, intrinsicMeasureScope.mo321roundToPx0680j_4(this.$mainAxisArrangementSpacing), intrinsicMeasureScope.mo321roundToPx0680j_4(this.$crossAxisArrangementSpacing));
            }
            ...
            public int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> measurables, int i2) {
                ...
                return maxIntrinsicMainAxisSize(measurables, i2, intrinsicMeasureScope.mo321roundToPx0680j_4(this.$mainAxisArrangementSpacing));
            }
    ...
    private static final int m431measureAndCache6m2dt9o(Measurable measurable, long j, LayoutOrientation layoutOrientation, Function1<? super Placeable, Unit> function1) {
        if (RowColumnImplKt.getWeight(RowColumnImplKt.getRowColumnParentData(measurable)) == 0.0f) {
            Placeable mo3868measureBRTryo0 = measurable.mo3868measureBRTryo0(OrientationIndependentConstraints.m464toBoxConstraintsOenEA2s(OrientationIndependentConstraints.m453copyyUG9Ft0$default(j, 0, 0, 0, 0, 14, null), layoutOrientation));
            function1.invoke(mo3868measureBRTryo0);
            return mainAxisSize(mo3868measureBRTryo0, layoutOrientation);
        }
    ...
    public static final FlowResult m429breakDownItemsw1Onq5I(MeasureScope breakDownItems, RowColumnMeasurementHelper measureHelper, LayoutOrientation orientation, long j, int i) {
        ...
        int ceil = (int) Math.ceil(breakDownItems.mo327toPx0680j_4(measureHelper.getArrangementSpacing()));
        long m449constructorimpl = OrientationIndependentConstraints.m449constructorimpl(m4836getMinWidthimpl, m4834getMaxWidthimpl, 0, m4833getMaxHeightimpl);
        Measurable measurable = (Measurable) CollectionsKt.getOrNull(measurables, 0);
        Integer valueOf = measurable != null ? Integer.valueOf(m431measureAndCache6m2dt9o(measurable, m449constructorimpl, orientation, new Function1<Placeable, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutKt$breakDownItems$nextSize$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
        ...
        while (i3 < size) {
            ...
            Integer valueOf2 = measurable2 != null ? Integer.valueOf(m431measureAndCache6m2dt9o(measurable2, m449constructorimpl, orientation, new Function1<Placeable, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutKt$breakDownItems$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
            ...
            int min = Math.min(Math.max(m4836getMinWidthimpl, i7), m4834getMaxWidthimpl);
            numArr[i6] = Integer.valueOf(i8);
            i6++;
            i2 = m4834getMaxWidthimpl;
            valueOf2 = valueOf2 != null ? Integer.valueOf(valueOf2.intValue() - ceil) : null;
            i5 = i8;
            i4 = 0;
            m4836getMinWidthimpl = min;
            i3 = i8;
            valueOf = valueOf2;
        }
        int i9 = m4836getMinWidthimpl;
        long m464toBoxConstraintsOenEA2s = OrientationIndependentConstraints.m464toBoxConstraintsOenEA2s(OrientationIndependentConstraints.m453copyyUG9Ft0$default(m449constructorimpl, i9, 0, 0, 0, 14, null), orientation);
        int i10 = 0;
        int i11 = 0;
        int i12 = 0;
        Integer num = (Integer) ArraysKt.getOrNull(numArr, 0);
        while (num != null) {
            RowColumnMeasureHelperResult m509measureWithoutPlacing_EkL_Y = measureHelper.m509measureWithoutPlacing_EkL_Y(breakDownItems, m464toBoxConstraintsOenEA2s, i10, num.intValue());
            i11 += m509measureWithoutPlacing_EkL_Y.getCrossAxisSize();
            i9 = Math.max(i9, m509measureWithoutPlacing_EkL_Y.getMainAxisSize());
            mutableVector.add(m509measureWithoutPlacing_EkL_Y);
            i10 = num.intValue();
            i12++;
            num = (Integer) ArraysKt.getOrNull(numArr, i12);
        }
        return new FlowResult(Math.max(i9, Constraints.m4836getMinWidthimpl(j)), Math.max(i11, Constraints.m4835getMinHeightimpl(j)), mutableVector);
    }
}
