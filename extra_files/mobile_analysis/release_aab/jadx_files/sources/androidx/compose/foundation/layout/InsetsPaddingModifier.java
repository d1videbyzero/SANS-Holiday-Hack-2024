...
public final class InsetsPaddingModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer, ModifierLocalProvider<WindowInsets> {
    ...
    public MeasureResult mo39measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        final Placeable mo3868measureBRTryo0 = measurable.mo3868measureBRTryo0(ConstraintsKt.m4850offsetNN6EwU(j, -right, -bottom));
        return MeasureScope.layout$default(measure, ConstraintsKt.m4848constrainWidthK40F9xA(j, mo3868measureBRTryo0.getWidth() + right), ConstraintsKt.m4847constrainHeightK40F9xA(j, mo3868measureBRTryo0.getHeight() + bottom), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.InsetsPaddingModifier$measure$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
