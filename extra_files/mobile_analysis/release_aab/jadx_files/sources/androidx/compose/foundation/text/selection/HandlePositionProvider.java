...
public final class HandlePositionProvider implements PopupPositionProvider {
    ...
    public long mo876calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        ...
        if (i == 1) {
            return IntOffsetKt.IntOffset(anchorBounds.getLeft() + IntOffset.m4996getXimpl(this.offset), anchorBounds.getTop() + IntOffset.m4997getYimpl(this.offset));
        }
        if (i == 2) {
            return IntOffsetKt.IntOffset((anchorBounds.getLeft() + IntOffset.m4996getXimpl(this.offset)) - IntSize.m5038getWidthimpl(popupContentSize), anchorBounds.getTop() + IntOffset.m4997getYimpl(this.offset));
        }
        if (i == 3) {
            return IntOffsetKt.IntOffset((anchorBounds.getLeft() + IntOffset.m4996getXimpl(this.offset)) - (IntSize.m5038getWidthimpl(popupContentSize) / 2), anchorBounds.getTop() + IntOffset.m4997getYimpl(this.offset));
        }
