...
public final class TextFieldScrollerPosition {
    ...
    public TextFieldScrollerPosition(Orientation initialOrientation, float f) {
        ...
        this.previousSelection = TextRange.INSTANCE.m4413getZerod9O1mEE();
    ...
    public final void m825setPreviousSelection5zctL8(long j) {
    ...
    public final int m823getOffsetToFollow5zctL8(long selection) {
        return TextRange.m4408getStartimpl(selection) != TextRange.m4408getStartimpl(this.previousSelection) ? TextRange.m4408getStartimpl(selection) : TextRange.m4403getEndimpl(selection) != TextRange.m4403getEndimpl(this.previousSelection) ? TextRange.m4403getEndimpl(selection) : TextRange.m4406getMinimpl(selection);
    }
