...
final /* data */ class BoxWithConstraintsScopeImpl implements BoxWithConstraintsScope, BoxScope {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.density, boxWithConstraintsScopeImpl.density) && Constraints.m4827equalsimpl0(this.constraints, boxWithConstraintsScopeImpl.constraints);
    }

    public int hashCode() {
        return (this.density.hashCode() * 31) + Constraints.m4837hashCodeimpl(this.constraints);
    }
    ...
    public String toString() {
        return "BoxWithConstraintsScopeImpl(density=" + this.density + ", constraints=" + ((Object) Constraints.m4839toStringimpl(this.constraints)) + ')';
    }
    ...
    public float mo424getMinWidthD9Ej5fM() {
        return this.density.mo324toDpu2uoSUM(Constraints.m4836getMinWidthimpl(mo420getConstraintsmsEJaDk()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMaxWidth-D9Ej5fM */
    public float mo422getMaxWidthD9Ej5fM() {
        return Constraints.m4830getHasBoundedWidthimpl(mo420getConstraintsmsEJaDk()) ? this.density.mo324toDpu2uoSUM(Constraints.m4834getMaxWidthimpl(mo420getConstraintsmsEJaDk())) : Dp.INSTANCE.m4897getInfinityD9Ej5fM();
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMinHeight-D9Ej5fM */
    public float mo423getMinHeightD9Ej5fM() {
        return this.density.mo324toDpu2uoSUM(Constraints.m4835getMinHeightimpl(mo420getConstraintsmsEJaDk()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMaxHeight-D9Ej5fM */
    public float mo421getMaxHeightD9Ej5fM() {
        return Constraints.m4829getHasBoundedHeightimpl(mo420getConstraintsmsEJaDk()) ? this.density.mo324toDpu2uoSUM(Constraints.m4833getMaxHeightimpl(mo420getConstraintsmsEJaDk())) : Dp.INSTANCE.m4897getInfinityD9Ej5fM();
    }
}
