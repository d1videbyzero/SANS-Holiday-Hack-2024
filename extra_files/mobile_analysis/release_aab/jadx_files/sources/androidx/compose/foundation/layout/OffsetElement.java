...
final class OffsetElement extends ModifierNodeElement<OffsetNode> {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m4883equalsimpl0(this.x, offsetElement.x) && Dp.m4883equalsimpl0(this.y, offsetElement.y) && this.rtlAware == offsetElement.rtlAware;
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((Dp.m4884hashCodeimpl(this.x) * 31) + Dp.m4884hashCodeimpl(this.y)) * 31) + Boolean.hashCode(this.rtlAware);
    }

    public String toString() {
        return "OffsetModifierElement(x=" + ((Object) Dp.m4889toStringimpl(this.x)) + ", y=" + ((Object) Dp.m4889toStringimpl(this.y)) + ", rtlAware=" + this.rtlAware + ')';
    }
