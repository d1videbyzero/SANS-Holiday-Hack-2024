...
abstract class AbstractClickableNode extends DelegatingNode implements PointerInputModifierNode, KeyInputModifierNode {
    ...
    public boolean mo145onPreKeyEventZmokQxo(KeyEvent event) {
    ...
    public static final class InteractionData {
        ...
        private long centreOffset = Offset.INSTANCE.m2407getZeroF1C5BW0();
        ...
        public final void m148setCentreOffsetk4lQ0M(long j) {
            this.centreOffset = j;
        }
    }
    ...
    public static /* synthetic */ void m142updateCommonXHw0xAI$default(AbstractClickableNode abstractClickableNode, MutableInteractionSource mutableInteractionSource, boolean z, String str, Role role, Function0 function0, int i, Object obj) {
        if (obj != null) {
        ...
        abstractClickableNode.m146updateCommonXHw0xAI(mutableInteractionSource, z, str, role, function0);
    }

    /* renamed from: updateCommon-XHw0xAI, reason: not valid java name */
    protected final void m146updateCommonXHw0xAI(MutableInteractionSource interactionSource, boolean enabled, String onClickLabel, Role role, Function0<Unit> onClick) {
        Intrinsics.checkNotNullParameter(interactionSource, "interactionSource");
        Intrinsics.checkNotNullParameter(onClick, "onClick");
    ...
    public void mo144onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        ...
        getClickablePointerInputNode().mo144onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }
    ...
    public boolean mo143onKeyEventZmokQxo(KeyEvent event) {
        Intrinsics.checkNotNullParameter(event, "event");
        if (this.enabled && Clickable_androidKt.m209isPressZmokQxo(event)) {
            if (!this.interactionData.getCurrentKeyPressInteractions().containsKey(Key.m3306boximpl(KeyEvent_androidKt.m3617getKeyZmokQxo(event)))) {
                PressInteraction.Press press = new PressInteraction.Press(this.interactionData.getCentreOffset(), null);
                this.interactionData.getCurrentKeyPressInteractions().put(Key.m3306boximpl(KeyEvent_androidKt.m3617getKeyZmokQxo(event)), press);
        ...
        } else if (this.enabled && Clickable_androidKt.m207isClickZmokQxo(event)) {
            PressInteraction.Press remove = this.interactionData.getCurrentKeyPressInteractions().remove(Key.m3306boximpl(KeyEvent_androidKt.m3617getKeyZmokQxo(event)));
            if (remove != null) {
