...
public final class TransformGestureDetectorKt {
    ...
    public static final float calculateRotation(PointerEvent pointerEvent) {
        ...
        for (int i4 = 0; i4 < size2; i4++) {
            ...
            if (pointerInputChange2.getPressed() && pointerInputChange2.getPreviousPressed()) {
                ...
                long m2395minusMKHz9U = Offset.m2395minusMKHz9U(pointerInputChange2.getPreviousPosition(), calculateCentroid2);
                long m2395minusMKHz9U2 = Offset.m2395minusMKHz9U(position, calculateCentroid);
                float m353anglek4lQ0M = m353anglek4lQ0M(m2395minusMKHz9U2) - m353anglek4lQ0M(m2395minusMKHz9U);
                float m2389getDistanceimpl = Offset.m2389getDistanceimpl(Offset.m2396plusMKHz9U(m2395minusMKHz9U2, m2395minusMKHz9U)) / 2.0f;
                if (m353anglek4lQ0M > 180.0f) {
                    m353anglek4lQ0M -= 360.0f;
                } else if (m353anglek4lQ0M < -180.0f) {
                    m353anglek4lQ0M += 360.0f;
                }
                f2 += m353anglek4lQ0M * m2389getDistanceimpl;
                f += m2389getDistanceimpl;
            }
        }
        if (f == 0.0f) {
            return 0.0f;
    ...
    private static final float m353anglek4lQ0M(long j) {
        if (Offset.m2391getXimpl(j) == 0.0f && Offset.m2392getYimpl(j) == 0.0f) {
            return 0.0f;
        }
        return ((-((float) Math.atan2(Offset.m2391getXimpl(j), Offset.m2392getYimpl(j)))) * 180.0f) / 3.1415927f;
    }
    ...
    public static final long calculatePan(PointerEvent pointerEvent) {
        Intrinsics.checkNotNullParameter(pointerEvent, "<this>");
        long calculateCentroid = calculateCentroid(pointerEvent, true);
        if (Offset.m2388equalsimpl0(calculateCentroid, Offset.INSTANCE.m2406getUnspecifiedF1C5BW0())) {
            return Offset.INSTANCE.m2407getZeroF1C5BW0();
        }
        return Offset.m2395minusMKHz9U(calculateCentroid, calculateCentroid(pointerEvent, false));
    }
    ...
    public static final float calculateCentroidSize(PointerEvent pointerEvent, boolean z) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (pointerInputChange.getPressed() && pointerInputChange.getPreviousPressed()) {
                f += Offset.m2389getDistanceimpl(Offset.m2395minusMKHz9U(z ? pointerInputChange.getPosition() : pointerInputChange.getPreviousPosition(), calculateCentroid));
                i++;
            }
        }
        return f / i;
    ...
    public static final long calculateCentroid(PointerEvent pointerEvent, boolean z) {
        Intrinsics.checkNotNullParameter(pointerEvent, "<this>");
        long m2407getZeroF1C5BW0 = Offset.INSTANCE.m2407getZeroF1C5BW0();
        List<PointerInputChange> changes = pointerEvent.getChanges();
        int size = changes.size();
        int i = 0;
        for (int i2 = 0; i2 < size; i2++) {
            PointerInputChange pointerInputChange = changes.get(i2);
            if (pointerInputChange.getPressed() && pointerInputChange.getPreviousPressed()) {
                m2407getZeroF1C5BW0 = Offset.m2396plusMKHz9U(m2407getZeroF1C5BW0, z ? pointerInputChange.getPosition() : pointerInputChange.getPreviousPosition());
                i++;
            }
        }
        if (i == 0) {
        ...
        return Offset.m2386divtuRUvjQ(m2407getZeroF1C5BW0, i);
    }
}
