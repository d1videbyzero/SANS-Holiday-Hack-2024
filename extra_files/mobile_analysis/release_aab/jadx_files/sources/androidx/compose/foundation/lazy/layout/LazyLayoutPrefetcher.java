...
public final class LazyLayoutPrefetcher implements RememberObserver, LazyLayoutPrefetchState.Prefetcher, Runnable, Choreographer.FrameCallback {
                        ...
                        try {
                            ...
                            if (enoughTimeLeft(nanoTime, nanos, this.averagePremeasureTimeNs)) {
                                ...
                                for (int i = 0; i < placeablesCount; i++) {
                                    precomposeHandle.mo3889premeasure0kLqBqw(i, prefetchRequest.getConstraints());
                                }
    ...
    public LazyLayoutPrefetchState.PrefetchHandle mo642schedulePrefetch0kLqBqw(int index, long constraints) {
