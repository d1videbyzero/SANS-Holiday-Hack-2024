...
final /* data */ class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo39measure3p2s80s(final MeasureScope measure, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measure, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        final Placeable mo3868measureBRTryo0 = measurable.mo3868measureBRTryo0(measurable.maxIntrinsicWidth(Constraints.m4833getMaxHeightimpl(j)) < Constraints.m4834getMaxWidthimpl(j) ? j : Constraints.m4825copyZbe2FdA$default(j, 0, Integer.MAX_VALUE, 0, 0, 13, null));
        final int min = Math.min(mo3868measureBRTryo0.getWidth(), Constraints.m4834getMaxWidthimpl(j));
        return MeasureScope.layout$default(measure, min, mo3868measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.HorizontalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                cursorRectInScroller = TextFieldScrollKt.getCursorRectInScroller(measureScope, cursorOffset, transformedText, invoke != null ? invoke.getValue() : null, MeasureScope.this.getLayoutDirection() == LayoutDirection.Rtl, mo3868measureBRTryo0.getWidth());
                this.getScrollerPosition().update(Orientation.Horizontal, cursorRectInScroller, min, mo3868measureBRTryo0.getWidth());
                Placeable.PlacementScope.placeRelative$default(layout, mo3868measureBRTryo0, MathKt.roundToInt(-this.getScrollerPosition().getOffset()), 0, 0.0f, 4, null);
            }
        }, 4, null);
    }
}
