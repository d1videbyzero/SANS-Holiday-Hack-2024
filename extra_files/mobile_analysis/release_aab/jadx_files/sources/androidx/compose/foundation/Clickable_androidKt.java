...
public final class Clickable_androidKt {
    ...
    public static final boolean m209isPressZmokQxo(KeyEvent isPress) {
        Intrinsics.checkNotNullParameter(isPress, "$this$isPress");
        return KeyEventType.m3610equalsimpl0(KeyEvent_androidKt.m3618getTypeZmokQxo(isPress), KeyEventType.INSTANCE.m3614getKeyDownCS__XNY()) && m208isEnterZmokQxo(isPress);
    }

    /* renamed from: isClick-ZmokQxo, reason: not valid java name */
    public static final boolean m207isClickZmokQxo(KeyEvent isClick) {
        Intrinsics.checkNotNullParameter(isClick, "$this$isClick");
        return KeyEventType.m3610equalsimpl0(KeyEvent_androidKt.m3618getTypeZmokQxo(isClick), KeyEventType.INSTANCE.m3615getKeyUpCS__XNY()) && m208isEnterZmokQxo(isClick);
    }

    /* renamed from: isEnter-ZmokQxo, reason: not valid java name */
    private static final boolean m208isEnterZmokQxo(KeyEvent keyEvent) {
        int m3624getNativeKeyCodeYVgTNJs = Key_androidKt.m3624getNativeKeyCodeYVgTNJs(KeyEvent_androidKt.m3617getKeyZmokQxo(keyEvent));
        return m3624getNativeKeyCodeYVgTNJs == 23 || m3624getNativeKeyCodeYVgTNJs == 66 || m3624getNativeKeyCodeYVgTNJs == 160;
    }
}
