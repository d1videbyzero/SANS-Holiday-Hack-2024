...
public final class TextFieldScrollKt {
    ...
    public static final Modifier textFieldScroll(Modifier modifier, TextFieldScrollerPosition scrollerPosition, TextFieldValue textFieldValue, VisualTransformation visualTransformation, Function0<TextLayoutResultProxy> textLayoutResultProvider) {
        ...
        int m823getOffsetToFollow5zctL8 = scrollerPosition.m823getOffsetToFollow5zctL8(textFieldValue.getSelection());
        scrollerPosition.m825setPreviousSelection5zctL8(textFieldValue.getSelection());
        ...
        if (i == 1) {
            verticalScrollLayoutModifier = new VerticalScrollLayoutModifier(scrollerPosition, m823getOffsetToFollow5zctL8, filterWithValidation, textLayoutResultProvider);
        } else {
            if (i != 2) {
                throw new NoWhenBranchMatchedException();
            }
            verticalScrollLayoutModifier = new HorizontalScrollLayoutModifier(scrollerPosition, m823getOffsetToFollow5zctL8, filterWithValidation, textLayoutResultProvider);
        }
    ...
    public static final Rect getCursorRectInScroller(Density density, int i, TransformedText transformedText, TextLayoutResult textLayoutResult, boolean z, int i2) {
        ...
        Rect rect = zero;
        int mo321roundToPx0680j_4 = density.mo321roundToPx0680j_4(TextFieldCursorKt.getDefaultCursorThickness());
        if (z) {
            left = (i2 - rect.getLeft()) - mo321roundToPx0680j_4;
        } else {
            left = rect.getLeft();
        }
        float f = left;
        if (z) {
            ...
            left2 = rect.getLeft() + mo321roundToPx0680j_4;
        }
