...
public final class TextAnnotatedStringNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public /* synthetic */ TextAnnotatedStringNode(AnnotatedString annotatedString, TextStyle textStyle, FontFamily.Resolver resolver, Function1 function1, int i, boolean z, int i2, int i3, List list, Function1 function12, SelectionController selectionController, ColorProducer colorProducer, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, textStyle, resolver, (i4 & 8) != 0 ? null : function1, (i4 & 16) != 0 ? TextOverflow.INSTANCE.m4819getClipgIe3tQ8() : i, (i4 & 32) != 0 ? true : z, (i4 & 64) != 0 ? Integer.MAX_VALUE : i2, (i4 & 128) != 0 ? 1 : i3, (i4 & 256) != 0 ? null : list, (i4 & 512) != 0 ? null : function12, (i4 & 1024) != 0 ? null : selectionController, (i4 & 2048) != 0 ? null : colorProducer, null);
    }
    ...
    public final boolean m869updateLayoutRelatedArgsMPT68mk(TextStyle style, List<AnnotatedString.Range<Placeholder>> placeholders, int minLines, int maxLines, boolean softWrap, FontFamily.Resolver fontFamilyResolver, int overflow) {
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(fontFamilyResolver, "fontFamilyResolver");
        ...
        if (TextOverflow.m4812equalsimpl0(this.overflow, overflow)) {
            return z;
        }
    ...
    public final void doInvalidations(boolean drawChanged, boolean textChanged, boolean layoutChanged, boolean callbacksChanged) {
        ...
        if (textChanged || layoutChanged || callbacksChanged) {
            getLayoutCache().m851updateZNqEYIc(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, this.placeholders);
    ...
    public final MeasureResult m868measureNonExtension3p2s80s(MeasureScope measureScope, Measurable measurable, long constraints) {
    ...
    public MeasureResult mo239measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        boolean m850layoutWithConstraintsK40F9xA = layoutCache.m850layoutWithConstraintsK40F9xA(j, measure.getLayoutDirection());
        ...
        if (m850layoutWithConstraintsK40F9xA) {
        ...
        final Placeable mo3868measureBRTryo0 = measurable.mo3868measureBRTryo0(Constraints.INSTANCE.m4842fixedJhjzzOo(IntSize.m5038getWidthimpl(textLayoutResult.getSize()), IntSize.m5037getHeightimpl(textLayoutResult.getSize())));
        int m5038getWidthimpl = IntSize.m5038getWidthimpl(textLayoutResult.getSize());
        int m5037getHeightimpl = IntSize.m5037getHeightimpl(textLayoutResult.getSize());
        Map<AlignmentLine, Integer> map = this.baselineCache;
        Intrinsics.checkNotNull(map);
        return measure.layout(m5038getWidthimpl, m5037getHeightimpl, map, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.modifiers.TextAnnotatedStringNode$measure$1
            {
                super(1);
            }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        boolean z = textLayoutResult.getHasVisualOverflow() && !TextOverflow.m4812equalsimpl0(this.overflow, TextOverflow.INSTANCE.m4821getVisiblegIe3tQ8());
        if (z) {
            Rect m2431Recttz77jQw = RectKt.m2431Recttz77jQw(Offset.INSTANCE.m2407getZeroF1C5BW0(), SizeKt.Size(IntSize.m5038getWidthimpl(textLayoutResult.getSize()), IntSize.m5037getHeightimpl(textLayoutResult.getSize())));
            canvas.save();
            Canvas.m2603clipRectmtrdDE$default(canvas, m2431Recttz77jQw, 0, 2, null);
        }
        try {
            ...
            if (brush == null) {
                ...
                long m2707invoke0d7_KjU = colorProducer != null ? colorProducer.m2707invoke0d7_KjU() : Color.INSTANCE.m2666getUnspecified0d7_KjU();
                if (m2707invoke0d7_KjU == Color.INSTANCE.m2666getUnspecified0d7_KjU()) {
                    if (this.style.m4429getColor0d7_KjU() != Color.INSTANCE.m2666getUnspecified0d7_KjU()) {
                        m2707invoke0d7_KjU = this.style.m4429getColor0d7_KjU();
                    } else {
                        m2707invoke0d7_KjU = Color.INSTANCE.m2656getBlack0d7_KjU();
                    }
                }
                multiParagraph.m4298paintLG529CI(canvas, (r14 & 2) != 0 ? Color.INSTANCE.m2666getUnspecified0d7_KjU() : m2707invoke0d7_KjU, (r14 & 4) != 0 ? null : shadow2, (r14 & 8) != 0 ? null : textDecoration2, (r14 & 16) == 0 ? drawStyle2 : null, (r14 & 32) != 0 ? DrawScope.INSTANCE.m3175getDefaultBlendMode0nO6VwU() : 0);
            } else {
                multiParagraph.m4300painthn5TExg(canvas, brush, (r17 & 4) != 0 ? Float.NaN : this.style.getAlpha(), (r17 & 8) != 0 ? null : shadow2, (r17 & 16) != 0 ? null : textDecoration2, (r17 & 32) != 0 ? null : drawStyle2, (r17 & 64) != 0 ? DrawScope.INSTANCE.m3175getDefaultBlendMode0nO6VwU() : 0);
            }
