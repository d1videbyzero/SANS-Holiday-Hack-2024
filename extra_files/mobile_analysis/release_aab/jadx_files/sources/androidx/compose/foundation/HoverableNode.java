...
final class HoverableNode extends Modifier.Node implements PointerInputModifierNode {
    ...
    public void mo144onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        ...
        if (pass == PointerEventPass.Main) {
            ...
            if (PointerEventType.m3700equalsimpl0(type, PointerEventType.INSTANCE.m3704getEnter7fucELk())) {
            ...
            } else if (PointerEventType.m3700equalsimpl0(type, PointerEventType.INSTANCE.m3705getExit7fucELk())) {
