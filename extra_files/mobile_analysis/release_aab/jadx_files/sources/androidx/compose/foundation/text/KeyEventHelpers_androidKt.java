...
public final class KeyEventHelpers_androidKt {
    ...
    public static final boolean m760cancelsTextSelectionZmokQxo(KeyEvent cancelsTextSelection) {
        ...
        return cancelsTextSelection.getKeyCode() == 4 && KeyEventType.m3610equalsimpl0(KeyEvent_androidKt.m3618getTypeZmokQxo(cancelsTextSelection), KeyEventType.INSTANCE.m3615getKeyUpCS__XNY());
    }
}
