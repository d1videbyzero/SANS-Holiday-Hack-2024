...
public class StaticTextSelectionParams {
    ...
    public boolean getShouldClip() {
        ...
        TextLayoutResult textLayoutResult = this.textLayoutResult;
        TextOverflow m4809boximpl = (textLayoutResult == null || (layoutInput = textLayoutResult.getLayoutInput()) == null) ? null : TextOverflow.m4809boximpl(layoutInput.getOverflow());
        int m4821getVisiblegIe3tQ8 = TextOverflow.INSTANCE.m4821getVisiblegIe3tQ8();
        if (m4809boximpl == null) {
            return false;
        }
        return TextOverflow.m4812equalsimpl0(m4809boximpl.getValue(), m4821getVisiblegIe3tQ8);
    }
