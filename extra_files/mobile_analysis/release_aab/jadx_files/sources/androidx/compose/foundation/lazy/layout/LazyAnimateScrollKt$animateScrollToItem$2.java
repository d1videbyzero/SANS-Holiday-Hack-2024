...
final class LazyAnimateScrollKt$animateScrollToItem$2 extends SuspendLambda implements Function2<ScrollScope, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: Removed duplicated region for block: B:22:0x00d5 A[Catch: ItemFoundInScroll -> 0x01bb, TryCatch #2 {ItemFoundInScroll -> 0x01bb, blocks: (B:20:0x00d1, B:22:0x00d5, B:24:0x00dd, B:30:0x0101, B:33:0x0141, B:36:0x014e), top: B:19:0x00d1 }] */
    /* JADX WARN: Removed duplicated region for block: B:27:0x00ef A[Catch: ItemFoundInScroll -> 0x01b1, TRY_ENTER, TRY_LEAVE, TryCatch #5 {ItemFoundInScroll -> 0x01b1, blocks: (B:17:0x01a8, B:27:0x00ef), top: B:16:0x01a8 }] */
    ...
    /* JADX WARN: Type inference failed for: r8v17, types: [T, androidx.compose.animation.core.AnimationState] */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:45:0x01a3 -> B:16:0x01a8). Please report as a decompilation issue!!! */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    /*
