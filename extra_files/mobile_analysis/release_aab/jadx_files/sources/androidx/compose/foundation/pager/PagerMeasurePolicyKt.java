...
public final class PagerMeasurePolicyKt {
    ...
    public static final Function2<LazyLayoutMeasureScope, Constraints, MeasureResult> m700rememberPagerMeasurePolicyBxUkNYg(final Function0<PagerLazyLayoutItemProvider> itemProviderLambda, final PagerState state, final PaddingValues contentPadding, final boolean z, final Orientation orientation, final int i, final float f, final PageSize pageSize, final Alignment.Horizontal horizontal, final Alignment.Vertical vertical, final Function0<Integer> pageCount, Composer composer, int i2, int i3) {
        ...
        Object[] objArr = {contentPadding, Dp.m4876boximpl(f), pageSize, state, contentPadding, Boolean.valueOf(z), orientation, horizontal, vertical, pageCount};
        ...
        if (z2 || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = (Function2) new Function2<LazyLayoutMeasureScope, Constraints, PagerMeasureResult>() { // from class: androidx.compose.foundation.pager.PagerMeasurePolicyKt$rememberPagerMeasurePolicy$1$1
                ...
                public final PagerMeasureResult m701invoke0kLqBqw(final LazyLayoutMeasureScope lazyLayoutMeasureScope, final long j) {
                    int i5;
                    int i6;
                    int i7;
                    ...
                    CheckScrollableContainerConstraintsKt.m189checkScrollableContainerConstraintsK40F9xA(j, z3 ? Orientation.Vertical : Orientation.Horizontal);
                    if (z3) {
                        i5 = lazyLayoutMeasureScope.mo321roundToPx0680j_4(contentPadding.mo433calculateLeftPaddingu2uoSUM(lazyLayoutMeasureScope.getLayoutDirection()));
                    } else {
                        i5 = lazyLayoutMeasureScope.mo321roundToPx0680j_4(PaddingKt.calculateStartPadding(contentPadding, lazyLayoutMeasureScope.getLayoutDirection()));
                    }
                    if (z3) {
                        i6 = lazyLayoutMeasureScope.mo321roundToPx0680j_4(contentPadding.mo434calculateRightPaddingu2uoSUM(lazyLayoutMeasureScope.getLayoutDirection()));
                    } else {
                        i6 = lazyLayoutMeasureScope.mo321roundToPx0680j_4(PaddingKt.calculateEndPadding(contentPadding, lazyLayoutMeasureScope.getLayoutDirection()));
                    }
                    int i8 = lazyLayoutMeasureScope.mo321roundToPx0680j_4(contentPadding.getTop());
                    int i9 = lazyLayoutMeasureScope.mo321roundToPx0680j_4(contentPadding.getBottom());
                    final int i10 = i8 + i9;
                    final int i11 = i5 + i6;
                    int i12 = z3 ? i10 : i11;
                    if (z3 && !z) {
                    ...
                    int i13 = i12 - i7;
                    long m4850offsetNN6EwU = ConstraintsKt.m4850offsetNN6EwU(j, -i11, -i10);
                    LazyLayoutMeasureScope lazyLayoutMeasureScope2 = lazyLayoutMeasureScope;
                    state.setDensity$foundation_release(lazyLayoutMeasureScope2);
                    int i14 = lazyLayoutMeasureScope.mo321roundToPx0680j_4(f);
                    if (z3) {
                        m4834getMaxWidthimpl = Constraints.m4833getMaxHeightimpl(j) - i10;
                    } else {
                        m4834getMaxWidthimpl = Constraints.m4834getMaxWidthimpl(j) - i11;
                    }
                    if (!z || m4834getMaxWidthimpl > 0) {
                        IntOffset = IntOffsetKt.IntOffset(i5, i8);
                    } else {
                        if (!z3) {
                            i5 += m4834getMaxWidthimpl;
                        }
                        if (z3) {
                            i8 += m4834getMaxWidthimpl;
                        }
                        IntOffset = IntOffsetKt.IntOffset(i5, i8);
                    }
                    long j2 = IntOffset;
                    int calculateMainAxisPageSize = pageSize.calculateMainAxisPageSize(lazyLayoutMeasureScope2, m4834getMaxWidthimpl, i14);
                    state.m704setPremeasureConstraintsBRTryo0$foundation_release(ConstraintsKt.Constraints$default(0, Orientation.this == Orientation.Vertical ? Constraints.m4834getMaxWidthimpl(m4850offsetNN6EwU) : calculateMainAxisPageSize, 0, Orientation.this != Orientation.Vertical ? Constraints.m4833getMaxHeightimpl(m4850offsetNN6EwU) : calculateMainAxisPageSize, 5, null));
                    ...
                    try {
                        ...
                        try {
                            ...
                            PagerMeasureResult m699measurePagerntgEbfI = PagerMeasureKt.m699measurePagerntgEbfI(lazyLayoutMeasureScope, pageCount.invoke().intValue(), invoke, m4834getMaxWidthimpl, i7, i13, i14, firstVisiblePage$foundation_release, i15, state.getScrollToBeConsumed(), m4850offsetNN6EwU, Orientation.this, vertical, horizontal, z, j2, calculateMainAxisPageSize, i, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(invoke, state.getPinnedPages(), state.getBeyondBoundsInfo()), new Function3<Integer, Integer, Function1<? super Placeable.PlacementScope, ? extends Unit>, MeasureResult>() { // from class: androidx.compose.foundation.pager.PagerMeasurePolicyKt$rememberPagerMeasurePolicy$1$1.2
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                {
                                    super(3);
                                }
                                ...
                                public final MeasureResult invoke(int i16, int i17, Function1<? super Placeable.PlacementScope, Unit> placement) {
                                    ...
                                    return LazyLayoutMeasureScope.this.layout(ConstraintsKt.m4848constrainWidthK40F9xA(j, i16 + i11), ConstraintsKt.m4847constrainHeightK40F9xA(j, i17 + i10), MapsKt.emptyMap(), placement);
                                }
                            });
                            state.applyMeasureResult$foundation_release(m699measurePagerntgEbfI);
                            return m699measurePagerntgEbfI;
                        } finally {
