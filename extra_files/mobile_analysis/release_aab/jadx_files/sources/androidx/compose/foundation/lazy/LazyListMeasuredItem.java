...
public final class LazyListMeasuredItem implements LazyListItemInfo {
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        for (int i = 0; i < placeablesCount; i++) {
            ...
            long m592getOffsetBjo55l4 = m592getOffsetBjo55l4(i);
            ...
            if (lazyLayoutAnimateItemModifierNode != null) {
                ...
                long IntOffset = IntOffsetKt.IntOffset(IntOffset.m4996getXimpl(m592getOffsetBjo55l4) + IntOffset.m4996getXimpl(m627getPlacementDeltanOccac), IntOffset.m4997getYimpl(m592getOffsetBjo55l4) + IntOffset.m4997getYimpl(m627getPlacementDeltanOccac));
                if ((m591getMainAxisgyyYBs(m592getOffsetBjo55l4) <= mainAxisSize && m591getMainAxisgyyYBs(IntOffset) <= mainAxisSize) || (m591getMainAxisgyyYBs(m592getOffsetBjo55l4) >= i2 && m591getMainAxisgyyYBs(IntOffset) >= i2)) {
                    lazyLayoutAnimateItemModifierNode.cancelAnimation();
                }
                m592getOffsetBjo55l4 = IntOffset;
            }
            if (this.reverseLayout) {
                int m4996getXimpl = this.isVertical ? IntOffset.m4996getXimpl(m592getOffsetBjo55l4) : (this.mainAxisLayoutSize - IntOffset.m4996getXimpl(m592getOffsetBjo55l4)) - getMainAxisSize(placeable);
                if (this.isVertical) {
                    m4997getYimpl = (this.mainAxisLayoutSize - IntOffset.m4997getYimpl(m592getOffsetBjo55l4)) - getMainAxisSize(placeable);
                } else {
                    m4997getYimpl = IntOffset.m4997getYimpl(m592getOffsetBjo55l4);
                }
                m592getOffsetBjo55l4 = IntOffsetKt.IntOffset(m4996getXimpl, m4997getYimpl);
            }
            long j = this.visualOffset;
            long IntOffset2 = IntOffsetKt.IntOffset(IntOffset.m4996getXimpl(m592getOffsetBjo55l4) + IntOffset.m4996getXimpl(j), IntOffset.m4997getYimpl(m592getOffsetBjo55l4) + IntOffset.m4997getYimpl(j));
            if (this.isVertical) {
                Placeable.PlacementScope.m3928placeWithLayeraW9wM$default(scope, placeable, IntOffset2, 0.0f, null, 6, null);
            } else {
                Placeable.PlacementScope.m3927placeRelativeWithLayeraW9wM$default(scope, placeable, IntOffset2, 0.0f, null, 6, null);
            }
        }
    }

    /* renamed from: getMainAxis--gyyYBs, reason: not valid java name */
    private final int m591getMainAxisgyyYBs(long j) {
    ...
    private final long m590copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
