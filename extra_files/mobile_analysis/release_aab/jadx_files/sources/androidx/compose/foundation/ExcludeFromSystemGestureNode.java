...
final class ExcludeFromSystemGestureNode extends Modifier.Node implements GlobalPositionAwareModifierNode, CompositionLocalConsumerModifierNode {
    ...
    private final android.graphics.Rect calcBounds(LayoutCoordinates layoutCoordinates, Rect rect) {
        ...
        long mo3876localPositionOfR5De75A = findRoot.mo3876localPositionOfR5De75A(layoutCoordinates, rect.m2426getTopLeftF1C5BW0());
        long mo3876localPositionOfR5De75A2 = findRoot.mo3876localPositionOfR5De75A(layoutCoordinates, rect.m2427getTopRightF1C5BW0());
        long mo3876localPositionOfR5De75A3 = findRoot.mo3876localPositionOfR5De75A(layoutCoordinates, rect.m2419getBottomLeftF1C5BW0());
        long mo3876localPositionOfR5De75A4 = findRoot.mo3876localPositionOfR5De75A(layoutCoordinates, rect.m2420getBottomRightF1C5BW0());
        return new android.graphics.Rect(MathKt.roundToInt(ComparisonsKt.minOf(Offset.m2391getXimpl(mo3876localPositionOfR5De75A), Offset.m2391getXimpl(mo3876localPositionOfR5De75A2), Offset.m2391getXimpl(mo3876localPositionOfR5De75A3), Offset.m2391getXimpl(mo3876localPositionOfR5De75A4))), MathKt.roundToInt(ComparisonsKt.minOf(Offset.m2392getYimpl(mo3876localPositionOfR5De75A), Offset.m2392getYimpl(mo3876localPositionOfR5De75A2), Offset.m2392getYimpl(mo3876localPositionOfR5De75A3), Offset.m2392getYimpl(mo3876localPositionOfR5De75A4))), MathKt.roundToInt(ComparisonsKt.maxOf(Offset.m2391getXimpl(mo3876localPositionOfR5De75A), Offset.m2391getXimpl(mo3876localPositionOfR5De75A2), Offset.m2391getXimpl(mo3876localPositionOfR5De75A3), Offset.m2391getXimpl(mo3876localPositionOfR5De75A4))), MathKt.roundToInt(ComparisonsKt.maxOf(Offset.m2392getYimpl(mo3876localPositionOfR5De75A), Offset.m2392getYimpl(mo3876localPositionOfR5De75A2), Offset.m2392getYimpl(mo3876localPositionOfR5De75A3), Offset.m2392getYimpl(mo3876localPositionOfR5De75A4))));
    }
