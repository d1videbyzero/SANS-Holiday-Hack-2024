...
public final class PlatformMagnifierFactoryApi29Impl implements PlatformMagnifierFactory {
    ...
    public PlatformMagnifierImpl create(MagnifierStyle style, View view, Density density, float initialZoom) {
        ...
        long mo328toSizeXkaWNTQ = density.mo328toSizeXkaWNTQ(style.getSize());
        float mo327toPx0680j_4 = density.mo327toPx0680j_4(style.getCornerRadius());
        float mo327toPx0680j_42 = density.mo327toPx0680j_4(style.getElevation());
        Magnifier.Builder builder = new Magnifier.Builder(view);
        if (mo328toSizeXkaWNTQ != Size.INSTANCE.m2468getUnspecifiedNHjbRc()) {
            builder.setSize(MathKt.roundToInt(Size.m2460getWidthimpl(mo328toSizeXkaWNTQ)), MathKt.roundToInt(Size.m2457getHeightimpl(mo328toSizeXkaWNTQ)));
        }
    ...
    public static final class PlatformMagnifierImpl extends PlatformMagnifierFactoryApi28Impl.PlatformMagnifierImpl {
        ...
        public void mo244updateWko1d7g(long sourceCenter, long magnifierCenter, float zoom) {
            ...
            if (OffsetKt.m2410isSpecifiedk4lQ0M(magnifierCenter)) {
                getMagnifier().show(Offset.m2391getXimpl(sourceCenter), Offset.m2392getYimpl(sourceCenter), Offset.m2391getXimpl(magnifierCenter), Offset.m2392getYimpl(magnifierCenter));
            } else {
                getMagnifier().show(Offset.m2391getXimpl(sourceCenter), Offset.m2392getYimpl(sourceCenter));
            }
        }
    }
}
