...
final class WrapContentNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo239measure3p2s80s(final MeasureScope measure, Measurable measurable, long j) {
        ...
        final Placeable mo3868measureBRTryo0 = measurable.mo3868measureBRTryo0(ConstraintsKt.Constraints(this.direction != Direction.Vertical ? 0 : Constraints.m4836getMinWidthimpl(j), (this.direction == Direction.Vertical || !this.unbounded) ? Constraints.m4834getMaxWidthimpl(j) : Integer.MAX_VALUE, this.direction == Direction.Horizontal ? Constraints.m4835getMinHeightimpl(j) : 0, (this.direction == Direction.Horizontal || !this.unbounded) ? Constraints.m4833getMaxHeightimpl(j) : Integer.MAX_VALUE));
        final int coerceIn = RangesKt.coerceIn(mo3868measureBRTryo0.getWidth(), Constraints.m4836getMinWidthimpl(j), Constraints.m4834getMaxWidthimpl(j));
        final int coerceIn2 = RangesKt.coerceIn(mo3868measureBRTryo0.getHeight(), Constraints.m4835getMinHeightimpl(j), Constraints.m4833getMaxHeightimpl(j));
        return MeasureScope.layout$default(measure, coerceIn, coerceIn2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.WrapContentNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.m3925place70tqf50$default(layout, mo3868measureBRTryo0, WrapContentNode.this.getAlignmentCallback().invoke(IntSize.m5030boximpl(IntSizeKt.IntSize(coerceIn - mo3868measureBRTryo0.getWidth(), coerceIn2 - mo3868measureBRTryo0.getHeight())), measure.getLayoutDirection()).getPackedValue(), 0.0f, 2, null);
            }
        }, 4, null);
    }
}
