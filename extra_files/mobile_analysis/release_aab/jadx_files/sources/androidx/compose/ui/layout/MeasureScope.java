...
public interface MeasureScope extends IntrinsicMeasureScope {
    ...
    public static final class DefaultImpls {
        ...
        public static int m3905roundToPxR2X_6o(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo320roundToPxR2X_6o(j);
        }

        @Deprecated
        /* renamed from: roundToPx-0680j_4, reason: not valid java name */
        public static int m3906roundToPx0680j_4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo321roundToPx0680j_4(f);
        }

        @Deprecated
        /* renamed from: toDp-GaN1DYA, reason: not valid java name */
        public static float m3907toDpGaN1DYA(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo322toDpGaN1DYA(j);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM, reason: not valid java name */
        public static float m3908toDpu2uoSUM(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo323toDpu2uoSUM(f);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM, reason: not valid java name */
        public static float m3909toDpu2uoSUM(MeasureScope measureScope, int i) {
            return MeasureScope.super.mo324toDpu2uoSUM(i);
        }

        @Deprecated
        /* renamed from: toDpSize-k-rfVVM, reason: not valid java name */
        public static long m3910toDpSizekrfVVM(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo325toDpSizekrfVVM(j);
        }

        @Deprecated
        /* renamed from: toPx--R2X_6o, reason: not valid java name */
        public static float m3911toPxR2X_6o(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo326toPxR2X_6o(j);
        }

        @Deprecated
        /* renamed from: toPx-0680j_4, reason: not valid java name */
        public static float m3912toPx0680j_4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo327toPx0680j_4(f);
        }
        ...
        public static long m3913toSizeXkaWNTQ(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo328toSizeXkaWNTQ(j);
        }

        @Deprecated
        /* renamed from: toSp-0xMU5do, reason: not valid java name */
        public static long m3914toSp0xMU5do(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo329toSp0xMU5do(f);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4, reason: not valid java name */
        public static long m3915toSpkPz2Gy4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo330toSpkPz2Gy4(f);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4, reason: not valid java name */
        public static long m3916toSpkPz2Gy4(MeasureScope measureScope, int i) {
            return MeasureScope.super.mo331toSpkPz2Gy4(i);
        }
