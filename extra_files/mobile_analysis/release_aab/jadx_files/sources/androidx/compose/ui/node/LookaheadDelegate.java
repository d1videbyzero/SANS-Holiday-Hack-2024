...
public abstract class LookaheadDelegate extends LookaheadCapablePlaceable implements Measurable {
    ...
    public void m4035setPositiongyyYBs(long j) {
        this.position = j;
    }
    ...
    public final void set_measureResult(MeasureResult measureResult) {
        ...
        if (measureResult != null) {
            m3923setMeasuredSizeozmzZPI(IntSizeKt.IntSize(measureResult.getWidth(), measureResult.getHeight()));
            unit = Unit.INSTANCE;
        } else {
            unit = null;
        }
        if (unit == null) {
            m3923setMeasuredSizeozmzZPI(IntSize.INSTANCE.m5043getZeroYbymL2g());
        }
    ...
    public void replace$ui_release() {
        mo3869placeAtf8xVGno(getPosition(), 0.0f, null);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // androidx.compose.ui.layout.Placeable
    /* renamed from: placeAt-f8xVGno */
    public final void mo3869placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        if (!IntOffset.m4995equalsimpl0(getPosition(), position)) {
            m4035setPositiongyyYBs(position);
    ...
    public final Placeable m4033performingMeasureK40F9xA(long constraints, Function0<? extends MeasureResult> block) {
    ...
    public final long m4034positionInBjo55l4$ui_release(LookaheadDelegate ancestor) {
        Intrinsics.checkNotNullParameter(ancestor, "ancestor");
        long m5006getZeronOccac = IntOffset.INSTANCE.m5006getZeronOccac();
        LookaheadDelegate lookaheadDelegate = this;
        while (!Intrinsics.areEqual(lookaheadDelegate, ancestor)) {
            long position = lookaheadDelegate.getPosition();
            m5006getZeronOccac = IntOffsetKt.IntOffset(IntOffset.m4996getXimpl(m5006getZeronOccac) + IntOffset.m4996getXimpl(position), IntOffset.m4997getYimpl(m5006getZeronOccac) + IntOffset.m4997getYimpl(position));
