...
public final class DecodeHelper {
        ...
        while (this.parcel.dataAvail() > 1) {
            ...
            if (decodeByte != 1) {
                ...
                if (decodeByte == 2) {
                    ...
                    mutableSpanStyle.m4213setFontSizeR2X_6o(m4185decodeTextUnitXSAIIZE());
                    ...
                    mutableSpanStyle.m4214setFontStylemLjRB2g(FontStyle.m4500boximpl(m4183decodeFontStyle_LCdwA()));
                    mutableSpanStyle2 = mutableSpanStyle;
                            ...
                            if (decodeByte != 8) {
                                if (decodeByte != 9) {
                                    if (decodeByte != 10) {
                                        ...
                                        mutableSpanStyle.m4210setBackground8_81llA(m4182decodeColor0d7_KjU());
                                    }
                                } else {
                                    if (dataAvailable() < 8) {
                                        break;
                                ...
                                mutableSpanStyle.m4211setBaselineShift_isdbwI(BaselineShift.m4665boximpl(m4180decodeBaselineShifty9eOQZs()));
                            }
                        } else {
                            if (dataAvailable() < 5) {
                                break;
                            }
                            mutableSpanStyle.m4216setLetterSpacingR2X_6o(m4185decodeTextUnitXSAIIZE());
                        }
                    } else {
                    ...
                    mutableSpanStyle.m4215setFontSynthesistDdu0R4(FontSynthesis.m4509boximpl(m4184decodeFontSynthesisGVVA2EU()));
                    mutableSpanStyle2 = mutableSpanStyle;
                }
            } else {
                if (dataAvailable() < 8) {
                ...
                mutableSpanStyle2.m4212setColor8_81llA(m4182decodeColor0d7_KjU());
            }
        }
        mutableSpanStyle = mutableSpanStyle2;
    ...
    public final long m4182decodeColor0d7_KjU() {
        return Color.m2626constructorimpl(m4181decodeULongsVKNKU());
    }

    /* renamed from: decodeTextUnit-XSAIIZE, reason: not valid java name */
    public final long m4185decodeTextUnitXSAIIZE() {
        long m5093getUnspecifiedUIouoOA;
        byte decodeByte = decodeByte();
        if (decodeByte == 1) {
            m5093getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m5092getSpUIouoOA();
        } else if (decodeByte == 2) {
            m5093getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m5091getEmUIouoOA();
        } else {
            m5093getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m5093getUnspecifiedUIouoOA();
        }
        if (TextUnitType.m5087equalsimpl0(m5093getUnspecifiedUIouoOA, TextUnitType.INSTANCE.m5093getUnspecifiedUIouoOA())) {
            return TextUnit.INSTANCE.m5070getUnspecifiedXSAIIZE();
        }
        return TextUnitKt.m5071TextUnitanM5pPY(decodeFloat(), m5093getUnspecifiedUIouoOA);
    }
    ...
    public final int m4183decodeFontStyle_LCdwA() {
        byte decodeByte = decodeByte();
        if (decodeByte == 0) {
            return FontStyle.INSTANCE.m4508getNormal_LCdwA();
        }
        if (decodeByte == 1) {
            return FontStyle.INSTANCE.m4507getItalic_LCdwA();
        }
        return FontStyle.INSTANCE.m4508getNormal_LCdwA();
    }

    /* renamed from: decodeFontSynthesis-GVVA2EU, reason: not valid java name */
    public final int m4184decodeFontSynthesisGVVA2EU() {
        byte decodeByte = decodeByte();
        if (decodeByte == 0) {
            return FontSynthesis.INSTANCE.m4519getNoneGVVA2EU();
        }
        if (decodeByte == 1) {
            return FontSynthesis.INSTANCE.m4518getAllGVVA2EU();
        }
        if (decodeByte == 3) {
            return FontSynthesis.INSTANCE.m4520getStyleGVVA2EU();
        }
        if (decodeByte == 2) {
            return FontSynthesis.INSTANCE.m4521getWeightGVVA2EU();
        }
        return FontSynthesis.INSTANCE.m4519getNoneGVVA2EU();
    }

    /* renamed from: decodeBaselineShift-y9eOQZs, reason: not valid java name */
    private final float m4180decodeBaselineShifty9eOQZs() {
        return BaselineShift.m4666constructorimpl(decodeFloat());
    }
    ...
    private final Shadow decodeShadow() {
        return new Shadow(m4182decodeColor0d7_KjU(), OffsetKt.Offset(decodeFloat(), decodeFloat()), decodeFloat(), null);
    }
    ...
    private final long m4181decodeULongsVKNKU() {
        return ULong.m5340constructorimpl(this.parcel.readLong());
    }
