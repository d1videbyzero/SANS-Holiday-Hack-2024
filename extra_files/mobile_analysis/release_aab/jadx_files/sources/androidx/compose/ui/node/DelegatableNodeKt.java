...
public final class DelegatableNodeKt {
    ...
    public static /* synthetic */ void m3983visitAncestorsYYKmho$default(DelegatableNode visitAncestors, int i, boolean z, Function1 block, int i2, Object obj) {
        NodeChain nodes;
        if ((i2 & 2) != 0) {
            z = false;
        }
    ...
    public static final /* synthetic */ <T> void m3987visitSelfAndAncestors5BbP62I(DelegatableNode visitSelfAndAncestors, int i, int i2, Function1<? super T, Unit> block) {
        NodeChain nodes;
    ...
    public static final /* synthetic */ <T> void m3988visitSelfAndChildren6rFNWt0(DelegatableNode visitSelfAndChildren, int i, Function1<? super T, Unit> block) {
    ...
    public static final boolean m3979has64DMado(DelegatableNode has, int i) {
    ...
    public static final NodeCoordinator m3981requireCoordinator64DMado(DelegatableNode requireCoordinator, int i) {
        Intrinsics.checkNotNullParameter(requireCoordinator, "$this$requireCoordinator");
        NodeCoordinator coordinator = requireCoordinator.getNode().getCoordinator();
        Intrinsics.checkNotNull(coordinator);
        if (coordinator.getTail() != requireCoordinator || !NodeKindKt.m4091getIncludeSelfInTraversalH91voCI(i)) {
            return coordinator;
        }
    ...
    public static final /* synthetic */ <T> void m3978dispatchForKind6rFNWt0(Modifier.Node dispatchForKind, int i, Function1<? super T, Unit> block) {
    ...
    public static final /* synthetic */ <T> void m3986visitLocalDescendants6rFNWt0(DelegatableNode visitLocalDescendants, int i, Function1<? super T, Unit> block) {
    ...
    public static final /* synthetic */ <T> void m3985visitLocalAncestors6rFNWt0(DelegatableNode visitLocalAncestors, int i, Function1<? super T, Unit> block) {
    ...
    public static final /* synthetic */ <T> void m3982visitAncestorsYYKmho(DelegatableNode visitAncestors, int i, boolean z, Function1<? super T, Unit> block) {
        NodeChain nodes;
        Intrinsics.checkNotNullParameter(visitAncestors, "$this$visitAncestors");
        Intrinsics.checkNotNullParameter(block, "block");
        if (!visitAncestors.getNode().getIsAttached()) {
    ...
    public static final /* synthetic */ <T> List<T> m3977ancestors64DMado(DelegatableNode ancestors, int i) {
        NodeChain nodes;
    ...
    public static final /* synthetic */ <T> T m3980nearestAncestor64DMado(DelegatableNode nearestAncestor, int i) {
        NodeChain nodes;
    ...
    public static final /* synthetic */ <T> void m3989visitSubtree6rFNWt0(DelegatableNode visitSubtree, int i, Function1<? super T, Unit> block) {
    ...
    public static final /* synthetic */ <T> void m3984visitChildren6rFNWt0(DelegatableNode visitChildren, int i, Function1<? super T, Unit> block) {
    ...
    public static final /* synthetic */ <T> void m3990visitSubtreeIf6rFNWt0(DelegatableNode visitSubtreeIf, int i, Function1<? super T, Boolean> block) {
    ...
    public static final LayoutModifierNode asLayoutModifierNode(Modifier.Node node) {
        ...
        if ((NodeKind.m4082constructorimpl(2) & node.getKindSet()) != 0) {
            ...
            if (node instanceof DelegatingNode) {
                ...
                while (delegate != 0) {
                    ...
                    if ((delegate instanceof DelegatingNode) && (NodeKind.m4082constructorimpl(2) & delegate.getKindSet()) != 0) {
