...
public final class TextStyleKt {
    ...
    public static final int m4440resolveTextDirectionYj3eThk(LayoutDirection layoutDirection, TextDirection textDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        int m4785getContents_7Xco = TextDirection.INSTANCE.m4785getContents_7Xco();
        if (textDirection != null && TextDirection.m4781equalsimpl0(textDirection.getValue(), m4785getContents_7Xco)) {
            int i = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i == 1) {
                return TextDirection.INSTANCE.m4786getContentOrLtrs_7Xco();
            }
            if (i == 2) {
                return TextDirection.INSTANCE.m4787getContentOrRtls_7Xco();
            }
        ...
        if (textDirection == null) {
            ...
            if (i2 == 1) {
                return TextDirection.INSTANCE.m4788getLtrs_7Xco();
            }
            if (i2 == 2) {
                return TextDirection.INSTANCE.m4789getRtls_7Xco();
            }
            throw new NoWhenBranchMatchedException();
        }
