...
public final class AndroidCanvas implements Canvas {
    ...
    public void mo2487concat58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        if (MatrixKt.m2880isIdentity58bKbWc(matrix)) {
            return;
        }
        android.graphics.Matrix matrix2 = new android.graphics.Matrix();
        AndroidMatrixConversions_androidKt.m2502setFromEL8BTi8(matrix2, matrix);
        this.internalCanvas.concat(matrix2);
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: clipRect-N_I0leg, reason: not valid java name */
    public void mo2486clipRectN_I0leg(float left, float top, float right, float bottom, int clipOp) {
        this.internalCanvas.clipRect(left, top, right, bottom, m2495toRegionOp7u2Bmg(clipOp));
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: clipPath-mtrdD-E, reason: not valid java name */
    public void mo2485clipPathmtrdDE(Path path, int clipOp) {
        Intrinsics.checkNotNullParameter(path, "path");
        android.graphics.Canvas canvas = this.internalCanvas;
        if (path instanceof AndroidPath) {
            canvas.clipPath(((AndroidPath) path).getInternalPath(), m2495toRegionOp7u2Bmg(clipOp));
            return;
        }
    ...
    public final Region.Op m2495toRegionOp7u2Bmg(int i) {
        return ClipOp.m2614equalsimpl0(i, ClipOp.INSTANCE.m2618getDifferencertfAjoo()) ? Region.Op.DIFFERENCE : Region.Op.INTERSECT;
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: drawLine-Wko1d7g, reason: not valid java name */
    public void mo2491drawLineWko1d7g(long p1, long p2, Paint paint) {
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawLine(Offset.m2391getXimpl(p1), Offset.m2392getYimpl(p1), Offset.m2391getXimpl(p2), Offset.m2392getYimpl(p2), paint.getInternalPaint());
    }
    ...
    public void mo2488drawCircle9KIMszo(long center, float radius, Paint paint) {
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawCircle(Offset.m2391getXimpl(center), Offset.m2392getYimpl(center), radius, paint.getInternalPaint());
    }
    ...
    public void mo2489drawImaged4ec7I(ImageBitmap image, long topLeftOffset, Paint paint) {
        Intrinsics.checkNotNullParameter(image, "image");
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawBitmap(AndroidImageBitmap_androidKt.asAndroidBitmap(image), Offset.m2391getXimpl(topLeftOffset), Offset.m2392getYimpl(topLeftOffset), paint.getInternalPaint());
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: drawImageRect-HPBpro0, reason: not valid java name */
    public void mo2490drawImageRectHPBpro0(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, Paint paint) {
        Intrinsics.checkNotNullParameter(image, "image");
        Intrinsics.checkNotNullParameter(paint, "paint");
        android.graphics.Canvas canvas = this.internalCanvas;
        Bitmap asAndroidBitmap = AndroidImageBitmap_androidKt.asAndroidBitmap(image);
        Rect rect = this.srcRect;
        rect.left = IntOffset.m4996getXimpl(srcOffset);
        rect.top = IntOffset.m4997getYimpl(srcOffset);
        rect.right = IntOffset.m4996getXimpl(srcOffset) + IntSize.m5038getWidthimpl(srcSize);
        rect.bottom = IntOffset.m4997getYimpl(srcOffset) + IntSize.m5037getHeightimpl(srcSize);
        Unit unit = Unit.INSTANCE;
        Rect rect2 = this.dstRect;
        rect2.left = IntOffset.m4996getXimpl(dstOffset);
        rect2.top = IntOffset.m4997getYimpl(dstOffset);
        rect2.right = IntOffset.m4996getXimpl(dstOffset) + IntSize.m5038getWidthimpl(dstSize);
        rect2.bottom = IntOffset.m4997getYimpl(dstOffset) + IntSize.m5037getHeightimpl(dstSize);
    ...
    public void mo2492drawPointsO7TthRY(int pointMode, List<Offset> points, Paint paint) {
        Intrinsics.checkNotNullParameter(points, "points");
        Intrinsics.checkNotNullParameter(paint, "paint");
        if (PointMode.m2925equalsimpl0(pointMode, PointMode.INSTANCE.m2929getLinesr_lszbg())) {
            drawLines(points, paint, 2);
        } else if (PointMode.m2925equalsimpl0(pointMode, PointMode.INSTANCE.m2931getPolygonr_lszbg())) {
            drawLines(points, paint, 1);
        } else if (PointMode.m2925equalsimpl0(pointMode, PointMode.INSTANCE.m2930getPointsr_lszbg())) {
    ...
    private final void drawLines(List<Offset> points, Paint paint, int stepBy) {
        if (points.size() >= 2) {
            ...
            while (i < points.size() - 1) {
                ...
                this.internalCanvas.drawLine(Offset.m2391getXimpl(packedValue), Offset.m2392getYimpl(packedValue), Offset.m2391getXimpl(packedValue2), Offset.m2392getYimpl(packedValue2), internalPaint);
                i += stepBy;
            }
        }
    }
    ...
    public void mo2493drawRawPointsO7TthRY(int pointMode, float[] points, Paint paint) {
        Intrinsics.checkNotNullParameter(points, "points");
        Intrinsics.checkNotNullParameter(paint, "paint");
    ...
    public void mo2494drawVerticesTPEHhCM(Vertices vertices, int blendMode, Paint paint) {
        Intrinsics.checkNotNullParameter(vertices, "vertices");
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawVertices(AndroidVertexMode_androidKt.m2538toAndroidVertexModeJOOmi9M(vertices.getVertexMode()), vertices.getPositions().length, vertices.getPositions(), 0, vertices.getTextureCoordinates(), 0, vertices.getColors(), 0, vertices.getIndices(), 0, vertices.getIndices().length, paint.getInternalPaint());
    }
    ...
    private final void drawPoints(List<Offset> points, Paint paint) {
        ...
        for (int i = 0; i < size; i++) {
            long packedValue = points.get(i).getPackedValue();
            this.internalCanvas.drawPoint(Offset.m2391getXimpl(packedValue), Offset.m2392getYimpl(packedValue), paint.getInternalPaint());
        }
    }
}
