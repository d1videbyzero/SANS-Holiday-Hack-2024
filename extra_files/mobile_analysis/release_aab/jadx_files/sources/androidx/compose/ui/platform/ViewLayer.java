...
public final class ViewLayer extends View implements OwnedLayer, GraphicLayerInfo {
    ...
    public ViewLayer(AndroidComposeView ownerView, DrawChildContainer container, Function1<? super Canvas, Unit> drawBlock, Function0<Unit> invalidateParentLayer) {
        ...
        this.mTransformOrigin = TransformOrigin.INSTANCE.m3015getCenterSzJe1aQ();
    ...
    public void mo4133updateLayerPropertiesdDxrwY(float scaleX, float scaleY, float alpha, float translationX, float translationY, float shadowElevation, float rotationX, float rotationY, float rotationZ, float cameraDistance, long transformOrigin, Shape shape, boolean clip, RenderEffect renderEffect, long ambientShadowColor, long spotShadowColor, int compositingStrategy, LayoutDirection layoutDirection, Density density) {
        ...
        setPivotX(TransformOrigin.m3010getPivotFractionXimpl(this.mTransformOrigin) * getWidth());
        setPivotY(TransformOrigin.m3011getPivotFractionYimpl(this.mTransformOrigin) * getHeight());
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            ViewLayerVerificationHelper28.INSTANCE.setOutlineAmbientShadowColor(viewLayer, ColorKt.m2684toArgb8_81llA(ambientShadowColor));
            ViewLayerVerificationHelper28.INSTANCE.setOutlineSpotShadowColor(viewLayer, ColorKt.m2684toArgb8_81llA(spotShadowColor));
        }
        if (Build.VERSION.SDK_INT >= 31) {
            ViewLayerVerificationHelper31.INSTANCE.setRenderEffect(this, renderEffect);
        }
        if (CompositingStrategy.m2712equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m2718getOffscreenNrFUSI())) {
            setLayerType(2, null);
        } else if (CompositingStrategy.m2712equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m2717getModulateAlphaNrFUSI())) {
            setLayerType(0, null);
            z = false;
        } else {
            setLayerType(0, null);
    ...
    public boolean mo4128isInLayerk4lQ0M(long position) {
        ...
        if (this.clipToBounds) {
            return 0.0f <= m2391getXimpl && m2391getXimpl < ((float) getWidth()) && 0.0f <= m2392getYimpl && m2392getYimpl < ((float) getHeight());
        }
        if (getClipToOutline()) {
    ...
    public void mo4131resizeozmzZPI(long size) {
        ...
        if (m5038getWidthimpl == getWidth() && m5037getHeightimpl == getHeight()) {
            return;
        }
        float f = m5038getWidthimpl;
        setPivotX(TransformOrigin.m3010getPivotFractionXimpl(this.mTransformOrigin) * f);
        float f2 = m5037getHeightimpl;
        setPivotY(TransformOrigin.m3011getPivotFractionYimpl(this.mTransformOrigin) * f2);
        this.outlineResolver.m4225updateuvyYCjk(SizeKt.Size(f, f2));
        updateOutlineResolver();
        layout(getLeft(), getTop(), getLeft() + m5038getWidthimpl, getTop() + m5037getHeightimpl);
        resetClipBounds();
        this.matrixCache.invalidate();
    }
    ...
    public void mo4130movegyyYBs(long position) {
        ...
        if (m4996getXimpl != getLeft()) {
            offsetLeftAndRight(m4996getXimpl - getLeft());
            this.matrixCache.invalidate();
        }
        int m4997getYimpl = IntOffset.m4997getYimpl(position);
        if (m4997getYimpl != getTop()) {
            offsetTopAndBottom(m4997getYimpl - getTop());
            this.matrixCache.invalidate();
        }
    }
    ...
    public long mo4129mapOffset8S9VItk(long point, boolean inverse) {
        if (inverse) {
            float[] m4201calculateInverseMatrixbWbORWo = this.matrixCache.m4201calculateInverseMatrixbWbORWo(this);
        ...
        return androidx.compose.ui.graphics.Matrix.m2862mapMKHz9U(this.matrixCache.m4202calculateMatrixGrdbGEg(this), point);
    }
    ...
    public void mapBounds(MutableRect rect, boolean inverse) {
        ...
        androidx.compose.ui.graphics.Matrix.m2864mapimpl(this.matrixCache.m4202calculateMatrixGrdbGEg(this), rect);
    }
    ...
    public void mo4132transform58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        androidx.compose.ui.graphics.Matrix.m2873timesAssign58bKbWc(matrix, this.matrixCache.m4202calculateMatrixGrdbGEg(this));
    }
