...
public final class DrawStyleSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public void updateDrawState(TextPaint textPaint) {
        if (textPaint != null) {
            ...
            if (drawStyle instanceof Stroke) {
                ...
                textPaint.setStrokeJoin(m4662toAndroidJoinWw9F2mQ(((Stroke) this.drawStyle).getJoin()));
                textPaint.setStrokeCap(m4661toAndroidCapBeK7IIE(((Stroke) this.drawStyle).getCap()));
    ...
    private final Paint.Join m4662toAndroidJoinWw9F2mQ(int i) {
        return StrokeJoin.m2983equalsimpl0(i, StrokeJoin.INSTANCE.m2988getMiterLxFBmk8()) ? Paint.Join.MITER : StrokeJoin.m2983equalsimpl0(i, StrokeJoin.INSTANCE.m2989getRoundLxFBmk8()) ? Paint.Join.ROUND : StrokeJoin.m2983equalsimpl0(i, StrokeJoin.INSTANCE.m2987getBevelLxFBmk8()) ? Paint.Join.BEVEL : Paint.Join.MITER;
    }

    /* renamed from: toAndroidCap-BeK7IIE, reason: not valid java name */
    private final Paint.Cap m4661toAndroidCapBeK7IIE(int i) {
        return StrokeCap.m2973equalsimpl0(i, StrokeCap.INSTANCE.m2977getButtKaPHkGw()) ? Paint.Cap.BUTT : StrokeCap.m2973equalsimpl0(i, StrokeCap.INSTANCE.m2978getRoundKaPHkGw()) ? Paint.Cap.ROUND : StrokeCap.m2973equalsimpl0(i, StrokeCap.INSTANCE.m2979getSquareKaPHkGw()) ? Paint.Cap.SQUARE : Paint.Cap.BUTT;
    }
}
