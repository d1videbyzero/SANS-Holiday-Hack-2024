...
public final class AndroidParagraph implements Paragraph {
    ...
    private AndroidParagraph(AndroidParagraphIntrinsics paragraphIntrinsics, int i, boolean z, long j) {
        ...
        int m4278toLayoutAlignAMY3VfE;
        int m4280toLayoutHyphenationFrequency0_XeFpE;
        int m4279toLayoutBreakStrategyu6PBz3U;
        int m4281toLayoutLineBreakStyle4a2g8L8;
        int m4282toLayoutLineBreakWordStylegvcdTPQ;
        ArrayList arrayList;
        Rect rect;
        ...
        this.ellipsis = z;
        this.constraints = j;
        if (Constraints.m4835getMinHeightimpl(j) != 0 || Constraints.m4836getMinWidthimpl(j) != 0) {
        ...
        m4278toLayoutAlignAMY3VfE = AndroidParagraph_androidKt.m4278toLayoutAlignAMY3VfE(style.m4437getTextAlignbuA522U());
        TextAlign m4437getTextAlignbuA522U = style.m4437getTextAlignbuA522U();
        int i2 = m4437getTextAlignbuA522U == null ? 0 : TextAlign.m4768equalsimpl0(m4437getTextAlignbuA522U.getValue(), TextAlign.INSTANCE.m4774getJustifye0LSkKk()) ? 1 : 0;
        m4280toLayoutHyphenationFrequency0_XeFpE = AndroidParagraph_androidKt.m4280toLayoutHyphenationFrequency0_XeFpE(style.getParagraphStyle().getHyphens());
        LineBreak m4435getLineBreakLgCVezo = style.m4435getLineBreakLgCVezo();
        m4279toLayoutBreakStrategyu6PBz3U = AndroidParagraph_androidKt.m4279toLayoutBreakStrategyu6PBz3U(m4435getLineBreakLgCVezo != null ? LineBreak.Strategy.m4709boximpl(LineBreak.m4700getStrategyfcGXIks(m4435getLineBreakLgCVezo.getMask())) : null);
        LineBreak m4435getLineBreakLgCVezo2 = style.m4435getLineBreakLgCVezo();
        m4281toLayoutLineBreakStyle4a2g8L8 = AndroidParagraph_androidKt.m4281toLayoutLineBreakStyle4a2g8L8(m4435getLineBreakLgCVezo2 != null ? LineBreak.Strictness.m4719boximpl(LineBreak.m4701getStrictnessusljTpc(m4435getLineBreakLgCVezo2.getMask())) : null);
        LineBreak m4435getLineBreakLgCVezo3 = style.m4435getLineBreakLgCVezo();
        m4282toLayoutLineBreakWordStylegvcdTPQ = AndroidParagraph_androidKt.m4282toLayoutLineBreakWordStylegvcdTPQ(m4435getLineBreakLgCVezo3 != null ? LineBreak.WordBreak.m4730boximpl(LineBreak.m4702getWordBreakjp8hJ3c(m4435getLineBreakLgCVezo3.getMask())) : null);
        TextUtils.TruncateAt truncateAt = z ? TextUtils.TruncateAt.END : null;
        TextLayout constructTextLayout = constructTextLayout(m4278toLayoutAlignAMY3VfE, i2, truncateAt, i, m4280toLayoutHyphenationFrequency0_XeFpE, m4279toLayoutBreakStrategyu6PBz3U, m4281toLayoutLineBreakStyle4a2g8L8, m4282toLayoutLineBreakWordStylegvcdTPQ);
        if (z && constructTextLayout.getHeight() > Constraints.m4833getMaxHeightimpl(j) && i > 1) {
            numberOfLinesThatFitMaxHeight = AndroidParagraph_androidKt.numberOfLinesThatFitMaxHeight(constructTextLayout, Constraints.m4833getMaxHeightimpl(j));
            if (numberOfLinesThatFitMaxHeight >= 0 && numberOfLinesThatFitMaxHeight != i) {
                constructTextLayout = constructTextLayout(m4278toLayoutAlignAMY3VfE, i2, truncateAt, RangesKt.coerceAtLeast(numberOfLinesThatFitMaxHeight, 1), m4280toLayoutHyphenationFrequency0_XeFpE, m4279toLayoutBreakStrategyu6PBz3U, m4281toLayoutLineBreakStyle4a2g8L8, m4282toLayoutLineBreakWordStylegvcdTPQ);
            }
            this.layout = constructTextLayout;
        } else {
            this.layout = constructTextLayout;
        }
        getTextPaint$ui_text_release().m4645setBrush12SF9DM(style.getBrush(), SizeKt.Size(getWidth(), getHeight()), style.getAlpha());
        for (ShaderBrushSpan shaderBrushSpan : getShaderBrushSpans(this.layout)) {
            shaderBrushSpan.m4664setSizeuvyYCjk(SizeKt.Size(getWidth(), getHeight()));
        }
    ...
    public float getWidth() {
        return Constraints.m4834getMaxWidthimpl(this.constraints);
    }
    ...
    public int mo4268getOffsetForPositionk4lQ0M(long position) {
        return this.layout.getOffsetForHorizontal(this.layout.getLineForVertical((int) Offset.m2392getYimpl(position)), Offset.m2391getXimpl(position));
    }
    ...
    public final void m4266fillBoundingBoxes8ffj60Q(long range, float[] array, int arrayStart) {
        Intrinsics.checkNotNullParameter(array, "array");
        this.layout.fillBoundingBoxes(TextRange.m4406getMinimpl(range), TextRange.m4405getMaximpl(range), array, arrayStart);
    }
    ...
    public long mo4269getWordBoundaryjx7JFs(int offset) {
    ...
    public void mo4271paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m4646setColor8_81llA(color);
    ...
    public void mo4270paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        int m4643getBlendMode0nO6VwU = getTextPaint$ui_text_release().m4643getBlendMode0nO6VwU();
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m4646setColor8_81llA(color);
        textPaint$ui_text_release.setShadow(shadow);
        textPaint$ui_text_release.setTextDecoration(textDecoration);
        textPaint$ui_text_release.setDrawStyle(drawStyle);
        textPaint$ui_text_release.m4644setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text_release().m4644setBlendModes9anfk8(m4643getBlendMode0nO6VwU);
    }

    @Override // androidx.compose.ui.text.Paragraph
    /* renamed from: paint-hn5TExg, reason: not valid java name */
    public void mo4272painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        Intrinsics.checkNotNullParameter(brush, "brush");
        int m4643getBlendMode0nO6VwU = getTextPaint$ui_text_release().m4643getBlendMode0nO6VwU();
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m4645setBrush12SF9DM(brush, SizeKt.Size(getWidth(), getHeight()), alpha);
        textPaint$ui_text_release.setShadow(shadow);
        textPaint$ui_text_release.setTextDecoration(textDecoration);
        textPaint$ui_text_release.setDrawStyle(drawStyle);
        textPaint$ui_text_release.m4644setBlendModes9anfk8(blendMode);
