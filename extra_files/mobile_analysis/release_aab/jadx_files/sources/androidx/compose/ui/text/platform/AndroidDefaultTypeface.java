...
public final class AndroidDefaultTypeface implements AndroidTypeface {
    ...
    public Typeface mo4631getNativeTypefacePYhJU0U(FontWeight fontWeight, int fontStyle, int synthesis) {
        ...
        if (Build.VERSION.SDK_INT < 28) {
            Typeface defaultFromStyle = Typeface.defaultFromStyle(AndroidFontUtils_androidKt.m4457getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle));
        ...
        return typefaceHelperMethodsApi28.create(DEFAULT, fontWeight.getWeight(), FontStyle.m4503equalsimpl0(fontStyle, FontStyle.INSTANCE.m4507getItalic_LCdwA()));
    }
}
