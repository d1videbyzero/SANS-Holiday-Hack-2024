...
public final class AndroidFontLoader implements PlatformFontLoader {
    ...
    public android.graphics.Typeface loadBlocking(Font font) {
        ...
        } else if (FontLoadingStrategy.m4490equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m4496getOptionalLocalPKNRLFQ())) {
            try {
                ...
                m5166constructorimpl = Result.m5166constructorimpl(load);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                m5166constructorimpl = Result.m5166constructorimpl(ResultKt.createFailure(th));
            }
            typeface = (android.graphics.Typeface) (Result.m5172isFailureimpl(m5166constructorimpl) ? null : m5166constructorimpl);
        } else {
            if (FontLoadingStrategy.m4490equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m4494getAsyncPKNRLFQ())) {
                throw new UnsupportedOperationException("Unsupported Async font load path");
            }
            throw new IllegalArgumentException("Unknown loading type " + ((Object) FontLoadingStrategy.m4492toStringimpl(font.getLoadingStrategy())));
        }
