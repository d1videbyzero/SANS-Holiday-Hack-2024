...
public final class Hyphens {
    ...
    private static final int None = m4685constructorimpl(1);
    private static final int Auto = m4685constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ Hyphens m4684boximpl(int i) {
        return new Hyphens(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m4685constructorimpl(int i) {
        return i;
    }
    ...
    public boolean equals(Object obj) {
        return m4686equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m4688hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m4692getNonevmbZdU8() {
            return Hyphens.None;
        }

        /* renamed from: getAuto-vmbZdU8, reason: not valid java name */
        public final int m4691getAutovmbZdU8() {
            return Hyphens.Auto;
        }
    }
    ...
    public String toString() {
        return m4689toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m4689toStringimpl(int i) {
        return m4687equalsimpl0(i, None) ? "Hyphens.None" : m4687equalsimpl0(i, Auto) ? "Hyphens.Auto" : "Invalid";
    }
}
