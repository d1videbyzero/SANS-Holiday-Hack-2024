...
public final class SweepGradient extends ShaderBrush {
    ...
    public Shader mo2599createShaderuvyYCjk(long size) {
        ...
        if (OffsetKt.m2412isUnspecifiedk4lQ0M(this.center)) {
            Offset = SizeKt.m2470getCenteruvyYCjk(size);
        } else {
            Offset = OffsetKt.Offset(Offset.m2391getXimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m2460getWidthimpl(size) : Offset.m2391getXimpl(this.center), Offset.m2392getYimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m2457getHeightimpl(size) : Offset.m2392getYimpl(this.center));
        }
        return ShaderKt.m2943SweepGradientShader9KIMszo(Offset, this.colors, this.stops);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Offset.m2388equalsimpl0(this.center, sweepGradient.center) && Intrinsics.areEqual(this.colors, sweepGradient.colors) && Intrinsics.areEqual(this.stops, sweepGradient.stops);
    }

    public int hashCode() {
        int m2393hashCodeimpl = ((Offset.m2393hashCodeimpl(this.center) * 31) + this.colors.hashCode()) * 31;
        List<Float> list = this.stops;
        return m2393hashCodeimpl + (list != null ? list.hashCode() : 0);
    }

    public String toString() {
        return "SweepGradient(" + (OffsetKt.m2410isSpecifiedk4lQ0M(this.center) ? "center=" + ((Object) Offset.m2399toStringimpl(this.center)) + ", " : "") + "colors=" + this.colors + ", stops=" + this.stops + ')';
    }
}
