...
public final class VerticalPaddings {
    ...
    public static final /* synthetic */ VerticalPaddings m4441boximpl(long j) {
        return new VerticalPaddings(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m4442constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4443equalsimpl(long j, Object obj) {
        return (obj instanceof VerticalPaddings) && j == ((VerticalPaddings) obj).getPackedValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4444equalsimpl0(long j, long j2) {
        return j == j2;
    }

    /* renamed from: getBottomPadding-impl, reason: not valid java name */
    public static final int m4445getBottomPaddingimpl(long j) {
        return (int) (j & 4294967295L);
    }

    /* renamed from: getTopPadding-impl, reason: not valid java name */
    public static final int m4446getTopPaddingimpl(long j) {
        return (int) (j >> 32);
    }
    ...
    public static String m4448toStringimpl(long j) {
        return "VerticalPaddings(packedValue=" + j + ')';
    }

    public boolean equals(Object obj) {
        return m4443equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m4447hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m4448toStringimpl(this.packedValue);
    }
