...
public final class TextDrawStyleKt {
    public static final TextForegroundStyle lerp(TextForegroundStyle start, TextForegroundStyle stop, float f) {
        ...
        if (!z && !(stop instanceof BrushStyle)) {
            return TextForegroundStyle.INSTANCE.m4791from8_81llA(ColorKt.m2681lerpjxsXWHM(start.mo4679getColor0d7_KjU(), stop.mo4679getColor0d7_KjU(), f));
        }
        if (z && (stop instanceof BrushStyle)) {
    ...
    public static final long m4790modulateDxMtmZc(long j, float f) {
        return (Float.isNaN(f) || f >= 1.0f) ? j : Color.m2629copywmQWz5c$default(j, Color.m2632getAlphaimpl(j) * f, 0.0f, 0.0f, 0.0f, 14, null);
    }
