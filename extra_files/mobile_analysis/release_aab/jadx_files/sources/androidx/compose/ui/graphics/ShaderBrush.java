...
public abstract class ShaderBrush extends Brush {
    ...
    public abstract Shader mo2599createShaderuvyYCjk(long size);

    public ShaderBrush() {
        super(null);
        this.createdSize = Size.INSTANCE.m2468getUnspecifiedNHjbRc();
    }

    @Override // androidx.compose.ui.graphics.Brush
    /* renamed from: applyTo-Pq9zytI */
    public final void mo2577applyToPq9zytI(long size, Paint p, float alpha) {
        Intrinsics.checkNotNullParameter(p, "p");
        Shader shader = this.internalShader;
        if (shader == null || !Size.m2456equalsimpl0(this.createdSize, size)) {
            if (Size.m2462isEmptyimpl(size)) {
                shader = null;
                this.internalShader = null;
                this.createdSize = Size.INSTANCE.m2468getUnspecifiedNHjbRc();
            } else {
                shader = mo2599createShaderuvyYCjk(size);
                this.internalShader = shader;
                this.createdSize = size;
            }
        }
        if (!Color.m2631equalsimpl0(p.mo2505getColor0d7_KjU(), Color.INSTANCE.m2656getBlack0d7_KjU())) {
            p.mo2511setColor8_81llA(Color.INSTANCE.m2656getBlack0d7_KjU());
        }
