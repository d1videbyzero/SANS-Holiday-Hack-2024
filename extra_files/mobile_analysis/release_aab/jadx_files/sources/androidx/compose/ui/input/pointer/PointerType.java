...
public final class PointerType {
    ...
    private static final int Unknown = m3819constructorimpl(0);
    private static final int Touch = m3819constructorimpl(1);
    private static final int Mouse = m3819constructorimpl(2);
    private static final int Stylus = m3819constructorimpl(3);
    private static final int Eraser = m3819constructorimpl(4);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PointerType m3818boximpl(int i) {
        return new PointerType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m3819constructorimpl(int i) {
        return i;
    }
