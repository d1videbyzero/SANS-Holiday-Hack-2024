...
public final class VertexMode {
    ...
    private static final int Triangles = m3017constructorimpl(0);
    private static final int TriangleStrip = m3017constructorimpl(1);
    private static final int TriangleFan = m3017constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ VertexMode m3016boximpl(int i) {
        return new VertexMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m3017constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3018equalsimpl(int i, Object obj) {
        return (obj instanceof VertexMode) && i == ((VertexMode) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3019equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m3020hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object obj) {
        return m3018equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m3020hashCodeimpl(this.value);
    }
    ...
    public static String m3021toStringimpl(int i) {
        return m3019equalsimpl0(i, Triangles) ? "Triangles" : m3019equalsimpl0(i, TriangleStrip) ? "TriangleStrip" : m3019equalsimpl0(i, TriangleFan) ? "TriangleFan" : "Unknown";
    }
}
