...
public final class CompositingStrategy {
    ...
    private static final int Auto = m2710constructorimpl(0);
    private static final int Offscreen = m2710constructorimpl(1);
    private static final int ModulateAlpha = m2710constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ CompositingStrategy m2709boximpl(int i) {
        return new CompositingStrategy(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m2710constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2711equalsimpl(int i, Object obj) {
        return (obj instanceof CompositingStrategy) && i == ((CompositingStrategy) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2712equalsimpl0(int i, int i2) {
        return i == i2;
    }
    ...
    public boolean equals(Object obj) {
        return m2711equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m2713hashCodeimpl(this.value);
    }

    public String toString() {
        return m2714toStringimpl(this.value);
    }
