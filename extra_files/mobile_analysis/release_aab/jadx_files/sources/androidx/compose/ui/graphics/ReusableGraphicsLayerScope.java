...
public final class ReusableGraphicsLayerScope implements GraphicsLayerScope {
    ...
    private long transformOrigin = TransformOrigin.INSTANCE.m3015getCenterSzJe1aQ();
    private Shape shape = RectangleShapeKt.getRectangleShape();
    private int compositingStrategy = CompositingStrategy.INSTANCE.m2716getAutoNrFUSI();
    private long size = Size.INSTANCE.m2468getUnspecifiedNHjbRc();
    ...
    public void mo2817setAmbientShadowColor8_81llA(long j) {
    ...
    public void mo2819setSpotShadowColor8_81llA(long j) {
    ...
    public void mo2820setTransformOrigin__ExYCQ(long j) {
    ...
    public void mo2818setCompositingStrategyaDBOjCE(int i) {
    ...
    public void m2936setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public final void reset() {
        ...
        mo2817setAmbientShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        mo2819setSpotShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        setRotationX(0.0f);
        setRotationY(0.0f);
        setRotationZ(0.0f);
        setCameraDistance(8.0f);
        mo2820setTransformOrigin__ExYCQ(TransformOrigin.INSTANCE.m3015getCenterSzJe1aQ());
        setShape(RectangleShapeKt.getRectangleShape());
        setClip(false);
        setRenderEffect(null);
        mo2818setCompositingStrategyaDBOjCE(CompositingStrategy.INSTANCE.m2716getAutoNrFUSI());
        m2936setSizeuvyYCjk(Size.INSTANCE.m2468getUnspecifiedNHjbRc());
    }
}
