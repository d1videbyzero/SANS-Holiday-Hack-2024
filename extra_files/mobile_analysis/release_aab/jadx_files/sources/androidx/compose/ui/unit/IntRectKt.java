...
public final class IntRectKt {
    ...
    public static final IntRect m5028IntRectVbeCjmY(long j, long j2) {
        return new IntRect(IntOffset.m4996getXimpl(j), IntOffset.m4997getYimpl(j), IntOffset.m4996getXimpl(j) + IntSize.m5038getWidthimpl(j2), IntOffset.m4997getYimpl(j) + IntSize.m5037getHeightimpl(j2));
    }

    /* renamed from: IntRect-E1MhUcY, reason: not valid java name */
    public static final IntRect m5027IntRectE1MhUcY(long j, long j2) {
        return new IntRect(IntOffset.m4996getXimpl(j), IntOffset.m4997getYimpl(j), IntOffset.m4996getXimpl(j2), IntOffset.m4997getYimpl(j2));
    }

    /* renamed from: IntRect-ar5cAso, reason: not valid java name */
    public static final IntRect m5029IntRectar5cAso(long j, int i) {
        return new IntRect(IntOffset.m4996getXimpl(j) - i, IntOffset.m4997getYimpl(j) - i, IntOffset.m4996getXimpl(j) + i, IntOffset.m4997getYimpl(j) + i);
    }
