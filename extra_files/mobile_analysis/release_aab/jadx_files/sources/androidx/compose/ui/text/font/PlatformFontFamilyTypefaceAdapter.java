...
public final class PlatformFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        android.graphics.Typeface mo4528createDefaultFO1MlWM;
        ...
        if (fontFamily == null || (fontFamily instanceof DefaultFontFamily)) {
            mo4528createDefaultFO1MlWM = this.platformTypefaceResolver.mo4528createDefaultFO1MlWM(typefaceRequest.getFontWeight(), typefaceRequest.m4546getFontStyle_LCdwA());
        } else if (fontFamily instanceof GenericFontFamily) {
            mo4528createDefaultFO1MlWM = this.platformTypefaceResolver.mo4529createNamedRetOiIg((GenericFontFamily) typefaceRequest.getFontFamily(), typefaceRequest.getFontWeight(), typefaceRequest.m4546getFontStyle_LCdwA());
        } else {
            ...
            mo4528createDefaultFO1MlWM = ((AndroidTypeface) typeface).mo4631getNativeTypefacePYhJU0U(typefaceRequest.getFontWeight(), typefaceRequest.m4546getFontStyle_LCdwA(), typefaceRequest.m4547getFontSynthesisGVVA2EU());
        }
        return new TypefaceResult.Immutable(mo4528createDefaultFO1MlWM, false, 2, null);
    }
}
