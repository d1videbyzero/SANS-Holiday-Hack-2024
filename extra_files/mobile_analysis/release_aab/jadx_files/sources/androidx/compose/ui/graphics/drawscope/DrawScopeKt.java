...
public final class DrawScopeKt {
    ...
    public static /* synthetic */ void m3216rotateRg1IO4c$default(DrawScope rotate, float f, long j, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            j = rotate.mo3173getCenterF1C5BW0();
        }
        ...
        drawContext.getTransform().mo3105rotateUv8p0NA(f, j);
        block.invoke(rotate);
    ...
    public static /* synthetic */ void m3218rotateRadRg1IO4c$default(DrawScope rotateRad, float f, long j, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            j = rotateRad.mo3173getCenterF1C5BW0();
        }
        ...
        long mo3099getSizeNHjbRc = drawContext.mo3099getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo3105rotateUv8p0NA(DegreesKt.degrees(f), j);
    ...
    public static /* synthetic */ void m3220scaleFgt4K4Q$default(DrawScope scale, float f, float f2, long j, Function1 block, int i, Object obj) {
        if ((i & 4) != 0) {
            j = scale.mo3173getCenterF1C5BW0();
        }
        ...
        long mo3099getSizeNHjbRc = drawContext.mo3099getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo3106scale0AR0LA0(f, f2, j);
        block.invoke(scale);
        drawContext.getCanvas().restore();
        drawContext.mo3100setSizeuvyYCjk(mo3099getSizeNHjbRc);
    }
    ...
    public static /* synthetic */ void m3222scaleRg1IO4c$default(DrawScope scale, float f, long j, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            j = scale.mo3173getCenterF1C5BW0();
        }
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        ...
        long mo3099getSizeNHjbRc = drawContext.mo3099getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo3106scale0AR0LA0(f, f, j);
        block.invoke(scale);
        drawContext.getCanvas().restore();
        drawContext.mo3100setSizeuvyYCjk(mo3099getSizeNHjbRc);
    }
    ...
    public static /* synthetic */ void m3214clipRectrOu3jXo$default(DrawScope clipRect, float f, float f2, float f3, float f4, int i, Function1 block, int i2, Object obj) {
        float f5 = (i2 & 1) != 0 ? 0.0f : f;
        float f6 = (i2 & 2) != 0 ? 0.0f : f2;
        if ((i2 & 4) != 0) {
            f3 = Size.m2460getWidthimpl(clipRect.mo3174getSizeNHjbRc());
        }
        float f7 = f3;
        if ((i2 & 8) != 0) {
            f4 = Size.m2457getHeightimpl(clipRect.mo3174getSizeNHjbRc());
        }
        float f8 = f4;
        if ((i2 & 16) != 0) {
            i = ClipOp.INSTANCE.m2619getIntersectrtfAjoo();
        }
        ...
        long mo3099getSizeNHjbRc = drawContext.mo3099getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo3102clipRectN_I0leg(f5, f6, f7, f8, i);
    ...
    public static /* synthetic */ void m3212clipPathKD09W0M$default(DrawScope clipPath, Path path, int i, Function1 block, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            i = ClipOp.INSTANCE.m2619getIntersectrtfAjoo();
        }
        ...
        long mo3099getSizeNHjbRc = drawContext.mo3099getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo3101clipPathmtrdDE(path, i);
    ...
    public static final void m3215rotateRg1IO4c(DrawScope rotate, float f, long j, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(rotate, "$this$rotate");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = rotate.getDrawContext();
        long mo3099getSizeNHjbRc = drawContext.mo3099getSizeNHjbRc();
    ...
    public static final void m3217rotateRadRg1IO4c(DrawScope rotateRad, float f, long j, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(rotateRad, "$this$rotateRad");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = rotateRad.getDrawContext();
        long mo3099getSizeNHjbRc = drawContext.mo3099getSizeNHjbRc();
    ...
    public static final void m3219scaleFgt4K4Q(DrawScope scale, float f, float f2, long j, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = scale.getDrawContext();
        long mo3099getSizeNHjbRc = drawContext.mo3099getSizeNHjbRc();
    ...
    public static final void m3221scaleRg1IO4c(DrawScope scale, float f, long j, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = scale.getDrawContext();
        long mo3099getSizeNHjbRc = drawContext.mo3099getSizeNHjbRc();
    ...
    public static final void m3213clipRectrOu3jXo(DrawScope clipRect, float f, float f2, float f3, float f4, int i, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(clipRect, "$this$clipRect");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = clipRect.getDrawContext();
        long mo3099getSizeNHjbRc = drawContext.mo3099getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo3102clipRectN_I0leg(f, f2, f3, f4, i);
        block.invoke(clipRect);
        drawContext.getCanvas().restore();
        drawContext.mo3100setSizeuvyYCjk(mo3099getSizeNHjbRc);
    }
    ...
    public static final void m3211clipPathKD09W0M(DrawScope clipPath, Path path, int i, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(clipPath, "$this$clipPath");
        Intrinsics.checkNotNullParameter(path, "path");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = clipPath.getDrawContext();
