...
public final class EditingBuffer {
    ...
    private EditingBuffer(AnnotatedString text, long j) {
        ...
        this.selectionStart = TextRange.m4406getMinimpl(j);
        this.selectionEnd = TextRange.m4405getMaximpl(j);
        this.compositionStart = -1;
        this.compositionEnd = -1;
        int m4406getMinimpl = TextRange.m4406getMinimpl(j);
        int m4405getMaximpl = TextRange.m4405getMaximpl(j);
        if (m4406getMinimpl < 0 || m4406getMinimpl > text.length()) {
            throw new IndexOutOfBoundsException("start (" + m4406getMinimpl + ") offset is outside of text region " + text.length());
        }
        if (m4405getMaximpl < 0 || m4405getMaximpl > text.length()) {
            throw new IndexOutOfBoundsException("end (" + m4405getMaximpl + ") offset is outside of text region " + text.length());
        }
        if (m4406getMinimpl > m4405getMaximpl) {
            throw new IllegalArgumentException("Do not set reversed range: " + m4406getMinimpl + " > " + m4405getMaximpl);
        }
    }
    ...
    public final TextRange m4548getCompositionMzsxiRA$ui_text_release() {
        if (hasComposition$ui_text_release()) {
            return TextRange.m4396boximpl(TextRangeKt.TextRange(this.compositionStart, this.compositionEnd));
        }
        return null;
    }

    /* renamed from: getSelection-d9O1mEE$ui_text_release, reason: not valid java name */
    public final long m4549getSelectiond9O1mEE$ui_text_release() {
    ...
    public final void delete$ui_text_release(int start, int end) {
        ...
        long m4550updateRangeAfterDeletepWDy79M = EditingBufferKt.m4550updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.selectionStart, this.selectionEnd), TextRange);
        setSelectionStart(TextRange.m4406getMinimpl(m4550updateRangeAfterDeletepWDy79M));
        setSelectionEnd(TextRange.m4405getMaximpl(m4550updateRangeAfterDeletepWDy79M));
        if (hasComposition$ui_text_release()) {
            long m4550updateRangeAfterDeletepWDy79M2 = EditingBufferKt.m4550updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.compositionStart, this.compositionEnd), TextRange);
            if (TextRange.m4402getCollapsedimpl(m4550updateRangeAfterDeletepWDy79M2)) {
                commitComposition$ui_text_release();
            } else {
                this.compositionStart = TextRange.m4406getMinimpl(m4550updateRangeAfterDeletepWDy79M2);
                this.compositionEnd = TextRange.m4405getMaximpl(m4550updateRangeAfterDeletepWDy79M2);
            }
        }
    }
