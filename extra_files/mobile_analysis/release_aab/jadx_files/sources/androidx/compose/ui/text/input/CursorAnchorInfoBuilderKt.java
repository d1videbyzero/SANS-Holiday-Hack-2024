...
public final class CursorAnchorInfoBuilderKt {
    public static final CursorAnchorInfo build(CursorAnchorInfo.Builder builder, TextFieldValue textFieldValue, TextLayoutResult textLayoutResult, Matrix matrix) {
        ...
        int m4406getMinimpl = TextRange.m4406getMinimpl(textFieldValue.getSelection());
        builder.setSelectionRange(m4406getMinimpl, TextRange.m4405getMaximpl(textFieldValue.getSelection()));
        setInsertionMarker(builder, m4406getMinimpl, textLayoutResult);
        ...
        int m4405getMaximpl = composition2 != null ? TextRange.m4405getMaximpl(composition2.getPackedValue()) : -1;
        if (m4406getMinimpl2 >= 0 && m4406getMinimpl2 < m4405getMaximpl) {
            builder.setComposingText(m4406getMinimpl2, textFieldValue.getText().subSequence(m4406getMinimpl2, m4405getMaximpl));
        }
