...
public final class StampedPathEffectStyle {
    ...
    private static final int Translate = m2961constructorimpl(0);
    private static final int Rotate = m2961constructorimpl(1);
    private static final int Morph = m2961constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ StampedPathEffectStyle m2960boximpl(int i) {
    ...
    public static String m2965toStringimpl(int i) {
        return m2963equalsimpl0(i, Translate) ? "Translate" : m2963equalsimpl0(i, Rotate) ? "Rotate" : m2963equalsimpl0(i, Morph) ? "Morph" : "Unknown";
    }
}
