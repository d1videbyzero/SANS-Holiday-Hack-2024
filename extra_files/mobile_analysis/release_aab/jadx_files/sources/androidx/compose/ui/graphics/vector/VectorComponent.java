...
public final class VectorComponent extends VNode {
    ...
    public VectorComponent() {
        ...
        this.previousDrawSize = Size.INSTANCE.m2468getUnspecifiedNHjbRc();
    ...
    public final void draw(DrawScope drawScope, float f, ColorFilter colorFilter) {
        ...
        if (this.isDirty || !Size.m2456equalsimpl0(this.previousDrawSize, drawScope.mo3174getSizeNHjbRc())) {
            this.root.setScaleX(Size.m2460getWidthimpl(drawScope.mo3174getSizeNHjbRc()) / this.viewportWidth);
            this.root.setScaleY(Size.m2457getHeightimpl(drawScope.mo3174getSizeNHjbRc()) / this.viewportHeight);
            this.cacheDrawScope.m3250drawCachedImageCJJARo(IntSizeKt.IntSize((int) Math.ceil(Size.m2460getWidthimpl(drawScope.mo3174getSizeNHjbRc())), (int) Math.ceil(Size.m2457getHeightimpl(drawScope.mo3174getSizeNHjbRc()))), drawScope, drawScope.getLayoutDirection(), this.drawVectorBlock);
            this.isDirty = false;
            this.previousDrawSize = drawScope.mo3174getSizeNHjbRc();
        }
