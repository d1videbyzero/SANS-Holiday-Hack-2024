...
public final class NodeKindKt {
    ...
    public static final boolean m4090contains64DMado(int i, int i2) {
        return (i & i2) != 0;
    }
    ...
    public static final int m4092or64DMado(int i, int i2) {
        return i | i2;
    }
    ...
    public static final int calculateNodeKindSetFrom(Modifier.Node node) {
        ...
        int m4082constructorimpl = NodeKind.m4082constructorimpl(1);
        if (node instanceof LayoutModifierNode) {
            m4082constructorimpl |= NodeKind.m4082constructorimpl(2);
        }
        if (node instanceof DrawModifierNode) {
            m4082constructorimpl |= NodeKind.m4082constructorimpl(4);
        }
        if (node instanceof SemanticsModifierNode) {
            m4082constructorimpl |= NodeKind.m4082constructorimpl(8);
        }
        if (node instanceof PointerInputModifierNode) {
            m4082constructorimpl |= NodeKind.m4082constructorimpl(16);
        }
        if (node instanceof ModifierLocalModifierNode) {
            m4082constructorimpl |= NodeKind.m4082constructorimpl(32);
        }
        if (node instanceof ParentDataModifierNode) {
            m4082constructorimpl |= NodeKind.m4082constructorimpl(64);
        }
        if (node instanceof LayoutAwareModifierNode) {
            m4082constructorimpl |= NodeKind.m4082constructorimpl(128);
        }
        if (node instanceof GlobalPositionAwareModifierNode) {
            m4082constructorimpl |= NodeKind.m4082constructorimpl(256);
        }
        if (node instanceof IntermediateLayoutModifierNode) {
            m4082constructorimpl |= NodeKind.m4082constructorimpl(512);
        }
        if (node instanceof FocusTargetNode) {
            m4082constructorimpl |= NodeKind.m4082constructorimpl(1024);
        }
        if (node instanceof FocusPropertiesModifierNode) {
            m4082constructorimpl |= NodeKind.m4082constructorimpl(2048);
        }
        if (node instanceof FocusEventModifierNode) {
            m4082constructorimpl |= NodeKind.m4082constructorimpl(4096);
        }
        if (node instanceof KeyInputModifierNode) {
            m4082constructorimpl |= NodeKind.m4082constructorimpl(8192);
        }
        if (node instanceof RotaryInputModifierNode) {
            m4082constructorimpl |= NodeKind.m4082constructorimpl(16384);
        }
        if (node instanceof CompositionLocalConsumerModifierNode) {
            m4082constructorimpl |= NodeKind.m4082constructorimpl(32768);
        }
        return node instanceof SoftKeyboardInterceptionModifierNode ? m4082constructorimpl | NodeKind.m4082constructorimpl(131072) : m4082constructorimpl;
    }
    ...
    private static final void autoInvalidateNodeSelf(Modifier.Node node, int i, int i2) {
        if (i2 != 0 || node.getShouldAutoInvalidate()) {
            if ((NodeKind.m4082constructorimpl(2) & i) != 0 && (node instanceof LayoutModifierNode)) {
                LayoutModifierNodeKt.invalidateMeasurement((LayoutModifierNode) node);
                if (i2 == 2) {
                    DelegatableNodeKt.m3981requireCoordinator64DMado(node, NodeKind.m4082constructorimpl(2)).onRelease();
                }
            }
            if ((NodeKind.m4082constructorimpl(256) & i) != 0 && (node instanceof GlobalPositionAwareModifierNode)) {
                DelegatableNodeKt.requireLayoutNode(node).invalidateMeasurements$ui_release();
            }
            if ((NodeKind.m4082constructorimpl(4) & i) != 0 && (node instanceof DrawModifierNode)) {
                DrawModifierNodeKt.invalidateDraw((DrawModifierNode) node);
            }
            if ((NodeKind.m4082constructorimpl(8) & i) != 0 && (node instanceof SemanticsModifierNode)) {
                SemanticsModifierNodeKt.invalidateSemantics((SemanticsModifierNode) node);
            }
            if ((NodeKind.m4082constructorimpl(64) & i) != 0 && (node instanceof ParentDataModifierNode)) {
                ParentDataModifierNodeKt.invalidateParentData((ParentDataModifierNode) node);
            }
            if ((NodeKind.m4082constructorimpl(1024) & i) != 0 && (node instanceof FocusTargetNode)) {
                if (i2 == 2) {
                    node.onReset();
                } else {
            ...
            if ((NodeKind.m4082constructorimpl(2048) & i) != 0 && (node instanceof FocusPropertiesModifierNode)) {
            ...
            if ((i & NodeKind.m4082constructorimpl(4096)) == 0 || !(node instanceof FocusEventModifierNode)) {
                return;
            }
    ...
    public static final boolean m4091getIncludeSelfInTraversalH91voCI(int i) {
        return (i & NodeKind.m4082constructorimpl(128)) != 0;
    }
    ...
    public static final int calculateNodeKindSetFrom(Modifier.Element element) {
        ...
        return ((element instanceof OnPlacedModifier) || (element instanceof OnRemeasuredModifier)) ? m4082constructorimpl | NodeKind.m4082constructorimpl(128) : m4082constructorimpl;
    }
}
