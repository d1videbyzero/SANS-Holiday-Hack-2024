...
public final class VelocityTracker {
    ...
    private long currentPointerPositionAccumulator = Offset.INSTANCE.m2407getZeroF1C5BW0();
    ...
    public final void m3844setCurrentPointerPositionAccumulatork4lQ0M$ui_release(long j) {
        this.currentPointerPositionAccumulator = j;
    }

    /* renamed from: addPosition-Uv8p0NA, reason: not valid java name */
    public final void m3841addPositionUv8p0NA(long timeMillis, long position) {
        this.xVelocityTracker.addDataPoint(timeMillis, Offset.m2391getXimpl(position));
        this.yVelocityTracker.addDataPoint(timeMillis, Offset.m2392getYimpl(position));
    }

    /* renamed from: calculateVelocity-9UxMQ8M, reason: not valid java name */
    public final long m3842calculateVelocity9UxMQ8M() {
