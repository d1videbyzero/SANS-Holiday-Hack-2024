...
public final class LayerMatrixCache<T> {
    ...
    public final float[] m4202calculateMatrixGrdbGEg(T target) {
        float[] fArr = this.matrixCache;
        if (fArr == null) {
            fArr = androidx.compose.ui.graphics.Matrix.m2856constructorimpl$default(null, 1, null);
        ...
        if (matrix2 == null || !Intrinsics.areEqual(matrix, matrix2)) {
            AndroidMatrixConversions_androidKt.m2503setFromtUYjHk(fArr, matrix);
    ...
    public final float[] m4201calculateInverseMatrixbWbORWo(T target) {
        ...
        if (this.isInverseDirty) {
            this.isInverseValid = InvertMatrixKt.m4199invertToJiSxe2E(m4202calculateMatrixGrdbGEg(target), fArr);
