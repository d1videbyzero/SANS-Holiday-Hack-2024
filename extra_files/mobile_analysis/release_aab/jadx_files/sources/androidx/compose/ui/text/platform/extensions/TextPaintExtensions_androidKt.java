...
public final class TextPaintExtensions_androidKt {
    ...
    public static final SpanStyle applySpanStyle(AndroidTextPaint androidTextPaint, SpanStyle style, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> resolveTypeface, Density density, boolean z) {
        ...
        long m5058getTypeUIouoOA = TextUnit.m5058getTypeUIouoOA(style.getFontSize());
        if (TextUnitType.m5087equalsimpl0(m5058getTypeUIouoOA, TextUnitType.INSTANCE.m5092getSpUIouoOA())) {
            androidTextPaint.setTextSize(density.mo326toPxR2X_6o(style.getFontSize()));
        } else if (TextUnitType.m5087equalsimpl0(m5058getTypeUIouoOA, TextUnitType.INSTANCE.m5091getEmUIouoOA())) {
            androidTextPaint.setTextSize(androidTextPaint.getTextSize() * TextUnit.m5059getValueimpl(style.getFontSize()));
        }
        if (hasFontAttributes(style)) {
            ...
            androidTextPaint.setTypeface(resolveTypeface.invoke(fontFamily, fontWeight, m4500boximpl, FontSynthesis.m4509boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m4518getAllGVVA2EU())));
        }
        ...
        androidTextPaint.m4646setColor8_81llA(style.m4367getColor0d7_KjU());
        androidTextPaint.m4645setBrush12SF9DM(style.getBrush(), Size.INSTANCE.m2468getUnspecifiedNHjbRc(), style.getAlpha());
        ...
        if (TextUnitType.m5087equalsimpl0(TextUnit.m5058getTypeUIouoOA(style.getLetterSpacing()), TextUnitType.INSTANCE.m5092getSpUIouoOA()) && TextUnit.m5059getValueimpl(style.getLetterSpacing()) != 0.0f) {
            float textSize = androidTextPaint.getTextSize() * androidTextPaint.getTextScaleX();
            float mo326toPxR2X_6o = density.mo326toPxR2X_6o(style.getLetterSpacing());
            if (textSize != 0.0f) {
                androidTextPaint.setLetterSpacing(mo326toPxR2X_6o / textSize);
            }
        } else if (TextUnitType.m5087equalsimpl0(TextUnit.m5058getTypeUIouoOA(style.getLetterSpacing()), TextUnitType.INSTANCE.m5091getEmUIouoOA())) {
            androidTextPaint.setLetterSpacing(TextUnit.m5059getValueimpl(style.getLetterSpacing()));
        }
        return m4660generateFallbackSpanStyle62GTOB8(style.getLetterSpacing(), z, style.getBackground(), style.getBaselineShift());
    }

    /* JADX WARN: Code restructure failed: missing block: B:15:0x004e, code lost:
    
        if (androidx.compose.ui.text.style.BaselineShift.m4668equalsimpl0(r36.m4671unboximpl(), androidx.compose.ui.text.style.BaselineShift.INSTANCE.m4675getNoney9eOQZs()) == false) goto L22;
     */
    ...
    */
    private static final androidx.compose.ui.text.SpanStyle m4660generateFallbackSpanStyle62GTOB8(long r31, boolean r33, long r34, androidx.compose.ui.text.style.BaselineShift r36) {
        /*
            r0 = r34
            r2 = 1
            r3 = 0
            if (r33 == 0) goto L22
            long r4 = androidx.compose.ui.unit.TextUnit.m5058getTypeUIouoOA(r31)
            androidx.compose.ui.unit.TextUnitType$Companion r6 = androidx.compose.ui.unit.TextUnitType.INSTANCE
            long r6 = r6.m5092getSpUIouoOA()
            boolean r4 = androidx.compose.ui.unit.TextUnitType.m5087equalsimpl0(r4, r6)
            if (r4 == 0) goto L22
            float r4 = androidx.compose.ui.unit.TextUnit.m5059getValueimpl(r31)
            r5 = 0
        ...
        L23:
            ...
            long r5 = r5.m2666getUnspecified0d7_KjU()
            boolean r5 = androidx.compose.ui.graphics.Color.m2631equalsimpl0(r0, r5)
            if (r5 != 0) goto L3d
            androidx.compose.ui.graphics.Color$Companion r5 = androidx.compose.ui.graphics.Color.INSTANCE
            long r5 = r5.m2665getTransparent0d7_KjU()
            boolean r5 = androidx.compose.ui.graphics.Color.m2631equalsimpl0(r0, r5)
            if (r5 != 0) goto L3d
            r5 = r2
            goto L3e
        ...
        L3e:
            ...
            float r6 = r6.m4675getNoney9eOQZs()
            float r7 = r36.m4671unboximpl()
            boolean r6 = androidx.compose.ui.text.style.BaselineShift.m4668equalsimpl0(r7, r6)
            if (r6 != 0) goto L51
            goto L52
        L51:
            r2 = r3
        ...
        L5f:
            ...
            long r6 = r4.m5070getUnspecifiedXSAIIZE()
            r18 = r6
        L67:
            if (r5 == 0) goto L6a
            goto L70
        L6a:
            ...
            long r0 = r0.m2666getUnspecified0d7_KjU()
        L70:
            r23 = r0
            if (r2 == 0) goto L77
            r20 = r36
        ...
        L9b:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.text.platform.extensions.TextPaintExtensions_androidKt.m4660generateFallbackSpanStyle62GTOB8(long, boolean, long, androidx.compose.ui.text.style.BaselineShift):androidx.compose.ui.text.SpanStyle");
    }
    ...
    public static final void setTextMotion(AndroidTextPaint androidTextPaint, TextMotion textMotion) {
        ...
        if (TextMotion.Linearity.m4802equalsimpl0(linearity, TextMotion.Linearity.INSTANCE.m4807getLinear4e0Vf04())) {
            androidTextPaint.setFlags(androidTextPaint.getFlags() | 64);
            androidTextPaint.setHinting(0);
        } else if (TextMotion.Linearity.m4802equalsimpl0(linearity, TextMotion.Linearity.INSTANCE.m4806getFontHinting4e0Vf04())) {
            androidTextPaint.getFlags();
            androidTextPaint.setHinting(1);
        } else if (TextMotion.Linearity.m4802equalsimpl0(linearity, TextMotion.Linearity.INSTANCE.m4808getNone4e0Vf04())) {
            androidTextPaint.getFlags();
            androidTextPaint.setHinting(0);
        } else {
            androidTextPaint.getFlags();
