...
public final class StrokeJoin {
    ...
    private static final int Miter = m2981constructorimpl(0);
    private static final int Round = m2981constructorimpl(1);
    private static final int Bevel = m2981constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ StrokeJoin m2980boximpl(int i) {
        return new StrokeJoin(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m2981constructorimpl(int i) {
        return i;
    }
    ...
    public static final class Companion {
        ...
        public final int m2988getMiterLxFBmk8() {
            return StrokeJoin.Miter;
        }

        /* renamed from: getRound-LxFBmk8, reason: not valid java name */
        public final int m2989getRoundLxFBmk8() {
            return StrokeJoin.Round;
        }

        /* renamed from: getBevel-LxFBmk8, reason: not valid java name */
        public final int m2987getBevelLxFBmk8() {
    ...
    public static String m2985toStringimpl(int i) {
        return m2983equalsimpl0(i, Miter) ? "Miter" : m2983equalsimpl0(i, Round) ? "Round" : m2983equalsimpl0(i, Bevel) ? "Bevel" : "Unknown";
    }
}
