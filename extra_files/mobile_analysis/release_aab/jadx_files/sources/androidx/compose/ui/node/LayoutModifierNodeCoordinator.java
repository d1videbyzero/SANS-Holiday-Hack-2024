...
public final class LayoutModifierNodeCoordinator extends NodeCoordinator {
    ...
    private final class LookaheadDelegateForLayoutModifierNode extends LookaheadDelegate {
        ...
        public Placeable mo3868measureBRTryo0(long constraints) {
            ...
            lookaheadDelegateForLayoutModifierNode.m3924setMeasurementConstraintsBRTryo0(constraints);
            layoutModifierNodeCoordinator.lookaheadConstraints = Constraints.m4822boximpl(constraints);
            LookaheadDelegate lookaheadDelegate = layoutModifierNodeCoordinator.getWrappedNonNull().getLookaheadDelegate();
            Intrinsics.checkNotNull(lookaheadDelegate);
            lookaheadDelegateForLayoutModifierNode.set_measureResult(layoutModifierNodeCoordinator.getLayoutModifierNode().mo239measure3p2s80s(this, lookaheadDelegate, constraints));
    ...
    public Placeable mo3868measureBRTryo0(long constraints) {
        ...
        if (layoutModifierNode instanceof IntermediateLayoutModifierNode) {
            ...
            mo239measure3p2s80s = ((IntermediateLayoutModifierNode) layoutModifierNode).m3870intermediateMeasureTeuZzU(this, wrappedNonNull, constraints, IntSize, constraints2.getValue());
        } else {
            mo239measure3p2s80s = layoutModifierNode.mo239measure3p2s80s(this, getWrappedNonNull(), constraints);
        }
    ...
    protected void mo3869placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        ...
        int m5038getWidthimpl = IntSize.m5038getWidthimpl(getMeasuredSize());
        ...
        Placeable.PlacementScope.parentWidth = m5038getWidthimpl;
    ...
    static {
        ...
        Paint.mo2511setColor8_81llA(Color.INSTANCE.m2657getBlue0d7_KjU());
