...
public final class CornerRadiusKt {
    ...
    public static final long m2377lerp3Ry4LBc(long j, long j2, float f) {
        return CornerRadius(MathHelpersKt.lerp(CornerRadius.m2366getXimpl(j), CornerRadius.m2366getXimpl(j2), f), MathHelpersKt.lerp(CornerRadius.m2367getYimpl(j), CornerRadius.m2367getYimpl(j2), f));
    }

    public static final long CornerRadius(float f, float f2) {
        return CornerRadius.m2360constructorimpl((Float.floatToIntBits(f2) & 4294967295L) | (Float.floatToIntBits(f) << 32));
    }
}
