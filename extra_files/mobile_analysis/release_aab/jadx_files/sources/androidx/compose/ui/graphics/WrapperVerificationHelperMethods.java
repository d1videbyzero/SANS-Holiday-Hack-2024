...
public final class WrapperVerificationHelperMethods {
    ...
    public final void m3027setBlendModeGB0RdKg(android.graphics.Paint paint, int mode) {
        Intrinsics.checkNotNullParameter(paint, "paint");
        paint.setBlendMode(AndroidBlendMode_androidKt.m2483toAndroidBlendModes9anfk8(mode));
    }
}
