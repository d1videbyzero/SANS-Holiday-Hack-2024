...
public final class TileMode {
    ...
    private static final int Clamp = m2991constructorimpl(0);
    private static final int Repeated = m2991constructorimpl(1);
    private static final int Mirror = m2991constructorimpl(2);
    private static final int Decal = m2991constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TileMode m2990boximpl(int i) {
        return new TileMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m2991constructorimpl(int i) {
        return i;
    }
    ...
    public static final class Companion {
        ...
        public final int m2997getClamp3opZhB0() {
            return TileMode.Clamp;
        }

        /* renamed from: getRepeated-3opZhB0, reason: not valid java name */
        public final int m3000getRepeated3opZhB0() {
            return TileMode.Repeated;
        }

        /* renamed from: getMirror-3opZhB0, reason: not valid java name */
        public final int m2999getMirror3opZhB0() {
            return TileMode.Mirror;
        }

        /* renamed from: getDecal-3opZhB0, reason: not valid java name */
        public final int m2998getDecal3opZhB0() {
    ...
    public static String m2995toStringimpl(int i) {
        return m2993equalsimpl0(i, Clamp) ? "Clamp" : m2993equalsimpl0(i, Repeated) ? "Repeated" : m2993equalsimpl0(i, Mirror) ? "Mirror" : m2993equalsimpl0(i, Decal) ? "Decal" : "Unknown";
    }
}
