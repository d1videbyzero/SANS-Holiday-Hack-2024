...
public final class PointerEvent {
    ...
    public PointerEvent(List<PointerInputChange> changes, InternalPointerEvent internalPointerEvent) {
        ...
        this.buttons = PointerButtons.m3684constructorimpl(motionEvent$ui_release != null ? motionEvent$ui_release.getButtonState() : 0);
        MotionEvent motionEvent$ui_release2 = getMotionEvent$ui_release();
        this.keyboardModifiers = PointerKeyboardModifiers.m3812constructorimpl(motionEvent$ui_release2 != null ? motionEvent$ui_release2.getMetaState() : 0);
        this.type = m3690calculatePointerEventType7fucELk();
    }
    ...
    public final void m3694setTypeEhbLWgg$ui_release(int i) {
        this.type = i;
    }

    /* renamed from: calculatePointerEventType-7fucELk, reason: not valid java name */
    private final int m3690calculatePointerEventType7fucELk() {
        MotionEvent motionEvent$ui_release = getMotionEvent$ui_release();
            ...
            if (actionMasked != 0) {
                if (actionMasked != 1) {
                    if (actionMasked != 2) {
                        ...
                        return PointerEventType.INSTANCE.m3707getPress7fucELk();
                    }
                    return PointerEventType.INSTANCE.m3706getMove7fucELk();
                }
                return PointerEventType.INSTANCE.m3708getRelease7fucELk();
            }
            return PointerEventType.INSTANCE.m3707getPress7fucELk();
        }
    ...
    public final PointerEvent copy(List<PointerInputChange> changes, MotionEvent motionEvent) {
        ...
        while (i < size) {
            ...
            linkedHashMap.put(PointerId.m3730boximpl(pointerInputChange.getId()), pointerInputChange);
            ...
            if (internalPointerEvent != null) {
                z = true;
                if (internalPointerEvent.m3680issuesEnterExitEvent0FcD4WY(pointerInputChange.getId())) {
