...
public abstract class Painter {
    ...
    public abstract long mo3243getIntrinsicSizeNHjbRc();
    ...
    public static /* synthetic */ void m3248drawx_KDEd0$default(Painter painter, DrawScope drawScope, long j, float f, ColorFilter colorFilter, int i, Object obj) {
        if (obj != null) {
        ...
        painter.m3249drawx_KDEd0(drawScope, j, f2, colorFilter);
    }

    /* renamed from: draw-x_KDEd0, reason: not valid java name */
    public final void m3249drawx_KDEd0(DrawScope draw, long j, float f, ColorFilter colorFilter) {
        Intrinsics.checkNotNullParameter(draw, "$this$draw");
        configureAlpha(f);
        configureColorFilter(colorFilter);
        configureLayoutDirection(draw.getLayoutDirection());
        float m2460getWidthimpl = Size.m2460getWidthimpl(draw.mo3174getSizeNHjbRc()) - Size.m2460getWidthimpl(j);
        float m2457getHeightimpl = Size.m2457getHeightimpl(draw.mo3174getSizeNHjbRc()) - Size.m2457getHeightimpl(j);
        draw.getDrawContext().getTransform().inset(0.0f, 0.0f, m2460getWidthimpl, m2457getHeightimpl);
        if (f > 0.0f && Size.m2460getWidthimpl(j) > 0.0f && Size.m2457getHeightimpl(j) > 0.0f) {
            if (this.useLayer) {
                Rect m2431Recttz77jQw = RectKt.m2431Recttz77jQw(Offset.INSTANCE.m2407getZeroF1C5BW0(), SizeKt.Size(Size.m2460getWidthimpl(j), Size.m2457getHeightimpl(j)));
                Canvas canvas = draw.getDrawContext().getCanvas();
                try {
                    canvas.saveLayer(m2431Recttz77jQw, obtainPaint());
                    onDraw(draw);
                } finally {
                    canvas.restore();
                }
