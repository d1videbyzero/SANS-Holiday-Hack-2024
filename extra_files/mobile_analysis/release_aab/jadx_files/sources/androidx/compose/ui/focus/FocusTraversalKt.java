...
public final class FocusTraversalKt {
    ...
    public static final FocusRequester m2343customFocusSearchOMvw8(FocusTargetNode customFocusSearch, int i, LayoutDirection layoutDirection) {
        FocusRequester end;
        ...
        if (FocusDirection.m2310equalsimpl0(i, FocusDirection.INSTANCE.m2323getNextdhqQ8s())) {
            return fetchFocusProperties$ui_release.getNext();
        }
        if (FocusDirection.m2310equalsimpl0(i, FocusDirection.INSTANCE.m2325getPreviousdhqQ8s())) {
            return fetchFocusProperties$ui_release.getPrevious();
        }
        if (FocusDirection.m2310equalsimpl0(i, FocusDirection.INSTANCE.m2327getUpdhqQ8s())) {
        ...
        if (FocusDirection.m2310equalsimpl0(i, FocusDirection.INSTANCE.m2322getLeftdhqQ8s())) {
            ...
            if (FocusDirection.m2310equalsimpl0(i, FocusDirection.INSTANCE.m2319getEnterdhqQ8s())) {
                return fetchFocusProperties$ui_release.getEnter().invoke(FocusDirection.m2307boximpl(i));
            }
            if (FocusDirection.m2310equalsimpl0(i, FocusDirection.INSTANCE.m2320getExitdhqQ8s())) {
                return fetchFocusProperties$ui_release.getExit().invoke(FocusDirection.m2307boximpl(i));
            }
    ...
    public static final boolean m2344focusSearchsMXa3k8(FocusTargetNode focusSearch, int i, LayoutDirection layoutDirection, Function1<? super FocusTargetNode, Boolean> onFound) {
        int m2326getRightdhqQ8s;
        Boolean m2356twoDimensionalFocusSearchOMvw8;
        Intrinsics.checkNotNullParameter(focusSearch, "$this$focusSearch");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Intrinsics.checkNotNullParameter(onFound, "onFound");
        if (FocusDirection.m2310equalsimpl0(i, FocusDirection.INSTANCE.m2323getNextdhqQ8s()) || FocusDirection.m2310equalsimpl0(i, FocusDirection.INSTANCE.m2325getPreviousdhqQ8s())) {
            return OneDimensionalFocusSearchKt.m2347oneDimensionalFocusSearchOMvw8(focusSearch, i, onFound);
        }
        if (FocusDirection.m2310equalsimpl0(i, FocusDirection.INSTANCE.m2322getLeftdhqQ8s()) || FocusDirection.m2310equalsimpl0(i, FocusDirection.INSTANCE.m2326getRightdhqQ8s()) || FocusDirection.m2310equalsimpl0(i, FocusDirection.INSTANCE.m2327getUpdhqQ8s()) || FocusDirection.m2310equalsimpl0(i, FocusDirection.INSTANCE.m2318getDowndhqQ8s())) {
            Boolean m2356twoDimensionalFocusSearchOMvw82 = TwoDimensionalFocusSearchKt.m2356twoDimensionalFocusSearchOMvw8(focusSearch, i, onFound);
            if (m2356twoDimensionalFocusSearchOMvw82 != null) {
                return m2356twoDimensionalFocusSearchOMvw82.booleanValue();
            }
        } else if (FocusDirection.m2310equalsimpl0(i, FocusDirection.INSTANCE.m2319getEnterdhqQ8s())) {
            int i2 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i2 == 1) {
                m2326getRightdhqQ8s = FocusDirection.INSTANCE.m2326getRightdhqQ8s();
            } else {
                if (i2 != 2) {
                    throw new NoWhenBranchMatchedException();
                }
                m2326getRightdhqQ8s = FocusDirection.INSTANCE.m2322getLeftdhqQ8s();
            }
            FocusTargetNode findActiveFocusNode = findActiveFocusNode(focusSearch);
            if (findActiveFocusNode != null && (m2356twoDimensionalFocusSearchOMvw8 = TwoDimensionalFocusSearchKt.m2356twoDimensionalFocusSearchOMvw8(findActiveFocusNode, m2326getRightdhqQ8s, onFound)) != null) {
                return m2356twoDimensionalFocusSearchOMvw8.booleanValue();
            }
        } else if (FocusDirection.m2310equalsimpl0(i, FocusDirection.INSTANCE.m2320getExitdhqQ8s())) {
            ...
            throw new IllegalStateException(("Focus search invoked with invalid FocusDirection " + ((Object) FocusDirection.m2312toStringimpl(i))).toString());
        }
        return false;
    }
