...
public final class Constraints {
    ...
    public static final /* synthetic */ Constraints m4822boximpl(long j) {
        return new Constraints(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m4823constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4826equalsimpl(long j, Object obj) {
        return (obj instanceof Constraints) && j == ((Constraints) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4827equalsimpl0(long j, long j2) {
        return j == j2;
    }

    /* renamed from: getFocusIndex-impl, reason: not valid java name */
    private static final int m4828getFocusIndeximpl(long j) {
        return (int) (j & 3);
    }
    ...
    public boolean equals(Object obj) {
        return m4826equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m4837hashCodeimpl(this.value);
    }
    ...
    public static final int m4836getMinWidthimpl(long j) {
        return ((int) (j >> MinFocusHeight)) & WidthMask[m4828getFocusIndeximpl(j)];
    }

    /* renamed from: getMaxWidth-impl, reason: not valid java name */
    public static final int m4834getMaxWidthimpl(long j) {
        int i = ((int) (j >> 33)) & WidthMask[m4828getFocusIndeximpl(j)];
        if (i == 0) {
    ...
    public static final int m4835getMinHeightimpl(long j) {
        int m4828getFocusIndeximpl = m4828getFocusIndeximpl(j);
        return ((int) (j >> MinHeightOffsets[m4828getFocusIndeximpl])) & HeightMask[m4828getFocusIndeximpl];
    }

    /* renamed from: getMaxHeight-impl, reason: not valid java name */
    public static final int m4833getMaxHeightimpl(long j) {
        int m4828getFocusIndeximpl = m4828getFocusIndeximpl(j);
        int i = ((int) (j >> (MinHeightOffsets[m4828getFocusIndeximpl] + 31))) & HeightMask[m4828getFocusIndeximpl];
        if (i == 0) {
            return Integer.MAX_VALUE;
        }
        return i - 1;
    ...
    public static final boolean m4830getHasBoundedWidthimpl(long j) {
        return (((int) (j >> 33)) & WidthMask[m4828getFocusIndeximpl(j)]) != 0;
    }

    /* renamed from: getHasBoundedHeight-impl, reason: not valid java name */
    public static final boolean m4829getHasBoundedHeightimpl(long j) {
        int m4828getFocusIndeximpl = m4828getFocusIndeximpl(j);
        return (((int) (j >> (MinHeightOffsets[m4828getFocusIndeximpl] + 31))) & HeightMask[m4828getFocusIndeximpl]) != 0;
    }

    /* renamed from: getHasFixedWidth-impl, reason: not valid java name */
    public static final boolean m4832getHasFixedWidthimpl(long j) {
        return m4834getMaxWidthimpl(j) == m4836getMinWidthimpl(j);
    }

    /* renamed from: getHasFixedHeight-impl, reason: not valid java name */
    public static final boolean m4831getHasFixedHeightimpl(long j) {
        return m4833getMaxHeightimpl(j) == m4835getMinHeightimpl(j);
    }

    /* renamed from: isZero-impl, reason: not valid java name */
    public static final boolean m4838isZeroimpl(long j) {
        return m4834getMaxWidthimpl(j) == 0 || m4833getMaxHeightimpl(j) == 0;
    }

    /* renamed from: copy-Zbe2FdA$default, reason: not valid java name */
    public static /* synthetic */ long m4825copyZbe2FdA$default(long j, int i, int i2, int i3, int i4, int i5, Object obj) {
        if ((i5 & 1) != 0) {
            i = m4836getMinWidthimpl(j);
        }
        int i6 = i;
        if ((i5 & 2) != 0) {
            i2 = m4834getMaxWidthimpl(j);
        }
        int i7 = i2;
        if ((i5 & 4) != 0) {
            i3 = m4835getMinHeightimpl(j);
        }
        int i8 = i3;
        if ((i5 & 8) != 0) {
            i4 = m4833getMaxHeightimpl(j);
        }
        return m4824copyZbe2FdA(j, i6, i7, i8, i4);
    }

    /* renamed from: copy-Zbe2FdA, reason: not valid java name */
    public static final long m4824copyZbe2FdA(long j, int i, int i2, int i3, int i4) {
        if (i3 < 0 || i < 0) {
        ...
        return INSTANCE.m4841createConstraintsZbe2FdA$ui_unit_release(i, i2, i3, i4);
    }
    ...
    public static String m4839toStringimpl(long j) {
        int m4834getMaxWidthimpl = m4834getMaxWidthimpl(j);
        String str = "Infinity";
        String valueOf = m4834getMaxWidthimpl == Integer.MAX_VALUE ? "Infinity" : String.valueOf(m4834getMaxWidthimpl);
        int m4833getMaxHeightimpl = m4833getMaxHeightimpl(j);
        if (m4833getMaxHeightimpl != Integer.MAX_VALUE) {
            str = String.valueOf(m4833getMaxHeightimpl);
        }
        return "Constraints(minWidth = " + m4836getMinWidthimpl(j) + ", maxWidth = " + valueOf + ", minHeight = " + m4835getMinHeightimpl(j) + ", maxHeight = " + str + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m4842fixedJhjzzOo(int width, int height) {
            if (width < 0 || height < 0) {
                throw new IllegalArgumentException(("width(" + width + ") and height(" + height + ") must be >= 0").toString());
            }
            return m4841createConstraintsZbe2FdA$ui_unit_release(width, width, height, height);
        }

        /* renamed from: fixedWidth-OenEA2s, reason: not valid java name */
        public final long m4844fixedWidthOenEA2s(int width) {
            if (width < 0) {
                throw new IllegalArgumentException(("width(" + width + ") must be >= 0").toString());
            }
            return m4841createConstraintsZbe2FdA$ui_unit_release(width, width, 0, Integer.MAX_VALUE);
        }

        /* renamed from: fixedHeight-OenEA2s, reason: not valid java name */
        public final long m4843fixedHeightOenEA2s(int height) {
            if (height < 0) {
                throw new IllegalArgumentException(("height(" + height + ") must be >= 0").toString());
            }
            return m4841createConstraintsZbe2FdA$ui_unit_release(0, Integer.MAX_VALUE, height, height);
        }

        /* renamed from: createConstraints-Zbe2FdA$ui_unit_release, reason: not valid java name */
        public final long m4841createConstraintsZbe2FdA$ui_unit_release(int minWidth, int maxWidth, int minHeight, int maxHeight) {
            long j;
            ...
            if (bitsNeedForSize + bitsNeedForSize2 <= 31) {
                ...
                return Constraints.m4823constructorimpl((i3 << 33) | j | (minWidth << Constraints.MinFocusHeight) | (minHeight << i5) | (i4 << (i5 + 31)));
            }
