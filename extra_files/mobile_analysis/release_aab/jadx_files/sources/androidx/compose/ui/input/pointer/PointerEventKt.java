...
public final class PointerEventKt {
    ...
    public static final boolean positionChanged(PointerInputChange pointerInputChange) {
        Intrinsics.checkNotNullParameter(pointerInputChange, "<this>");
        return !Offset.m2388equalsimpl0(positionChangeInternal(pointerInputChange, false), Offset.INSTANCE.m2407getZeroF1C5BW0());
    }

    public static final boolean positionChangedIgnoreConsumed(PointerInputChange pointerInputChange) {
        Intrinsics.checkNotNullParameter(pointerInputChange, "<this>");
        return !Offset.m2388equalsimpl0(positionChangeInternal(pointerInputChange, true), Offset.INSTANCE.m2407getZeroF1C5BW0());
    }
    ...
    private static final long positionChangeInternal(PointerInputChange pointerInputChange, boolean z) {
        long m2395minusMKHz9U = Offset.m2395minusMKHz9U(pointerInputChange.getPosition(), pointerInputChange.getPreviousPosition());
        return (z || !pointerInputChange.isConsumed()) ? m2395minusMKHz9U : Offset.INSTANCE.m2407getZeroF1C5BW0();
    }
    ...
    public static final void consumePositionChange(PointerInputChange pointerInputChange) {
        Intrinsics.checkNotNullParameter(pointerInputChange, "<this>");
        if (Offset.m2388equalsimpl0(positionChange(pointerInputChange), Offset.INSTANCE.m2407getZeroF1C5BW0())) {
            return;
        }
        pointerInputChange.consume();
    }
    ...
    public static final boolean m3695isOutOfBoundsO0kMr_c(PointerInputChange isOutOfBounds, long j) {
        ...
        return m2391getXimpl < 0.0f || m2391getXimpl > ((float) IntSize.m5038getWidthimpl(j)) || m2392getYimpl < 0.0f || m2392getYimpl > ((float) IntSize.m5037getHeightimpl(j));
    }

    /* renamed from: isOutOfBounds-jwHxaWs, reason: not valid java name */
    public static final boolean m3696isOutOfBoundsjwHxaWs(PointerInputChange isOutOfBounds, long j, long j2) {
        Intrinsics.checkNotNullParameter(isOutOfBounds, "$this$isOutOfBounds");
        if (!PointerType.m3821equalsimpl0(isOutOfBounds.getType(), PointerType.INSTANCE.m3828getTouchT8wyACA())) {
            return m3695isOutOfBoundsO0kMr_c(isOutOfBounds, j);
        }
        long position = isOutOfBounds.getPosition();
        float m2391getXimpl = Offset.m2391getXimpl(position);
        float m2392getYimpl = Offset.m2392getYimpl(position);
        return m2391getXimpl < (-Size.m2460getWidthimpl(j2)) || m2391getXimpl > ((float) IntSize.m5038getWidthimpl(j)) + Size.m2460getWidthimpl(j2) || m2392getYimpl < (-Size.m2457getHeightimpl(j2)) || m2392getYimpl > ((float) IntSize.m5037getHeightimpl(j)) + Size.m2457getHeightimpl(j2);
    }
}
