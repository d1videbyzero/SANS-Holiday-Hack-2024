...
public final class ClipOp {
    ...
    private static final int Difference = m2612constructorimpl(0);
    private static final int Intersect = m2612constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ClipOp m2611boximpl(int i) {
        return new ClipOp(i);
    }
    ...
    public static String m2616toStringimpl(int i) {
        return m2614equalsimpl0(i, Difference) ? "Difference" : m2614equalsimpl0(i, Intersect) ? "Intersect" : "Unknown";
    }
}
