...
public final /* data */ class ParagraphInfo {
    ...
    public final long m4305toLocalMKHz9U(long j) {
        return OffsetKt.Offset(Offset.m2391getXimpl(j), Offset.m2392getYimpl(j) - this.top);
    }

    public final Rect toGlobal(Rect rect) {
        Intrinsics.checkNotNullParameter(rect, "<this>");
        return rect.m2428translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }

    public final Path toGlobal(Path path) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        path.mo2527translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return path;
    }

    /* renamed from: toGlobal-GEjPoXI, reason: not valid java name */
    public final long m4304toGlobalGEjPoXI(long j) {
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m4408getStartimpl(j)), toGlobalIndex(TextRange.m4403getEndimpl(j)));
    }
}
