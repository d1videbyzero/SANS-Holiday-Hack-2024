...
final class PointerInputChangeEventProducer {
    ...
    public final InternalPointerEvent produce(PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator) {
        long j;
        boolean down;
        long mo3831screenToLocalMKHz9U;
        ...
        for (int i = 0; i < size; i++) {
            ...
            PointerInputData pointerInputData = this.previousPointerInputData.get(PointerId.m3730boximpl(pointerInputEventData.m3763getIdJ3iCeTQ()));
            if (pointerInputData == null) {
                j = pointerInputEventData.getUptime();
                mo3831screenToLocalMKHz9U = pointerInputEventData.m3764getPositionF1C5BW0();
                down = false;
            } else {
                long uptime = pointerInputData.getUptime();
                j = uptime;
                down = pointerInputData.getDown();
                mo3831screenToLocalMKHz9U = positionCalculator.mo3831screenToLocalMKHz9U(pointerInputData.getPositionOnScreen());
            }
            linkedHashMap.put(PointerId.m3730boximpl(pointerInputEventData.m3763getIdJ3iCeTQ()), new PointerInputChange(pointerInputEventData.m3763getIdJ3iCeTQ(), pointerInputEventData.getUptime(), pointerInputEventData.m3764getPositionF1C5BW0(), pointerInputEventData.getDown(), pointerInputEventData.getPressure(), j, mo3831screenToLocalMKHz9U, down, false, pointerInputEventData.m3767getTypeT8wyACA(), (List) pointerInputEventData.getHistorical(), pointerInputEventData.m3766getScrollDeltaF1C5BW0(), (DefaultConstructorMarker) null));
            if (pointerInputEventData.getDown()) {
                this.previousPointerInputData.put(PointerId.m3730boximpl(pointerInputEventData.m3763getIdJ3iCeTQ()), new PointerInputData(pointerInputEventData.getUptime(), pointerInputEventData.m3765getPositionOnScreenF1C5BW0(), pointerInputEventData.getDown(), pointerInputEventData.m3767getTypeT8wyACA(), null));
            } else {
                this.previousPointerInputData.remove(PointerId.m3730boximpl(pointerInputEventData.m3763getIdJ3iCeTQ()));
            }
        }
