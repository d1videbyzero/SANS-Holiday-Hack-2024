...
public final class RenderIntent {
    ...
    private static final int Perceptual = m3050constructorimpl(0);
    private static final int Relative = m3050constructorimpl(1);
    private static final int Saturation = m3050constructorimpl(2);
    private static final int Absolute = m3050constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ RenderIntent m3049boximpl(int i) {
    ...
    public static String m3054toStringimpl(int i) {
        return m3052equalsimpl0(i, Perceptual) ? "Perceptual" : m3052equalsimpl0(i, Relative) ? "Relative" : m3052equalsimpl0(i, Saturation) ? "Saturation" : m3052equalsimpl0(i, Absolute) ? "Absolute" : "Unknown";
    }
}
