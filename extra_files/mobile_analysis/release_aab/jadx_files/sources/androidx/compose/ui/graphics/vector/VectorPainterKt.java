...
public final class VectorPainterKt {
    ...
    public static final VectorPainter m3271rememberVectorPaintermlNsNFs(float f, float f2, float f3, float f4, String str, long j, int i, Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> content, Composer composer, int i2, int i3) {
        ...
        long m2666getUnspecified0d7_KjU = (i3 & 32) != 0 ? Color.INSTANCE.m2666getUnspecified0d7_KjU() : j;
        int m2572getSrcIn0nO6VwU = (i3 & 64) != 0 ? BlendMode.INSTANCE.m2572getSrcIn0nO6VwU() : i;
        ...
        VectorPainter m3272rememberVectorPaintervIP8VLU = m3272rememberVectorPaintervIP8VLU(f, f2, f5, f6, str2, m2666getUnspecified0d7_KjU, m2572getSrcIn0nO6VwU, false, content, composer, (i2 & 14) | 12582912 | (i2 & 112) | (i2 & 896) | (i2 & 7168) | (57344 & i2) | (458752 & i2) | (3670016 & i2) | ((i2 << 3) & 234881024), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m3272rememberVectorPaintervIP8VLU;
    }

    /* renamed from: rememberVectorPainter-vIP8VLU, reason: not valid java name */
    public static final VectorPainter m3272rememberVectorPaintervIP8VLU(float f, float f2, float f3, float f4, String str, long j, int i, boolean z, Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> content, Composer composer, int i2, int i3) {
        Intrinsics.checkNotNullParameter(content, "content");
        ...
        if (Float.isNaN(f6)) {
            f6 = mo327toPx0680j_42;
        }
        Color m2620boximpl = Color.m2620boximpl(m2666getUnspecified0d7_KjU);
        BlendMode m2540boximpl = BlendMode.m2540boximpl(m2572getSrcIn0nO6VwU);
        int i4 = i2 >> 15;
        composer.startReplaceableGroup(511388516);
        ComposerKt.sourceInformation(composer, "CC(remember)P(1,2):Composables.kt#9igjgp");
        boolean changed = composer.changed(m2620boximpl) | composer.changed(m2540boximpl);
        Object rememberedValue = composer.rememberedValue();
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = !Color.m2631equalsimpl0(m2666getUnspecified0d7_KjU, Color.INSTANCE.m2666getUnspecified0d7_KjU()) ? ColorFilter.INSTANCE.m2674tintxETnrds(m2666getUnspecified0d7_KjU, m2572getSrcIn0nO6VwU) : null;
        ...
        vectorPainter.m3270setSizeuvyYCjk$ui_release(SizeKt.Size(mo327toPx0680j_4, mo327toPx0680j_42));
    ...
    private static final void mirror(DrawScope drawScope, Function1<? super DrawScope, Unit> function1) {
        long mo3173getCenterF1C5BW0 = drawScope.mo3173getCenterF1C5BW0();
