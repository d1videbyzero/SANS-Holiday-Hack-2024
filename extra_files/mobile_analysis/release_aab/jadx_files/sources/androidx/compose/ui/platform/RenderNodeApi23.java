...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    public RenderNodeApi23(AndroidComposeView ownerView) {
        ...
        this.internalCompositingStrategy = CompositingStrategy.INSTANCE.m2716getAutoNrFUSI();
    ...
    public void mo4187setCompositingStrategyaDBOjCE(int i) {
        if (CompositingStrategy.m2712equalsimpl0(i, CompositingStrategy.INSTANCE.m2718getOffscreenNrFUSI())) {
            this.renderNode.setLayerType(2);
            this.renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m2712equalsimpl0(i, CompositingStrategy.INSTANCE.m2717getModulateAlphaNrFUSI())) {
    ...
    public final int getLayerType$ui_release() {
        return CompositingStrategy.m2712equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.INSTANCE.m2718getOffscreenNrFUSI()) ? 2 : 0;
    }
    ...
    public void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super Canvas, Unit> drawBlock) {
        ...
        if (clipPath != null) {
            androidCanvas.save();
            Canvas.m2601clipPathmtrdDE$default(androidCanvas, clipPath, 0, 2, null);
        }
