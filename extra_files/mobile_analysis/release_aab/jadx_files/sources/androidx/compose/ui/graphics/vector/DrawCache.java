...
public final class DrawCache {
    ...
    private long size = IntSize.INSTANCE.m5043getZeroYbymL2g();
    ...
    public final void m3250drawCachedImageCJJARo(long size, Density density, LayoutDirection layoutDirection, Function1<? super DrawScope, Unit> block) {
        ...
        if (imageBitmap == null || canvas == null || IntSize.m5038getWidthimpl(size) > imageBitmap.getWidth() || IntSize.m5037getHeightimpl(size) > imageBitmap.getHeight()) {
            imageBitmap = ImageBitmapKt.m2853ImageBitmapx__hDU$default(IntSize.m5038getWidthimpl(size), IntSize.m5037getHeightimpl(size), 0, false, null, 28, null);
        ...
        long m5048toSizeozmzZPI = IntSizeKt.m5048toSizeozmzZPI(size);
        ...
        drawParams2.m3098setSizeuvyYCjk(m5048toSizeozmzZPI);
        canvas.save();
    ...
    public final void drawInto(DrawScope target, float alpha, ColorFilter colorFilter) {
        ...
        DrawScope.m3158drawImageAZ2fEMs$default(target, imageBitmap, 0L, this.size, 0L, 0L, alpha, null, colorFilter, 0, 0, 858, null);
    }

    private final void clear(DrawScope drawScope) {
        DrawScope.m3169drawRectnJ9OG0$default(drawScope, Color.INSTANCE.m2656getBlack0d7_KjU(), 0L, 0L, 0.0f, null, null, BlendMode.INSTANCE.m2547getClear0nO6VwU(), 62, null);
    }
}
