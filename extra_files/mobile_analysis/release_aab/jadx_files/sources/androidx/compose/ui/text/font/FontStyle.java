...
public final class FontStyle {
    ...
    private static final int Normal = m4501constructorimpl(0);
    private static final int Italic = m4501constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FontStyle m4500boximpl(int i) {
    ...
    public static boolean m4502equalsimpl(int i, Object obj) {
        return (obj instanceof FontStyle) && i == ((FontStyle) obj).m4506unboximpl();
    }
    ...
    public static String m4505toStringimpl(int i) {
        return m4503equalsimpl0(i, Normal) ? "Normal" : m4503equalsimpl0(i, Italic) ? "Italic" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public final int m4508getNormal_LCdwA() {
            return FontStyle.Normal;
        }

        /* renamed from: getItalic-_-LCdwA, reason: not valid java name */
        public final int m4507getItalic_LCdwA() {
            return FontStyle.Italic;
        }

        public final List<FontStyle> values() {
            return CollectionsKt.listOf((Object[]) new FontStyle[]{FontStyle.m4500boximpl(m4508getNormal_LCdwA()), FontStyle.m4500boximpl(m4507getItalic_LCdwA())});
        }
    }
}
