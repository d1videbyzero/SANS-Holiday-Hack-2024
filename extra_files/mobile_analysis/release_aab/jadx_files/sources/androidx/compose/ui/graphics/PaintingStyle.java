...
public final class PaintingStyle {
    ...
    private static final int Fill = m2886constructorimpl(0);
    private static final int Stroke = m2886constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PaintingStyle m2885boximpl(int i) {
        return new PaintingStyle(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m2886constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2887equalsimpl(int i, Object obj) {
        return (obj instanceof PaintingStyle) && i == ((PaintingStyle) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2888equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m2889hashCodeimpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m2892getFillTiuSbCo() {
            return PaintingStyle.Fill;
        }

        /* renamed from: getStroke-TiuSbCo, reason: not valid java name */
        public final int m2893getStrokeTiuSbCo() {
    ...
    public static String m2890toStringimpl(int i) {
        return m2888equalsimpl0(i, Fill) ? "Fill" : m2888equalsimpl0(i, Stroke) ? "Stroke" : "Unknown";
    }
}
