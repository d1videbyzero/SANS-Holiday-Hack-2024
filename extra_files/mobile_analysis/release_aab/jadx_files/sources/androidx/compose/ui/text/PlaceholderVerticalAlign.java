...
public final class PlaceholderVerticalAlign {
    ...
    private static final int AboveBaseline = m4333constructorimpl(1);
    private static final int Top = m4333constructorimpl(2);
    private static final int Bottom = m4333constructorimpl(3);
    private static final int Center = m4333constructorimpl(4);
    private static final int TextTop = m4333constructorimpl(5);
    private static final int TextBottom = m4333constructorimpl(6);
    private static final int TextCenter = m4333constructorimpl(7);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PlaceholderVerticalAlign m4332boximpl(int i) {
    ...
    public static String m4337toStringimpl(int i) {
        return m4335equalsimpl0(i, AboveBaseline) ? "AboveBaseline" : m4335equalsimpl0(i, Top) ? "Top" : m4335equalsimpl0(i, Bottom) ? "Bottom" : m4335equalsimpl0(i, Center) ? "Center" : m4335equalsimpl0(i, TextTop) ? "TextTop" : m4335equalsimpl0(i, TextBottom) ? "TextBottom" : m4335equalsimpl0(i, TextCenter) ? "TextCenter" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public final int m4339getAboveBaselineJ6kI3mc() {
            return PlaceholderVerticalAlign.AboveBaseline;
        }

        /* renamed from: getTop-J6kI3mc, reason: not valid java name */
        public final int m4345getTopJ6kI3mc() {
            return PlaceholderVerticalAlign.Top;
        }

        /* renamed from: getBottom-J6kI3mc, reason: not valid java name */
        public final int m4340getBottomJ6kI3mc() {
            return PlaceholderVerticalAlign.Bottom;
        }

        /* renamed from: getCenter-J6kI3mc, reason: not valid java name */
        public final int m4341getCenterJ6kI3mc() {
            return PlaceholderVerticalAlign.Center;
        }

        /* renamed from: getTextTop-J6kI3mc, reason: not valid java name */
        public final int m4344getTextTopJ6kI3mc() {
            return PlaceholderVerticalAlign.TextTop;
        }

        /* renamed from: getTextBottom-J6kI3mc, reason: not valid java name */
        public final int m4342getTextBottomJ6kI3mc() {
            return PlaceholderVerticalAlign.TextBottom;
        }

        /* renamed from: getTextCenter-J6kI3mc, reason: not valid java name */
        public final int m4343getTextCenterJ6kI3mc() {
