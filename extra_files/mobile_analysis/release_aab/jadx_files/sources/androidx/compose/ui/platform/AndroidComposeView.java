...
public final class AndroidComposeView extends ViewGroup implements Owner, ViewRootForTest, PositionCalculator, DefaultLifecycleObserver {
    ...
    public AndroidComposeView(Context context, CoroutineContext coroutineContext) {
        ...
        this.lastDownPointerPosition = Offset.INSTANCE.m2406getUnspecifiedF1C5BW0();
        ...
        Modifier onKeyEvent = KeyInputModifierKt.onKeyEvent(Modifier.INSTANCE, new Function1<KeyEvent, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m4165invokeZmokQxo(keyEvent.m3606unboximpl());
            }

            /* renamed from: invoke-ZmokQxo, reason: not valid java name */
            public final Boolean m4165invokeZmokQxo(android.view.KeyEvent it) {
                Intrinsics.checkNotNullParameter(it, "it");
                FocusDirection mo4136getFocusDirectionP8AzH3I = AndroidComposeView.this.mo4136getFocusDirectionP8AzH3I(it);
                if (mo4136getFocusDirectionP8AzH3I == null || !KeyEventType.m3610equalsimpl0(KeyEvent_androidKt.m3618getTypeZmokQxo(it), KeyEventType.INSTANCE.m3614getKeyDownCS__XNY())) {
                    return false;
                }
                return Boolean.valueOf(AndroidComposeView.this.getFocusOwner().mo2328moveFocus3ESFkO8(mo4136getFocusDirectionP8AzH3I.getValue()));
            }
        });
        ...
        this.viewToWindowMatrix = Matrix.m2856constructorimpl$default(null, 1, null);
        this.windowToViewMatrix = Matrix.m2856constructorimpl$default(null, 1, null);
        this.lastMatrixRecalculationAnimationTime = -1L;
        this.windowPosition = Offset.INSTANCE.m2405getInfiniteF1C5BW0();
        ...
        this._inputModeManager = new InputModeManagerImpl(isInTouchMode() ? InputMode.INSTANCE.m3300getTouchaOaMEAU() : InputMode.INSTANCE.m3299getKeyboardaOaMEAU(), new Function1<InputMode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$_inputModeManager$1
            {
                super(1);
            }
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(InputMode inputMode) {
                return m4164invokeiuPiT84(inputMode.getValue());
            }

            /* renamed from: invoke-iuPiT84, reason: not valid java name */
            public final Boolean m4164invokeiuPiT84(int i) {
                boolean requestFocusFromTouch;
                if (InputMode.m3295equalsimpl0(i, InputMode.INSTANCE.m3300getTouchaOaMEAU())) {
                    requestFocusFromTouch = AndroidComposeView.this.isInTouchMode();
                } else {
                    requestFocusFromTouch = InputMode.m3295equalsimpl0(i, InputMode.INSTANCE.m3299getKeyboardaOaMEAU()) ? AndroidComposeView.this.isInTouchMode() ? AndroidComposeView.this.requestFocusFromTouch() : true : false;
                }
    ...
    public static final void touchModeChangeListener$lambda$3(AndroidComposeView this$0, boolean z) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0._inputModeManager.m3303setInputModeiuPiT84(z ? InputMode.INSTANCE.m3300getTouchaOaMEAU() : InputMode.INSTANCE.m3299getKeyboardaOaMEAU());
    }
    ...
    public static final void sendHoverExitEvent$lambda$5(AndroidComposeView this$0) {
        ...
        this$0.m4163sendMotionEvent8iAsVTc(motionEvent);
    }
    ...
    public boolean mo4138sendKeyEventZmokQxo(android.view.KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "keyEvent");
        return getFocusOwner().mo2329dispatchInterceptedSoftKeyboardEventZmokQxo(keyEvent) || getFocusOwner().mo2330dispatchKeyEventZmokQxo(keyEvent);
    }
    ...
    public boolean dispatchKeyEvent(android.view.KeyEvent event) {
        ...
        if (isFocused()) {
            this._windowInfo.m4232setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m3812constructorimpl(event.getMetaState()));
            return getFocusOwner().mo2330dispatchKeyEventZmokQxo(KeyEvent.m3601constructorimpl(event)) || super.dispatchKeyEvent(event);
        }
    ...
    public boolean dispatchKeyEventPreIme(android.view.KeyEvent event) {
        Intrinsics.checkNotNullParameter(event, "event");
        return (isFocused() && getFocusOwner().mo2329dispatchInterceptedSoftKeyboardEventZmokQxo(KeyEvent.m3601constructorimpl(event))) || super.dispatchKeyEventPreIme(event);
    }
                    ...
                    androidx.compose.ui.platform.AndroidComposeView$addAndroidView$1$onInitializeAccessibilityNodeInfo$parentId$1 r0 = new kotlin.jvm.functions.Function1<androidx.compose.ui.node.LayoutNode, java.lang.Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$addAndroidView$1$onInitializeAccessibilityNodeInfo$parentId$1
                        ...
                        public final java.lang.Boolean invoke(androidx.compose.ui.node.LayoutNode r2) {
                            /*
                                ...
                                r0 = 8
                                int r0 = androidx.compose.ui.node.NodeKind.m4082constructorimpl(r0)
                                boolean r2 = r2.m4045hasH91voCI$ui_release(r0)
    ...
    public void mo4137measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        Intrinsics.checkNotNullParameter(layoutNode, "layoutNode");
        Trace.beginSection("AndroidOwner:measureAndLayout");
        try {
            this.measureAndLayoutDelegate.m4038measureAndLayout0kLqBqw(layoutNode, constraints);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:21:0x0058, code lost:
        ...
        if (androidx.compose.ui.unit.Constraints.m4827equalsimpl0(r0.getValue(), r8) == false) goto L13;
     */
    @Override // android.view.View
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    ...
    */
    protected void onMeasure(int r8, int r9) {
        ...
        L12:
            long r0 = r7.m4160convertMeasureSpecI7RO_PI(r8)     // Catch: java.lang.Throwable -> La5
            r8 = 32
            long r2 = r0 >>> r8
            long r2 = kotlin.ULong.m5340constructorimpl(r2)     // Catch: java.lang.Throwable -> La5
            int r2 = (int) r2     // Catch: java.lang.Throwable -> La5
            r3 = 4294967295(0xffffffff, double:2.1219957905E-314)
            long r0 = r0 & r3
            long r0 = kotlin.ULong.m5340constructorimpl(r0)     // Catch: java.lang.Throwable -> La5
            int r0 = (int) r0     // Catch: java.lang.Throwable -> La5
            long r5 = r7.m4160convertMeasureSpecI7RO_PI(r9)     // Catch: java.lang.Throwable -> La5
            long r8 = r5 >>> r8
            long r8 = kotlin.ULong.m5340constructorimpl(r8)     // Catch: java.lang.Throwable -> La5
            int r8 = (int) r8     // Catch: java.lang.Throwable -> La5
            long r3 = r3 & r5
            long r3 = kotlin.ULong.m5340constructorimpl(r3)     // Catch: java.lang.Throwable -> La5
            ...
            if (r0 != 0) goto L4d
            androidx.compose.ui.unit.Constraints r0 = androidx.compose.ui.unit.Constraints.m4822boximpl(r8)     // Catch: java.lang.Throwable -> La5
        ...
        L50:
            ...
            boolean r0 = androidx.compose.ui.unit.Constraints.m4827equalsimpl0(r0, r8)     // Catch: java.lang.Throwable -> La5
            if (r0 != 0) goto L5d
        L5a:
            r0 = 1
            r7.wasMeasuredWithMultipleConstraints = r0     // Catch: java.lang.Throwable -> La5
        L5d:
            ...
            r0.m4039updateRootConstraintsBRTryo0(r8)     // Catch: java.lang.Throwable -> La5
    ...
    private final int m4158component1VKZWuLQ(long j) {
        return (int) ULong.m5340constructorimpl(j >>> 32);
    }

    /* renamed from: component2-VKZWuLQ, reason: not valid java name */
    private final int m4159component2VKZWuLQ(long j) {
        return (int) ULong.m5340constructorimpl(j & 4294967295L);
    }

    /* renamed from: pack-ZIaKswc, reason: not valid java name */
    private final long m4162packZIaKswc(int a, int b) {
        return ULong.m5340constructorimpl(ULong.m5340constructorimpl(b) | ULong.m5340constructorimpl(ULong.m5340constructorimpl(a) << 32));
    }

    /* renamed from: convertMeasureSpec-I7RO_PI, reason: not valid java name */
    private final long m4160convertMeasureSpecI7RO_PI(int measureSpec) {
        int mode = View.MeasureSpec.getMode(measureSpec);
        int size = View.MeasureSpec.getSize(measureSpec);
        if (mode == Integer.MIN_VALUE) {
            return m4162packZIaKswc(0, size);
        }
        if (mode == 0) {
            return m4162packZIaKswc(0, Integer.MAX_VALUE);
        }
        if (mode == 1073741824) {
            return m4162packZIaKswc(size, size);
        }
    ...
    private final void updatePositionCacheAndDispatch() {
        ...
        int m4988component1impl = IntOffset.m4988component1impl(j);
        int m4989component2impl = IntOffset.m4989component2impl(j);
        int[] iArr = this.tmpPositionArray;
        boolean z = false;
        int i = iArr[0];
        if (m4988component1impl != i || m4989component2impl != iArr[1]) {
            this.globalPosition = IntOffsetKt.IntOffset(i, iArr[1]);
            if (m4988component1impl != Integer.MAX_VALUE && m4989component2impl != Integer.MAX_VALUE) {
    ...
    public FocusDirection mo4136getFocusDirectionP8AzH3I(android.view.KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "keyEvent");
        long m3617getKeyZmokQxo = KeyEvent_androidKt.m3617getKeyZmokQxo(keyEvent);
        if (Key.m3309equalsimpl0(m3617getKeyZmokQxo, Key.INSTANCE.m3545getTabEK5gGoQ())) {
            return FocusDirection.m2307boximpl(KeyEvent_androidKt.m3623isShiftPressedZmokQxo(keyEvent) ? FocusDirection.INSTANCE.m2325getPreviousdhqQ8s() : FocusDirection.INSTANCE.m2323getNextdhqQ8s());
        }
        if (Key.m3309equalsimpl0(m3617getKeyZmokQxo, Key.INSTANCE.m3386getDirectionRightEK5gGoQ())) {
            return FocusDirection.m2307boximpl(FocusDirection.INSTANCE.m2326getRightdhqQ8s());
        }
        if (Key.m3309equalsimpl0(m3617getKeyZmokQxo, Key.INSTANCE.m3385getDirectionLeftEK5gGoQ())) {
            return FocusDirection.m2307boximpl(FocusDirection.INSTANCE.m2322getLeftdhqQ8s());
        }
        if (Key.m3309equalsimpl0(m3617getKeyZmokQxo, Key.INSTANCE.m3387getDirectionUpEK5gGoQ())) {
            return FocusDirection.m2307boximpl(FocusDirection.INSTANCE.m2327getUpdhqQ8s());
        }
        if (Key.m3309equalsimpl0(m3617getKeyZmokQxo, Key.INSTANCE.m3382getDirectionDownEK5gGoQ())) {
            return FocusDirection.m2307boximpl(FocusDirection.INSTANCE.m2318getDowndhqQ8s());
        }
        if (Key.m3309equalsimpl0(m3617getKeyZmokQxo, Key.INSTANCE.m3381getDirectionCenterEK5gGoQ()) || Key.m3309equalsimpl0(m3617getKeyZmokQxo, Key.INSTANCE.m3395getEnterEK5gGoQ()) || Key.m3309equalsimpl0(m3617getKeyZmokQxo, Key.INSTANCE.m3487getNumPadEnterEK5gGoQ())) {
            return FocusDirection.m2307boximpl(FocusDirection.INSTANCE.m2319getEnterdhqQ8s());
        }
        if (Key.m3309equalsimpl0(m3617getKeyZmokQxo, Key.INSTANCE.m3324getBackEK5gGoQ()) || Key.m3309equalsimpl0(m3617getKeyZmokQxo, Key.INSTANCE.m3398getEscapeEK5gGoQ())) {
            return FocusDirection.m2307boximpl(FocusDirection.INSTANCE.m2320getExitdhqQ8s());
        }
        return null;
    }
    ...
    protected void onAttachedToWindow() {
        ...
        this._inputModeManager.m3303setInputModeiuPiT84(isInTouchMode() ? InputMode.INSTANCE.m3300getTouchaOaMEAU() : InputMode.INSTANCE.m3299getKeyboardaOaMEAU());
    ...
    public boolean dispatchGenericMotionEvent(MotionEvent event) {
        ...
        if (event.getActionMasked() == 8) {
            ...
            return ProcessResult.m3837getDispatchedToAPointerInputModifierimpl(m4161handleMotionEvent8iAsVTc(event));
        }
        return super.dispatchGenericMotionEvent(event);
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        int m4161handleMotionEvent8iAsVTc = m4161handleMotionEvent8iAsVTc(motionEvent);
        if (ProcessResult.m3836getAnyMovementConsumedimpl(m4161handleMotionEvent8iAsVTc)) {
            getParent().requestDisallowInterceptTouchEvent(true);
        }
        return ProcessResult.m3837getDispatchedToAPointerInputModifierimpl(m4161handleMotionEvent8iAsVTc);
    }
    ...
    private final int m4161handleMotionEvent8iAsVTc(MotionEvent motionEvent) {
        ...
        try {
            ...
            try {
                ...
                return m4163sendMotionEvent8iAsVTc(motionEvent);
            } finally {
                Trace.endSection();
            }
        } finally {
    ...
    private final int m4163sendMotionEvent8iAsVTc(MotionEvent motionEvent) {
        PointerInputEventData pointerInputEventData;
        if (this.keyboardModifiersRequireUpdate) {
            this.keyboardModifiersRequireUpdate = false;
            this._windowInfo.m4232setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m3812constructorimpl(motionEvent.getMetaState()));
        }
        AndroidComposeView androidComposeView = this;
        ...
        if (convertToPointerInputEvent$ui_release != null) {
            ...
            if (pointerInputEventData2 != null) {
                this.lastDownPointerPosition = pointerInputEventData2.m3764getPositionF1C5BW0();
            }
            int m3769processBIzXfog = this.pointerInputEventProcessor.m3769processBIzXfog(convertToPointerInputEvent$ui_release, androidComposeView, isInBounds(motionEvent));
            int actionMasked = motionEvent.getActionMasked();
            if ((actionMasked != 0 && actionMasked != 5) || ProcessResult.m3837getDispatchedToAPointerInputModifierimpl(m3769processBIzXfog)) {
                return m3769processBIzXfog;
            }
    ...
    public final void sendSimulatedEvent(MotionEvent motionEvent, int action, long eventTime, boolean forceHover) {
        ...
        while (i4 < pointerCount) {
            ...
            long mo3830localToScreenMKHz9U = mo3830localToScreenMKHz9U(OffsetKt.Offset(pointerCoords.x, pointerCoords.y));
            pointerCoords.x = Offset.m2391getXimpl(mo3830localToScreenMKHz9U);
            pointerCoords.y = Offset.m2392getYimpl(mo3830localToScreenMKHz9U);
            i4++;
        }
        ...
        this.pointerInputEventProcessor.m3769processBIzXfog(convertToPointerInputEvent$ui_release, androidComposeView, true);
        event.recycle();
    }

    @Override // android.view.View
    public boolean canScrollHorizontally(int direction) {
        return this.accessibilityDelegate.m4168canScroll0AR0LA0$ui_release(false, direction, this.lastDownPointerPosition);
    }

    @Override // android.view.View
    public boolean canScrollVertically(int direction) {
        return this.accessibilityDelegate.m4168canScroll0AR0LA0$ui_release(true, direction, this.lastDownPointerPosition);
    }
    ...
    public long mo3830localToScreenMKHz9U(long localPosition) {
        recalculateWindowPosition();
        long m2862mapMKHz9U = Matrix.m2862mapMKHz9U(this.viewToWindowMatrix, localPosition);
        return OffsetKt.Offset(Offset.m2391getXimpl(m2862mapMKHz9U) + Offset.m2391getXimpl(this.windowPosition), Offset.m2392getYimpl(m2862mapMKHz9U) + Offset.m2392getYimpl(this.windowPosition));
    }

    @Override // androidx.compose.ui.input.pointer.PositionCalculator
    /* renamed from: screenToLocal-MK-Hz9U */
    public long mo3831screenToLocalMKHz9U(long positionOnScreen) {
        recalculateWindowPosition();
        return Matrix.m2862mapMKHz9U(this.windowToViewMatrix, OffsetKt.Offset(Offset.m2391getXimpl(positionOnScreen) - Offset.m2391getXimpl(this.windowPosition), Offset.m2392getYimpl(positionOnScreen) - Offset.m2392getYimpl(this.windowPosition)));
    }
    ...
    private final void recalculateWindowPosition(MotionEvent motionEvent) {
        ...
        recalculateWindowViewTransforms();
        long m2862mapMKHz9U = Matrix.m2862mapMKHz9U(this.viewToWindowMatrix, OffsetKt.Offset(motionEvent.getX(), motionEvent.getY()));
        this.windowPosition = OffsetKt.Offset(motionEvent.getRawX() - Offset.m2391getXimpl(m2862mapMKHz9U), motionEvent.getRawY() - Offset.m2392getYimpl(m2862mapMKHz9U));
    }

    private final void recalculateWindowViewTransforms() {
        this.matrixToWindow.mo4175calculateMatrixToWindowEL8BTi8(this, this.viewToWindowMatrix);
        InvertMatrixKt.m4199invertToJiSxe2E(this.viewToWindowMatrix, this.windowToViewMatrix);
    }
    ...
    public long mo4134calculateLocalPositionMKHz9U(long positionInWindow) {
        recalculateWindowPosition();
        return Matrix.m2862mapMKHz9U(this.windowToViewMatrix, positionInWindow);
    }

    @Override // androidx.compose.ui.node.Owner
    /* renamed from: calculatePositionInWindow-MK-Hz9U */
    public long mo4135calculatePositionInWindowMKHz9U(long localPosition) {
        recalculateWindowPosition();
        return Matrix.m2862mapMKHz9U(this.viewToWindowMatrix, localPosition);
    }
