...
public interface BeyondBoundsLayout {
    ...
    public static final class LayoutDirection {
        ...
        private static final int Before = m3846constructorimpl(1);
        private static final int After = m3846constructorimpl(2);
        private static final int Left = m3846constructorimpl(3);
        private static final int Right = m3846constructorimpl(4);
        private static final int Above = m3846constructorimpl(5);
        private static final int Below = m3846constructorimpl(6);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ LayoutDirection m3845boximpl(int i) {
            return new LayoutDirection(i);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static int m3846constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m3847equalsimpl(int i, Object obj) {
            return (obj instanceof LayoutDirection) && i == ((LayoutDirection) obj).getValue();
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m3848equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m3849hashCodeimpl(int i) {
        ...
        public static final class Companion {
            ...
            public final int m3854getBeforehoxUOeE() {
                return LayoutDirection.Before;
            }

            /* renamed from: getAfter-hoxUOeE, reason: not valid java name */
            public final int m3853getAfterhoxUOeE() {
                return LayoutDirection.After;
            }

            /* renamed from: getLeft-hoxUOeE, reason: not valid java name */
            public final int m3856getLefthoxUOeE() {
                return LayoutDirection.Left;
            }

            /* renamed from: getRight-hoxUOeE, reason: not valid java name */
            public final int m3857getRighthoxUOeE() {
                return LayoutDirection.Right;
            }

            /* renamed from: getAbove-hoxUOeE, reason: not valid java name */
            public final int m3852getAbovehoxUOeE() {
                return LayoutDirection.Above;
            }

            /* renamed from: getBelow-hoxUOeE, reason: not valid java name */
            public final int m3855getBelowhoxUOeE() {
                return LayoutDirection.Below;
            }
        }

        public String toString() {
            return m3850toStringimpl(this.value);
        }

        /* renamed from: toString-impl, reason: not valid java name */
        public static String m3850toStringimpl(int i) {
            return m3848equalsimpl0(i, Before) ? "Before" : m3848equalsimpl0(i, After) ? "After" : m3848equalsimpl0(i, Left) ? "Left" : m3848equalsimpl0(i, Right) ? "Right" : m3848equalsimpl0(i, Above) ? "Above" : m3848equalsimpl0(i, Below) ? "Below" : "invalid LayoutDirection";
        }
    }
}
