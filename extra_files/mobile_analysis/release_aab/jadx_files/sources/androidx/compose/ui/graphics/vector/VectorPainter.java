...
public final class VectorPainter extends Painter {
    ...
    private final MutableState size = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m2448boximpl(Size.INSTANCE.m2469getZeroNHjbRc()), null, 2, null);
    ...
    public final long m3269getSizeNHjbRc$ui_release() {
        return ((Size) this.size.getValue()).getPackedValue();
    }

    /* renamed from: setSize-uvyYCjk$ui_release, reason: not valid java name */
    public final void m3270setSizeuvyYCjk$ui_release(long j) {
        this.size.setValue(Size.m2448boximpl(j));
    }
    ...
    public long getIntrinsicSize() {
        return m3269getSizeNHjbRc$ui_release();
    }
