...
public interface ContentScale {
    ...
    long mo3859computeScaleFactorH7hwNQA(long srcSize, long dstSize);
    ...
    public static final class Companion {
        ...
        private static final ContentScale Crop = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Crop$1
            ...
            public long mo3859computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m3865computeFillMaxDimensioniLBOSCw;
                m3865computeFillMaxDimensioniLBOSCw = ContentScaleKt.m3865computeFillMaxDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(m3865computeFillMaxDimensioniLBOSCw, m3865computeFillMaxDimensioniLBOSCw);
            }
        };
        private static final ContentScale Fit = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Fit$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo3859computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m3866computeFillMinDimensioniLBOSCw;
                m3866computeFillMinDimensioniLBOSCw = ContentScaleKt.m3866computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(m3866computeFillMinDimensioniLBOSCw, m3866computeFillMinDimensioniLBOSCw);
            }
        };
        private static final ContentScale FillHeight = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillHeight$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo3859computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m3864computeFillHeightiLBOSCw;
                m3864computeFillHeightiLBOSCw = ContentScaleKt.m3864computeFillHeightiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(m3864computeFillHeightiLBOSCw, m3864computeFillHeightiLBOSCw);
            }
        };
        private static final ContentScale FillWidth = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillWidth$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo3859computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m3867computeFillWidthiLBOSCw;
                m3867computeFillWidthiLBOSCw = ContentScaleKt.m3867computeFillWidthiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(m3867computeFillWidthiLBOSCw, m3867computeFillWidthiLBOSCw);
            }
        };
        private static final ContentScale Inside = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Inside$1
            ...
            public long mo3859computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m3866computeFillMinDimensioniLBOSCw;
                if (Size.m2460getWidthimpl(srcSize) > Size.m2460getWidthimpl(dstSize) || Size.m2457getHeightimpl(srcSize) > Size.m2457getHeightimpl(dstSize)) {
                    m3866computeFillMinDimensioniLBOSCw = ContentScaleKt.m3866computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                    return ScaleFactorKt.ScaleFactor(m3866computeFillMinDimensioniLBOSCw, m3866computeFillMinDimensioniLBOSCw);
                }
        ...
        private static final ContentScale FillBounds = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillBounds$1
            ...
            public long mo3859computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                ...
                m3867computeFillWidthiLBOSCw = ContentScaleKt.m3867computeFillWidthiLBOSCw(srcSize, dstSize);
                m3864computeFillHeightiLBOSCw = ContentScaleKt.m3864computeFillHeightiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(m3867computeFillWidthiLBOSCw, m3864computeFillHeightiLBOSCw);
            }
        };
