...
public final /* data */ class BiasAlignment implements Alignment {
    ...
    public long mo2281alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        ...
        float m5038getWidthimpl = (IntSize.m5038getWidthimpl(space) - IntSize.m5038getWidthimpl(size)) / 2.0f;
        float m5037getHeightimpl = (IntSize.m5037getHeightimpl(space) - IntSize.m5037getHeightimpl(size)) / 2.0f;
        ...
        float f2 = 1;
        return IntOffsetKt.IntOffset(MathKt.roundToInt(m5038getWidthimpl * (f + f2)), MathKt.roundToInt(m5037getHeightimpl * (f2 + this.verticalBias)));
    }
