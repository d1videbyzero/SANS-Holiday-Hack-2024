...
public final /* data */ class BiasAbsoluteAlignment implements Alignment {
    ...
    public long mo2281alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        long IntSize = IntSizeKt.IntSize(IntSize.m5038getWidthimpl(space) - IntSize.m5038getWidthimpl(size), IntSize.m5037getHeightimpl(space) - IntSize.m5037getHeightimpl(size));
        float f = 1;
        return IntOffsetKt.IntOffset(MathKt.roundToInt((IntSize.m5038getWidthimpl(IntSize) / 2.0f) * (this.horizontalBias + f)), MathKt.roundToInt((IntSize.m5037getHeightimpl(IntSize) / 2.0f) * (f + this.verticalBias)));
    }
