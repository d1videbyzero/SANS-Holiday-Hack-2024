...
public final class MeasureAndLayoutDelegate {
    ...
    public final void m4039updateRootConstraintsBRTryo0(long constraints) {
        Constraints constraints2 = this.rootConstraints;
        if (constraints2 != null && Constraints.m4827equalsimpl0(constraints2.getValue(), constraints)) {
            return;
        }
        if (!(!this.duringMeasureLayout)) {
            throw new IllegalArgumentException("Failed requirement.".toString());
        }
        this.rootConstraints = Constraints.m4822boximpl(constraints);
    ...
    private final boolean m4036doLookaheadRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean m4005lookaheadRemeasure_Sx5XlM$ui_release$default;
        if (layoutNode.getLookaheadRoot() == null) {
            return false;
        }
        if (constraints != null) {
            m4005lookaheadRemeasure_Sx5XlM$ui_release$default = layoutNode.m4009lookaheadRemeasure_Sx5XlM$ui_release(constraints);
        } else {
            m4005lookaheadRemeasure_Sx5XlM$ui_release$default = LayoutNode.m4005lookaheadRemeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (m4005lookaheadRemeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
        ...
        return m4005lookaheadRemeasure_Sx5XlM$ui_release$default;
    }

    /* renamed from: doRemeasure-sdFAvZA, reason: not valid java name */
    private final boolean m4037doRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean m4006remeasure_Sx5XlM$ui_release$default;
        if (constraints != null) {
            m4006remeasure_Sx5XlM$ui_release$default = layoutNode.m4010remeasure_Sx5XlM$ui_release(constraints);
        } else {
            m4006remeasure_Sx5XlM$ui_release$default = LayoutNode.m4006remeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (m4006remeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
        ...
        return m4006remeasure_Sx5XlM$ui_release$default;
    }
    ...
    public final void m4038measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        Intrinsics.checkNotNullParameter(layoutNode, "layoutNode");
        ...
        if (this.rootConstraints != null) {
            ...
            try {
                ...
                boolean m4036doLookaheadRemeasuresdFAvZA = m4036doLookaheadRemeasuresdFAvZA(layoutNode, Constraints.m4822boximpl(constraints));
                m4037doRemeasuresdFAvZA(layoutNode, Constraints.m4822boximpl(constraints));
                if ((m4036doLookaheadRemeasuresdFAvZA || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true)) {
    ...
    public final boolean remeasureAndRelayoutIfNeeded(LayoutNode layoutNode, boolean affectsLookahead) {
        ...
        boolean m4036doLookaheadRemeasuresdFAvZA;
        boolean m4037doRemeasuresdFAvZA;
        int i = 0;
        ...
        if (layoutNode.getLookaheadMeasurePending$ui_release() || layoutNode.getMeasurePending$ui_release()) {
            ...
            m4036doLookaheadRemeasuresdFAvZA = (layoutNode.getLookaheadMeasurePending$ui_release() && affectsLookahead) ? m4036doLookaheadRemeasuresdFAvZA(layoutNode, constraints) : false;
            m4037doRemeasuresdFAvZA = m4037doRemeasuresdFAvZA(layoutNode, constraints);
        } else {
            m4037doRemeasuresdFAvZA = false;
            m4036doLookaheadRemeasuresdFAvZA = false;
        }
        if ((m4036doLookaheadRemeasuresdFAvZA || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true) && affectsLookahead) {
            layoutNode.lookaheadReplace$ui_release();
        }
        if (layoutNode.getLayoutPending$ui_release() && layoutNode.isPlaced()) {
            if (layoutNode == this.root) {
        ...
        return m4037doRemeasuresdFAvZA;
    }
    ...
    private final void remeasureOnly(LayoutNode layoutNode) {
        ...
        if (layoutNode.getMeasurePending$ui_release() || layoutNode.getLookaheadMeasurePending$ui_release()) {
            ...
            if (layoutNode.getLookaheadMeasurePending$ui_release()) {
                m4036doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
            }
            m4037doRemeasuresdFAvZA(layoutNode, constraints);
        }
    }
