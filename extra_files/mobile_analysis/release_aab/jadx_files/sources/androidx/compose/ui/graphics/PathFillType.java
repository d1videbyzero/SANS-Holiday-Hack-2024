...
public final class PathFillType {
    ...
    private static final int NonZero = m2901constructorimpl(0);
    private static final int EvenOdd = m2901constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PathFillType m2900boximpl(int i) {
        return new PathFillType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m2901constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2902equalsimpl(int i, Object obj) {
        return (obj instanceof PathFillType) && i == ((PathFillType) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2903equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m2904hashCodeimpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m2908getNonZeroRgk1Os() {
            return PathFillType.NonZero;
        }

        /* renamed from: getEvenOdd-Rg-k1Os, reason: not valid java name */
        public final int m2907getEvenOddRgk1Os() {
    ...
    public static String m2905toStringimpl(int i) {
        return m2903equalsimpl0(i, NonZero) ? "NonZero" : m2903equalsimpl0(i, EvenOdd) ? "EvenOdd" : "Unknown";
    }
}
