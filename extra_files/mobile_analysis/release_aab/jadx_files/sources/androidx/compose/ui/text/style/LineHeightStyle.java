...
public final class LineHeightStyle {
    ...
    static {
        ...
        Default = new LineHeightStyle(Alignment.INSTANCE.m4750getProportionalPIaL0Z0(), Trim.INSTANCE.m4761getBothEVpEnUU(), defaultConstructorMarker);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Alignment.m4744equalsimpl0(this.alignment, lineHeightStyle.alignment) && Trim.m4755equalsimpl0(this.trim, lineHeightStyle.trim);
    }

    public int hashCode() {
        return (Alignment.m4745hashCodeimpl(this.alignment) * 31) + Trim.m4756hashCodeimpl(this.trim);
    }

    public String toString() {
        return "LineHeightStyle(alignment=" + ((Object) Alignment.m4746toStringimpl(this.alignment)) + ", trim=" + ((Object) Trim.m4759toStringimpl(this.trim)) + ')';
    }
    ...
    public static final class Trim {
        ...
        private static final int FirstLineTop = m4753constructorimpl(1);
        private static final int LastLineBottom = m4753constructorimpl(16);
        private static final int Both = m4753constructorimpl(17);
        private static final int None = m4753constructorimpl(0);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Trim m4752boximpl(int i) {
            return new Trim(i);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        private static int m4753constructorimpl(int i) {
            return i;
        }
        ...
        public static final boolean m4755equalsimpl0(int i, int i2) {
            return i == i2;
        }
        ...
        public static final boolean m4757isTrimFirstLineTopimpl$ui_text_release(int i) {
            return (i & 1) > 0;
        }

        /* renamed from: isTrimLastLineBottom-impl$ui_text_release, reason: not valid java name */
        public static final boolean m4758isTrimLastLineBottomimpl$ui_text_release(int i) {
            return (i & 16) > 0;
        }
        ...
        public String toString() {
            return m4759toStringimpl(this.value);
        }
        ...
        public static final class Companion {
            ...
            public final int m4762getFirstLineTopEVpEnUU() {
                return Trim.FirstLineTop;
            }

            /* renamed from: getLastLineBottom-EVpEnUU, reason: not valid java name */
            public final int m4763getLastLineBottomEVpEnUU() {
                return Trim.LastLineBottom;
            }

            /* renamed from: getBoth-EVpEnUU, reason: not valid java name */
            public final int m4761getBothEVpEnUU() {
                return Trim.Both;
            }

            /* renamed from: getNone-EVpEnUU, reason: not valid java name */
            public final int m4764getNoneEVpEnUU() {
                return Trim.None;
            }
        }
    }
    ...
    public static final class Alignment {
        ...
        /* renamed from: Companion, reason: from kotlin metadata */
        public static final Companion INSTANCE = new Companion(null);
        private static final float Top = m4742constructorimpl(0.0f);
        private static final float Center = m4742constructorimpl(0.5f);
        private static final float Proportional = m4742constructorimpl(-1.0f);
        private static final float Bottom = m4742constructorimpl(1.0f);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Alignment m4741boximpl(float f) {
            return new Alignment(f);
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m4743equalsimpl(float f, Object obj) {
            return (obj instanceof Alignment) && Float.compare(f, ((Alignment) obj).getTopRatio()) == 0;
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m4744equalsimpl0(float f, float f2) {
            return Float.compare(f, f2) == 0;
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m4745hashCodeimpl(float f) {
            return Float.hashCode(f);
        }

        public boolean equals(Object obj) {
            return m4743equalsimpl(this.topRatio, obj);
        }

        public int hashCode() {
            return m4745hashCodeimpl(this.topRatio);
        }
        ...
        /* renamed from: constructor-impl, reason: not valid java name */
        public static float m4742constructorimpl(float f) {
        ...
        public String toString() {
            return m4746toStringimpl(this.topRatio);
        }

        /* renamed from: toString-impl, reason: not valid java name */
        public static String m4746toStringimpl(float f) {
        ...
        public static final class Companion {
            ...
            public final float m4751getTopPIaL0Z0() {
                return Alignment.Top;
            }

            /* renamed from: getCenter-PIaL0Z0, reason: not valid java name */
            public final float m4749getCenterPIaL0Z0() {
                return Alignment.Center;
            }

            /* renamed from: getProportional-PIaL0Z0, reason: not valid java name */
            public final float m4750getProportionalPIaL0Z0() {
                return Alignment.Proportional;
            }

            /* renamed from: getBottom-PIaL0Z0, reason: not valid java name */
            public final float m4748getBottomPIaL0Z0() {
