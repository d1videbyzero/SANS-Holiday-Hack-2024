...
public final class KeyEventType {
    ...
    private static final int Unknown = m3608constructorimpl(0);
    private static final int KeyUp = m3608constructorimpl(1);
    private static final int KeyDown = m3608constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ KeyEventType m3607boximpl(int i) {
    ...
    public static String m3612toStringimpl(int i) {
        return m3610equalsimpl0(i, KeyUp) ? "KeyUp" : m3610equalsimpl0(i, KeyDown) ? "KeyDown" : m3610equalsimpl0(i, Unknown) ? "Unknown" : "Invalid";
    }
