...
public abstract class FontFamily {
    ...
    public interface Resolver {
        ...
        State<Object> mo4478resolveDPcqOEQ(FontFamily fontFamily, FontWeight fontWeight, int fontStyle, int fontSynthesis);

        /* renamed from: resolve-DPcqOEQ$default, reason: not valid java name */
        static /* synthetic */ State m4477resolveDPcqOEQ$default(Resolver resolver, FontFamily fontFamily, FontWeight fontWeight, int i, int i2, int i3, Object obj) {
            if (obj != null) {
            ...
            return resolver.mo4478resolveDPcqOEQ(fontFamily, fontWeight, i, i2);
        }
    }
