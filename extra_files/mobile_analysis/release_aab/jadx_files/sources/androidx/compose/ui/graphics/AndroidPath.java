...
public final class AndroidPath implements Path {
    ...
    public int mo2523getFillTypeRgk1Os() {
        if (this.internalPath.getFillType() == Path.FillType.EVEN_ODD) {
            return PathFillType.INSTANCE.m2907getEvenOddRgk1Os();
        }
        return PathFillType.INSTANCE.m2908getNonZeroRgk1Os();
    }

    @Override // androidx.compose.ui.graphics.Path
    /* renamed from: setFillType-oQ8Xj4U, reason: not valid java name */
    public void mo2525setFillTypeoQ8Xj4U(int i) {
        Path.FillType fillType;
        android.graphics.Path path = this.internalPath;
        if (PathFillType.m2903equalsimpl0(i, PathFillType.INSTANCE.m2907getEvenOddRgk1Os())) {
    ...
    public void addRoundRect(RoundRect roundRect) {
        ...
        this.radii[0] = CornerRadius.m2366getXimpl(roundRect.m2441getTopLeftCornerRadiuskKHJgLs());
        this.radii[1] = CornerRadius.m2367getYimpl(roundRect.m2441getTopLeftCornerRadiuskKHJgLs());
        this.radii[2] = CornerRadius.m2366getXimpl(roundRect.m2442getTopRightCornerRadiuskKHJgLs());
        this.radii[3] = CornerRadius.m2367getYimpl(roundRect.m2442getTopRightCornerRadiuskKHJgLs());
        this.radii[4] = CornerRadius.m2366getXimpl(roundRect.m2440getBottomRightCornerRadiuskKHJgLs());
        this.radii[5] = CornerRadius.m2367getYimpl(roundRect.m2440getBottomRightCornerRadiuskKHJgLs());
        this.radii[6] = CornerRadius.m2366getXimpl(roundRect.m2439getBottomLeftCornerRadiuskKHJgLs());
        this.radii[7] = CornerRadius.m2367getYimpl(roundRect.m2439getBottomLeftCornerRadiuskKHJgLs());
        this.internalPath.addRoundRect(this.rectF, this.radii, Path.Direction.CCW);
    }

    @Override // androidx.compose.ui.graphics.Path
    /* renamed from: addPath-Uv8p0NA, reason: not valid java name */
    public void mo2522addPathUv8p0NA(Path path, long offset) {
        Intrinsics.checkNotNullParameter(path, "path");
        android.graphics.Path path2 = this.internalPath;
        if (path instanceof AndroidPath) {
            path2.addPath(((AndroidPath) path).getInternalPath(), Offset.m2391getXimpl(offset), Offset.m2392getYimpl(offset));
            return;
        }
    ...
    public void mo2527translatek4lQ0M(long offset) {
        this.mMatrix.reset();
        this.mMatrix.setTranslate(Offset.m2391getXimpl(offset), Offset.m2392getYimpl(offset));
        this.internalPath.transform(this.mMatrix);
    }

    @Override // androidx.compose.ui.graphics.Path
    /* renamed from: transform-58bKbWc, reason: not valid java name */
    public void mo2526transform58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        AndroidMatrixConversions_androidKt.m2502setFromEL8BTi8(this.mMatrix, matrix);
        this.internalPath.transform(this.mMatrix);
    }
    ...
    public boolean mo2524opN5in7k0(Path path1, Path path2, int operation) {
        Path.Op op;
        Intrinsics.checkNotNullParameter(path1, "path1");
        Intrinsics.checkNotNullParameter(path2, "path2");
        if (PathOperation.m2912equalsimpl0(operation, PathOperation.INSTANCE.m2916getDifferenceb3I0S0c())) {
            op = Path.Op.DIFFERENCE;
        } else if (PathOperation.m2912equalsimpl0(operation, PathOperation.INSTANCE.m2917getIntersectb3I0S0c())) {
            op = Path.Op.INTERSECT;
        } else if (PathOperation.m2912equalsimpl0(operation, PathOperation.INSTANCE.m2918getReverseDifferenceb3I0S0c())) {
            op = Path.Op.REVERSE_DIFFERENCE;
        } else {
            op = PathOperation.m2912equalsimpl0(operation, PathOperation.INSTANCE.m2919getUnionb3I0S0c()) ? Path.Op.UNION : Path.Op.XOR;
        }
        android.graphics.Path path = this.internalPath;
