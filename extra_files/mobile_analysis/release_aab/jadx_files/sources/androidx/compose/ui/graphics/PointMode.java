...
public final class PointMode {
    ...
    private static final int Points = m2923constructorimpl(0);
    private static final int Lines = m2923constructorimpl(1);
    private static final int Polygon = m2923constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PointMode m2922boximpl(int i) {
        return new PointMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m2923constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2924equalsimpl(int i, Object obj) {
        return (obj instanceof PointMode) && i == ((PointMode) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2925equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m2926hashCodeimpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m2930getPointsr_lszbg() {
            return PointMode.Points;
        }

        /* renamed from: getLines-r_lszbg, reason: not valid java name */
        public final int m2929getLinesr_lszbg() {
            return PointMode.Lines;
        }

        /* renamed from: getPolygon-r_lszbg, reason: not valid java name */
        public final int m2931getPolygonr_lszbg() {
    ...
    public static String m2927toStringimpl(int i) {
        return m2925equalsimpl0(i, Points) ? "Points" : m2925equalsimpl0(i, Lines) ? "Lines" : m2925equalsimpl0(i, Polygon) ? "Polygon" : "Unknown";
    }
}
