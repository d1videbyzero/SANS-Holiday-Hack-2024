...
public final class ProcessResult {
    ...
    public static final /* synthetic */ ProcessResult m3832boximpl(int i) {
        return new ProcessResult(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m3833constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3834equalsimpl(int i, Object obj) {
        return (obj instanceof ProcessResult) && i == ((ProcessResult) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3835equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: getAnyMovementConsumed-impl, reason: not valid java name */
    public static final boolean m3836getAnyMovementConsumedimpl(int i) {
        return (i & 2) != 0;
    }

    /* renamed from: getDispatchedToAPointerInputModifier-impl, reason: not valid java name */
    public static final boolean m3837getDispatchedToAPointerInputModifierimpl(int i) {
        return (i & 1) != 0;
    }
    ...
    public boolean equals(Object obj) {
        return m3834equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m3838hashCodeimpl(this.value);
    }
