...
public final class RecordingInputConnection implements InputConnection {
    ...
    public final void updateInputState(TextFieldValue state, InputMethodManager inputMethodManager) {
        ...
        if (this.isActive) {
            ...
            int m4406getMinimpl = composition != null ? TextRange.m4406getMinimpl(composition.getPackedValue()) : -1;
            TextRange composition2 = state.getComposition();
            inputMethodManager.updateSelection(TextRange.m4406getMinimpl(state.getSelection()), TextRange.m4405getMaximpl(state.getSelection()), m4406getMinimpl, composition2 != null ? TextRange.m4405getMaximpl(composition2.getPackedValue()) : -1);
        }
    }
    ...
    public CharSequence getSelectedText(int flags) {
        if (TextRange.m4402getCollapsedimpl(this.mTextFieldValue.getSelection())) {
            return null;
        }
    ...
    public int getCursorCapsMode(int reqModes) {
        return TextUtils.getCapsMode(this.mTextFieldValue.getText(), TextRange.m4406getMinimpl(this.mTextFieldValue.getSelection()), reqModes);
    }
    ...
    public boolean performEditorAction(int editorAction) {
        int m4566getDefaulteUduSuo;
        boolean z = this.isActive;
        if (!z) {
            return z;
        }
        if (editorAction == 0) {
            m4566getDefaulteUduSuo = ImeAction.INSTANCE.m4566getDefaulteUduSuo();
        } else {
            switch (editorAction) {
                case 2:
                    m4566getDefaulteUduSuo = ImeAction.INSTANCE.m4568getGoeUduSuo();
                    break;
                case 3:
                    m4566getDefaulteUduSuo = ImeAction.INSTANCE.m4572getSearcheUduSuo();
                    break;
                case 4:
                    m4566getDefaulteUduSuo = ImeAction.INSTANCE.m4573getSendeUduSuo();
                    break;
                case 5:
                    m4566getDefaulteUduSuo = ImeAction.INSTANCE.m4569getNexteUduSuo();
                    break;
                case 6:
                    m4566getDefaulteUduSuo = ImeAction.INSTANCE.m4567getDoneeUduSuo();
                    break;
                case 7:
                    m4566getDefaulteUduSuo = ImeAction.INSTANCE.m4571getPreviouseUduSuo();
                    break;
                default:
        ...
        this.eventCallback.mo4580onImeActionKlQnJC8(m4566getDefaulteUduSuo);
        return true;
    }
