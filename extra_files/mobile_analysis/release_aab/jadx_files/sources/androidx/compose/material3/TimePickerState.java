...
public final class TimePickerState {
    ...
    public TimePickerState(int i, int i2, final boolean z) {
        ...
        this.selectorPos = SnapshotStateKt.derivedStateOf(SnapshotStateKt.structuralEqualityPolicy(), new Function0<DpOffset>() { // from class: androidx.compose.material3.TimePickerState$selectorPos$2
            ...
            public /* bridge */ /* synthetic */ DpOffset invoke() {
                return DpOffset.m4933boximpl(m1597invokeRKDOV3M());
            }

            /* renamed from: invoke-RKDOV3M, reason: not valid java name */
            public final long m1597invokeRKDOV3M() {
                boolean isInnerCircle$material3_release = TimePickerState.this.isInnerCircle$material3_release();
                float f = 2;
                float m4878constructorimpl = Dp.m4878constructorimpl(TimePickerTokens.INSTANCE.m2163getClockDialSelectorHandleContainerSizeD9Ej5fM() / f);
                float m4878constructorimpl2 = Dp.m4878constructorimpl(Dp.m4878constructorimpl(((z && isInnerCircle$material3_release && Selection.m1376equalsimpl0(TimePickerState.this.m1593getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m1380getHourJiIwxys())) ? TimePickerKt.InnerCircleRadius : TimePickerKt.OuterCircleSizeRadius) - m4878constructorimpl) + m4878constructorimpl);
                return DpKt.m4899DpOffsetYgX7TsA(Dp.m4878constructorimpl(Dp.m4878constructorimpl(((float) Math.cos(TimePickerState.this.getCurrentAngle$material3_release().getValue().floatValue())) * m4878constructorimpl2) + Dp.m4878constructorimpl(TimePickerTokens.INSTANCE.m2161getClockDialContainerSizeD9Ej5fM() / f)), Dp.m4878constructorimpl(Dp.m4878constructorimpl(m4878constructorimpl2 * ((float) Math.sin(TimePickerState.this.getCurrentAngle$material3_release().getValue().floatValue()))) + Dp.m4878constructorimpl(TimePickerTokens.INSTANCE.m2161getClockDialContainerSizeD9Ej5fM() / f)));
            }
        });
        this.center = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m4987boximpl(IntOffset.INSTANCE.m5006getZeronOccac()), null, 2, null);
        this.selection = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Selection.m1373boximpl(Selection.INSTANCE.m1380getHourJiIwxys()), null, 2, null);
    ...
    public final long m1594getSelectorPosRKDOV3M$material3_release() {
    ...
    public final long m1592getCenternOccac$material3_release() {
    ...
    public final void m1595setCentergyyYBs$material3_release(long j) {
        this.center.setValue(IntOffset.m4987boximpl(j));
    }

    public final List<Integer> getValues$material3_release() {
        List<Integer> list;
        List<Integer> list2;
        if (Selection.m1376equalsimpl0(m1593getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m1381getMinuteJiIwxys())) {
    ...
    public final int m1593getSelectionJiIwxys$material3_release() {
        return ((Selection) this.selection.getValue()).m1379unboximpl();
    }

    /* renamed from: setSelection-iHAOin8$material3_release, reason: not valid java name */
    public final void m1596setSelectioniHAOin8$material3_release(int i) {
        this.selection.setValue(Selection.m1373boximpl(i));
    }
    ...
    public final void moveSelector$material3_release(float x, float y, float maxDist) {
        float dist;
        if (Selection.m1376equalsimpl0(m1593getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m1380getHourJiIwxys()) && this.is24hour) {
            dist = TimePickerKt.dist(x, y, IntOffset.m4996getXimpl(m1592getCenternOccac$material3_release()), IntOffset.m4997getYimpl(m1592getCenternOccac$material3_release()));
    ...
    */
    public final java.lang.Object animateToCurrent$material3_release(kotlin.coroutines.Continuation<? super kotlin.Unit> r11) {
        ...
        L41:
            kotlin.ResultKt.throwOnFailure(r11)
            int r11 = r10.m1593getSelectionJiIwxys$material3_release()
            ...
            boolean r11 = androidx.compose.material3.Selection.m1376equalsimpl0(r11, r1)
            if (r11 == 0) goto L61
