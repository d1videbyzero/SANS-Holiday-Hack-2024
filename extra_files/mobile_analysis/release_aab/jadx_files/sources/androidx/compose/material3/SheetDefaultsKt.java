...
public final class SheetDefaultsKt {
    private static final float DragHandleVerticalPadding = Dp.m4878constructorimpl(22);
    private static final float BottomSheetMaxWidth = Dp.m4878constructorimpl(640);
    ...
    public static final NestedScrollConnection ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection(final SheetState sheetState, final Orientation orientation, final Function1<? super Float, Unit> onFling) {
        ...
        return new NestedScrollConnection() { // from class: androidx.compose.material3.SheetDefaultsKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1
            ...
            public long mo336onPreScrollOzD1aCk(long available, int source) {
                ...
                if (offsetToFloat < 0.0f && NestedScrollSource.m3642equalsimpl0(source, NestedScrollSource.INSTANCE.m3647getDragWNlRxjI())) {
            ...
            public long mo335onPostScrollDzOQY0M(long consumed, long available, int source) {
                if (NestedScrollSource.m3642equalsimpl0(source, NestedScrollSource.INSTANCE.m3647getDragWNlRxjI())) {
            ...
            private final float velocityToFloat(long j) {
                return orientation == Orientation.Horizontal ? Velocity.m5103getXimpl(j) : Velocity.m5104getYimpl(j);
            }

            private final float offsetToFloat(long j) {
                return orientation == Orientation.Horizontal ? Offset.m2391getXimpl(j) : Offset.m2392getYimpl(j);
            }
        };
    }
    ...
    public static final SheetState rememberSheetState(boolean z, Function1<? super SheetValue, Boolean> function1, SheetValue sheetValue, boolean z2, Composer composer, int i, int i2) {
        ...
        SheetState sheetState = (SheetState) RememberSaveableKt.m2277rememberSaveable(objArr, (Saver) Saver, (String) null, (Function0) rememberedValue, composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
