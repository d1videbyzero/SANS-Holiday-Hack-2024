...
public final class DisplayMode {
    ...
    private static final int Picker = m1168constructorimpl(0);
    private static final int Input = m1168constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ DisplayMode m1167boximpl(int i) {
    ...
    public static String m1172toStringimpl(int i) {
        return m1170equalsimpl0(i, Picker) ? "Picker" : m1170equalsimpl0(i, Input) ? "Input" : "Unknown";
    }
}
