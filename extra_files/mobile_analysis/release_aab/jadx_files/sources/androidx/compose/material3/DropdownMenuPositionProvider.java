...
public final /* data */ class DropdownMenuPositionProvider implements PopupPositionProvider {
    ...
    public static /* synthetic */ DropdownMenuPositionProvider m1186copyrOJDEFc$default(DropdownMenuPositionProvider dropdownMenuPositionProvider, long j, Density density, Function2 function2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return dropdownMenuPositionProvider.m1188copyrOJDEFc(j, density, function2);
    }
    ...
    public final DropdownMenuPositionProvider m1188copyrOJDEFc(long contentOffset, Density density, Function2<? super IntRect, ? super IntRect, Unit> onPositionCalculated) {
    ...
    public boolean equals(Object other) {
        ...
        return DpOffset.m4938equalsimpl0(this.contentOffset, dropdownMenuPositionProvider.contentOffset) && Intrinsics.areEqual(this.density, dropdownMenuPositionProvider.density) && Intrinsics.areEqual(this.onPositionCalculated, dropdownMenuPositionProvider.onPositionCalculated);
    }

    public int hashCode() {
        return (((DpOffset.m4943hashCodeimpl(this.contentOffset) * 31) + this.density.hashCode()) * 31) + this.onPositionCalculated.hashCode();
    }

    public String toString() {
        return "DropdownMenuPositionProvider(contentOffset=" + ((Object) DpOffset.m4946toStringimpl(this.contentOffset)) + ", density=" + this.density + ", onPositionCalculated=" + this.onPositionCalculated + ')';
    }
    ...
    public final long m1189getContentOffsetRKDOV3M() {
        return this.contentOffset;
    }
    ...
    public long mo876calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        Sequence sequenceOf;
        Object obj;
        Object obj2;
        Intrinsics.checkNotNullParameter(anchorBounds, "anchorBounds");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        int mo321roundToPx0680j_4 = this.density.mo321roundToPx0680j_4(MenuKt.getMenuVerticalMargin());
        int mo321roundToPx0680j_42 = this.density.mo321roundToPx0680j_4(DpOffset.m4939getXD9Ej5fM(this.contentOffset));
        int mo321roundToPx0680j_43 = this.density.mo321roundToPx0680j_4(DpOffset.m4941getYD9Ej5fM(this.contentOffset));
        int left = anchorBounds.getLeft() + mo321roundToPx0680j_42;
        int right = (anchorBounds.getRight() - mo321roundToPx0680j_42) - IntSize.m5038getWidthimpl(popupContentSize);
        int m5038getWidthimpl = IntSize.m5038getWidthimpl(windowSize) - IntSize.m5038getWidthimpl(popupContentSize);
        if (layoutDirection == LayoutDirection.Ltr) {
            ...
            numArr[2] = Integer.valueOf(m5038getWidthimpl);
            sequenceOf = SequencesKt.sequenceOf(numArr);
        } else {
            Integer[] numArr2 = new Integer[3];
            numArr2[0] = Integer.valueOf(right);
            numArr2[1] = Integer.valueOf(left);
            if (anchorBounds.getRight() <= IntSize.m5038getWidthimpl(windowSize)) {
                m5038getWidthimpl = 0;
            }
            numArr2[2] = Integer.valueOf(m5038getWidthimpl);
        ...
        while (true) {
            ...
            if (intValue >= 0 && intValue + IntSize.m5038getWidthimpl(popupContentSize) <= IntSize.m5038getWidthimpl(windowSize)) {
                break;
            }
        }
        ...
        int top = (anchorBounds.getTop() - mo321roundToPx0680j_43) - IntSize.m5037getHeightimpl(popupContentSize);
        Iterator it2 = SequencesKt.sequenceOf(Integer.valueOf(max), Integer.valueOf(top), Integer.valueOf(anchorBounds.getTop() - (IntSize.m5037getHeightimpl(popupContentSize) / 2)), Integer.valueOf((IntSize.m5037getHeightimpl(windowSize) - IntSize.m5037getHeightimpl(popupContentSize)) - mo321roundToPx0680j_4)).iterator();
        while (true) {
            if (!it2.hasNext()) {
                break;
            }
            ...
            if (intValue2 >= mo321roundToPx0680j_4 && intValue2 + IntSize.m5037getHeightimpl(popupContentSize) <= IntSize.m5037getHeightimpl(windowSize) - mo321roundToPx0680j_4) {
                obj = next;
                break;
            }
        }
        ...
        this.onPositionCalculated.invoke(anchorBounds, new IntRect(right, top, IntSize.m5038getWidthimpl(popupContentSize) + right, IntSize.m5037getHeightimpl(popupContentSize) + top));
