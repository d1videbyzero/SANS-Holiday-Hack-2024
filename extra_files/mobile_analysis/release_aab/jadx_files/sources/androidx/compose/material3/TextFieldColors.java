...
public final class TextFieldColors {
    ...
    public final State<Color> leadingIconColor$material3_release(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2620boximpl(j), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> indicatorColor$material3_release(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (z) {
            ...
            rememberUpdatedState = SingleValueAnimationKt.m70animateColorAsStateeuL9pac(j2, AnimationSpecKt.tween$default(150, 0, null, 6, null), null, null, composer, 48, 12);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(715788969);
            ComposerKt.sourceInformation(composer, "1816@99679L33");
            rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2620boximpl(j2), composer, 0);
            composer.endReplaceableGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public final State<Color> containerColor$material3_release(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        State<Color> m70animateColorAsStateeuL9pac = SingleValueAnimationKt.m70animateColorAsStateeuL9pac(j, AnimationSpecKt.tween$default(150, 0, null, 6, null), null, null, composer, 48, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final State<Color> cursorColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2620boximpl(z ? this.errorCursorColor : this.cursorColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2631equalsimpl0(this.focusedTextColor, textFieldColors.focusedTextColor) && Color.m2631equalsimpl0(this.unfocusedTextColor, textFieldColors.unfocusedTextColor) && Color.m2631equalsimpl0(this.disabledTextColor, textFieldColors.disabledTextColor) && Color.m2631equalsimpl0(this.errorTextColor, textFieldColors.errorTextColor) && Color.m2631equalsimpl0(this.focusedContainerColor, textFieldColors.focusedContainerColor) && Color.m2631equalsimpl0(this.unfocusedContainerColor, textFieldColors.unfocusedContainerColor) && Color.m2631equalsimpl0(this.disabledContainerColor, textFieldColors.disabledContainerColor) && Color.m2631equalsimpl0(this.errorContainerColor, textFieldColors.errorContainerColor) && Color.m2631equalsimpl0(this.cursorColor, textFieldColors.cursorColor) && Color.m2631equalsimpl0(this.errorCursorColor, textFieldColors.errorCursorColor) && Intrinsics.areEqual(this.textSelectionColors, textFieldColors.textSelectionColors) && Color.m2631equalsimpl0(this.focusedIndicatorColor, textFieldColors.focusedIndicatorColor) && Color.m2631equalsimpl0(this.unfocusedIndicatorColor, textFieldColors.unfocusedIndicatorColor) && Color.m2631equalsimpl0(this.disabledIndicatorColor, textFieldColors.disabledIndicatorColor) && Color.m2631equalsimpl0(this.errorIndicatorColor, textFieldColors.errorIndicatorColor) && Color.m2631equalsimpl0(this.focusedLeadingIconColor, textFieldColors.focusedLeadingIconColor) && Color.m2631equalsimpl0(this.unfocusedLeadingIconColor, textFieldColors.unfocusedLeadingIconColor) && Color.m2631equalsimpl0(this.disabledLeadingIconColor, textFieldColors.disabledLeadingIconColor) && Color.m2631equalsimpl0(this.errorLeadingIconColor, textFieldColors.errorLeadingIconColor) && Color.m2631equalsimpl0(this.focusedTrailingIconColor, textFieldColors.focusedTrailingIconColor) && Color.m2631equalsimpl0(this.unfocusedTrailingIconColor, textFieldColors.unfocusedTrailingIconColor) && Color.m2631equalsimpl0(this.disabledTrailingIconColor, textFieldColors.disabledTrailingIconColor) && Color.m2631equalsimpl0(this.errorTrailingIconColor, textFieldColors.errorTrailingIconColor) && Color.m2631equalsimpl0(this.focusedLabelColor, textFieldColors.focusedLabelColor) && Color.m2631equalsimpl0(this.unfocusedLabelColor, textFieldColors.unfocusedLabelColor) && Color.m2631equalsimpl0(this.disabledLabelColor, textFieldColors.disabledLabelColor) && Color.m2631equalsimpl0(this.errorLabelColor, textFieldColors.errorLabelColor) && Color.m2631equalsimpl0(this.focusedPlaceholderColor, textFieldColors.focusedPlaceholderColor) && Color.m2631equalsimpl0(this.unfocusedPlaceholderColor, textFieldColors.unfocusedPlaceholderColor) && Color.m2631equalsimpl0(this.disabledPlaceholderColor, textFieldColors.disabledPlaceholderColor) && Color.m2631equalsimpl0(this.errorPlaceholderColor, textFieldColors.errorPlaceholderColor) && Color.m2631equalsimpl0(this.focusedSupportingTextColor, textFieldColors.focusedSupportingTextColor) && Color.m2631equalsimpl0(this.unfocusedSupportingTextColor, textFieldColors.unfocusedSupportingTextColor) && Color.m2631equalsimpl0(this.disabledSupportingTextColor, textFieldColors.disabledSupportingTextColor) && Color.m2631equalsimpl0(this.errorSupportingTextColor, textFieldColors.errorSupportingTextColor) && Color.m2631equalsimpl0(this.focusedPrefixColor, textFieldColors.focusedPrefixColor) && Color.m2631equalsimpl0(this.unfocusedPrefixColor, textFieldColors.unfocusedPrefixColor) && Color.m2631equalsimpl0(this.disabledPrefixColor, textFieldColors.disabledPrefixColor) && Color.m2631equalsimpl0(this.errorPrefixColor, textFieldColors.errorPrefixColor) && Color.m2631equalsimpl0(this.focusedSuffixColor, textFieldColors.focusedSuffixColor) && Color.m2631equalsimpl0(this.unfocusedSuffixColor, textFieldColors.unfocusedSuffixColor) && Color.m2631equalsimpl0(this.disabledSuffixColor, textFieldColors.disabledSuffixColor) && Color.m2631equalsimpl0(this.errorSuffixColor, textFieldColors.errorSuffixColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((Color.m2637hashCodeimpl(this.focusedTextColor) * 31) + Color.m2637hashCodeimpl(this.unfocusedTextColor)) * 31) + Color.m2637hashCodeimpl(this.disabledTextColor)) * 31) + Color.m2637hashCodeimpl(this.errorTextColor)) * 31) + Color.m2637hashCodeimpl(this.focusedContainerColor)) * 31) + Color.m2637hashCodeimpl(this.unfocusedContainerColor)) * 31) + Color.m2637hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m2637hashCodeimpl(this.errorContainerColor)) * 31) + Color.m2637hashCodeimpl(this.cursorColor)) * 31) + Color.m2637hashCodeimpl(this.errorCursorColor)) * 31) + this.textSelectionColors.hashCode()) * 31) + Color.m2637hashCodeimpl(this.focusedIndicatorColor)) * 31) + Color.m2637hashCodeimpl(this.unfocusedIndicatorColor)) * 31) + Color.m2637hashCodeimpl(this.disabledIndicatorColor)) * 31) + Color.m2637hashCodeimpl(this.errorIndicatorColor)) * 31) + Color.m2637hashCodeimpl(this.focusedLeadingIconColor)) * 31) + Color.m2637hashCodeimpl(this.unfocusedLeadingIconColor)) * 31) + Color.m2637hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m2637hashCodeimpl(this.errorLeadingIconColor)) * 31) + Color.m2637hashCodeimpl(this.focusedTrailingIconColor)) * 31) + Color.m2637hashCodeimpl(this.unfocusedTrailingIconColor)) * 31) + Color.m2637hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m2637hashCodeimpl(this.errorTrailingIconColor)) * 31) + Color.m2637hashCodeimpl(this.focusedLabelColor)) * 31) + Color.m2637hashCodeimpl(this.unfocusedLabelColor)) * 31) + Color.m2637hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m2637hashCodeimpl(this.errorLabelColor)) * 31) + Color.m2637hashCodeimpl(this.focusedPlaceholderColor)) * 31) + Color.m2637hashCodeimpl(this.unfocusedPlaceholderColor)) * 31) + Color.m2637hashCodeimpl(this.disabledPlaceholderColor)) * 31) + Color.m2637hashCodeimpl(this.errorPlaceholderColor)) * 31) + Color.m2637hashCodeimpl(this.focusedSupportingTextColor)) * 31) + Color.m2637hashCodeimpl(this.unfocusedSupportingTextColor)) * 31) + Color.m2637hashCodeimpl(this.disabledSupportingTextColor)) * 31) + Color.m2637hashCodeimpl(this.errorSupportingTextColor)) * 31) + Color.m2637hashCodeimpl(this.focusedPrefixColor)) * 31) + Color.m2637hashCodeimpl(this.unfocusedPrefixColor)) * 31) + Color.m2637hashCodeimpl(this.disabledPrefixColor)) * 31) + Color.m2637hashCodeimpl(this.errorPrefixColor)) * 31) + Color.m2637hashCodeimpl(this.focusedSuffixColor)) * 31) + Color.m2637hashCodeimpl(this.unfocusedSuffixColor)) * 31) + Color.m2637hashCodeimpl(this.disabledSuffixColor)) * 31) + Color.m2637hashCodeimpl(this.errorSuffixColor);
    }
