...
public final class DateRangePickerKt {
    ...
    private static final PaddingValues CalendarMonthSubheadPadding = PaddingKt.m479PaddingValuesa9UjIt4$default(Dp.m4878constructorimpl(24), Dp.m4878constructorimpl(20), 0.0f, Dp.m4878constructorimpl(8), 4, null);
    private static final float HeaderHeightOffset = Dp.m4878constructorimpl(60);
    ...
    */
    ...
    public static final DateRangePickerState m1154rememberDateRangePickerStatepMw4iz8(Long l, Long l2, Long l3, IntRange intRange, int i, Composer composer, int i2, int i3) {
        ...
        final int m1175getPickerjFl4v0 = (i3 & 16) != 0 ? DisplayMode.INSTANCE.m1175getPickerjFl4v0() : i;
        ...
        DateRangePickerState dateRangePickerState = (DateRangePickerState) RememberSaveableKt.m2277rememberSaveable(new Object[0], (Saver) DateRangePickerState.INSTANCE.Saver(), (String) null, (Function0) new Function0<DateRangePickerState>() { // from class: androidx.compose.material3.DateRangePickerKt$rememberDateRangePickerState$1
            ...
            public final DateRangePickerState invoke() {
                return new DateRangePickerState(l4, l5, l6, yearRange, m1175getPickerjFl4v0, null);
            }
        }, composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void SwitchableDateEntryContent(final DateRangePickerState dateRangePickerState, final DatePickerFormatter datePickerFormatter, final Function1<? super Long, Boolean> function1, final DatePickerColors datePickerColors, Composer composer, final int i) {
        ...
        if ((i3 & 5851) != 1170 || !startRestartGroup.getSkipping()) {
            ...
            int m1157getDisplayModejFl4v0 = dateRangePickerState.m1157getDisplayModejFl4v0();
            CrossfadeKt.Crossfade(DisplayMode.m1167boximpl(m1157getDisplayModejFl4v0), SemanticsModifierKt.semantics$default(Modifier.INSTANCE, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$SwitchableDateEntryContent$1
                ...
                public /* bridge */ /* synthetic */ Unit invoke(DisplayMode displayMode, Composer composer2, Integer num) {
                    m1156invokeQujVXRc(displayMode.getValue(), composer2, num.intValue());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-QujVXRc, reason: not valid java name */
                public final void m1156invokeQujVXRc(int i4, Composer composer2, int i5) {
                    int i6;
    ...
    public static final void DateRangePickerContent(final StateData stateData, final DatePickerFormatter datePickerFormatter, final Function1<? super Long, Boolean> function1, final DatePickerColors datePickerColors, Composer composer, final int i) {
        ...
        if ((i2 & 5851) != 1170 || !startRestartGroup.getSkipping()) {
            ...
            Modifier m484paddingVpY3zN4$default = PaddingKt.m484paddingVpY3zN4$default(Modifier.INSTANCE, DatePickerKt.getDatePickerHorizontalPadding(), 0.0f, 2, null);
            ...
            TextKt.ProvideTextStyle(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography(startRestartGroup, 6), DatePickerModalTokens.INSTANCE.getRangeSelectionMonthSubheadFont()), ComposableLambdaKt.composableLambda(startRestartGroup, 56792252, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$VerticalMonthsList$1
                ...
                public final void invoke(Composer composer2, int i4) {
                    ...
                    if ((i4 & 11) != 2 || !composer2.getSkipping()) {
                        ...
                        composer2.endReplaceableGroup();
                        final String m1466getStringNWtq28 = Strings_androidKt.m1466getStringNWtq28(Strings.INSTANCE.m1438getDateRangePickerScrollToShowPreviousMonthadMyvUU(), composer2, 6);
                        final String m1466getStringNWtq282 = Strings_androidKt.m1466getStringNWtq28(Strings.INSTANCE.m1437getDateRangePickerScrollToShowNextMonthadMyvUU(), composer2, 6);
    ...
    public static final void m1153drawRangeBackgroundmxwnekA(ContentDrawScope drawRangeBackground, SelectedRangeInfo selectedRangeInfo, long j) {
        ...
        float f = drawRangeBackground.mo327toPx0680j_4(DatePickerKt.getRecommendedSizeForAccessibility());
        float f2 = drawRangeBackground.mo327toPx0680j_4(DatePickerKt.getRecommendedSizeForAccessibility());
        float f3 = drawRangeBackground.mo327toPx0680j_4(DatePickerModalTokens.INSTANCE.m1787getDateStateLayerHeightD9Ej5fM());
        float f4 = 2;
        float f5 = (f2 - f3) / f4;
        float f6 = 7;
        float m2460getWidthimpl2 = (Size.m2460getWidthimpl(drawRangeBackground.mo3174getSizeNHjbRc()) - (f6 * f)) / f6;
        long packedValue = selectedRangeInfo.getGridCoordinates().getFirst().getPackedValue();
        int m4988component1impl = IntOffset.m4988component1impl(packedValue);
        int m4989component2impl = IntOffset.m4989component2impl(packedValue);
        long packedValue2 = selectedRangeInfo.getGridCoordinates().getSecond().getPackedValue();
        int m4988component1impl2 = IntOffset.m4988component1impl(packedValue2);
        int m4989component2impl2 = IntOffset.m4989component2impl(packedValue2);
        float f7 = f + m2460getWidthimpl2;
        float f8 = m2460getWidthimpl2 / f4;
        float f9 = (m4988component1impl * f7) + (selectedRangeInfo.getFirstIsSelectionStart() ? f / f4 : 0.0f) + f8;
        float f10 = (m4989component2impl * f2) + f5;
        float f11 = m4988component1impl2 * f7;
        if (selectedRangeInfo.getLastIsSelectionEnd()) {
            f /= f4;
        }
        float f12 = f11 + f + f8;
        float f13 = (m4989component2impl2 * f2) + f5;
        boolean z = drawRangeBackground.getLayoutDirection() == LayoutDirection.Rtl;
        if (z) {
            f9 = Size.m2460getWidthimpl(drawRangeBackground.mo3174getSizeNHjbRc()) - f9;
            f12 = Size.m2460getWidthimpl(drawRangeBackground.mo3174getSizeNHjbRc()) - f12;
        }
        ContentDrawScope contentDrawScope = drawRangeBackground;
        long Offset = OffsetKt.Offset(f9, f10);
        if (m4989component2impl == m4989component2impl2) {
            m2460getWidthimpl = f12 - f9;
        } else {
            m2460getWidthimpl = z ? -f9 : Size.m2460getWidthimpl(drawRangeBackground.mo3174getSizeNHjbRc()) - f9;
        }
        DrawScope.m3169drawRectnJ9OG0$default(contentDrawScope, j, Offset, SizeKt.Size(m2460getWidthimpl, f3), 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
        if (m4989component2impl != m4989component2impl2) {
            for (int i = (m4989component2impl2 - m4989component2impl) - 1; i > 0; i--) {
                DrawScope.m3169drawRectnJ9OG0$default(contentDrawScope, j, OffsetKt.Offset(0.0f, (i * f2) + f10), SizeKt.Size(Size.m2460getWidthimpl(drawRangeBackground.mo3174getSizeNHjbRc()), f3), 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
            }
            long Offset2 = OffsetKt.Offset(drawRangeBackground.getLayoutDirection() != LayoutDirection.Ltr ? Size.m2460getWidthimpl(drawRangeBackground.mo3174getSizeNHjbRc()) : 0.0f, f13);
            if (z) {
                f12 -= Size.m2460getWidthimpl(drawRangeBackground.mo3174getSizeNHjbRc());
            }
            DrawScope.m3169drawRectnJ9OG0$default(contentDrawScope, j, Offset2, SizeKt.Size(f12, f3), 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
        }
    }
    ...
    static {
        float f = 64;
        float f2 = 12;
        DateRangePickerTitlePadding = PaddingKt.m479PaddingValuesa9UjIt4$default(Dp.m4878constructorimpl(f), 0.0f, Dp.m4878constructorimpl(f2), 0.0f, 10, null);
        DateRangePickerHeadlinePadding = PaddingKt.m479PaddingValuesa9UjIt4$default(Dp.m4878constructorimpl(f), 0.0f, Dp.m4878constructorimpl(f2), Dp.m4878constructorimpl(f2), 2, null);
    }
}
