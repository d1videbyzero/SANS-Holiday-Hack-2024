...
public final class DatePickerKt {
    ...
    private static final float RecommendedSizeForAccessibility = Dp.m4878constructorimpl(48);
    private static final float MonthYearHeight = Dp.m4878constructorimpl(56);
    ...
    */
    ...
    public static final DatePickerState m1148rememberDatePickerStateNVmSL94(final Long l, final Long l2, final IntRange intRange, final int i, Composer composer, int i2, int i3) {
        ...
        if ((i3 & 8) != 0) {
            i = DisplayMode.INSTANCE.m1175getPickerjFl4v0();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1574672255, i2, -1, "androidx.compose.material3.rememberDatePickerState (DatePicker.kt:219)");
        }
        DatePickerState datePickerState = (DatePickerState) RememberSaveableKt.m2277rememberSaveable(new Object[0], (Saver) DatePickerState.INSTANCE.Saver(), (String) null, (Function0) new Function0<DatePickerState>() { // from class: androidx.compose.material3.DatePickerKt$rememberDatePickerState$1
    ...
    public static final void m1145DateEntryContainerau3_HiA(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final DatePickerColors colors, final TextStyle headlineTextStyle, final float f, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i) {
        ...
        if ((23967451 & i3) != 4793490 || !startRestartGroup.getSkipping()) {
            ...
            Modifier semantics$default = SemanticsModifierKt.semantics$default(SizeKt.m533sizeInqDBjuR0$default(modifier, DatePickerModalTokens.INSTANCE.m1784getContainerWidthD9Ej5fM(), 0.0f, 0.0f, 0.0f, 14, null), false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DateEntryContainer$1
            ...
            m1146DatePickerHeaderpc5RIQQ(Modifier.INSTANCE, function2, colors.getTitleContentColor(), colors.getHeadlineContentColor(), f, ComposableLambdaKt.composableLambda(startRestartGroup, -229007058, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DateEntryContainer$2$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                ...
                public final void invoke(Composer composer3, int i4) {
                    ...
                    if ((i4 & 11) != 2 || !composer3.getSkipping()) {
                        ...
                        Composer m2264constructorimpl2 = Updater.m2264constructorimpl(composer3);
                        ...
                        materializerOf2.invoke(SkippableUpdater.m2255boximpl(SkippableUpdater.m2256constructorimpl(composer3)), composer3, 0);
                        ...
                        Updater.m2271setimpl(m2264constructorimpl3, rowMeasurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
                            ...
                            TextKt.ProvideTextStyle(textStyle, ComposableLambdaKt.composableLambda(composer3, -962031352, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DateEntryContainer$2$1$1$1$1
                                ...
                                public final void invoke(Composer composer4, int i6) {
                                    ...
                                    if ((i6 & 11) != 2 || !composer4.getSkipping()) {
                                        ...
                                        Composer m2264constructorimpl4 = Updater.m2264constructorimpl(composer4);
                                        Updater.m2271setimpl(m2264constructorimpl4, rememberBoxMeasurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
                                        ...
                                        materializerOf4.invoke(SkippableUpdater.m2255boximpl(SkippableUpdater.m2256constructorimpl(composer4)), composer4, 0);
                        ...
                        if (function26 != null || function24 != null || function25 != null) {
                            DividerKt.m1177Divider9IZ8Weo(null, 0.0f, 0L, composer3, 0, 7);
                        }
                        composer3.endReplaceableGroup();
                        ComposerKt.sourceInformationMarkerEnd(composer3);
                        ComposerKt.sourceInformationMarkerEnd(composer3);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DateEntryContainer$3
            ...
            public final void invoke(Composer composer3, int i4) {
                DatePickerKt.m1145DateEntryContainerau3_HiA(Modifier.this, function2, function22, function23, colors, headlineTextStyle, f, content, composer3, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }

    /* renamed from: DisplayModeToggleButton-tER2X8s, reason: not valid java name */
    public static final void m1147DisplayModeToggleButtontER2X8s(final Modifier modifier, final int i, final Function1<? super DisplayMode, Unit> onDisplayModeChange, Composer composer, final int i2) {
        int i3;
        Intrinsics.checkNotNullParameter(modifier, "modifier");
        ...
        if ((i3 & 731) != 146 || !startRestartGroup.getSkipping()) {
            ...
            if (DisplayMode.m1170equalsimpl0(i, DisplayMode.INSTANCE.m1175getPickerjFl4v0())) {
                ...
                if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
                    rememberedValue = (Function0) new Function0<Unit>() { // from class: androidx.compose.material3.DatePickerKt$DisplayModeToggleButton$1$1
                        ...
                        public final void invoke2() {
                            onDisplayModeChange.invoke(DisplayMode.m1167boximpl(DisplayMode.INSTANCE.m1174getInputjFl4v0()));
                        }
                    };
                    startRestartGroup.updateRememberedValue(rememberedValue);
                }
                startRestartGroup.endReplaceableGroup();
                IconButtonKt.IconButton((Function0) rememberedValue, modifier, false, null, null, ComposableSingletons$DatePickerKt.INSTANCE.m1115getLambda1$material3_release(), startRestartGroup, ((i3 << 3) & 112) | ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 28);
                startRestartGroup.endReplaceableGroup();
            } else {
                ...
                if (changed2 || rememberedValue2 == Composer.INSTANCE.getEmpty()) {
                    rememberedValue2 = (Function0) new Function0<Unit>() { // from class: androidx.compose.material3.DatePickerKt$DisplayModeToggleButton$2$1
                        ...
                        /* renamed from: invoke, reason: avoid collision after fix types in other method */
                        public final void invoke2() {
                            onDisplayModeChange.invoke(DisplayMode.m1167boximpl(DisplayMode.INSTANCE.m1175getPickerjFl4v0()));
                        }
                    };
                    startRestartGroup.updateRememberedValue(rememberedValue2);
                }
                startRestartGroup.endReplaceableGroup();
                IconButtonKt.IconButton((Function0) rememberedValue2, modifier, false, null, null, ComposableSingletons$DatePickerKt.INSTANCE.m1116getLambda2$material3_release(), startRestartGroup, ((i3 << 3) & 112) | ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 28);
                startRestartGroup.endReplaceableGroup();
            }
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DisplayModeToggleButton$3
            ...
            public final void invoke(Composer composer2, int i4) {
                DatePickerKt.m1147DisplayModeToggleButtontER2X8s(Modifier.this, i, onDisplayModeChange, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1));
            }
        });
    }
    ...
    public static final void SwitchableDateEntryContent(final DatePickerState datePickerState, final DatePickerFormatter datePickerFormatter, final Function1<? super Long, Boolean> function1, final DatePickerColors datePickerColors, Composer composer, final int i) {
        ...
        if ((i3 & 5851) != 1170 || !startRestartGroup.getSkipping()) {
            ...
            int m1151getDisplayModejFl4v0 = datePickerState.m1151getDisplayModejFl4v0();
            CrossfadeKt.Crossfade(DisplayMode.m1167boximpl(m1151getDisplayModejFl4v0), SemanticsModifierKt.semantics$default(Modifier.INSTANCE, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt$SwitchableDateEntryContent$1
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ Unit invoke(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                    invoke2(semanticsPropertyReceiver);
                    return Unit.INSTANCE;
                ...
                public /* bridge */ /* synthetic */ Unit invoke(DisplayMode displayMode, Composer composer2, Integer num) {
                    m1150invokeQujVXRc(displayMode.getValue(), composer2, num.intValue());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-QujVXRc, reason: not valid java name */
                public final void m1150invokeQujVXRc(int i4, Composer composer2, int i5) {
                    int i6;
                    ...
                    if ((i6 & 91) != 18 || !composer2.getSkipping()) {
                        ...
                        if (DisplayMode.m1170equalsimpl0(i4, DisplayMode.INSTANCE.m1175getPickerjFl4v0())) {
                            ...
                            composer2.endReplaceableGroup();
                        } else if (DisplayMode.m1170equalsimpl0(i4, DisplayMode.INSTANCE.m1174getInputjFl4v0())) {
    ...
    public static final void DatePickerContent(final StateData stateData, final DatePickerFormatter datePickerFormatter, final Function1<? super Long, Boolean> function1, final DatePickerColors datePickerColors, Composer composer, final int i) {
        ...
        if ((i3 & 5851) == 1170 && startRestartGroup.getSkipping()) {
            ...
            final MutableState mutableState = (MutableState) RememberSaveableKt.m2277rememberSaveable(new Object[0], (Saver) null, (String) null, (Function0) new Function0<MutableState<Boolean>>() { // from class: androidx.compose.material3.DatePickerKt$DatePickerContent$yearPickerVisible$2
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // kotlin.jvm.functions.Function0
            ...
            Modifier m484paddingVpY3zN4$default = PaddingKt.m484paddingVpY3zN4$default(companion2, f, 0.0f, 2, null);
            ...
            startRestartGroup.endReplaceableGroup();
            MonthsNavigation(m484paddingVpY3zN4$default, canScrollForward, canScrollBackward, DatePickerContent$lambda$5, formatMonthYear$material3_release, function0, function02, (Function0) rememberedValue3, startRestartGroup, 6);
            ...
            Modifier m484paddingVpY3zN4$default2 = PaddingKt.m484paddingVpY3zN4$default(Modifier.INSTANCE, f, 0.0f, 2, null);
            startRestartGroup.startReplaceableGroup(-483455358);
            ComposerKt.sourceInformation(startRestartGroup, "CC(Column)P(2,3,1)77@3913L61,78@3979L133:Column.kt#2w3rfo");
            ...
            ViewConfiguration viewConfiguration3 = (ViewConfiguration) consume9;
            Function0<ComposeUiNode> constructor3 = ComposeUiNode.INSTANCE.getConstructor();
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf3 = LayoutKt.materializerOf(m484paddingVpY3zN4$default2);
            if (!(startRestartGroup.getApplier() instanceof Applier)) {
                ComposablesKt.invalidApplier();
            }
            startRestartGroup.startReusableNode();
            ...
            AnimatedVisibilityKt.AnimatedVisibility(DatePickerContent$lambda$5(mutableState), ClipKt.clipToBounds(Modifier.INSTANCE), EnterExitTransitionKt.expandVertically$default(null, null, false, null, 15, null).plus(EnterExitTransitionKt.fadeIn$default(null, 0.6f, 1, null)), EnterExitTransitionKt.shrinkVertically$default(null, null, false, null, 15, null).plus(EnterExitTransitionKt.fadeOut$default(null, 0.0f, 3, null)), (String) null, ComposableLambdaKt.composableLambda(startRestartGroup, 760161496, true, new Function3<AnimatedVisibilityScope, Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DatePickerContent$1$4$2
                ...
                public final void invoke(AnimatedVisibilityScope AnimatedVisibility, Composer composer3, int i5) {
                    ...
                    final String m1466getStringNWtq28 = Strings_androidKt.m1466getStringNWtq28(Strings.INSTANCE.m1432getDatePickerYearPickerPaneTitleadMyvUU(), composer3, 6);
                    Modifier.Companion companion4 = Modifier.INSTANCE;
                    composer3.startReplaceableGroup(1157296644);
                    ComposerKt.sourceInformation(composer3, "CC(remember)P(1):Composables.kt#9igjgp");
                    boolean changed3 = composer3.changed(m1466getStringNWtq28);
                    ...
                    if (changed3 || rememberedValue4 == Composer.INSTANCE.getEmpty()) {
                        rememberedValue4 = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DatePickerContent$1$4$2$1$1
                            ...
                            public final void invoke2(SemanticsPropertyReceiver semantics) {
                                Intrinsics.checkNotNullParameter(semantics, "$this$semantics");
                                SemanticsPropertiesKt.setPaneTitle(semantics, m1466getStringNWtq28);
                            }
                        };
                    ...
                    Updater.m2271setimpl(m2264constructorimpl4, columnMeasurePolicy3, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
                    Updater.m2271setimpl(m2264constructorimpl4, density4, ComposeUiNode.INSTANCE.getSetDensity());
                    Updater.m2271setimpl(m2264constructorimpl4, layoutDirection4, ComposeUiNode.INSTANCE.getSetLayoutDirection());
                    Updater.m2271setimpl(m2264constructorimpl4, viewConfiguration4, ComposeUiNode.INSTANCE.getSetViewConfiguration());
                    composer3.enableReusing();
                    ...
                    DatePickerKt.YearPicker(PaddingKt.m484paddingVpY3zN4$default(SizeKt.m518requiredHeight3ABfNKs(Modifier.INSTANCE, Dp.m4878constructorimpl(Dp.m4878constructorimpl(DatePickerKt.getRecommendedSizeForAccessibility() * 7) - DividerDefaults.INSTANCE.m1176getThicknessD9Ej5fM())), DatePickerKt.getDatePickerHorizontalPadding(), 0.0f, 2, null), new Function1<Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DatePickerContent$1$4$2$2$1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        }
    ...
    public static final void m1146DatePickerHeaderpc5RIQQ(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final long j, final long j2, final float f, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i) {
        final int i2;
        ...
        if ((374491 & i2) != 74898 || !startRestartGroup.getSkipping()) {
            ...
            if (function2 != null) {
                companion = SizeKt.m514defaultMinSizeVpY3zN4$default(Modifier.INSTANCE, 0.0f, f, 1, null);
            } else {
            ...
            startRestartGroup.endReplaceableGroup();
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2620boximpl(j2))}, content, startRestartGroup, ((i2 >> 12) & 112) | 8);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            startRestartGroup.endReplaceableGroup();
            startRestartGroup.endNode();
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DatePickerHeader$2
            ...
            public final void invoke(Composer composer2, int i3) {
                DatePickerKt.m1146DatePickerHeaderpc5RIQQ(Modifier.this, function2, j, j2, f, content, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
                        ...
                        TextKt.ProvideTextStyle(fromToken, ComposableLambdaKt.composableLambda(composer2, 2133710592, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$WeekDays$1.1
                            ...
                            public final void invoke(Composer composer3, int i7) {
                                ...
                                if ((i7 & 11) != 2 || !composer3.getSkipping()) {
                                    ...
                                    Modifier fillMaxWidth$default = SizeKt.fillMaxWidth$default(SizeKt.m514defaultMinSizeVpY3zN4$default(Modifier.INSTANCE, 0.0f, DatePickerKt.getRecommendedSizeForAccessibility(), 1, null), 0.0f, 1, null);
                                    ...
                                    composer3.enableReusing();
                                    boolean z = 0;
                                    materializerOf.invoke(SkippableUpdater.m2255boximpl(SkippableUpdater.m2256constructorimpl(composer3)), composer4, 0);
                                    int i10 = 2058660585;
                                    composer4.startReplaceableGroup(2058660585);
                                    ...
                                    while (it.hasNext()) {
                                        ...
                                        composer3.endReplaceableGroup();
                                        Modifier m531sizeVpY3zN4 = SizeKt.m531sizeVpY3zN4(SemanticsModifierKt.clearAndSetSemantics(companion, (Function1) rememberedValue), DatePickerKt.getRecommendedSizeForAccessibility(), DatePickerKt.getRecommendedSizeForAccessibility());
                                        ...
                                        ViewConfiguration viewConfiguration2 = (ViewConfiguration) consume6;
                                        Function0<ComposeUiNode> constructor2 = ComposeUiNode.INSTANCE.getConstructor();
                                        Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf2 = LayoutKt.materializerOf(m531sizeVpY3zN4);
                                        if (!(composer3.getApplier() instanceof Applier)) {
                                            ComposablesKt.invalidApplier();
                                        }
                                        composer3.startReusableNode();
                                        ...
                                        Updater.m2271setimpl(m2264constructorimpl2, viewConfiguration2, ComposeUiNode.INSTANCE.getSetViewConfiguration());
                                        composer3.enableReusing();
                                        materializerOf2.invoke(SkippableUpdater.m2255boximpl(SkippableUpdater.m2256constructorimpl(composer3)), composer4, Integer.valueOf((int) z));
                                        ...
                                        TextKt.m1553Text4IGK_g((String) pair.getSecond(), SizeKt.wrapContentSize$default(Modifier.INSTANCE, alignment, z, 3, alignment), 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, TextAlign.m4765boximpl(TextAlign.INSTANCE.m4772getCentere0LSkKk()), 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer3, 48, 0, 130556);
                                        ComposerKt.sourceInformationMarkerEnd(composer3);
                                        ComposerKt.sourceInformationMarkerEnd(composer3);
                                        composer3.endReplaceableGroup();
                                        composer3.endNode();
                ...
                if (changed2 || rememberedValue2 == Composer.INSTANCE.getEmpty()) {
                    rememberedValue2 = (Function1) new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.material3.DatePickerKt$Month$rangeSelectionDrawModifier$1$1
                        ...
                        public final void invoke2(ContentDrawScope drawWithContent) {
                            ...
                            if (value != null) {
                                DateRangePickerKt.m1153drawRangeBackgroundmxwnekA(drawWithContent, value, colors.getDayInSelectionRangeContainerColor());
                            }
            ...
            TextKt.ProvideTextStyle(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography(startRestartGroup, 6), DatePickerModalTokens.INSTANCE.getDateLabelTextFont()), ComposableLambdaKt.composableLambda(composer2, -1776200645, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$Month$1
                ...
                public final void invoke(Composer composer3, int i4) {
                    ...
                    if ((i4 & 11) != 2 || !composer3.getSkipping()) {
                        ...
                        Modifier then = SizeKt.m518requiredHeight3ABfNKs(Modifier.INSTANCE, Dp.m4878constructorimpl(DatePickerKt.getRecommendedSizeForAccessibility() * 6)).then(Modifier.this);
                        Arrangement.HorizontalOrVertical spaceEvenly = Arrangement.INSTANCE.getSpaceEvenly();
                        ...
                        while (i10 < i11) {
                            ...
                            while (i14 < 7) {
                                if (i15 < calendarMonth2.getDaysFromStartOfWeekToFirstOfMonth() || i15 >= calendarMonth2.getDaysFromStartOfWeekToFirstOfMonth() + calendarMonth2.getNumberOfDays()) {
                                    ...
                                    SpacerKt.Spacer(SizeKt.m523requiredSizeVpY3zN4(Modifier.INSTANCE, DatePickerKt.getRecommendedSizeForAccessibility(), DatePickerKt.getRecommendedSizeForAccessibility()), composer3, 6);
                                    composer3.endReplaceableGroup();
                                } else {
                                    ...
                                    DatePickerKt.Day(companion3, z9, function0, z10, booleanValue, z11, booleanValue2, str9, datePickerColors, ComposableLambdaKt.composableLambda(composer3, 1633583293, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$Month$1$1$1$1$1$3
                                        ...
                                        public final void invoke(Composer composer4, int i18) {
                                            ...
                                            if ((i18 & 11) != 2 || !composer4.getSkipping()) {
                                                ...
                                                TextKt.m1553Text4IGK_g(DatePickerKt.toLocalString(daysFromStartOfWeekToFirstOfMonth + 1), SemanticsModifierKt.clearAndSetSemantics(Modifier.INSTANCE, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt$Month$1$1$1$1$1$3.1
                                                    /* renamed from: invoke, reason: avoid collision after fix types in other method */
                                                    public final void invoke2(SemanticsPropertyReceiver clearAndSetSemantics) {
                                                        Intrinsics.checkNotNullParameter(clearAndSetSemantics, "$this$clearAndSetSemantics");
                                                    }
                                                ...
                                                }), 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, TextAlign.m4765boximpl(TextAlign.INSTANCE.m4772getCentere0LSkKk()), 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer4, 0, 0, 130556);
                                                if (ComposerKt.isTraceInProgress()) {
                                                    ComposerKt.traceEventEnd();
                                                    return;
                                                }
    ...
    public static final String dayContentDescription(boolean z, boolean z2, boolean z3, boolean z4, boolean z5, Composer composer, int i) {
        ...
        if (z) {
            if (z3) {
                ...
                sb.append(Strings_androidKt.m1466getStringNWtq28(Strings.INSTANCE.m1439getDateRangePickerStartHeadlineadMyvUU(), composer, 6));
                composer.endReplaceableGroup();
            } else if (z4) {
                composer.startReplaceableGroup(-852203980);
                ComposerKt.sourceInformation(composer, "1553@64360L54");
                sb.append(Strings_androidKt.m1466getStringNWtq28(Strings.INSTANCE.m1436getDateRangePickerEndHeadlineadMyvUU(), composer, 6));
                composer.endReplaceableGroup();
            } else if (z5) {
                composer.startReplaceableGroup(-852203842);
                ComposerKt.sourceInformation(composer, "1557@64498L53");
                sb.append(Strings_androidKt.m1466getStringNWtq28(Strings.INSTANCE.m1435getDateRangePickerDayInRangeadMyvUU(), composer, 6));
                composer.endReplaceableGroup();
            } else {
        ...
        if (z2) {
            ...
            sb.append(Strings_androidKt.m1466getStringNWtq28(Strings.INSTANCE.m1431getDatePickerTodayDescriptionadMyvUU(), composer, 6));
        }
    ...
    public static final void Day(final Modifier modifier, final boolean z, final Function0<Unit> function0, final boolean z2, final boolean z3, final boolean z4, final boolean z5, final String str, final DatePickerColors datePickerColors, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        ...
        if ((1533916891 & i3) != 306783378 || !startRestartGroup.getSkipping()) {
            ...
            Modifier m523requiredSizeVpY3zN4 = SizeKt.m523requiredSizeVpY3zN4(InteractiveComponentSizeKt.minimumInteractiveComponentSize(modifier), DatePickerModalTokens.INSTANCE.m1788getDateStateLayerWidthD9Ej5fM(), DatePickerModalTokens.INSTANCE.m1787getDateStateLayerHeightD9Ej5fM());
            startRestartGroup.startReplaceableGroup(1157296644);
            ComposerKt.sourceInformation(startRestartGroup, "CC(remember)P(1):Composables.kt#9igjgp");
            ...
            if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
                rememberedValue = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt$Day$1$1
                    ...
                    public final void invoke2(SemanticsPropertyReceiver semantics) {
                        ...
                        SemanticsPropertiesKt.m4264setRolekuIjeqM(semantics, Role.INSTANCE.m4250getButtono7Vup1c());
                    }
                };
                startRestartGroup.updateRememberedValue(rememberedValue);
            }
            startRestartGroup.endReplaceableGroup();
            Modifier semantics = SemanticsModifierKt.semantics(m523requiredSizeVpY3zN4, true, (Function1) rememberedValue);
            Shape shape = ShapesKt.toShape(DatePickerModalTokens.INSTANCE.getDateContainerShape(), startRestartGroup, 6);
            int i4 = i3 >> 3;
            int i5 = i4 & 14;
            int i6 = i3 >> 15;
            long m2640unboximpl = datePickerColors.dayContainerColor$material3_release(z, z3, z2, startRestartGroup, i5 | ((i3 >> 9) & 112) | (i4 & 896) | (i6 & 7168)).getValue().m2640unboximpl();
            int i7 = (i6 & 14) | (i3 & 112);
            int i8 = i3 >> 12;
            int i9 = i4 & 7168;
            composer2 = startRestartGroup;
            SurfaceKt.m1476Surfaced85dljk(z, function0, semantics, z3, shape, m2640unboximpl, datePickerColors.dayContentColor$material3_release(z4, z, z5, z3, startRestartGroup, i7 | (i8 & 896) | i9 | (i8 & 57344)).getValue().m2640unboximpl(), 0.0f, 0.0f, (!z4 || z) ? null : BorderStrokeKt.m188BorderStrokecXLIe8U(DatePickerModalTokens.INSTANCE.m1789getDateTodayContainerOutlineWidthD9Ej5fM(), datePickerColors.getTodayDateBorderColor()), (MutableInteractionSource) null, ComposableLambdaKt.composableLambda(startRestartGroup, -2031780827, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$Day$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
            ...
            TextKt.ProvideTextStyle(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography(startRestartGroup, 6), DatePickerModalTokens.INSTANCE.getSelectionYearLabelTextFont()), ComposableLambdaKt.composableLambda(startRestartGroup, -145469688, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$YearPicker$1
                ...
                public final void invoke(Composer composer2, int i4) {
                    ...
                    if ((i4 & 11) != 2 || !composer2.getSkipping()) {
                        ...
                        if (Color.m2631equalsimpl0(datePickerColors.getContainerColor(), MaterialTheme.INSTANCE.getColorScheme(composer2, 6).m1059getSurface0d7_KjU())) {
                            ...
                            ComposerKt.sourceInformationMarkerEnd(composer2);
                            containerColor = ColorSchemeKt.m1100surfaceColorAtElevation3ABfNKs(colorScheme, ((Dp) consume).m4892unboximpl());
                        } else {
                        ...
                        final CoroutineScope coroutineScope = ((CompositionScopedCoroutineScopeCanceller) rememberedValue).getCoroutineScope();
                        composer2.endReplaceableGroup();
                        final String m1466getStringNWtq28 = Strings_androidKt.m1466getStringNWtq28(Strings.INSTANCE.m1422getDatePickerScrollToShowEarlierYearsadMyvUU(), composer2, 6);
                        final String m1466getStringNWtq282 = Strings_androidKt.m1466getStringNWtq28(Strings.INSTANCE.m1423getDatePickerScrollToShowLaterYearsadMyvUU(), composer2, 6);
                        GridCells.Fixed fixed = new GridCells.Fixed(3);
                        Modifier semantics$default = SemanticsModifierKt.semantics$default(BackgroundKt.m161backgroundbw27NRU$default(modifier, j, null, 2, null), false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt$YearPicker$1.1
                            @Override // kotlin.jvm.functions.Function1
                            public /* bridge */ /* synthetic */ Unit invoke(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                                invoke2(semanticsPropertyReceiver);
                                return Unit.INSTANCE;
                        ...
                        final int i5 = i3;
                        final DatePickerColors datePickerColors2 = datePickerColors;
                        LazyGridDslKt.LazyVerticalGrid(fixed, semantics$default, rememberLazyGridState, null, false, arrangement.m393spacedBy0680j_4(f), spaceEvenly, null, false, new Function1<LazyGridScope, Unit>() { // from class: androidx.compose.material3.DatePickerKt$YearPicker$1.2
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            {
                                super(1);
                            ...
                            public final void invoke2(LazyGridScope LazyVerticalGrid) {
                                ...
                                final CoroutineScope coroutineScope2 = coroutineScope;
                                final String str = m1466getStringNWtq28;
                                final String str2 = m1466getStringNWtq282;
                                LazyGridScope.items$default(LazyVerticalGrid, count, null, null, null, ComposableLambdaKt.composableLambdaInstance(1369226173, true, new Function4<LazyGridItemScope, Integer, Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt.YearPicker.1.2.1
                                    ...
                                    public final void invoke(LazyGridItemScope items, final int i9, Composer composer3, int i10) {
                                        ...
                                        if ((i11 & 721) != 144 || !composer3.getSkipping()) {
                                            ...
                                            Modifier m523requiredSizeVpY3zN4 = SizeKt.m523requiredSizeVpY3zN4(Modifier.INSTANCE, DatePickerModalTokens.INSTANCE.m1796getSelectionYearContainerWidthD9Ej5fM(), DatePickerModalTokens.INSTANCE.m1795getSelectionYearContainerHeightD9Ej5fM());
                                            final LazyGridState lazyGridState2 = lazyGridState;
                                            final CoroutineScope coroutineScope3 = coroutineScope2;
                                            final String str3 = str;
                                            final String str4 = str2;
                                            Modifier semantics$default2 = SemanticsModifierKt.semantics$default(m523requiredSizeVpY3zN4, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt.YearPicker.1.2.1.1
                                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                                {
                                                    super(1);
                                                }
                                            ...
                                            composer3.endReplaceableGroup();
                                            String format = String.format(Strings_androidKt.m1466getStringNWtq28(Strings.INSTANCE.m1420getDatePickerNavigateToYearDescriptionadMyvUU(), composer3, 6), Arrays.copyOf(new Object[]{localString}, 1));
                                            ...
                                            DatePickerKt.Year(semantics$default2, z, z2, (Function0) rememberedValue2, format, datePickerColors3, ComposableLambdaKt.composableLambda(composer3, 2095319565, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt.YearPicker.1.2.1.3
                                                ...
                                                public final void invoke(Composer composer4, int i12) {
                                                    ...
                                                    if ((i12 & 11) != 2 || !composer4.getSkipping()) {
                                                        ...
                                                        TextKt.m1553Text4IGK_g(localString, SemanticsModifierKt.clearAndSetSemantics(Modifier.INSTANCE, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt.YearPicker.1.2.1.3.1
                                                            /* renamed from: invoke, reason: avoid collision after fix types in other method */
                                                            public final void invoke2(SemanticsPropertyReceiver clearAndSetSemantics) {
                                                                Intrinsics.checkNotNullParameter(clearAndSetSemantics, "$this$clearAndSetSemantics");
                                                            }
    ...
    public static final void Year(final Modifier modifier, final boolean z, final boolean z2, final Function0<Unit> function0, final String str, final DatePickerColors datePickerColors, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        ...
        if ((2995931 & i2) != 599186 || !startRestartGroup.getSkipping()) {
            ...
            Object rememberedValue = startRestartGroup.rememberedValue();
            if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
                rememberedValue = (!z2 || z) ? null : BorderStrokeKt.m188BorderStrokecXLIe8U(DatePickerModalTokens.INSTANCE.m1789getDateTodayContainerOutlineWidthD9Ej5fM(), datePickerColors.getTodayDateBorderColor());
                startRestartGroup.updateRememberedValue(rememberedValue);
            }
            startRestartGroup.endReplaceableGroup();
            ...
            int i6 = (i2 >> 3) & 14;
            composer2 = startRestartGroup;
            SurfaceKt.m1476Surfaced85dljk(z, function0, SemanticsModifierKt.semantics(modifier, true, (Function1) rememberedValue2), false, ShapesKt.toShape(DatePickerModalTokens.INSTANCE.getSelectionYearStateLayerShape(), startRestartGroup, 6), datePickerColors.yearContainerColor$material3_release(z, startRestartGroup, i6 | (i5 & 112)).getValue().m2640unboximpl(), datePickerColors.yearContentColor$material3_release(z2, z, startRestartGroup, i4 | ((i2 >> 9) & 896)).getValue().m2640unboximpl(), 0.0f, 0.0f, borderStroke, (MutableInteractionSource) null, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda(startRestartGroup, -68753950, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$Year$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
    ...
    public static final void MonthsNavigation(final Modifier modifier, final boolean z, final boolean z2, final boolean z3, final String str, final Function0<Unit> function0, final Function0<Unit> function02, final Function0<Unit> function03, Composer composer, final int i) {
        ...
        if ((23967451 & i3) != 4793490 || !startRestartGroup.getSkipping()) {
            ...
            Modifier m518requiredHeight3ABfNKs = SizeKt.m518requiredHeight3ABfNKs(SizeKt.fillMaxWidth$default(modifier, 0.0f, 1, null), MonthYearHeight);
            if (z3) {
            ...
            ViewConfiguration viewConfiguration = (ViewConfiguration) consume3;
            Function0<ComposeUiNode> constructor = ComposeUiNode.INSTANCE.getConstructor();
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf = LayoutKt.materializerOf(m518requiredHeight3ABfNKs);
            if (!(startRestartGroup.getApplier() instanceof Applier)) {
                ComposablesKt.invalidApplier();
            }
            startRestartGroup.startReusableNode();
                    ...
                    if ((i4 & 11) != 2 || !composer3.getSkipping()) {
                        ...
                        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
                            rememberedValue = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt$MonthsNavigation$1$1$1$1
                                ...
                                public final void invoke2(SemanticsPropertyReceiver semantics) {
                                    Intrinsics.checkNotNullParameter(semantics, "$this$semantics");
                                    SemanticsPropertiesKt.m4263setLiveRegionhR3wRGc(semantics, LiveRegionMode.INSTANCE.m4242getPolite0phEisY());
                        ...
                        composer3.endReplaceableGroup();
                        TextKt.m1553Text4IGK_g(str2, SemanticsModifierKt.semantics$default(companion, false, (Function1) rememberedValue, 1, null), 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer3, (i3 >> 12) & 14, 0, 131068);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
                ...
                IconButtonKt.IconButton(function02, null, z2, null, null, ComposableLambdaKt.composableLambda(startRestartGroup, -1143715416, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$MonthsNavigation$1$2$1
                    ...
                    public final void invoke(Composer composer3, int i4) {
                        ...
                        if ((i4 & 11) != 2 || !composer3.getSkipping()) {
                            ...
                            IconKt.m1237Iconww6aTOc(keyboardArrowLeft, Strings_androidKt.m1466getStringNWtq28(Strings.INSTANCE.m1428getDatePickerSwitchToPreviousMonthadMyvUU(), composer3, 6), (Modifier) null, 0L, composer3, 0, 12);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                                return;
                            }
                ...
                IconButtonKt.IconButton(function0, null, z, null, null, ComposableLambdaKt.composableLambda(composer2, 1336532191, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$MonthsNavigation$1$2$2
                    ...
                    public final void invoke(Composer composer3, int i4) {
                        ...
                        if ((i4 & 11) != 2 || !composer3.getSkipping()) {
                            ...
                            IconKt.m1237Iconww6aTOc(keyboardArrowRight, Strings_androidKt.m1466getStringNWtq28(Strings.INSTANCE.m1427getDatePickerSwitchToNextMonthadMyvUU(), composer3, 6), (Modifier) null, 0L, composer3, 0, 12);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                                return;
                            }
    ...
    */
    ...
    static {
        float f = 12;
        DatePickerHorizontalPadding = Dp.m4878constructorimpl(f);
        DatePickerModeTogglePadding = PaddingKt.m479PaddingValuesa9UjIt4$default(0.0f, 0.0f, Dp.m4878constructorimpl(f), Dp.m4878constructorimpl(f), 3, null);
        float f2 = 24;
        float f3 = 16;
        DatePickerTitlePadding = PaddingKt.m479PaddingValuesa9UjIt4$default(Dp.m4878constructorimpl(f2), Dp.m4878constructorimpl(f3), Dp.m4878constructorimpl(f), 0.0f, 8, null);
        DatePickerHeadlinePadding = PaddingKt.m479PaddingValuesa9UjIt4$default(Dp.m4878constructorimpl(f2), 0.0f, Dp.m4878constructorimpl(f), Dp.m4878constructorimpl(f), 2, null);
        YearsVerticalPadding = Dp.m4878constructorimpl(f3);
    }
}
