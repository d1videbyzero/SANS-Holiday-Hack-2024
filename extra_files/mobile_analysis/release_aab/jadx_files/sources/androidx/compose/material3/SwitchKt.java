...
public final class SwitchKt {
    ...
    */
    ...
    public static final void m1497SwitchImpl0DmnUew(final BoxScope boxScope, final boolean z, final boolean z2, final SwitchColors switchColors, final State<Float> state, final Function2<? super Composer, ? super Integer, Unit> function2, final InteractionSource interactionSource, final Shape shape, final float f, final float f2, final float f3, Composer composer, final int i, final int i2) {
        int i3;
        int i4;
        float m4878constructorimpl;
        final float floatValue;
        float m2147getTrackOutlineWidthD9Ej5fM;
        ...
        if ((i3 & 1533916891) != 306783378 || (i4 & 11) != 2 || !startRestartGroup.getSkipping()) {
            ...
            float mo323toDpu2uoSUM = ((Density) consume).mo323toDpu2uoSUM(state.getValue().floatValue());
            if (SwitchImpl_0DmnUew$lambda$7(collectIsPressedAsState)) {
                m4878constructorimpl = SwitchTokens.INSTANCE.m2141getPressedHandleWidthD9Ej5fM();
            } else {
                m4878constructorimpl = Dp.m4878constructorimpl(Dp.m4878constructorimpl(Dp.m4878constructorimpl(ThumbDiameter - f) * (Dp.m4878constructorimpl(mo323toDpu2uoSUM - f2) / Dp.m4878constructorimpl(f3 - f2))) + f);
            }
            ...
            if (SwitchImpl_0DmnUew$lambda$7(collectIsPressedAsState)) {
                ...
                if (!z) {
                    m2147getTrackOutlineWidthD9Ej5fM = SwitchTokens.INSTANCE.m2147getTrackOutlineWidthD9Ej5fM();
                } else {
                    m2147getTrackOutlineWidthD9Ej5fM = Dp.m4878constructorimpl(ThumbPathLength - SwitchTokens.INSTANCE.m2147getTrackOutlineWidthD9Ej5fM());
                }
                floatValue = density.mo327toPx0680j_4(m2147getTrackOutlineWidthD9Ej5fM);
            } else {
            ...
            Modifier m160backgroundbw27NRU = BackgroundKt.m160backgroundbw27NRU(BorderKt.m172borderxT4_qwU(SizeKt.m515height3ABfNKs(SizeKt.m534width3ABfNKs(boxScope.align(Modifier.INSTANCE, Alignment.INSTANCE.getCenter()), SwitchWidth), SwitchHeight), SwitchTokens.INSTANCE.m2147getTrackOutlineWidthD9Ej5fM(), switchColors.borderColor$material3_release(z2, z, startRestartGroup, i5).getValue().m2640unboximpl(), shape2), SwitchImpl_0DmnUew$lambda$6(trackColor$material3_release), shape2);
            ...
            Updater.m2271setimpl(m2264constructorimpl, density2, ComposeUiNode.INSTANCE.getSetDensity());
            ...
            if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
                rememberedValue = (Function1) new Function1<Density, IntOffset>() { // from class: androidx.compose.material3.SwitchKt$SwitchImpl$1$1$1
                    ...
                    public /* bridge */ /* synthetic */ IntOffset invoke(Density density3) {
                        return IntOffset.m4987boximpl(m1499invokeBjo55l4(density3));
                    }

                    /* renamed from: invoke-Bjo55l4, reason: not valid java name */
                    public final long m1499invokeBjo55l4(Density offset) {
            ...
            startRestartGroup.endReplaceableGroup();
            Modifier m160backgroundbw27NRU2 = BackgroundKt.m160backgroundbw27NRU(SizeKt.m521requiredSize3ABfNKs(IndicationKt.indication(OffsetKt.offset(align, (Function1) rememberedValue), interactionSource, RippleKt.m967rememberRipple9IZ8Weo(false, Dp.m4878constructorimpl(SwitchTokens.INSTANCE.m2145getStateLayerSizeD9Ej5fM() / 2), 0L, startRestartGroup, 54, 4)), m4878constructorimpl), SwitchImpl_0DmnUew$lambda$13$lambda$10, shape);
            ...
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf2 = LayoutKt.materializerOf(m160backgroundbw27NRU2);
            if (!(startRestartGroup.getApplier() instanceof Applier)) {
                ComposablesKt.invalidApplier();
            }
            startRestartGroup.startReusableNode();
            ...
            Updater.m2271setimpl(m2264constructorimpl2, rememberBoxMeasurePolicy2, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            Updater.m2271setimpl(m2264constructorimpl2, density3, ComposeUiNode.INSTANCE.getSetDensity());
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SwitchKt$SwitchImpl$2
            ...
            public final void invoke(Composer composer2, int i7) {
                SwitchKt.m1497SwitchImpl0DmnUew(BoxScope.this, z, z2, switchColors, state, function2, interactionSource, shape, f, f2, f3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), RecomposeScopeImplKt.updateChangedFlags(i2));
            }
        });
    }

    static {
        float m2143getSelectedHandleWidthD9Ej5fM = SwitchTokens.INSTANCE.m2143getSelectedHandleWidthD9Ej5fM();
        ThumbDiameter = m2143getSelectedHandleWidthD9Ej5fM;
        UncheckedThumbDiameter = SwitchTokens.INSTANCE.m2150getUnselectedHandleWidthD9Ej5fM();
        float m2148getTrackWidthD9Ej5fM = SwitchTokens.INSTANCE.m2148getTrackWidthD9Ej5fM();
        SwitchWidth = m2148getTrackWidthD9Ej5fM;
        float m2146getTrackHeightD9Ej5fM = SwitchTokens.INSTANCE.m2146getTrackHeightD9Ej5fM();
        SwitchHeight = m2146getTrackHeightD9Ej5fM;
        float m4878constructorimpl = Dp.m4878constructorimpl(Dp.m4878constructorimpl(m2146getTrackHeightD9Ej5fM - m2143getSelectedHandleWidthD9Ej5fM) / 2);
        ThumbPadding = m4878constructorimpl;
        ThumbPathLength = Dp.m4878constructorimpl(Dp.m4878constructorimpl(m2148getTrackWidthD9Ej5fM - m2143getSelectedHandleWidthD9Ej5fM) - m4878constructorimpl);
