...
public final class TopAppBarColors {
    ...
    public final long m1669containerColorXeAY9LY$material3_release(float f, Composer composer, int i) {
        ...
        long m2681lerpjxsXWHM = ColorKt.m2681lerpjxsXWHM(this.containerColor, this.scrolledContainerColor, EasingKt.getFastOutLinearInEasing().transform(f));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m2681lerpjxsXWHM;
    }
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2631equalsimpl0(this.containerColor, topAppBarColors.containerColor) && Color.m2631equalsimpl0(this.scrolledContainerColor, topAppBarColors.scrolledContainerColor) && Color.m2631equalsimpl0(this.navigationIconContentColor, topAppBarColors.navigationIconContentColor) && Color.m2631equalsimpl0(this.titleContentColor, topAppBarColors.titleContentColor) && Color.m2631equalsimpl0(this.actionIconContentColor, topAppBarColors.actionIconContentColor);
    }

    public int hashCode() {
        return (((((((Color.m2637hashCodeimpl(this.containerColor) * 31) + Color.m2637hashCodeimpl(this.scrolledContainerColor)) * 31) + Color.m2637hashCodeimpl(this.navigationIconContentColor)) * 31) + Color.m2637hashCodeimpl(this.titleContentColor)) * 31) + Color.m2637hashCodeimpl(this.actionIconContentColor);
    }
}
