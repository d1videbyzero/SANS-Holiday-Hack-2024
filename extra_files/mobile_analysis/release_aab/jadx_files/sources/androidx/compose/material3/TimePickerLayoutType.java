...
public final class TimePickerLayoutType {
    ...
    private static final int Horizontal = m1584constructorimpl(0);
    private static final int Vertical = m1584constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TimePickerLayoutType m1583boximpl(int i) {
        return new TimePickerLayoutType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m1584constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m1585equalsimpl(int i, Object obj) {
        return (obj instanceof TimePickerLayoutType) && i == ((TimePickerLayoutType) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1586equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m1587hashCodeimpl(int i) {
    ...
    public int hashCode() {
        return m1587hashCodeimpl(this.value);
    }
    ...
    public static String m1588toStringimpl(int i) {
        return m1586equalsimpl0(i, Horizontal) ? "Horizontal" : m1586equalsimpl0(i, Vertical) ? "Vertical" : "Unknown";
    }
}
