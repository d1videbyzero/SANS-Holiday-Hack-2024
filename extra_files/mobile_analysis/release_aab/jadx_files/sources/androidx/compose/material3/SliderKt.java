...
public final class SliderKt {
    ...
    */
    ...
    public static final void SliderImpl(final Modifier modifier, final boolean z, final MutableInteractionSource mutableInteractionSource, final Function1<? super Float, Unit> function1, final Function0<Unit> function0, final int i, final float f, final ClosedFloatingPointRange<Float> closedFloatingPointRange, final Function3<? super SliderPositions, ? super Composer, ? super Integer, Unit> function3, final Function3<? super SliderPositions, ? super Composer, ? super Integer, Unit> function32, Composer composer, final int i2) {
        ...
        if ((1533916891 & i6) != 306783378 || !startRestartGroup.getSkipping()) {
            ...
            composer3 = composer2;
            Modifier then = FocusableKt.focusable(sliderSemantics(SizeKt.m525requiredSizeInqDBjuR0$default(InteractiveComponentSizeKt.minimumInteractiveComponentSize(modifier), SliderTokens.INSTANCE.m2116getHandleWidthD9Ej5fM(), SliderTokens.INSTANCE.m2115getHandleHeightD9Ej5fM(), 0.0f, 0.0f, 12, null), f, z, function1, function0, closedFloatingPointRange, i), z, mutableInteractionSource).then(sliderTapModifier).then(draggable);
            final float f4 = f3;
                        ...
                        if (LayoutIdKt.getLayoutId(measurable) == SliderComponents.THUMB) {
                            ...
                            for (Measurable measurable2 : list) {
                                if (LayoutIdKt.getLayoutId(measurable2) == SliderComponents.TRACK) {
                                    final Placeable mo3868measureBRTryo02 = measurable2.mo3868measureBRTryo0(Constraints.m4825copyZbe2FdA$default(ConstraintsKt.m4851offsetNN6EwU$default(j, -mo3868measureBRTryo0.getWidth(), 0, 2, null), 0, 0, 0, 0, 11, null));
                                    int width = mo3868measureBRTryo02.getWidth() + mo3868measureBRTryo0.getWidth();
                                    int max = Math.max(mo3868measureBRTryo02.getHeight(), mo3868measureBRTryo0.getHeight());
                                    mutableState6.setValue(Float.valueOf(mo3868measureBRTryo0.getWidth()));
                                    mutableState3.setValue(Integer.valueOf(width));
                                    final int width2 = mo3868measureBRTryo0.getWidth() / 2;
                                    final int roundToInt = MathKt.roundToInt(mo3868measureBRTryo02.getWidth() * f4);
                                    final int height = (max - mo3868measureBRTryo02.getHeight()) / 2;
                                    final int height2 = (max - mo3868measureBRTryo0.getHeight()) / 2;
                                    return MeasureScope.layout$default(Layout, width, max, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.SliderKt$SliderImpl$2$measure$1
                                        ...
                                        public final void invoke2(Placeable.PlacementScope layout) {
                                            ...
                                            Placeable.PlacementScope.placeRelative$default(layout, mo3868measureBRTryo0, roundToInt, height2, 0.0f, 4, null);
                                        }
                                    }, 4, null);
                                }
                            }
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final java.lang.Object m1385awaitSlop8vUncbI(androidx.compose.ui.input.pointer.AwaitPointerEventScope r8, long r9, int r11, kotlin.coroutines.Continuation<? super kotlin.Pair<androidx.compose.ui.input.pointer.PointerInputChange, java.lang.Float>> r12) {
        /*
        ...
        L37:
            ...
            r2 = r9
            r4 = r11
            java.lang.Object r8 = androidx.compose.material3.DragGestureDetectorCopyKt.m1178awaitHorizontalPointerSlopOrCancellationgDDlDlE(r1, r2, r4, r5, r6)
            if (r8 != r0) goto L55
            return r0
        L55:
            r7 = r12
        ...
        L68:
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.SliderKt.m1385awaitSlop8vUncbI(androidx.compose.ui.input.pointer.AwaitPointerEventScope, long, int, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    static {
        float m2116getHandleWidthD9Ej5fM = SliderTokens.INSTANCE.m2116getHandleWidthD9Ej5fM();
        ThumbWidth = m2116getHandleWidthD9Ej5fM;
        float m2115getHandleHeightD9Ej5fM = SliderTokens.INSTANCE.m2115getHandleHeightD9Ej5fM();
        ThumbHeight = m2115getHandleHeightD9Ej5fM;
        ThumbSize = DpKt.m4900DpSizeYgX7TsA(m2116getHandleWidthD9Ej5fM, m2115getHandleHeightD9Ej5fM);
        ThumbDefaultElevation = Dp.m4878constructorimpl(1);
        ThumbPressedElevation = Dp.m4878constructorimpl(6);
        TickSize = SliderTokens.INSTANCE.m2122getTickMarksContainerSizeD9Ej5fM();
        TrackHeight = SliderTokens.INSTANCE.m2117getInactiveTrackHeightD9Ej5fM();
        float m4878constructorimpl = Dp.m4878constructorimpl(48);
        SliderHeight = m4878constructorimpl;
        float m4878constructorimpl2 = Dp.m4878constructorimpl(144);
        SliderMinWidth = m4878constructorimpl2;
        DefaultSliderConstraints = SizeKt.m517heightInVpY3zN4$default(SizeKt.m536widthInVpY3zN4$default(Modifier.INSTANCE, m4878constructorimpl2, 0.0f, 2, null), 0.0f, m4878constructorimpl, 1, null);
    ...
    private static final Modifier sliderTapModifier(Modifier modifier, final DraggableState draggableState, final MutableInteractionSource mutableInteractionSource, final int i, final boolean z, final State<Float> state, final State<? extends Function0<Unit>> state2, final MutableState<Float> mutableState, final boolean z2) {
        return ComposedModifierKt.composed(modifier, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.material3.SliderKt$sliderTapModifier$$inlined$debugInspectorInfo$1
            ...
            static final class AnonymousClass1 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
                ...
                static final class C00341 extends SuspendLambda implements Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> {
                    final /* synthetic */ boolean $isRtl;
                    final /* synthetic */ int $maxPx;
                    final /* synthetic */ MutableState<Float> $pressOffset;
                    final /* synthetic */ State<Float> $rawOffset;
                    ...
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    C00341(boolean z, int i, MutableState<Float> mutableState, State<Float> state, Continuation<? super C00341> continuation) {
                    ...
                    public /* bridge */ /* synthetic */ Object invoke(PressGestureScope pressGestureScope, Offset offset, Continuation<? super Unit> continuation) {
                        return m1386invoked4ec7I(pressGestureScope, offset.getPackedValue(), continuation);
                    }

                    /* renamed from: invoke-d-4ec7I, reason: not valid java name */
                    public final Object m1386invoked4ec7I(PressGestureScope pressGestureScope, long j, Continuation<? super Unit> continuation) {
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        try {
                            if (i == 0) {
                                ...
                                long j = this.J$0;
                                this.$pressOffset.setValue(Boxing.boxFloat((this.$isRtl ? this.$maxPx - Offset.m2391getXimpl(j) : Offset.m2391getXimpl(j)) - this.$rawOffset.getValue().floatValue()));
                                this.label = 1;
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    if (i == 0) {
                        ...
                        this.label = 1;
                        if (TapGestureDetectorKt.detectTapGestures$default(pointerInputScope, null, null, c00341, new Function1<Offset, Unit>() { // from class: androidx.compose.material3.SliderKt.sliderTapModifier.2.1.2
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            {
                                super(1);
                            ...
                            public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                                m1387invokek4lQ0M(offset.getPackedValue());
                                return Unit.INSTANCE;
                            }

                            /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
                            public final void m1387invokek4lQ0M(long j) {
                            ...
                            static final class C00351 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                                ...
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                /* JADX WARN: Multi-variable type inference failed */
                                C00351(DraggableState draggableState, State<? extends Function0<Unit>> state, Continuation<? super C00351> continuation) {
                                    super(2, continuation);
                                    this.$draggableState = draggableState;
                                ...
                                static final class C00361 extends SuspendLambda implements Function2<DragScope, Continuation<? super Unit>, Object> {
                                    private /* synthetic */ Object L$0;
                                    int label;
