...
public final class SelectableChipElevation {
    ...
    private final State<Dp> animateElevation(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (!z) {
            ...
            EffectsKt.LaunchedEffect(Dp.m4876boximpl(f2), new SelectableChipElevation$animateElevation$2(animatable, f2, null), composer, 64);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(-699481799);
            ComposerKt.sourceInformation(composer, "1712@81209L570");
            EffectsKt.LaunchedEffect(Dp.m4876boximpl(f2), new SelectableChipElevation$animateElevation$3(animatable, this, f2, interaction, null), composer, 64);
            composer.endReplaceableGroup();
        }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m4883equalsimpl0(this.elevation, selectableChipElevation.elevation) && Dp.m4883equalsimpl0(this.pressedElevation, selectableChipElevation.pressedElevation) && Dp.m4883equalsimpl0(this.focusedElevation, selectableChipElevation.focusedElevation) && Dp.m4883equalsimpl0(this.hoveredElevation, selectableChipElevation.hoveredElevation) && Dp.m4883equalsimpl0(this.disabledElevation, selectableChipElevation.disabledElevation);
    }
