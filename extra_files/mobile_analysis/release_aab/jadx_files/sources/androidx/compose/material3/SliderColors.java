...
public final class SliderColors {
    ...
    public final State<Color> thumbColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2620boximpl(z ? this.thumbColor : this.disabledThumbColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2631equalsimpl0(this.thumbColor, sliderColors.thumbColor) && Color.m2631equalsimpl0(this.activeTrackColor, sliderColors.activeTrackColor) && Color.m2631equalsimpl0(this.activeTickColor, sliderColors.activeTickColor) && Color.m2631equalsimpl0(this.inactiveTrackColor, sliderColors.inactiveTrackColor) && Color.m2631equalsimpl0(this.inactiveTickColor, sliderColors.inactiveTickColor) && Color.m2631equalsimpl0(this.disabledThumbColor, sliderColors.disabledThumbColor) && Color.m2631equalsimpl0(this.disabledActiveTrackColor, sliderColors.disabledActiveTrackColor) && Color.m2631equalsimpl0(this.disabledActiveTickColor, sliderColors.disabledActiveTickColor) && Color.m2631equalsimpl0(this.disabledInactiveTrackColor, sliderColors.disabledInactiveTrackColor) && Color.m2631equalsimpl0(this.disabledInactiveTickColor, sliderColors.disabledInactiveTickColor);
    }

    public int hashCode() {
        return (((((((((((((((((Color.m2637hashCodeimpl(this.thumbColor) * 31) + Color.m2637hashCodeimpl(this.activeTrackColor)) * 31) + Color.m2637hashCodeimpl(this.activeTickColor)) * 31) + Color.m2637hashCodeimpl(this.inactiveTrackColor)) * 31) + Color.m2637hashCodeimpl(this.inactiveTickColor)) * 31) + Color.m2637hashCodeimpl(this.disabledThumbColor)) * 31) + Color.m2637hashCodeimpl(this.disabledActiveTrackColor)) * 31) + Color.m2637hashCodeimpl(this.disabledActiveTickColor)) * 31) + Color.m2637hashCodeimpl(this.disabledInactiveTrackColor)) * 31) + Color.m2637hashCodeimpl(this.disabledInactiveTickColor);
    }
}
