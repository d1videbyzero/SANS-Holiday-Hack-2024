...
final /* data */ class RichTooltipPositionProvider implements PopupPositionProvider {
    ...
    public long mo876calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        ...
        if (IntSize.m5038getWidthimpl(popupContentSize) + right > IntSize.m5038getWidthimpl(windowSize) && (right = anchorBounds.getLeft() - IntSize.m5038getWidthimpl(popupContentSize)) < 0) {
            right = anchorBounds.getLeft() + ((anchorBounds.getWidth() - IntSize.m5038getWidthimpl(popupContentSize)) / 2);
        }
        int top = (anchorBounds.getTop() - IntSize.m5037getHeightimpl(popupContentSize)) - this.tooltipAnchorPadding;
        if (top < 0) {
