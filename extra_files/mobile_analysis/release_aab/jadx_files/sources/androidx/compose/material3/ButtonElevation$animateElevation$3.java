    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (Dp.m4883equalsimpl0(m4892unboximpl, f)) {
                focus = new PressInteraction.Press(Offset.INSTANCE.m2407getZeroF1C5BW0(), null);
            } else {
            ...
            this.label = 1;
            if (ElevationKt.m1190animateElevationrAjV9yQ(this.$animatable, this.$target, focus, this.$interaction, this) == coroutine_suspended) {
