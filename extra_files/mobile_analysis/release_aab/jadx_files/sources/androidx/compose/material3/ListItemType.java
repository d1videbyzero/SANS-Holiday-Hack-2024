...
final class ListItemType implements Comparable<ListItemType> {
    ...
    private static final int OneLine = m1268constructorimpl(1);
    private static final int TwoLine = m1268constructorimpl(2);
    private static final int ThreeLine = m1268constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ListItemType m1266boximpl(int i) {
        return new ListItemType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m1268constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m1269equalsimpl(int i, Object obj) {
        return (obj instanceof ListItemType) && i == ((ListItemType) obj).getLines();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1270equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m1271hashCodeimpl(int i) {
    ...
    public boolean equals(Object obj) {
        return m1269equalsimpl(this.lines, obj);
    }

    public int hashCode() {
        return m1271hashCodeimpl(this.lines);
    }

    public String toString() {
        return m1272toStringimpl(this.lines);
    }
    ...
    public /* bridge */ /* synthetic */ int compareTo(ListItemType listItemType) {
        return m1273compareToyh95HIg(listItemType.getLines());
    }
    ...
    public static int m1267compareToyh95HIg(int i, int i2) {
        return Intrinsics.compare(i, i2);
    }

    /* renamed from: compareTo-yh95HIg, reason: not valid java name */
    public int m1273compareToyh95HIg(int i) {
        return m1267compareToyh95HIg(this.lines, i);
    }
    ...
    public static final class Companion {
        ...
        public final int m1276getOneLineAlXitO8() {
            return ListItemType.OneLine;
        }

        /* renamed from: getTwoLine-AlXitO8, reason: not valid java name */
        public final int m1278getTwoLineAlXitO8() {
            return ListItemType.TwoLine;
        }

        /* renamed from: getThreeLine-AlXitO8, reason: not valid java name */
        public final int m1277getThreeLineAlXitO8() {
            return ListItemType.ThreeLine;
        }

        /* renamed from: getListItemType-7AlIA9s$material3_release, reason: not valid java name */
        public final int m1275getListItemType7AlIA9s$material3_release(boolean hasOverline, boolean hasSupporting) {
            if (hasOverline && hasSupporting) {
                return m1277getThreeLineAlXitO8();
            }
            if (hasOverline || hasSupporting) {
                return m1278getTwoLineAlXitO8();
            }
            return m1276getOneLineAlXitO8();
        }
    }
}
