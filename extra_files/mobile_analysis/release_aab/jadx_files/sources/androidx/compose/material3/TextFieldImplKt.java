...
public final class TextFieldImplKt {
    ...
    private static final float HorizontalIconPadding = Dp.m4878constructorimpl(12);
    private static final float SupportingTopPadding = Dp.m4878constructorimpl(4);
    private static final float PrefixSuffixTextPadding = Dp.m4878constructorimpl(2);
    private static final float MinTextLineHeight = Dp.m4878constructorimpl(24);
    ...
    */
    ...
    public static final void m1543DecorationKTwxG1Y(final long j, TextStyle textStyle, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i, final int i2) {
        final int i3;
            ...
            ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(startRestartGroup, 1449369305, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextFieldImplKt$Decoration$contentWithColor$1
                ...
                public final void invoke(Composer composer2, int i5) {
                    ...
                    if ((i5 & 11) != 2 || !composer2.getSkipping()) {
                        ...
                        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2620boximpl(j))}, content, composer2, ((i3 >> 3) & 112) | 8);
                        if (ComposerKt.isTraceInProgress()) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextFieldImplKt$Decoration$1
            ...
            public final void invoke(Composer composer2, int i5) {
                TextFieldImplKt.m1543DecorationKTwxG1Y(j, textStyle2, content, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
            }
        });
    }
    ...
    static {
        float f = 16;
        TextFieldPadding = Dp.m4878constructorimpl(f);
        MinFocusedLabelLineHeight = Dp.m4878constructorimpl(f);
        MinSupportingTextLineHeight = Dp.m4878constructorimpl(f);
        float f2 = 48;
        IconDefaultSizeModifier = SizeKt.m513defaultMinSizeVpY3zN4(Modifier.INSTANCE, Dp.m4878constructorimpl(f2), Dp.m4878constructorimpl(f2));
    }
