...
final class CardElevation$animateElevation$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (this.$enabled) {
                float m4892unboximpl = this.$animatable.getTargetValue().m4892unboximpl();
                f = this.this$0.pressedElevation;
                DragInteraction.Start start = null;
                if (Dp.m4883equalsimpl0(m4892unboximpl, f)) {
                    start = new PressInteraction.Press(Offset.INSTANCE.m2407getZeroF1C5BW0(), null);
                } else {
                    f2 = this.this$0.hoveredElevation;
                    if (Dp.m4883equalsimpl0(m4892unboximpl, f2)) {
                        start = new HoverInteraction.Enter();
                    } else {
                        f3 = this.this$0.focusedElevation;
                        if (Dp.m4883equalsimpl0(m4892unboximpl, f3)) {
                            start = new FocusInteraction.Focus();
                        } else {
                            f4 = this.this$0.draggedElevation;
                            if (Dp.m4883equalsimpl0(m4892unboximpl, f4)) {
                ...
                this.label = 1;
                if (ElevationKt.m1190animateElevationrAjV9yQ(this.$animatable, this.$target, start, this.$interaction, this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                this.label = 2;
                if (this.$animatable.snapTo(Dp.m4876boximpl(this.$target), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
        } else {
