...
public final class OutlinedIconButtonTokens {
    ...
    private static final float ContainerSize = Dp.m4878constructorimpl((float) 40.0d);
    ...
    private static final float Size = Dp.m4878constructorimpl((float) 24.0d);
    ...
    public final float m2003getContainerSizeD9Ej5fM() {
    ...
    public final float m2004getSizeD9Ej5fM() {
        return Size;
    }
    ...
    public final float m2005getUnselectedOutlineWidthD9Ej5fM() {
