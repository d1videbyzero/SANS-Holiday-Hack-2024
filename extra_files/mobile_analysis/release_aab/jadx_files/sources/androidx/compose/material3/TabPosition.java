...
public final class TabPosition {
    ...
    public final float m1506getRightD9Ej5fM() {
        return Dp.m4878constructorimpl(this.left + this.width);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m4883equalsimpl0(this.left, tabPosition.left) && Dp.m4883equalsimpl0(this.width, tabPosition.width);
    }

    public int hashCode() {
        return (Dp.m4884hashCodeimpl(this.left) * 31) + Dp.m4884hashCodeimpl(this.width);
    }

    public String toString() {
        return "TabPosition(left=" + ((Object) Dp.m4889toStringimpl(this.left)) + ", right=" + ((Object) Dp.m4889toStringimpl(m1506getRightD9Ej5fM())) + ", width=" + ((Object) Dp.m4889toStringimpl(this.width)) + ')';
    }
}
