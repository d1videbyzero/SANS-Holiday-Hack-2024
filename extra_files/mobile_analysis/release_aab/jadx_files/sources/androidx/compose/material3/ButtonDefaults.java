...
public final class ButtonDefaults {
    ...
    public final float m1012getMinWidthD9Ej5fM() {
        return MinWidth;
    }

    /* renamed from: getMinHeight-D9Ej5fM, reason: not valid java name */
    public final float m1011getMinHeightD9Ej5fM() {
        return MinHeight;
    }

    /* renamed from: getIconSize-D9Ej5fM, reason: not valid java name */
    public final float m1009getIconSizeD9Ej5fM() {
        return IconSize;
    }

    /* renamed from: getIconSpacing-D9Ej5fM, reason: not valid java name */
    public final float m1010getIconSpacingD9Ej5fM() {
        return IconSpacing;
    }
    ...
    public final ButtonColors m1003buttonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long m2629copywmQWz5c$default = (i2 & 4) != 0 ? Color.m2629copywmQWz5c$default(ColorSchemeKt.toColor(FilledButtonTokens.INSTANCE.getDisabledContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j3;
        long m2629copywmQWz5c$default2 = (i2 & 8) != 0 ? Color.m2629copywmQWz5c$default(ColorSchemeKt.toColor(FilledButtonTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-339300779, i, -1, "androidx.compose.material3.ButtonDefaults.buttonColors (Button.kt:552)");
        }
        ButtonColors buttonColors = new ButtonColors(color, color2, m2629copywmQWz5c$default, m2629copywmQWz5c$default2, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ButtonColors m1005elevatedButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long m2629copywmQWz5c$default = (i2 & 4) != 0 ? Color.m2629copywmQWz5c$default(ColorSchemeKt.toColor(ElevatedButtonTokens.INSTANCE.getDisabledContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j3;
        long m2629copywmQWz5c$default2 = (i2 & 8) != 0 ? Color.m2629copywmQWz5c$default(ColorSchemeKt.toColor(ElevatedButtonTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final ButtonColors m1007filledTonalButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long m2629copywmQWz5c$default = (i2 & 4) != 0 ? Color.m2629copywmQWz5c$default(ColorSchemeKt.toColor(FilledTonalButtonTokens.INSTANCE.getDisabledContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j3;
        long m2629copywmQWz5c$default2 = (i2 & 8) != 0 ? Color.m2629copywmQWz5c$default(ColorSchemeKt.toColor(FilledTonalButtonTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final ButtonColors m1013outlinedButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long m2665getTransparent0d7_KjU = (i2 & 1) != 0 ? Color.INSTANCE.m2665getTransparent0d7_KjU() : j;
        long color = (i2 & 2) != 0 ? ColorSchemeKt.toColor(OutlinedButtonTokens.INSTANCE.getLabelTextColor(), composer, 6) : j2;
        long m2665getTransparent0d7_KjU2 = (i2 & 4) != 0 ? Color.INSTANCE.m2665getTransparent0d7_KjU() : j3;
        long m2629copywmQWz5c$default = (i2 & 8) != 0 ? Color.m2629copywmQWz5c$default(ColorSchemeKt.toColor(OutlinedButtonTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1778526249, i, -1, "androidx.compose.material3.ButtonDefaults.outlinedButtonColors (Button.kt:629)");
        }
        ButtonColors buttonColors = new ButtonColors(m2665getTransparent0d7_KjU, color, m2665getTransparent0d7_KjU2, m2629copywmQWz5c$default, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ButtonColors m1014textButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long m2665getTransparent0d7_KjU2 = (i2 & 4) != 0 ? Color.INSTANCE.m2665getTransparent0d7_KjU() : j3;
        long m2629copywmQWz5c$default = (i2 & 8) != 0 ? Color.m2629copywmQWz5c$default(ColorSchemeKt.toColor(TextButtonTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final ButtonElevation m1004buttonElevationR_JCAzs(float f, float f2, float f3, float f4, float f5, Composer composer, int i, int i2) {
        ...
        float m1886getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? FilledButtonTokens.INSTANCE.m1886getContainerElevationD9Ej5fM() : f;
        float m1892getPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? FilledButtonTokens.INSTANCE.m1892getPressedContainerElevationD9Ej5fM() : f2;
        float m1889getFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? FilledButtonTokens.INSTANCE.m1889getFocusContainerElevationD9Ej5fM() : f3;
        float m1890getHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? FilledButtonTokens.INSTANCE.m1890getHoverContainerElevationD9Ej5fM() : f4;
        float m1888getDisabledContainerElevationD9Ej5fM = (i2 & 16) != 0 ? FilledButtonTokens.INSTANCE.m1888getDisabledContainerElevationD9Ej5fM() : f5;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1827791191, i, -1, "androidx.compose.material3.ButtonDefaults.buttonElevation (Button.kt:679)");
        }
        ButtonElevation buttonElevation = new ButtonElevation(m1886getContainerElevationD9Ej5fM, m1892getPressedContainerElevationD9Ej5fM, m1889getFocusContainerElevationD9Ej5fM, m1890getHoverContainerElevationD9Ej5fM, m1888getDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ButtonElevation m1006elevatedButtonElevationR_JCAzs(float f, float f2, float f3, float f4, float f5, Composer composer, int i, int i2) {
        ...
        float m1802getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? ElevatedButtonTokens.INSTANCE.m1802getContainerElevationD9Ej5fM() : f;
        float m1808getPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? ElevatedButtonTokens.INSTANCE.m1808getPressedContainerElevationD9Ej5fM() : f2;
        float m1805getFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? ElevatedButtonTokens.INSTANCE.m1805getFocusContainerElevationD9Ej5fM() : f3;
        float m1806getHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? ElevatedButtonTokens.INSTANCE.m1806getHoverContainerElevationD9Ej5fM() : f4;
        float m1804getDisabledContainerElevationD9Ej5fM = (i2 & 16) != 0 ? ElevatedButtonTokens.INSTANCE.m1804getDisabledContainerElevationD9Ej5fM() : f5;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ButtonElevation buttonElevation = new ButtonElevation(m1802getContainerElevationD9Ej5fM, m1808getPressedContainerElevationD9Ej5fM, m1805getFocusContainerElevationD9Ej5fM, m1806getHoverContainerElevationD9Ej5fM, m1804getDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ButtonElevation m1008filledTonalButtonElevationR_JCAzs(float f, float f2, float f3, float f4, float f5, Composer composer, int i, int i2) {
        ...
        float m1909getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? FilledTonalButtonTokens.INSTANCE.m1909getContainerElevationD9Ej5fM() : f;
        float m1915getPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? FilledTonalButtonTokens.INSTANCE.m1915getPressedContainerElevationD9Ej5fM() : f2;
        float m1912getFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? FilledTonalButtonTokens.INSTANCE.m1912getFocusContainerElevationD9Ej5fM() : f3;
        float m1913getHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? FilledTonalButtonTokens.INSTANCE.m1913getHoverContainerElevationD9Ej5fM() : f4;
        float m4878constructorimpl = (i2 & 16) != 0 ? Dp.m4878constructorimpl(0) : f5;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ButtonElevation buttonElevation = new ButtonElevation(m1909getContainerElevationD9Ej5fM, m1915getPressedContainerElevationD9Ej5fM, m1912getFocusContainerElevationD9Ej5fM, m1913getHoverContainerElevationD9Ej5fM, m4878constructorimpl, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final BorderStroke getOutlinedButtonBorder(Composer composer, int i) {
        ...
        BorderStroke m188BorderStrokecXLIe8U = BorderStrokeKt.m188BorderStrokecXLIe8U(OutlinedButtonTokens.INSTANCE.m1994getOutlineWidthD9Ej5fM(), ColorSchemeKt.toColor(OutlinedButtonTokens.INSTANCE.getOutlineColor(), composer, 6));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    static {
        float m4878constructorimpl = Dp.m4878constructorimpl(24);
        ButtonHorizontalPadding = m4878constructorimpl;
        float f = 8;
        float m4878constructorimpl2 = Dp.m4878constructorimpl(f);
        ButtonVerticalPadding = m4878constructorimpl2;
        PaddingValues m478PaddingValuesa9UjIt4 = PaddingKt.m478PaddingValuesa9UjIt4(m4878constructorimpl, m4878constructorimpl2, m4878constructorimpl, m4878constructorimpl2);
        ContentPadding = m478PaddingValuesa9UjIt4;
        float f2 = 16;
        float m4878constructorimpl3 = Dp.m4878constructorimpl(f2);
        ButtonWithIconHorizontalStartPadding = m4878constructorimpl3;
        ButtonWithIconContentPadding = PaddingKt.m478PaddingValuesa9UjIt4(m4878constructorimpl3, m4878constructorimpl2, m4878constructorimpl, m4878constructorimpl2);
        float m4878constructorimpl4 = Dp.m4878constructorimpl(12);
        TextButtonHorizontalPadding = m4878constructorimpl4;
        TextButtonContentPadding = PaddingKt.m478PaddingValuesa9UjIt4(m4878constructorimpl4, m478PaddingValuesa9UjIt4.getTop(), m4878constructorimpl4, m478PaddingValuesa9UjIt4.getBottom());
        float m4878constructorimpl5 = Dp.m4878constructorimpl(f2);
        TextButtonWithIconHorizontalEndPadding = m4878constructorimpl5;
        TextButtonWithIconContentPadding = PaddingKt.m478PaddingValuesa9UjIt4(m4878constructorimpl4, m478PaddingValuesa9UjIt4.getTop(), m4878constructorimpl5, m478PaddingValuesa9UjIt4.getBottom());
        MinWidth = Dp.m4878constructorimpl(58);
        MinHeight = Dp.m4878constructorimpl(40);
        IconSize = FilledButtonTokens.INSTANCE.m1891getIconSizeD9Ej5fM();
        IconSpacing = Dp.m4878constructorimpl(f);
    }
}
