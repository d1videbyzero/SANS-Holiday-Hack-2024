...
public final class InputIdentifier {
    ...
    private static final int SingleDateInput = m1246constructorimpl(0);
    private static final int StartDateInput = m1246constructorimpl(1);
    private static final int EndDateInput = m1246constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ InputIdentifier m1245boximpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m1253getSingleDateInputJ2x2o4M() {
            return InputIdentifier.SingleDateInput;
        }

        /* renamed from: getStartDateInput-J2x2o4M, reason: not valid java name */
        public final int m1254getStartDateInputJ2x2o4M() {
            return InputIdentifier.StartDateInput;
        }

        /* renamed from: getEndDateInput-J2x2o4M, reason: not valid java name */
        public final int m1252getEndDateInputJ2x2o4M() {
            return InputIdentifier.EndDateInput;
        }
    }

    public String toString() {
        return m1250toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m1250toStringimpl(int i) {
        return m1248equalsimpl0(i, SingleDateInput) ? "SingleDateInput" : m1248equalsimpl0(i, StartDateInput) ? "StartDateInput" : m1248equalsimpl0(i, EndDateInput) ? "EndDateInput" : "Unknown";
    }
}
