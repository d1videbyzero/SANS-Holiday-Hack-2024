...
public final class BottomAppBarDefaults {
    ...
    private static final float ContainerElevation = BottomAppBarTokens.INSTANCE.m1695getContainerElevationD9Ej5fM();
    ...
    static {
        ...
        ContentPadding = PaddingKt.m479PaddingValuesa9UjIt4$default(f, bottomAppBarVerticalPadding, f2, 0.0f, 8, null);
    }

    /* renamed from: getContainerElevation-D9Ej5fM, reason: not valid java name */
    public final float m992getContainerElevationD9Ej5fM() {
    ...
    public final WindowInsets getWindowInsets(Composer composer, int i) {
        ...
        WindowInsets m555onlybOOhFvg = WindowInsetsKt.m555onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.INSTANCE, composer, 8), WindowInsetsSides.m566plusgK_yJZ4(WindowInsetsSides.INSTANCE.m576getHorizontalJoeWqyM(), WindowInsetsSides.INSTANCE.m574getBottomJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
