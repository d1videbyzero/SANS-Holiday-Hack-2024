...
public final class TimePickerColors {
    ...
    public final long m1561periodSelectorContainerColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
    ...
    public final long m1562periodSelectorContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
    ...
    public final long m1563timeSelectorContainerColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
    ...
    public final long m1564timeSelectorContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
    ...
    public final long m1556clockDialContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2631equalsimpl0(this.clockDialColor, timePickerColors.clockDialColor) && Color.m2631equalsimpl0(this.selectorColor, timePickerColors.selectorColor) && Color.m2631equalsimpl0(this.containerColor, timePickerColors.containerColor) && Color.m2631equalsimpl0(this.periodSelectorBorderColor, timePickerColors.periodSelectorBorderColor) && Color.m2631equalsimpl0(this.periodSelectorSelectedContainerColor, timePickerColors.periodSelectorSelectedContainerColor) && Color.m2631equalsimpl0(this.periodSelectorUnselectedContainerColor, timePickerColors.periodSelectorUnselectedContainerColor) && Color.m2631equalsimpl0(this.periodSelectorSelectedContentColor, timePickerColors.periodSelectorSelectedContentColor) && Color.m2631equalsimpl0(this.periodSelectorUnselectedContentColor, timePickerColors.periodSelectorUnselectedContentColor) && Color.m2631equalsimpl0(this.timeSelectorSelectedContainerColor, timePickerColors.timeSelectorSelectedContainerColor) && Color.m2631equalsimpl0(this.timeSelectorUnselectedContainerColor, timePickerColors.timeSelectorUnselectedContainerColor) && Color.m2631equalsimpl0(this.timeSelectorSelectedContentColor, timePickerColors.timeSelectorSelectedContentColor) && Color.m2631equalsimpl0(this.timeSelectorUnselectedContentColor, timePickerColors.timeSelectorUnselectedContentColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((Color.m2637hashCodeimpl(this.clockDialColor) * 31) + Color.m2637hashCodeimpl(this.selectorColor)) * 31) + Color.m2637hashCodeimpl(this.containerColor)) * 31) + Color.m2637hashCodeimpl(this.periodSelectorBorderColor)) * 31) + Color.m2637hashCodeimpl(this.periodSelectorSelectedContainerColor)) * 31) + Color.m2637hashCodeimpl(this.periodSelectorUnselectedContainerColor)) * 31) + Color.m2637hashCodeimpl(this.periodSelectorSelectedContentColor)) * 31) + Color.m2637hashCodeimpl(this.periodSelectorUnselectedContentColor)) * 31) + Color.m2637hashCodeimpl(this.timeSelectorSelectedContainerColor)) * 31) + Color.m2637hashCodeimpl(this.timeSelectorUnselectedContainerColor)) * 31) + Color.m2637hashCodeimpl(this.timeSelectorSelectedContentColor)) * 31) + Color.m2637hashCodeimpl(this.timeSelectorUnselectedContentColor);
    }
}
