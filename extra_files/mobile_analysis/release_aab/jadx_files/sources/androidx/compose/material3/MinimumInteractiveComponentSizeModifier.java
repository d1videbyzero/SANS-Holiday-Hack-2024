...
final class MinimumInteractiveComponentSizeModifier implements LayoutModifier {
    ...
    public MeasureResult mo39measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        final int max = Math.max(mo3868measureBRTryo0.getWidth(), measure.mo321roundToPx0680j_4(DpSize.m4976getWidthD9Ej5fM(this.size)));
        final int max2 = Math.max(mo3868measureBRTryo0.getHeight(), measure.mo321roundToPx0680j_4(DpSize.m4974getHeightD9Ej5fM(this.size)));
        return MeasureScope.layout$default(measure, max, max2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.MinimumInteractiveComponentSizeModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.place$default(layout, mo3868measureBRTryo0, MathKt.roundToInt((max - mo3868measureBRTryo0.getWidth()) / 2.0f), MathKt.roundToInt((max2 - mo3868measureBRTryo0.getHeight()) / 2.0f), 0.0f, 4, null);
            }
        }, 4, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return DpSize.m4973equalsimpl0(this.size, minimumInteractiveComponentSizeModifier.size);
    }

    public int hashCode() {
        return DpSize.m4978hashCodeimpl(this.size);
    }
}
