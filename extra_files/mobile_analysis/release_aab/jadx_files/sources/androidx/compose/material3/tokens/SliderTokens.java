...
public final class SliderTokens {
    ...
    private static final float DisabledHandleElevation = ElevationTokens.INSTANCE.m1816getLevel0D9Ej5fM();
    ...
    private static final float HandleElevation = ElevationTokens.INSTANCE.m1817getLevel1D9Ej5fM();
    ...
    private static final float LabelContainerElevation = ElevationTokens.INSTANCE.m1816getLevel0D9Ej5fM();
    private static final float LabelContainerHeight = Dp.m4878constructorimpl((float) 28.0d);
    ...
    private static final float TrackElevation = ElevationTokens.INSTANCE.m1816getLevel0D9Ej5fM();
    private static final ColorSchemeKeyTokens OverlapHandleOutlineColor = ColorSchemeKeyTokens.OnPrimary;
    private static final float OverlapHandleOutlineWidth = Dp.m4878constructorimpl((float) 1.0d);
    ...
    private static final float TickMarksContainerSize = Dp.m4878constructorimpl((float) 2.0d);
    ...
    static {
        float f = (float) 4.0d;
        ActiveTrackHeight = Dp.m4878constructorimpl(f);
        float f2 = (float) 20.0d;
        HandleHeight = Dp.m4878constructorimpl(f2);
        HandleWidth = Dp.m4878constructorimpl(f2);
        InactiveTrackHeight = Dp.m4878constructorimpl(f);
    }
    ...
    public final float m2112getActiveTrackHeightD9Ej5fM() {
    ...
    public final float m2113getDisabledHandleElevationD9Ej5fM() {
    ...
    public final float m2114getHandleElevationD9Ej5fM() {
        return HandleElevation;
    }

    /* renamed from: getHandleHeight-D9Ej5fM, reason: not valid java name */
    public final float m2115getHandleHeightD9Ej5fM() {
        return HandleHeight;
    }
    ...
    public final float m2116getHandleWidthD9Ej5fM() {
        return HandleWidth;
    }
    ...
    public final float m2117getInactiveTrackHeightD9Ej5fM() {
    ...
    public final float m2118getLabelContainerElevationD9Ej5fM() {
        return LabelContainerElevation;
    }

    /* renamed from: getLabelContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m2119getLabelContainerHeightD9Ej5fM() {
    ...
    public final float m2121getStateLayerSizeD9Ej5fM() {
        return StateLayerSize;
    }

    /* renamed from: getTrackElevation-D9Ej5fM, reason: not valid java name */
    public final float m2123getTrackElevationD9Ej5fM() {
    ...
    public final float m2120getOverlapHandleOutlineWidthD9Ej5fM() {
    ...
    public final float m2122getTickMarksContainerSizeD9Ej5fM() {
