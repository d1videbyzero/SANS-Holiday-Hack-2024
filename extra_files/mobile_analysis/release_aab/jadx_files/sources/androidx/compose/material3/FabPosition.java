...
public final class FabPosition {
    ...
    private static final int Center = m1199constructorimpl(0);
    private static final int End = m1199constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FabPosition m1198boximpl(int i) {
    ...
    public boolean equals(Object obj) {
        return m1200equalsimpl(this.value, obj);
    }
    ...
    public static final class Companion {
        ...
        public final int m1205getCenterERTFSPs() {
            return FabPosition.Center;
        }

        /* renamed from: getEnd-ERTFSPs, reason: not valid java name */
        public final int m1206getEndERTFSPs() {
    ...
    public static String m1203toStringimpl(int i) {
        return m1201equalsimpl0(i, Center) ? "FabPosition.Center" : "FabPosition.End";
    }
}
