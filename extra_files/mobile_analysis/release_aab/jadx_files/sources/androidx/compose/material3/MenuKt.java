...
public final class MenuKt {
    ...
    private static final float MenuVerticalMargin = Dp.m4878constructorimpl(48);
    private static final float DropdownMenuItemHorizontalPadding = Dp.m4878constructorimpl(12);
    private static final float DropdownMenuVerticalPadding = Dp.m4878constructorimpl(8);
    private static final float DropdownMenuItemDefaultMinWidth = Dp.m4878constructorimpl(112);
    private static final float DropdownMenuItemDefaultMaxWidth = Dp.m4878constructorimpl(280);
    ...
    */
    ...
    public static final void DropdownMenuItemContent(final Function2<? super Composer, ? super Integer, Unit> text, final Function0<Unit> onClick, final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final boolean z, final MenuItemColors colors, final PaddingValues contentPadding, final MutableInteractionSource interactionSource, Composer composer, final int i) {
        ...
        if ((191739611 & i3) != 38347922 || !startRestartGroup.getSkipping()) {
            ...
            Modifier padding = PaddingKt.padding(SizeKt.m533sizeInqDBjuR0$default(SizeKt.fillMaxWidth$default(ClickableKt.m192clickableO2vRcR0$default(modifier, interactionSource, RippleKt.m967rememberRipple9IZ8Weo(true, 0.0f, 0L, startRestartGroup, 6, 6), z, null, null, onClick, 24, null), 0.0f, 1, null), DropdownMenuItemDefaultMinWidth, MenuTokens.INSTANCE.m1961getListItemContainerHeightD9Ej5fM(), DropdownMenuItemDefaultMaxWidth, 0.0f, 8, null), contentPadding);
                            ...
                            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer3, 2035552199, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1.1
                                ...
                                public final void invoke(Composer composer4, int i7) {
                                    ...
                                    if ((i7 & 11) != 2 || !composer4.getSkipping()) {
                                        ...
                                        Modifier m514defaultMinSizeVpY3zN4$default = SizeKt.m514defaultMinSizeVpY3zN4$default(Modifier.INSTANCE, MenuTokens.INSTANCE.m1962getListItemLeadingIconSizeD9Ej5fM(), 0.0f, 2, null);
                                        ...
                                        Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf2 = LayoutKt.materializerOf(m514defaultMinSizeVpY3zN4$default);
                        ...
                        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr2, ComposableLambdaKt.composableLambda(composer3, -1728894036, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1.2
                            ...
                            public final void invoke(Composer composer4, int i9) {
                                ...
                                if ((i9 & 11) != 2 || !composer4.getSkipping()) {
                                    ...
                                    if (function24 != null) {
                                        m4878constructorimpl = MenuKt.DropdownMenuItemHorizontalPadding;
                                    } else {
                                        m4878constructorimpl = Dp.m4878constructorimpl(0);
                                    }
                                    float f = m4878constructorimpl;
                                    if (function25 != null) {
                                        m4878constructorimpl2 = MenuKt.DropdownMenuItemHorizontalPadding;
                                    } else {
                                        m4878constructorimpl2 = Dp.m4878constructorimpl(0);
                                    }
                                    Modifier m486paddingqDBjuR0$default = PaddingKt.m486paddingqDBjuR0$default(weight$default, f, 0.0f, m4878constructorimpl2, 0.0f, 10, null);
                            ...
                            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr3, ComposableLambdaKt.composableLambda(composer3, 580312062, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1.3
                                ...
                                public final void invoke(Composer composer4, int i11) {
                                    ...
                                    if ((i11 & 11) != 2 || !composer4.getSkipping()) {
                                        ...
                                        Modifier m514defaultMinSizeVpY3zN4$default = SizeKt.m514defaultMinSizeVpY3zN4$default(Modifier.INSTANCE, MenuTokens.INSTANCE.m1963getListItemTrailingIconSizeD9Ej5fM(), 0.0f, 2, null);
