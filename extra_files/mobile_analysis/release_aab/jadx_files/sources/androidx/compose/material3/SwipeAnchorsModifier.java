...
final class SwipeAnchorsModifier extends InspectorValueInfo implements LayoutModifier, OnRemeasuredModifier {
    ...
    public MeasureResult mo39measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measure, mo3868measureBRTryo0.getWidth(), mo3868measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.SwipeAnchorsModifier$measure$1
            {
                super(1);
            }
    ...
    public void mo252onRemeasuredozmzZPI(long size) {
        this.onSizeChanged.invoke(IntSize.m5030boximpl(size));
    }
