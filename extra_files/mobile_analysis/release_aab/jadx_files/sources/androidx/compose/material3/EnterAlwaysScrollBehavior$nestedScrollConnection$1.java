...
public final class EnterAlwaysScrollBehavior$nestedScrollConnection$1 implements NestedScrollConnection {
    ...
    public long mo335onPostScrollDzOQY0M(long consumed, long available, int source) {
        ...
        if ((this.this$0.getState().getHeightOffset() == 0.0f || this.this$0.getState().getHeightOffset() == this.this$0.getState().getHeightOffsetLimit()) && Offset.m2392getYimpl(consumed) == 0.0f && Offset.m2392getYimpl(available) > 0.0f) {
