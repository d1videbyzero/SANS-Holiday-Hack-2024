...
public final class CheckboxKt {
    ...
    private static final float CheckboxSize = Dp.m4878constructorimpl(20);
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:105:0x02b2 A[LOOP:0: B:103:0x02af->B:105:0x02b2, LOOP_END] */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void CheckboxImpl(final boolean r34, final androidx.compose.ui.state.ToggleableState r35, final androidx.compose.ui.Modifier r36, final androidx.compose.material3.CheckboxColors r37, androidx.compose.runtime.Composer r38, final int r39) {
        /*
    ...
    public static final void m1024drawBox1wkBAMs(DrawScope drawScope, long j, long j2, float f, float f2) {
        float f3 = f2 / 2.0f;
        ...
        if (Color.m2631equalsimpl0(j, j2)) {
            DrawScope.m3171drawRoundRectuAw5IA$default(drawScope, j, 0L, SizeKt.Size(m2460getWidthimpl, m2460getWidthimpl), CornerRadiusKt.CornerRadius$default(f, 0.0f, 2, null), Fill.INSTANCE, 0.0f, null, 0, 226, null);
            return;
        }
        float f4 = m2460getWidthimpl - (2 * f2);
        DrawScope.m3171drawRoundRectuAw5IA$default(drawScope, j, OffsetKt.Offset(f2, f2), SizeKt.Size(f4, f4), CornerRadiusKt.CornerRadius$default(Math.max(0.0f, f - f2), 0.0f, 2, null), Fill.INSTANCE, 0.0f, null, 0, 224, null);
        float f5 = m2460getWidthimpl - f2;
        DrawScope.m3171drawRoundRectuAw5IA$default(drawScope, j2, OffsetKt.Offset(f3, f3), SizeKt.Size(f5, f5), CornerRadiusKt.CornerRadius$default(f - f3, 0.0f, 2, null), stroke, 0.0f, null, 0, 224, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: drawCheck-3IgeMak, reason: not valid java name */
    public static final void m1025drawCheck3IgeMak(DrawScope drawScope, long j, float f, float f2, float f3, CheckDrawingCache checkDrawingCache) {
        Stroke stroke = new Stroke(f3, 0.0f, StrokeCap.INSTANCE.m2979getSquareKaPHkGw(), 0, null, 26, null);
        float m2460getWidthimpl = Size.m2460getWidthimpl(drawScope.mo3174getSizeNHjbRc());
        ...
        checkDrawingCache.getCheckPath().moveTo(0.2f * m2460getWidthimpl, lerp3 * m2460getWidthimpl);
        checkDrawingCache.getCheckPath().lineTo(lerp * m2460getWidthimpl, lerp2 * m2460getWidthimpl);
        checkDrawingCache.getCheckPath().lineTo(0.8f * m2460getWidthimpl, m2460getWidthimpl * lerp4);
        ...
        DrawScope.m3165drawPathLG529CI$default(drawScope, checkDrawingCache.getPathToDraw(), j, 0.0f, stroke, null, 0, 52, null);
    }

    static {
        float f = 2;
        CheckboxDefaultPadding = Dp.m4878constructorimpl(f);
        StrokeWidth = Dp.m4878constructorimpl(f);
        RadiusSize = Dp.m4878constructorimpl(f);
    }
}
