...
public final class TimePicker_androidKt {
    ...
    public static final int getDefaultTimePickerLayoutType(Composer composer, int i) {
        ...
        if (configuration.screenHeightDp < configuration.screenWidthDp) {
            m1591getVerticalQJTpgSE = TimePickerLayoutType.INSTANCE.m1590getHorizontalQJTpgSE();
        } else {
            m1591getVerticalQJTpgSE = TimePickerLayoutType.INSTANCE.m1591getVerticalQJTpgSE();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m1591getVerticalQJTpgSE;
    }
}
