...
public final class ExposedDropdownMenuPopupKt {
    ...
    public static final void ExposedDropdownMenuPopup(Function0<Unit> function0, final PopupPositionProvider popupPositionProvider, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i, final int i2) {
        ...
        if ((i6 & 731) != 146 || !startRestartGroup.getSkipping()) {
            ...
            UUID popupId = (UUID) RememberSaveableKt.m2277rememberSaveable(new Object[0], (Saver) null, (String) null, (Function0) new Function0<UUID>() { // from class: androidx.compose.material3.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$popupId$1
                @Override // kotlin.jvm.functions.Function0
                        ...
                        if ((i7 & 11) != 2 || !composer5.getSkipping()) {
                            ...
                            Modifier alpha = AlphaKt.alpha(OnRemeasuredModifierKt.onSizeChanged(semantics$default, new Function1<IntSize, Unit>() { // from class: androidx.compose.material3.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$popupLayout$1$1$1.2
                                ...
                                public /* bridge */ /* synthetic */ Unit invoke(IntSize intSize) {
                                    m1679invokeozmzZPI(intSize.getPackedValue());
                                    return Unit.INSTANCE;
                                }

                                /* renamed from: invoke-ozmzZPI, reason: not valid java name */
                                public final void m1679invokeozmzZPI(long j) {
                                    PopupLayout.this.m1681setPopupContentSizefhxjrPA(IntSize.m5030boximpl(j));
                            ...
                            Composer m2264constructorimpl = Updater.m2264constructorimpl(composer5);
                            Updater.m2271setimpl(m2264constructorimpl, exposedDropdownMenuPopupKt$SimpleStack$1, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
                            Updater.m2271setimpl(m2264constructorimpl, density2, ComposeUiNode.INSTANCE.getSetDensity());
                            Updater.m2271setimpl(m2264constructorimpl, layoutDirection3, ComposeUiNode.INSTANCE.getSetLayoutDirection());
                            Updater.m2271setimpl(m2264constructorimpl, viewConfiguration, ComposeUiNode.INSTANCE.getSetViewConfiguration());
                            materializerOf.invoke(SkippableUpdater.m2255boximpl(SkippableUpdater.m2256constructorimpl(composer5)), composer5, 0);
            ...
            Modifier onGloballyPositioned = OnGloballyPositionedModifierKt.onGloballyPositioned(Modifier.INSTANCE, new Function1<LayoutCoordinates, Unit>() { // from class: androidx.compose.material3.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$5
                ...
                public final void invoke2(LayoutCoordinates childCoordinates) {
                    ...
                    long mo3875getSizeYbymL2g = parentLayoutCoordinates.mo3875getSizeYbymL2g();
                    long positionInWindow = LayoutCoordinatesKt.positionInWindow(parentLayoutCoordinates);
                    PopupLayout.this.setParentBounds(IntRectKt.m5028IntRectVbeCjmY(IntOffsetKt.IntOffset(MathKt.roundToInt(Offset.m2391getXimpl(positionInWindow)), MathKt.roundToInt(Offset.m2392getYimpl(positionInWindow))), mo3875getSizeYbymL2g));
                    PopupLayout.this.updatePosition();
                }
            });
