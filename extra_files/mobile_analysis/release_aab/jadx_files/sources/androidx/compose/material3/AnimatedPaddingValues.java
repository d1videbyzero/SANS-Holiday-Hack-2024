...
final class AnimatedPaddingValues implements PaddingValues {
    ...
    public float getTop() {
        return Dp.m4878constructorimpl(this.topPadding.getValue().m4892unboximpl() * this.animationProgress.getValue().floatValue());
    }

    @Override // androidx.compose.foundation.layout.PaddingValues
    /* renamed from: calculateBottomPadding-D9Ej5fM */
    public float getBottom() {
        return Dp.m4878constructorimpl(SearchBarKt.getSearchBarVerticalPadding() * this.animationProgress.getValue().floatValue());
    }
