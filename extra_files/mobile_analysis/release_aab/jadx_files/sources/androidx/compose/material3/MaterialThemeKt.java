...
public final class MaterialThemeKt {
    ...
    */
    ...
    public static final TextSelectionColors rememberTextSelectionColors(ColorScheme colorScheme, Composer composer, int i) {
        ...
        long m1054getPrimary0d7_KjU = colorScheme.m1054getPrimary0d7_KjU();
        Color m2620boximpl = Color.m2620boximpl(m1054getPrimary0d7_KjU);
        composer.startReplaceableGroup(1157296644);
        ComposerKt.sourceInformation(composer, "CC(remember)P(1):Composables.kt#9igjgp");
        boolean changed = composer.changed(m2620boximpl);
        Object rememberedValue = composer.rememberedValue();
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = new TextSelectionColors(m1054getPrimary0d7_KjU, Color.m2629copywmQWz5c$default(m1054getPrimary0d7_KjU, 0.4f, 0.0f, 0.0f, 0.0f, 14, null), null);
