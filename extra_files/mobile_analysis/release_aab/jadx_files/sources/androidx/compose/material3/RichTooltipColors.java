...
public final class RichTooltipColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2631equalsimpl0(this.containerColor, richTooltipColors.containerColor) && Color.m2631equalsimpl0(this.contentColor, richTooltipColors.contentColor) && Color.m2631equalsimpl0(this.titleContentColor, richTooltipColors.titleContentColor) && Color.m2631equalsimpl0(this.actionContentColor, richTooltipColors.actionContentColor);
    }

    public int hashCode() {
        return (((((Color.m2637hashCodeimpl(this.containerColor) * 31) + Color.m2637hashCodeimpl(this.contentColor)) * 31) + Color.m2637hashCodeimpl(this.titleContentColor)) * 31) + Color.m2637hashCodeimpl(this.actionContentColor);
    }
}
