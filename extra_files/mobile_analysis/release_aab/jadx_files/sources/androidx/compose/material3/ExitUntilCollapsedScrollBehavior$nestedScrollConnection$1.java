...
public final class ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1 implements NestedScrollConnection {
    ...
    public long mo336onPreScrollOzD1aCk(long available, int source) {
        if (!this.this$0.getCanScroll().invoke().booleanValue() || Offset.m2392getYimpl(available) > 0.0f) {
            return Offset.INSTANCE.m2407getZeroF1C5BW0();
        }
        float heightOffset = this.this$0.getState().getHeightOffset();
        this.this$0.getState().setHeightOffset(this.this$0.getState().getHeightOffset() + Offset.m2392getYimpl(available));
        if (heightOffset != this.this$0.getState().getHeightOffset()) {
            return Offset.m2385copydBAh8RU$default(available, 0.0f, 0.0f, 2, null);
        }
        return Offset.INSTANCE.m2407getZeroF1C5BW0();
    }
    ...
    public long mo335onPostScrollDzOQY0M(long consumed, long available, int source) {
        ...
        state.setContentOffset(state.getContentOffset() + Offset.m2392getYimpl(consumed));
        if (Offset.m2392getYimpl(available) < 0.0f || Offset.m2392getYimpl(consumed) < 0.0f) {
            float heightOffset = this.this$0.getState().getHeightOffset();
            this.this$0.getState().setHeightOffset(this.this$0.getState().getHeightOffset() + Offset.m2392getYimpl(consumed));
            return OffsetKt.Offset(0.0f, this.this$0.getState().getHeightOffset() - heightOffset);
        }
        if (Offset.m2392getYimpl(consumed) == 0.0f && Offset.m2392getYimpl(available) > 0.0f) {
            this.this$0.getState().setContentOffset(0.0f);
        }
        if (Offset.m2392getYimpl(available) > 0.0f) {
    ...
    */
    public java.lang.Object mo334onPostFlingRZ2iAVY(long r10, long r12, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r14) {
        ...
        L41:
            ...
            r4 = r12
            r6 = r0
            java.lang.Object r14 = super.mo334onPostFlingRZ2iAVY(r2, r4, r6)
            if (r14 != r7) goto L55
            return r7
        L55:
            r10 = r9
        L56:
            ...
            float r12 = androidx.compose.ui.unit.Velocity.m5104getYimpl(r12)
        ...
        L81:
            ...
            long r10 = androidx.compose.ui.unit.Velocity.m5107plusAH228Gc(r10, r12)
            androidx.compose.ui.unit.Velocity r10 = androidx.compose.ui.unit.Velocity.m5094boximpl(r10)
            return r10
        */
