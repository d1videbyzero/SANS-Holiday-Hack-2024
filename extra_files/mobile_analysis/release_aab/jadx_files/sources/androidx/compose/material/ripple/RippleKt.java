...
public final class RippleKt {
    ...
    public static final Indication m967rememberRipple9IZ8Weo(boolean z, float f, long j, Composer composer, int i, int i2) {
        ...
        State rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2620boximpl(j), composer, (i >> 6) & 14);
        Boolean valueOf = Boolean.valueOf(z);
        Dp m4876boximpl = Dp.m4876boximpl(f);
        composer.startReplaceableGroup(511388516);
        ComposerKt.sourceInformation(composer, "CC(remember)P(1,2):Composables.kt#9igjgp");
        boolean changed = composer.changed(valueOf) | composer.changed(m4876boximpl);
