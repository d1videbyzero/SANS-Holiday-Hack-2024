...
final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo959defaultColorWaAFU9c(Composer composer, int i) {
        ...
        long m969defaultRippleColor5vOe2sY = RippleTheme.INSTANCE.m969defaultRippleColor5vOe2sY(Color.INSTANCE.m2656getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m969defaultRippleColor5vOe2sY;
    }
    ...
    public RippleAlpha rippleAlpha(Composer composer, int i) {
        ...
        RippleAlpha m968defaultRippleAlphaDxMtmZc = RippleTheme.INSTANCE.m968defaultRippleAlphaDxMtmZc(Color.INSTANCE.m2656getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m968defaultRippleAlphaDxMtmZc;
    }
}
