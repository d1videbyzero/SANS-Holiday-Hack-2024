...
public interface RippleTheme {
    ...
    long mo959defaultColorWaAFU9c(Composer composer, int i);
    ...
    public static final class Companion {
        ...
        public final long m969defaultRippleColor5vOe2sY(long contentColor, boolean lightTheme) {
            return (lightTheme || ((double) ColorKt.m2682luminance8_81llA(contentColor)) >= 0.5d) ? contentColor : Color.INSTANCE.m2667getWhite0d7_KjU();
        }

        /* renamed from: defaultRippleAlpha-DxMtmZc, reason: not valid java name */
        public final RippleAlpha m968defaultRippleAlphaDxMtmZc(long contentColor, boolean lightTheme) {
            ...
            if (ColorKt.m2682luminance8_81llA(contentColor) > 0.5d) {
