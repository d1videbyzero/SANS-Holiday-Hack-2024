...
final class StateLayer {
    ...
    public final void m970drawStateLayerH2RKhps(DrawScope drawStateLayer, float f, long j) {
        float f2;
        Intrinsics.checkNotNullParameter(drawStateLayer, "$this$drawStateLayer");
        if (Float.isNaN(f)) {
            f2 = RippleAnimationKt.m961getRippleEndRadiuscSwnlzA(drawStateLayer, this.bounded, drawStateLayer.mo3174getSizeNHjbRc());
        } else {
            f2 = drawStateLayer.mo327toPx0680j_4(f);
        }
        float f3 = f2;
        float floatValue = this.animatedAlpha.getValue().floatValue();
        if (floatValue > 0.0f) {
            long m2629copywmQWz5c$default = Color.m2629copywmQWz5c$default(j, floatValue, 0.0f, 0.0f, 0.0f, 14, null);
            if (!this.bounded) {
                DrawScope.m3156drawCircleVaOC9Bg$default(drawStateLayer, m2629copywmQWz5c$default, f3, 0L, 0.0f, null, null, 0, 124, null);
                return;
            }
            float m2460getWidthimpl = Size.m2460getWidthimpl(drawStateLayer.mo3174getSizeNHjbRc());
            float m2457getHeightimpl = Size.m2457getHeightimpl(drawStateLayer.mo3174getSizeNHjbRc());
