...
public final class RippleAnimationKt {
    private static final float BoundedRippleExtraRadius = Dp.m4878constructorimpl(10);
    ...
    public static final float m962getRippleStartRadiusuvyYCjk(long j) {
        return Math.max(Size.m2460getWidthimpl(j), Size.m2457getHeightimpl(j)) * 0.3f;
    }

    /* renamed from: getRippleEndRadius-cSwnlzA, reason: not valid java name */
    public static final float m961getRippleEndRadiuscSwnlzA(Density getRippleEndRadius, boolean z, long j) {
        Intrinsics.checkNotNullParameter(getRippleEndRadius, "$this$getRippleEndRadius");
        float m2389getDistanceimpl = Offset.m2389getDistanceimpl(OffsetKt.Offset(Size.m2460getWidthimpl(j), Size.m2457getHeightimpl(j))) / 2.0f;
        return z ? m2389getDistanceimpl + getRippleEndRadius.mo327toPx0680j_4(BoundedRippleExtraRadius) : m2389getDistanceimpl;
    }
}
