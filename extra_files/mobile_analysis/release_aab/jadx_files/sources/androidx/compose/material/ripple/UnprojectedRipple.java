...
final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m972setColorDxMtmZc(long color, float alpha) {
        long m971calculateRippleColor5vOe2sY = m971calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (color2 != null && Color.m2631equalsimpl0(color2.m2640unboximpl(), m971calculateRippleColor5vOe2sY)) {
            return;
        }
        this.rippleColor = Color.m2620boximpl(m971calculateRippleColor5vOe2sY);
        setColor(ColorStateList.valueOf(ColorKt.m2684toArgb8_81llA(m971calculateRippleColor5vOe2sY)));
    }
    ...
    private final long m971calculateRippleColor5vOe2sY(long color, float alpha) {
        if (Build.VERSION.SDK_INT < 28) {
            alpha *= 2;
        }
        return Color.m2629copywmQWz5c$default(color, RangesKt.coerceAtMost(alpha, 1.0f), 0.0f, 0.0f, 0.0f, 14, null);
    }
