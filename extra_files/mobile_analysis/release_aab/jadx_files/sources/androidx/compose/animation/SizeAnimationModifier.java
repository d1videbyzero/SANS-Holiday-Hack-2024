...
final class SizeAnimationModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public static final /* data */ class AnimData {
        ...
        public static /* synthetic */ AnimData m72copyO0kMr_c$default(AnimData animData, Animatable animatable, long j, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return animData.m74copyO0kMr_c(animatable, j);
        }
        ...
        public final AnimData m74copyO0kMr_c(Animatable<IntSize, AnimationVector2D> anim, long startSize) {
        ...
        public boolean equals(Object other) {
            ...
            return Intrinsics.areEqual(this.anim, animData.anim) && IntSize.m5036equalsimpl0(this.startSize, animData.startSize);
        }

        public int hashCode() {
            return (this.anim.hashCode() * 31) + IntSize.m5039hashCodeimpl(this.startSize);
        }

        public String toString() {
            return "AnimData(anim=" + this.anim + ", startSize=" + ((Object) IntSize.m5041toStringimpl(this.startSize)) + ')';
        }
        ...
        public final long m75getStartSizeYbymL2g() {
            return this.startSize;
        }

        /* renamed from: setStartSize-ozmzZPI, reason: not valid java name */
        public final void m76setStartSizeozmzZPI(long j) {
            this.startSize = j;
        }
    }
    ...
    public MeasureResult mo39measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        long m71animateTomzRDjE0 = m71animateTomzRDjE0(IntSizeKt.IntSize(mo3868measureBRTryo0.getWidth(), mo3868measureBRTryo0.getHeight()));
        return MeasureScope.layout$default(measure, IntSize.m5038getWidthimpl(m71animateTomzRDjE0), IntSize.m5037getHeightimpl(m71animateTomzRDjE0), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SizeAnimationModifier$measure$1
            {
                super(1);
            }
    ...
    public final long m71animateTomzRDjE0(long targetSize) {
        AnimData animData = getAnimData();
        if (animData != null) {
            if (!IntSize.m5036equalsimpl0(targetSize, animData.getAnim().getTargetValue().getPackedValue())) {
                animData.m76setStartSizeozmzZPI(animData.getAnim().getValue().getPackedValue());
            ...
            animData = new AnimData(new Animatable(IntSize.m5030boximpl(targetSize), VectorConvertersKt.getVectorConverter(IntSize.INSTANCE), IntSize.m5030boximpl(IntSizeKt.IntSize(1, 1)), null, 8, null), targetSize, null);
        }
