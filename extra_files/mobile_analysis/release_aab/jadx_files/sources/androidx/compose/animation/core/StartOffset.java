...
public final class StartOffset {
    ...
    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m111constructorimpl(int i, int i2) {
    ...
    public static final int m116getOffsetMillisimpl(long j) {
        return Math.abs((int) j);
    }

    /* renamed from: getOffsetType-Eo1U57Q, reason: not valid java name */
    public static final int m117getOffsetTypeEo1U57Q(long j) {
        boolean z = j > 0;
        if (z) {
