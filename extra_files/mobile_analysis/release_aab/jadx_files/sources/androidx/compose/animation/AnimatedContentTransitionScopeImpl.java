...
public final class AnimatedContentTransitionScopeImpl<S> implements AnimatedContentTransitionScope<S> {
    ...
    public AnimatedContentTransitionScopeImpl(Transition<S> transition, Alignment contentAlignment, LayoutDirection layoutDirection) {
        ...
        this.measuredSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m5030boximpl(IntSize.INSTANCE.m5043getZeroYbymL2g()), null, 2, null);
    ...
    public EnterTransition mo16slideIntoContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> initialOffset) {
        ...
        return m35isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$1
            ...
            public final Integer invoke(int i) {
                ...
                int m5038getWidthimpl = IntSize.m5038getWidthimpl(m34getCurrentSizeYbymL2g);
                ...
                return function1.invoke(Integer.valueOf(m5038getWidthimpl - IntOffset.m4996getXimpl(m33calculateOffsetemnUabE)));
            }
            ...
            public final Integer invoke(int i) {
                ...
                return function1.invoke(Integer.valueOf((-IntOffset.m4996getXimpl(m33calculateOffsetemnUabE)) - i));
            }
            ...
            public final Integer invoke(int i) {
                ...
                Function1<Integer, Integer> function1 = initialOffset;
                m34getCurrentSizeYbymL2g = this.m34getCurrentSizeYbymL2g();
                int m5037getHeightimpl = IntSize.m5037getHeightimpl(m34getCurrentSizeYbymL2g);
                AnimatedContentTransitionScopeImpl<S> animatedContentTransitionScopeImpl = this;
                long IntSize = IntSizeKt.IntSize(i, i);
                m34getCurrentSizeYbymL2g2 = this.m34getCurrentSizeYbymL2g();
                m33calculateOffsetemnUabE = animatedContentTransitionScopeImpl.m33calculateOffsetemnUabE(IntSize, m34getCurrentSizeYbymL2g2);
                return function1.invoke(Integer.valueOf(m5037getHeightimpl - IntOffset.m4997getYimpl(m33calculateOffsetemnUabE)));
            }
            ...
            public final Integer invoke(int i) {
                ...
                m34getCurrentSizeYbymL2g = this.m34getCurrentSizeYbymL2g();
                m33calculateOffsetemnUabE = animatedContentTransitionScopeImpl.m33calculateOffsetemnUabE(IntSize, m34getCurrentSizeYbymL2g);
                return function1.invoke(Integer.valueOf((-IntOffset.m4997getYimpl(m33calculateOffsetemnUabE)) - i));
            }
        }) : EnterTransition.INSTANCE.getNone();
    }

    /* renamed from: isLeft-gWo6LJ4, reason: not valid java name */
    private final boolean m35isLeftgWo6LJ4(int i) {
        return AnimatedContentTransitionScope.SlideDirection.m21equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m27getLeftDKzdypw()) || (AnimatedContentTransitionScope.SlideDirection.m21equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m29getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr) || (AnimatedContentTransitionScope.SlideDirection.m21equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m26getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl);
    }

    /* renamed from: isRight-gWo6LJ4, reason: not valid java name */
    private final boolean m36isRightgWo6LJ4(int i) {
        return AnimatedContentTransitionScope.SlideDirection.m21equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m28getRightDKzdypw()) || (AnimatedContentTransitionScope.SlideDirection.m21equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m29getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl) || (AnimatedContentTransitionScope.SlideDirection.m21equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m26getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr);
    }
    ...
    public final long m33calculateOffsetemnUabE(long fullSize, long currentSize) {
        return this.contentAlignment.mo2281alignKFBX0sM(fullSize, currentSize, LayoutDirection.Ltr);
    }
    ...
    public ExitTransition mo17slideOutOfContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> targetOffset) {
        ...
        return m35isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$1
            ...
            public final Integer invoke(int i) {
                ...
                long packedValue = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m5043getZeroYbymL2g();
                Function1<Integer, Integer> function1 = targetOffset;
                m33calculateOffsetemnUabE = this.this$0.m33calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), packedValue);
                return function1.invoke(Integer.valueOf((-IntOffset.m4996getXimpl(m33calculateOffsetemnUabE)) - i));
            }
            ...
            public final Integer invoke(int i) {
                ...
                Function1<Integer, Integer> function1 = targetOffset;
                m33calculateOffsetemnUabE = this.this$0.m33calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), packedValue);
                return function1.invoke(Integer.valueOf((-IntOffset.m4996getXimpl(m33calculateOffsetemnUabE)) + IntSize.m5038getWidthimpl(packedValue)));
            }
            ...
            public final Integer invoke(int i) {
                ...
                Function1<Integer, Integer> function1 = targetOffset;
                m33calculateOffsetemnUabE = this.this$0.m33calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), packedValue);
                return function1.invoke(Integer.valueOf((-IntOffset.m4997getYimpl(m33calculateOffsetemnUabE)) + IntSize.m5037getHeightimpl(packedValue)));
            }
    ...
    public final void m38setMeasuredSizeozmzZPI$animation_release(long j) {
        this.measuredSize.setValue(IntSize.m5030boximpl(j));
    }
        ...
        public MeasureResult mo39measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
            ...
            Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>> function1 = new Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$1
                ...
                public final FiniteAnimationSpec<IntSize> invoke(Transition.Segment<S> animate) {
                    ...
                    long packedValue = state != null ? state.getValue().getPackedValue() : IntSize.INSTANCE.m5043getZeroYbymL2g();
                    State<IntSize> state2 = animatedContentTransitionScopeImpl.getTargetSizeMap$animation_release().get(animate.getTargetState());
                    long packedValue2 = state2 != null ? state2.getValue().getPackedValue() : IntSize.INSTANCE.m5043getZeroYbymL2g();
                    SizeTransform value = this.getSizeTransform().getValue();
                    return (value == null || (mo77createAnimationSpecTemP2vQ = value.mo77createAnimationSpecTemP2vQ(packedValue, packedValue2)) == null) ? AnimationSpecKt.spring$default(0.0f, 0.0f, null, 7, null) : mo77createAnimationSpecTemP2vQ;
                }
            };
            ...
            State<IntSize> animate = deferredAnimation.animate(function1, new Function1<S, IntSize>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$2
                ...
                public /* bridge */ /* synthetic */ IntSize invoke(Object obj) {
                    return IntSize.m5030boximpl(m40invokeYEO4UFw(obj));
                }
                ...
                public final long m40invokeYEO4UFw(S s) {
                    ...
                    return state != null ? state.getValue().getPackedValue() : IntSize.INSTANCE.m5043getZeroYbymL2g();
                }
            });
            this.this$0.setAnimatedSize$animation_release(animate);
            final long mo2281alignKFBX0sM = this.this$0.getContentAlignment().mo2281alignKFBX0sM(IntSizeKt.IntSize(mo3868measureBRTryo0.getWidth(), mo3868measureBRTryo0.getHeight()), animate.getValue().getPackedValue(), LayoutDirection.Ltr);
            return MeasureScope.layout$default(measure, IntSize.m5038getWidthimpl(animate.getValue().getPackedValue()), IntSize.m5037getHeightimpl(animate.getValue().getPackedValue()), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(Placeable.PlacementScope layout) {
                    ...
                    Placeable.PlacementScope.m3925place70tqf50$default(layout, Placeable.this, mo2281alignKFBX0sM, 0.0f, 2, null);
                }
            }, 4, null);
        }
    }
