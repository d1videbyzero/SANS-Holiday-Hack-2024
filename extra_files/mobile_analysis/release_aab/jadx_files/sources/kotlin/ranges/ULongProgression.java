...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m6373getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int m5340constructorimpl = ((int) ULong.m5340constructorimpl(j ^ ULong.m5340constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int m5340constructorimpl2 = (m5340constructorimpl + ((int) ULong.m5340constructorimpl(j2 ^ ULong.m5340constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return m5340constructorimpl2 + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            append = new StringBuilder().append((Object) ULong.m5386toStringimpl(this.first)).append("..").append((Object) ULong.m5386toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            append = new StringBuilder().append((Object) ULong.m5386toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m5386toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m6399fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
