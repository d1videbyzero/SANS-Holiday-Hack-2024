...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m6631boximpl(m6625markNowz9LOYto());
    }
    ...
    public long m6625markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m6634constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m6624elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m6623differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m6622adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m6634constructorimpl(LongSaturatedMathKt.m6620saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
