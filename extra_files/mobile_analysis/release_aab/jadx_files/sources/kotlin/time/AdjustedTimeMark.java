...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo6482minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m6628minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo6481elapsedNowUwyO8pc() {
        return Duration.m6526minusLRDsOJo(this.mark.mo6481elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo6484plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m6527plusLRDsOJo(this.adjustment, duration), null);
    }
}
