...
public interface TimeMark {
    ...
    TimeMark mo6482minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo6484plusLRDsOJo(long duration);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m6629plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m6628minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo6484plusLRDsOJo(Duration.m6544unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m6524isNegativeimpl(timeMark.mo6481elapsedNowUwyO8pc());
        }
