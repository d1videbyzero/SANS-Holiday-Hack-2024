...
public final class UMathKt {
    ...
    private static final int m6377minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m6359minOfJ1ME1BU(i, i2);
    }

    /* renamed from: min-eb3DHEI, reason: not valid java name */
    private static final long m6378mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m6367minOfeb3DHEI(j, j2);
    }

    /* renamed from: max-J1ME1BU, reason: not valid java name */
    private static final int m6375maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m6347maxOfJ1ME1BU(i, i2);
    }

    /* renamed from: max-eb3DHEI, reason: not valid java name */
    private static final long m6376maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m6355maxOfeb3DHEI(j, j2);
    }
}
