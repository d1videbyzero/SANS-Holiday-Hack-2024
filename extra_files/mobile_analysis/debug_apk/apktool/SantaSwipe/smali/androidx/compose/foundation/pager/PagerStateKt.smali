...
.method public static final rememberPagerState(IFLandroidx/compose/runtime/Composer;II)Landroidx/compose/foundation/pager/PagerState;
    ...
    .end local p0    # "initialPage":I
    .local v1, "initialPage":I
    goto :goto_0

    .line 0
    .end local v1    # "initialPage":I
    .restart local p0    # "initialPage":I
    :cond_0
    move/from16 v9, p0

    .line 115
    .end local p0    # "initialPage":I
    .local v9, "initialPage":I
    :goto_0
    ...
    .end local p1    # "initialPageOffsetFraction":F
    .local v1, "initialPageOffsetFraction":F
    goto :goto_1

    .line 115
    .end local v1    # "initialPageOffsetFraction":F
    .restart local p1    # "initialPageOffsetFraction":F
    :cond_1
    move/from16 v10, p1

    .line 116
    .end local p1    # "initialPageOffsetFraction":F
    .local v10, "initialPageOffsetFraction":F
    :goto_1
    ...
    const-string v2, "androidx.compose.foundation.pager.rememberPagerState (PagerState.kt:113)"
    ...
    .line 118
    sget-object v1, Landroidx/compose/foundation/pager/PagerStateImpl;->Companion:Landroidx/compose/foundation/pager/PagerStateImpl$Companion;

    invoke-virtual {v1}, Landroidx/compose/foundation/pager/PagerStateImpl$Companion;->getSaver()Landroidx/compose/runtime/saveable/Saver;
    ...
    .line 118
    .local v15, "$i$a$-remember-PagerStateKt$rememberPagerState$3":I
    move-object/from16 p0, v2

    .end local v2    # "key1$iv":Ljava/lang/Object;
    .local p0, "key1$iv":Ljava/lang/Object;
    new-instance v2, Landroidx/compose/foundation/pager/PagerStateKt$rememberPagerState$3$1;

    invoke-direct {v2, v9, v10}, Landroidx/compose/foundation/pager/PagerStateKt$rememberPagerState$3$1;-><init>(IF)V

    check-cast v2, Lkotlin/jvm/functions/Function0;

    .line 699
    .end local v15    # "$i$a$-remember-PagerStateKt$rememberPagerState$3":I
    nop
...
.method public static final rememberPagerState(IFLkotlin/jvm/functions/Function0;Landroidx/compose/runtime/Composer;II)Landroidx/compose/foundation/pager/PagerState;
    ...
    const-string v2, "C(rememberPagerState)*78@3520L127,78@3473L174:PagerState.kt#g6yjnt"
    ...
    .end local p0    # "initialPage":I
    .local v2, "initialPage":I
    goto :goto_0

    .line 0
    .end local v2    # "initialPage":I
    .restart local p0    # "initialPage":I
    :cond_0
    move/from16 v10, p0
    ...
    .end local p1    # "initialPageOffsetFraction":F
    .local v2, "initialPageOffsetFraction":F
    goto :goto_1

    .line 75
    .end local v2    # "initialPageOffsetFraction":F
    .restart local p1    # "initialPageOffsetFraction":F
    :cond_1
    move/from16 v11, p1
    ...
    .line 76
    .end local p1    # "initialPageOffsetFraction":F
    .local v11, "initialPageOffsetFraction":F
    :goto_1
    invoke-static {}, Landroidx/compose/runtime/ComposerKt;->isTraceInProgress()Z
    ...
    const-string v3, "androidx.compose.foundation.pager.rememberPagerState (PagerState.kt:73)"
    ...
    .line 79
    sget-object v2, Landroidx/compose/foundation/pager/PagerStateImpl;->Companion:Landroidx/compose/foundation/pager/PagerStateImpl$Companion;

    invoke-virtual {v2}, Landroidx/compose/foundation/pager/PagerStateImpl$Companion;->getSaver()Landroidx/compose/runtime/saveable/Saver;
    ...
    .line 79
    .local v3, "$i$a$-remember-PagerStateKt$rememberPagerState$1":I
    move/from16 p1, v3

    .end local v3    # "$i$a$-remember-PagerStateKt$rememberPagerState$1":I
    .local p1, "$i$a$-remember-PagerStateKt$rememberPagerState$1":I
    new-instance v3, Landroidx/compose/foundation/pager/PagerStateKt$rememberPagerState$1$1;

    invoke-direct {v3, v10, v11, v0}, Landroidx/compose/foundation/pager/PagerStateKt$rememberPagerState$1$1;-><init>(IFLkotlin/jvm/functions/Function0;)V

    check-cast v3, Lkotlin/jvm/functions/Function0;

    .line 691
    .end local p1    # "$i$a$-remember-PagerStateKt$rememberPagerState$1":I
    nop
    ...
    check-cast v2, Landroidx/compose/foundation/pager/PagerStateImpl;

    .local v2, "$this$rememberPagerState_u24lambda_u241":Landroidx/compose/foundation/pager/PagerStateImpl;
    const/4 v3, 0x0

    .line 86
    .local v3, "$i$a$-apply-PagerStateKt$rememberPagerState$2":I
    invoke-virtual {v2}, Landroidx/compose/foundation/pager/PagerStateImpl;->getPageCountState()Landroidx/compose/runtime/MutableState;
    ...
    .line 85
    .end local v2    # "$this$rememberPagerState_u24lambda_u241":Landroidx/compose/foundation/pager/PagerStateImpl;
    .end local v3    # "$i$a$-apply-PagerStateKt$rememberPagerState$2":I
