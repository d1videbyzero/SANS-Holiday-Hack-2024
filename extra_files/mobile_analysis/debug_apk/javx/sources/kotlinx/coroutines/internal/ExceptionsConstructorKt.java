...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                m5507constructorimpl = Result.m5507constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                m5507constructorimpl = Result.m5507constructorimpl(ResultKt.createFailure(th));
            }
            if (Result.m5513isFailureimpl(m5507constructorimpl)) {
                m5507constructorimpl = null;
            }
            return (E) m5507constructorimpl;
        }
        ...
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$safeCtor$1
            ...
            public final Throwable invoke(Throwable e) {
                ...
                try {
                    ...
                    m5507constructorimpl = Result.m5507constructorimpl((Intrinsics.areEqual(e.getMessage(), result.getMessage()) || Intrinsics.areEqual(result.getMessage(), e.toString())) ? result : null);
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.INSTANCE;
                    m5507constructorimpl = Result.m5507constructorimpl(ResultKt.createFailure(th));
                }
                return (Throwable) (Result.m5513isFailureimpl(m5507constructorimpl) ? null : m5507constructorimpl);
            }
        };
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int defaultValue) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            m5507constructorimpl = Result.m5507constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m5507constructorimpl = Result.m5507constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m5513isFailureimpl(m5507constructorimpl)) {
            m5507constructorimpl = valueOf;
        }
        return ((Number) m5507constructorimpl).intValue();
    }
