...
public interface SendChannel<E> {
    ...
    Object mo7008trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object result = sendChannel.mo7008trySendJP2dKIU(e);
            if (ChannelResult.m7028isSuccessimpl(result)) {
                return true;
            }
            Throwable m7022exceptionOrNullimpl = ChannelResult.m7022exceptionOrNullimpl(result);
