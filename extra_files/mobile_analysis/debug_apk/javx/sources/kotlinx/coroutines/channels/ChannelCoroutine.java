...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo7012receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo7012receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo7013tryReceivePtdJZtk() {
        return this._channel.mo7013tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo7008trySendJP2dKIU(E element) {
        return this._channel.mo7008trySendJP2dKIU(element);
    }
