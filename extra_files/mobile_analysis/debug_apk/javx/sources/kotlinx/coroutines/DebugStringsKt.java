...
public final class DebugStringsKt {
    ...
    public static final String toDebugString(Continuation<?> continuation) {
        ...
        try {
            ...
            m5507constructorimpl = Result.m5507constructorimpl(continuation + '@' + getHexAddress(continuation));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m5507constructorimpl = Result.m5507constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m5510exceptionOrNullimpl(m5507constructorimpl) != null) {
            m5507constructorimpl = continuation.getClass().getName() + '@' + getHexAddress(continuation);
        }
        return (String) m5507constructorimpl;
    }
