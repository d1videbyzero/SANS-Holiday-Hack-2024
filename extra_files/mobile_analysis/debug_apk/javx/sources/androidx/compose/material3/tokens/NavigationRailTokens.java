...
public final class NavigationRailTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m5216constructorimpl((float) 32.0d);
    private static final ShapeKeyTokens ActiveIndicatorShape = ShapeKeyTokens.CornerFull;
    private static final float ActiveIndicatorWidth = Dp.m5216constructorimpl((float) 56.0d);
    ...
    private static final float ContainerWidth = Dp.m5216constructorimpl((float) 80.0d);
    ...
    private static final float MenuIconSize = Dp.m5216constructorimpl((float) 24.0d);
    private static final ColorSchemeKeyTokens MenuPressedIconColor = ColorSchemeKeyTokens.OnSurface;
    private static final float NoLabelActiveIndicatorHeight = Dp.m5216constructorimpl((float) 56.0d);
