...
public final class TimePickerState {
    ...
    public TimePickerState(int initialHour, int initialMinute, final boolean is24Hour) {
        ...
        this.selectorPos = SnapshotStateKt.derivedStateOf(SnapshotStateKt.structuralEqualityPolicy(), new Function0<DpOffset>() { // from class: androidx.compose.material3.TimePickerState$selectorPos$2
            ...
            public /* bridge */ /* synthetic */ DpOffset invoke() {
                return DpOffset.m5271boximpl(m1914invokeRKDOV3M());
            }
            ...
            public final long m1914invokeRKDOV3M() {
                ...
                float arg0$iv = Dp.m5216constructorimpl(TimePickerTokens.INSTANCE.m2480getClockDialSelectorHandleContainerSizeD9Ej5fM() / 2);
                float length = Dp.m5216constructorimpl(Dp.m5216constructorimpl(((is24Hour && inInnerCircle && Selection.m1693equalsimpl0(TimePickerState.this.m1910getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m1697getHourJiIwxys())) ? TimePickerKt.InnerCircleRadius : TimePickerKt.OuterCircleSizeRadius) - arg0$iv) + arg0$iv);
                float other$iv = (float) Math.cos(TimePickerState.this.getCurrentAngle$material3_release().getValue().floatValue());
                float arg0$iv2 = Dp.m5216constructorimpl(Dp.m5216constructorimpl(length * other$iv) + Dp.m5216constructorimpl(TimePickerTokens.INSTANCE.m2478getClockDialContainerSizeD9Ej5fM() / 2));
                float other$iv2 = (float) Math.sin(TimePickerState.this.getCurrentAngle$material3_release().getValue().floatValue());
                return DpKt.m5237DpOffsetYgX7TsA(arg0$iv2, Dp.m5216constructorimpl(Dp.m5216constructorimpl(length * other$iv2) + Dp.m5216constructorimpl(TimePickerTokens.INSTANCE.m2478getClockDialContainerSizeD9Ej5fM() / 2)));
            }
        });
        this.center = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m5325boximpl(IntOffset.INSTANCE.m5344getZeronOccac()), null, 2, null);
    ...
    public final void moveSelector$material3_release(float x, float y, float maxDist) {
        ...
        if (Selection.m1693equalsimpl0(m1910getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m1697getHourJiIwxys()) && this.is24hour) {
            dist = TimePickerKt.dist(x, y, IntOffset.m5334getXimpl(m1909getCenternOccac$material3_release()), IntOffset.m5335getYimpl(m1909getCenternOccac$material3_release()));
