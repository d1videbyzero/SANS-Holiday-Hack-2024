...
public final class NavigationDrawerKt {
    private static final float DrawerVelocityThreshold = Dp.m5216constructorimpl(400);
    private static final float MinimumDrawerWidth = Dp.m5216constructorimpl(240);
    ...
    */
    ...
    public static final void DismissibleNavigationDrawer(final Function2<? super Composer, ? super Integer, Unit> drawerContent, Modifier modifier, DrawerState drawerState, boolean gesturesEnabled, final Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed, final int i) {
        ...
        if ((46811 & $dirty) == 9362 && $composer3.getSkipping()) {
            ...
            }, (r26 & 128) != 0 ? SwipeableDefaults.resistanceConfig$material3_release$default(SwipeableDefaults.INSTANCE, anchors.keySet(), 0.0f, 0.0f, 6, null) : null, (r26 & 256) != 0 ? SwipeableDefaults.INSTANCE.m1803getVelocityThresholdD9Ej5fM$material3_release() : DrawerVelocityThreshold);
            ...
            MeasurePolicy measurePolicy$iv2 = new MeasurePolicy() { // from class: androidx.compose.material3.NavigationDrawerKt$DismissibleNavigationDrawer$2$2
                ...
                public final MeasureResult mo13measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long constraints) {
                    ...
                    final Placeable sheetPlaceable = measurables.get(0).mo4184measureBRTryo0(constraints);
                    final Placeable contentPlaceable = measurables.get(1).mo4184measureBRTryo0(constraints);
    ...
    */
    ...
    public static final void NavigationDrawerItem(final Function2<? super Composer, ? super Integer, Unit> label, final boolean selected, final Function0<Unit> onClick, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, Shape shape, NavigationDrawerItemColors colors, MutableInteractionSource interactionSource, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty2 & 191739611) == 38347922 && $composer2.getSkipping()) {
            ...
            SurfaceKt.m1793Surfaced85dljk(selected, onClick, SizeKt.fillMaxWidth$default(SizeKt.m515height3ABfNKs(SemanticsModifierKt.semantics$default(modifier2, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.NavigationDrawerKt$NavigationDrawerItem$2
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ Unit invoke(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                    invoke2(semanticsPropertyReceiver);
                    return Unit.INSTANCE;
                ...
                public final void invoke2(SemanticsPropertyReceiver semantics) {
                    Intrinsics.checkNotNullParameter(semantics, "$this$semantics");
                    SemanticsPropertiesKt.m4580setRolekuIjeqM(semantics, Role.INSTANCE.m4572getTabo7Vup1c());
                }
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        Modifier modifier$iv = PaddingKt.m486paddingqDBjuR0$default(Modifier.INSTANCE, Dp.m5216constructorimpl(16), 0.0f, Dp.m5216constructorimpl(24), 0.0f, 10, null);
                        ...
                        if (function25 != null) {
                            long iconColor = navigationDrawerItemColors2.iconColor(z, $composer3, ((i9 >> 3) & 14) | ((i9 >> 18) & 112)).getValue().m2957unboximpl();
                            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2937boximpl(iconColor))}, function25, $composer3, ((i9 >> 9) & 112) | 8);
                            SpacerKt.Spacer(SizeKt.m534width3ABfNKs(Modifier.INSTANCE, Dp.m5216constructorimpl(12)), $composer3, 6);
                        }
                        $composer3.endReplaceableGroup();
                        ...
                        long labelColor = navigationDrawerItemColors2.textColor(z, $composer3, i14).getValue().m2957unboximpl();
                        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2937boximpl(labelColor))}, function27, $composer3, ((i9 << 3) & 112) | 8);
                        ComposerKt.sourceInformationMarkerEnd($composer3);
                        ComposerKt.sourceInformationMarkerEnd($composer3);
                        $composer3.endReplaceableGroup();
                        $composer3.endNode();
                        ...
                        if (function26 != null) {
                            SpacerKt.Spacer(SizeKt.m534width3ABfNKs(Modifier.INSTANCE, Dp.m5216constructorimpl(12)), $composer3, 6);
                            long badgeColor = navigationDrawerItemColors2.badgeColor(z, $composer3, i14).getValue().m2957unboximpl();
                            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2937boximpl(badgeColor))}, function26, $composer3, ((i9 >> 12) & 112) | 8);
                        }
                        $composer3.endReplaceableGroup();
                        ComposerKt.sourceInformationMarkerEnd($composer3);
                        ComposerKt.sourceInformationMarkerEnd($composer3);
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m1621ScrimBx497Mc(final boolean r22, final kotlin.jvm.functions.Function0<kotlin.Unit> r23, final kotlin.jvm.functions.Function0<java.lang.Float> r24, final long r25, androidx.compose.runtime.Composer r27, final int r28) {
        /*
            Method dump skipped, instructions count: 456
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.NavigationDrawerKt.m1621ScrimBx497Mc(boolean, kotlin.jvm.functions.Function0, kotlin.jvm.functions.Function0, long, androidx.compose.runtime.Composer, int):void");
    }
}
