...
public final class DateInputKt {
    private static final PaddingValues InputTextFieldPadding = PaddingKt.m479PaddingValuesa9UjIt4$default(Dp.m5216constructorimpl(24), Dp.m5216constructorimpl(10), Dp.m5216constructorimpl(24), 0.0f, 8, null);
    private static final float InputTextNonErroneousBottomPadding = Dp.m5216constructorimpl(16);
    ...
    */
    ...
    public static final void m1450DateInputTextFieldzm97o8M(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final StateData stateData, final CalendarDate initialDate, final Function1<? super CalendarDate, Unit> onDateChanged, final int inputIdentifier, final DateInputValidator dateInputValidator, final DateInputFormat dateInputFormat, final Locale locale, Composer $composer, final int $changed) {
        ...
        OutlinedTextFieldKt.OutlinedTextField(DateInputTextField_zm97o8M$lambda$3, (Function1<? super TextFieldValue, Unit>) function1, SemanticsModifierKt.semantics$default(m486paddingqDBjuR0$default, false, (Function1) value$iv$iv, 1, null), false, false, (TextStyle) null, function2, function22, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda($composer2, 785795078, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateInputKt$DateInputTextField$3
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(2);
            }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateInputKt$DateInputTextField$4
            ...
            public final void invoke(Composer composer, int i) {
                DateInputKt.m1450DateInputTextFieldzm97o8M(Modifier.this, function2, function22, stateData, initialDate, onDateChanged, inputIdentifier, dateInputValidator, dateInputFormat, locale, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
