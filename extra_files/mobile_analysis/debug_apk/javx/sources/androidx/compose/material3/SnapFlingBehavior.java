...
public final class SnapFlingBehavior implements FlingBehavior {
    ...
    public SnapFlingBehavior(LazyListState lazyListState, DecayAnimationSpec<Float> decayAnimationSpec, AnimationSpec<Float> snapAnimationSpec, Density density) {
        ...
        this.velocityThreshold = $this$velocityThreshold_u24lambda_u241.mo327toPx0680j_4(this.MinFlingVelocityDp);
        ...
        this.MinFlingVelocityDp = Dp.m5216constructorimpl(400);
    }
    ...
    */
    ...
    private final int getSingleAxisViewportSize(LazyListLayoutInfo $this$singleAxisViewportSize) {
        return $this$singleAxisViewportSize.getOrientation() == Orientation.Vertical ? IntSize.m5375getHeightimpl($this$singleAxisViewportSize.mo585getViewportSizeYbymL2g()) : IntSize.m5376getWidthimpl($this$singleAxisViewportSize.mo585getViewportSizeYbymL2g());
    }
}
