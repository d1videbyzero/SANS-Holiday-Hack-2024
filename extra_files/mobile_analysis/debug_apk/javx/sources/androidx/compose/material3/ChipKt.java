...
public final class ChipKt {
    private static final float HorizontalElementsPadding = Dp.m5216constructorimpl(8);
    private static final PaddingValues AssistChipPadding = PaddingKt.m477PaddingValuesYgX7TsA$default(HorizontalElementsPadding, 0.0f, 2, null);
    private static final PaddingValues FilterChipPadding = PaddingKt.m477PaddingValuesYgX7TsA$default(HorizontalElementsPadding, 0.0f, 2, null);
    private static final PaddingValues SuggestionChipPadding = PaddingKt.m477PaddingValuesYgX7TsA$default(HorizontalElementsPadding, 0.0f, 2, null);
    ...
    public static final void AssistChip(final Function0<Unit> onClick, final Function2<? super Composer, ? super Integer, Unit> label, Modifier modifier, boolean enabled, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, Shape shape, ChipColors colors, ChipElevation elevation, ChipBorder border, MutableInteractionSource interactionSource, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (($dirty3 & 1533916891) == 306783378 && ($dirty13 & 11) == 2 && $composer3.getSkipping()) {
            ...
            long m2957unboximpl = colors3.labelColor$material3_release(enabled2, $composer3, (($dirty2 >> 9) & 14) | (($dirty2 >> 18) & 112)).getValue().m2957unboximpl();
            ...
            colors4 = colors3;
            enabled3 = enabled2;
            m1343ChipnkUnTEs(modifier3, onClick, enabled2, label, fromToken, m2957unboximpl, leadingIcon2, trailingIcon, shape2, colors4, elevation3, borderStroke$material3_release != null ? borderStroke$material3_release.getValue() : null, AssistChipDefaults.INSTANCE.m1306getHeightD9Ej5fM(), AssistChipPadding, interactionSource2, $composer2, (($dirty2 >> 6) & 14) | (($dirty2 << 3) & 112) | (($dirty2 >> 3) & 896) | (($dirty2 << 6) & 7168) | (($dirty2 << 6) & 3670016) | (($dirty2 << 6) & 29360128) | (($dirty2 << 6) & 234881024) | (($dirty2 << 6) & 1879048192), (($dirty2 >> 24) & 14) | 3456 | (($dirty12 << 12) & 57344));
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void ElevatedAssistChip(final Function0<Unit> onClick, final Function2<? super Composer, ? super Integer, Unit> label, Modifier modifier, boolean enabled, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, Shape shape, ChipColors colors, ChipElevation elevation, ChipBorder border, MutableInteractionSource interactionSource, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (($dirty3 & 1533916891) == 306783378 && ($dirty13 & 11) == 2 && $composer3.getSkipping()) {
            ...
            long m2957unboximpl = colors3.labelColor$material3_release(enabled2, $composer3, (($dirty2 >> 9) & 14) | (($dirty2 >> 18) & 112)).getValue().m2957unboximpl();
            float m1306getHeightD9Ej5fM = AssistChipDefaults.INSTANCE.m1306getHeightD9Ej5fM();
            ...
            enabled3 = enabled2;
            $composer2 = $composer3;
            m1343ChipnkUnTEs(modifier4, onClick, enabled2, label, fromToken, m2957unboximpl, leadingIcon, trailingIcon, shape2, colors4, elevation3, borderStroke$material3_release != null ? borderStroke$material3_release.getValue() : null, m1306getHeightD9Ej5fM, paddingValues, interactionSource2, $composer2, (($dirty2 >> 6) & 14) | (($dirty2 << 3) & 112) | (($dirty2 >> 3) & 896) | (($dirty2 << 6) & 7168) | (($dirty2 << 6) & 3670016) | (($dirty2 << 6) & 29360128) | (($dirty2 << 6) & 234881024) | (($dirty2 << 6) & 1879048192), (($dirty2 >> 24) & 14) | 3456 | (($dirty12 << 12) & 57344));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final void FilterChip(final boolean selected, final Function0<Unit> onClick, final Function2<? super Composer, ? super Integer, Unit> label, Modifier modifier, boolean enabled, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, Shape shape, SelectableChipColors colors, SelectableChipElevation elevation, SelectableChipBorder border, MutableInteractionSource interactionSource, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if ((1533916891 & $dirty4) == 306783378 && ($dirty1 & 91) == 18 && $composer4.getSkipping()) {
            ...
            float m1529getHeightD9Ej5fM = FilterChipDefaults.INSTANCE.m1529getHeightD9Ej5fM();
            ...
            enabled3 = enabled2;
            $composer3 = $composer4;
            m1345SelectableChipu0RnIRE(selected, modifier3, onClick, enabled2, label, fromToken, leadingIcon, null, trailingIcon, shape2, colors2, elevation3, borderStroke$material3_release != null ? borderStroke$material3_release.getValue() : null, m1529getHeightD9Ej5fM, paddingValues, interactionSource2, $composer3, ($dirty3 & 14) | 12582912 | (($dirty3 >> 6) & 112) | (($dirty3 << 3) & 896) | (($dirty3 >> 3) & 7168) | (($dirty3 << 6) & 57344) | (($dirty3 << 3) & 3670016) | (($dirty3 << 6) & 234881024) | (($dirty3 << 6) & 1879048192), (($dirty3 >> 24) & 14) | 27648 | (($dirty3 >> 24) & 112) | (($dirty12 << 12) & 458752));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final void InputChip(final boolean selected, final Function0<Unit> onClick, final Function2<? super Composer, ? super Integer, Unit> label, Modifier modifier, boolean enabled, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, Function2<? super Composer, ? super Integer, Unit> function23, Shape shape, SelectableChipColors colors, SelectableChipElevation elevation, SelectableChipBorder border, MutableInteractionSource interactionSource, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (($dirty2 & 1533916891) == 306783378 && ($dirty12 & 731) == 146 && $composer3.getSkipping()) {
                ...
                Function2<Composer, Integer, Unit> function24 = new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ChipKt$InputChip$2
                    ...
                    public final void invoke(Composer $composer4, int $changed2) {
                        ...
                        if (($changed2 & 11) != 2 || !$composer4.getSkipping()) {
                            ...
                            skippableUpdate$iv$iv$iv.invoke(SkippableUpdater.m2572boximpl(SkippableUpdater.m2573constructorimpl($composer4)), $composer4, Integer.valueOf(($changed$iv$iv$iv >> 3) & 112));
            ...
            enabled3 = enabled2;
            $composer2 = $composer3;
            m1345SelectableChipu0RnIRE(selected, modifier3, onClick, enabled2, label, fromToken, avatar3, shapedAvatar, trailingIcon, shape3, colors3, elevation3, borderStroke$material3_release != null ? borderStroke$material3_release.getValue() : null, InputChipDefaults.INSTANCE.m1557getHeightD9Ej5fM(), inputChipPadding(shapedAvatar != null ? z : false, leadingIcon2 != null ? z : false, trailingIcon != null ? z : false), interactionSource2, $composer2, ($dirty & 14) | (($dirty >> 6) & 112) | (($dirty << 3) & 896) | (($dirty >> 3) & 7168) | (($dirty << 6) & 57344) | (($dirty << 3) & 3670016) | (($dirty << 3) & 234881024) | (($dirty << 3) & 1879048192), (($dirty >> 27) & 14) | 3072 | (($dirty1 << 3) & 112) | (($dirty1 << 9) & 458752));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final void SuggestionChip(final Function0<Unit> onClick, final Function2<? super Composer, ? super Integer, Unit> label, Modifier modifier, boolean enabled, Function2<? super Composer, ? super Integer, Unit> function2, Shape shape, ChipColors colors, ChipElevation elevation, ChipBorder border, MutableInteractionSource interactionSource, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty3 & 1533916891) == 306783378 && $composer3.getSkipping()) {
            ...
            long m2957unboximpl = colors3.labelColor$material3_release(enabled2, $composer3, (($dirty2 >> 9) & 14) | (($dirty2 >> 15) & 112)).getValue().m2957unboximpl();
            ...
            colors4 = colors3;
            enabled3 = enabled2;
            m1343ChipnkUnTEs(modifier3, onClick, enabled2, label, fromToken, m2957unboximpl, icon, null, shape3, colors4, elevation3, borderStroke$material3_release != null ? borderStroke$material3_release.getValue() : null, SuggestionChipDefaults.INSTANCE.m1787getHeightD9Ej5fM(), SuggestionChipPadding, interactionSource2, $composer2, (($dirty2 >> 6) & 14) | 12582912 | (($dirty2 << 3) & 112) | (($dirty2 >> 3) & 896) | (($dirty2 << 6) & 7168) | (($dirty2 << 6) & 3670016) | (($dirty2 << 9) & 234881024) | (($dirty2 << 9) & 1879048192), (($dirty2 >> 21) & 14) | 3456 | (($dirty2 >> 15) & 57344));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final void ElevatedSuggestionChip(final Function0<Unit> onClick, final Function2<? super Composer, ? super Integer, Unit> label, Modifier modifier, boolean enabled, Function2<? super Composer, ? super Integer, Unit> function2, Shape shape, ChipColors colors, ChipElevation elevation, ChipBorder border, MutableInteractionSource interactionSource, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty3 & 1533916891) == 306783378 && $composer3.getSkipping()) {
            ...
            TextStyle fromToken = TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography($composer3, i4), SuggestionChipTokens.INSTANCE.getLabelTextFont());
            long m2957unboximpl = colors2.labelColor$material3_release(enabled2, $composer3, (($dirty2 >> 9) & 14) | (($dirty2 >> 15) & 112)).getValue().m2957unboximpl();
            float m1787getHeightD9Ej5fM = SuggestionChipDefaults.INSTANCE.m1787getHeightD9Ej5fM();
            ...
            enabled3 = enabled2;
            $composer2 = $composer3;
            m1343ChipnkUnTEs(modifier2, onClick, enabled2, label, fromToken, m2957unboximpl, icon, null, shape3, colors4, elevation3, borderStroke$material3_release != null ? borderStroke$material3_release.getValue() : null, m1787getHeightD9Ej5fM, paddingValues, interactionSource2, $composer2, (($dirty2 >> 6) & 14) | 12582912 | (($dirty2 << 3) & 112) | (($dirty2 >> 3) & 896) | (($dirty2 << 6) & 7168) | (($dirty2 << 6) & 3670016) | (($dirty2 << 9) & 234881024) | (($dirty2 << 9) & 1879048192), (($dirty2 >> 21) & 14) | 3456 | (($dirty2 >> 15) & 57344));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final void m1343ChipnkUnTEs(final Modifier modifier, final Function0<Unit> function0, final boolean enabled, final Function2<? super Composer, ? super Integer, Unit> function2, final TextStyle labelTextStyle, final long labelColor, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final Shape shape, final ChipColors colors, final ChipElevation elevation, final BorderStroke border, final float minHeight, final PaddingValues paddingValues, final MutableInteractionSource interactionSource, Composer $composer, final int $changed, final int $changed1) {
        ...
        if (($dirty2 & 1533916891) != 306783378 || (46811 & $dirty1) != 9362 || !$composer3.getSkipping()) {
            ...
            Modifier semantics$default = SemanticsModifierKt.semantics$default(modifier, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.ChipKt$Chip$1
                ...
                public final void invoke2(SemanticsPropertyReceiver semantics) {
                    ...
                    SemanticsPropertiesKt.m4580setRolekuIjeqM(semantics, Role.INSTANCE.m4566getButtono7Vup1c());
                }
            }, 1, null);
            long m2957unboximpl = colors.containerColor$material3_release(enabled, $composer3, (($dirty2 >> 6) & 14) | (($dirty2 >> 24) & 112)).getValue().m2957unboximpl();
            ...
            $composer3.endReplaceableGroup();
            float m5230unboximpl = state != null ? state.getValue().m5230unboximpl() : Dp.m5216constructorimpl(0);
            ...
            $composer3.endReplaceableGroup();
            float m5230unboximpl2 = shadowElevation$material3_release != null ? shadowElevation$material3_release.getValue().m5230unboximpl() : Dp.m5216constructorimpl(0);
            final int $dirty3 = $dirty2;
            final int $dirty12 = $dirty1;
            $composer2 = $composer3;
            $dirty = $dirty3;
            SurfaceKt.m1795Surfaceo_FOJdg(function0, semantics$default, enabled, shape, m2957unboximpl, 0L, m5230unboximpl, m5230unboximpl2, border, interactionSource, ComposableLambdaKt.composableLambda($composer2, -1985962652, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ChipKt$Chip$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer4.getSkipping()) {
                        ...
                        ChipKt.m1344ChipContentfe0OD_I(function2, labelTextStyle, labelColor, function22, null, function23, colors.leadingIconContentColor$material3_release(enabled, $composer4, (($dirty3 >> 6) & 14) | (($dirty3 >> 24) & 112)).getValue().m2957unboximpl(), colors.trailingIconContentColor$material3_release(enabled, $composer4, (($dirty3 >> 6) & 14) | (($dirty3 >> 24) & 112)).getValue().m2957unboximpl(), minHeight, paddingValues, $composer4, (($dirty3 >> 9) & 14) | 24576 | (($dirty3 >> 9) & 112) | (($dirty3 >> 9) & 896) | (($dirty3 >> 9) & 7168) | (($dirty3 >> 6) & 458752) | (($dirty12 << 18) & 234881024) | (($dirty12 << 18) & 1879048192));
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ChipKt$Chip$3
            ...
            public final void invoke(Composer composer, int i) {
                ChipKt.m1343ChipnkUnTEs(Modifier.this, function0, enabled, function2, labelTextStyle, labelColor, function22, function23, shape, colors, elevation, border, minHeight, paddingValues, interactionSource, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1));
            }
        });
    }
    ...
    public static final void m1345SelectableChipu0RnIRE(final boolean selected, final Modifier modifier, final Function0<Unit> function0, final boolean enabled, final Function2<? super Composer, ? super Integer, Unit> function2, final TextStyle labelTextStyle, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final Function2<? super Composer, ? super Integer, Unit> function24, final Shape shape, final SelectableChipColors colors, final SelectableChipElevation elevation, final BorderStroke border, final float minHeight, final PaddingValues paddingValues, final MutableInteractionSource interactionSource, Composer $composer, final int $changed, final int $changed1) {
        ...
        if (($dirty & 1533916891) != 306783378 || (374491 & $dirty1) != 74898 || !$composer3.getSkipping()) {
            ...
            Modifier semantics$default = SemanticsModifierKt.semantics$default(modifier, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.ChipKt$SelectableChip$1
                ...
                public final void invoke2(SemanticsPropertyReceiver semantics) {
                    Intrinsics.checkNotNullParameter(semantics, "$this$semantics");
                    SemanticsPropertiesKt.m4580setRolekuIjeqM(semantics, Role.INSTANCE.m4567getCheckboxo7Vup1c());
                }
            }, 1, null);
            long m2957unboximpl = colors.containerColor$material3_release(enabled, selected, $composer3, (($dirty >> 9) & 14) | (($dirty << 3) & 112) | (($dirty1 << 6) & 896)).getValue().m2957unboximpl();
            ...
            final int $dirty12 = $dirty1;
            $composer2 = $composer3;
            SurfaceKt.m1793Surfaced85dljk(selected, function0, semantics$default, enabled, shape, m2957unboximpl, 0L, m5230unboximpl, shadowElevation$material3_release != null ? shadowElevation$material3_release.getValue().m5230unboximpl() : Dp.m5216constructorimpl(0), border, interactionSource, ComposableLambdaKt.composableLambda($composer3, -577614814, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ChipKt$SelectableChip$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer4.getSkipping()) {
                        ...
                        long m2957unboximpl2 = SelectableChipColors.this.labelColor$material3_release(enabled, selected, $composer4, (($dirty2 >> 9) & 14) | (($dirty2 << 3) & 112) | (($dirty12 << 6) & 896)).getValue().m2957unboximpl();
                        long m2957unboximpl3 = SelectableChipColors.this.leadingIconContentColor$material3_release(enabled, selected, $composer4, (($dirty2 >> 9) & 14) | (($dirty2 << 3) & 112) | (($dirty12 << 6) & 896)).getValue().m2957unboximpl();
                        long m2957unboximpl4 = SelectableChipColors.this.trailingIconContentColor$material3_release(enabled, selected, $composer4, (($dirty2 >> 9) & 14) | (($dirty2 << 3) & 112) | (($dirty12 << 6) & 896)).getValue().m2957unboximpl();
                        ChipKt.m1344ChipContentfe0OD_I(function2, labelTextStyle, m2957unboximpl2, function22, function23, function24, m2957unboximpl3, m2957unboximpl4, minHeight, paddingValues, $composer4, (($dirty12 << 15) & 1879048192) | (($dirty2 >> 12) & 14) | (($dirty2 >> 12) & 112) | (($dirty2 >> 9) & 7168) | (($dirty2 >> 9) & 57344) | (($dirty2 >> 9) & 458752) | (($dirty12 << 15) & 234881024));
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2937boximpl(labelColor)), TextKt.getLocalTextStyle().provides(labelTextStyle)}, ComposableLambdaKt.composableLambda($composer2, 1748799148, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ChipKt$ChipContent$1
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        Modifier modifier$iv = PaddingKt.padding(SizeKt.m514defaultMinSizeVpY3zN4$default(Modifier.INSTANCE, 0.0f, minHeight, 1, null), paddingValues);
                        ...
                        SpacerKt.Spacer(SizeKt.m534width3ABfNKs(companion, f), $composer3, 6);
                        function27.invoke($composer3, Integer.valueOf(i2 & 14));
                        Modifier.Companion companion2 = Modifier.INSTANCE;
                        f2 = ChipKt.HorizontalElementsPadding;
                        SpacerKt.Spacer(SizeKt.m534width3ABfNKs(companion2, f2), $composer3, 6);
    ...
    private static final PaddingValues inputChipPadding(boolean hasAvatar, boolean hasLeadingIcon, boolean hasTrailingIcon) {
        float start = (hasAvatar || !hasLeadingIcon) ? Dp.m5216constructorimpl(4) : Dp.m5216constructorimpl(8);
        float end = hasTrailingIcon ? Dp.m5216constructorimpl(8) : Dp.m5216constructorimpl(4);
        return PaddingKt.m479PaddingValuesa9UjIt4$default(start, 0.0f, end, 0.0f, 10, null);
    }
}
