...
public final class MenuKt {
    ...
    private static final float MenuVerticalMargin = Dp.m5216constructorimpl(48);
    private static final float DropdownMenuItemHorizontalPadding = Dp.m5216constructorimpl(12);
    private static final float DropdownMenuVerticalPadding = Dp.m5216constructorimpl(8);
    private static final float DropdownMenuItemDefaultMinWidth = Dp.m5216constructorimpl(112);
    private static final float DropdownMenuItemDefaultMaxWidth = Dp.m5216constructorimpl(280);
            ...
            if (invalid$iv$iv || it$iv$iv == Composer.INSTANCE.getEmpty()) {
                value$iv$iv = new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuContent$1$1
                    ...
                    public final void invoke2(GraphicsLayerScope graphicsLayer) {
                        ...
                        graphicsLayer.mo3136setTransformOrigin__ExYCQ(transformOriginState.getValue().getPackedValue());
                    }
                };
            ...
            SurfaceKt.m1792SurfaceT9BRK9s(GraphicsLayerModifierKt.graphicsLayer(companion, (Function1) value$iv$iv), ShapesKt.toShape(MenuTokens.INSTANCE.getContainerShape(), $composer2, 6), ColorSchemeKt.fromToken(MaterialTheme.INSTANCE.getColorScheme($composer2, 6), MenuTokens.INSTANCE.getContainerColor()), 0L, MenuTokens.INSTANCE.m2277getContainerElevationD9Ej5fM(), MenuTokens.INSTANCE.m2277getContainerElevationD9Ej5fM(), null, ComposableLambdaKt.composableLambda($composer2, -1651673913, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuContent$2
                ...
                public final void invoke(Composer $composer3, int $changed6) {
                    ...
                    if (($changed6 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        Modifier modifier$iv = ScrollKt.verticalScroll$default(IntrinsicKt.width(PaddingKt.m484paddingVpY3zN4$default(Modifier.this, 0.0f, MenuKt.getDropdownMenuVerticalPadding(), 1, null), IntrinsicSize.Max), ScrollKt.rememberScrollState(0, $composer3, 0, 1), false, null, false, 14, null);
    ...
    public static final void DropdownMenuItemContent(final Function2<? super Composer, ? super Integer, Unit> text, final Function0<Unit> onClick, final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final boolean enabled, final MenuItemColors colors, final PaddingValues contentPadding, final MutableInteractionSource interactionSource, Composer $composer, final int $changed) {
        ...
        if ((191739611 & $dirty2) != 38347922 || !$composer3.getSkipping()) {
            ...
            $composer2 = $composer3;
            m191clickableO2vRcR0 = ClickableKt.m191clickableO2vRcR0(modifier, interactionSource, RippleKt.m1284rememberRipple9IZ8Weo(true, 0.0f, 0L, $composer3, 6, 6), (r14 & 4) != 0 ? true : enabled, (r14 & 8) != 0 ? null : null, (r14 & 16) != 0 ? null : null, onClick);
            Modifier modifier$iv = PaddingKt.padding(SizeKt.m533sizeInqDBjuR0$default(SizeKt.fillMaxWidth$default(m191clickableO2vRcR0, 0.0f, 1, null), DropdownMenuItemDefaultMinWidth, MenuTokens.INSTANCE.m2278getListItemContainerHeightD9Ej5fM(), DropdownMenuItemDefaultMaxWidth, 0.0f, 8, null), contentPadding);
                            ...
                            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda($composer4, 2035552199, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1.1
                                ...
                                public final void invoke(Composer $composer5, int $changed3) {
                                    ...
                                    if (($changed3 & 11) != 2 || !$composer5.getSkipping()) {
                                        ...
                                        Modifier modifier$iv2 = SizeKt.m514defaultMinSizeVpY3zN4$default(Modifier.INSTANCE, MenuTokens.INSTANCE.m2279getListItemLeadingIconSizeD9Ej5fM(), 0.0f, 2, null);
                                        ...
                                        skippableUpdate$iv$iv$iv2.invoke(SkippableUpdater.m2572boximpl(SkippableUpdater.m2573constructorimpl($composer5)), $composer5, Integer.valueOf(($changed$iv$iv$iv2 >> 3) & 112));
                            ...
                            public final void invoke(Composer $composer5, int $changed3) {
                                ...
                                if (($changed3 & 11) != 2 || !$composer5.getSkipping()) {
                                    ...
                                    if (function24 != null) {
                                        ...
                                        m5216constructorimpl = f2;
                                    } else {
                                        m5216constructorimpl = Dp.m5216constructorimpl(0);
                                    }
                                    if (function25 != null) {
                                        f = MenuKt.DropdownMenuItemHorizontalPadding;
                                        m5216constructorimpl2 = f;
                                    } else {
                                        m5216constructorimpl2 = Dp.m5216constructorimpl(0);
                                    }
                                    Modifier modifier$iv2 = PaddingKt.m486paddingqDBjuR0$default(weight$default, m5216constructorimpl, 0.0f, m5216constructorimpl2, 0.0f, 10, null);
                            ...
                            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr3, ComposableLambdaKt.composableLambda($composer4, 580312062, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1.3
                                ...
                                public final void invoke(Composer $composer5, int $changed3) {
                                    ...
                                    if (($changed3 & 11) != 2 || !$composer5.getSkipping()) {
                                        ...
                                        Modifier modifier$iv2 = SizeKt.m514defaultMinSizeVpY3zN4$default(Modifier.INSTANCE, MenuTokens.INSTANCE.m2280getListItemTrailingIconSizeD9Ej5fM(), 0.0f, 2, null);
