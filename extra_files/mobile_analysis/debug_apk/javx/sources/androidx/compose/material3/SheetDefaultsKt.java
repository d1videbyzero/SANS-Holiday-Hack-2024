...
public final class SheetDefaultsKt {
    private static final float DragHandleVerticalPadding = Dp.m5216constructorimpl(22);
    private static final float BottomSheetMaxWidth = Dp.m5216constructorimpl(640);
        ...
        return new NestedScrollConnection() { // from class: androidx.compose.material3.SheetDefaultsKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1
            ...
            public Object mo559onPreFlingQWom1Mo(long available, Continuation<? super Velocity> continuation) {
                ...
                if (toFling < 0.0f && currentOffset > SheetState.this.getSwipeableState$material3_release().getMinOffset()) {
                    ...
                    m5452getZero9UxMQ8M = available;
                } else {
                    m5452getZero9UxMQ8M = Velocity.INSTANCE.m5452getZero9UxMQ8M();
                }
                return Velocity.m5432boximpl(m5452getZero9UxMQ8M);
            }
            ...
            public Object mo334onPostFlingRZ2iAVY(long consumed, long available, Continuation<? super Velocity> continuation) {
                ...
                return Velocity.m5432boximpl(available);
            }
            ...
            private final float velocityToFloat(long $this$toFloat) {
                return orientation == Orientation.Horizontal ? Velocity.m5441getXimpl($this$toFloat) : Velocity.m5442getYimpl($this$toFloat);
            }
