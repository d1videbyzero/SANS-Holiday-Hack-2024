...
public final class FilledTextFieldTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m5216constructorimpl((float) 1.0d);
    ...
    private static final float ContainerHeight = Dp.m5216constructorimpl((float) 56.0d);
    ...
    private static final float DisabledActiveIndicatorHeight = Dp.m5216constructorimpl((float) 1.0d);
    ...
    private static final float FocusActiveIndicatorHeight = Dp.m5216constructorimpl((float) 2.0d);
    ...
    private static final float HoverActiveIndicatorHeight = Dp.m5216constructorimpl((float) 1.0d);
    ...
    private static final float LeadingIconSize = Dp.m5216constructorimpl((float) 20.0d);
    ...
    private static final float TrailingIconSize = Dp.m5216constructorimpl((float) 24.0d);
