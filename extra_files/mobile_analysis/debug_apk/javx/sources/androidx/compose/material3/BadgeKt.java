...
public final class BadgeKt {
    ...
    private static final float BadgeWithContentHorizontalPadding = Dp.m5216constructorimpl(4);
                ...
                public final MeasureResult mo13measure3p2s80s(final MeasureScope Layout, List<? extends Measurable> measurables, long constraints) {
                    ...
                    for (Object element$iv : $this$first$iv) {
                        ...
                        if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it), "badge")) {
                            ...
                            final Placeable badgePlaceable = ((Measurable) element$iv).mo4184measureBRTryo0(m5162copyZbe2FdA);
                            ...
                            for (Object element$iv2 : $this$first$iv2) {
                                ...
                                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it2), "anchor")) {
                                    final Placeable anchorPlaceable = ((Measurable) element$iv2).mo4184measureBRTryo0(constraints);
                                    ...
                                    return Layout.layout(totalWidth, totalHeight, MapsKt.mapOf(TuplesKt.to(AlignmentLineKt.getFirstBaseline(), Integer.valueOf(firstBaseline)), TuplesKt.to(AlignmentLineKt.getLastBaseline(), Integer.valueOf(lastBaseline))), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.BadgeKt$BadgedBox$2$measure$1
                                        ...
                                        public final void invoke2(Placeable.PlacementScope layout) {
                                            Intrinsics.checkNotNullParameter(layout, "$this$layout");
                                            boolean hasContent = Placeable.this.getWidth() > Layout.mo321roundToPx0680j_4(BadgeTokens.INSTANCE.m2011getSizeD9Ej5fM());
    ...
    public static final void m1308BadgeeopBjH0(Modifier modifier, long containerColor, long contentColor, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            float size = content != null ? badgeTokens.m2010getLargeSizeD9Ej5fM() : badgeTokens.m2011getSizeD9Ej5fM();
            if (content != null) {
            ...
            Modifier then = ClipKt.clip(BackgroundKt.m160backgroundbw27NRU(SizeKt.m513defaultMinSizeVpY3zN4(modifier3, size, size), containerColor2, shape), shape).then(content != null ? PaddingKt.m484paddingVpY3zN4$default(Modifier.INSTANCE, BadgeWithContentHorizontalPadding, 0.0f, 2, null) : Modifier.INSTANCE);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BadgeKt$Badge$2
            ...
            public final void invoke(Composer composer, int i7) {
                BadgeKt.m1308BadgeeopBjH0(Modifier.this, j2, j3, function32, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }

    static {
        float arg0$iv = Dp.m5216constructorimpl(4);
        BadgeWithContentHorizontalOffset = Dp.m5216constructorimpl(-arg0$iv);
        float arg0$iv2 = Dp.m5216constructorimpl(4);
        BadgeWithContentVerticalOffset = Dp.m5216constructorimpl(-arg0$iv2);
        BadgeOffset = Dp.m5216constructorimpl(0);
    }
