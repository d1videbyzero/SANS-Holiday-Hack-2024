...
public final class AlertDialogKt {
    private static final float DialogMinWidth = Dp.m5216constructorimpl(280);
    private static final float DialogMaxWidth = Dp.m5216constructorimpl(560);
    private static final PaddingValues DialogPadding = PaddingKt.m475PaddingValues0680j_4(Dp.m5216constructorimpl(24));
    private static final PaddingValues IconPadding = PaddingKt.m479PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, Dp.m5216constructorimpl(16), 7, null);
    private static final PaddingValues TitlePadding = PaddingKt.m479PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, Dp.m5216constructorimpl(16), 7, null);
    private static final PaddingValues TextPadding = PaddingKt.m479PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, Dp.m5216constructorimpl(24), 7, null);
            ...
            MeasurePolicy measurePolicy$iv = new MeasurePolicy() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogFlowRow$1
                ...
                public final MeasureResult mo13measure3p2s80s(final MeasureScope Layout, List<? extends Measurable> measurables, long constraints) {
                    ...
                    for (Measurable measurable : measurables) {
                        Placeable placeable = measurable.mo4184measureBRTryo0(constraints);
                    ...
                    final int mainAxisLayoutSize = Math.max(mainAxisSpace.element, Constraints.m5174getMinWidthimpl(constraints));
                    int crossAxisLayoutSize = Math.max(crossAxisSpace.element, Constraints.m5173getMinHeightimpl(constraints));
                ...
                private static final boolean measure_3p2s80s$canAddToCurrentSequence(List<Placeable> list, Ref.IntRef currentMainAxisSize, MeasureScope $this_Layout, float $mainAxisSpacing, long $constraints, Placeable placeable) {
                    return list.isEmpty() || (currentMainAxisSize.element + $this_Layout.mo321roundToPx0680j_4($mainAxisSpacing)) + placeable.getWidth() <= Constraints.m5172getMaxWidthimpl($constraints);
                }
