...
public final class ButtonElevation {
    ...
    private final State<Dp> animateElevation(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (enabled) {
            ...
            EffectsKt.LaunchedEffect(Dp.m5214boximpl(target), new ButtonElevation$animateElevation$3(animatable, this, target, interaction, null), $composer, 64);
            $composer.endReplaceableGroup();
        } else {
            $composer.startReplaceableGroup(-719930083);
            ComposerKt.sourceInformation($composer, "859@40906L52");
            EffectsKt.LaunchedEffect(Dp.m5214boximpl(target), new ButtonElevation$animateElevation$2(animatable, target, null), $composer, 64);
            $composer.endReplaceableGroup();
        }
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof ButtonElevation) && Dp.m5221equalsimpl0(this.defaultElevation, ((ButtonElevation) other).defaultElevation) && Dp.m5221equalsimpl0(this.pressedElevation, ((ButtonElevation) other).pressedElevation) && Dp.m5221equalsimpl0(this.focusedElevation, ((ButtonElevation) other).focusedElevation) && Dp.m5221equalsimpl0(this.hoveredElevation, ((ButtonElevation) other).hoveredElevation) && Dp.m5221equalsimpl0(this.disabledElevation, ((ButtonElevation) other).disabledElevation)) {
            return true;
        }
        return false;
    }
