...
public final class SliderKt {
    private static final float ThumbWidth = SliderTokens.INSTANCE.m2433getHandleWidthD9Ej5fM();
    private static final float ThumbHeight = SliderTokens.INSTANCE.m2432getHandleHeightD9Ej5fM();
    private static final long ThumbSize = DpKt.m5238DpSizeYgX7TsA(ThumbWidth, ThumbHeight);
    ...
    private static final float TickSize = SliderTokens.INSTANCE.m2439getTickMarksContainerSizeD9Ej5fM();
    private static final float TrackHeight = SliderTokens.INSTANCE.m2434getInactiveTrackHeightD9Ej5fM();
            ...
            SliderImpl(modifier2, enabled2, interactionSource2, onValueChange, onValueChangeFinished, steps2, value, valueRange2, ComposableLambdaKt.composableLambda($composer3, -1522452856, true, new Function3<SliderPositions, Composer, Integer, Unit>() { // from class: androidx.compose.material3.SliderKt$Slider$3
                ...
                public final void invoke(SliderPositions it, Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 81) != 16 || !$composer4.getSkipping()) {
                        ...
                        SliderDefaults.INSTANCE.m1699Thumb9LiSoMs(MutableInteractionSource.this, null, colors3, enabled2, 0L, $composer4, (($dirty >> 24) & 14) | ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE | (($dirty >> 15) & 896) | ($dirty & 7168), 18);
                        if (ComposerKt.isTraceInProgress()) {
                    ...
                    Function3<SliderPositions, Composer, Integer, Unit> function33 = new Function3<SliderPositions, Composer, Integer, Unit>() { // from class: androidx.compose.material3.SliderKt$Slider$7
                        ...
                        public final void invoke(SliderPositions it, Composer $composer3, int $changed2) {
                            ...
                            if (($changed2 & 81) != 16 || !$composer3.getSkipping()) {
                                ...
                                SliderDefaults.INSTANCE.m1699Thumb9LiSoMs(MutableInteractionSource.this, null, colors2, enabled3, 0L, $composer3, (($dirty2 >> 21) & 14) | ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE | (($dirty2 >> 12) & 896) | ($dirty2 & 7168), 18);
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventEnd();
                                    return;
                                }
            ...
            RangeSliderImpl(modifier2, value, onValueChange, enabled3, valueRange2, steps3, onValueChangeFinished2, startInteractionSource, endInteractionSource, ComposableLambdaKt.composableLambda($composer3, 1361279243, true, new Function3<SliderPositions, Composer, Integer, Unit>() { // from class: androidx.compose.material3.SliderKt$RangeSlider$2
                ...
                public final void invoke(SliderPositions it, Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 81) != 16 || !$composer4.getSkipping()) {
                        ...
                        SliderDefaults.INSTANCE.m1699Thumb9LiSoMs(MutableInteractionSource.this, null, colors2, enabled3, 0L, $composer4, (($dirty >> 15) & 896) | 196614 | ($dirty & 7168), 18);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
                    ...
                    Function3<SliderPositions, Composer, Integer, Unit> function34 = new Function3<SliderPositions, Composer, Integer, Unit>() { // from class: androidx.compose.material3.SliderKt$RangeSlider$8
                        ...
                        public final void invoke(SliderPositions it, Composer $composer4, int $changed2) {
                            ...
                            if (($changed2 & 81) != 16 || !$composer4.getSkipping()) {
                                ...
                                SliderDefaults.INSTANCE.m1699Thumb9LiSoMs(MutableInteractionSource.this, null, colors2, enabled4, 0L, $composer4, (($dirty >> 21) & 14) | ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE | (($dirty >> 12) & 896) | ($dirty & 7168), 18);
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventEnd();
                                    return;
                                }
                ...
                Function3 endThumb3 = i10 != 0 ? ComposableLambdaKt.composableLambda($composer3, 1397395775, z, new Function3<SliderPositions, Composer, Integer, Unit>() { // from class: androidx.compose.material3.SliderKt$RangeSlider$9
                    ...
                    public final void invoke(SliderPositions it, Composer $composer4, int $changed2) {
                        ...
                        if (($changed2 & 81) != 16 || !$composer4.getSkipping()) {
                            ...
                            SliderDefaults.INSTANCE.m1699Thumb9LiSoMs(MutableInteractionSource.this, null, colors2, enabled4, 0L, $composer4, (($dirty >> 24) & 14) | ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE | (($dirty >> 12) & 896) | ($dirty & 7168), 18);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                                return;
                            }
