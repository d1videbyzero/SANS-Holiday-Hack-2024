...
public final class SliderTokens {
    ...
    private static final float ActiveTrackHeight = Dp.m5216constructorimpl((float) 4.0d);
    ...
    private static final float HandleHeight = Dp.m5216constructorimpl((float) 20.0d);
    private static final ShapeKeyTokens HandleShape = ShapeKeyTokens.CornerFull;
    private static final float HandleWidth = Dp.m5216constructorimpl((float) 20.0d);
    ...
    private static final float InactiveTrackHeight = Dp.m5216constructorimpl((float) 4.0d);
    ...
    private static final float LabelContainerHeight = Dp.m5216constructorimpl((float) 28.0d);
    ...
    private static final float OverlapHandleOutlineWidth = Dp.m5216constructorimpl((float) 1.0d);
    ...
    private static final float TickMarksContainerSize = Dp.m5216constructorimpl((float) 2.0d);
