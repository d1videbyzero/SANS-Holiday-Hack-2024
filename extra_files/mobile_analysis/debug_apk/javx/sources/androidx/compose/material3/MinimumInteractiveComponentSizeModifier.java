...
final class MinimumInteractiveComponentSizeModifier implements LayoutModifier {
    ...
    public MeasureResult mo39measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        final int width = Math.max(placeable.getWidth(), measure.mo321roundToPx0680j_4(DpSize.m5314getWidthD9Ej5fM(this.size)));
        final int height = Math.max(placeable.getHeight(), measure.mo321roundToPx0680j_4(DpSize.m5312getHeightD9Ej5fM(this.size)));
    ...
    public boolean equals(Object other) {
        ...
        return DpSize.m5311equalsimpl0(this.size, otherModifier.size);
    }
