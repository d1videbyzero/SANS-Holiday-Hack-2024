...
public final class NavigationBarItemColors {
    ...
    public final State<Color> iconColor$material3_release(boolean selected, boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> m70animateColorAsStateeuL9pac = SingleValueAnimationKt.m70animateColorAsStateeuL9pac(targetValue, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, $composer, 48, 12);
        if (ComposerKt.isTraceInProgress()) {
