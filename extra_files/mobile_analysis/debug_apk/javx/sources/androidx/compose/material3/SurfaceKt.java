...
public final class SurfaceKt {
    private static final ProvidableCompositionLocal<Dp> LocalAbsoluteTonalElevation = CompositionLocalKt.compositionLocalOf$default(null, new Function0<Dp>() { // from class: androidx.compose.material3.SurfaceKt$LocalAbsoluteTonalElevation$1
        ...
        public /* bridge */ /* synthetic */ Dp invoke() {
            return Dp.m5214boximpl(m1800invokeD9Ej5fM());
        }

        /* renamed from: invoke-D9Ej5fM, reason: not valid java name */
        public final float m1800invokeD9Ej5fM() {
            return Dp.m5216constructorimpl(0);
        }
    }, 1, null);
    ...
    public static final void m1792SurfaceT9BRK9s(Modifier modifier, Shape shape, long color, long contentColor, float tonalElevation, float shadowElevation, BorderStroke border, final Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed, int i) {
        ...
        float tonalElevation2 = (i & 16) != 0 ? Dp.m5216constructorimpl(0) : tonalElevation;
        float shadowElevation2 = (i & 32) != 0 ? Dp.m5216constructorimpl(0) : shadowElevation;
        ...
        float arg0$iv = ((Dp) consume).m5230unboximpl();
        final float absoluteElevation = Dp.m5216constructorimpl(arg0$iv + tonalElevation2);
        final Modifier modifier3 = modifier2;
        final Shape shape3 = shape2;
        final long j = color2;
        final BorderStroke borderStroke = border2;
        final float f = shadowElevation2;
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2937boximpl(contentColor2)), LocalAbsoluteTonalElevation.provides(Dp.m5214boximpl(absoluteElevation))}, ComposableLambdaKt.composableLambda($composer, -70914509, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$1
            ...
            public final void invoke(Composer $composer2, int $changed2) {
                long m1799surfaceColorAtElevationCLU3JFs;
                Modifier m1798surface8ww4TTg;
                ...
                if (($changed2 & 11) != 2 || !$composer2.getSkipping()) {
                    ...
                    Shape shape4 = shape3;
                    m1799surfaceColorAtElevationCLU3JFs = SurfaceKt.m1799surfaceColorAtElevationCLU3JFs(j, absoluteElevation, $composer2, ($changed >> 6) & 14);
                    m1798surface8ww4TTg = SurfaceKt.m1798surface8ww4TTg(modifier4, shape4, m1799surfaceColorAtElevationCLU3JFs, borderStroke, f);
                    Modifier modifier$iv = SuspendingPointerInputFilterKt.pointerInput(SemanticsModifierKt.semantics(m1798surface8ww4TTg, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$1.1
    ...
    public static final void m1795Surfaceo_FOJdg(final Function0<Unit> onClick, Modifier modifier, boolean enabled, Shape shape, long color, long contentColor, float tonalElevation, float shadowElevation, BorderStroke border, MutableInteractionSource interactionSource, final Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed, final int $changed1, int i) {
        ...
        float tonalElevation2 = (i & 64) != 0 ? Dp.m5216constructorimpl(0) : tonalElevation;
        float shadowElevation2 = (i & 128) != 0 ? Dp.m5216constructorimpl(0) : shadowElevation;
        ...
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2937boximpl(contentColor2)), LocalAbsoluteTonalElevation.provides(Dp.m5214boximpl(absoluteElevation))}, ComposableLambdaKt.composableLambda($composer, 1279702876, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$3
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(2);
            ...
            public final void invoke(Composer $composer2, int $changed2) {
                ...
                if (($changed2 & 11) != 2 || !$composer2.getSkipping()) {
                    ...
                    Shape shape4 = shape3;
                    m1799surfaceColorAtElevationCLU3JFs = SurfaceKt.m1799surfaceColorAtElevationCLU3JFs(j, absoluteElevation, $composer2, ($changed >> 12) & 14);
                    m1798surface8ww4TTg = SurfaceKt.m1798surface8ww4TTg(minimumInteractiveComponentSize, shape4, m1799surfaceColorAtElevationCLU3JFs, borderStroke, f);
                    modifier$iv = ClickableKt.m191clickableO2vRcR0(m1798surface8ww4TTg, mutableInteractionSource, RippleKt.m1284rememberRipple9IZ8Weo(false, 0.0f, 0L, $composer2, 0, 7), (r14 & 4) != 0 ? true : z, (r14 & 8) != 0 ? null : null, (r14 & 16) != 0 ? null : null, onClick);
                    Function2<Composer, Integer, Unit> function2 = content;
                    int i2 = $changed1;
                    $composer2.startReplaceableGroup(733328855);
                    ComposerKt.sourceInformation($composer2, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
    ...
    public static final void m1793Surfaced85dljk(final boolean selected, final Function0<Unit> onClick, Modifier modifier, boolean enabled, Shape shape, long color, long contentColor, float tonalElevation, float shadowElevation, BorderStroke border, MutableInteractionSource interactionSource, final Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed, final int $changed1, int i) {
        ...
        float tonalElevation2 = (i & 128) != 0 ? Dp.m5216constructorimpl(0) : tonalElevation;
        float shadowElevation2 = (i & 256) != 0 ? Dp.m5216constructorimpl(0) : shadowElevation;
        ...
        final MutableInteractionSource mutableInteractionSource = interactionSource2;
        final boolean z = enabled2;
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2937boximpl(contentColor2)), LocalAbsoluteTonalElevation.provides(Dp.m5214boximpl(absoluteElevation))}, ComposableLambdaKt.composableLambda($composer, -1164547968, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$5
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(2);
            ...
            public final void invoke(Composer $composer2, int $changed2) {
                ...
                if (($changed2 & 11) != 2 || !$composer2.getSkipping()) {
                    ...
                    Modifier minimumInteractiveComponentSize = InteractiveComponentSizeKt.minimumInteractiveComponentSize(Modifier.this);
                    Shape shape4 = shape3;
                    m1799surfaceColorAtElevationCLU3JFs = SurfaceKt.m1799surfaceColorAtElevationCLU3JFs(j, absoluteElevation, $composer2, ($changed >> 15) & 14);
                    m1798surface8ww4TTg = SurfaceKt.m1798surface8ww4TTg(minimumInteractiveComponentSize, shape4, m1799surfaceColorAtElevationCLU3JFs, borderStroke, f);
                    Modifier modifier$iv = SelectableKt.m707selectableO2vRcR0$default(m1798surface8ww4TTg, selected, mutableInteractionSource, RippleKt.m1284rememberRipple9IZ8Weo(false, 0.0f, 0L, $composer2, 0, 7), z, null, onClick, 16, null);
                    Function2<Composer, Integer, Unit> function2 = content;
                    int i2 = $changed1;
                    $composer2.startReplaceableGroup(733328855);
                    ComposerKt.sourceInformation($composer2, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
    ...
    public static final void m1794Surfaced85dljk(final boolean checked, final Function1<? super Boolean, Unit> onCheckedChange, Modifier modifier, boolean enabled, Shape shape, long color, long contentColor, float tonalElevation, float shadowElevation, BorderStroke border, MutableInteractionSource interactionSource, final Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed, final int $changed1, int i) {
        ...
        final MutableInteractionSource mutableInteractionSource = interactionSource2;
        final boolean z = enabled2;
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2937boximpl(contentColor2)), LocalAbsoluteTonalElevation.provides(Dp.m5214boximpl(absoluteElevation))}, ComposableLambdaKt.composableLambda($composer, 712720927, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$7
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(2);
            ...
            public final void invoke(Composer $composer2, int $changed2) {
                ...
                if (($changed2 & 11) != 2 || !$composer2.getSkipping()) {
                    ...
                    m1799surfaceColorAtElevationCLU3JFs = SurfaceKt.m1799surfaceColorAtElevationCLU3JFs(j, absoluteElevation, $composer2, ($changed >> 15) & 14);
                    m1798surface8ww4TTg = SurfaceKt.m1798surface8ww4TTg(minimumInteractiveComponentSize, shape4, m1799surfaceColorAtElevationCLU3JFs, borderStroke, f);
                    Modifier modifier$iv = ToggleableKt.m711toggleableO2vRcR0$default(m1798surface8ww4TTg, checked, mutableInteractionSource, RippleKt.m1284rememberRipple9IZ8Weo(false, 0.0f, 0L, $composer2, 0, 7), z, null, onCheckedChange, 16, null);
                    Function2<Composer, Integer, Unit> function2 = content;
                    int i2 = $changed1;
                    $composer2.startReplaceableGroup(733328855);
                    ComposerKt.sourceInformation($composer2, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
    ...
    public static final Modifier m1798surface8ww4TTg(Modifier $this$surface_u2d8ww4TTg, Shape shape, long backgroundColor, BorderStroke border, float shadowElevation) {
        ...
        m2619shadows4CzXII = ShadowKt.m2619shadows4CzXII($this$surface_u2d8ww4TTg, shadowElevation, (r15 & 2) != 0 ? RectangleShapeKt.getRectangleShape() : shape, (r15 & 4) != 0 ? Dp.m5215compareTo0680j_4(r8, Dp.m5216constructorimpl((float) 0)) > 0 : false, (r15 & 8) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : 0L, (r15 & 16) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : 0L);
        Modifier.Companion companion = Modifier.INSTANCE;
        if (border != null) {
            companion = BorderKt.border(companion, border, shape);
        }
        return ClipKt.clip(BackgroundKt.m160backgroundbw27NRU(m2619shadows4CzXII.then(companion), backgroundColor, shape), shape);
    }
    ...
    public static final long m1799surfaceColorAtElevationCLU3JFs(long color, float elevation, Composer $composer, int $changed) {
        ...
        if (Color.m2948equalsimpl0(color, MaterialTheme.INSTANCE.getColorScheme($composer, 6).m1376getSurface0d7_KjU())) {
            j = ColorSchemeKt.m1417surfaceColorAtElevation3ABfNKs(MaterialTheme.INSTANCE.getColorScheme($composer, 6), elevation);
        } else {
            j = color;
        }
        if (ComposerKt.isTraceInProgress()) {
