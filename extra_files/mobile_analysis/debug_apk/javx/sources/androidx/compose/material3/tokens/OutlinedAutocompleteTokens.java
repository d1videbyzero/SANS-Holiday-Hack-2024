...
public final class OutlinedAutocompleteTokens {
    ...
    private static final float TextFieldDisabledOutlineWidth = Dp.m5216constructorimpl((float) 1.0d);
    ...
    private static final float TextFieldFocusOutlineWidth = Dp.m5216constructorimpl((float) 2.0d);
    ...
    private static final float TextFieldHoverOutlineWidth = Dp.m5216constructorimpl((float) 1.0d);
    ...
    private static final float TextFieldLeadingIconSize = Dp.m5216constructorimpl((float) 24.0d);
    private static final ColorSchemeKeyTokens TextFieldOutlineColor = ColorSchemeKeyTokens.Outline;
    private static final float TextFieldOutlineWidth = Dp.m5216constructorimpl((float) 1.0d);
