...
final class TimePickerKt$clockDial$2 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier composed, Composer $composer, int $changed) {
        ...
        if (it$iv$iv3 == Composer.INSTANCE.getEmpty()) {
            value$iv$iv3 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m5325boximpl(IntOffset.INSTANCE.m5344getZeronOccac()), null, 2, null);
        ...
        if (invalid$iv$iv || it$iv$iv4 == Composer.INSTANCE.getEmpty()) {
            value$iv$iv4 = (Function1) new Function1<IntSize, Unit>() { // from class: androidx.compose.material3.TimePickerKt$clockDial$2$1$1
                ...
                public final void m1896invokeozmzZPI(long it) {
                    TimePickerState.this.m1912setCentergyyYBs$material3_release(IntSizeKt.m5382getCenterozmzZPI(it));
                }
            };
        ...
        $composer.endReplaceableGroup();
        Modifier pointerInput = SuspendingPointerInputFilterKt.pointerInput(SuspendingPointerInputFilterKt.pointerInput(OnRemeasuredModifierKt.onSizeChanged(companion, (Function1) value$iv$iv4), new Object[]{this.$state, IntOffset.m5325boximpl(invoke$lambda$7(center$delegate)), Float.valueOf(maxDist)}, (Function2<? super PointerInputScope, ? super Continuation<? super Unit>, ? extends Object>) new AnonymousClass2(offsetX$delegate, offsetY$delegate, scope, this.$state, maxDist, this.$autoSwitchToMinute, null)), new Object[]{this.$state, IntOffset.m5325boximpl(invoke$lambda$7(center$delegate)), Float.valueOf(maxDist)}, (Function2<? super PointerInputScope, ? super Continuation<? super Unit>, ? extends Object>) new AnonymousClass3(scope, this.$state, this.$autoSwitchToMinute, maxDist, offsetX$delegate, offsetY$delegate, null));
        if (ComposerKt.isTraceInProgress()) {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                switch (this.label) {
                    case 0:
                        ...
                        long it = this.J$0;
                        TimePickerKt$clockDial$2.invoke$lambda$2(this.$offsetX$delegate, Offset.m2708getXimpl(it));
                        TimePickerKt$clockDial$2.invoke$lambda$5(this.$offsetY$delegate, Offset.m2709getYimpl(it));
                        return Unit.INSTANCE;
                    default:
                        ...
                        static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                            ...
                            public final Object invokeSuspend(Object $result) {
                                ...
                                switch (this.label) {
                                    case 0:
                                        ResultKt.throwOnFailure($result);
                                        TimePickerKt$clockDial$2.invoke$lambda$2(this.$offsetX$delegate, TimePickerKt$clockDial$2.invoke$lambda$1(this.$offsetX$delegate) + Offset.m2708getXimpl(this.$dragAmount));
                                        TimePickerKt$clockDial$2.invoke$lambda$5(this.$offsetY$delegate, TimePickerKt$clockDial$2.invoke$lambda$4(this.$offsetY$delegate) + Offset.m2709getYimpl(this.$dragAmount));
                                        TimePickerState timePickerState = this.$state;
                                        atan = TimePickerKt.atan(TimePickerKt$clockDial$2.invoke$lambda$4(this.$offsetY$delegate) - IntOffset.m5335getYimpl(this.$state.m1909getCenternOccac$material3_release()), TimePickerKt$clockDial$2.invoke$lambda$1(this.$offsetX$delegate) - IntOffset.m5334getXimpl(this.$state.m1909getCenternOccac$material3_release()));
                                        this.label = 1;
