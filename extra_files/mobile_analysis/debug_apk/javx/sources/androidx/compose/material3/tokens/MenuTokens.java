...
public final class MenuTokens {
    ...
    private static final float ListItemContainerHeight = Dp.m5216constructorimpl((float) 48.0d);
    ...
    private static final float ListItemLeadingIconSize = Dp.m5216constructorimpl((float) 24.0d);
