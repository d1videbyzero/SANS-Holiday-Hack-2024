...
public final class ProgressIndicatorDefaults {
    ...
    private static final int LinearStrokeCap = StrokeCap.INSTANCE.m3293getButtKaPHkGw();
    private static final int CircularDeterminateStrokeCap = StrokeCap.INSTANCE.m3293getButtKaPHkGw();
    private static final int CircularIndeterminateStrokeCap = StrokeCap.INSTANCE.m3295getSquareKaPHkGw();
    ...
    public final long getCircularTrackColor(Composer $composer, int $changed) {
        ...
        long m2982getTransparent0d7_KjU = Color.INSTANCE.m2982getTransparent0d7_KjU();
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
        return m2982getTransparent0d7_KjU;
    }
