...
public final class ListItemKt {
    private static final float ListItemVerticalPadding = Dp.m5216constructorimpl(8);
    private static final float ListItemThreeLineVerticalPadding = Dp.m5216constructorimpl(16);
    private static final float ListItemHorizontalPadding = Dp.m5216constructorimpl(16);
    private static final float LeadingContentEndPadding = Dp.m5216constructorimpl(16);
    private static final float ContentEndPadding = Dp.m5216constructorimpl(8);
    private static final float TrailingHorizontalPadding = Dp.m5216constructorimpl(8);
    ...
    public static final void m1575ListItemHXNGIdc(final Function2<? super Composer, ? super Integer, Unit> headlineContent, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, Function2<? super Composer, ? super Integer, Unit> function23, Function2<? super Composer, ? super Integer, Unit> function24, ListItemColors colors, float tonalElevation, float shadowElevation, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 191739611) == 38347922 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                tonalElevation2 = i8 != 0 ? ListItemDefaults.INSTANCE.m1573getElevationD9Ej5fM() : tonalElevation;
                shadowElevation2 = i9 != 0 ? ListItemDefaults.INSTANCE.m1573getElevationD9Ej5fM() : shadowElevation;
            } else {
                $composer2.skipToGroupEnd();
                if ((i & 64) != 0) {
                    $dirty &= -3670017;
            ...
            final Function2 decoratedHeadlineContent = ComposableLambdaKt.composableLambda($composer2, -403249643, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$ListItem$decoratedHeadlineContent$1
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        ListItemKt.m1577ProvideTextStyleFromToken3JVO9M(ListItemColors.this.headlineColor$material3_release(true, $composer3, (($dirty >> 15) & 112) | 6).getValue().m2957unboximpl(), ListTokens.INSTANCE.getListItemLabelTextFont(), headlineContent, $composer3, (($dirty << 6) & 896) | 48);
                        if (ComposerKt.isTraceInProgress()) {
                ...
                decoratedSupportingContent = ComposableLambdaKt.composableLambda($composer2, -1020860251, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$ListItem$decoratedSupportingContent$1$1
                    ...
                    public final void invoke(Composer $composer3, int $changed2) {
                        ...
                        if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                            ...
                            ListItemKt.m1577ProvideTextStyleFromToken3JVO9M(ListItemColors.this.supportingColor$material3_release($composer3, ($dirty >> 18) & 14).getValue().m2957unboximpl(), ListTokens.INSTANCE.getListItemSupportingTextFont(), it, $composer3, 48);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                                return;
                            }
                ...
                decoratedOverlineContent = ComposableLambdaKt.composableLambda($composer2, -764441232, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$ListItem$decoratedOverlineContent$1$1
                    ...
                    public final void invoke(Composer $composer3, int $changed2) {
                        ...
                        if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                            ...
                            ListItemKt.m1577ProvideTextStyleFromToken3JVO9M(ListItemColors.this.overlineColor$material3_release($composer3, ($dirty >> 18) & 14).getValue().m2957unboximpl(), ListTokens.INSTANCE.getListItemOverlineFont(), it2, $composer3, 48);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                                return;
                            }
                ...
                decoratedLeadingContent = ComposableLambdaKt.composableLambda($composer2, 1673725255, true, new Function3<RowScope, Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$ListItem$decoratedLeadingContent$1$1
                    ...
                    public final void invoke(RowScope $this$null, Composer $composer3, int $changed2) {
                        ...
                        if (($dirty2 & 91) != 18 || !$composer3.getSkipping()) {
                            ...
                            ListItemKt.m1574LeadingContent3IgeMak($this$null, ListItemColors.this.leadingIconColor$material3_release(true, $composer3, (($dirty >> 15) & 112) | 6).getValue().m2957unboximpl(), ListItemType.m1587equalsimpl0(listItemType, ListItemType.INSTANCE.m1594getThreeLineAlXitO8()), it3, $composer3, $dirty2 & 14);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                                return;
                            }
                ...
                decoratedTrailingContent = ComposableLambdaKt.composableLambda($composer2, 1392069445, true, new Function3<RowScope, Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$ListItem$decoratedTrailingContent$1$1
                    ...
                    public final void invoke(RowScope $this$null, Composer $composer3, int $changed2) {
                        ...
                        if (($dirty2 & 91) != 18 || !$composer3.getSkipping()) {
                            ...
                            ListItemKt.m1578TrailingContent3IgeMak($this$null, ListItemColors.this.trailingIconColor$material3_release(true, $composer3, (($dirty >> 15) & 112) | 6).getValue().m2957unboximpl(), ListItemType.m1587equalsimpl0(listItemType, ListItemType.INSTANCE.m1594getThreeLineAlXitO8()), it4, $composer3, $dirty2 & 14);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                                return;
                            }
            ...
            PaddingValues outerPaddingValues = PaddingKt.m476PaddingValuesYgX7TsA(ListItemHorizontalPadding, ListItemType.m1587equalsimpl0(listItemType, ListItemType.INSTANCE.m1594getThreeLineAlXitO8()) ? ListItemThreeLineVerticalPadding : ListItemVerticalPadding);
            final PaddingValues contentPaddingValues = PaddingKt.m479PaddingValuesa9UjIt4$default(0.0f, 0.0f, ListItemType.m1587equalsimpl0(listItemType, ListItemType.INSTANCE.m1594getThreeLineAlXitO8()) ? ContentEndPadding : Dp.m5216constructorimpl(0), 0.0f, 11, null);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$ListItem$2
            ...
            public final void invoke(Composer composer, int i10) {
                ListItemKt.m1575ListItemHXNGIdc(headlineContent, modifier4, function29, function210, function211, function212, listItemColors, f, f2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    */
    ...
    public static final void m1574LeadingContent3IgeMak(final RowScope $this$LeadingContent_u2d3IgeMak, final long contentColor, final boolean topAlign, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2937boximpl(contentColor))}, ComposableLambdaKt.composableLambda($composer2, 315166618, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$LeadingContent$1
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        Modifier modifier$iv = PaddingKt.m486paddingqDBjuR0$default(companion, 0.0f, 0.0f, f, 0.0f, 11, null).then(!topAlign ? $this$LeadingContent_u2d3IgeMak.align(Modifier.INSTANCE, Alignment.INSTANCE.getCenterVertically()) : Modifier.INSTANCE);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$LeadingContent$2
            ...
            public final void invoke(Composer composer, int i) {
                ListItemKt.m1574LeadingContent3IgeMak(RowScope.this, contentColor, topAlign, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
    ...
    public static final void m1578TrailingContent3IgeMak(final RowScope $this$TrailingContent_u2d3IgeMak, final long contentColor, final boolean topAlign, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        ...
        if (($dirty2 & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            Modifier m484paddingVpY3zN4$default = PaddingKt.m484paddingVpY3zN4$default(Modifier.INSTANCE, TrailingHorizontalPadding, 0.0f, 2, null);
            Modifier.Companion companion = Modifier.INSTANCE;
            if (!topAlign) {
                companion = $this$TrailingContent_u2d3IgeMak.align(companion, Alignment.INSTANCE.getCenterVertically());
            }
            Modifier modifier$iv = m484paddingVpY3zN4$default.then(companion);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$TrailingContent$2
            ...
            public final void invoke(Composer composer, int i3) {
                ListItemKt.m1578TrailingContent3IgeMak(RowScope.this, contentColor, topAlign, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
