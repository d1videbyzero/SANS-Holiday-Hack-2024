...
public final class TimeInputTokens {
    ...
    private static final float PeriodSelectorContainerHeight = Dp.m5216constructorimpl((float) 72.0d);
    private static final ShapeKeyTokens PeriodSelectorContainerShape = ShapeKeyTokens.CornerSmall;
    private static final float PeriodSelectorContainerWidth = Dp.m5216constructorimpl((float) 52.0d);
    ...
    private static final float TimeFieldContainerHeight = Dp.m5216constructorimpl((float) 72.0d);
    private static final ShapeKeyTokens TimeFieldContainerShape = ShapeKeyTokens.CornerSmall;
    private static final float TimeFieldContainerWidth = Dp.m5216constructorimpl((float) 96.0d);
    ...
    private static final float TimeFieldFocusOutlineWidth = Dp.m5216constructorimpl((float) 2.0d);
