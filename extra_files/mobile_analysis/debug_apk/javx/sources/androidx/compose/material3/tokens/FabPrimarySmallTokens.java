...
public final class FabPrimarySmallTokens {
    ...
    private static final float ContainerHeight = Dp.m5216constructorimpl((float) 40.0d);
    private static final ShapeKeyTokens ContainerShape = ShapeKeyTokens.CornerMedium;
    private static final float ContainerWidth = Dp.m5216constructorimpl((float) 40.0d);
