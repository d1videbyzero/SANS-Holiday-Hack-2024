...
public final class DateRangePickerKt {
    private static final PaddingValues CalendarMonthSubheadPadding = PaddingKt.m479PaddingValuesa9UjIt4$default(Dp.m5216constructorimpl(24), Dp.m5216constructorimpl(20), 0.0f, Dp.m5216constructorimpl(8), 4, null);
    private static final PaddingValues DateRangePickerTitlePadding = PaddingKt.m479PaddingValuesa9UjIt4$default(Dp.m5216constructorimpl(64), 0.0f, Dp.m5216constructorimpl(12), 0.0f, 10, null);
    private static final PaddingValues DateRangePickerHeadlinePadding = PaddingKt.m479PaddingValuesa9UjIt4$default(Dp.m5216constructorimpl(64), 0.0f, Dp.m5216constructorimpl(12), Dp.m5216constructorimpl(12), 2, null);
    private static final float HeaderHeightOffset = Dp.m5216constructorimpl(60);
    ...
    public static final void DateRangePicker(final DateRangePickerState state, Modifier modifier, DatePickerFormatter dateFormatter, Function1<? super Long, Boolean> function1, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, boolean showModeToggle, DatePickerColors colors, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 23967451) == 4793490 && $composer2.getSkipping()) {
            ...
            ComposableLambda composableLambda = showModeToggle2 ? ComposableLambdaKt.composableLambda($composer2, -1062265737, z, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$DateRangePicker$5
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        int m1474getDisplayModejFl4v0 = DateRangePickerState.this.m1474getDisplayModejFl4v0();
                        ...
                        if (invalid$iv$iv || it$iv$iv2 == Composer.INSTANCE.getEmpty()) {
                            value$iv$iv2 = new Function1<DisplayMode, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$DateRangePicker$5$1$1
                                ...
                                public final void m1472invokevCnGnXg(int displayMode) {
                                    DateRangePickerState.this.getStateData().m1711switchDisplayModevCnGnXg(displayMode);
                                }
                            };
                        ...
                        DatePickerKt.m1464DisplayModeToggleButtontER2X8s(padding, m1474getDisplayModejFl4v0, (Function1) value$iv$iv2, $composer3, 6);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
            ...
            final int i9 = $dirty;
            DatePickerKt.m1462DateEntryContainerau3_HiA(modifier2, title, headline, composableLambda, colors2, fromToken, Dp.m5216constructorimpl(arg0$iv - other$iv), ComposableLambdaKt.composableLambda($composer2, -186850856, z, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$DateRangePicker$6
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    ...
    public static final void SwitchableDateEntryContent(final DateRangePickerState state, final DatePickerFormatter dateFormatter, final Function1<? super Long, Boolean> function1, final DatePickerColors colors, Composer $composer, final int $changed) {
        ...
        if (($dirty & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            int m1474getDisplayModejFl4v0 = state.m1474getDisplayModejFl4v0();
            final int i = $dirty;
            CrossfadeKt.Crossfade(DisplayMode.m1484boximpl(m1474getDisplayModejFl4v0), SemanticsModifierKt.semantics$default(Modifier.INSTANCE, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$SwitchableDateEntryContent$1
                @Override // kotlin.jvm.functions.Function1
    ...
    public static final void DateRangePickerContent(final StateData stateData, final DatePickerFormatter dateFormatter, final Function1<? super Long, Boolean> function1, final DatePickerColors colors, Composer $composer, final int $changed) {
        ...
        if (($dirty2 & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            Modifier modifier$iv = PaddingKt.m484paddingVpY3zN4$default(Modifier.INSTANCE, DatePickerKt.getDatePickerHorizontalPadding(), 0.0f, 2, null);
    ...
    public static final void m1470drawRangeBackgroundmxwnekA(ContentDrawScope drawRangeBackground, SelectedRangeInfo selectedRangeInfo, long color) {
        ...
        float itemStateLayerHeight = drawRangeBackground.mo327toPx0680j_4(DatePickerModalTokens.INSTANCE.m2104getDateStateLayerHeightD9Ej5fM());
        float f = 2;
        float stateLayerVerticalPadding = (itemContainerHeight - itemStateLayerHeight) / f;
        float f2 = 7;
        float horizontalSpaceBetweenItems = (Size.m2777getWidthimpl(drawRangeBackground.mo3490getSizeNHjbRc()) - (f2 * itemContainerWidth)) / f2;
        long packedValue = selectedRangeInfo.getGridCoordinates().getFirst().getPackedValue();
        int x1 = IntOffset.m5326component1impl(packedValue);
        int y1 = IntOffset.m5327component2impl(packedValue);
        long packedValue2 = selectedRangeInfo.getGridCoordinates().getSecond().getPackedValue();
        int x2 = IntOffset.m5326component1impl(packedValue2);
        int y2 = IntOffset.m5327component2impl(packedValue2);
        ...
        if (isRtl) {
            startX = Size.m2777getWidthimpl(drawRangeBackground.mo3490getSizeNHjbRc()) - startX;
            endX = Size.m2777getWidthimpl(drawRangeBackground.mo3490getSizeNHjbRc()) - endX;
        }
        ContentDrawScope contentDrawScope = drawRangeBackground;
        long Offset = OffsetKt.Offset(startX, startY);
        if (y1 == y2) {
            m2777getWidthimpl = endX - startX;
        } else {
            m2777getWidthimpl = isRtl ? -startX : Size.m2777getWidthimpl(drawRangeBackground.mo3490getSizeNHjbRc()) - startX;
        }
        DrawScope.m3485drawRectnJ9OG0$default(contentDrawScope, color, Offset, SizeKt.Size(m2777getWidthimpl, itemStateLayerHeight), 0.0f, null, null, 0, 120, null);
        if (y1 != y2) {
            int y = (y2 - y1) - 1;
            while (y > 0) {
                DrawScope.m3485drawRectnJ9OG0$default(drawRangeBackground, color, OffsetKt.Offset(0.0f, (y * itemContainerHeight) + startY), SizeKt.Size(Size.m2777getWidthimpl(drawRangeBackground.mo3490getSizeNHjbRc()), itemStateLayerHeight), 0.0f, null, null, 0, 120, null);
                y--;
                itemContainerHeight = itemContainerHeight;
            }
            float topLeftX = drawRangeBackground.getLayoutDirection() == LayoutDirection.Ltr ? 0.0f : Size.m2777getWidthimpl(drawRangeBackground.mo3490getSizeNHjbRc());
            DrawScope.m3485drawRectnJ9OG0$default(drawRangeBackground, color, OffsetKt.Offset(topLeftX, endY), SizeKt.Size(isRtl ? endX - Size.m2777getWidthimpl(drawRangeBackground.mo3490getSizeNHjbRc()) : endX, itemStateLayerHeight), 0.0f, null, null, 0, 120, null);
        }
    }
