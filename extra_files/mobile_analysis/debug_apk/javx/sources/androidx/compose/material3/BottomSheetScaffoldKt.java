...
public final class BottomSheetScaffoldKt {
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m1315StandardBottomSheet8oydGBM(final androidx.compose.material3.SheetState r34, final float r35, final boolean r36, final float r37, final androidx.compose.ui.graphics.Shape r38, final long r39, final long r41, final float r43, final float r44, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r45, final kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.ColumnScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r46, androidx.compose.runtime.Composer r47, final int r48, final int r49) {
        /*
    ...
    public static final void m1314BottomSheetScaffoldLayoutPxNyym8(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final Function3<? super PaddingValues, ? super Composer, ? super Integer, Unit> function3, final Function3<? super Integer, ? super Composer, ? super Integer, Unit> function32, final Function2<? super Composer, ? super Integer, Unit> function22, final float sheetPeekHeight, final Function0<Float> function0, final SheetState sheetState, final long containerColor, final long contentColor, Composer $composer, final int $changed) {
        ...
        if (($dirty & 1533916891) != 306783378 || !$composer2.getSkipping()) {
            ...
            Object[] keys$iv = {function32, function0, function2, modifier, Color.m2937boximpl(containerColor), Color.m2937boximpl(contentColor), function3, Dp.m5214boximpl(sheetPeekHeight), function22, sheetState};
            ...
            if (invalid$iv || it$iv$iv == Composer.INSTANCE.getEmpty()) {
                ...
                value$iv$iv = new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$BottomSheetScaffoldLayout$1$1
                    ...
                    public final MeasureResult m1318invoke0kLqBqw(SubcomposeMeasureScope SubcomposeLayout, long constraints) {
                        ...
                        int layoutWidth = Constraints.m5172getMaxWidthimpl(constraints);
                        final int layoutHeight = Constraints.m5171getMaxHeightimpl(constraints);
                        ...
                        })).get(0).mo4184measureBRTryo0(looseConstraints);
                        ...
                        bodyConstraints = Constraints.m5162copyZbe2FdA(looseConstraints, (r12 & 1) != 0 ? Constraints.m5174getMinWidthimpl(looseConstraints) : 0, (r12 & 2) != 0 ? Constraints.m5172getMaxWidthimpl(looseConstraints) : 0, (r12 & 4) != 0 ? Constraints.m5173getMinHeightimpl(looseConstraints) : 0, (r12 & 8) != 0 ? Constraints.m5171getMaxHeightimpl(looseConstraints) : layoutHeight - topBarHeight);
                        ...
                        final Placeable bodyPlaceable = SubcomposeLayout.subcompose(bottomSheetScaffoldLayoutSlot2, ComposableLambdaKt.composableLambdaInstance(-1459220575, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$BottomSheetScaffoldLayout$1$1$bodyPlaceable$1
                            ...
                            public final void invoke(Composer $composer3, int $changed2) {
                                ...
                                if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                                    ...
                                    SurfaceKt.m1792SurfaceT9BRK9s(modifier3, null, j3, j4, 0.0f, 0.0f, null, ComposableLambdaKt.composableLambda($composer3, 1725620860, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$BottomSheetScaffoldLayout$1$1$bodyPlaceable$1.1
                                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                        /* JADX WARN: Multi-variable type inference failed */
                                        {
                                            super(2);
                                        ...
                                        public final void invoke(Composer $composer4, int $changed3) {
                                            ...
                                            function35.invoke(PaddingKt.m479PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, f2, 7, null), $composer4, Integer.valueOf((i4 >> 3) & 112));
                                            if (ComposerKt.isTraceInProgress()) {
                                                ComposerKt.traceEventEnd();
                                            }
                                        }
                        ...
                        })).get(0).mo4184measureBRTryo0(bodyConstraints);
                        final Placeable snackbarPlaceable = SubcomposeLayout.subcompose(BottomSheetScaffoldLayoutSlot.Snackbar, function22).get(0).mo4184measureBRTryo0(looseConstraints);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$BottomSheetScaffoldLayout$2
            ...
            public final void invoke(Composer composer, int i2) {
                BottomSheetScaffoldKt.m1314BottomSheetScaffoldLayoutPxNyym8(Modifier.this, function2, function3, function32, function22, sheetPeekHeight, function0, sheetState, containerColor, contentColor, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
