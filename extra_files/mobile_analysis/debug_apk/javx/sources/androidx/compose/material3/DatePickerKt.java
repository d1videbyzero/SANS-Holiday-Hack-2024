...
public final class DatePickerKt {
    ...
    private static final float RecommendedSizeForAccessibility = Dp.m5216constructorimpl(48);
    private static final float MonthYearHeight = Dp.m5216constructorimpl(56);
    private static final float DatePickerHorizontalPadding = Dp.m5216constructorimpl(12);
    private static final PaddingValues DatePickerModeTogglePadding = PaddingKt.m479PaddingValuesa9UjIt4$default(0.0f, 0.0f, Dp.m5216constructorimpl(12), Dp.m5216constructorimpl(12), 3, null);
    private static final PaddingValues DatePickerTitlePadding = PaddingKt.m479PaddingValuesa9UjIt4$default(Dp.m5216constructorimpl(24), Dp.m5216constructorimpl(16), Dp.m5216constructorimpl(12), 0.0f, 8, null);
    private static final PaddingValues DatePickerHeadlinePadding = PaddingKt.m479PaddingValuesa9UjIt4$default(Dp.m5216constructorimpl(24), 0.0f, Dp.m5216constructorimpl(12), Dp.m5216constructorimpl(12), 2, null);
    private static final float YearsVerticalPadding = Dp.m5216constructorimpl(16);
    ...
    public static final void DatePicker(final DatePickerState state, Modifier modifier, DatePickerFormatter dateFormatter, Function1<? super Long, Boolean> function1, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, boolean showModeToggle, DatePickerColors colors, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 23967451) == 4793490 && $composer2.getSkipping()) {
            ...
            final int i9 = $dirty;
            m1462DateEntryContainerau3_HiA(modifier2, title, headline, showModeToggle2 ? ComposableLambdaKt.composableLambda($composer2, -1702543532, z, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DatePicker$5
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                }
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        int m1468getDisplayModejFl4v0 = DatePickerState.this.m1468getDisplayModejFl4v0();
                        ...
                        if (invalid$iv$iv || it$iv$iv2 == Composer.INSTANCE.getEmpty()) {
                            value$iv$iv2 = new Function1<DisplayMode, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DatePicker$5$1$1
                                ...
                                public final void m1466invokevCnGnXg(int displayMode) {
                                    DatePickerState.this.getStateData().m1711switchDisplayModevCnGnXg(displayMode);
                                }
                            };
                        ...
                        DatePickerKt.m1464DisplayModeToggleButtontER2X8s(padding, m1468getDisplayModejFl4v0, (Function1) value$iv$iv2, $composer3, 6);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
    ...
    public static final void m1462DateEntryContainerau3_HiA(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final DatePickerColors colors, final TextStyle headlineTextStyle, final float headerMinHeight, final Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed) {
        ...
        if ((23967451 & $dirty2) != 4793490 || !$composer2.getSkipping()) {
            ...
            Modifier modifier$iv = SemanticsModifierKt.semantics$default(SizeKt.m533sizeInqDBjuR0$default(modifier, DatePickerModalTokens.INSTANCE.m2101getContainerWidthD9Ej5fM(), 0.0f, 0.0f, 0.0f, 14, null), false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DateEntryContainer$1
                @Override // kotlin.jvm.functions.Function1
                            ...
                            TextKt.ProvideTextStyle(textStyle, ComposableLambdaKt.composableLambda($composer3, -962031352, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DateEntryContainer$2$1$1$1$1
                                ...
                                public final void invoke(Composer $composer4, int $changed3) {
                                    ...
                                    if (($changed3 & 11) != 2 || !$composer4.getSkipping()) {
                                        ...
                                        skippableUpdate$iv$iv$iv4.invoke(SkippableUpdater.m2572boximpl(SkippableUpdater.m2573constructorimpl($composer4)), $composer4, Integer.valueOf(($changed$iv$iv$iv4 >> 3) & 112));
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DateEntryContainer$3
            ...
            public final void invoke(Composer composer, int i3) {
                DatePickerKt.m1462DateEntryContainerau3_HiA(Modifier.this, function2, function22, function23, colors, headlineTextStyle, headerMinHeight, content, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
    ...
    public static final void m1464DisplayModeToggleButtontER2X8s(final Modifier modifier, final int displayMode, final Function1<? super DisplayMode, Unit> onDisplayModeChange, Composer $composer, final int $changed) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DisplayModeToggleButton$3
            ...
            public final void invoke(Composer composer, int i3) {
                DatePickerKt.m1464DisplayModeToggleButtontER2X8s(Modifier.this, displayMode, onDisplayModeChange, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
    ...
    public static final void SwitchableDateEntryContent(final DatePickerState state, final DatePickerFormatter dateFormatter, final Function1<? super Long, Boolean> function1, final DatePickerColors colors, Composer $composer, final int $changed) {
        ...
        if (($dirty & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            int m1468getDisplayModejFl4v0 = state.m1468getDisplayModejFl4v0();
            final int i = $dirty;
            CrossfadeKt.Crossfade(DisplayMode.m1484boximpl(m1468getDisplayModejFl4v0), SemanticsModifierKt.semantics$default(Modifier.INSTANCE, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt$SwitchableDateEntryContent$1
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ Unit invoke(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                    invoke2(semanticsPropertyReceiver);
                    return Unit.INSTANCE;
    ...
    */
    ...
    public static final void m1463DatePickerHeaderpc5RIQQ(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final long titleContentColor, final long headlineContentColor, final float minHeight, final Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed) {
        ...
        if ((374491 & $dirty2) != 74898 || !$composer2.getSkipping()) {
            ...
            if (function2 != null) {
                heightModifier = SizeKt.m514defaultMinSizeVpY3zN4$default(Modifier.INSTANCE, 0.0f, minHeight, 1, null);
            } else {
                            ...
                            TextKt.ProvideTextStyle(textStyle, ComposableLambdaKt.composableLambda($composer3, -2006650069, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DatePickerHeader$1$1.1
                                ...
                                public final void invoke(Composer $composer4, int $changed3) {
                                    ...
                                    if (($changed3 & 11) != 2 || !$composer4.getSkipping()) {
                                        ...
                                        Updater.m2588setimpl($this$Layout_u24lambda_u2d0$iv$iv2, viewConfiguration$iv$iv2, ComposeUiNode.INSTANCE.getSetViewConfiguration());
                                        $composer4.enableReusing();
                                        skippableUpdate$iv$iv$iv2.invoke(SkippableUpdater.m2572boximpl(SkippableUpdater.m2573constructorimpl($composer4)), $composer4, Integer.valueOf(($changed$iv$iv$iv2 >> 3) & 112));
                                        $composer4.startReplaceableGroup(2058660585);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DatePickerHeader$2
            ...
            public final void invoke(Composer composer, int i3) {
                DatePickerKt.m1463DatePickerHeaderpc5RIQQ(Modifier.this, function2, titleContentColor, headlineContentColor, minHeight, content, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        if (Color.m2948equalsimpl0(colors.getContainerColor(), MaterialTheme.INSTANCE.getColorScheme($composer3, 6).m1376getSurface0d7_KjU())) {
                            ...
                            ComposerKt.sourceInformationMarkerEnd($composer3);
                            containerColor = ColorSchemeKt.m1417surfaceColorAtElevation3ABfNKs(colorScheme, ((Dp) consume).m5230unboximpl());
                        } else {
                        ...
                        Modifier semantics$default = SemanticsModifierKt.semantics$default(BackgroundKt.m161backgroundbw27NRU$default(modifier, containerColor, null, 2, null), false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt$YearPicker$1.1
                            @Override // kotlin.jvm.functions.Function1
                            public /* bridge */ /* synthetic */ Unit invoke(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                                invoke2(semanticsPropertyReceiver);
                                return Unit.INSTANCE;
                        ...
                        final int i2 = i;
                        final DatePickerColors datePickerColors = colors;
                        LazyGridDslKt.LazyVerticalGrid(fixed, semantics$default, lazyGridState, null, false, arrangement.m393spacedBy0680j_4(f), spaceEvenly, null, false, new Function1<LazyGridScope, Unit>() { // from class: androidx.compose.material3.DatePickerKt$YearPicker$1.2
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            {
                                super(1);
    ...
    */
    ...
    public static final void MonthsNavigation(final Modifier modifier, final boolean nextAvailable, final boolean previousAvailable, final boolean yearPickerVisible, final String yearPickerText, final Function0<Unit> function0, final Function0<Unit> function02, final Function0<Unit> function03, Composer $composer, final int $changed) {
        ...
        if ((23967451 & $dirty3) != 4793490 || !$composer2.getSkipping()) {
            ...
            Modifier modifier$iv = SizeKt.m518requiredHeight3ABfNKs(SizeKt.fillMaxWidth$default(modifier, 0.0f, 1, null), MonthYearHeight);
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        if (invalid$iv$iv || it$iv$iv == Composer.INSTANCE.getEmpty()) {
                            value$iv$iv = new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt$MonthsNavigation$1$1$1$1
                                ...
                                public final void invoke2(SemanticsPropertyReceiver semantics) {
                                    Intrinsics.checkNotNullParameter(semantics, "$this$semantics");
                                    SemanticsPropertiesKt.m4579setLiveRegionhR3wRGc(semantics, LiveRegionMode.INSTANCE.m4558getPolite0phEisY());
            ...
            ButtonKt.TextButton(function0, modifier4, false, RoundedCornerShapeKt.getCircleShape(), ButtonDefaults.INSTANCE.m1331textButtonColorsro_MJ88(0L, MaterialTheme.INSTANCE.getColorScheme($composer2, 6).m1366getOnSurfaceVariant0d7_KjU(), 0L, 0L, $composer2, 24576, 13), null, null, null, null, ComposableLambdaKt.composableLambda($composer2, 1899012021, true, new Function3<RowScope, Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$YearPickerMenuButton$1
                ...
                public final void invoke(RowScope TextButton, Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 81) != 16 || !$composer3.getSkipping()) {
                        ...
                        SpacerKt.Spacer(SizeKt.m529size3ABfNKs(Modifier.INSTANCE, ButtonDefaults.INSTANCE.m1327getIconSpacingD9Ej5fM()), $composer3, 6);
                        ...
                        if (expanded) {
                            ...
                            String m1783getStringNWtq28 = Strings_androidKt.m1783getStringNWtq28(Strings.INSTANCE.m1742getDatePickerSwitchToDaySelectionadMyvUU(), $composer3, 6);
                            $composer3.endReplaceableGroup();
                            str = m1783getStringNWtq28;
                        } else {
                            $composer3.startReplaceableGroup(1071182591);
                            ComposerKt.sourceInformation($composer3, "1852@75759L50");
                            String m1783getStringNWtq282 = Strings_androidKt.m1783getStringNWtq28(Strings.INSTANCE.m1746getDatePickerSwitchToYearSelectionadMyvUU(), $composer3, 6);
                            $composer3.endReplaceableGroup();
                            str = m1783getStringNWtq282;
                        }
