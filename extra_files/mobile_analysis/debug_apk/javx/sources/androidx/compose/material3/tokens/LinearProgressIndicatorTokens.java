...
public final class LinearProgressIndicatorTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m5216constructorimpl((float) 4.0d);
    ...
    private static final float TrackHeight = Dp.m5216constructorimpl((float) 4.0d);
