...
final class PopupLayout extends AbstractComposeView implements ViewRootForInspector, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    */
    ...
    public final void updatePosition() {
        IntSize m1997getPopupContentSizebOM6tXw;
        IntRect parentBounds = getParentBounds();
        if (parentBounds == null || (m1997getPopupContentSizebOM6tXw = m1997getPopupContentSizebOM6tXw()) == null) {
            return;
        }
        long popupContentSize = m1997getPopupContentSizebOM6tXw.getPackedValue();
