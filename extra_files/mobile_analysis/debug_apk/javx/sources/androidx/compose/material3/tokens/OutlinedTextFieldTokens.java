...
public final class OutlinedTextFieldTokens {
    ...
    private static final float DisabledOutlineWidth = Dp.m5216constructorimpl((float) 1.0d);
    ...
    private static final float FocusOutlineWidth = Dp.m5216constructorimpl((float) 2.0d);
    ...
    private static final float HoverOutlineWidth = Dp.m5216constructorimpl((float) 1.0d);
    ...
    private static final float LeadingIconSize = Dp.m5216constructorimpl((float) 24.0d);
    private static final ColorSchemeKeyTokens OutlineColor = ColorSchemeKeyTokens.Outline;
    private static final float OutlineWidth = Dp.m5216constructorimpl((float) 1.0d);
