...
public final class InputChipTokens {
    ...
    private static final float ContainerHeight = Dp.m5216constructorimpl((float) 32.0d);
    ...
    private static final float UnselectedOutlineWidth = Dp.m5216constructorimpl((float) 1.0d);
    ...
    private static final float AvatarSize = Dp.m5216constructorimpl((float) 24.0d);
    private static final ColorSchemeKeyTokens DisabledLeadingIconColor = ColorSchemeKeyTokens.OnSurface;
    private static final float LeadingIconSize = Dp.m5216constructorimpl((float) 18.0d);
    ...
    private static final float TrailingIconSize = Dp.m5216constructorimpl((float) 18.0d);
