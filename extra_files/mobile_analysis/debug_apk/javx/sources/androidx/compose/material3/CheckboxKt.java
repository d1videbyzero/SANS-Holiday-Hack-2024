...
public final class CheckboxKt {
    ...
    private static final float CheckboxDefaultPadding = Dp.m5216constructorimpl(2);
    private static final float CheckboxSize = Dp.m5216constructorimpl(20);
    private static final float StrokeWidth = Dp.m5216constructorimpl(2);
    private static final float RadiusSize = Dp.m5216constructorimpl(2);
    ...
    public static final void TriStateCheckbox(final ToggleableState state, final Function0<Unit> function0, Modifier modifier, boolean enabled, CheckboxColors colors, MutableInteractionSource interactionSource, Composer $composer, final int $changed, final int i) {
        ...
        if ((374491 & $dirty3) == 74898 && $composer2.getSkipping()) {
            ...
            if (function0 != null) {
                ...
                int m4567getCheckboxo7Vup1c = Role.INSTANCE.m4567getCheckboxo7Vup1c();
                float arg0$iv = CheckboxTokens.INSTANCE.m2025getStateLayerSizeD9Ej5fM();
                $dirty2 = $dirty;
                companion = ToggleableKt.m714triStateToggleableO2vRcR0(companion2, state, interactionSource2, RippleKt.m1284rememberRipple9IZ8Weo(false, Dp.m5216constructorimpl(arg0$iv / 2), 0L, $composer2, 54, 4), enabled2, Role.m4559boximpl(m4567getCheckboxo7Vup1c), function0);
            } else {
                $dirty2 = $dirty;
            ...
            CheckboxImpl(enabled2, state, PaddingKt.m482padding3ABfNKs(modifier3.then(function0 != null ? InteractiveComponentSizeKt.minimumInteractiveComponentSize(Modifier.INSTANCE) : Modifier.INSTANCE).then(toggleableModifier), CheckboxDefaultPadding), colors3, $composer2, (($dirty2 >> 9) & 14) | (($dirty2 << 3) & 112) | (($dirty2 >> 3) & 7168));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
        ...
        if (($dirty2 & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            switch (WhenMappings.$EnumSwitchMapping$0[it4.ordinal()]) {
                ...
                case 2:
                    ...
                    Modifier m521requiredSize3ABfNKs = SizeKt.m521requiredSize3ABfNKs(SizeKt.wrapContentSize$default(modifier, Alignment.INSTANCE.getCenter(), false, 2, null), CheckboxSize);
                    ...
                    if (invalid$iv || value$iv$iv2 == Composer.INSTANCE.getEmpty()) {
                        value$iv$iv2 = new Function1<DrawScope, Unit>() { // from class: androidx.compose.material3.CheckboxKt$CheckboxImpl$1$1
                            ...
                            public final void invoke2(DrawScope Canvas) {
                                ...
                                long m2957unboximpl = boxColor.getValue().m2957unboximpl();
                                long m2957unboximpl2 = borderColor.getValue().m2957unboximpl();
                                f6 = CheckboxKt.RadiusSize;
                                CheckboxKt.m1341drawBox1wkBAMs(Canvas, m2957unboximpl, m2957unboximpl2, Canvas.mo327toPx0680j_4(f6), strokeWidthPx);
                                CheckboxKt.m1342drawCheck3IgeMak(Canvas, checkColor.getValue().m2957unboximpl(), checkDrawFraction.getValue().floatValue(), checkCenterGravitationShiftFraction.getValue().floatValue(), strokeWidthPx, checkCache);
                            }
                        };
                        $composer2.updateRememberedValue(value$iv$iv2);
                    }
                    $composer2.endReplaceableGroup();
                    CanvasKt.Canvas(m521requiredSize3ABfNKs, (Function1) value$iv$iv2, $composer2, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                        break;
                    }
    ...
    public static final void m1341drawBox1wkBAMs(DrawScope $this$drawBox_u2d1wkBAMs, long boxColor, long borderColor, float radius, float strokeWidth) {
        ...
        float checkboxSize = Size.m2777getWidthimpl($this$drawBox_u2d1wkBAMs.mo3490getSizeNHjbRc());
        if (Color.m2948equalsimpl0(boxColor, borderColor)) {
            DrawScope.m3487drawRoundRectuAw5IA$default($this$drawBox_u2d1wkBAMs, boxColor, 0L, androidx.compose.ui.geometry.SizeKt.Size(checkboxSize, checkboxSize), CornerRadiusKt.CornerRadius$default(radius, 0.0f, 2, null), Fill.INSTANCE, 0.0f, null, 0, 226, null);
            return;
        }
        float f = 2;
        DrawScope.m3487drawRoundRectuAw5IA$default($this$drawBox_u2d1wkBAMs, boxColor, OffsetKt.Offset(strokeWidth, strokeWidth), androidx.compose.ui.geometry.SizeKt.Size(checkboxSize - (strokeWidth * f), checkboxSize - (f * strokeWidth)), CornerRadiusKt.CornerRadius$default(Math.max(0.0f, radius - strokeWidth), 0.0f, 2, null), Fill.INSTANCE, 0.0f, null, 0, 224, null);
    ...
    public static final void m1342drawCheck3IgeMak(DrawScope $this$drawCheck_u2d3IgeMak, long checkColor, float checkFraction, float crossCenterGravitation, float strokeWidthPx, CheckDrawingCache drawingCache) {
        Stroke stroke = new Stroke(strokeWidthPx, 0.0f, StrokeCap.INSTANCE.m3295getSquareKaPHkGw(), 0, null, 26, null);
        float width = Size.m2777getWidthimpl($this$drawCheck_u2d3IgeMak.mo3490getSizeNHjbRc());
        ...
        DrawScope.m3481drawPathLG529CI$default($this$drawCheck_u2d3IgeMak, drawingCache.getPathToDraw(), checkColor, 0.0f, stroke, null, 0, 52, null);
    }
}
