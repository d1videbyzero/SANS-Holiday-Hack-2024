...
final /* data */ class RichTooltipPositionProvider implements PopupPositionProvider {
    ...
    public long mo876calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        ...
        if (IntSize.m5376getWidthimpl(popupContentSize) + x > IntSize.m5376getWidthimpl(windowSize) && (x = anchorBounds.getLeft() - IntSize.m5376getWidthimpl(popupContentSize)) < 0) {
            x = anchorBounds.getLeft() + ((anchorBounds.getWidth() - IntSize.m5376getWidthimpl(popupContentSize)) / 2);
        }
        int y = (anchorBounds.getTop() - IntSize.m5375getHeightimpl(popupContentSize)) - this.tooltipAnchorPadding;
        if (y < 0) {
