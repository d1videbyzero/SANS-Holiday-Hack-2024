...
public final class AndroidAlertDialog_androidKt {
    private static final float ButtonsMainAxisSpacing = Dp.m5216constructorimpl(8);
    private static final float ButtonsCrossAxisSpacing = Dp.m5216constructorimpl(12);
    ...
    public static final void m1293AlertDialogOix01E0(final Function0<Unit> onDismissRequest, final Function2<? super Composer, ? super Integer, Unit> confirmButton, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, Function2<? super Composer, ? super Integer, Unit> function23, Function2<? super Composer, ? super Integer, Unit> function24, Shape shape, long containerColor, long iconContentColor, long titleContentColor, long textContentColor, float tonalElevation, DialogProperties properties, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (($dirty2 & 1533916891) == 306783378 && ($dirty12 & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                float tonalElevation3 = i12 != 0 ? AlertDialogDefaults.INSTANCE.m1290getTonalElevationD9Ej5fM() : tonalElevation;
                if (i13 != 0) {
            ...
            AlertDialog(onDismissRequest, modifier2, properties2, ComposableLambdaKt.composableLambda($composer2, 741647174, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AndroidAlertDialog_androidKt$AlertDialog$1
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        AlertDialogKt.m1291AlertDialogContent4hvqGtA(ComposableLambdaKt.composableLambda($composer3, -1873210524, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AndroidAlertDialog_androidKt$AlertDialog$1.1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            {
                                super(2);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AndroidAlertDialog_androidKt$AlertDialog$2
            ...
            public final void invoke(Composer composer, int i17) {
                AndroidAlertDialog_androidKt.m1293AlertDialogOix01E0(onDismissRequest, confirmButton, modifier6, function29, function210, function211, function212, shape5, j5, j6, j7, j8, f2, dialogProperties, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
            }
        });
    }
            ...
            AndroidDialog_androidKt.Dialog(onDismissRequest, properties3, ComposableLambdaKt.composableLambda($composer2, 823217604, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AndroidAlertDialog_androidKt$AlertDialog$3
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        Modifier m533sizeInqDBjuR0$default = SizeKt.m533sizeInqDBjuR0$default(Modifier.this, AlertDialogKt.getDialogMinWidth(), 0.0f, AlertDialogKt.getDialogMaxWidth(), 0.0f, 10, null);
                        ...
                        Modifier modifier$iv = m533sizeInqDBjuR0$default.then(SemanticsModifierKt.semantics$default(companion, false, (Function1) value$iv$iv, 1, null));
