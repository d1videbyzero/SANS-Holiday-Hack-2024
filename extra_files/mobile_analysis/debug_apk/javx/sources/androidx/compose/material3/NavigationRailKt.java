...
public final class NavigationRailKt {
    ...
    private static final float NavigationRailVerticalPadding = Dp.m5216constructorimpl(4);
    private static final float NavigationRailHeaderPadding = Dp.m5216constructorimpl(8);
    ...
    private static final float NavigationRailItemVerticalPadding = Dp.m5216constructorimpl(4);
    ...
    */
    ...
    public static final void NavigationRailItemBaselineLayout(final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final Function2<? super Composer, ? super Integer, Unit> function24, final boolean alwaysShowLabel, final float animationProgress, Composer $composer, final int $changed) {
        ...
        if ((374491 & $dirty2) != 74898 || !$composer3.getSkipping()) {
            ...
            MeasurePolicy measurePolicy$iv = new MeasurePolicy() { // from class: androidx.compose.material3.NavigationRailKt$NavigationRailItemBaselineLayout$2
                ...
                public final MeasureResult mo13measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> list, long constraints) {
                    float arg0$iv;
                    int totalIndicatorWidth;
                    Object element$iv;
                    Placeable labelPlaceable;
                    MeasureResult m1632placeLabelAndIconzUg2_y0;
                    MeasureResult m1631placeIconX9ElhV4;
                    ...
                    for (Object element$iv2 : measurables) {
                        ...
                        if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it), "icon")) {
                            Placeable iconPlaceable = ((Measurable) element$iv2).mo4184measureBRTryo0(constraints);
                            int width = iconPlaceable.getWidth();
                            arg0$iv = NavigationRailKt.IndicatorHorizontalPadding;
                            int totalIndicatorWidth2 = width + Layout.mo321roundToPx0680j_4(Dp.m5216constructorimpl(2 * arg0$iv));
                            ...
                            int other$iv = Layout.mo321roundToPx0680j_4(Dp.m5216constructorimpl(2 * indicatorVerticalPadding));
                            ...
                            for (Object element$iv3 : $this$first$iv) {
                                ...
                                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it2), "indicatorRipple")) {
                                    Placeable indicatorRipplePlaceable = ((Measurable) element$iv3).mo4184measureBRTryo0(Constraints.INSTANCE.m5180fixedJhjzzOo(totalIndicatorWidth2, indicatorHeight));
                                    ...
                                    Placeable indicatorPlaceable = measurable != null ? measurable.mo4184measureBRTryo0(Constraints.INSTANCE.m5180fixedJhjzzOo(animatedIndicatorWidth, indicatorHeight)) : null;
                                    ...
                                    if (it5 != null) {
                                        ...
                                        for (Object element$iv4 : $this$first$iv3) {
                                            ...
                                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it6), "label")) {
                                                ...
                                                labelPlaceable = ((Measurable) element$iv4).mo4184measureBRTryo0(m5162copyZbe2FdA);
                                            } else {
                                                it5 = it7;
                                    ...
                                    labelPlaceable = null;
                                    if (function24 == null) {
                                        m1631placeIconX9ElhV4 = NavigationRailKt.m1631placeIconX9ElhV4($this$Layout, iconPlaceable, indicatorRipplePlaceable, indicatorPlaceable, constraints);
                                        return m1631placeIconX9ElhV4;
                                    }
                                    Intrinsics.checkNotNull(labelPlaceable);
                                    m1632placeLabelAndIconzUg2_y0 = NavigationRailKt.m1632placeLabelAndIconzUg2_y0($this$Layout, labelPlaceable, iconPlaceable, indicatorRipplePlaceable, indicatorPlaceable, constraints, alwaysShowLabel, animationProgress);
                                    return m1632placeLabelAndIconzUg2_y0;
                                }
                                measurables = list;
    ...
    public static final MeasureResult m1631placeIconX9ElhV4(MeasureScope $this$placeIcon_u2dX9ElhV4, final Placeable iconPlaceable, final Placeable indicatorRipplePlaceable, final Placeable indicatorPlaceable, long constraints) {
        final int width = ConstraintsKt.m5186constrainWidthK40F9xA(constraints, Math.max(iconPlaceable.getWidth(), Math.max(indicatorRipplePlaceable.getWidth(), indicatorPlaceable != null ? indicatorPlaceable.getWidth() : 0)));
        final int height = Constraints.m5171getMaxHeightimpl(constraints);
    ...
    public static final MeasureResult m1632placeLabelAndIconzUg2_y0(final MeasureScope $this$placeLabelAndIcon_u2dzUg2_y0, final Placeable labelPlaceable, final Placeable iconPlaceable, final Placeable indicatorRipplePlaceable, final Placeable indicatorPlaceable, long constraints, final boolean alwaysShowLabel, final float animationProgress) {
        int height = Constraints.m5171getMaxHeightimpl(constraints);
        final int labelY = (height - labelPlaceable.getHeight()) - $this$placeLabelAndIcon_u2dzUg2_y0.mo321roundToPx0680j_4(NavigationRailItemVerticalPadding);
        final int selectedIconY = $this$placeLabelAndIcon_u2dzUg2_y0.mo321roundToPx0680j_4(NavigationRailItemVerticalPadding);
        ...
        final int width = ConstraintsKt.m5186constrainWidthK40F9xA(constraints, Math.max(iconPlaceable.getWidth(), Math.max(labelPlaceable.getWidth(), indicatorPlaceable != null ? indicatorPlaceable.getWidth() : 0)));
    ...
    static {
        ...
        IndicatorHorizontalPadding = Dp.m5216constructorimpl(Dp.m5216constructorimpl(arg0$iv - other$iv) / 2);
        ...
        IndicatorVerticalPaddingWithLabel = Dp.m5216constructorimpl(Dp.m5216constructorimpl(arg0$iv2 - other$iv2) / 2);
        ...
        IndicatorVerticalPaddingNoLabel = Dp.m5216constructorimpl(Dp.m5216constructorimpl(arg0$iv3 - other$iv3) / 2);
    }
