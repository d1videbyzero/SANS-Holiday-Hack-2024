...
public final class DatePickerColors {
    ...
    public final State<Color> dayContentColor$material3_release(boolean isToday, boolean selected, boolean inRange, boolean enabled, Composer $composer, int $changed) {
        ...
        if (inRange) {
            ...
            m70animateColorAsStateeuL9pac = SnapshotStateKt.rememberUpdatedState(Color.m2937boximpl(target), $composer, 0);
            $composer.endReplaceableGroup();
        } else {
            $composer.startReplaceableGroup(379006329);
            ComposerKt.sourceInformation($composer, "596@26492L134");
            m70animateColorAsStateeuL9pac = SingleValueAnimationKt.m70animateColorAsStateeuL9pac(target, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, $composer, 0, 12);
            $composer.endReplaceableGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> dayContainerColor$material3_release(boolean selected, boolean enabled, boolean animate, Composer $composer, int $changed) {
        ...
        if (animate) {
            ...
            rememberUpdatedState = SingleValueAnimationKt.m70animateColorAsStateeuL9pac(target, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, $composer, 0, 12);
            $composer.endReplaceableGroup();
        } else {
    ...
    public final State<Color> yearContentColor$material3_release(boolean currentYear, boolean selected, Composer $composer, int $changed) {
        ...
        State<Color> m70animateColorAsStateeuL9pac = SingleValueAnimationKt.m70animateColorAsStateeuL9pac(target, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, $composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
