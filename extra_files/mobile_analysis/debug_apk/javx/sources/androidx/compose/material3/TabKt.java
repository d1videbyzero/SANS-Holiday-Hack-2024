...
public final class TabKt {
    ...
    private static final float LargeTabHeight = Dp.m5216constructorimpl(72);
    private static final float HorizontalTextPadding = Dp.m5216constructorimpl(16);
    private static final float SingleLineTextBaselineWithIcon = Dp.m5216constructorimpl(14);
    private static final float DoubleLineTextBaselineWithIcon = Dp.m5216constructorimpl(6);
    private static final long IconDistanceFromBaseline = TextUnitKt.getSp(20);
    private static final float TextDistanceFromLeadingIcon = Dp.m5216constructorimpl(8);
    ...
    public static final void m1819TabwqdebIU(final boolean selected, final Function0<Unit> onClick, Modifier modifier, boolean enabled, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, long selectedContentColor, long unselectedContentColor, MutableInteractionSource interactionSource, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty2 & 191739611) == 38347922 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if ((i & 64) != 0) {
                    ...
                    selectedContentColor2 = ((Color) consume).m2957unboximpl();
                    $dirty2 &= -3670017;
                } else {
                    modifier2 = modifier4;
            ...
            final Function2 styledText = text != null ? ComposableLambdaKt.composableLambda($composer3, 708874428, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabKt$Tab$styledText$1$1
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer4.getSkipping()) {
                        ...
                        TextStyle style = TextStyle.m4732copyCXVQc50$default(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography($composer4, 6), PrimaryNavigationTabTokens.INSTANCE.getLabelTextFont()), 0L, 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, TextAlign.m5081boximpl(TextAlign.INSTANCE.m5088getCentere0LSkKk()), null, 0L, null, null, null, null, null, 4177919, null);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabKt$Tab$3
            ...
            public final void invoke(Composer composer, int i9) {
                TabKt.m1819TabwqdebIU(selected, onClick, modifier5, z, function24, function25, j, j2, mutableInteractionSource, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
            ...
            m1820TabTransitionKlgxPg(selectedContentColor3, unselectedContentColor3, selected, ComposableLambdaKt.composableLambda($composer2, -429037564, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabKt$LeadingIconTab$2
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        Modifier m706selectableO2vRcR0 = SelectableKt.m706selectableO2vRcR0(SizeKt.m515height3ABfNKs(modifier5, f), selected, mutableInteractionSource, ripple, z, Role.m4559boximpl(Role.INSTANCE.m4572getTabo7Vup1c()), onClick);
                        f2 = TabKt.HorizontalTextPadding;
                        Modifier modifier$iv = SizeKt.fillMaxWidth$default(PaddingKt.m484paddingVpY3zN4$default(m706selectableO2vRcR0, f2, 0.0f, 2, null), 0.0f, 1, null);
                        ...
                        SpacerKt.Spacer(SizeKt.m526requiredWidth3ABfNKs(companion, f3), $composer3, 6);
                        TextStyle style = TextStyle.m4732copyCXVQc50$default(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography($composer3, 6), PrimaryNavigationTabTokens.INSTANCE.getLabelTextFont()), 0L, 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, TextAlign.m5081boximpl(TextAlign.INSTANCE.m5088getCentere0LSkKk()), null, 0L, null, null, null, null, null, 4177919, null);
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m1820TabTransitionKlgxPg(final long r30, final long r32, final boolean r34, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r35, androidx.compose.runtime.Composer r36, final int r37) {
        /*
            Method dump skipped, instructions count: 591
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.TabKt.m1820TabTransitionKlgxPg(long, long, boolean, kotlin.jvm.functions.Function2, androidx.compose.runtime.Composer, int):void");
    }
    ...
    public static final void TabBaselineLayout(final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, Composer $composer, final int $changed) {
        ...
        if (($dirty & 91) != 18 || !$composer3.getSkipping()) {
            ...
            MeasurePolicy measurePolicy$iv = new MeasurePolicy() { // from class: androidx.compose.material3.TabKt$TabBaselineLayout$2
                ...
                public final MeasureResult mo13measure3p2s80s(final MeasureScope Layout, List<? extends Measurable> measurables, long constraints) {
                    Placeable placeable;
                    ...
                    if (function2 == null) {
                        ...
                        for (Object element$iv : $this$first$iv) {
                            ...
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it), "text")) {
                                ...
                                placeable = ((Measurable) element$iv).mo4184measureBRTryo0(m5162copyZbe2FdA);
                            }
                        }
                    ...
                    if (function22 != null) {
                        ...
                        for (Object element$iv2 : $this$first$iv2) {
                            ...
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it2), "icon")) {
                                placeable2 = ((Measurable) element$iv2).mo4184measureBRTryo0(constraints);
                            }
                        }
                        throw new NoSuchElementException("Collection contains no element matching the predicate.");
                    }
            ...
            if (function2 == null) {
                ...
                Modifier modifier$iv2 = PaddingKt.m484paddingVpY3zN4$default(LayoutIdKt.layoutId(Modifier.INSTANCE, "text"), HorizontalTextPadding, 0.0f, 2, null);
    ...
    public static final void placeTextAndIcon(Placeable.PlacementScope $this$placeTextAndIcon, Density density, Placeable textPlaceable, Placeable iconPlaceable, int tabWidth, int tabHeight, int firstBaseline, int lastBaseline) {
        ...
        int textOffset = density.mo321roundToPx0680j_4(baselineOffset) + density.mo321roundToPx0680j_4(PrimaryNavigationTabTokens.INSTANCE.m2410getActiveIndicatorHeightD9Ej5fM());
