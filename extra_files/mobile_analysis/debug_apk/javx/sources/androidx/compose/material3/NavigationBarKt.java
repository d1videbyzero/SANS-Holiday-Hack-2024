...
public final class NavigationBarKt {
    ...
    private static final float NavigationBarItemHorizontalPadding = Dp.m5216constructorimpl(8);
    private static final float NavigationBarItemVerticalPadding = Dp.m5216constructorimpl(16);
    ...
    */
        ...
        if ((374491 & $dirty2) != 74898 || !$composer3.getSkipping()) {
            ...
            MeasurePolicy measurePolicy$iv = new MeasurePolicy() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItemBaselineLayout$2
                ...
                public final MeasureResult mo13measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> list, long constraints) {
                    ...
                    MeasureResult m1613placeLabelAndIconzUg2_y0;
                    MeasureResult m1612placeIconX9ElhV4;
                    ...
                    for (Object element$iv2 : measurables) {
                        ...
                        if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it), "icon")) {
                            ...
                            int indicatorHeight = height + Layout.mo321roundToPx0680j_4(Dp.m5216constructorimpl(2 * arg0$iv2));
                            ...
                            for (Object element$iv3 : $this$first$iv) {
                                ...
                                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it2), "indicatorRipple")) {
                                    ...
                                    labelPlaceable = null;
                                    if (function24 == null) {
                                        m1612placeIconX9ElhV4 = NavigationBarKt.m1612placeIconX9ElhV4($this$Layout, iconPlaceable, indicatorRipplePlaceable, indicatorPlaceable, constraints);
                                        return m1612placeIconX9ElhV4;
                                    }
                                    Intrinsics.checkNotNull(labelPlaceable);
                                    m1613placeLabelAndIconzUg2_y0 = NavigationBarKt.m1613placeLabelAndIconzUg2_y0($this$Layout, labelPlaceable, iconPlaceable, indicatorRipplePlaceable, indicatorPlaceable, constraints, alwaysShowLabel, animationProgress);
                                    return m1613placeLabelAndIconzUg2_y0;
                                }
                                measurables = list;
            ...
            if (function24 != null) {
                ...
                Modifier modifier$iv3 = PaddingKt.m484paddingVpY3zN4$default(alpha, Dp.m5216constructorimpl(arg0$iv / 2), 0.0f, 2, null);
                $composer3.startReplaceableGroup(733328855);
                ComposerKt.sourceInformation($composer3, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
    ...
    public static final MeasureResult m1612placeIconX9ElhV4(MeasureScope $this$placeIcon_u2dX9ElhV4, final Placeable iconPlaceable, final Placeable indicatorRipplePlaceable, final Placeable indicatorPlaceable, long constraints) {
        final int width = Constraints.m5172getMaxWidthimpl(constraints);
    ...
    public static final MeasureResult m1613placeLabelAndIconzUg2_y0(final MeasureScope $this$placeLabelAndIcon_u2dzUg2_y0, final Placeable labelPlaceable, final Placeable iconPlaceable, final Placeable indicatorRipplePlaceable, final Placeable indicatorPlaceable, long constraints, final boolean alwaysShowLabel, final float animationProgress) {
        ...
        final int labelY = (height - labelPlaceable.getHeight()) - $this$placeLabelAndIcon_u2dzUg2_y0.mo321roundToPx0680j_4(NavigationBarItemVerticalPadding);
        final int selectedIconY = $this$placeLabelAndIcon_u2dzUg2_y0.mo321roundToPx0680j_4(NavigationBarItemVerticalPadding);
        ...
        final int containerWidth = Constraints.m5172getMaxWidthimpl(constraints);
    ...
    static {
        ...
        IndicatorVerticalPadding = Dp.m5216constructorimpl(Dp.m5216constructorimpl(arg0$iv2 - other$iv2) / 2);
        IndicatorVerticalOffset = Dp.m5216constructorimpl(12);
    }
