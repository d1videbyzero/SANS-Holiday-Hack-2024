...
public final class NavigationBarTokens {
    ...
    private static final float ActiveIndicatorWidth = Dp.m5216constructorimpl((float) 64.0d);
    ...
    private static final float ContainerHeight = Dp.m5216constructorimpl((float) 80.0d);
