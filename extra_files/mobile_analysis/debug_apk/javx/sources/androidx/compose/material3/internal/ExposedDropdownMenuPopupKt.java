        ...
        if ((i6 & 731) == 146 && startRestartGroup.getSkipping()) {
                        ...
                        if (($changed & 11) != 2 || !$composer.getSkipping()) {
                            ...
                            Modifier modifier$iv = AlphaKt.alpha(OnRemeasuredModifierKt.onSizeChanged(semantics$default, new Function1<IntSize, Unit>() { // from class: androidx.compose.material3.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$popupLayout$1$1$1.2
                                ...
                                public final void m1996invokeozmzZPI(long it) {
                                    PopupLayout.this.m1998setPopupContentSizefhxjrPA(IntSize.m5368boximpl(it));
                            ...
                            skippableUpdate$iv$iv$iv.invoke(SkippableUpdater.m2572boximpl(SkippableUpdater.m2573constructorimpl($composer)), $composer, Integer.valueOf(($changed$iv$iv$iv >> 3) & 112));
            ...
            Modifier onGloballyPositioned = OnGloballyPositionedModifierKt.onGloballyPositioned(Modifier.INSTANCE, new Function1<LayoutCoordinates, Unit>() { // from class: androidx.compose.material3.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$5
                ...
                public final void invoke2(LayoutCoordinates childCoordinates) {
                    ...
                    long layoutSize = coordinates.mo4191getSizeYbymL2g();
                    ...
                    PopupLayout.this.setParentBounds(IntRectKt.m5366IntRectVbeCjmY(layoutPosition, layoutSize));
                    PopupLayout.this.updatePosition();
                }
            });
            ...
            Composer m2581constructorimpl = Updater.m2581constructorimpl(composer4);
            Updater.m2588setimpl(m2581constructorimpl, measurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            Updater.m2588setimpl(m2581constructorimpl, density2, ComposeUiNode.INSTANCE.getSetDensity());
            Updater.m2588setimpl(m2581constructorimpl, layoutDirection3, ComposeUiNode.INSTANCE.getSetLayoutDirection());
            Updater.m2588setimpl(m2581constructorimpl, viewConfiguration, ComposeUiNode.INSTANCE.getSetViewConfiguration());
            materializerOf.invoke(SkippableUpdater.m2572boximpl(SkippableUpdater.m2573constructorimpl(composer4)), composer4, Integer.valueOf((i7 >> 3) & 112));
