...
public final class TimePickerKt {
    ...
    private static final float OuterCircleSizeRadius = Dp.m5216constructorimpl(101);
    private static final float InnerCircleRadius = Dp.m5216constructorimpl(69);
    private static final float ClockDisplayBottomMargin = Dp.m5216constructorimpl(36);
    private static final float ClockFaceBottomMargin = Dp.m5216constructorimpl(24);
    private static final float DisplaySeparatorWidth = Dp.m5216constructorimpl(24);
    private static final float SupportLabelTop = Dp.m5216constructorimpl(7);
    private static final float TimeInputBottomPadding = Dp.m5216constructorimpl(24);
    private static final float MaxDistance = Dp.m5216constructorimpl(74);
    private static final float MinimumInteractiveSize = Dp.m5216constructorimpl(48);
    ...
    public static final void m1885TimePickermT9BvqQ(final TimePickerState state, Modifier modifier, TimePickerColors colors, int layoutType, Composer $composer, final int $changed, final int i) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TimePickerKt$TimePicker$1
            ...
            public final void invoke(Composer composer, int i7) {
                TimePickerKt.m1885TimePickermT9BvqQ(TimePickerState.this, modifier5, timePickerColors2, i6, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    */
    ...
    public static final void VerticalTimePicker(final TimePickerState state, Modifier modifier, TimePickerColors colors, final boolean autoSwitchToMinute, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            SpacerKt.Spacer(SizeKt.m515height3ABfNKs(Modifier.INSTANCE, ClockDisplayBottomMargin), $composer2, 6);
            ClockFace(state, colors2, autoSwitchToMinute, $composer2, ($dirty & 14) | (($dirty >> 3) & 112) | (($dirty >> 3) & 896));
            SpacerKt.Spacer(SizeKt.m515height3ABfNKs(Modifier.INSTANCE, ClockFaceBottomMargin), $composer2, 6);
            ComposerKt.sourceInformationMarkerEnd($composer2);
            ComposerKt.sourceInformationMarkerEnd($composer2);
            $composer2.endReplaceableGroup();
            $composer2.endNode();
    ...
    public static final void HorizontalTimePicker(final TimePickerState state, Modifier modifier, TimePickerColors colors, final boolean autoSwitchToMinute, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            Modifier modifier$iv = PaddingKt.m486paddingqDBjuR0$default(modifier3, 0.0f, 0.0f, 0.0f, ClockFaceBottomMargin, 7, null);
            ...
            SpacerKt.Spacer(SizeKt.m534width3ABfNKs(Modifier.INSTANCE, ClockDisplayBottomMargin), $composer2, 6);
            ClockFace(state, colors2, autoSwitchToMinute, $composer2, ($dirty & 14) | (($dirty >> 3) & 112) | (($dirty >> 3) & 896));
            ComposerKt.sourceInformationMarkerEnd($composer2);
            ComposerKt.sourceInformationMarkerEnd($composer2);
            $composer2.endReplaceableGroup();
    ...
    public static final void TimeInputImpl(final Modifier modifier, final TimePickerColors colors, final TimePickerState state, Composer $composer, final int $changed) {
        ...
        if (($dirty2 & 731) == 146 && $composer4.getSkipping()) {
            ...
            $composer2 = $composer4;
            Modifier modifier$iv = PaddingKt.m486paddingqDBjuR0$default(modifier, 0.0f, 0.0f, 0.0f, TimeInputBottomPadding, 7, null);
            ...
            TextStyle textStyle = TextStyle.m4732copyCXVQc50$default(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography($composer2, 6), TimeInputTokens.INSTANCE.getTimeFieldLabelTextFont()), colors.m1881timeSelectorContentColorvNxB06k$material3_release(true), 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, TextAlign.m5081boximpl(TextAlign.INSTANCE.m5088getCentere0LSkKk()), null, 0L, null, null, null, null, null, 4177918, null);
            ...
            if (state.getIs24hour()) {
                ...
                $composer3 = $composer2;
                Modifier modifier$iv2 = PaddingKt.m486paddingqDBjuR0$default(modifier, PeriodToggleMargin, 0.0f, 0.0f, 0.0f, 14, null);
                ...
                skippableUpdate$iv$iv$iv2.invoke(SkippableUpdater.m2572boximpl(SkippableUpdater.m2573constructorimpl($composer3)), $composer3, Integer.valueOf(($changed$iv$iv$iv2 >> 3) & 112));
                ...
                VerticalPeriodToggle(SizeKt.m531sizeVpY3zN4(Modifier.INSTANCE, TimeInputTokens.INSTANCE.m2473getPeriodSelectorContainerWidthD9Ej5fM(), TimeInputTokens.INSTANCE.m2472getPeriodSelectorContainerHeightD9Ej5fM()), state, colors, $composer3, (($dirty2 >> 3) & 112) | 6 | (($dirty2 << 3) & 896));
                ComposerKt.sourceInformationMarkerEnd($composer3);
                ComposerKt.sourceInformationMarkerEnd($composer3);
    ...
    public static final void HorizontalClockDisplay(final TimePickerState state, final TimePickerColors colors, Composer $composer, final int $changed) {
        ...
        if (($dirty & 91) != 18 || !$composer2.getSkipping()) {
            ...
            if (!state.getIs24hour()) {
                Modifier modifier$iv2 = PaddingKt.m486paddingqDBjuR0$default(Modifier.INSTANCE, 0.0f, PeriodToggleMargin, 0.0f, 0.0f, 13, null);
                ...
                Updater.m2588setimpl($this$Layout_u24lambda_u2d0$iv$iv2, viewConfiguration$iv$iv2, ComposeUiNode.INSTANCE.getSetViewConfiguration());
                $composer2.enableReusing();
                skippableUpdate$iv$iv$iv2.invoke(SkippableUpdater.m2572boximpl(SkippableUpdater.m2573constructorimpl($composer2)), $composer2, Integer.valueOf(($changed$iv$iv$iv2 >> 3) & 112));
                $composer2.startReplaceableGroup(2058660585);
                ...
                HorizontalPeriodToggle(SizeKt.m531sizeVpY3zN4(Modifier.INSTANCE, TimePickerTokens.INSTANCE.m2484getPeriodSelectorHorizontalContainerWidthD9Ej5fM(), TimePickerTokens.INSTANCE.m2483getPeriodSelectorHorizontalContainerHeightD9Ej5fM()), state, colors, $composer2, (($dirty << 3) & 112) | 6 | (($dirty << 3) & 896));
                ComposerKt.sourceInformationMarkerEnd($composer2);
                ComposerKt.sourceInformationMarkerEnd($composer2);
                $composer2.endReplaceableGroup();
                $composer2.endNode();
    ...
    public static final void VerticalClockDisplay(final TimePickerState state, final TimePickerColors colors, Composer $composer, final int $changed) {
        ...
        if (($dirty & 91) != 18 || !$composer2.getSkipping()) {
            ...
            if (!state.getIs24hour()) {
                Modifier modifier$iv2 = PaddingKt.m486paddingqDBjuR0$default(Modifier.INSTANCE, PeriodToggleMargin, 0.0f, 0.0f, 0.0f, 14, null);
                $composer2.startReplaceableGroup(733328855);
                ComposerKt.sourceInformation($composer2, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
                Alignment contentAlignment$iv = Alignment.INSTANCE.getTopStart();
                int $changed$iv = ((6 >> 3) & 14) | ((6 >> 3) & 112);
                ...
                VerticalPeriodToggle(SizeKt.m531sizeVpY3zN4(Modifier.INSTANCE, TimePickerTokens.INSTANCE.m2487getPeriodSelectorVerticalContainerWidthD9Ej5fM(), TimePickerTokens.INSTANCE.m2486getPeriodSelectorVerticalContainerHeightD9Ej5fM()), state, colors, $composer2, (($dirty << 3) & 112) | 6 | (($dirty << 3) & 896));
                ComposerKt.sourceInformationMarkerEnd($composer2);
                ComposerKt.sourceInformationMarkerEnd($composer2);
                $composer2.endReplaceableGroup();
                $composer2.endNode();
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{TextKt.getLocalTextStyle().provides(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography($composer2, 6), TimePickerTokens.INSTANCE.getTimeSelectorLabelTextFont()))}, ComposableLambdaKt.composableLambda($composer2, -477913269, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TimePickerKt$ClockDisplayNumbers$1
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        Updater.m2588setimpl($this$Layout_u24lambda_u2d0$iv$iv, viewConfiguration$iv$iv, ComposeUiNode.INSTANCE.getSetViewConfiguration());
                        $composer3.enableReusing();
                        skippableUpdate$iv$iv$iv.invoke(SkippableUpdater.m2572boximpl(SkippableUpdater.m2573constructorimpl($composer3)), $composer3, Integer.valueOf(($changed$iv$iv$iv >> 3) & 112));
                        $composer3.startReplaceableGroup(2058660585);
                        ...
                        TimePickerKt.m1887TimeSelectoruXwN82Y(SizeKt.m531sizeVpY3zN4(Modifier.INSTANCE, TimePickerTokens.INSTANCE.m2490getTimeSelectorContainerWidthD9Ej5fM(), TimePickerTokens.INSTANCE.m2489getTimeSelectorContainerHeightD9Ej5fM()), timePickerState.getHourForDisplay$material3_release(), timePickerState, Selection.INSTANCE.m1697getHourJiIwxys(), timePickerColors, $composer3, i4);
                        Modifier.Companion companion = Modifier.INSTANCE;
                        f = TimePickerKt.DisplaySeparatorWidth;
                        TimePickerKt.DisplaySeparator(SizeKt.m531sizeVpY3zN4(companion, f, TimePickerTokens.INSTANCE.m2486getPeriodSelectorVerticalContainerHeightD9Ej5fM()), $composer3, 6);
        ...
        if (($dirty2 & 731) != 146 || !$composer2.getSkipping()) {
            ...
            if (it$iv$iv == Composer.INSTANCE.getEmpty()) {
                value$iv$iv = new MeasurePolicy() { // from class: androidx.compose.material3.TimePickerKt$HorizontalPeriodToggle$measurePolicy$1$1
                    ...
                    public final MeasureResult mo13measure3p2s80s(MeasureScope MeasurePolicy, List<? extends Measurable> measurables, long constraints) {
                        long m5162copyZbe2FdA;
                        long m5162copyZbe2FdA2;
                        ...
                        for (Object element$iv : $this$first$iv) {
                            ...
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it), "Spacer")) {
                                ...
                                m5162copyZbe2FdA = Constraints.m5162copyZbe2FdA(constraints, (r12 & 1) != 0 ? Constraints.m5174getMinWidthimpl(constraints) : 0, (r12 & 2) != 0 ? Constraints.m5172getMaxWidthimpl(constraints) : MathKt.roundToInt(MeasurePolicy.mo327toPx0680j_4(TimePickerTokens.INSTANCE.m2485getPeriodSelectorOutlineWidthD9Ej5fM())), (r12 & 4) != 0 ? Constraints.m5173getMinHeightimpl(constraints) : 0, (r12 & 8) != 0 ? Constraints.m5171getMaxHeightimpl(constraints) : 0);
                                final Placeable spacerPlaceable = spacer.mo4184measureBRTryo0(m5162copyZbe2FdA);
                                ...
                                for (Object item$iv$iv : $this$map$iv) {
                                    ...
                                    m5162copyZbe2FdA2 = Constraints.m5162copyZbe2FdA(constraints, (r12 & 1) != 0 ? Constraints.m5174getMinWidthimpl(constraints) : 0, (r12 & 2) != 0 ? Constraints.m5172getMaxWidthimpl(constraints) : Constraints.m5172getMaxWidthimpl(constraints) / 2, (r12 & 4) != 0 ? Constraints.m5173getMinHeightimpl(constraints) : 0, (r12 & 8) != 0 ? Constraints.m5171getMaxHeightimpl(constraints) : 0);
                                    destination$iv$iv2.add(item.mo4184measureBRTryo0(m5162copyZbe2FdA2));
                                }
                                final List items = (List) destination$iv$iv2;
                                return MeasureScope.layout$default(MeasurePolicy, Constraints.m5172getMaxWidthimpl(constraints), Constraints.m5171getMaxHeightimpl(constraints), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.TimePickerKt$HorizontalPeriodToggle$measurePolicy$1$1$measure$1
                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                ...
                value$iv$iv = new MeasurePolicy() { // from class: androidx.compose.material3.TimePickerKt$VerticalPeriodToggle$measurePolicy$1$1
                    ...
                    public final MeasureResult mo13measure3p2s80s(MeasureScope MeasurePolicy, List<? extends Measurable> measurables, long constraints) {
                        ...
                        for (Object element$iv : $this$first$iv) {
                            ...
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it), "Spacer")) {
                                Measurable spacer = (Measurable) element$iv;
                                m5162copyZbe2FdA = Constraints.m5162copyZbe2FdA(constraints, (r12 & 1) != 0 ? Constraints.m5174getMinWidthimpl(constraints) : 0, (r12 & 2) != 0 ? Constraints.m5172getMaxWidthimpl(constraints) : 0, (r12 & 4) != 0 ? Constraints.m5173getMinHeightimpl(constraints) : 0, (r12 & 8) != 0 ? Constraints.m5171getMaxHeightimpl(constraints) : MathKt.roundToInt(MeasurePolicy.mo327toPx0680j_4(TimePickerTokens.INSTANCE.m2485getPeriodSelectorOutlineWidthD9Ej5fM())));
                                final Placeable spacerPlaceable = spacer.mo4184measureBRTryo0(m5162copyZbe2FdA);
                                List<? extends Measurable> $this$filter$iv = measurables;
                                Collection destination$iv$iv = new ArrayList();
                                for (Object element$iv$iv : $this$filter$iv) {
                                ...
                                for (Object item$iv$iv : $this$map$iv) {
                                    Measurable item = (Measurable) item$iv$iv;
                                    m5162copyZbe2FdA2 = Constraints.m5162copyZbe2FdA(constraints, (r12 & 1) != 0 ? Constraints.m5174getMinWidthimpl(constraints) : 0, (r12 & 2) != 0 ? Constraints.m5172getMaxWidthimpl(constraints) : 0, (r12 & 4) != 0 ? Constraints.m5173getMinHeightimpl(constraints) : 0, (r12 & 8) != 0 ? Constraints.m5171getMaxHeightimpl(constraints) : Constraints.m5171getMaxHeightimpl(constraints) / 2);
                                    destination$iv$iv2.add(item.mo4184measureBRTryo0(m5162copyZbe2FdA2));
                                }
                                final List items = (List) destination$iv$iv2;
                                return MeasureScope.layout$default(MeasurePolicy, Constraints.m5172getMaxWidthimpl(constraints), Constraints.m5171getMaxHeightimpl(constraints), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.TimePickerKt$VerticalPeriodToggle$measurePolicy$1$1$measure$1
                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                    /* JADX WARN: Multi-variable type inference failed */
                                    {
                                        super(1);
    ...
    */
    ...
    public static final void ToggleItem(final boolean checked, final Shape shape, final Function0<Unit> function0, final TimePickerColors colors, final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed) {
        ...
        if ((46811 & $dirty2) == 9362 && $composer2.getSkipping()) {
            ...
            $composer2.endReplaceableGroup();
            ButtonKt.TextButton(function0, SemanticsModifierKt.semantics$default(fillMaxSize$default, false, (Function1) value$iv$iv, 1, null), false, shape, ButtonDefaults.INSTANCE.m1331textButtonColorsro_MJ88(containerColor, contentColor, 0L, 0L, $composer2, 24576, 12), null, null, PaddingKt.m475PaddingValues0680j_4(Dp.m5216constructorimpl(0)), null, function3, $composer2, (($dirty2 >> 6) & 14) | 12582912 | (($dirty2 << 6) & 7168) | (($dirty2 << 15) & 1879048192), 356);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final void DisplaySeparator(final Modifier modifier, Composer $composer, final int $changed) {
        ...
        if (($dirty & 11) == 2 && $composer2.getSkipping()) {
            ...
            ComposerKt.sourceInformationMarkerEnd($composer2);
            TextStyle style = IncludeFontPaddingHelper_androidKt.copyAndSetFontPadding(TextStyle.m4732copyCXVQc50$default((TextStyle) consume, 0L, 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, TextAlign.m5081boximpl(TextAlign.INSTANCE.m5088getCentere0LSkKk()), null, 0L, null, null, new LineHeightStyle(LineHeightStyle.Alignment.INSTANCE.m5065getCenterPIaL0Z0(), LineHeightStyle.Trim.INSTANCE.m5077getBothEVpEnUU(), null), null, null, 3653631, null), false);
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m1887TimeSelectoruXwN82Y(final androidx.compose.ui.Modifier r38, final int r39, final androidx.compose.material3.TimePickerState r40, final int r41, final androidx.compose.material3.TimePickerColors r42, androidx.compose.runtime.Composer r43, final int r44) {
        /*
            Method dump skipped, instructions count: 495
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.TimePickerKt.m1887TimeSelectoruXwN82Y(androidx.compose.ui.Modifier, int, androidx.compose.material3.TimePickerState, int, androidx.compose.material3.TimePickerColors, androidx.compose.runtime.Composer, int):void");
    }
    ...
    public static final void ClockFace(final TimePickerState state, final TimePickerColors colors, final boolean autoSwitchToMinute, Composer $composer, final int $changed) {
        ...
        if (($dirty2 & 731) != 146 || !$composer2.getSkipping()) {
            ...
            CrossfadeKt.Crossfade(state.getValues$material3_release(), SemanticsModifierKt.semantics$default(SizeKt.m529size3ABfNKs(BackgroundKt.m160backgroundbw27NRU(Modifier.INSTANCE, colors.getClockDialColor(), RoundedCornerShapeKt.getCircleShape()), TimePickerTokens.INSTANCE.m2478getClockDialContainerSizeD9Ej5fM()), false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.TimePickerKt$ClockFace$1
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ Unit invoke(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                    invoke2(semanticsPropertyReceiver);
                    return Unit.INSTANCE;
                ...
                public final void invoke(final List<Integer> screen, Composer $composer3, int $changed2) {
                    ...
                    drawSelector = TimePickerKt.drawSelector(SizeKt.m529size3ABfNKs(clockDial, TimePickerTokens.INSTANCE.m2478getClockDialContainerSizeD9Ej5fM()), TimePickerState.this, colors);
                    ...
                    final int i = $dirty2;
                    TimePickerKt.m1884CircularLayoutuFdPcIQ(drawSelector, f, ComposableLambdaKt.composableLambda($composer3, -1385633737, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TimePickerKt$ClockFace$2.1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(2);
                        }
                        ...
                        public final void invoke(Composer $composer4, int $changed3) {
                            ...
                            if (($changed3 & 11) != 2 || !$composer4.getSkipping()) {
                                ...
                                ProvidedValue[] providedValueArr = {ContentColorKt.getLocalContentColor().provides(Color.m2937boximpl(TimePickerColors.this.m1873clockDialContentColorvNxB06k$material3_release(false)))};
                                    ...
                                    public final void invoke(Composer $composer5, int $changed4) {
                                        ...
                                        if (($changed4 & 11) != 2 || !$composer5.getSkipping()) {
                                            ...
                                            if (Selection.m1693equalsimpl0(timePickerState2.m1910getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m1697getHourJiIwxys()) && timePickerState2.getIs24hour()) {
                                                Modifier m160backgroundbw27NRU = BackgroundKt.m160backgroundbw27NRU(SizeKt.m529size3ABfNKs(LayoutIdKt.layoutId(Modifier.INSTANCE, LayoutId.InnerCircle), TimePickerTokens.INSTANCE.m2478getClockDialContainerSizeD9Ej5fM()), Color.INSTANCE.m2982getTransparent0d7_KjU(), RoundedCornerShapeKt.getCircleShape());
                                                f2 = TimePickerKt.InnerCircleRadius;
                                                final TimePickerState timePickerState4 = timePickerState2;
                                                final boolean z4 = z2;
                                                final int i5 = i2;
                                                TimePickerKt.m1884CircularLayoutuFdPcIQ(m160backgroundbw27NRU, f2, ComposableLambdaKt.composableLambda($composer5, -448649404, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TimePickerKt.ClockFace.2.1.1.2
                                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                                    {
                                                        super(2);
                                                    }
    ...
    public static final Modifier drawSelector(Modifier $this$drawSelector, final TimePickerState state, final TimePickerColors colors) {
        return DrawModifierKt.drawWithContent($this$drawSelector, new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.material3.TimePickerKt$drawSelector$1
            ...
            public final void invoke2(ContentDrawScope drawWithContent) {
                ...
                long selectorOffsetPx = OffsetKt.Offset(drawWithContent.mo327toPx0680j_4(DpOffset.m5277getXD9Ej5fM(TimePickerState.this.m1911getSelectorPosRKDOV3M$material3_release())), drawWithContent.mo327toPx0680j_4(DpOffset.m5279getYD9Ej5fM(TimePickerState.this.m1911getSelectorPosRKDOV3M$material3_release())));
                float f = 2;
                float selectorRadius = drawWithContent.mo327toPx0680j_4(TimePickerTokens.INSTANCE.m2480getClockDialSelectorHandleContainerSizeD9Ej5fM()) / f;
                long selectorColor = colors.getSelectorColor();
                DrawScope.m3472drawCircleVaOC9Bg$default(drawWithContent, Color.INSTANCE.m2973getBlack0d7_KjU(), selectorRadius, selectorOffsetPx, 0.0f, null, null, BlendMode.INSTANCE.m2864getClear0nO6VwU(), 56, null);
                drawWithContent.drawContent();
                DrawScope.m3472drawCircleVaOC9Bg$default(drawWithContent, selectorColor, selectorRadius, selectorOffsetPx, 0.0f, null, null, BlendMode.INSTANCE.m2892getXor0nO6VwU(), 56, null);
                float strokeWidth = drawWithContent.mo327toPx0680j_4(TimePickerTokens.INSTANCE.m2481getClockDialSelectorTrackContainerWidthD9Ej5fM());
                long lineLength = Offset.m2712minusMKHz9U(selectorOffsetPx, OffsetKt.Offset(((float) Math.cos(TimePickerState.this.getCurrentAngle$material3_release().getValue().floatValue())) * selectorRadius, ((float) Math.sin(TimePickerState.this.getCurrentAngle$material3_release().getValue().floatValue())) * selectorRadius));
                DrawScope.m3477drawLineNGM6Ib0$default(drawWithContent, selectorColor, androidx.compose.ui.geometry.SizeKt.m2787getCenteruvyYCjk(drawWithContent.mo3490getSizeNHjbRc()), lineLength, strokeWidth, 0, null, 0.0f, null, BlendMode.INSTANCE.m2891getSrcOver0nO6VwU(), 240, null);
                DrawScope.m3472drawCircleVaOC9Bg$default(drawWithContent, selectorColor, drawWithContent.mo327toPx0680j_4(TimePickerTokens.INSTANCE.m2479getClockDialSelectorCenterContainerSizeD9Ej5fM()) / f, androidx.compose.ui.geometry.SizeKt.m2787getCenteruvyYCjk(drawWithContent.mo3490getSizeNHjbRc()), 0.0f, null, null, 0, 120, null);
                DrawScope.m3472drawCircleVaOC9Bg$default(drawWithContent, colors.m1873clockDialContentColorvNxB06k$material3_release(true), selectorRadius, selectorOffsetPx, 0.0f, null, null, BlendMode.INSTANCE.m2874getDstOver0nO6VwU(), 56, null);
            }
        });
    }
    ...
    */
    ...
    public static final void m1893timeInputOnChangegIWD5Rc(int selection, TimePickerState state, TextFieldValue value, TextFieldValue prevValue, int max, Function1<? super TextFieldValue, Unit> function1) {
        int newValue;
        TextFieldValue m4938copy3r_uNRQ$default;
        ...
        if (value.getText().length() == 0) {
            ...
            function1.invoke(TextFieldValue.m4938copy3r_uNRQ$default(value, "", 0L, (TextRange) null, 6, (Object) null));
            return;
        }
        try {
            if (value.getText().length() == 3 && TextRange.m4724getStartimpl(value.getSelection()) == 1) {
            ...
            if (newValue <= max) {
                ...
                if (value.getText().length() <= 2) {
                    m4938copy3r_uNRQ$default = value;
                } else {
                    m4938copy3r_uNRQ$default = TextFieldValue.m4938copy3r_uNRQ$default(value, String.valueOf(value.getText().charAt(0)), 0L, (TextRange) null, 6, (Object) null);
                }
                function1.invoke(m4938copy3r_uNRQ$default);
            }
    ...
    */
    ...
    public static final void m1884CircularLayoutuFdPcIQ(Modifier modifier, final float radius, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty2 & 731) == 146 && $composer2.getSkipping()) {
            ...
            MeasurePolicy measurePolicy = new MeasurePolicy() { // from class: androidx.compose.material3.TimePickerKt$CircularLayout$1
                @Override // androidx.compose.ui.layout.MeasurePolicy
                /* renamed from: measure-3p2s80s */
                public final MeasureResult mo13measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, final long constraints) {
                    ...
                    itemConstraints = Constraints.m5162copyZbe2FdA(constraints, (r12 & 1) != 0 ? Constraints.m5174getMinWidthimpl(constraints) : 0, (r12 & 2) != 0 ? Constraints.m5172getMaxWidthimpl(constraints) : 0, (r12 & 4) != 0 ? Constraints.m5173getMinHeightimpl(constraints) : 0, (r12 & 8) != 0 ? Constraints.m5171getMaxHeightimpl(constraints) : 0);
                    List<? extends Measurable> $this$filter$iv = measurables;
                    Collection destination$iv$iv = new ArrayList();
                    for (Object element$iv$iv : $this$filter$iv) {
                    ...
                    for (Object item$iv$iv : $this$map$iv) {
                        ...
                        destination$iv$iv2.add(measurable.mo4184measureBRTryo0(itemConstraints));
                    }
                    ...
                    final Placeable selectorPlaceable = selectorMeasurable != null ? selectorMeasurable.mo4184measureBRTryo0(itemConstraints) : null;
                    final Placeable innerCirclePlaceable = innerMeasurable != null ? innerMeasurable.mo4184measureBRTryo0(itemConstraints) : null;
                    return MeasureScope.layout$default(Layout, Constraints.m5174getMinWidthimpl(constraints), Constraints.m5173getMinHeightimpl(constraints), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.TimePickerKt$CircularLayout$1$measure$1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        /* JADX WARN: Multi-variable type inference failed */
                        {
                            super(1);
                        ...
                        public final void invoke2(Placeable.PlacementScope layout) {
                            ...
                            for (Object item$iv : $this$forEachIndexed$iv) {
                                ...
                                int i3 = index$iv;
                                int centerOffsetX = (Constraints.m5172getMaxWidthimpl(j) / 2) - (it6.getWidth() / 2);
                                int centerOffsetY = (Constraints.m5171getMaxHeightimpl(j) / 2) - (it6.getHeight() / 2);
                                double d = f;
                            ...
                            if (placeable2 != null) {
                                Placeable.PlacementScope.place$default(layout, placeable2, (Constraints.m5174getMinWidthimpl(constraints) - innerCirclePlaceable.getWidth()) / 2, (Constraints.m5173getMinHeightimpl(constraints) - innerCirclePlaceable.getHeight()) / 2, 0.0f, 4, null);
                            }
                        }
                    }, 4, null);
                }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TimePickerKt$CircularLayout$2
            ...
            public final void invoke(Composer composer, int i3) {
                TimePickerKt.m1884CircularLayoutuFdPcIQ(Modifier.this, radius, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    public static final String m1892numberContentDescriptionYKJpE6Y(int selection, boolean is24Hour, int number, Composer $composer, int $changed) {
        ...
        String m1784getStringiSCLEhQ = Strings_androidKt.m1784getStringiSCLEhQ(id, new Object[]{Integer.valueOf(number)}, $composer, 64);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
        return m1784getStringiSCLEhQ;
    }
    ...
    static {
        ...
        PeriodToggleMargin = Dp.m5216constructorimpl(12);
    }
