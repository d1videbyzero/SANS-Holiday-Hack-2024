...
public final class KeyEventType {
    ...
    private static final int Unknown = m3924constructorimpl(0);
    private static final int KeyUp = m3924constructorimpl(1);
    private static final int KeyDown = m3924constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ KeyEventType m3923boximpl(int i) {
        return new KeyEventType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m3924constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3925equalsimpl(int i, Object obj) {
        return (obj instanceof KeyEventType) && i == ((KeyEventType) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3926equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m3927hashCodeimpl(int i) {
    ...
    public static String m3928toStringimpl(int arg0) {
        return m3926equalsimpl0(arg0, KeyUp) ? "KeyUp" : m3926equalsimpl0(arg0, KeyDown) ? "KeyDown" : m3926equalsimpl0(arg0, Unknown) ? "Unknown" : "Invalid";
    }
