...
public final class PointerType {
    ...
    private static final int Unknown = m4135constructorimpl(0);
    private static final int Touch = m4135constructorimpl(1);
    private static final int Mouse = m4135constructorimpl(2);
    private static final int Stylus = m4135constructorimpl(3);
    private static final int Eraser = m4135constructorimpl(4);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PointerType m4134boximpl(int i) {
        return new PointerType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m4135constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4136equalsimpl(int i, Object obj) {
        return (obj instanceof PointerType) && i == ((PointerType) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4137equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4138hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object obj) {
        return m4136equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m4138hashCodeimpl(this.value);
    }
    ...
    public static String m4139toStringimpl(int arg0) {
        switch (arg0) {
            case 1:
                return "Touch";
            case 2:
    ...
    public String toString() {
        return m4139toStringimpl(this.value);
    }
