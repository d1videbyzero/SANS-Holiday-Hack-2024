...
public final class LayoutNodeDrawScopeKt {
    ...
    public static final Modifier.Node nextDrawNode(DelegatableNode $this$nextDrawNode) {
        ...
        if (child == null || (child.getAggregateChildKindSet() & m4398constructorimpl) == 0) {
            return null;
        }
        for (Modifier.Node next = child; next != null && (next.getKindSet() & m4398constructorimpl2) == 0; next = next.getChild()) {
            if ((next.getKindSet() & m4398constructorimpl) != 0) {
                return next;
            }
        }
        return null;
