...
public final class FontVariation {
    ...
    private static final class SettingTextUnit implements Setting {
        ...
        public boolean equals(Object other) {
            ...
            return (other instanceof SettingTextUnit) && Intrinsics.areEqual(getAxisName(), ((SettingTextUnit) other).getAxisName()) && TextUnit.m5394equalsimpl0(this.value, ((SettingTextUnit) other).value);
        }

        public int hashCode() {
            int result = getAxisName().hashCode();
            return (result * 31) + TextUnit.m5398hashCodeimpl(this.value);
        }
    ...
    public final Setting m4840opticalSizingR2X_6o(long textSize) {
        if (!TextUnit.m5400isSpimpl(textSize)) {
    ...
    public final Settings m4839Settings6EWAqTQ(FontWeight weight, int style, Setting... settings) {
