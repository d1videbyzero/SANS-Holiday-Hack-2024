...
public final class ShadowKt {
    ...
    public static /* synthetic */ Modifier m2622shadowziNgDLE$default(Modifier modifier, float f, Shape shape, boolean z, int i, Object obj) {
        ...
        if ((i & 4) != 0) {
            int $this$dp$iv = Dp.m5215compareTo0680j_4(f, Dp.m5216constructorimpl(0));
            z = $this$dp$iv > 0;
        }
    ...
    public static final Modifier m2619shadows4CzXII(Modifier shadow, final float elevation, final Shape shape, final boolean clip, final long ambientColor, final long spotColor) {
        Intrinsics.checkNotNullParameter(shadow, "$this$shadow");
        Intrinsics.checkNotNullParameter(shape, "shape");
        if (Dp.m5215compareTo0680j_4(elevation, Dp.m5216constructorimpl(0)) <= 0 && !clip) {
            return shadow;
        }
        Function1 inspectorInfo$iv = InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.ui.draw.ShadowKt$shadow-s4CzXII$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo $this$null) {
                ...
                $this$null.getProperties().set("elevation", Dp.m5214boximpl(elevation));
        ...
        Modifier $this$inspectable$iv = InspectableValueKt.inspectableWrapper(shadow, inspectorInfo$iv, GraphicsLayerModifierKt.graphicsLayer($this$shadow_s4CzXII_u24lambda_u241, new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.ui.draw.ShadowKt$shadow$2$1
            ...
            public final void invoke2(GraphicsLayerScope graphicsLayer) {
                ...
                graphicsLayer.mo3133setAmbientShadowColor8_81llA(ambientColor);
                graphicsLayer.mo3135setSpotShadowColor8_81llA(spotColor);
            }
        }));
