...
public final class OutlineResolver {
    ...
    public final boolean m4540isInOutlinek4lQ0M(long position) {
    ...
    public final void clipToOutline(Canvas canvas) {
        ...
        if (this.roundedCornerRadius > 0.0f) {
            ...
            if (roundRectClipPath == null || !m4539isSameBounds4L21HEs(roundRect, this.rectTopLeft, this.rectSize, this.roundedCornerRadius)) {
    ...
    public final void m4541updateuvyYCjk(long size) {
    ...
    private final void updateCache() {
        if (this.cacheIsDirty) {
            ...
            if (this.outlineNeeded && Size.m2777getWidthimpl(this.size) > 0.0f && Size.m2774getHeightimpl(this.size) > 0.0f) {
                this.isSupportedOutline = true;
                androidx.compose.ui.graphics.Outline outline = this.shape.mo210createOutlinePq9zytI(this.size, this.layoutDirection, this.density);
    ...
    private final boolean m4539isSameBounds4L21HEs(RoundRect $this$isSameBounds_u2d4L21HEs, long offset, long size, float radius) {
