...
public abstract class Placeable implements Measured {
    ...
    public abstract void mo4185placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock);

    public Placeable() {
        long j;
        j = PlaceableKt.DefaultConstraints;
        this.measurementConstraints = j;
        this.apparentToRealOffset = IntOffset.INSTANCE.m5344getZeronOccac();
    }
    ...
    protected final void m4239setMeasuredSizeozmzZPI(long value) {
        if (!IntSize.m5374equalsimpl0(this.measuredSize, value)) {
    ...
    private final void onMeasuredSizeChanged() {
        this.width = RangesKt.coerceIn(IntSize.m5376getWidthimpl(this.measuredSize), Constraints.m5174getMinWidthimpl(this.measurementConstraints), Constraints.m5172getMaxWidthimpl(this.measurementConstraints));
        this.height = RangesKt.coerceIn(IntSize.m5375getHeightimpl(this.measuredSize), Constraints.m5173getMinHeightimpl(this.measurementConstraints), Constraints.m5171getMaxHeightimpl(this.measurementConstraints));
        this.apparentToRealOffset = IntOffsetKt.IntOffset((this.width - IntSize.m5376getWidthimpl(this.measuredSize)) / 2, (this.height - IntSize.m5375getHeightimpl(this.measuredSize)) / 2);
    }
    ...
    public final void m4240setMeasurementConstraintsBRTryo0(long value) {
        if (!Constraints.m5165equalsimpl0(this.measurementConstraints, value)) {
    ...
    public static abstract class PlacementScope {
        ...
        public static /* synthetic */ void m4242placeRelative70tqf50$default(PlacementScope placementScope, Placeable placeable, long j, float f, int i, Object obj) {
            if (obj != null) {
            ...
            placementScope.m4248placeRelative70tqf50(placeable, j, f);
        }

        /* renamed from: placeRelative-70tqf50, reason: not valid java name */
        public final void m4248placeRelative70tqf50(Placeable placeRelative, long position, float zIndex) {
            Intrinsics.checkNotNullParameter(placeRelative, "$this$placeRelative");
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                long other$iv$iv$iv = placeRelative.apparentToRealOffset;
                placeRelative.mo4185placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5334getXimpl(position) + IntOffset.m5334getXimpl(other$iv$iv$iv), IntOffset.m5335getYimpl(position) + IntOffset.m5335getYimpl(other$iv$iv$iv)), zIndex, null);
            } else {
                long position$iv$iv = IntOffsetKt.IntOffset((getParentWidth() - placeRelative.getWidth()) - IntOffset.m5334getXimpl(position), IntOffset.m5335getYimpl(position));
                long other$iv$iv$iv2 = placeRelative.apparentToRealOffset;
                placeRelative.mo4185placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5334getXimpl(position$iv$iv) + IntOffset.m5334getXimpl(other$iv$iv$iv2), IntOffset.m5335getYimpl(position$iv$iv) + IntOffset.m5335getYimpl(other$iv$iv$iv2)), zIndex, null);
            }
        }
        ...
        public final void placeRelative(Placeable $this$placeRelative, int x, int y, float zIndex) {
            ...
            if (getParentLayoutDirection() != LayoutDirection.Ltr && getParentWidth() != 0) {
                long position$iv$iv = IntOffsetKt.IntOffset((getParentWidth() - $this$placeRelative.getWidth()) - IntOffset.m5334getXimpl(position$iv), IntOffset.m5335getYimpl(position$iv));
                long other$iv$iv$iv = $this$placeRelative.apparentToRealOffset;
                $this$placeRelative.mo4185placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5334getXimpl(position$iv$iv) + IntOffset.m5334getXimpl(other$iv$iv$iv), IntOffset.m5335getYimpl(position$iv$iv) + IntOffset.m5335getYimpl(other$iv$iv$iv)), zIndex, null);
                return;
            }
            long other$iv$iv$iv2 = $this$placeRelative.apparentToRealOffset;
            $this$placeRelative.mo4185placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5334getXimpl(position$iv) + IntOffset.m5334getXimpl(other$iv$iv$iv2), IntOffset.m5335getYimpl(position$iv) + IntOffset.m5335getYimpl(other$iv$iv$iv2)), zIndex, null);
        }
        ...
        public final void place(Placeable $this$place, int x, int y, float zIndex) {
            ...
            $this$place.mo4185placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5334getXimpl(position$iv) + IntOffset.m5334getXimpl(other$iv$iv), IntOffset.m5335getYimpl(position$iv) + IntOffset.m5335getYimpl(other$iv$iv)), zIndex, null);
        }

        /* renamed from: place-70tqf50$default, reason: not valid java name */
        public static /* synthetic */ void m4241place70tqf50$default(PlacementScope placementScope, Placeable placeable, long j, float f, int i, Object obj) {
            if (obj != null) {
            ...
            placementScope.m4245place70tqf50(placeable, j, f);
        }

        /* renamed from: place-70tqf50, reason: not valid java name */
        public final void m4245place70tqf50(Placeable place, long position, float zIndex) {
            Intrinsics.checkNotNullParameter(place, "$this$place");
            long other$iv$iv = place.apparentToRealOffset;
            place.mo4185placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5334getXimpl(position) + IntOffset.m5334getXimpl(other$iv$iv), IntOffset.m5335getYimpl(position) + IntOffset.m5335getYimpl(other$iv$iv)), zIndex, null);
        }

        /* renamed from: placeRelativeWithLayer-aW-9-wM$default, reason: not valid java name */
        public static /* synthetic */ void m4243placeRelativeWithLayeraW9wM$default(PlacementScope placementScope, Placeable placeable, long j, float f, Function1 function1, int i, Object obj) {
            float f2;
            ...
            placementScope.m4249placeRelativeWithLayeraW9wM(placeable, j, f2, function12);
        }

        /* renamed from: placeRelativeWithLayer-aW-9-wM, reason: not valid java name */
        public final void m4249placeRelativeWithLayeraW9wM(Placeable placeRelativeWithLayer, long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            Intrinsics.checkNotNullParameter(placeRelativeWithLayer, "$this$placeRelativeWithLayer");
            Intrinsics.checkNotNullParameter(layerBlock, "layerBlock");
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                long other$iv$iv$iv = placeRelativeWithLayer.apparentToRealOffset;
                placeRelativeWithLayer.mo4185placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5334getXimpl(position) + IntOffset.m5334getXimpl(other$iv$iv$iv), IntOffset.m5335getYimpl(position) + IntOffset.m5335getYimpl(other$iv$iv$iv)), zIndex, layerBlock);
            } else {
                long position$iv$iv = IntOffsetKt.IntOffset((getParentWidth() - placeRelativeWithLayer.getWidth()) - IntOffset.m5334getXimpl(position), IntOffset.m5335getYimpl(position));
                long other$iv$iv$iv2 = placeRelativeWithLayer.apparentToRealOffset;
                placeRelativeWithLayer.mo4185placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5334getXimpl(position$iv$iv) + IntOffset.m5334getXimpl(other$iv$iv$iv2), IntOffset.m5335getYimpl(position$iv$iv) + IntOffset.m5335getYimpl(other$iv$iv$iv2)), zIndex, layerBlock);
            }
        }
        ...
        public final void placeRelativeWithLayer(Placeable $this$placeRelativeWithLayer, int x, int y, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            ...
            long position$iv = IntOffsetKt.IntOffset(x, y);
            if (getParentLayoutDirection() != LayoutDirection.Ltr && getParentWidth() != 0) {
                long position$iv$iv = IntOffsetKt.IntOffset((getParentWidth() - $this$placeRelativeWithLayer.getWidth()) - IntOffset.m5334getXimpl(position$iv), IntOffset.m5335getYimpl(position$iv));
                long other$iv$iv$iv = $this$placeRelativeWithLayer.apparentToRealOffset;
                $this$placeRelativeWithLayer.mo4185placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5334getXimpl(position$iv$iv) + IntOffset.m5334getXimpl(other$iv$iv$iv), IntOffset.m5335getYimpl(position$iv$iv) + IntOffset.m5335getYimpl(other$iv$iv$iv)), zIndex, layerBlock);
                return;
            }
            long other$iv$iv$iv2 = $this$placeRelativeWithLayer.apparentToRealOffset;
            $this$placeRelativeWithLayer.mo4185placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5334getXimpl(position$iv) + IntOffset.m5334getXimpl(other$iv$iv$iv2), IntOffset.m5335getYimpl(position$iv) + IntOffset.m5335getYimpl(other$iv$iv$iv2)), zIndex, layerBlock);
        }
        ...
        public final void placeWithLayer(Placeable $this$placeWithLayer, int x, int y, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            ...
            $this$placeWithLayer.mo4185placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5334getXimpl(position$iv) + IntOffset.m5334getXimpl(other$iv$iv), IntOffset.m5335getYimpl(position$iv) + IntOffset.m5335getYimpl(other$iv$iv)), zIndex, layerBlock);
        }

        /* renamed from: placeWithLayer-aW-9-wM$default, reason: not valid java name */
        public static /* synthetic */ void m4244placeWithLayeraW9wM$default(PlacementScope placementScope, Placeable placeable, long j, float f, Function1 function1, int i, Object obj) {
            float f2;
            Function1 function12;
            Function1 function13;
            if (obj != null) {
            ...
            placementScope.m4250placeWithLayeraW9wM(placeable, j, f2, function12);
        }

        /* renamed from: placeWithLayer-aW-9-wM, reason: not valid java name */
        public final void m4250placeWithLayeraW9wM(Placeable placeWithLayer, long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            Intrinsics.checkNotNullParameter(placeWithLayer, "$this$placeWithLayer");
            Intrinsics.checkNotNullParameter(layerBlock, "layerBlock");
            long other$iv$iv = placeWithLayer.apparentToRealOffset;
            placeWithLayer.mo4185placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5334getXimpl(position) + IntOffset.m5334getXimpl(other$iv$iv), IntOffset.m5335getYimpl(position) + IntOffset.m5335getYimpl(other$iv$iv)), zIndex, layerBlock);
        }

        /* renamed from: placeAutoMirrored-aW-9-wM$ui_release, reason: not valid java name */
        public final void m4247placeAutoMirroredaW9wM$ui_release(Placeable placeAutoMirrored, long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> function1) {
            ...
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                ...
                placeAutoMirrored.mo4185placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5334getXimpl(position) + IntOffset.m5334getXimpl(other$iv$iv), IntOffset.m5335getYimpl(position) + IntOffset.m5335getYimpl(other$iv$iv)), zIndex, function1);
            } else {
                long position$iv = IntOffsetKt.IntOffset((getParentWidth() - placeAutoMirrored.getWidth()) - IntOffset.m5334getXimpl(position), IntOffset.m5335getYimpl(position));
                long other$iv$iv2 = placeAutoMirrored.apparentToRealOffset;
                placeAutoMirrored.mo4185placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5334getXimpl(position$iv) + IntOffset.m5334getXimpl(other$iv$iv2), IntOffset.m5335getYimpl(position$iv) + IntOffset.m5335getYimpl(other$iv$iv2)), zIndex, function1);
            }
        }

        /* renamed from: placeApparentToRealOffset-aW-9-wM$ui_release, reason: not valid java name */
        public final void m4246placeApparentToRealOffsetaW9wM$ui_release(Placeable placeApparentToRealOffset, long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> function1) {
            ...
            placeApparentToRealOffset.mo4185placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5334getXimpl(position) + IntOffset.m5334getXimpl(other$iv), IntOffset.m5335getYimpl(position) + IntOffset.m5335getYimpl(other$iv)), zIndex, function1);
        }
