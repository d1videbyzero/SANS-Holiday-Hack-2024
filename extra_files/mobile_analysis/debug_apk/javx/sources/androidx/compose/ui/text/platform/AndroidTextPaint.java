...
public final class AndroidTextPaint extends TextPaint {
    ...
    public final void m4962setColor8_81llA(long color) {
    ...
    public static /* synthetic */ void m4958setBrush12SF9DM$default(AndroidTextPaint androidTextPaint, Brush brush, long j, float f, int i, Object obj) {
        if ((i & 4) != 0) {
            f = Float.NaN;
        }
        androidTextPaint.m4961setBrush12SF9DM(brush, j, f);
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:6:0x001b, code lost:
        ...
        if ((r3 != androidx.compose.ui.graphics.Color.INSTANCE.m2983getUnspecified0d7_KjU() ? 1 : 0) == 0) goto L9;
     */
    ...
    */
    public final void m4961setBrush12SF9DM(androidx.compose.ui.graphics.Brush r8, long r9, float r11) {
        /*
            r7 = this;
        ...
        L55:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.text.platform.AndroidTextPaint.m4961setBrush12SF9DM(androidx.compose.ui.graphics.Brush, long, float):void");
    }
    ...
    public final void setDrawStyle(DrawStyle drawStyle) {
        if (drawStyle != null && !Intrinsics.areEqual(this.drawStyle, drawStyle)) {
            ...
            if (Intrinsics.areEqual(drawStyle, Fill.INSTANCE)) {
                this.composePaint.mo2832setStylek9PVt8s(PaintingStyle.INSTANCE.m3208getFillTiuSbCo());
                return;
            }
            if (drawStyle instanceof Stroke) {
                this.composePaint.mo2832setStylek9PVt8s(PaintingStyle.INSTANCE.m3209getStrokeTiuSbCo());
    ...
    public final int m4959getBlendMode0nO6VwU() {
        return this.composePaint.get_blendMode();
    }

    /* renamed from: setBlendMode-s9anfk8, reason: not valid java name */
    public final void m4960setBlendModes9anfk8(int i) {
