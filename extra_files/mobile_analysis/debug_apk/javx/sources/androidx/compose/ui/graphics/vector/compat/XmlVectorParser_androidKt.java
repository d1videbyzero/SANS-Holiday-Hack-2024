...
public final class XmlVectorParser_androidKt {
    ...
    static /* synthetic */ int m3593getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.INSTANCE.m3293getButtKaPHkGw();
        }
        return m3592getStrokeLineCapCSYIeUk(i, i2);
    }

    /* renamed from: getStrokeLineCap-CSYIeUk, reason: not valid java name */
    private static final int m3592getStrokeLineCapCSYIeUk(int id, int defValue) {
        switch (id) {
            case 0:
                return StrokeCap.INSTANCE.m3293getButtKaPHkGw();
            case 1:
                return StrokeCap.INSTANCE.m3294getRoundKaPHkGw();
            case 2:
                return StrokeCap.INSTANCE.m3295getSquareKaPHkGw();
            default:
                return defValue;
        }
    }
    ...
    static /* synthetic */ int m3595getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.INSTANCE.m3304getMiterLxFBmk8();
        }
        return m3594getStrokeLineJoinkLtJ_vA(i, i2);
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA, reason: not valid java name */
    private static final int m3594getStrokeLineJoinkLtJ_vA(int id, int defValue) {
        switch (id) {
            case 0:
                return StrokeJoin.INSTANCE.m3304getMiterLxFBmk8();
            case 1:
                return StrokeJoin.INSTANCE.m3305getRoundLxFBmk8();
            case 2:
                return StrokeJoin.INSTANCE.m3303getBevelLxFBmk8();
            default:
                return defValue;
        }
    }
    ...
    public static final ImageVector.Builder createVectorImageBuilder(AndroidVectorParser $this$createVectorImageBuilder, Resources res, Resources.Theme theme, AttributeSet attrs) {
        ...
        float defaultWidthDp = Dp.m5216constructorimpl($this$dp$iv);
        float $this$dp$iv2 = defaultHeight / res.getDisplayMetrics().density;
        float defaultHeightDp = Dp.m5216constructorimpl($this$dp$iv2);
        vectorAttrs.recycle();
    ...
    public static final void parsePath(AndroidVectorParser $this$parsePath, Resources res, Resources.Theme theme, AttributeSet attrs, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        int strokeLineCap = m3592getStrokeLineCapCSYIeUk(lineCap, StrokeCap.INSTANCE.m3293getButtKaPHkGw());
        ...
        int strokeLineJoin = m3594getStrokeLineJoinkLtJ_vA(lineJoin, StrokeJoin.INSTANCE.m3303getBevelLxFBmk8());
        ...
        int lineJoin2 = fillRule == 0 ? companion.m3224getNonZeroRgk1Os() : companion.m3223getEvenOddRgk1Os();
        builder.m3572addPathoIyEayM(pathData, lineJoin2, name, fillBrush, fillAlpha, strokeBrush, strokeAlpha, strokeLineWidth, strokeLineCap, strokeLineJoin, strokeMiterLimit, trimPathStart, trimPathEnd, trimPathOffset);
    }
