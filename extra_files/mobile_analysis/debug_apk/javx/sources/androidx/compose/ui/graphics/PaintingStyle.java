...
public final class PaintingStyle {
    ...
    private static final int Fill = m3202constructorimpl(0);
    private static final int Stroke = m3202constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PaintingStyle m3201boximpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m3208getFillTiuSbCo() {
            return PaintingStyle.Fill;
        }

        /* renamed from: getStroke-TiuSbCo, reason: not valid java name */
        public final int m3209getStrokeTiuSbCo() {
            return PaintingStyle.Stroke;
        }
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3206toStringimpl(int arg0) {
        return m3204equalsimpl0(arg0, Fill) ? "Fill" : m3204equalsimpl0(arg0, Stroke) ? "Stroke" : "Unknown";
    }
