...
public final class AsyncTypefaceCache {
    private final Object PermanentFailure = AsyncTypefaceResult.m4777constructorimpl(null);
    ...
    public static final class AsyncTypefaceResult {
        ...
        public static final /* synthetic */ AsyncTypefaceResult m4776boximpl(Object obj) {
            return new AsyncTypefaceResult(obj);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static Object m4777constructorimpl(Object obj) {
            return obj;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m4778equalsimpl(Object obj, Object obj2) {
            return (obj2 instanceof AsyncTypefaceResult) && Intrinsics.areEqual(obj, ((AsyncTypefaceResult) obj2).m4783unboximpl());
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m4779equalsimpl0(Object obj, Object obj2) {
            return Intrinsics.areEqual(obj, obj2);
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m4780hashCodeimpl(Object obj) {
            if (obj == null) {
                return 0;
            }
            return obj.hashCode();
        ...
        public static String m4782toStringimpl(Object obj) {
            return "AsyncTypefaceResult(result=" + obj + ')';
        }

        public boolean equals(Object obj) {
            return m4778equalsimpl(this.result, obj);
        }

        public int hashCode() {
            return m4780hashCodeimpl(this.result);
        }

        public String toString() {
            return m4782toStringimpl(this.result);
        }

        /* renamed from: unbox-impl, reason: not valid java name */
        public final /* synthetic */ Object m4783unboximpl() {
            return this.result;
        }
        ...
        public static final boolean m4781isPermanentFailureimpl(Object arg0) {
            return arg0 == null;
        }
    }
    ...
    public final void put(Font font, PlatformFontLoader platformFontLoader, Object result, boolean forever) {
        ...
        synchronized (lock$iv) {
            try {
                if (result == null) {
                    this.permanentCache.put(key, AsyncTypefaceResult.m4776boximpl(this.PermanentFailure));
                } else if (forever) {
                    this.permanentCache.put(key, AsyncTypefaceResult.m4776boximpl(AsyncTypefaceResult.m4777constructorimpl(result)));
                } else {
                    this.resultCache.put(key, AsyncTypefaceResult.m4776boximpl(AsyncTypefaceResult.m4777constructorimpl(result)));
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public final AsyncTypefaceResult m4775get1ASDuI8(Font font, PlatformFontLoader platformFontLoader) {
    ...
    */
    public final java.lang.Object runCached(androidx.compose.ui.text.font.Font r8, androidx.compose.ui.text.font.PlatformFontLoader r9, boolean r10, kotlin.jvm.functions.Function1<? super kotlin.coroutines.Continuation<java.lang.Object>, ? extends java.lang.Object> r11, kotlin.coroutines.Continuation<java.lang.Object> r12) {
        ...
        L63:
            if (r5 == 0) goto L6b
            java.lang.Object r9 = r5.m4783unboximpl()     // Catch: java.lang.Throwable -> Lbd
            monitor-exit(r8)
            return r9
        L6b:
        ...
        L7f:
            ...
            androidx.compose.ui.text.font.AsyncTypefaceCache$AsyncTypefaceResult r11 = androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult.m4776boximpl(r11)     // Catch: java.lang.Throwable -> L95
        ...
        L97:
            if (r10 == 0) goto La8
            androidx.compose.ui.text.caches.SimpleArrayMap<androidx.compose.ui.text.font.AsyncTypefaceCache$Key, androidx.compose.ui.text.font.AsyncTypefaceCache$AsyncTypefaceResult> r10 = r2.permanentCache     // Catch: java.lang.Throwable -> L95
            java.lang.Object r6 = androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult.m4777constructorimpl(r11)     // Catch: java.lang.Throwable -> L95
            androidx.compose.ui.text.font.AsyncTypefaceCache$AsyncTypefaceResult r6 = androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult.m4776boximpl(r6)     // Catch: java.lang.Throwable -> L95
    ...
    public final Object runCachedBlocking(Font font, PlatformFontLoader platformFontLoader, Function0<? extends Object> block) {
        ...
        synchronized (lock$iv) {
            try {
                ...
                if (priorResult != null) {
                    Object m4783unboximpl = priorResult.m4783unboximpl();
                    InlineMarker.finallyStart(2);
                    InlineMarker.finallyEnd(2);
                    return m4783unboximpl;
                }
