...
public final class FocusRequester {
    ...
    public final boolean focus$ui_release() {
        ...
        boolean success$iv;
        boolean m2669findChildCorrespondingToFocusEnterOMvw8;
        ...
        if (size$iv$iv > 0) {
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    if ((branch$iv$iv$iv3.getAggregateChildKindSet() & m4398constructorimpl) != 0) {
                                ...
                                while (node != null) {
                                    ...
                                    if (node instanceof FocusTargetNode) {
                                        ...
                                        if (focusProperties.getCanFocus()) {
                                            ...
                                            m2669findChildCorrespondingToFocusEnterOMvw8 = FocusTransactionsKt.requestFocus(it$iv);
                                            success$iv = success$iv2;
                                        } else {
                                            child$iv$iv$iv = child$iv$iv$iv2;
                                            success$iv = success$iv2;
                                            m2669findChildCorrespondingToFocusEnterOMvw8 = TwoDimensionalFocusSearchKt.m2669findChildCorrespondingToFocusEnterOMvw8(it$iv, FocusDirection.INSTANCE.m2636getEnterdhqQ8s(), new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.focus.FocusRequester$focus$1$1
                                        ...
                                        if (m2669findChildCorrespondingToFocusEnterOMvw8) {
                                            success$iv2 = true;
                                            i = 0;
                                            break;
                                        }
                                        ...
                                        if (((this_$iv$iv$iv$iv3.getKindSet() & m4398constructorimpl) != 0) && (node instanceof DelegatingNode)) {
                                            ...
                                            while (node$iv$iv$iv$iv != null) {
                                                ...
                                                if ((next$iv$iv$iv.getKindSet() & m4398constructorimpl) != 0) {
                                                    count$iv$iv$iv2++;
        ...
        if (size$iv > 0) {
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    if ((branch$iv$iv3.getAggregateChildKindSet() & m4398constructorimpl) != 0) {
                            ...
                            if ((node$iv$iv.getKindSet() & m4398constructorimpl) != 0) {
                                ...
                                while (node2 != null) {
                                    ...
                                    if (node2 instanceof FocusTargetNode) {
                                        ...
                                        if (((this_$iv$iv$iv2.getKindSet() & m4398constructorimpl) != 0) && (node2 instanceof DelegatingNode)) {
                                            int count$iv$iv2 = 0;
                                            DelegatingNode this_$iv$iv$iv3 = (DelegatingNode) node2;
                                            Modifier.Node node$iv$iv$iv = this_$iv$iv$iv3.getDelegate();
                                            while (node$iv$iv$iv != null) {
                                                Modifier.Node next$iv$iv = node$iv$iv$iv;
                                                if ((next$iv$iv.getKindSet() & m4398constructorimpl) != 0) {
                                                    count$iv$iv2++;
                                                    if (count$iv$iv2 == 1) {
                                                        node2 = next$iv$iv;
                                                        success2 = success3;
