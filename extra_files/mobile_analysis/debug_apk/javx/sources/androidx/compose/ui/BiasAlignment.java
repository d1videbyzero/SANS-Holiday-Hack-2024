...
public final /* data */ class BiasAlignment implements Alignment {
    ...
    public long mo2598alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        ...
        float centerX = (IntSize.m5376getWidthimpl(space) - IntSize.m5376getWidthimpl(size)) / 2.0f;
        float centerY = (IntSize.m5375getHeightimpl(space) - IntSize.m5375getHeightimpl(size)) / 2.0f;
