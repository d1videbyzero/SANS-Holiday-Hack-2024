...
public final class LinearGradient extends ShaderBrush {
    ...
    */
    ...
    public Shader mo2916createShaderuvyYCjk(long size) {
        ...
        return ShaderKt.m3255LinearGradientShaderVjE6UOU(OffsetKt.Offset(startX, startY), OffsetKt.Offset(endX, endY), this.colors, this.stops, this.tileMode);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof LinearGradient) && Intrinsics.areEqual(this.colors, ((LinearGradient) other).colors) && Intrinsics.areEqual(this.stops, ((LinearGradient) other).stops) && Offset.m2705equalsimpl0(this.start, ((LinearGradient) other).start) && Offset.m2705equalsimpl0(this.end, ((LinearGradient) other).end) && TileMode.m3309equalsimpl0(this.tileMode, ((LinearGradient) other).tileMode);
    }
    ...
    public int hashCode() {
        ...
        return (((((result2 * 31) + Offset.m2710hashCodeimpl(this.start)) * 31) + Offset.m2710hashCodeimpl(this.end)) * 31) + TileMode.m3310hashCodeimpl(this.tileMode);
    }
    ...
    public String toString() {
        ...
        return "LinearGradient(colors=" + this.colors + ", stops=" + this.stops + ", " + startValue + endValue + "tileMode=" + ((Object) TileMode.m3311toStringimpl(this.tileMode)) + ')';
    }
}
