...
public final class VectorComposeKt {
    ...
    */
    ...
    public static final void m3581Path9cdaXJ4(final List<? extends PathNode> pathData, int pathFillType, String name, Brush fill, float fillAlpha, Brush stroke, float strokeAlpha, float strokeLineWidth, int strokeLineCap, int strokeLineJoin, float strokeLineMiter, float trimPathStart, float trimPathEnd, float trimPathOffset, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        Updater.m2588setimpl($this$Path_9cdaXJ4_u24lambda_u242, PathFillType.m3216boximpl(pathFillType2), new Function2<PathComponent, PathFillType, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComposeKt$Path$2$3
            @Override // kotlin.jvm.functions.Function2
            public /* bridge */ /* synthetic */ Unit invoke(PathComponent pathComponent, PathFillType pathFillType3) {
                m3583invokepweu1eQ(pathComponent, pathFillType3.getValue());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-pweu1eQ, reason: not valid java name */
            public final void m3583invokepweu1eQ(PathComponent set, int it) {
                Intrinsics.checkNotNullParameter(set, "$this$set");
                set.m3578setPathFillTypeoQ8Xj4U(it);
            }
        });
        ...
        Updater.m2588setimpl($this$Path_9cdaXJ4_u24lambda_u242, StrokeJoin.m3296boximpl(strokeLineJoin2), new Function2<PathComponent, StrokeJoin, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComposeKt$Path$2$9
            @Override // kotlin.jvm.functions.Function2
            public /* bridge */ /* synthetic */ Unit invoke(PathComponent pathComponent, StrokeJoin strokeJoin) {
                m3584invokekLtJ_vA(pathComponent, strokeJoin.getValue());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-kLtJ_vA, reason: not valid java name */
            public final void m3584invokekLtJ_vA(PathComponent set, int it) {
                Intrinsics.checkNotNullParameter(set, "$this$set");
                set.m3580setStrokeLineJoinWw9F2mQ(it);
            }
        });
        Updater.m2588setimpl($this$Path_9cdaXJ4_u24lambda_u242, StrokeCap.m3286boximpl(strokeLineCap2), new Function2<PathComponent, StrokeCap, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComposeKt$Path$2$10
            @Override // kotlin.jvm.functions.Function2
            public /* bridge */ /* synthetic */ Unit invoke(PathComponent pathComponent, StrokeCap strokeCap) {
                m3582invokeCSYIeUk(pathComponent, strokeCap.getValue());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-CSYIeUk, reason: not valid java name */
            public final void m3582invokeCSYIeUk(PathComponent set, int it) {
                Intrinsics.checkNotNullParameter(set, "$this$set");
                set.m3579setStrokeLineCapBeK7IIE(it);
            }
        });
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComposeKt$Path$3
            ...
            public final void invoke(Composer composer, int i5) {
                VectorComposeKt.m3581Path9cdaXJ4(pathData, i2, str, brush, f, brush2, f2, f3, i3, i4, f4, f5, f6, f7, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
            }
        });
    }
}
