...
public final class TransformOrigin {
    ...
    public static final /* synthetic */ TransformOrigin m3318boximpl(long j) {
    ...
    public static int m3328hashCodeimpl(long j) {
        return Long.hashCode(j);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3329toStringimpl(long j) {
        return "TransformOrigin(packedValue=" + j + ')';
    }

    public boolean equals(Object obj) {
        return m3324equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m3328hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m3329toStringimpl(this.packedValue);
    }
    ...
    public static final float m3326getPivotFractionXimpl(long arg0) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
        return Float.intBitsToFloat((int) (arg0 >> 32));
    }

    /* renamed from: getPivotFractionY-impl, reason: not valid java name */
    public static final float m3327getPivotFractionYimpl(long arg0) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
        return Float.intBitsToFloat((int) (4294967295L & arg0));
    }

    /* renamed from: component1-impl, reason: not valid java name */
    public static final float m3319component1impl(long arg0) {
        return m3326getPivotFractionXimpl(arg0);
    }

    /* renamed from: component2-impl, reason: not valid java name */
    public static final float m3320component2impl(long arg0) {
        return m3327getPivotFractionYimpl(arg0);
    }

    /* renamed from: copy-zey9I6w$default, reason: not valid java name */
    public static /* synthetic */ long m3323copyzey9I6w$default(long j, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = m3326getPivotFractionXimpl(j);
        }
        if ((i & 2) != 0) {
            f2 = m3327getPivotFractionYimpl(j);
        }
        return m3322copyzey9I6w(j, f, f2);
    }

    /* renamed from: copy-zey9I6w, reason: not valid java name */
    public static final long m3322copyzey9I6w(long arg0, float pivotFractionX, float pivotFractionY) {
    ...
    public static final class Companion {
        ...
        public final long m3331getCenterSzJe1aQ() {
