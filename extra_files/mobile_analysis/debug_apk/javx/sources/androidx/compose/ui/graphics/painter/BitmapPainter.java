...
public final class BitmapPainter extends Painter {
    ...
    */
    ...
    private BitmapPainter(ImageBitmap image, long srcOffset, long srcSize) {
        ...
        this.filterQuality = FilterQuality.INSTANCE.m3043getLowfv9h1I();
        this.size = m3557validateSizeN5eqBDc(this.srcOffset, this.srcSize);
        this.alpha = 1.0f;
    }
    ...
    public final void m3560setFilterQualityvDHp3xo$ui_graphics_release(int i) {
    ...
    protected void onDraw(DrawScope $this$onDraw) {
        ...
        DrawScope.m3474drawImageAZ2fEMs$default($this$onDraw, this.image, this.srcOffset, this.srcSize, 0L, IntSizeKt.IntSize(MathKt.roundToInt(Size.m2777getWidthimpl($this$onDraw.mo3490getSizeNHjbRc())), MathKt.roundToInt(Size.m2774getHeightimpl($this$onDraw.mo3490getSizeNHjbRc()))), this.alpha, null, this.colorFilter, 0, this.filterQuality, 328, null);
    }

    @Override // androidx.compose.ui.graphics.painter.Painter
    /* renamed from: getIntrinsicSize-NH-jbRc, reason: not valid java name */
    public long mo3559getIntrinsicSizeNHjbRc() {
    ...
    private final long m3557validateSizeN5eqBDc(long srcOffset, long srcSize) {
        if (!(IntOffset.m5334getXimpl(srcOffset) >= 0 && IntOffset.m5335getYimpl(srcOffset) >= 0 && IntSize.m5376getWidthimpl(srcSize) >= 0 && IntSize.m5375getHeightimpl(srcSize) >= 0 && IntSize.m5376getWidthimpl(srcSize) <= this.image.getWidth() && IntSize.m5375getHeightimpl(srcSize) <= this.image.getHeight())) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof BitmapPainter) && Intrinsics.areEqual(this.image, ((BitmapPainter) other).image) && IntOffset.m5333equalsimpl0(this.srcOffset, ((BitmapPainter) other).srcOffset) && IntSize.m5374equalsimpl0(this.srcSize, ((BitmapPainter) other).srcSize) && FilterQuality.m3038equalsimpl0(this.filterQuality, ((BitmapPainter) other).filterQuality);
    }

    public int hashCode() {
        int result = this.image.hashCode();
        return (((((result * 31) + IntOffset.m5336hashCodeimpl(this.srcOffset)) * 31) + IntSize.m5377hashCodeimpl(this.srcSize)) * 31) + FilterQuality.m3039hashCodeimpl(this.filterQuality);
    }

    public String toString() {
        return "BitmapPainter(image=" + this.image + ", srcOffset=" + ((Object) IntOffset.m5341toStringimpl(this.srcOffset)) + ", srcSize=" + ((Object) IntSize.m5379toStringimpl(this.srcSize)) + ", filterQuality=" + ((Object) FilterQuality.m3040toStringimpl(this.filterQuality)) + ')';
    }
}
