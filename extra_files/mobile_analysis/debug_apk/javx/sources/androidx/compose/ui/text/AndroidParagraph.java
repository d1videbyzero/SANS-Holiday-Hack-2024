...
public final class AndroidParagraph implements Paragraph {
    ...
    private AndroidParagraph(AndroidParagraphIntrinsics paragraphIntrinsics, int maxLines, boolean ellipsis, long constraints) {
        ...
        if (!(Constraints.m5173getMinHeightimpl(this.constraints) == 0 && Constraints.m5174getMinWidthimpl(this.constraints) == 0)) {
        ...
        alignment = AndroidParagraph_androidKt.m4594toLayoutAlignAMY3VfE(style.m4753getTextAlignbuA522U());
        TextAlign m4753getTextAlignbuA522U = style.m4753getTextAlignbuA522U();
        int justificationMode = m4753getTextAlignbuA522U == null ? false : TextAlign.m5084equalsimpl0(m4753getTextAlignbuA522U.getValue(), TextAlign.INSTANCE.m5090getJustifye0LSkKk()) ? 1 : 0;
        hyphens = AndroidParagraph_androidKt.m4596toLayoutHyphenationFrequency0_XeFpE(style.getParagraphStyle().getHyphens());
        LineBreak m4751getLineBreakLgCVezo = style.m4751getLineBreakLgCVezo();
        breakStrategy = AndroidParagraph_androidKt.m4595toLayoutBreakStrategyu6PBz3U(m4751getLineBreakLgCVezo != null ? LineBreak.Strategy.m5025boximpl(LineBreak.m5016getStrategyfcGXIks(m4751getLineBreakLgCVezo.getMask())) : null);
        LineBreak m4751getLineBreakLgCVezo2 = style.m4751getLineBreakLgCVezo();
        lineBreakStyle = AndroidParagraph_androidKt.m4597toLayoutLineBreakStyle4a2g8L8(m4751getLineBreakLgCVezo2 != null ? LineBreak.Strictness.m5035boximpl(LineBreak.m5017getStrictnessusljTpc(m4751getLineBreakLgCVezo2.getMask())) : null);
        LineBreak m4751getLineBreakLgCVezo3 = style.m4751getLineBreakLgCVezo();
        lineBreakWordStyle = AndroidParagraph_androidKt.m4598toLayoutLineBreakWordStylegvcdTPQ(m4751getLineBreakLgCVezo3 != null ? LineBreak.WordBreak.m5046boximpl(LineBreak.m5018getWordBreakjp8hJ3c(m4751getLineBreakLgCVezo3.getMask())) : null);
        if (this.ellipsis) {
        ...
        if (this.ellipsis && firstLayout.getHeight() > Constraints.m5171getMaxHeightimpl(this.constraints) && this.maxLines > 1) {
            calculatedMaxLines = AndroidParagraph_androidKt.numberOfLinesThatFitMaxHeight(firstLayout, Constraints.m5171getMaxHeightimpl(this.constraints));
        ...
        getTextPaint$ui_text_release().m4961setBrush12SF9DM(style.getBrush(), SizeKt.Size(getWidth(), getHeight()), style.getAlpha());
        ShaderBrushSpan[] shaderBrushSpans = getShaderBrushSpans(this.layout);
        int length = shaderBrushSpans.length;
        for (int i3 = i; i3 < length; i3++) {
            shaderBrushSpans[i3].m4980setSizeuvyYCjk(SizeKt.Size(getWidth(), getHeight()));
        }
    ...
    public float getWidth() {
        return Constraints.m5172getMaxWidthimpl(this.constraints);
    }
    ...
    public int mo4584getOffsetForPositionk4lQ0M(long position) {
    ...
    public final void m4582fillBoundingBoxes8ffj60Q(long range, float[] array, int arrayStart) {
        Intrinsics.checkNotNullParameter(array, "array");
        this.layout.fillBoundingBoxes(TextRange.m4722getMinimpl(range), TextRange.m4721getMaximpl(range), array, arrayStart);
    }
    ...
    public long mo4585getWordBoundaryjx7JFs(int offset) {
    ...
    public void mo4587paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        AndroidTextPaint $this$paint_RPmYEkk_u24lambda_u248 = getTextPaint$ui_text_release();
        $this$paint_RPmYEkk_u24lambda_u248.m4962setColor8_81llA(color);
    ...
    public void mo4586paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        int currBlendMode = getTextPaint$ui_text_release().m4959getBlendMode0nO6VwU();
        AndroidTextPaint $this$paint_LG529CI_u24lambda_u249 = getTextPaint$ui_text_release();
        $this$paint_LG529CI_u24lambda_u249.m4962setColor8_81llA(color);
        ...
        $this$paint_LG529CI_u24lambda_u249.m4960setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text_release().m4960setBlendModes9anfk8(currBlendMode);
    }

    @Override // androidx.compose.ui.text.Paragraph
    /* renamed from: paint-hn5TExg, reason: not valid java name */
    public void mo4588painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        Intrinsics.checkNotNullParameter(brush, "brush");
        int currBlendMode = getTextPaint$ui_text_release().m4959getBlendMode0nO6VwU();
        AndroidTextPaint $this$paint_hn5TExg_u24lambda_u2410 = getTextPaint$ui_text_release();
        $this$paint_hn5TExg_u24lambda_u2410.m4961setBrush12SF9DM(brush, SizeKt.Size(getWidth(), getHeight()), alpha);
        ...
        $this$paint_hn5TExg_u24lambda_u2410.m4960setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text_release().m4960setBlendModes9anfk8(currBlendMode);
    }
