...
public final class Stroke extends DrawStyle {
    ...
    private static final int DefaultCap = StrokeCap.INSTANCE.m3293getButtKaPHkGw();
    private static final int DefaultJoin = StrokeJoin.INSTANCE.m3304getMiterLxFBmk8();
    ...
    public static final class Companion {
        ...
        public final int m3555getDefaultCapKaPHkGw() {
            return Stroke.DefaultCap;
        }

        /* renamed from: getDefaultJoin-LxFBmk8, reason: not valid java name */
        public final int m3556getDefaultJoinLxFBmk8() {
    ...
    public boolean equals(Object other) {
        ...
        if (this.width == ((Stroke) other).width) {
            return ((this.miter > ((Stroke) other).miter ? 1 : (this.miter == ((Stroke) other).miter ? 0 : -1)) == 0) && StrokeCap.m3289equalsimpl0(this.cap, ((Stroke) other).cap) && StrokeJoin.m3299equalsimpl0(this.join, ((Stroke) other).join) && Intrinsics.areEqual(this.pathEffect, ((Stroke) other).pathEffect);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int result2 = ((((((result * 31) + Float.hashCode(this.miter)) * 31) + StrokeCap.m3290hashCodeimpl(this.cap)) * 31) + StrokeJoin.m3300hashCodeimpl(this.join)) * 31;
        PathEffect pathEffect = this.pathEffect;
        return result2 + (pathEffect != null ? pathEffect.hashCode() : 0);
    }

    public String toString() {
        return "Stroke(width=" + this.width + ", miter=" + this.miter + ", cap=" + ((Object) StrokeCap.m3291toStringimpl(this.cap)) + ", join=" + ((Object) StrokeJoin.m3301toStringimpl(this.join)) + ", pathEffect=" + this.pathEffect + ')';
    }
}
