...
public abstract class Painter {
    ...
    public abstract long mo3559getIntrinsicSizeNHjbRc();
    ...
    public static /* synthetic */ void m3564drawx_KDEd0$default(Painter painter, DrawScope drawScope, long j, float f, ColorFilter colorFilter, int i, Object obj) {
        float f2;
        ...
        painter.m3565drawx_KDEd0(drawScope, j, f2, colorFilter2);
    }

    /* renamed from: draw-x_KDEd0, reason: not valid java name */
    public final void m3565drawx_KDEd0(DrawScope draw, long size, float alpha, ColorFilter colorFilter) {
        Intrinsics.checkNotNullParameter(draw, "$this$draw");
        configureAlpha(alpha);
        configureColorFilter(colorFilter);
        configureLayoutDirection(draw.getLayoutDirection());
        float right$iv = Size.m2777getWidthimpl(draw.mo3490getSizeNHjbRc()) - Size.m2777getWidthimpl(size);
        float bottom$iv = Size.m2774getHeightimpl(draw.mo3490getSizeNHjbRc()) - Size.m2774getHeightimpl(size);
