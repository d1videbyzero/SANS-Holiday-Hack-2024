...
public final /* data */ class IntRect {
    ...
    public final IntRect m5364translategyyYBs(long offset) {
        return new IntRect(this.left + IntOffset.m5334getXimpl(offset), this.top + IntOffset.m5335getYimpl(offset), this.right + IntOffset.m5334getXimpl(offset), this.bottom + IntOffset.m5335getYimpl(offset));
    }
    ...
    public final boolean m5353containsgyyYBs(long offset) {
        return IntOffset.m5334getXimpl(offset) >= this.left && IntOffset.m5334getXimpl(offset) < this.right && IntOffset.m5335getYimpl(offset) >= this.top && IntOffset.m5335getYimpl(offset) < this.bottom;
    }
