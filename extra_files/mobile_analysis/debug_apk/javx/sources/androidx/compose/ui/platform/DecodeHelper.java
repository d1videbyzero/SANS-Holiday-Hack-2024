...
public final class DecodeHelper {
    ...
    public final SpanStyle decodeSpanStyle() {
        ...
        while (this.parcel.dataAvail() > 1) {
            ...
            if (decodeByte == 1) {
                ...
                mutableSpanStyle.m4528setColor8_81llA(m4498decodeColor0d7_KjU());
            } else if (decodeByte == 2) {
                if (dataAvailable() < 5) {
                    break;
                }
                mutableSpanStyle.m4529setFontSizeR2X_6o(m4501decodeTextUnitXSAIIZE());
                ...
                mutableSpanStyle.m4530setFontStylemLjRB2g(FontStyle.m4816boximpl(m4499decodeFontStyle_LCdwA()));
            } else if (decodeByte == 5) {
                if (dataAvailable() < 1) {
                    break;
                }
                mutableSpanStyle.m4531setFontSynthesistDdu0R4(FontSynthesis.m4825boximpl(m4500decodeFontSynthesisGVVA2EU()));
                ...
                mutableSpanStyle.m4532setLetterSpacingR2X_6o(m4501decodeTextUnitXSAIIZE());
            } else if (decodeByte == 8) {
                if (dataAvailable() < 4) {
                    break;
                }
                mutableSpanStyle.m4527setBaselineShift_isdbwI(BaselineShift.m4981boximpl(m4496decodeBaselineShifty9eOQZs()));
                ...
                mutableSpanStyle.m4526setBackground8_81llA(m4498decodeColor0d7_KjU());
    ...
    public final long m4498decodeColor0d7_KjU() {
        return Color.m2943constructorimpl(m4497decodeULongsVKNKU());
    }

    /* renamed from: decodeTextUnit-XSAIIZE, reason: not valid java name */
    public final long m4501decodeTextUnitXSAIIZE() {
        long type;
        byte decodeByte = decodeByte();
        if (decodeByte == 1) {
            type = TextUnitType.INSTANCE.m5430getSpUIouoOA();
        } else {
            type = decodeByte == 2 ? TextUnitType.INSTANCE.m5429getEmUIouoOA() : TextUnitType.INSTANCE.m5431getUnspecifiedUIouoOA();
        }
        if (TextUnitType.m5425equalsimpl0(type, TextUnitType.INSTANCE.m5431getUnspecifiedUIouoOA())) {
            return TextUnit.INSTANCE.m5408getUnspecifiedXSAIIZE();
        }
        float value = decodeFloat();
        return TextUnitKt.m5409TextUnitanM5pPY(value, type);
    }
    ...
    public final int m4499decodeFontStyle_LCdwA() {
        byte decodeByte = decodeByte();
        return decodeByte == 0 ? FontStyle.INSTANCE.m4824getNormal_LCdwA() : decodeByte == 1 ? FontStyle.INSTANCE.m4823getItalic_LCdwA() : FontStyle.INSTANCE.m4824getNormal_LCdwA();
    }

    /* renamed from: decodeFontSynthesis-GVVA2EU, reason: not valid java name */
    public final int m4500decodeFontSynthesisGVVA2EU() {
        byte decodeByte = decodeByte();
        return decodeByte == 0 ? FontSynthesis.INSTANCE.m4835getNoneGVVA2EU() : decodeByte == 1 ? FontSynthesis.INSTANCE.m4834getAllGVVA2EU() : decodeByte == 3 ? FontSynthesis.INSTANCE.m4836getStyleGVVA2EU() : decodeByte == 2 ? FontSynthesis.INSTANCE.m4837getWeightGVVA2EU() : FontSynthesis.INSTANCE.m4835getNoneGVVA2EU();
    }

    /* renamed from: decodeBaselineShift-y9eOQZs, reason: not valid java name */
    private final float m4496decodeBaselineShifty9eOQZs() {
        return BaselineShift.m4982constructorimpl(decodeFloat());
    }
    ...
    private final Shadow decodeShadow() {
        return new Shadow(m4498decodeColor0d7_KjU(), OffsetKt.Offset(decodeFloat(), decodeFloat()), decodeFloat(), null);
    }
    ...
    private final long m4497decodeULongsVKNKU() {
        return ULong.m5681constructorimpl(this.parcel.readLong());
    }
