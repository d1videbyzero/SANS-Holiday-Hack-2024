...
public final class ReusableGraphicsLayerScope implements GraphicsLayerScope {
    ...
    private long transformOrigin = TransformOrigin.INSTANCE.m3331getCenterSzJe1aQ();
    private Shape shape = RectangleShapeKt.getRectangleShape();
    private int compositingStrategy = CompositingStrategy.INSTANCE.m3032getAutoNrFUSI();
    ...
    public void mo3135setSpotShadowColor8_81llA(long j) {
    ...
    public void mo3136setTransformOrigin__ExYCQ(long j) {
    ...
    public void mo3134setCompositingStrategyaDBOjCE(int i) {
    ...
    public void m3252setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public final void reset() {
        ...
        mo3133setAmbientShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        mo3135setSpotShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        setRotationX(0.0f);
        setRotationY(0.0f);
        setRotationZ(0.0f);
        setCameraDistance(8.0f);
        mo3136setTransformOrigin__ExYCQ(TransformOrigin.INSTANCE.m3331getCenterSzJe1aQ());
        setShape(RectangleShapeKt.getRectangleShape());
        setClip(false);
        setRenderEffect(null);
        mo3134setCompositingStrategyaDBOjCE(CompositingStrategy.INSTANCE.m3032getAutoNrFUSI());
        m3252setSizeuvyYCjk(Size.INSTANCE.m2785getUnspecifiedNHjbRc());
    }
}
