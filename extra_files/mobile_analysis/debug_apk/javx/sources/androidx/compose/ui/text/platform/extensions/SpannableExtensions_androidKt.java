...
public final class SpannableExtensions_androidKt {
    ...
    public static final void setTextIndent(Spannable $this$setTextIndent, TextIndent textIndent, float contextFontSize, Density density) {
        ...
        if (textIndent != null) {
            if ((!TextUnit.m5394equalsimpl0(textIndent.getFirstLine(), TextUnitKt.getSp(0)) || !TextUnit.m5394equalsimpl0(textIndent.getRestLine(), TextUnitKt.getSp(0))) && !TextUnitKt.m5415isUnspecifiedR2X_6o(textIndent.getFirstLine()) && !TextUnitKt.m5415isUnspecifiedR2X_6o(textIndent.getRestLine())) {
                long m5396getTypeUIouoOA = TextUnit.m5396getTypeUIouoOA(textIndent.getFirstLine());
                float f = 0.0f;
                if (TextUnitType.m5425equalsimpl0(m5396getTypeUIouoOA, TextUnitType.INSTANCE.m5430getSpUIouoOA())) {
                    ...
                    firstLine = TextUnitType.m5425equalsimpl0(m5396getTypeUIouoOA, TextUnitType.INSTANCE.m5429getEmUIouoOA()) ? TextUnit.m5397getValueimpl(textIndent.getFirstLine()) * contextFontSize : 0.0f;
                }
                long m5396getTypeUIouoOA2 = TextUnit.m5396getTypeUIouoOA(textIndent.getRestLine());
                if (TextUnitType.m5425equalsimpl0(m5396getTypeUIouoOA2, TextUnitType.INSTANCE.m5430getSpUIouoOA())) {
                    f = density.mo326toPxR2X_6o(textIndent.getRestLine());
                } else if (TextUnitType.m5425equalsimpl0(m5396getTypeUIouoOA2, TextUnitType.INSTANCE.m5429getEmUIouoOA())) {
                    f = TextUnit.m5397getValueimpl(textIndent.getRestLine()) * contextFontSize;
                }
                float restLine = f;
    ...
    public static final void m4974setLineHeightKmRG4DE(Spannable setLineHeight, long lineHeight, float contextFontSize, Density density, LineHeightStyle lineHeightStyle) {
        Intrinsics.checkNotNullParameter(setLineHeight, "$this$setLineHeight");
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(lineHeightStyle, "lineHeightStyle");
        float resolvedLineHeight = m4969resolveLineHeightInPxo2QH7mI(lineHeight, contextFontSize, density);
        if (!Float.isNaN(resolvedLineHeight)) {
            ...
            setSpan(setLineHeight, new LineHeightStyleSpan(resolvedLineHeight, 0, endIndex, LineHeightStyle.Trim.m5073isTrimFirstLineTopimpl$ui_text_release(lineHeightStyle.getTrim()), LineHeightStyle.Trim.m5074isTrimLastLineBottomimpl$ui_text_release(lineHeightStyle.getTrim()), lineHeightStyle.getAlignment()), 0, setLineHeight.length());
        }
    }

    /* renamed from: setLineHeight-r9BaKPg, reason: not valid java name */
    public static final void m4975setLineHeightr9BaKPg(Spannable setLineHeight, long lineHeight, float contextFontSize, Density density) {
        Intrinsics.checkNotNullParameter(setLineHeight, "$this$setLineHeight");
        Intrinsics.checkNotNullParameter(density, "density");
        float resolvedLineHeight = m4969resolveLineHeightInPxo2QH7mI(lineHeight, contextFontSize, density);
        if (!Float.isNaN(resolvedLineHeight)) {
    ...
    private static final float m4969resolveLineHeightInPxo2QH7mI(long lineHeight, float contextFontSize, Density density) {
        long m5396getTypeUIouoOA = TextUnit.m5396getTypeUIouoOA(lineHeight);
        if (TextUnitType.m5425equalsimpl0(m5396getTypeUIouoOA, TextUnitType.INSTANCE.m5430getSpUIouoOA())) {
            return density.mo326toPxR2X_6o(lineHeight);
        }
        if (TextUnitType.m5425equalsimpl0(m5396getTypeUIouoOA, TextUnitType.INSTANCE.m5429getEmUIouoOA())) {
            return TextUnit.m5397getValueimpl(lineHeight) * contextFontSize;
        }
        return Float.NaN;
    }
    ...
    public static final void setSpanStyles(Spannable $this$setSpanStyles, TextStyle contextTextStyle, List<AnnotatedString.Range<SpanStyle>> spanStyles, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> resolveTypeface) {
        ...
        if (hasLetterSpacing) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (start2 >= 0 && start2 < $this$setSpanStyles.length() && end2 > start2 && end2 <= $this$setSpanStyles.length() && (it = m4968createLetterSpacingSpaneAf_CNQ(style.getLetterSpacing(), density)) != null) {
    ...
    private static final void setSpanStyle(Spannable $this$setSpanStyle, AnnotatedString.Range<SpanStyle> range, Density density) {
        ...
        m4971setBaselineShift0ocSgnM($this$setSpanStyle, style.getBaselineShift(), start, end);
        m4972setColorRPmYEkk($this$setSpanStyle, style.m4683getColor0d7_KjU(), start, end);
        ...
        m4973setFontSizeKmRG4DE($this$setSpanStyle, style.getFontSize(), density, start, end);
        ...
        m4970setBackgroundRPmYEkk($this$setSpanStyle, style.getBackground(), start, end);
    ...
    private static final void setFontAttributes(final Spannable $this$setFontAttributes, TextStyle contextTextStyle, List<AnnotatedString.Range<SpanStyle>> list, final Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        ...
        if (hasFontAttributes(contextTextStyle)) {
            contextFontSpanStyle = new SpanStyle(0L, 0L, contextTextStyle.getFontWeight(), contextTextStyle.m4747getFontStyle4Lr2A7w(), contextTextStyle.m4748getFontSynthesisZQGJjVo(), contextTextStyle.getFontFamily(), (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65475, (DefaultConstructorMarker) null);
        } else {
        ...
        flattenFontStylesAndApply(contextFontSpanStyle, fontRelatedSpanStyles, new Function3<SpanStyle, Integer, Integer, Unit>() { // from class: androidx.compose.ui.text.platform.extensions.SpannableExtensions_androidKt$setFontAttributes$1
            ...
            public final void invoke(SpanStyle spanStyle, int start, int end) {
                ...
                FontStyle m4816boximpl = FontStyle.m4816boximpl(fontStyle != null ? fontStyle.m4822unboximpl() : FontStyle.INSTANCE.m4824getNormal_LCdwA());
                FontSynthesis fontSynthesis = spanStyle.getFontSynthesis();
                spannable.setSpan(new TypefaceSpan(function42.invoke(fontFamily, fontWeight, m4816boximpl, FontSynthesis.m4825boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m4834getAllGVVA2EU()))), start, end, 33);
            }
        });
    }
    ...
    private static final MetricAffectingSpan m4968createLetterSpacingSpaneAf_CNQ(long letterSpacing, Density density) {
        long m5396getTypeUIouoOA = TextUnit.m5396getTypeUIouoOA(letterSpacing);
        if (TextUnitType.m5425equalsimpl0(m5396getTypeUIouoOA, TextUnitType.INSTANCE.m5430getSpUIouoOA())) {
            return new LetterSpacingSpanPx(density.mo326toPxR2X_6o(letterSpacing));
        }
        if (TextUnitType.m5425equalsimpl0(m5396getTypeUIouoOA, TextUnitType.INSTANCE.m5429getEmUIouoOA())) {
            return new LetterSpacingSpanEm(TextUnit.m5397getValueimpl(letterSpacing));
        }
        return null;
    }

    private static final boolean getNeedsLetterSpacingSpan(SpanStyle $this$needsLetterSpacingSpan) {
        return TextUnitType.m5425equalsimpl0(TextUnit.m5396getTypeUIouoOA($this$needsLetterSpacingSpan.getLetterSpacing()), TextUnitType.INSTANCE.m5430getSpUIouoOA()) || TextUnitType.m5425equalsimpl0(TextUnit.m5396getTypeUIouoOA($this$needsLetterSpacingSpan.getLetterSpacing()), TextUnitType.INSTANCE.m5429getEmUIouoOA());
    }
    ...
    public static final void m4970setBackgroundRPmYEkk(Spannable setBackground, long color, int start, int end) {
    ...
    public static final void m4973setFontSizeKmRG4DE(Spannable setFontSize, long fontSize, Density density, int start, int end) {
        Intrinsics.checkNotNullParameter(setFontSize, "$this$setFontSize");
        Intrinsics.checkNotNullParameter(density, "density");
        long m5396getTypeUIouoOA = TextUnit.m5396getTypeUIouoOA(fontSize);
        if (TextUnitType.m5425equalsimpl0(m5396getTypeUIouoOA, TextUnitType.INSTANCE.m5430getSpUIouoOA())) {
            ...
            setSpan(setFontSize, new RelativeSizeSpan(TextUnit.m5397getValueimpl(fontSize)), start, end);
        }
    }
    ...
    public static final void m4972setColorRPmYEkk(Spannable setColor, long color, int start, int end) {
    ...
    private static final void m4971setBaselineShift0ocSgnM(Spannable $this$setBaselineShift_u2d0ocSgnM, BaselineShift baselineShift, int start, int end) {
        if (baselineShift != null) {
            float it = baselineShift.m4987unboximpl();
    ...
    private static final void setBrush(Spannable $this$setBrush, Brush brush, float alpha, int start, int end) {
        if (brush != null) {
            if (brush instanceof SolidColor) {
                m4972setColorRPmYEkk($this$setBrush, ((SolidColor) brush).getValue(), start, end);
    ...
    private static final boolean hasFontAttributes(TextStyle $this$hasFontAttributes) {
        return TextPaintExtensions_androidKt.hasFontAttributes($this$hasFontAttributes.toSpanStyle()) || $this$hasFontAttributes.m4748getFontSynthesisZQGJjVo() != null;
    }
