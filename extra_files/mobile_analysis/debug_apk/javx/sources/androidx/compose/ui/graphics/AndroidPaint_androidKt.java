...
public final class AndroidPaint_androidKt {
    ...
    public static final void m2833setNativeBlendModeGB0RdKg(android.graphics.Paint setNativeBlendMode, int mode) {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            WrapperVerificationHelperMethods.INSTANCE.m3343setBlendModeGB0RdKg(setNativeBlendMode, mode);
        } else {
    ...
    public static final void m2838setNativeStyle5YerkU(android.graphics.Paint setNativeStyle, int value) {
        ...
        setNativeStyle.setStyle(PaintingStyle.m3204equalsimpl0(value, PaintingStyle.INSTANCE.m3209getStrokeTiuSbCo()) ? Paint.Style.STROKE : Paint.Style.FILL);
    }
    ...
    public static final int getNativeStyle(android.graphics.Paint $this$getNativeStyle) {
        ...
        return (style == null ? -1 : WhenMappings.$EnumSwitchMapping$0[style.ordinal()]) == 1 ? PaintingStyle.INSTANCE.m3209getStrokeTiuSbCo() : PaintingStyle.INSTANCE.m3208getFillTiuSbCo();
    }
    ...
    public static final void m2836setNativeStrokeCapCSYIeUk(android.graphics.Paint setNativeStrokeCap, int value) {
        ...
        if (StrokeCap.m3289equalsimpl0(value, StrokeCap.INSTANCE.m3295getSquareKaPHkGw())) {
            cap = Paint.Cap.SQUARE;
        } else if (StrokeCap.m3289equalsimpl0(value, StrokeCap.INSTANCE.m3294getRoundKaPHkGw())) {
            cap = Paint.Cap.ROUND;
        } else {
            cap = StrokeCap.m3289equalsimpl0(value, StrokeCap.INSTANCE.m3293getButtKaPHkGw()) ? Paint.Cap.BUTT : Paint.Cap.BUTT;
        }
    ...
    public static final void m2837setNativeStrokeJoinkLtJ_vA(android.graphics.Paint setNativeStrokeJoin, int value) {
        ...
        if (StrokeJoin.m3299equalsimpl0(value, StrokeJoin.INSTANCE.m3304getMiterLxFBmk8())) {
            join = Paint.Join.MITER;
        } else if (StrokeJoin.m3299equalsimpl0(value, StrokeJoin.INSTANCE.m3303getBevelLxFBmk8())) {
            join = Paint.Join.BEVEL;
        } else {
            join = StrokeJoin.m3299equalsimpl0(value, StrokeJoin.INSTANCE.m3305getRoundLxFBmk8()) ? Paint.Join.ROUND : Paint.Join.MITER;
        }
    ...
    public static final int getNativeFilterQuality(android.graphics.Paint $this$getNativeFilterQuality) {
        ...
        if (!$this$getNativeFilterQuality.isFilterBitmap()) {
            return FilterQuality.INSTANCE.m3045getNonefv9h1I();
        }
        return FilterQuality.INSTANCE.m3043getLowfv9h1I();
    }
    ...
    public static final void m2835setNativeFilterQuality50PEsBU(android.graphics.Paint setNativeFilterQuality, int value) {
        ...
        setNativeFilterQuality.setFilterBitmap(!FilterQuality.m3038equalsimpl0(value, FilterQuality.INSTANCE.m3045getNonefv9h1I()));
    }
