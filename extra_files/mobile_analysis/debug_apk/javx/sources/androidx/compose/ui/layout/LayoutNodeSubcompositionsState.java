...
public final class LayoutNodeSubcompositionsState {
    ...
    public LayoutNodeSubcompositionsState(LayoutNode root, SubcomposeSlotReusePolicy slotReusePolicy) {
        ...
        this.intermediateMeasurePolicy = new Function2<SubcomposeIntermediateMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState$intermediateMeasurePolicy$1
            ...
            public /* bridge */ /* synthetic */ MeasureResult invoke(SubcomposeIntermediateMeasureScope subcomposeIntermediateMeasureScope, Constraints constraints) {
                return m4204invoke0kLqBqw(subcomposeIntermediateMeasureScope, constraints.getValue());
            }

            /* renamed from: invoke-0kLqBqw, reason: not valid java name */
            public final MeasureResult m4204invoke0kLqBqw(SubcomposeIntermediateMeasureScope $this$null, long it) {
                Intrinsics.checkNotNullParameter($this$null, "$this$null");
                return $this$null.getLookaheadMeasurePolicy().invoke($this$null, Constraints.m5160boximpl(it));
            }
        };
    ...
    private final void subcompose(LayoutNode node, Object slotId, Function2<? super Composer, ? super Integer, Unit> content) {
        ...
        if (nodeState2 == null) {
            nodeState = new NodeState(slotId, ComposableSingletons$SubcomposeLayoutKt.INSTANCE.m4174getLambda1$ui_release(), null, 4, null);
        ...
        return new LayoutNode.NoIntrinsicsMeasurePolicy(str) { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState$createMeasurePolicy$1
            ...
            public MeasureResult mo13measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long constraints) {
                ...
                if (!isIntermediate) {
                    ...
                    intermediateMeasureScopeImpl.m4202setLookaheadConstraintsBRTryo0(constraints);
                    final MeasureResult result = block.invoke(LayoutNodeSubcompositionsState.this.scope, Constraints.m5160boximpl(constraints));
                    ...
                    intermediateMeasureScopeImpl2.m4203setLookaheadSizeozmzZPI(IntSizeKt.IntSize(result.getWidth(), result.getHeight()));
                ...
                return intermediateMeasurePolicy$ui_release.invoke(intermediateMeasureScopeImpl3, Constraints.m5160boximpl(constraints));
            }
        };
    }
    ...
    public final SubcomposeLayoutState.PrecomposedSlotHandle precompose(final Object slotId, Function2<? super Composer, ? super Integer, Unit> content) {
        ...
        return new SubcomposeLayoutState.PrecomposedSlotHandle() { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState$precompose$1
            ...
            public void mo4205premeasure0kLqBqw(int index, long constraints) {
                Map map;
                map = LayoutNodeSubcompositionsState.this.precomposeMap;
    ...
    final class IntermediateMeasureScopeImpl implements SubcomposeIntermediateMeasureScope, MeasureScope {
        ...
        public void m4203setLookaheadSizeozmzZPI(long j) {
        ...
        public void m4202setLookaheadConstraintsBRTryo0(long j) {
