...
public final class AndroidComposeView extends ViewGroup implements Owner, ViewRootForTest, PositionCalculator, DefaultLifecycleObserver {
    ...
    public AndroidComposeView(Context context, CoroutineContext coroutineContext) {
        ...
        this.keyInputModifier = KeyInputModifierKt.onKeyEvent(Modifier.INSTANCE, new Function1<KeyEvent, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m4481invokeZmokQxo(keyEvent.m3922unboximpl());
            }

            /* renamed from: invoke-ZmokQxo, reason: not valid java name */
            public final Boolean m4481invokeZmokQxo(android.view.KeyEvent it) {
                Intrinsics.checkNotNullParameter(it, "it");
                FocusDirection focusDirection = AndroidComposeView.this.mo4452getFocusDirectionP8AzH3I(it);
                if (focusDirection == null || !KeyEventType.m3926equalsimpl0(KeyEvent_androidKt.m3934getTypeZmokQxo(it), KeyEventType.INSTANCE.m3930getKeyDownCS__XNY())) {
                    return false;
                }
                return Boolean.valueOf(AndroidComposeView.this.getFocusOwner().mo2645moveFocus3ESFkO8(focusDirection.getValue()));
            }
        });
        ...
        this.viewToWindowMatrix = Matrix.m3172constructorimpl$default(null, 1, null);
        this.windowToViewMatrix = Matrix.m3172constructorimpl$default(null, 1, null);
        ...
        this._inputModeManager = new InputModeManagerImpl(isInTouchMode() ? InputMode.INSTANCE.m3616getTouchaOaMEAU() : InputMode.INSTANCE.m3615getKeyboardaOaMEAU(), new Function1<InputMode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$_inputModeManager$1
            {
                super(1);
            }
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(InputMode inputMode) {
                return m4480invokeiuPiT84(inputMode.getValue());
            }

            /* renamed from: invoke-iuPiT84, reason: not valid java name */
            public final Boolean m4480invokeiuPiT84(int it) {
                boolean z;
                if (InputMode.m3611equalsimpl0(it, InputMode.INSTANCE.m3616getTouchaOaMEAU())) {
                    z = AndroidComposeView.this.isInTouchMode();
                } else if (InputMode.m3611equalsimpl0(it, InputMode.INSTANCE.m3615getKeyboardaOaMEAU())) {
    ...
    public static final void touchModeChangeListener$lambda$3(AndroidComposeView this$0, boolean touchMode) {
        ...
        inputModeManagerImpl.m3619setInputModeiuPiT84(touchMode ? companion.m3616getTouchaOaMEAU() : companion.m3615getKeyboardaOaMEAU());
    }
    ...
    public static final void sendHoverExitEvent$lambda$5(AndroidComposeView this$0) {
        ...
        this$0.m4479sendMotionEvent8iAsVTc(lastEvent);
    }
    ...
    public boolean dispatchKeyEvent(android.view.KeyEvent event) {
        ...
        if (isFocused()) {
            this._windowInfo.m4548setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m4128constructorimpl(event.getMetaState()));
            return getFocusOwner().mo2647dispatchKeyEventZmokQxo(KeyEvent.m3917constructorimpl(event)) || super.dispatchKeyEvent(event);
        }
    ...
    public boolean dispatchKeyEventPreIme(android.view.KeyEvent event) {
        Intrinsics.checkNotNullParameter(event, "event");
        return (isFocused() && getFocusOwner().mo2646dispatchInterceptedSoftKeyboardEventZmokQxo(KeyEvent.m3917constructorimpl(event))) || super.dispatchKeyEventPreIme(event);
    }
                    ...
                    androidx.compose.ui.platform.AndroidComposeView$addAndroidView$1$onInitializeAccessibilityNodeInfo$parentId$1 r1 = new kotlin.jvm.functions.Function1<androidx.compose.ui.node.LayoutNode, java.lang.Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$addAndroidView$1$onInitializeAccessibilityNodeInfo$parentId$1
                        ...
                        public final java.lang.Boolean invoke(androidx.compose.ui.node.LayoutNode r4) {
                            /*
                                ...
                                r1 = 0
                                r2 = 8
                                int r1 = androidx.compose.ui.node.NodeKind.m4398constructorimpl(r2)
                                boolean r0 = r0.m4361hasH91voCI$ui_release(r1)
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        try {
            ...
            long $this$component2_u2dVKZWuLQ$iv = m4476convertMeasureSpecI7RO_PI(widthMeasureSpec);
            int minWidth = (int) ULong.m5681constructorimpl($this$component2_u2dVKZWuLQ$iv >>> 32);
            int maxWidth = (int) ULong.m5681constructorimpl($this$component2_u2dVKZWuLQ$iv & 4294967295L);
            try {
                long $this$component2_u2dVKZWuLQ$iv2 = m4476convertMeasureSpecI7RO_PI(heightMeasureSpec);
                int minHeight = (int) ULong.m5681constructorimpl($this$component2_u2dVKZWuLQ$iv2 >>> 32);
                int maxHeight = (int) ULong.m5681constructorimpl(4294967295L & $this$component2_u2dVKZWuLQ$iv2);
                long constraints = ConstraintsKt.Constraints(minWidth, maxWidth, minHeight, maxHeight);
                if (this.onMeasureConstraints == null) {
                    this.onMeasureConstraints = Constraints.m5160boximpl(constraints);
                    this.wasMeasuredWithMultipleConstraints = false;
                } else {
                    Constraints constraints2 = this.onMeasureConstraints;
                    if (!(constraints2 != null ? Constraints.m5165equalsimpl0(constraints2.getValue(), constraints) : false)) {
    ...
    private final int m4474component1VKZWuLQ(long $this$component1_u2dVKZWuLQ) {
        return (int) ULong.m5681constructorimpl($this$component1_u2dVKZWuLQ >>> 32);
    }

    /* renamed from: component2-VKZWuLQ, reason: not valid java name */
    private final int m4475component2VKZWuLQ(long $this$component2_u2dVKZWuLQ) {
        return (int) ULong.m5681constructorimpl(4294967295L & $this$component2_u2dVKZWuLQ);
    }

    /* renamed from: pack-ZIaKswc, reason: not valid java name */
    private final long m4478packZIaKswc(int a, int b) {
        return ULong.m5681constructorimpl(ULong.m5681constructorimpl(ULong.m5681constructorimpl(a) << 32) | ULong.m5681constructorimpl(b));
    }

    /* renamed from: convertMeasureSpec-I7RO_PI, reason: not valid java name */
    private final long m4476convertMeasureSpecI7RO_PI(int measureSpec) {
        int mode = View.MeasureSpec.getMode(measureSpec);
        int size = View.MeasureSpec.getSize(measureSpec);
        switch (mode) {
            case Integer.MIN_VALUE:
                return m4478packZIaKswc(0, size);
            case 0:
                return m4478packZIaKswc(0, Integer.MAX_VALUE);
            case 1073741824:
                return m4478packZIaKswc(size, size);
            default:
    ...
    private final void updatePositionCacheAndDispatch() {
        ...
        int globalX = IntOffset.m5326component1impl(j);
        int globalY = IntOffset.m5327component2impl(j);
    ...
    public FocusDirection mo4452getFocusDirectionP8AzH3I(android.view.KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "keyEvent");
        long m3933getKeyZmokQxo = KeyEvent_androidKt.m3933getKeyZmokQxo(keyEvent);
        if (Key.m3625equalsimpl0(m3933getKeyZmokQxo, Key.INSTANCE.m3861getTabEK5gGoQ())) {
            return FocusDirection.m2624boximpl(KeyEvent_androidKt.m3939isShiftPressedZmokQxo(keyEvent) ? FocusDirection.INSTANCE.m2642getPreviousdhqQ8s() : FocusDirection.INSTANCE.m2640getNextdhqQ8s());
        }
        if (Key.m3625equalsimpl0(m3933getKeyZmokQxo, Key.INSTANCE.m3702getDirectionRightEK5gGoQ())) {
            return FocusDirection.m2624boximpl(FocusDirection.INSTANCE.m2643getRightdhqQ8s());
        }
        if (Key.m3625equalsimpl0(m3933getKeyZmokQxo, Key.INSTANCE.m3701getDirectionLeftEK5gGoQ())) {
            return FocusDirection.m2624boximpl(FocusDirection.INSTANCE.m2639getLeftdhqQ8s());
        }
        if (Key.m3625equalsimpl0(m3933getKeyZmokQxo, Key.INSTANCE.m3703getDirectionUpEK5gGoQ())) {
            return FocusDirection.m2624boximpl(FocusDirection.INSTANCE.m2644getUpdhqQ8s());
        }
        if (Key.m3625equalsimpl0(m3933getKeyZmokQxo, Key.INSTANCE.m3698getDirectionDownEK5gGoQ())) {
            return FocusDirection.m2624boximpl(FocusDirection.INSTANCE.m2635getDowndhqQ8s());
        }
        if (Key.m3625equalsimpl0(m3933getKeyZmokQxo, Key.INSTANCE.m3697getDirectionCenterEK5gGoQ()) ? true : Key.m3625equalsimpl0(m3933getKeyZmokQxo, Key.INSTANCE.m3711getEnterEK5gGoQ()) ? true : Key.m3625equalsimpl0(m3933getKeyZmokQxo, Key.INSTANCE.m3803getNumPadEnterEK5gGoQ())) {
            return FocusDirection.m2624boximpl(FocusDirection.INSTANCE.m2636getEnterdhqQ8s());
        }
        if (Key.m3625equalsimpl0(m3933getKeyZmokQxo, Key.INSTANCE.m3640getBackEK5gGoQ()) ? true : Key.m3625equalsimpl0(m3933getKeyZmokQxo, Key.INSTANCE.m3714getEscapeEK5gGoQ())) {
    ...
    protected void onAttachedToWindow() {
        ...
        this._inputModeManager.m3619setInputModeiuPiT84(isInTouchMode() ? InputMode.INSTANCE.m3616getTouchaOaMEAU() : InputMode.INSTANCE.m3615getKeyboardaOaMEAU());
    ...
    public boolean dispatchGenericMotionEvent(MotionEvent event) {
        ...
        if (event.getActionMasked() == 8) {
            ...
            return ProcessResult.m4153getDispatchedToAPointerInputModifierimpl(m4477handleMotionEvent8iAsVTc(event));
        }
        return super.dispatchGenericMotionEvent(event);
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        int processResult = m4477handleMotionEvent8iAsVTc(motionEvent);
        if (ProcessResult.m4152getAnyMovementConsumedimpl(processResult)) {
            getParent().requestDisallowInterceptTouchEvent(true);
        }
        return ProcessResult.m4153getDispatchedToAPointerInputModifierimpl(processResult);
    }
    ...
    private final int m4477handleMotionEvent8iAsVTc(MotionEvent motionEvent) {
        boolean z;
        int i;
        MotionEvent lastEvent;
        ...
        try {
            ...
            try {
                ...
                return m4479sendMotionEvent8iAsVTc(motionEvent);
            } finally {
                Trace.endSection();
            }
        } finally {
    ...
    private final int m4479sendMotionEvent8iAsVTc(MotionEvent motionEvent) {
        Object item$iv;
        if (this.keyboardModifiersRequireUpdate) {
            this.keyboardModifiersRequireUpdate = false;
            this._windowInfo.m4548setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m4128constructorimpl(motionEvent.getMetaState()));
        }
        ...
        if (pointerInputEventData != null) {
            long it2 = pointerInputEventData.m4080getPositionF1C5BW0();
            this.lastDownPointerPosition = it2;
        }
        int result = this.pointerInputEventProcessor.m4085processBIzXfog(pointerInputEvent, this, isInBounds(motionEvent));
        int action = motionEvent.getActionMasked();
        if ((action != 0 && action != 5) || ProcessResult.m4153getDispatchedToAPointerInputModifierimpl(result)) {
            return result;
        }
    ...
    public final void sendSimulatedEvent(MotionEvent motionEvent, int action, long eventTime, boolean forceHover) {
        ...
        while (i4 < pointerCount) {
            ...
            long screenPosition = mo4146localToScreenMKHz9U(localPosition);
        ...
        this.pointerInputEventProcessor.m4085processBIzXfog(pointerInputEvent, this, true);
        event.recycle();
    }

    @Override // android.view.View
    public boolean canScrollHorizontally(int direction) {
        return this.accessibilityDelegate.m4484canScroll0AR0LA0$ui_release(false, direction, this.lastDownPointerPosition);
    }

    @Override // android.view.View
    public boolean canScrollVertically(int direction) {
        return this.accessibilityDelegate.m4484canScroll0AR0LA0$ui_release(true, direction, this.lastDownPointerPosition);
    }
    ...
    public long mo4146localToScreenMKHz9U(long localPosition) {
        recalculateWindowPosition();
        long local = Matrix.m3178mapMKHz9U(this.viewToWindowMatrix, localPosition);
    ...
    public long mo4147screenToLocalMKHz9U(long positionOnScreen) {
        recalculateWindowPosition();
        ...
        return Matrix.m3178mapMKHz9U(this.windowToViewMatrix, OffsetKt.Offset(x, y));
    }
    ...
    private final void recalculateWindowPosition(MotionEvent motionEvent) {
        ...
        recalculateWindowViewTransforms();
        long positionInWindow = Matrix.m3178mapMKHz9U(this.viewToWindowMatrix, OffsetKt.Offset(motionEvent.getX(), motionEvent.getY()));
    ...
    private final void recalculateWindowViewTransforms() {
        this.matrixToWindow.mo4491calculateMatrixToWindowEL8BTi8(this, this.viewToWindowMatrix);
        InvertMatrixKt.m4515invertToJiSxe2E(this.viewToWindowMatrix, this.windowToViewMatrix);
    }
    ...
    public long mo4450calculateLocalPositionMKHz9U(long positionInWindow) {
        recalculateWindowPosition();
        return Matrix.m3178mapMKHz9U(this.windowToViewMatrix, positionInWindow);
    }
    ...
    public long mo4451calculatePositionInWindowMKHz9U(long localPosition) {
        recalculateWindowPosition();
        return Matrix.m3178mapMKHz9U(this.viewToWindowMatrix, localPosition);
    }
    ...
    public boolean dispatchHoverEvent(MotionEvent event) {
        ...
        int result = m4477handleMotionEvent8iAsVTc(event);
        return ProcessResult.m4153getDispatchedToAPointerInputModifierimpl(result);
    }
