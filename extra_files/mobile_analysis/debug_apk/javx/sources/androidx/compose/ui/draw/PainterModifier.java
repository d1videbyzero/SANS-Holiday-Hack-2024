...
final class PainterModifier extends Modifier.Node implements LayoutModifierNode, DrawModifierNode {
    ...
    public MeasureResult mo239measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        final Placeable placeable = measurable.mo4184measureBRTryo0(m2618modifyConstraintsZezNO4M(constraints));
    ...
    public int minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, IntrinsicMeasurable measurable, int height) {
        ...
        if (getUseIntrinsicSize()) {
            ...
            return Math.max(Constraints.m5174getMinWidthimpl(constraints), layoutWidth);
        }
    ...
    public int minIntrinsicHeight(IntrinsicMeasureScope $this$minIntrinsicHeight, IntrinsicMeasurable measurable, int width) {
        ...
        if (getUseIntrinsicSize()) {
            ...
            return Math.max(Constraints.m5173getMinHeightimpl(constraints), layoutHeight);
        }
    ...
    private final long m2615calculateScaledSizeE7KxVPU(long dstSize) {
        ...
        if (!(Size.m2777getWidthimpl(dstSize) == 0.0f)) {
            if (!(Size.m2774getHeightimpl(dstSize) == 0.0f)) {
                return ScaleFactorKt.m4275timesUQTWf7w(srcSize, this.contentScale.mo4175computeScaleFactorH7hwNQA(srcSize, dstSize));
            }
        }
    ...
    private final long m2618modifyConstraintsZezNO4M(long constraints) {
        ...
        boolean hasBoundedDimens = Constraints.m5168getHasBoundedWidthimpl(constraints) && Constraints.m5167getHasBoundedHeightimpl(constraints);
        boolean hasFixedDimens = Constraints.m5170getHasFixedWidthimpl(constraints) && Constraints.m5169getHasFixedHeightimpl(constraints);
        if ((!getUseIntrinsicSize() && hasBoundedDimens) || hasFixedDimens) {
            m5162copyZbe2FdA2 = Constraints.m5162copyZbe2FdA(constraints, (r12 & 1) != 0 ? Constraints.m5174getMinWidthimpl(constraints) : Constraints.m5172getMaxWidthimpl(constraints), (r12 & 2) != 0 ? Constraints.m5172getMaxWidthimpl(constraints) : 0, (r12 & 4) != 0 ? Constraints.m5173getMinHeightimpl(constraints) : Constraints.m5171getMaxHeightimpl(constraints), (r12 & 8) != 0 ? Constraints.m5171getMaxHeightimpl(constraints) : 0);
            return m5162copyZbe2FdA2;
        }
        long intrinsicSize = this.painter.getIntrinsicSize();
        if (m2617hasSpecifiedAndFiniteWidthuvyYCjk(intrinsicSize)) {
            m5174getMinWidthimpl = MathKt.roundToInt(Size.m2777getWidthimpl(intrinsicSize));
        } else {
            m5174getMinWidthimpl = Constraints.m5174getMinWidthimpl(constraints);
        }
        int intrinsicWidth = m5174getMinWidthimpl;
        if (m2616hasSpecifiedAndFiniteHeightuvyYCjk(intrinsicSize)) {
            m5173getMinHeightimpl = MathKt.roundToInt(Size.m2774getHeightimpl(intrinsicSize));
        } else {
            m5173getMinHeightimpl = Constraints.m5173getMinHeightimpl(constraints);
        }
        int intrinsicHeight = m5173getMinHeightimpl;
        int constrainedWidth = ConstraintsKt.m5186constrainWidthK40F9xA(constraints, intrinsicWidth);
        int constrainedHeight = ConstraintsKt.m5185constrainHeightK40F9xA(constraints, intrinsicHeight);
        long scaledSize = m2615calculateScaledSizeE7KxVPU(SizeKt.Size(constrainedWidth, constrainedHeight));
        int minWidth = ConstraintsKt.m5186constrainWidthK40F9xA(constraints, MathKt.roundToInt(Size.m2777getWidthimpl(scaledSize)));
        int minHeight = ConstraintsKt.m5185constrainHeightK40F9xA(constraints, MathKt.roundToInt(Size.m2774getHeightimpl(scaledSize)));
        m5162copyZbe2FdA = Constraints.m5162copyZbe2FdA(constraints, (r12 & 1) != 0 ? Constraints.m5174getMinWidthimpl(constraints) : minWidth, (r12 & 2) != 0 ? Constraints.m5172getMaxWidthimpl(constraints) : 0, (r12 & 4) != 0 ? Constraints.m5173getMinHeightimpl(constraints) : minHeight, (r12 & 8) != 0 ? Constraints.m5171getMaxHeightimpl(constraints) : 0);
        return m5162copyZbe2FdA;
    }
    ...
    public void draw(ContentDrawScope $this$draw) {
        ...
        long intrinsicSize = this.painter.getIntrinsicSize();
        if (m2617hasSpecifiedAndFiniteWidthuvyYCjk(intrinsicSize)) {
            srcWidth = Size.m2777getWidthimpl(intrinsicSize);
        } else {
            srcWidth = Size.m2777getWidthimpl($this$draw.mo3490getSizeNHjbRc());
        }
        if (m2616hasSpecifiedAndFiniteHeightuvyYCjk(intrinsicSize)) {
            srcHeight = Size.m2774getHeightimpl(intrinsicSize);
        } else {
            srcHeight = Size.m2774getHeightimpl($this$draw.mo3490getSizeNHjbRc());
        }
        long srcSize = SizeKt.Size(srcWidth, srcHeight);
        if (!(Size.m2777getWidthimpl($this$draw.mo3490getSizeNHjbRc()) == 0.0f)) {
            if (!(Size.m2774getHeightimpl($this$draw.mo3490getSizeNHjbRc()) == 0.0f)) {
                scaledSize = ScaleFactorKt.m4275timesUQTWf7w(srcSize, this.contentScale.mo4175computeScaleFactorH7hwNQA(srcSize, $this$draw.mo3490getSizeNHjbRc()));
                long alignedPosition = this.alignment.mo2598alignKFBX0sM(IntSizeKt.IntSize(MathKt.roundToInt(Size.m2777getWidthimpl(scaledSize)), MathKt.roundToInt(Size.m2774getHeightimpl(scaledSize))), IntSizeKt.IntSize(MathKt.roundToInt(Size.m2777getWidthimpl($this$draw.mo3490getSizeNHjbRc())), MathKt.roundToInt(Size.m2774getHeightimpl($this$draw.mo3490getSizeNHjbRc()))), $this$draw.getLayoutDirection());
                float dx = IntOffset.m5334getXimpl(alignedPosition);
                float dy = IntOffset.m5335getYimpl(alignedPosition);
                ContentDrawScope $this$translate$iv = $this$draw;
                $this$translate$iv.getDrawContext().getTransform().translate(dx, dy);
                this.painter.m3565drawx_KDEd0($this$translate$iv, scaledSize, this.alpha, this.colorFilter);
                $this$translate$iv.getDrawContext().getTransform().translate(-dx, -dy);
                $this$draw.drawContent();
            }
        }
        scaledSize = Size.INSTANCE.m2786getZeroNHjbRc();
        long alignedPosition2 = this.alignment.mo2598alignKFBX0sM(IntSizeKt.IntSize(MathKt.roundToInt(Size.m2777getWidthimpl(scaledSize)), MathKt.roundToInt(Size.m2774getHeightimpl(scaledSize))), IntSizeKt.IntSize(MathKt.roundToInt(Size.m2777getWidthimpl($this$draw.mo3490getSizeNHjbRc())), MathKt.roundToInt(Size.m2774getHeightimpl($this$draw.mo3490getSizeNHjbRc()))), $this$draw.getLayoutDirection());
        float dx2 = IntOffset.m5334getXimpl(alignedPosition2);
        float dy2 = IntOffset.m5335getYimpl(alignedPosition2);
        ContentDrawScope $this$translate$iv2 = $this$draw;
        $this$translate$iv2.getDrawContext().getTransform().translate(dx2, dy2);
        this.painter.m3565drawx_KDEd0($this$translate$iv2, scaledSize, this.alpha, this.colorFilter);
        $this$translate$iv2.getDrawContext().getTransform().translate(-dx2, -dy2);
        $this$draw.drawContent();
    }
    ...
    private final boolean m2617hasSpecifiedAndFiniteWidthuvyYCjk(long $this$hasSpecifiedAndFiniteWidth_u2duvyYCjk) {
        ...
        float m2777getWidthimpl = Size.m2777getWidthimpl($this$hasSpecifiedAndFiniteWidth_u2duvyYCjk);
        return !Float.isInfinite(m2777getWidthimpl) && !Float.isNaN(m2777getWidthimpl);
    }
    ...
    private final boolean m2616hasSpecifiedAndFiniteHeightuvyYCjk(long $this$hasSpecifiedAndFiniteHeight_u2duvyYCjk) {
        ...
        float m2774getHeightimpl = Size.m2774getHeightimpl($this$hasSpecifiedAndFiniteHeight_u2duvyYCjk);
        return !Float.isInfinite(m2774getHeightimpl) && !Float.isNaN(m2774getHeightimpl);
    }
