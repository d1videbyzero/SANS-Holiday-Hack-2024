...
public final class Constraints {
    ...
    public static final /* synthetic */ Constraints m5160boximpl(long j) {
        return new Constraints(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m5161constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m5164equalsimpl(long j, Object obj) {
        return (obj instanceof Constraints) && j == ((Constraints) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m5165equalsimpl0(long j, long j2) {
        return j == j2;
    }
    ...
    public static int m5175hashCodeimpl(long j) {
    ...
    private static final int m5166getFocusIndeximpl(long arg0) {
        return (int) (3 & arg0);
    }

    /* renamed from: getMinWidth-impl, reason: not valid java name */
    public static final int m5174getMinWidthimpl(long arg0) {
        int mask = WidthMask[m5166getFocusIndeximpl(arg0)];
        return ((int) (arg0 >> MinFocusHeight)) & mask;
    }

    /* renamed from: getMaxWidth-impl, reason: not valid java name */
    public static final int m5172getMaxWidthimpl(long arg0) {
        int mask = WidthMask[m5166getFocusIndeximpl(arg0)];
    ...
    public static final int m5173getMinHeightimpl(long arg0) {
        int focus = m5166getFocusIndeximpl(arg0);
    ...
    public static final int m5171getMaxHeightimpl(long arg0) {
        int focus = m5166getFocusIndeximpl(arg0);
        int mask = HeightMask[focus];
    ...
    public static final boolean m5168getHasBoundedWidthimpl(long arg0) {
        int mask = WidthMask[m5166getFocusIndeximpl(arg0)];
        return (((int) (arg0 >> 33)) & mask) != 0;
    }

    /* renamed from: getHasBoundedHeight-impl, reason: not valid java name */
    public static final boolean m5167getHasBoundedHeightimpl(long arg0) {
        int focus = m5166getFocusIndeximpl(arg0);
        int mask = HeightMask[focus];
        int offset = MinHeightOffsets[focus] + 31;
    ...
    public static final boolean m5170getHasFixedWidthimpl(long arg0) {
        return m5172getMaxWidthimpl(arg0) == m5174getMinWidthimpl(arg0);
    }

    /* renamed from: getHasFixedHeight-impl, reason: not valid java name */
    public static final boolean m5169getHasFixedHeightimpl(long arg0) {
        return m5171getMaxHeightimpl(arg0) == m5173getMinHeightimpl(arg0);
    }

    /* renamed from: isZero-impl, reason: not valid java name */
    public static final boolean m5176isZeroimpl(long arg0) {
        return m5172getMaxWidthimpl(arg0) == 0 || m5171getMaxHeightimpl(arg0) == 0;
    }

    /* renamed from: copy-Zbe2FdA, reason: not valid java name */
    public static final long m5162copyZbe2FdA(long arg0, int minWidth, int maxWidth, int minHeight, int maxHeight) {
        boolean z = true;
        ...
        return INSTANCE.m5179createConstraintsZbe2FdA$ui_unit_release(minWidth, maxWidth, minHeight, maxHeight);
    }

    public String toString() {
        return m5177toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m5177toStringimpl(long arg0) {
        int maxWidth = m5172getMaxWidthimpl(arg0);
        String maxWidthStr = maxWidth == Integer.MAX_VALUE ? "Infinity" : String.valueOf(maxWidth);
        int maxHeight = m5171getMaxHeightimpl(arg0);
        String maxHeightStr = maxHeight != Integer.MAX_VALUE ? String.valueOf(maxHeight) : "Infinity";
        return "Constraints(minWidth = " + m5174getMinWidthimpl(arg0) + ", maxWidth = " + maxWidthStr + ", minHeight = " + m5173getMinHeightimpl(arg0) + ", maxHeight = " + maxHeightStr + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m5180fixedJhjzzOo(int width, int height) {
            if (!(width >= 0 && height >= 0)) {
                throw new IllegalArgumentException(("width(" + width + ") and height(" + height + ") must be >= 0").toString());
            }
            return m5179createConstraintsZbe2FdA$ui_unit_release(width, width, height, height);
        }

        /* renamed from: fixedWidth-OenEA2s, reason: not valid java name */
        public final long m5182fixedWidthOenEA2s(int width) {
            if (width >= 0) {
                return m5179createConstraintsZbe2FdA$ui_unit_release(width, width, 0, Integer.MAX_VALUE);
            }
            throw new IllegalArgumentException(("width(" + width + ") must be >= 0").toString());
        }

        /* renamed from: fixedHeight-OenEA2s, reason: not valid java name */
        public final long m5181fixedHeightOenEA2s(int height) {
            if (height >= 0) {
                return m5179createConstraintsZbe2FdA$ui_unit_release(0, Integer.MAX_VALUE, height, height);
            }
            throw new IllegalArgumentException(("height(" + height + ") must be >= 0").toString());
        }

        /* renamed from: createConstraints-Zbe2FdA$ui_unit_release, reason: not valid java name */
        public final long m5179createConstraintsZbe2FdA$ui_unit_release(int minWidth, int maxWidth, int minHeight, int maxHeight) {
            long focus;
            ...
            return Constraints.m5161constructorimpl(value);
        }
