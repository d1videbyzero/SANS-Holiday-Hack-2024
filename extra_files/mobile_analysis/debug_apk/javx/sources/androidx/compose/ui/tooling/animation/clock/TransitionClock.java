...
public final class TransitionClock<T> implements ComposeAnimationClock<TransitionBasedAnimation<T>, TargetState<T>> {
    ...
    public TransitionClock(TransitionBasedAnimation<T> animation) {
        ...
        this.state = new TargetState<>(getAnimation().m5143getAnimationObject().getCurrentState(), getAnimation().m5143getAnimationObject().getTargetState());
    }
    ...
    public List<ComposeAnimatedProperty> getAnimatedProperties() {
        Iterable $this$mapNotNull$iv = UtilsKt.allAnimations(getAnimation().m5143getAnimationObject());
    ...
    public long getMaxDurationPerIteration() {
        return UtilsKt.nanosToMillis(getAnimation().m5143getAnimationObject().getTotalDurationNanos());
    }
    ...
    public List<TransitionInfo> getTransitions(long stepMillis) {
        Transition transition = getAnimation().m5143getAnimationObject();
    ...
    public void setClockTime(long animationTimeNanos) {
        getAnimation().m5143getAnimationObject().seek(getState().getInitial(), getState().getTarget(), animationTimeNanos);
    }
}
