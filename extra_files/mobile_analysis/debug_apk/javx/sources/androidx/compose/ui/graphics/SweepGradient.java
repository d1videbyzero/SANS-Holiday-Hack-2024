    ...
    */
    ...
    public Shader mo2916createShaderuvyYCjk(long size) {
        ...
        if (OffsetKt.m2729isUnspecifiedk4lQ0M(this.center)) {
            Offset = SizeKt.m2787getCenteruvyYCjk(size);
        } else {
            Offset = OffsetKt.Offset((Offset.m2708getXimpl(this.center) > Float.POSITIVE_INFINITY ? 1 : (Offset.m2708getXimpl(this.center) == Float.POSITIVE_INFINITY ? 0 : -1)) == 0 ? Size.m2777getWidthimpl(size) : Offset.m2708getXimpl(this.center), Offset.m2709getYimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m2774getHeightimpl(size) : Offset.m2709getYimpl(this.center));
        }
        return ShaderKt.m3259SweepGradientShader9KIMszo(Offset, this.colors, this.stops);
    }
