    ...
    */
    public /* synthetic */ RadialGradient(java.util.List r10, java.util.List r11, long r12, float r14, int r15, int r16, kotlin.jvm.internal.DefaultConstructorMarker r17) {
        ...
        L8:
            ...
            int r0 = r0.m3313getClamp3opZhB0()
            r7 = r0
            goto L15
        L14:
            r7 = r15
    ...
    public Shader mo2916createShaderuvyYCjk(long size) {
        ...
        return ShaderKt.m3257RadialGradientShader8uybcMk(OffsetKt.Offset(centerX, centerY), this.radius == Float.POSITIVE_INFINITY ? Size.m2776getMinDimensionimpl(size) / 2 : this.radius, this.colors, this.stops, this.tileMode);
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RadialGradient) && Intrinsics.areEqual(this.colors, ((RadialGradient) other).colors) && Intrinsics.areEqual(this.stops, ((RadialGradient) other).stops) && Offset.m2705equalsimpl0(this.center, ((RadialGradient) other).center)) {
            return ((this.radius > ((RadialGradient) other).radius ? 1 : (this.radius == ((RadialGradient) other).radius ? 0 : -1)) == 0) && TileMode.m3309equalsimpl0(this.tileMode, ((RadialGradient) other).tileMode);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((result2 * 31) + Offset.m2710hashCodeimpl(this.center)) * 31) + Float.hashCode(this.radius)) * 31) + TileMode.m3310hashCodeimpl(this.tileMode);
    }
    ...
    public String toString() {
        ...
        return "RadialGradient(colors=" + this.colors + ", stops=" + this.stops + ", " + centerValue + radiusValue + "tileMode=" + ((Object) TileMode.m3311toStringimpl(this.tileMode)) + ')';
    }
}
