...
public final class AndroidPath implements Path {
    ...
    public int mo2840getFillTypeRgk1Os() {
        if (this.internalPath.getFillType() == Path.FillType.EVEN_ODD) {
            return PathFillType.INSTANCE.m3223getEvenOddRgk1Os();
        }
        return PathFillType.INSTANCE.m3224getNonZeroRgk1Os();
    }
    ...
    public void mo2842setFillTypeoQ8Xj4U(int value) {
        ...
        if (PathFillType.m3219equalsimpl0(value, PathFillType.INSTANCE.m3223getEvenOddRgk1Os())) {
    ...
    public boolean mo2841opN5in7k0(Path path1, Path path2, int operation) {
        ...
        if (PathOperation.m3228equalsimpl0(operation, PathOperation.INSTANCE.m3232getDifferenceb3I0S0c())) {
            op = Path.Op.DIFFERENCE;
        } else if (PathOperation.m3228equalsimpl0(operation, PathOperation.INSTANCE.m3233getIntersectb3I0S0c())) {
            op = Path.Op.INTERSECT;
        } else if (PathOperation.m3228equalsimpl0(operation, PathOperation.INSTANCE.m3234getReverseDifferenceb3I0S0c())) {
            op = Path.Op.REVERSE_DIFFERENCE;
        } else {
            op = PathOperation.m3228equalsimpl0(operation, PathOperation.INSTANCE.m3235getUnionb3I0S0c()) ? Path.Op.UNION : Path.Op.XOR;
        }
        android.graphics.Path path = this.internalPath;
