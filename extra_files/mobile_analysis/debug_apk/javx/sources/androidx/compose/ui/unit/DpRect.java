...
public final /* data */ class DpRect {
    ...
    public final DpRect m5297copya9UjIt4(float left, float top, float right, float bottom) {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5221equalsimpl0(this.left, dpRect.left) && Dp.m5221equalsimpl0(this.top, dpRect.top) && Dp.m5221equalsimpl0(this.right, dpRect.right) && Dp.m5221equalsimpl0(this.bottom, dpRect.bottom);
    }

    public int hashCode() {
        return (((((Dp.m5222hashCodeimpl(this.left) * 31) + Dp.m5222hashCodeimpl(this.top)) * 31) + Dp.m5222hashCodeimpl(this.right)) * 31) + Dp.m5222hashCodeimpl(this.bottom);
    }

    public String toString() {
        return "DpRect(left=" + ((Object) Dp.m5227toStringimpl(this.left)) + ", top=" + ((Object) Dp.m5227toStringimpl(this.top)) + ", right=" + ((Object) Dp.m5227toStringimpl(this.right)) + ", bottom=" + ((Object) Dp.m5227toStringimpl(this.bottom)) + ')';
    }
    ...
    */
    private DpRect(long r8, long r10) {
        /*
            r7 = this;
            float r1 = androidx.compose.ui.unit.DpOffset.m5277getXD9Ej5fM(r8)
            float r2 = androidx.compose.ui.unit.DpOffset.m5279getYD9Ej5fM(r8)
            float r0 = androidx.compose.ui.unit.DpOffset.m5277getXD9Ej5fM(r8)
            float r3 = androidx.compose.ui.unit.DpSize.m5314getWidthD9Ej5fM(r10)
            r4 = 0
            float r5 = r0 + r3
            float r3 = androidx.compose.ui.unit.Dp.m5216constructorimpl(r5)
            float r0 = androidx.compose.ui.unit.DpOffset.m5279getYD9Ej5fM(r8)
            float r4 = androidx.compose.ui.unit.DpSize.m5312getHeightD9Ej5fM(r10)
            r5 = 0
            float r6 = r0 + r4
            float r4 = androidx.compose.ui.unit.Dp.m5216constructorimpl(r6)
            r5 = 0
            r0 = r7
