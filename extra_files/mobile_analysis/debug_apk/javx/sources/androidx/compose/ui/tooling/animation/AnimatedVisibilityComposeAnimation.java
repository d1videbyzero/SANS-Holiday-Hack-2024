...
public final class AnimatedVisibilityComposeAnimation implements ComposeAnimation {
    ...
    public AnimatedVisibilityComposeAnimation(Transition<Boolean> animationObject, String label) {
        ...
        this.states = SetsKt.setOf((Object[]) new AnimatedVisibilityState[]{AnimatedVisibilityState.m5151boximpl(AnimatedVisibilityState.INSTANCE.m5158getEnterjXw82LU()), AnimatedVisibilityState.m5151boximpl(AnimatedVisibilityState.INSTANCE.m5159getExitjXw82LU())});
    }

    /* renamed from: getAnimationObject, reason: merged with bridge method [inline-methods] */
    public Transition<Boolean> m5144getAnimationObject() {
    ...
    public final Transition<Object> getChildTransition() {
        Object orNull = CollectionsKt.getOrNull(m5144getAnimationObject().getTransitions(), 0);
