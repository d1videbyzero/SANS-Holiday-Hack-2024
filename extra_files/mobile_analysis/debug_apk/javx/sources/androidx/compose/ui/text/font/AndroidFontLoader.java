...
public final class AndroidFontLoader implements PlatformFontLoader {
    ...
    public android.graphics.Typeface loadBlocking(Font font) {
        ...
        } else if (FontLoadingStrategy.m4806equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m4812getOptionalLocalPKNRLFQ())) {
            try {
                ...
                m5507constructorimpl = Result.m5507constructorimpl(load);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                m5507constructorimpl = Result.m5507constructorimpl(ResultKt.createFailure(th));
            }
            typeface = (android.graphics.Typeface) (Result.m5513isFailureimpl(m5507constructorimpl) ? null : m5507constructorimpl);
        } else {
            if (FontLoadingStrategy.m4806equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m4810getAsyncPKNRLFQ())) {
                throw new UnsupportedOperationException("Unsupported Async font load path");
            }
            throw new IllegalArgumentException("Unknown loading type " + ((Object) FontLoadingStrategy.m4808toStringimpl(font.getLoadingStrategy())));
        }
