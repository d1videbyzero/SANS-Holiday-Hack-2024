...
public final class FontListFontFamilyTypefaceAdapterKt {
    ...
    public static final Pair<List<Font>, Object> firstImmediatelyAvailable(List<? extends Font> list, TypefaceRequest typefaceRequest, AsyncTypefaceCache asyncTypefaceCache, PlatformFontLoader platformFontLoader, Function1<? super TypefaceRequest, ? extends Object> function1) {
        ...
        for (int idx = 0; idx < size; idx++) {
            ...
            if (!FontLoadingStrategy.m4806equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m4811getBlockingPKNRLFQ())) {
                if (!FontLoadingStrategy.m4806equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m4812getOptionalLocalPKNRLFQ())) {
                    if (!FontLoadingStrategy.m4806equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m4810getAsyncPKNRLFQ())) {
                        throw new IllegalStateException("Unknown font type " + font);
                    }
                    AsyncTypefaceCache.AsyncTypefaceResult cacheResult = asyncTypefaceCache.m4775get1ASDuI8(font, platformFontLoader);
                    if (cacheResult == null) {
                    ...
                    } else if (!AsyncTypefaceCache.AsyncTypefaceResult.m4781isPermanentFailureimpl(cacheResult.m4783unboximpl()) && cacheResult.m4783unboximpl() != null) {
                        return TuplesKt.to(asyncFontsToLoad, FontSynthesis_androidKt.m4838synthesizeTypefaceFxwP2eA(typefaceRequest.m4863getFontSynthesisGVVA2EU(), cacheResult.m4783unboximpl(), font, typefaceRequest.getFontWeight(), typefaceRequest.m4862getFontStyle_LCdwA()));
                    }
                } else {
                    ...
                    synchronized (lock$iv$iv) {
                        ...
                        if (priorResult$iv == null) {
                            ...
                            try {
                                ...
                                it$iv = Result.m5507constructorimpl(platformFontLoader.loadBlocking(font));
                            } catch (Throwable th) {
                                Result.Companion companion2 = Result.INSTANCE;
                                it$iv = Result.m5507constructorimpl(ResultKt.createFailure(th));
                            }
                            if (Result.m5513isFailureimpl(it$iv)) {
                                it$iv = null;
                            }
                            AsyncTypefaceCache.put$default(asyncTypefaceCache, font, platformFontLoader, it$iv, false, 8, null);
                            obj = it$iv;
                        } else {
                            obj = priorResult$iv.m4783unboximpl();
                        }
                    }
                    Object result2 = obj;
                    if (result2 != null) {
                        return TuplesKt.to(asyncFontsToLoad, FontSynthesis_androidKt.m4838synthesizeTypefaceFxwP2eA(typefaceRequest.m4863getFontSynthesisGVVA2EU(), result2, font, typefaceRequest.getFontWeight(), typefaceRequest.m4862getFontStyle_LCdwA()));
                    }
                }
            } else {
                ...
                synchronized (lock$iv$iv2) {
                    ...
                    if (priorResult$iv2 == null) {
                        ...
                        result = priorResult$iv2.m4783unboximpl();
                    }
                }
                if (result == null) {
                    throw new IllegalStateException("Unable to load font " + font);
                }
                return TuplesKt.to(asyncFontsToLoad, FontSynthesis_androidKt.m4838synthesizeTypefaceFxwP2eA(typefaceRequest.m4863getFontSynthesisGVVA2EU(), result, font, typefaceRequest.getFontWeight(), typefaceRequest.m4862getFontStyle_LCdwA()));
            }
        }
