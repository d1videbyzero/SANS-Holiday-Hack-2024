...
public final class LayoutNodeLayoutDelegate {
    ...
    public final class MeasurePassDelegate extends Placeable implements Measurable, AlignmentLinesOwner {
        ...
        private long lastPosition = IntOffset.INSTANCE.m5344getZeronOccac();
        ...
        public final Constraints m4345getLastConstraintsDWUhwKw() {
            if (this.measuredOnce) {
                return Constraints.m5160boximpl(getMeasurementConstraints());
            }
            return null;
        }
        ...
        public Placeable mo4184measureBRTryo0(long constraints) {
            ...
            if (LayoutNodeLayoutDelegate.this.isOutMostLookaheadRoot(LayoutNodeLayoutDelegate.this.layoutNode)) {
                ...
                $this$measure_BRTryo0_u24lambda_u2412.mo4184measureBRTryo0(constraints);
            }
        ...
        public final boolean m4346remeasureBRTryo0(long constraints) {
            ...
            if (!LayoutNodeLayoutDelegate.this.layoutNode.getMeasurePending$ui_release() && Constraints.m5165equalsimpl0(getMeasurementConstraints(), constraints)) {
            ...
            this.measuredOnce = true;
            long outerPreviousMeasuredSize = LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo4191getSizeYbymL2g();
            m4240setMeasurementConstraintsBRTryo0(constraints);
            LayoutNodeLayoutDelegate.this.m4338performMeasureBRTryo0(constraints);
            if (IntSize.m5374equalsimpl0(LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo4191getSizeYbymL2g(), outerPreviousMeasuredSize) && LayoutNodeLayoutDelegate.this.getOuterCoordinator().getWidth() == getWidth() && LayoutNodeLayoutDelegate.this.getOuterCoordinator().getHeight() == getHeight()) {
                sizeChanged = false;
            }
            m4239setMeasuredSizeozmzZPI(IntSizeKt.IntSize(LayoutNodeLayoutDelegate.this.getOuterCoordinator().getWidth(), LayoutNodeLayoutDelegate.this.getOuterCoordinator().getHeight()));
            return sizeChanged;
        }
        ...
        public void mo4185placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            if (!IntOffset.m5333equalsimpl0(position, this.lastPosition)) {
            ...
            if (LayoutNodeLayoutDelegate.this.isOutMostLookaheadRoot(LayoutNodeLayoutDelegate.this.layoutNode)) {
                ...
                Placeable.PlacementScope.place$default($this$placeAt_f8xVGno_u24lambda_u2416, it, IntOffset.m5334getXimpl(position), IntOffset.m5335getYimpl(position), 0.0f, 4, null);
            }
            ...
            if (!LayoutNodeLayoutDelegate.this.getLayoutPending() && getIsPlaced()) {
                ...
                snapshotObserver.observeLayoutModifierSnapshotReads$ui_release(layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$MeasurePassDelegate$placeOuterCoordinator$1
                    ...
                    public final void invoke2() {
                        ...
                        float f = zIndex;
                        if (function1 == null) {
                            $this$invoke_u24lambda_u240.m4245place70tqf50(layoutNodeLayoutDelegate2.getOuterCoordinator(), j, f);
                        } else {
                            $this$invoke_u24lambda_u240.m4250placeWithLayeraW9wM(layoutNodeLayoutDelegate2.getOuterCoordinator(), j, f, function1);
                        }
                    }
                });
            }
        ...
        public final void measureBasedOnLookahead() {
            ...
            if (lookaheadDelegate.getMeasuredByParent() == LayoutNode.UsageByParent.InMeasureBlock && parent.getLayoutState$ui_release() == LayoutNode.LayoutState.Measuring) {
                ...
                mo4184measureBRTryo0(lookaheadConstraints.getValue());
                ...
                mo4184measureBRTryo0(lookaheadConstraints2.getValue());
            }
        }
        ...
        public final void placeBasedOnLookahead() {
            ...
            mo4185placeAtf8xVGno(lookaheadDelegate.getLastPosition(), lookaheadDelegate.getLastZIndex(), lookaheadDelegate.getLastLayerBlock$ui_release());
        }
    }
    ...
    public final class LookaheadPassDelegate extends Placeable implements Measurable, AlignmentLinesOwner {
        ...
        public final boolean m4343remeasureBRTryo0(long constraints) {
            ...
            if (!LayoutNodeLayoutDelegate.this.layoutNode.getLookaheadMeasurePending$ui_release()) {
                ...
                if (constraints2 == null ? false : Constraints.m5165equalsimpl0(constraints2.getValue(), constraints)) {
            ...
            this.lookaheadConstraints = Constraints.m5160boximpl(constraints);
            getAlignmentLines().setUsedByModifierMeasurement$ui_release(false);
            ...
            m4239setMeasuredSizeozmzZPI(IntSizeKt.IntSize(lookaheadDelegate.getWidth(), lookaheadDelegate.getHeight()));
            if (IntSize.m5376getWidthimpl(lastLookaheadSize) == lookaheadDelegate.getWidth() && IntSize.m5375getHeightimpl(lastLookaheadSize) == lookaheadDelegate.getHeight()) {
                z = false;
            }
        ...
        @Override // androidx.compose.ui.layout.Placeable
        /* renamed from: placeAt-f8xVGno */
        public void mo4185placeAtf8xVGno(final long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            LayoutNodeLayoutDelegate.this.layoutState = LayoutNode.LayoutState.LookaheadLayingOut;
            this.placedOnce = true;
            if (!IntOffset.m5333equalsimpl0(position, this.lastPosition)) {
                if (LayoutNodeLayoutDelegate.this.getCoordinatesAccessedDuringModifierPlacement() || LayoutNodeLayoutDelegate.this.getCoordinatesAccessedDuringPlacement()) {
            ...
            if (!LayoutNodeLayoutDelegate.this.getLookaheadLayoutPending() && getIsPlaced()) {
                ...
                OwnerSnapshotObserver.observeLayoutModifierSnapshotReads$ui_release$default(snapshotObserver, layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$LookaheadPassDelegate$placeAt$1
                    ...
                    public final void invoke2() {
                        ...
                        Intrinsics.checkNotNull(lookaheadDelegate);
                        Placeable.PlacementScope.m4241place70tqf50$default($this$invoke_u24lambda_u240, lookaheadDelegate, j, 0.0f, 2, null);
                    }
                }, 2, null);
            }
            this.lastPosition = position;
        ...
        public final void replace() {
            try {
                ...
                mo4185placeAtf8xVGno(this.lastPosition, 0.0f, null);
            } finally {
                this.relayoutWithoutParentInProgress = false;
            }
        }
    ...
    public final void m4338performMeasureBRTryo0(final long constraints) {
        ...
        LayoutNodeKt.requireOwner(this.layoutNode).getSnapshotObserver().observeMeasureSnapshotReads$ui_release(this.layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$performMeasure$2
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2() {
                LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo4184measureBRTryo0(constraints);
            }
        });
    ...
    public final void m4337performLookaheadMeasureBRTryo0(final long constraints) {
        ...
        OwnerSnapshotObserver.observeMeasureSnapshotReads$ui_release$default(LayoutNodeKt.requireOwner(this.layoutNode).getSnapshotObserver(), this.layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$performLookaheadMeasure$1
            ...
            public final void invoke2() {
                LookaheadDelegate lookaheadDelegate = LayoutNodeLayoutDelegate.this.getOuterCoordinator().getLookaheadDelegate();
                Intrinsics.checkNotNull(lookaheadDelegate);
                lookaheadDelegate.mo4184measureBRTryo0(constraints);
            }
        }, 2, null);
