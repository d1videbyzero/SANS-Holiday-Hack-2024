...
public class AndroidViewHolder extends ViewGroup implements NestedScrollingParent3, ComposeNodeLifecycleCallback {
        ...
        layoutNode.setMeasurePolicy(new MeasurePolicy() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$5
            ...
            public MeasureResult mo13measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long constraints) {
                ...
                if (AndroidViewHolder.this.getChildCount() == 0) {
                    return MeasureScope.layout$default(measure, Constraints.m5174getMinWidthimpl(constraints), Constraints.m5173getMinHeightimpl(constraints), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$5$measure$1
                        @Override // kotlin.jvm.functions.Function1
                ...
                if (Constraints.m5174getMinWidthimpl(constraints) != 0) {
                    AndroidViewHolder.this.getChildAt(0).setMinimumWidth(Constraints.m5174getMinWidthimpl(constraints));
                }
                if (Constraints.m5173getMinHeightimpl(constraints) != 0) {
                    AndroidViewHolder.this.getChildAt(0).setMinimumHeight(Constraints.m5173getMinHeightimpl(constraints));
                }
                AndroidViewHolder androidViewHolder2 = AndroidViewHolder.this;
                AndroidViewHolder androidViewHolder3 = AndroidViewHolder.this;
                int m5174getMinWidthimpl = Constraints.m5174getMinWidthimpl(constraints);
                int m5172getMaxWidthimpl = Constraints.m5172getMaxWidthimpl(constraints);
                ViewGroup.LayoutParams layoutParams = AndroidViewHolder.this.getLayoutParams();
                Intrinsics.checkNotNull(layoutParams);
                obtainMeasureSpec = androidViewHolder3.obtainMeasureSpec(m5174getMinWidthimpl, m5172getMaxWidthimpl, layoutParams.width);
                AndroidViewHolder androidViewHolder4 = AndroidViewHolder.this;
                int m5173getMinHeightimpl = Constraints.m5173getMinHeightimpl(constraints);
                int m5171getMaxHeightimpl = Constraints.m5171getMaxHeightimpl(constraints);
                ViewGroup.LayoutParams layoutParams2 = AndroidViewHolder.this.getLayoutParams();
                Intrinsics.checkNotNull(layoutParams2);
                obtainMeasureSpec2 = androidViewHolder4.obtainMeasureSpec(m5173getMinHeightimpl, m5171getMaxHeightimpl, layoutParams2.height);
    ...
    public void onNestedScroll(View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type, int[] consumed) {
        ...
        if (isNestedScrollingEnabled()) {
            ...
            long consumedByParent = nestedScrollDispatcher.m3952dispatchPostScrollDzOQY0M(Offset, Offset2, nestedScrollSource);
    ...
    public void onNestedScroll(View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type) {
        ...
        if (isNestedScrollingEnabled()) {
            ...
            long Offset2 = OffsetKt.Offset(composeOffset3, composeOffset4);
            nestedScrollSource = AndroidViewHolder_androidKt.toNestedScrollSource(type);
            nestedScrollDispatcher.m3952dispatchPostScrollDzOQY0M(Offset, Offset2, nestedScrollSource);
        }
    }
    ...
    public void onNestedPreScroll(View target, int dx, int dy, int[] consumed, int type) {
        ...
        if (isNestedScrollingEnabled()) {
            ...
            long Offset = OffsetKt.Offset(composeOffset, composeOffset2);
            nestedScrollSource = AndroidViewHolder_androidKt.toNestedScrollSource(type);
            long consumedByParent = nestedScrollDispatcher.m3954dispatchPreScrollOzD1aCk(Offset, nestedScrollSource);
            consumed[0] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2708getXimpl(consumedByParent));
            consumed[1] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2709getYimpl(consumedByParent));
        }
    }
