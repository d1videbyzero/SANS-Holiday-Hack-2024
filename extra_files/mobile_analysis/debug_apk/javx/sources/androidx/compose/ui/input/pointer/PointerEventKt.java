...
public final class PointerEventKt {
    ...
    public static final boolean m4011isOutOfBoundsO0kMr_c(PointerInputChange isOutOfBounds, long size) {
    ...
    public static final boolean m4012isOutOfBoundsjwHxaWs(PointerInputChange isOutOfBounds, long size, long extendedTouchPadding) {
        Intrinsics.checkNotNullParameter(isOutOfBounds, "$this$isOutOfBounds");
        if (!PointerType.m4137equalsimpl0(isOutOfBounds.getType(), PointerType.INSTANCE.m4144getTouchT8wyACA())) {
            return m4011isOutOfBoundsO0kMr_c(isOutOfBounds, size);
        }
        long position = isOutOfBounds.getPosition();
        float x = Offset.m2708getXimpl(position);
        float y = Offset.m2709getYimpl(position);
        float minX = -Size.m2777getWidthimpl(extendedTouchPadding);
        float maxX = IntSize.m5376getWidthimpl(size) + Size.m2777getWidthimpl(extendedTouchPadding);
        float minY = -Size.m2774getHeightimpl(extendedTouchPadding);
        float maxY = IntSize.m5375getHeightimpl(size) + Size.m2774getHeightimpl(extendedTouchPadding);
