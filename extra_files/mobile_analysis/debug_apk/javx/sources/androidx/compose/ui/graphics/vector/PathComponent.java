...
public final class PathComponent extends VNode {
    ...
    public final void m3578setPathFillTypeoQ8Xj4U(int value) {
    ...
    public final void m3579setStrokeLineCapBeK7IIE(int value) {
    ...
    public final void m3580setStrokeLineJoinWw9F2mQ(int value) {
    ...
    public void draw(DrawScope $this$draw) {
        ...
        Brush it = this.fill;
        if (it != null) {
            DrawScope.m3480drawPathGBMwjPU$default($this$draw, this.renderPath, it, this.fillAlpha, null, null, 0, 56, null);
        }
        ...
        if (it2 != null) {
            ...
            DrawScope.m3480drawPathGBMwjPU$default($this$draw, this.renderPath, it2, this.strokeAlpha, targetStroke, null, 0, 48, null);
        }
    }
