...
public final class SolidColor extends Brush {
    ...
    public void mo2894applyToPq9zytI(long size, Paint p, float alpha) {
        ...
        p.setAlpha(1.0f);
        if (!(alpha == 1.0f)) {
            j = Color.m2945copywmQWz5c(r1, (r12 & 1) != 0 ? Color.m2949getAlphaimpl(r1) : Color.m2949getAlphaimpl(this.value) * alpha, (r12 & 2) != 0 ? Color.m2953getRedimpl(r1) : 0.0f, (r12 & 4) != 0 ? Color.m2952getGreenimpl(r1) : 0.0f, (r12 & 8) != 0 ? Color.m2950getBlueimpl(this.value) : 0.0f);
        } else {
            j = this.value;
        }
        p.mo2828setColor8_81llA(j);
        if (p.getShader() != null) {
            p.setShader(null);
        }
    }
