...
public final class RenderIntent {
    ...
    private static final int Perceptual = m3366constructorimpl(0);
    private static final int Relative = m3366constructorimpl(1);
    private static final int Saturation = m3366constructorimpl(2);
    private static final int Absolute = m3366constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ RenderIntent m3365boximpl(int i) {
        return new RenderIntent(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m3366constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3367equalsimpl(int i, Object obj) {
        return (obj instanceof RenderIntent) && i == ((RenderIntent) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3368equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m3369hashCodeimpl(int i) {
    ...
    public static String m3370toStringimpl(int arg0) {
        return m3368equalsimpl0(arg0, Perceptual) ? "Perceptual" : m3368equalsimpl0(arg0, Relative) ? "Relative" : m3368equalsimpl0(arg0, Saturation) ? "Saturation" : m3368equalsimpl0(arg0, Absolute) ? "Absolute" : "Unknown";
    }
