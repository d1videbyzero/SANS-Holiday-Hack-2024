    ...
    */
    private Connector(androidx.compose.ui.graphics.colorspace.ColorSpace r12, androidx.compose.ui.graphics.colorspace.ColorSpace r13, int r14) {
        /*
            ...
            long r2 = r2.m3354getRgbxdoWZVw()
            boolean r0 = androidx.compose.ui.graphics.colorspace.ColorModel.m3347equalsimpl0(r0, r2)
            r1 = 2
            r2 = 0
            if (r0 == 0) goto L2b
        ...
        L2c:
            ...
            long r7 = r0.m3354getRgbxdoWZVw()
            boolean r0 = androidx.compose.ui.graphics.colorspace.ColorModel.m3347equalsimpl0(r3, r7)
            if (r0 == 0) goto L48
            androidx.compose.ui.graphics.colorspace.Illuminant r0 = androidx.compose.ui.graphics.colorspace.Illuminant.INSTANCE
            androidx.compose.ui.graphics.colorspace.WhitePoint r0 = r0.getD50()
        ...
        L49:
            ...
            float[] r9 = androidx.compose.ui.graphics.colorspace.Connector.Companion.m3362access$computeTransformYBCOT_4(r0, r12, r13, r14)
            r10 = 0
            r3 = r11
            r4 = r12
            r5 = r13
    ...
    public long mo3361transformToColorwmQWz5c$ui_graphics_release(float r, float g, float b, float a) {
        ...
        return this.transformDestination.mo3357xyzaToColorJlNiLsg$ui_graphics_release(x, y, z, a, this.destination);
    }
    ...
    public static final class RgbConnector extends Connector {
        ...
        private RgbConnector(Rgb mSource, Rgb mDestination, int intent) {
            ...
            this.mTransform = m3364computeTransformYBCOT_4(this.mSource, this.mDestination, intent);
        }
        ...
        private final float[] m3364computeTransformYBCOT_4(Rgb source, Rgb destination, int intent) {
            ...
            if (RenderIntent.m3368equalsimpl0(intent, RenderIntent.INSTANCE.m3372getAbsoluteuksYyKA())) {
    ...
    public static final class Companion {
        ...
        /* renamed from: computeTransform-YBCOT_4, reason: not valid java name */
        public final float[] m3363computeTransformYBCOT_4(ColorSpace source, ColorSpace destination, int intent) {
            if (!RenderIntent.m3368equalsimpl0(intent, RenderIntent.INSTANCE.m3372getAbsoluteuksYyKA())) {
                return null;
            }
            boolean srcRGB = ColorModel.m3347equalsimpl0(source.getModel(), ColorModel.INSTANCE.m3354getRgbxdoWZVw());
            boolean dstRGB = ColorModel.m3347equalsimpl0(destination.getModel(), ColorModel.INSTANCE.m3354getRgbxdoWZVw());
            if (srcRGB && dstRGB) {
                return null;
            }
            if (!srcRGB && !dstRGB) {
        ...
        public final Connector identity$ui_graphics_release(final ColorSpace source) {
            Intrinsics.checkNotNullParameter(source, "source");
            final int m3374getRelativeuksYyKA = RenderIntent.INSTANCE.m3374getRelativeuksYyKA();
            return new Connector(source, m3374getRelativeuksYyKA) { // from class: androidx.compose.ui.graphics.colorspace.Connector$Companion$identity$1
                {
                    super(source, source, m3374getRelativeuksYyKA, null);
                }
    ...
    static {
        ...
        SrgbToOklabPerceptual = new Connector(ColorSpaces.INSTANCE.getSrgb(), ColorSpaces.INSTANCE.getOklab(), RenderIntent.INSTANCE.m3373getPerceptualuksYyKA(), defaultConstructorMarker);
        OklabToSrgbPerceptual = new Connector(ColorSpaces.INSTANCE.getOklab(), ColorSpaces.INSTANCE.getSrgb(), RenderIntent.INSTANCE.m3373getPerceptualuksYyKA(), defaultConstructorMarker);
    }
}
