...
public final class CanvasDrawScope implements DrawScope {
    ...
    private final DrawContext drawContext = new DrawContext() { // from class: androidx.compose.ui.graphics.drawscope.CanvasDrawScope$drawContext$1
        ...
        public long mo3415getSizeNHjbRc() {
            return CanvasDrawScope.this.getDrawParams().m3413getSizeNHjbRc();
        }

        @Override // androidx.compose.ui.graphics.drawscope.DrawContext
        /* renamed from: setSize-uvyYCjk, reason: not valid java name */
        public void mo3416setSizeuvyYCjk(long value) {
            CanvasDrawScope.this.getDrawParams().m3414setSizeuvyYCjk(value);
        }
    ...
    public void mo3398drawLine1RTmtNc(Brush brush, long start, long end, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        Intrinsics.checkNotNullParameter(brush, "brush");
        this.drawParams.getCanvas().mo2808drawLineWko1d7g(start, end, m3388configureStrokePaintho4zsrM$default(this, brush, strokeWidth, 4.0f, cap, StrokeJoin.INSTANCE.m3304getMiterLxFBmk8(), pathEffect, alpha, colorFilter, blendMode, 0, 512, null));
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* renamed from: drawLine-NGM6Ib0, reason: not valid java name */
    public void mo3399drawLineNGM6Ib0(long color, long start, long end, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().mo2808drawLineWko1d7g(start, end, m3386configureStrokePaintQ_0CZUI$default(this, color, strokeWidth, 4.0f, cap, StrokeJoin.INSTANCE.m3304getMiterLxFBmk8(), pathEffect, alpha, colorFilter, blendMode, 0, 512, null));
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* renamed from: drawRect-AsUm42w, reason: not valid java name */
    public void mo3406drawRectAsUm42w(Brush brush, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        Intrinsics.checkNotNullParameter(brush, "brush");
        Intrinsics.checkNotNullParameter(style, "style");
        this.drawParams.getCanvas().drawRect(Offset.m2708getXimpl(topLeft), Offset.m2709getYimpl(topLeft), Offset.m2708getXimpl(topLeft) + Size.m2777getWidthimpl(size), Offset.m2709getYimpl(topLeft) + Size.m2774getHeightimpl(size), m3384configurePaintswdJneE$default(this, brush, style, alpha, colorFilter, blendMode, 0, 32, null));
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* renamed from: drawRect-n-J9OG0, reason: not valid java name */
    public void mo3407drawRectnJ9OG0(long color, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        Intrinsics.checkNotNullParameter(style, "style");
        this.drawParams.getCanvas().drawRect(Offset.m2708getXimpl(topLeft), Offset.m2709getYimpl(topLeft), Offset.m2708getXimpl(topLeft) + Size.m2777getWidthimpl(size), Offset.m2709getYimpl(topLeft) + Size.m2774getHeightimpl(size), m3382configurePaint2qPWKa0$default(this, color, style, alpha, colorFilter, blendMode, 0, 32, null));
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* renamed from: drawImage-gbVJVH8, reason: not valid java name */
    public void mo3397drawImagegbVJVH8(ImageBitmap image, long topLeft, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        Intrinsics.checkNotNullParameter(image, "image");
        Intrinsics.checkNotNullParameter(style, "style");
        this.drawParams.getCanvas().mo2806drawImaged4ec7I(image, topLeft, m3384configurePaintswdJneE$default(this, null, style, alpha, colorFilter, blendMode, 0, 32, null));
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    @Deprecated(level = DeprecationLevel.HIDDEN, message = "Prefer usage of drawImage that consumes an optional FilterQuality parameter", replaceWith = @ReplaceWith(expression = "drawImage(image, srcOffset, srcSize, dstOffset, dstSize, alpha, style, colorFilter, blendMode, FilterQuality.Low)", imports = {"androidx.compose.ui.graphics.drawscope", "androidx.compose.ui.graphics.FilterQuality"}))
    /* renamed from: drawImage-9jGpkUE, reason: not valid java name */
    public /* synthetic */ void mo3395drawImage9jGpkUE(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        Intrinsics.checkNotNullParameter(image, "image");
        Intrinsics.checkNotNullParameter(style, "style");
        this.drawParams.getCanvas().mo2807drawImageRectHPBpro0(image, srcOffset, srcSize, dstOffset, dstSize, m3384configurePaintswdJneE$default(this, null, style, alpha, colorFilter, blendMode, 0, 32, null));
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* renamed from: drawImage-AZ2fEMs, reason: not valid java name */
    public void mo3396drawImageAZ2fEMs(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode, int filterQuality) {
        Intrinsics.checkNotNullParameter(image, "image");
        Intrinsics.checkNotNullParameter(style, "style");
        this.drawParams.getCanvas().mo2807drawImageRectHPBpro0(image, srcOffset, srcSize, dstOffset, dstSize, m3383configurePaintswdJneE(null, style, alpha, colorFilter, blendMode, filterQuality));
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* renamed from: drawRoundRect-ZuiqVtQ, reason: not valid java name */
    public void mo3408drawRoundRectZuiqVtQ(Brush brush, long topLeft, long size, long cornerRadius, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        Intrinsics.checkNotNullParameter(brush, "brush");
        Intrinsics.checkNotNullParameter(style, "style");
        this.drawParams.getCanvas().drawRoundRect(Offset.m2708getXimpl(topLeft), Offset.m2709getYimpl(topLeft), Offset.m2708getXimpl(topLeft) + Size.m2777getWidthimpl(size), Offset.m2709getYimpl(topLeft) + Size.m2774getHeightimpl(size), CornerRadius.m2683getXimpl(cornerRadius), CornerRadius.m2684getYimpl(cornerRadius), m3384configurePaintswdJneE$default(this, brush, style, alpha, colorFilter, blendMode, 0, 32, null));
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* renamed from: drawRoundRect-u-Aw5IA, reason: not valid java name */
    public void mo3409drawRoundRectuAw5IA(long color, long topLeft, long size, long cornerRadius, DrawStyle style, float alpha, ColorFilter colorFilter, int blendMode) {
        Intrinsics.checkNotNullParameter(style, "style");
        this.drawParams.getCanvas().drawRoundRect(Offset.m2708getXimpl(topLeft), Offset.m2709getYimpl(topLeft), Offset.m2708getXimpl(topLeft) + Size.m2777getWidthimpl(size), Offset.m2709getYimpl(topLeft) + Size.m2774getHeightimpl(size), CornerRadius.m2683getXimpl(cornerRadius), CornerRadius.m2684getYimpl(cornerRadius), m3382configurePaint2qPWKa0$default(this, color, style, alpha, colorFilter, blendMode, 0, 32, null));
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* renamed from: drawCircle-V9BoPsw, reason: not valid java name */
    public void mo3393drawCircleV9BoPsw(Brush brush, float radius, long center, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        Intrinsics.checkNotNullParameter(brush, "brush");
        Intrinsics.checkNotNullParameter(style, "style");
        this.drawParams.getCanvas().mo2805drawCircle9KIMszo(center, radius, m3384configurePaintswdJneE$default(this, brush, style, alpha, colorFilter, blendMode, 0, 32, null));
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* renamed from: drawCircle-VaOC9Bg, reason: not valid java name */
    public void mo3394drawCircleVaOC9Bg(long color, float radius, long center, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        Intrinsics.checkNotNullParameter(style, "style");
        this.drawParams.getCanvas().mo2805drawCircle9KIMszo(center, radius, m3382configurePaint2qPWKa0$default(this, color, style, alpha, colorFilter, blendMode, 0, 32, null));
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* renamed from: drawOval-AsUm42w, reason: not valid java name */
    public void mo3400drawOvalAsUm42w(Brush brush, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        Intrinsics.checkNotNullParameter(brush, "brush");
        Intrinsics.checkNotNullParameter(style, "style");
        this.drawParams.getCanvas().drawOval(Offset.m2708getXimpl(topLeft), Offset.m2709getYimpl(topLeft), Offset.m2708getXimpl(topLeft) + Size.m2777getWidthimpl(size), Offset.m2709getYimpl(topLeft) + Size.m2774getHeightimpl(size), m3384configurePaintswdJneE$default(this, brush, style, alpha, colorFilter, blendMode, 0, 32, null));
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* renamed from: drawOval-n-J9OG0, reason: not valid java name */
    public void mo3401drawOvalnJ9OG0(long color, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        Intrinsics.checkNotNullParameter(style, "style");
        this.drawParams.getCanvas().drawOval(Offset.m2708getXimpl(topLeft), Offset.m2709getYimpl(topLeft), Offset.m2708getXimpl(topLeft) + Size.m2777getWidthimpl(size), Offset.m2709getYimpl(topLeft) + Size.m2774getHeightimpl(size), m3382configurePaint2qPWKa0$default(this, color, style, alpha, colorFilter, blendMode, 0, 32, null));
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* renamed from: drawArc-illE91I, reason: not valid java name */
    public void mo3391drawArcillE91I(Brush brush, float startAngle, float sweepAngle, boolean useCenter, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        Intrinsics.checkNotNullParameter(brush, "brush");
        Intrinsics.checkNotNullParameter(style, "style");
        this.drawParams.getCanvas().drawArc(Offset.m2708getXimpl(topLeft), Offset.m2709getYimpl(topLeft), Offset.m2708getXimpl(topLeft) + Size.m2777getWidthimpl(size), Offset.m2709getYimpl(topLeft) + Size.m2774getHeightimpl(size), startAngle, sweepAngle, useCenter, m3384configurePaintswdJneE$default(this, brush, style, alpha, colorFilter, blendMode, 0, 32, null));
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* renamed from: drawArc-yD3GUKo, reason: not valid java name */
    public void mo3392drawArcyD3GUKo(long color, float startAngle, float sweepAngle, boolean useCenter, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        Intrinsics.checkNotNullParameter(style, "style");
        this.drawParams.getCanvas().drawArc(Offset.m2708getXimpl(topLeft), Offset.m2709getYimpl(topLeft), Offset.m2708getXimpl(topLeft) + Size.m2777getWidthimpl(size), Offset.m2709getYimpl(topLeft) + Size.m2774getHeightimpl(size), startAngle, sweepAngle, useCenter, m3382configurePaint2qPWKa0$default(this, color, style, alpha, colorFilter, blendMode, 0, 32, null));
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* renamed from: drawPath-LG529CI, reason: not valid java name */
    public void mo3403drawPathLG529CI(Path path, long color, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        Intrinsics.checkNotNullParameter(path, "path");
        Intrinsics.checkNotNullParameter(style, "style");
        this.drawParams.getCanvas().drawPath(path, m3382configurePaint2qPWKa0$default(this, color, style, alpha, colorFilter, blendMode, 0, 32, null));
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* renamed from: drawPath-GBMwjPU, reason: not valid java name */
    public void mo3402drawPathGBMwjPU(Path path, Brush brush, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        Intrinsics.checkNotNullParameter(path, "path");
        Intrinsics.checkNotNullParameter(brush, "brush");
        Intrinsics.checkNotNullParameter(style, "style");
        this.drawParams.getCanvas().drawPath(path, m3384configurePaintswdJneE$default(this, brush, style, alpha, colorFilter, blendMode, 0, 32, null));
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* renamed from: drawPoints-F8ZwMP8, reason: not valid java name */
    public void mo3404drawPointsF8ZwMP8(List<Offset> points, int pointMode, long color, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        Intrinsics.checkNotNullParameter(points, "points");
        this.drawParams.getCanvas().mo2809drawPointsO7TthRY(pointMode, points, m3386configureStrokePaintQ_0CZUI$default(this, color, strokeWidth, 4.0f, cap, StrokeJoin.INSTANCE.m3304getMiterLxFBmk8(), pathEffect, alpha, colorFilter, blendMode, 0, 512, null));
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* renamed from: drawPoints-Gsft0Ws, reason: not valid java name */
    public void mo3405drawPointsGsft0Ws(List<Offset> points, int pointMode, Brush brush, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        Intrinsics.checkNotNullParameter(points, "points");
        Intrinsics.checkNotNullParameter(brush, "brush");
        this.drawParams.getCanvas().mo2809drawPointsO7TthRY(pointMode, points, m3388configureStrokePaintho4zsrM$default(this, brush, strokeWidth, 4.0f, cap, StrokeJoin.INSTANCE.m3304getMiterLxFBmk8(), pathEffect, alpha, colorFilter, blendMode, 0, 512, null));
    }

    /* renamed from: draw-yzxVdVo, reason: not valid java name */
    public final void m3390drawyzxVdVo(Density density, LayoutDirection layoutDirection, Canvas canvas, long size, Function1<? super DrawScope, Unit> block) {
        ...
        $this$draw_yzxVdVo_u24lambda_u240.m3414setSizeuvyYCjk(size);
        canvas.save();
        block.invoke(this);
        canvas.restore();
        ...
        $this$draw_yzxVdVo_u24lambda_u241.m3414setSizeuvyYCjk(prevSize);
    }
    ...
    private final Paint obtainFillPaint() {
        ...
        if (paint == null) {
            ...
            $this$obtainFillPaint_u24lambda_u242.mo2832setStylek9PVt8s(PaintingStyle.INSTANCE.m3208getFillTiuSbCo());
    ...
    private final Paint obtainStrokePaint() {
        ...
        if (paint == null) {
            ...
            $this$obtainStrokePaint_u24lambda_u244.mo2832setStylek9PVt8s(PaintingStyle.INSTANCE.m3209getStrokeTiuSbCo());
    ...
    private final Paint selectPaint(DrawStyle drawStyle) {
        ...
        if (drawStyle instanceof Stroke) {
            ...
            if (!StrokeCap.m3289equalsimpl0($this$selectPaint_u24lambda_u246.mo2824getStrokeCapKaPHkGw(), ((Stroke) drawStyle).getCap())) {
            ...
            if (!StrokeJoin.m3299equalsimpl0($this$selectPaint_u24lambda_u246.mo2825getStrokeJoinLxFBmk8(), ((Stroke) drawStyle).getJoin())) {
    ...
    static /* synthetic */ Paint m3384configurePaintswdJneE$default(CanvasDrawScope canvasDrawScope, Brush brush, DrawStyle drawStyle, float f, ColorFilter colorFilter, int i, int i2, int i3, Object obj) {
        int i4;
        if ((i3 & 32) == 0) {
            i4 = i2;
        } else {
            i4 = DrawScope.INSTANCE.m3492getDefaultFilterQualityfv9h1I();
        }
        return canvasDrawScope.m3383configurePaintswdJneE(brush, drawStyle, f, colorFilter, i, i4);
    }

    /* renamed from: configurePaint-swdJneE, reason: not valid java name */
    private final Paint m3383configurePaintswdJneE(Brush brush, DrawStyle style, float alpha, ColorFilter colorFilter, int blendMode, int filterQuality) {
        Paint $this$configurePaint_swdJneE_u24lambda_u247 = selectPaint(style);
        if (brush != null) {
            brush.mo2894applyToPq9zytI(mo3490getSizeNHjbRc(), $this$configurePaint_swdJneE_u24lambda_u247, alpha);
        } else {
        ...
        if (!FilterQuality.m3038equalsimpl0($this$configurePaint_swdJneE_u24lambda_u247.mo2823getFilterQualityfv9h1I(), filterQuality)) {
    ...
    static /* synthetic */ Paint m3382configurePaint2qPWKa0$default(CanvasDrawScope canvasDrawScope, long j, DrawStyle drawStyle, float f, ColorFilter colorFilter, int i, int i2, int i3, Object obj) {
        int i4;
        if ((i3 & 32) == 0) {
            i4 = i2;
        } else {
        ...
        return canvasDrawScope.m3381configurePaint2qPWKa0(j, drawStyle, f, colorFilter, i, i4);
    }

    /* renamed from: configurePaint-2qPWKa0, reason: not valid java name */
    private final Paint m3381configurePaint2qPWKa0(long color, DrawStyle style, float alpha, ColorFilter colorFilter, int blendMode, int filterQuality) {
        Paint $this$configurePaint_2qPWKa0_u24lambda_u248 = selectPaint(style);
        long targetColor = m3389modulate5vOe2sY(color, alpha);
        ...
        if (!FilterQuality.m3038equalsimpl0($this$configurePaint_2qPWKa0_u24lambda_u248.mo2823getFilterQualityfv9h1I(), filterQuality)) {
    ...
    static /* synthetic */ Paint m3386configureStrokePaintQ_0CZUI$default(CanvasDrawScope canvasDrawScope, long j, float f, float f2, int i, int i2, PathEffect pathEffect, float f3, ColorFilter colorFilter, int i3, int i4, int i5, Object obj) {
        int i6;
        if ((i5 & 512) == 0) {
            i6 = i4;
        } else {
            i6 = DrawScope.INSTANCE.m3492getDefaultFilterQualityfv9h1I();
        }
        return canvasDrawScope.m3385configureStrokePaintQ_0CZUI(j, f, f2, i, i2, pathEffect, f3, colorFilter, i3, i6);
    }

    /* renamed from: configureStrokePaint-Q_0CZUI, reason: not valid java name */
    private final Paint m3385configureStrokePaintQ_0CZUI(long color, float strokeWidth, float miter, int cap, int join, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode, int filterQuality) {
        ...
        if (!StrokeCap.m3289equalsimpl0($this$configureStrokePaint_Q_0CZUI_u24lambda_u249.mo2824getStrokeCapKaPHkGw(), cap)) {
            $this$configureStrokePaint_Q_0CZUI_u24lambda_u249.mo2830setStrokeCapBeK7IIE(cap);
        }
        if (!StrokeJoin.m3299equalsimpl0($this$configureStrokePaint_Q_0CZUI_u24lambda_u249.mo2825getStrokeJoinLxFBmk8(), join)) {
        ...
        if (!FilterQuality.m3038equalsimpl0($this$configureStrokePaint_Q_0CZUI_u24lambda_u249.mo2823getFilterQualityfv9h1I(), filterQuality)) {
    ...
    static /* synthetic */ Paint m3388configureStrokePaintho4zsrM$default(CanvasDrawScope canvasDrawScope, Brush brush, float f, float f2, int i, int i2, PathEffect pathEffect, float f3, ColorFilter colorFilter, int i3, int i4, int i5, Object obj) {
        int i6;
        if ((i5 & 512) == 0) {
            i6 = i4;
        } else {
        ...
        return canvasDrawScope.m3387configureStrokePaintho4zsrM(brush, f, f2, i, i2, pathEffect, f3, colorFilter, i3, i6);
    }

    /* renamed from: configureStrokePaint-ho4zsrM, reason: not valid java name */
    private final Paint m3387configureStrokePaintho4zsrM(Brush brush, float strokeWidth, float miter, int cap, int join, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode, int filterQuality) {
        Paint $this$configureStrokePaint_ho4zsrM_u24lambda_u2410 = obtainStrokePaint();
        if (brush != null) {
            brush.mo2894applyToPq9zytI(mo3490getSizeNHjbRc(), $this$configureStrokePaint_ho4zsrM_u24lambda_u2410, alpha);
        } else {
        ...
        if (!StrokeCap.m3289equalsimpl0($this$configureStrokePaint_ho4zsrM_u24lambda_u2410.mo2824getStrokeCapKaPHkGw(), cap)) {
            $this$configureStrokePaint_ho4zsrM_u24lambda_u2410.mo2830setStrokeCapBeK7IIE(cap);
        }
        if (!StrokeJoin.m3299equalsimpl0($this$configureStrokePaint_ho4zsrM_u24lambda_u2410.mo2825getStrokeJoinLxFBmk8(), join)) {
        ...
        if (!FilterQuality.m3038equalsimpl0($this$configureStrokePaint_ho4zsrM_u24lambda_u2410.mo2823getFilterQualityfv9h1I(), filterQuality)) {
    ...
    private final long m3389modulate5vOe2sY(long $this$modulate_u2d5vOe2sY, float alpha) {
        long m2945copywmQWz5c;
        if (!(alpha == 1.0f)) {
            m2945copywmQWz5c = Color.m2945copywmQWz5c($this$modulate_u2d5vOe2sY, (r12 & 1) != 0 ? Color.m2949getAlphaimpl($this$modulate_u2d5vOe2sY) : Color.m2949getAlphaimpl($this$modulate_u2d5vOe2sY) * alpha, (r12 & 2) != 0 ? Color.m2953getRedimpl($this$modulate_u2d5vOe2sY) : 0.0f, (r12 & 4) != 0 ? Color.m2952getGreenimpl($this$modulate_u2d5vOe2sY) : 0.0f, (r12 & 8) != 0 ? Color.m2950getBlueimpl($this$modulate_u2d5vOe2sY) : 0.0f);
            return m2945copywmQWz5c;
        }
    ...
    public static final /* data */ class DrawParams {
        ...
        public static /* synthetic */ DrawParams m3410copyUg5Nnss$default(DrawParams drawParams, Density density, LayoutDirection layoutDirection, Canvas canvas, long j, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return drawParams.m3412copyUg5Nnss(density, layoutDirection2, canvas2, j);
        }
        ...
        public final DrawParams m3412copyUg5Nnss(Density density, LayoutDirection layoutDirection, Canvas canvas, long size) {
            Intrinsics.checkNotNullParameter(density, "density");
            Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
            Intrinsics.checkNotNullParameter(canvas, "canvas");
        ...
        */
        public /* synthetic */ DrawParams(androidx.compose.ui.unit.Density r8, androidx.compose.ui.unit.LayoutDirection r9, androidx.compose.ui.graphics.Canvas r10, long r11, int r13, kotlin.jvm.internal.DefaultConstructorMarker r14) {
            ...
            L23:
                ...
                long r11 = r8.m2786getZeroNHjbRc()
                r4 = r11
                goto L30
            L2f:
                r4 = r11
        ...
        /* renamed from: getSize-NH-jbRc, reason: not valid java name */
        public final long m3413getSizeNHjbRc() {
            return this.size;
        }

        /* renamed from: setSize-uvyYCjk, reason: not valid java name */
        public final void m3414setSizeuvyYCjk(long j) {
            this.size = j;
        }
    }
}
