...
public abstract class LookaheadDelegate extends LookaheadCapablePlaceable implements Measurable {
    ...
    public final void set_measureResult(MeasureResult result) {
        Unit unit;
        if (result != null) {
            m4239setMeasuredSizeozmzZPI(IntSizeKt.IntSize(result.getWidth(), result.getHeight()));
            unit = Unit.INSTANCE;
        } else {
            unit = null;
        }
        if (unit == null) {
            ...
            $this$_set__measureResult__u24lambda_u241.m4239setMeasuredSizeozmzZPI(IntSize.INSTANCE.m5381getZeroYbymL2g());
        }
    ...
    public void replace$ui_release() {
        mo4185placeAtf8xVGno(getPosition(), 0.0f, null);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // androidx.compose.ui.layout.Placeable
    /* renamed from: placeAt-f8xVGno */
    public final void mo4185placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
    ...
    public final long m4350positionInBjo55l4$ui_release(LookaheadDelegate ancestor) {
        ...
        long aggregatedOffset = IntOffset.INSTANCE.m5344getZeronOccac();
        ...
        while (!Intrinsics.areEqual(lookaheadDelegate, ancestor)) {
            ...
            aggregatedOffset = IntOffsetKt.IntOffset(IntOffset.m5334getXimpl(aggregatedOffset) + IntOffset.m5334getXimpl(other$iv), IntOffset.m5335getYimpl(aggregatedOffset) + IntOffset.m5335getYimpl(other$iv));
