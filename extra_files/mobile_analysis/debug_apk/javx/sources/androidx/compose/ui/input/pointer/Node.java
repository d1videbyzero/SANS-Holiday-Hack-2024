...
public final class Node extends NodeParent {
    ...
    public boolean dispatchMainEventPass(Map<PointerId, PointerInputChange> changes, LayoutCoordinates parentCoordinates, InternalPointerEvent internalPointerEvent, boolean isInBounds) {
        ...
        long size = layoutCoordinates.mo4191getSizeYbymL2g();
        ...
        while (node != null) {
            if (node instanceof PointerInputModifierNode) {
                ...
                this_$iv2 = this_$iv3;
                it.mo144onPointerEventH0pRuoY(event, PointerEventPass.Initial, size);
            } else {
                this_$iv2 = this_$iv3;
                Modifier.Node this_$iv$iv = node;
                if (((this_$iv$iv.getKindSet() & m4398constructorimpl) != 0) && (node instanceof DelegatingNode)) {
                    int count$iv2 = 0;
        ...
        if (!this.pointerInputFilter.getIsAttached()) {
            ...
            int m4398constructorimpl2 = NodeKind.m4398constructorimpl(16);
            ...
            while (node2 != null) {
                if (node2 instanceof PointerInputModifierNode) {
                    ...
                    it3.mo144onPointerEventH0pRuoY(event, PointerEventPass.Main, size);
                } else {
                    Modifier.Node this_$iv$iv3 = node2;
                    if (((this_$iv$iv3.getKindSet() & m4398constructorimpl2) != 0) && (node2 instanceof DelegatingNode)) {
                        int count$iv3 = 0;
                        ...
                        for (Modifier.Node node$iv$iv2 = this_$iv$iv4.getDelegate(); node$iv$iv2 != null; node$iv$iv2 = node$iv$iv2.getChild()) {
                            ...
                            if ((next$iv2.getKindSet() & m4398constructorimpl2) != 0) {
                                count$iv3++;
                                if (count$iv3 == 1) {
                                    node2 = next$iv2;
                                } else {
    ...
    public boolean dispatchFinalEventPass(InternalPointerEvent internalPointerEvent) {
        ...
        if (this_$iv3.relevantChanges.isEmpty()) {
            ...
            while (true) {
                ...
                if (node instanceof PointerInputModifierNode) {
                    PointerInputModifierNode it = (PointerInputModifierNode) node;
                    it.mo144onPointerEventH0pRuoY(event, PointerEventPass.Final, size);
                    this_$iv = this_$iv3;
                    $i$f$dispatchIfNeeded = $i$f$dispatchIfNeeded3;
                    i = i3;
                } else {
                    Modifier.Node this_$iv$iv = node;
                    Modifier.Node this_$iv$iv2 = (this_$iv$iv.getKindSet() & m4398constructorimpl) != 0 ? 1 : null;
                    if (this_$iv$iv2 == null || !(node instanceof DelegatingNode)) {
                        ...
                        while (node$iv$iv != null) {
                            Modifier.Node next$iv = node$iv$iv;
                            if (((next$iv.getKindSet() & m4398constructorimpl) != 0 ? i4 : 0) == 0) {
                                this_$iv2 = this_$iv3;
    ...
    public boolean buildCache(Map<PointerId, PointerInputChange> changes, LayoutCoordinates parentCoordinates, InternalPointerEvent internalPointerEvent, boolean isInBounds) {
        ...
        while (it.hasNext()) {
            ...
            long key = next.getKey().m4052unboximpl();
            ...
            if (0 <= size) {
                while (true) {
                    ...
                    if (this_$iv2.getContent()[i2].m4052unboximpl() == keyValue) {
            ...
            if (keyInPointerIds) {
                ...
                while (index$iv < size2) {
                    ...
                    LayoutCoordinates layoutCoordinates = this.coordinates;
                    Intrinsics.checkNotNull(layoutCoordinates);
                    historical.add(new HistoricalChange(uptimeMillis, layoutCoordinates.mo4192localPositionOfR5De75A(parentCoordinates, it3.getPosition()), null));
                    index$iv++;
                    size2 = size2;
                    keyValue = keyValue;
                ...
                Map<PointerId, PointerInputChange> map = this.relevantChanges;
                PointerId m4046boximpl = PointerId.m4046boximpl(key);
                LayoutCoordinates layoutCoordinates2 = this.coordinates;
                Intrinsics.checkNotNull(layoutCoordinates2);
                long mo4192localPositionOfR5De75A = layoutCoordinates2.mo4192localPositionOfR5De75A(parentCoordinates, change.getPreviousPosition());
                LayoutCoordinates layoutCoordinates3 = this.coordinates;
                Intrinsics.checkNotNull(layoutCoordinates3);
                map.put(m4046boximpl, PointerInputChange.m4056copyOHpmEuE$default(change, 0L, 0L, layoutCoordinates3.mo4192localPositionOfR5De75A(parentCoordinates, change.getPosition()), false, 0L, mo4192localPositionOfR5De75A, false, 0, historical, 0L, 731, null));
                it = it2;
            }
        }
        ...
        for (int i3 = this_$iv3.getSize() - 1; -1 < i3; i3--) {
            ...
            long pointerId = this_$iv4.getContent()[i3].m4052unboximpl();
            if (!changes.containsKey(PointerId.m4046boximpl(pointerId))) {
        ...
        while (true) {
            ...
            it$iv = item$iv$iv;
            if (internalPointerEvent.m3996issuesEnterExitEvent0FcD4WY(((PointerInputChange) it$iv).getId())) {
                break;
            }
            index$iv$iv++;
        }
        ...
        if (enterExitChange != null) {
            if (isInBounds) {
                ...
                if (this.isIn) {
                    ...
                    long size4 = layoutCoordinates4.mo4191getSizeYbymL2g();
                    z2 = true;
                    this.isIn = !PointerEventKt.m4011isOutOfBoundsO0kMr_c(enterExitChange, size4);
                } else {
                    z2 = true;
                }
            } else {
            ...
            if (this.isIn != this.wasIn && (PointerEventType.m4016equalsimpl0(event.getType(), PointerEventType.INSTANCE.m4022getMove7fucELk()) || PointerEventType.m4016equalsimpl0(event.getType(), PointerEventType.INSTANCE.m4020getEnter7fucELk()) || PointerEventType.m4016equalsimpl0(event.getType(), PointerEventType.INSTANCE.m4021getExit7fucELk()))) {
                event.m4010setTypeEhbLWgg$ui_release(this.isIn ? PointerEventType.INSTANCE.m4020getEnter7fucELk() : PointerEventType.INSTANCE.m4021getExit7fucELk());
            } else if (PointerEventType.m4016equalsimpl0(event.getType(), PointerEventType.INSTANCE.m4020getEnter7fucELk()) && this.wasIn && !this.hasExited) {
                event.m4010setTypeEhbLWgg$ui_release(PointerEventType.INSTANCE.m4022getMove7fucELk());
            } else if (PointerEventType.m4016equalsimpl0(event.getType(), PointerEventType.INSTANCE.m4021getExit7fucELk()) && this.isIn && enterExitChange.getPressed()) {
                event.m4010setTypeEhbLWgg$ui_release(PointerEventType.INSTANCE.m4022getMove7fucELk());
            }
        } else {
            z = false;
        ...
        boolean changed = (childChanged || !PointerEventType.m4016equalsimpl0(event.getType(), PointerEventType.INSTANCE.m4022getMove7fucELk()) || hasPositionChanged(this.pointerEvent, event)) ? z2 : z;
    ...
    public void dispatchCancel() {
        ...
        while (node != null) {
            if (node instanceof PointerInputModifierNode) {
                ...
                Modifier.Node this_$iv$iv = node;
                if (((this_$iv$iv.getKindSet() & m4398constructorimpl) != 0 ? i2 : 0) == 0 || !(node instanceof DelegatingNode)) {
                    i = i2;
                } else {
                    int count$iv = 0;
                    DelegatingNode this_$iv$iv2 = (DelegatingNode) node;
                    ...
                    while (node$iv$iv != null) {
                        Modifier.Node next$iv = node$iv$iv;
                        if (((next$iv.getKindSet() & m4398constructorimpl) != 0 ? i2 : 0) != 0) {
                            count$iv++;
                            if (count$iv == i2) {
                                node = next$iv;
                            } else {
    ...
    public void cleanUpHits(InternalPointerEvent internalPointerEvent) {
        ...
        while (true) {
            ...
            if (index$iv >= size) {
                this.isIn = false;
                this.hasExited = PointerEventType.m4016equalsimpl0(event.getType(), PointerEventType.INSTANCE.m4021getExit7fucELk());
                return;
            }
            Object item$iv = $this$fastForEach$iv.get(index$iv);
            PointerInputChange change = (PointerInputChange) item$iv;
            if (!change.getPressed() && (!internalPointerEvent.m3996issuesEnterExitEvent0FcD4WY(change.getId()) || !this.isIn)) {
                remove = true;
            }
            if (remove) {
                this.pointerIds.remove(PointerId.m4046boximpl(change.getId()));
            }
            index$iv++;
        }
    }
