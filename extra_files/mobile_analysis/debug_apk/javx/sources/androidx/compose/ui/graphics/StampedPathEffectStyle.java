...
public final class StampedPathEffectStyle {
    ...
    private static final int Translate = m3277constructorimpl(0);
    private static final int Rotate = m3277constructorimpl(1);
    private static final int Morph = m3277constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ StampedPathEffectStyle m3276boximpl(int i) {
    ...
    public static boolean m3278equalsimpl(int i, Object obj) {
        return (obj instanceof StampedPathEffectStyle) && i == ((StampedPathEffectStyle) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3279equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m3280hashCodeimpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m3285getTranslateYpspkwk() {
            return StampedPathEffectStyle.Translate;
        }

        /* renamed from: getRotate-Ypspkwk, reason: not valid java name */
        public final int m3284getRotateYpspkwk() {
            return StampedPathEffectStyle.Rotate;
        }

        /* renamed from: getMorph-Ypspkwk, reason: not valid java name */
        public final int m3283getMorphYpspkwk() {
            return StampedPathEffectStyle.Morph;
        }
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3281toStringimpl(int arg0) {
        return m3279equalsimpl0(arg0, Translate) ? "Translate" : m3279equalsimpl0(arg0, Rotate) ? "Rotate" : m3279equalsimpl0(arg0, Morph) ? "Morph" : "Unknown";
    }
