...
public final class ParagraphStyleKt {
    private static final long DefaultLineHeight = TextUnit.INSTANCE.m5408getUnspecifiedXSAIIZE();
    ...
    public static final ParagraphStyle lerp(ParagraphStyle start, ParagraphStyle stop, float fraction) {
        ...
        long m4689lerpTextUnitInheritableC3pnCVY = SpanStyleKt.m4689lerpTextUnitInheritableC3pnCVY(start.getLineHeight(), stop.getLineHeight(), fraction);
    ...
    public static final ParagraphStyle resolveParagraphStyleDefaults(ParagraphStyle style, LayoutDirection direction) {
        ...
        TextAlign m5081boximpl = TextAlign.m5081boximpl(style.getTextAlignOrDefault());
        TextDirection m5094boximpl = TextDirection.m5094boximpl(TextStyleKt.m4756resolveTextDirectionYj3eThk(direction, style.getTextDirection()));
        long lineHeight = TextUnitKt.m5415isUnspecifiedR2X_6o(style.getLineHeight()) ? DefaultLineHeight : style.getLineHeight();
        ...
        LineBreak m5009boximpl = LineBreak.m5009boximpl(style.getLineBreakOrDefault());
        Hyphens m5000boximpl = Hyphens.m5000boximpl(style.getHyphensOrDefault());
        TextMotion textMotion = style.getTextMotion();
        if (textMotion == null) {
            textMotion = TextMotion.INSTANCE.getStatic();
        }
        return new ParagraphStyle(m5081boximpl, m5094boximpl, lineHeight, textIndent2, platformStyle, lineHeightStyle, m5009boximpl, m5000boximpl, textMotion, (DefaultConstructorMarker) null);
    }

    /* JADX WARN: Code restructure failed: missing block: B:40:0x003e, code lost:
    
        if (androidx.compose.ui.unit.TextUnit.m5394equalsimpl0(r12, r26.getLineHeight()) != false) goto L14;
     */
