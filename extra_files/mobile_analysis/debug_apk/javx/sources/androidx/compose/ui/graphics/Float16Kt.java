...
public final class Float16Kt {
    ...
    public static final short m3090minAoSsdG0(short x, short y) {
        if (Float16.m3062isNaNimpl(x) || Float16.m3062isNaNimpl(y)) {
            return Float16.INSTANCE.m3084getNaNslo4al4();
        }
        return Float16.m3049compareTo41bOqos(x, y) <= 0 ? x : y;
    }

    /* renamed from: max-AoSsdG0, reason: not valid java name */
    public static final short m3089maxAoSsdG0(short x, short y) {
        if (Float16.m3062isNaNimpl(x) || Float16.m3062isNaNimpl(y)) {
            return Float16.INSTANCE.m3084getNaNslo4al4();
        }
        return Float16.m3049compareTo41bOqos(x, y) >= 0 ? x : y;
