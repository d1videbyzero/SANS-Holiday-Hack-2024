...
public final class AndroidFontListTypeface implements AndroidTypeface {
    ...
    */
    ...
    public Typeface mo4947getNativeTypefacePYhJU0U(FontWeight fontWeight, int fontStyle, int synthesis) {
        ...
        Font font = (Font) CollectionsKt.firstOrNull((List) this.fontMatcher.m4815matchFontRetOiIg(new ArrayList(this.loadedTypefaces.keySet()), fontWeight, fontStyle));
        if (font == null) {
        ...
        Object m4838synthesizeTypefaceFxwP2eA = FontSynthesis_androidKt.m4838synthesizeTypefaceFxwP2eA(synthesis, typeface, font, fontWeight, fontStyle);
        Intrinsics.checkNotNull(m4838synthesizeTypefaceFxwP2eA, "null cannot be cast to non-null type android.graphics.Typeface");
        return (Typeface) m4838synthesizeTypefaceFxwP2eA;
    }
}
