...
public final class PathFillType {
    ...
    private static final int NonZero = m3217constructorimpl(0);
    private static final int EvenOdd = m3217constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PathFillType m3216boximpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m3224getNonZeroRgk1Os() {
            return PathFillType.NonZero;
        }

        /* renamed from: getEvenOdd-Rg-k1Os, reason: not valid java name */
        public final int m3223getEvenOddRgk1Os() {
    ...
    public static String m3221toStringimpl(int arg0) {
        return m3219equalsimpl0(arg0, NonZero) ? "NonZero" : m3219equalsimpl0(arg0, EvenOdd) ? "EvenOdd" : "Unknown";
    }
