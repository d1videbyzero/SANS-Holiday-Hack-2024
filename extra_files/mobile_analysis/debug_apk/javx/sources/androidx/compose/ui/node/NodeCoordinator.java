...
public abstract class NodeCoordinator extends LookaheadCapablePlaceable implements Measurable, LayoutCoordinates, OwnerScope, Function1<Canvas, Unit> {
    ...
    private static final float[] tmpMatrix = Matrix.m3172constructorimpl$default(null, 1, null);
    ...
    public NodeCoordinator(LayoutNode layoutNode) {
        ...
        this.position = IntOffset.INSTANCE.m5344getZeronOccac();
    ...
    private final boolean m4371hasNodeH91voCI(int type) {
        Modifier.Node headNode = headNode(NodeKindKt.m4407getIncludeSelfInTraversalH91voCI(type));
        return headNode != null && DelegatableNodeKt.m4295has64DMado(headNode, type);
    }
    ...
    public void replace$ui_release() {
        mo4185placeAtf8xVGno(getPosition(), this.zIndex, this.layerBlock);
    }
    ...
    protected void onMeasureResultChanged(int width, int height) {
        ...
        m4239setMeasuredSizeozmzZPI(IntSizeKt.IntSize(width, height));
    ...
    public Object getParentData() {
        ...
        while (node$iv != null) {
            ...
            if (kind$iv != 0) {
                int m4398constructorimpl = NodeKind.m4398constructorimpl(i);
                MutableVector mutableVector2 = null;
                Modifier.Node node2 = node;
                while (node2 != null) {
                    if (node2 instanceof ParentDataModifierNode) {
                        ...
                        Modifier.Node this_$iv$iv = node2;
                        if (((this_$iv$iv.getKindSet() & m4398constructorimpl) != 0) && (node2 instanceof DelegatingNode)) {
                            int count$iv2 = 0;
                            DelegatingNode this_$iv$iv2 = (DelegatingNode) node2;
                            Modifier.Node node$iv$iv = this_$iv$iv2.getDelegate();
                            while (node$iv$iv != null) {
                                Modifier.Node next$iv = node$iv$iv;
                                if ((next$iv.getKindSet() & m4398constructorimpl) != 0) {
                                    count$iv2++;
                                    thisNode2 = thisNode3;
                                    if (count$iv2 == 1) {
                                        node2 = next$iv;
    ...
    protected final Placeable m4387performingMeasureK40F9xA(long constraints, Function0<? extends Placeable> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        m4240setMeasurementConstraintsBRTryo0(constraints);
        return block.invoke();
    }
                                    ...
                                    try {
                                        if (node instanceof LayoutAwareModifierNode) {
                                            try {
                                                ...
                                                this_$iv3 = this_$iv5;
                                                i2 = i3;
                                                it.mo4282onRemeasuredozmzZPI(getMeasuredSize());
                                                type$iv2 = type$iv4;
    ...
    protected void mo4185placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
    ...
    private final void m4375placeSelff8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        ...
        if (!IntOffset.m5333equalsimpl0(getPosition(), position)) {
    ...
    public final void m4388placeSelfApparentToRealOffsetf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        ...
        m4375placeSelff8xVGno(IntOffsetKt.IntOffset(IntOffset.m5334getXimpl(position) + IntOffset.m5334getXimpl(other$iv), IntOffset.m5335getYimpl(position) + IntOffset.m5335getYimpl(other$iv)), zIndex, layerBlock);
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        float x = IntOffset.m5334getXimpl(getPosition());
        float y = IntOffset.m5335getYimpl(getPosition());
    ...
    public final void drawContainedDrawModifiers(Canvas canvas) {
        ...
        if (head == null) {
            ...
            drawScope.m4333drawx_KDEd0$ui_release(canvas, IntSizeKt.m5386toSizeozmzZPI(mo4191getSizeYbymL2g()), this, head);
        }
    }
    ...
    private final void updateLayerParameters(boolean invokeOnLayoutChange) {
        ...
        graphicsLayerScope.m3252setSizeuvyYCjk(IntSizeKt.m5386toSizeozmzZPI(mo4191getSizeYbymL2g()));
    ...
    public final long m4383getMinimumTouchTargetSizeNHjbRc() {
        ...
        return $this$getMinimumTouchTargetSize_NH_jbRc_u24lambda_u2416.mo328toSizeXkaWNTQ(getLayoutNode().getViewConfiguration().mo4327getMinimumTouchTargetSizeMYxV2XQ());
    }
    ...
    public final void m4385hitTestYqVAtuI(HitTestSource hitTestSource, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
        ...
        if (head == null) {
            mo4318hitTestChildYqVAtuI(hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer);
            return;
        }
    ...
    public final void m4372hit1hIXUjU(final Modifier.Node $this$hit_u2d1hIXUjU, final HitTestSource hitTestSource, final long pointerPosition, final HitTestResult hitTestResult, final boolean isTouchEvent, final boolean isInLayer) {
        if ($this$hit_u2d1hIXUjU == null) {
            ...
            hitTestResult.hit($this$hit_u2d1hIXUjU, isInLayer, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$hit$1
                ...
                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2() {
                    Modifier.Node m4396nextUntilhw7D004;
                    NodeCoordinator nodeCoordinator = NodeCoordinator.this;
                    m4396nextUntilhw7D004 = NodeCoordinatorKt.m4396nextUntilhw7D004($this$hit_u2d1hIXUjU, hitTestSource.mo4394entityTypeOLwlOKw(), NodeKind.m4398constructorimpl(2));
                    nodeCoordinator.m4372hit1hIXUjU(m4396nextUntilhw7D004, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer);
                }
            });
        }
    }
        ...
        if ($this$hitNear_u2dJHbHoSQ == null) {
            ...
            hitTestResult.hitInMinimumTouchTarget($this$hitNear_u2dJHbHoSQ, distanceFromEdge, isInLayer, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$hitNear$1
                ...
                public final void invoke2() {
                    Modifier.Node m4396nextUntilhw7D004;
                    NodeCoordinator nodeCoordinator = NodeCoordinator.this;
                    m4396nextUntilhw7D004 = NodeCoordinatorKt.m4396nextUntilhw7D004($this$hitNear_u2dJHbHoSQ, hitTestSource.mo4394entityTypeOLwlOKw(), NodeKind.m4398constructorimpl(2));
                    nodeCoordinator.m4373hitNearJHbHoSQ(m4396nextUntilhw7D004, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge);
                }
            });
        }
    }
    ...
    public final void m4376speculativeHitJHbHoSQ(final Modifier.Node $this$speculativeHit_u2dJHbHoSQ, final HitTestSource hitTestSource, final long pointerPosition, final HitTestResult hitTestResult, final boolean isTouchEvent, final boolean isInLayer, final float distanceFromEdge) {
        ...
        if ($this$speculativeHit_u2dJHbHoSQ != null) {
            if (!hitTestSource.interceptOutOfBoundsChildEvents($this$speculativeHit_u2dJHbHoSQ)) {
                m4396nextUntilhw7D004 = NodeCoordinatorKt.m4396nextUntilhw7D004($this$speculativeHit_u2dJHbHoSQ, hitTestSource.mo4394entityTypeOLwlOKw(), NodeKind.m4398constructorimpl(2));
                m4376speculativeHitJHbHoSQ(m4396nextUntilhw7D004, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge);
                return;
            } else {
                hitTestResult.speculativeHit($this$speculativeHit_u2dJHbHoSQ, distanceFromEdge, isInLayer, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$speculativeHit$1
                    ...
                    /* renamed from: invoke, reason: avoid collision after fix types in other method */
                    public final void invoke2() {
                        Modifier.Node m4396nextUntilhw7D0042;
                        NodeCoordinator nodeCoordinator = NodeCoordinator.this;
                        m4396nextUntilhw7D0042 = NodeCoordinatorKt.m4396nextUntilhw7D004($this$speculativeHit_u2dJHbHoSQ, hitTestSource.mo4394entityTypeOLwlOKw(), NodeKind.m4398constructorimpl(2));
                        nodeCoordinator.m4376speculativeHitJHbHoSQ(m4396nextUntilhw7D0042, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge);
                    }
                });
                return;
            }
    ...
    public void mo4318hitTestChildYqVAtuI(HitTestSource hitTestSource, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
        Intrinsics.checkNotNullParameter(hitTestSource, "hitTestSource");
        Intrinsics.checkNotNullParameter(hitTestResult, "hitTestResult");
    ...
    public long mo4196windowToLocalMKHz9U(long relativeToWindow) {
        if (!isAttached()) {
            throw new IllegalStateException(ExpectAttachedLayoutCoordinates.toString());
        }
        LayoutCoordinates root = LayoutCoordinatesKt.findRootCoordinates(this);
        ...
        return mo4192localPositionOfR5De75A(root, positionInRoot);
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: localToWindow-MK-Hz9U */
    public long mo4194localToWindowMKHz9U(long relativeToLocal) {
        long positionInRoot = mo4193localToRootMKHz9U(relativeToLocal);
    ...
    public long mo4192localPositionOfR5De75A(LayoutCoordinates sourceCoordinates, long relativeToSource) {
        Intrinsics.checkNotNullParameter(sourceCoordinates, "sourceCoordinates");
        if (sourceCoordinates instanceof LookaheadLayoutCoordinatesImpl) {
            return Offset.m2717unaryMinusF1C5BW0(sourceCoordinates.mo4192localPositionOfR5De75A(this, Offset.m2717unaryMinusF1C5BW0(relativeToSource)));
        }
    ...
    public void mo4195transformFromEL8BTi8(LayoutCoordinates sourceCoordinates, float[] matrix) {
        Intrinsics.checkNotNullParameter(sourceCoordinates, "sourceCoordinates");
    ...
    private final void m4378transformToAncestorEL8BTi8(NodeCoordinator ancestor, float[] matrix) {
        ...
        while (!Intrinsics.areEqual(wrapper, ancestor)) {
            ...
            if (!IntOffset.m5333equalsimpl0(position, IntOffset.INSTANCE.m5344getZeronOccac())) {
                Matrix.m3181resetimpl(tmpMatrix);
                Matrix.m3192translateimpl$default(tmpMatrix, IntOffset.m5334getXimpl(position), IntOffset.m5335getYimpl(position), 0.0f, 4, null);
                Matrix.m3189timesAssign58bKbWc(matrix, tmpMatrix);
            }
    ...
    private final void m4377transformFromAncestorEL8BTi8(NodeCoordinator ancestor, float[] matrix) {
        if (!Intrinsics.areEqual(ancestor, this)) {
            ...
            if (!IntOffset.m5333equalsimpl0(getPosition(), IntOffset.INSTANCE.m5344getZeronOccac())) {
                Matrix.m3181resetimpl(tmpMatrix);
                Matrix.m3192translateimpl$default(tmpMatrix, -IntOffset.m5334getXimpl(getPosition()), -IntOffset.m5335getYimpl(getPosition()), 0.0f, 4, null);
                Matrix.m3189timesAssign58bKbWc(matrix, tmpMatrix);
            }
    ...
    public Rect localBoundingBoxOf(LayoutCoordinates sourceCoordinates, boolean clipBounds) {
        ...
        bounds.setLeft(0.0f);
        bounds.setTop(0.0f);
        bounds.setRight(IntSize.m5376getWidthimpl(sourceCoordinates.mo4191getSizeYbymL2g()));
        bounds.setBottom(IntSize.m5375getHeightimpl(sourceCoordinates.mo4191getSizeYbymL2g()));
    ...
    public long mo4193localToRootMKHz9U(long relativeToLocal) {
        if (!isAttached()) {
            throw new IllegalStateException(ExpectAttachedLayoutCoordinates.toString());
        }
        onCoordinatesUsed$ui_release();
    ...
    public long m4390toParentPositionMKHz9U(long position) {
        ...
        return IntOffsetKt.m5348plusNvtHpc(targetPosition, getPosition());
    }

    /* renamed from: fromParentPosition-MK-Hz9U, reason: not valid java name */
    public long m4381fromParentPositionMKHz9U(long position) {
        long relativeToPosition = IntOffsetKt.m5346minusNvtHpc(position, getPosition());
        OwnedLayer layer = this.layer;
    ...
    protected final void drawBorder(Canvas canvas, Paint paint) {
        ...
        Rect rect = new Rect(0.5f, 0.5f, IntSize.m5376getWidthimpl(getMeasuredSize()) - 0.5f, IntSize.m5375getHeightimpl(getMeasuredSize()) - 0.5f);
    ...
    public final void rectInParent$ui_release(MutableRect bounds, boolean clipBounds, boolean clipToMinimumTouchTargetSize) {
        ...
        if (layer != null) {
            if (this.isClipping) {
                if (clipToMinimumTouchTargetSize) {
                    ...
                    bounds.intersect(-horz, -vert, IntSize.m5376getWidthimpl(mo4191getSizeYbymL2g()) + horz, IntSize.m5375getHeightimpl(mo4191getSizeYbymL2g()) + vert);
                } else if (clipBounds) {
                    bounds.intersect(0.0f, 0.0f, IntSize.m5376getWidthimpl(mo4191getSizeYbymL2g()), IntSize.m5375getHeightimpl(mo4191getSizeYbymL2g()));
                }
                if (bounds.isEmpty()) {
                    return;
                }
        ...
        int x = IntOffset.m5334getXimpl(getPosition());
        bounds.setLeft(bounds.getLeft() + x);
        bounds.setRight(bounds.getRight() + x);
        int y = IntOffset.m5335getYimpl(getPosition());
    ...
    protected final float m4380distanceInMinimumTouchTargettz77jQw(long pointerPosition, long minimumTouchTargetSize) {
        ...
        long m4379calculateMinimumTouchTargetPaddingE7KxVPU = m4379calculateMinimumTouchTargetPaddingE7KxVPU(minimumTouchTargetSize);
        float width = Size.m2777getWidthimpl(m4379calculateMinimumTouchTargetPaddingE7KxVPU);
        float height = Size.m2774getHeightimpl(m4379calculateMinimumTouchTargetPaddingE7KxVPU);
