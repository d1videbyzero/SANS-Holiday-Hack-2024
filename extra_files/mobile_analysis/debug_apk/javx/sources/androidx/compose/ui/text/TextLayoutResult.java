...
public final class TextLayoutResult {
    ...
    public final int m4696getOffsetForPositionk4lQ0M(long position) {
        return this.multiParagraph.m4612getOffsetForPositionk4lQ0M(position);
    }
    ...
    public final long m4698getWordBoundaryjx7JFs(int offset) {
        return this.multiParagraph.m4613getWordBoundaryjx7JFs(offset);
    }
    ...
    public static /* synthetic */ TextLayoutResult m4694copyO0kMr_c$default(TextLayoutResult textLayoutResult, TextLayoutInput textLayoutInput, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textLayoutResult.m4695copyO0kMr_c(textLayoutInput, j);
    }

    /* renamed from: copy-O0kMr_c, reason: not valid java name */
    public final TextLayoutResult m4695copyO0kMr_c(TextLayoutInput layoutInput, long size) {
        Intrinsics.checkNotNullParameter(layoutInput, "layoutInput");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof TextLayoutResult) || !Intrinsics.areEqual(this.layoutInput, ((TextLayoutResult) other).layoutInput) || !Intrinsics.areEqual(this.multiParagraph, ((TextLayoutResult) other).multiParagraph) || !IntSize.m5374equalsimpl0(this.size, ((TextLayoutResult) other).size)) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        return (((((((((result * 31) + this.multiParagraph.hashCode()) * 31) + IntSize.m5377hashCodeimpl(this.size)) * 31) + Float.hashCode(this.firstBaseline)) * 31) + Float.hashCode(this.lastBaseline)) * 31) + this.placeholderRects.hashCode();
    }
