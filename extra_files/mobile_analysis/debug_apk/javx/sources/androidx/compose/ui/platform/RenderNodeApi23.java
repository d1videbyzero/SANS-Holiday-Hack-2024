...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    public RenderNodeApi23(AndroidComposeView ownerView) {
        ...
        this.internalCompositingStrategy = CompositingStrategy.INSTANCE.m3032getAutoNrFUSI();
    ...
    public void mo4503setCompositingStrategyaDBOjCE(int value) {
        if (CompositingStrategy.m3028equalsimpl0(value, CompositingStrategy.INSTANCE.m3034getOffscreenNrFUSI())) {
            this.renderNode.setLayerType(2);
            this.renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m3028equalsimpl0(value, CompositingStrategy.INSTANCE.m3033getModulateAlphaNrFUSI())) {
            this.renderNode.setLayerType(0);
    ...
    public final int getLayerType$ui_release() {
        return CompositingStrategy.m3028equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.INSTANCE.m3034getOffscreenNrFUSI()) ? 2 : 0;
    }
