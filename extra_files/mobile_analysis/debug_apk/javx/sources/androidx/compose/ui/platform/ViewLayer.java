...
public final class ViewLayer extends View implements OwnedLayer, GraphicLayerInfo {
    ...
    public ViewLayer(AndroidComposeView ownerView, DrawChildContainer container, Function1<? super Canvas, Unit> drawBlock, Function0<Unit> invalidateParentLayer) {
        ...
        this.mTransformOrigin = TransformOrigin.INSTANCE.m3331getCenterSzJe1aQ();
    ...
    */
    ...
    public void mo4447resizeozmzZPI(long size) {
        ...
        if (width != getWidth() || height != getHeight()) {
            setPivotX(TransformOrigin.m3326getPivotFractionXimpl(this.mTransformOrigin) * width);
            setPivotY(TransformOrigin.m3327getPivotFractionYimpl(this.mTransformOrigin) * height);
    ...
    public void mo4446movegyyYBs(long position) {
        int left = IntOffset.m5334getXimpl(position);
        if (left != getLeft()) {
            offsetLeftAndRight(left - getLeft());
            this.matrixCache.invalidate();
        }
        int top = IntOffset.m5335getYimpl(position);
        if (top != getTop()) {
    ...
    public long mo4445mapOffset8S9VItk(long point, boolean inverse) {
        if (inverse) {
            float[] m4517calculateInverseMatrixbWbORWo = this.matrixCache.m4517calculateInverseMatrixbWbORWo(this);
        ...
        return androidx.compose.ui.graphics.Matrix.m3178mapMKHz9U(this.matrixCache.m4518calculateMatrixGrdbGEg(this), point);
    }
    ...
    public void mapBounds(MutableRect rect, boolean inverse) {
        ...
        if (inverse) {
            float[] matrix = this.matrixCache.m4517calculateInverseMatrixbWbORWo(this);
            if (matrix != null) {
        ...
        androidx.compose.ui.graphics.Matrix.m3180mapimpl(this.matrixCache.m4518calculateMatrixGrdbGEg(this), rect);
    }
    ...
    public void mo4448transform58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        androidx.compose.ui.graphics.Matrix.m3189timesAssign58bKbWc(matrix, this.matrixCache.m4518calculateMatrixGrdbGEg(this));
    }
    ...
    public void mo4443inverseTransform58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        float[] inverse = this.matrixCache.m4517calculateInverseMatrixbWbORWo(this);
        if (inverse != null) {
