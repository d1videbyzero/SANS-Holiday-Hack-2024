...
public final class DelegatableNodeKt {
    ...
    public static final /* synthetic */ <T> void m4302visitLocalDescendants6rFNWt0(DelegatableNode visitLocalDescendants, int type, Function1<? super T, Unit> function1) {
        int i;
        int mask$iv;
        int i2;
        int mask$iv2;
    ...
    public static final /* synthetic */ <T> void m4301visitLocalAncestors6rFNWt0(DelegatableNode visitLocalAncestors, int type, Function1<? super T, Unit> function1) {
        int i;
        int mask$iv;
        int i2;
        int mask$iv2;
    ...
    public static /* synthetic */ void m4299visitAncestorsYYKmho$default(DelegatableNode visitAncestors, int type, boolean includeSelf, Function1 block, int i, Object obj) {
    ...
    public static final /* synthetic */ <T> void m4298visitAncestorsYYKmho(DelegatableNode visitAncestors, int type, boolean includeSelf, Function1<? super T, Unit> function1) {
        int i;
        int mask$iv;
    ...
    public static final /* synthetic */ <T> void m4303visitSelfAndAncestors5BbP62I(DelegatableNode visitSelfAndAncestors, int type, int untilType, Function1<? super T, Unit> function1) {
        int i;
        Modifier.Node self;
        int mask$iv;
        NodeChain nodes;
    ...
    public static final /* synthetic */ <T> List<T> m4293ancestors64DMado(DelegatableNode ancestors, int i) {
        int i2;
    ...
    public static final /* synthetic */ <T> T m4296nearestAncestor64DMado(DelegatableNode nearestAncestor, int i) {
        int i2;
        DelegatableNode delegatableNode;
        boolean z;
        int i3;
    ...
    public static final /* synthetic */ <T> void m4305visitSubtree6rFNWt0(DelegatableNode visitSubtree, int type, Function1<? super T, Unit> function1) {
        int i;
        int mask$iv;
    ...
    public static final /* synthetic */ <T> void m4300visitChildren6rFNWt0(DelegatableNode visitChildren, int type, Function1<? super T, Unit> function1) {
        int mask$iv;
    ...
    public static final /* synthetic */ <T> void m4304visitSelfAndChildren6rFNWt0(DelegatableNode visitSelfAndChildren, int type, Function1<? super T, Unit> function1) {
        int count$iv;
        int i;
        int mask$iv;
        DelegatableNode $this$visitChildren$iv;
    ...
    public static final /* synthetic */ <T> void m4306visitSubtreeIf6rFNWt0(DelegatableNode visitSubtreeIf, int type, Function1<? super T, Boolean> function1) {
        int i;
        int mask$iv;
    ...
    public static final boolean m4295has64DMado(DelegatableNode has, int type) {
    ...
    public static final NodeCoordinator m4297requireCoordinator64DMado(DelegatableNode requireCoordinator, int kind) {
    ...
    public static final LayoutModifierNode asLayoutModifierNode(Modifier.Node node) {
        ...
        int kind$iv = (node.getKindSet() & NodeKind.m4398constructorimpl(2)) != 0 ? 1 : 0;
        if (kind$iv == 0) {
            return null;
        }
        ...
        if (node instanceof DelegatingNode) {
            ...
            while (node2 != null) {
                ...
                if (node2 instanceof DelegatingNode) {
                    ...
                    int kind$iv2 = (this_$iv.getKindSet() & NodeKind.m4398constructorimpl(2)) != 0 ? 1 : 0;
                    if (kind$iv2 != 0) {
    ...
    public static final /* synthetic */ <T> void m4294dispatchForKind6rFNWt0(Modifier.Node dispatchForKind, int kind, Function1<? super T, Unit> function1) {
        Function1<? super T, Unit> block = function1;
