...
public final class FocusTargetNode extends Modifier.Node implements FocusTargetModifierNode, ObserverModifierNode, ModifierLocalModifierNode {
    ...
    public final void scheduleInvalidationForFocusEvents$ui_release() {
        ...
        int m4398constructorimpl = NodeKind.m4398constructorimpl(4096);
        MutableVector mutableVector2 = null;
            ...
            if (node instanceof FocusEventModifierNode) {
                ...
                if (this_$iv$iv2 != null && (node instanceof DelegatingNode)) {
                    ...
                    while (node$iv$iv != null) {
                        ...
                        if (((next$iv.getKindSet() & m4398constructorimpl) != 0 ? i : 0) != 0) {
                            count$iv++;
                            if (count$iv == i) {
                                node = next$iv;
                            } else {
                ...
                while (node$iv != null) {
                    if ((node$iv.getKindSet() & mask$iv4) != 0) {
                        ...
                        if (((it.getKindSet() & NodeKind.m4398constructorimpl(i2)) != 0 ? 1 : $this$visitAncestors_u24default$iv) == 0 && it.getIsAttached()) {
                            int m4398constructorimpl2 = NodeKind.m4398constructorimpl(4096);
                            ...
                            while (node2 != null) {
                                if (node2 instanceof FocusEventModifierNode) {
                                    ...
                                    if (((this_$iv$iv4.getKindSet() & m4398constructorimpl2) != 0 ? 1 : $this$visitAncestors_u24default$iv) == 0 || !(node2 instanceof DelegatingNode)) {
                                        $this$visitAncestors_u24default$iv4 = $this$visitAncestors_u24default$iv8;
                                        mask$iv2 = mask$iv4;
                                        includeSelf$iv2 = includeSelf$iv4;
                                        $this$visitAncestors_u24default$iv5 = $this$visitAncestors_u24default$iv;
                                        ...
                                        while (node$iv$iv2 != null) {
                                            ...
                                            if (((next$iv2.getKindSet() & m4398constructorimpl2) != 0 ? 1 : $this$visitAncestors_u24default$iv) != 0) {
                                                count$iv2++;
                                                if (count$iv2 == 1) {
                                                    node2 = next$iv2;
