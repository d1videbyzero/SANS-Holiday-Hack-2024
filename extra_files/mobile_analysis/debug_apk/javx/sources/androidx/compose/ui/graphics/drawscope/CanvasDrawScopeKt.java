    ...
    public static final DrawTransform asDrawTransform(final DrawContext $this$asDrawTransform) {
        return new DrawTransform() { // from class: androidx.compose.ui.graphics.drawscope.CanvasDrawScopeKt$asDrawTransform$1
            ...
            public long mo3420getSizeNHjbRc() {
                return DrawContext.this.mo3415getSizeNHjbRc();
            }

            @Override // androidx.compose.ui.graphics.drawscope.DrawTransform
            /* renamed from: getCenter-F1C5BW0, reason: not valid java name */
            public long mo3419getCenterF1C5BW0() {
                return SizeKt.m2787getCenteruvyYCjk(mo3420getSizeNHjbRc());
            }
            ...
            public void inset(float left, float top, float right, float bottom) {
                ...
                long updatedSize = SizeKt.Size(Size.m2777getWidthimpl(mo3420getSizeNHjbRc()) - (left + right), Size.m2774getHeightimpl(mo3420getSizeNHjbRc()) - (top + bottom));
                if (!(Size.m2777getWidthimpl(updatedSize) >= 0.0f && Size.m2774getHeightimpl(updatedSize) >= 0.0f)) {
                    throw new IllegalArgumentException("Width and height must be greater than or equal to zero".toString());
                }
                drawContext.mo3416setSizeuvyYCjk(updatedSize);
                it.translate(left, top);
            }

            @Override // androidx.compose.ui.graphics.drawscope.DrawTransform
            /* renamed from: clipRect-N_I0leg, reason: not valid java name */
            public void mo3418clipRectN_I0leg(float left, float top, float right, float bottom, int clipOp) {
                DrawContext.this.getCanvas().mo2803clipRectN_I0leg(left, top, right, bottom, clipOp);
            }

            @Override // androidx.compose.ui.graphics.drawscope.DrawTransform
            /* renamed from: clipPath-mtrdD-E, reason: not valid java name */
            public void mo3417clipPathmtrdDE(Path path, int clipOp) {
                Intrinsics.checkNotNullParameter(path, "path");
                DrawContext.this.getCanvas().mo2802clipPathmtrdDE(path, clipOp);
            }
            ...
            public void mo3421rotateUv8p0NA(float degrees, long pivot) {
            ...
            public void mo3422scale0AR0LA0(float scaleX, float scaleY, long pivot) {
            ...
            public void mo3423transform58bKbWc(float[] matrix) {
                Intrinsics.checkNotNullParameter(matrix, "matrix");
                DrawContext.this.getCanvas().mo2804concat58bKbWc(matrix);
            }
        };
    }
}
