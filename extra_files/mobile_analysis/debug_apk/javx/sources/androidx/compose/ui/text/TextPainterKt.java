...
public final class TextPainterKt {
    ...
    public static final void m4703drawTextJFhB2K4(DrawScope drawText, TextMeasurer textMeasurer, AnnotatedString text, long topLeft, TextStyle style, int overflow, boolean softWrap, int maxLines, List<AnnotatedString.Range<Placeholder>> placeholders, long size, int blendMode) {
        Intrinsics.checkNotNullParameter(drawText, "$this$drawText");
        Intrinsics.checkNotNullParameter(textMeasurer, "textMeasurer");
        Intrinsics.checkNotNullParameter(text, "text");
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(placeholders, "placeholders");
        TextLayoutResult textLayoutResult = TextMeasurer.m4700measurexDpz5zY$default(textMeasurer, text, style, overflow, softWrap, maxLines, placeholders, m4711textLayoutConstraintsv_w8tDc(drawText, size, topLeft), drawText.getLayoutDirection(), drawText, null, false, 1536, null);
        DrawContext $this$withTransform_u24lambda_u246$iv = drawText.getDrawContext();
        long previousSize$iv = $this$withTransform_u24lambda_u246$iv.mo3415getSizeNHjbRc();
        ...
        textLayoutResult.getMultiParagraph().m4614paintLG529CI(drawText.getDrawContext().getCanvas(), (r14 & 2) != 0 ? Color.INSTANCE.m2983getUnspecified0d7_KjU() : 0L, (r14 & 4) != 0 ? null : null, (r14 & 8) != 0 ? null : null, (r14 & 16) == 0 ? null : null, (r14 & 32) != 0 ? DrawScope.INSTANCE.m3491getDefaultBlendMode0nO6VwU() : blendMode);
        $this$withTransform_u24lambda_u246$iv.getCanvas().restore();
        $this$withTransform_u24lambda_u246$iv.mo3416setSizeuvyYCjk(previousSize$iv);
    }

    /* renamed from: drawText-TPWCCtM, reason: not valid java name */
    public static final void m4707drawTextTPWCCtM(DrawScope drawText, TextMeasurer textMeasurer, String text, long topLeft, TextStyle style, int overflow, boolean softWrap, int maxLines, long size, int blendMode) {
        Intrinsics.checkNotNullParameter(drawText, "$this$drawText");
        Intrinsics.checkNotNullParameter(textMeasurer, "textMeasurer");
        Intrinsics.checkNotNullParameter(text, "text");
        Intrinsics.checkNotNullParameter(style, "style");
        TextLayoutResult textLayoutResult = TextMeasurer.m4700measurexDpz5zY$default(textMeasurer, new AnnotatedString(text, null, null, 6, null), style, overflow, softWrap, maxLines, null, m4711textLayoutConstraintsv_w8tDc(drawText, size, topLeft), drawText.getLayoutDirection(), drawText, null, false, 1568, null);
        DrawContext $this$withTransform_u24lambda_u246$iv = drawText.getDrawContext();
        long previousSize$iv = $this$withTransform_u24lambda_u246$iv.mo3415getSizeNHjbRc();
        $this$withTransform_u24lambda_u246$iv.getCanvas().save();
    ...
    public static final void m4709drawTextd8rzKo(DrawScope drawText, TextLayoutResult textLayoutResult, long color, long topLeft, float alpha, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(drawText, "$this$drawText");
        ...
        $this$drawText_d8_rzKo_u24lambda_u244.translate(Offset.m2708getXimpl(topLeft), Offset.m2709getYimpl(topLeft));
        clip($this$drawText_d8_rzKo_u24lambda_u244, textLayoutResult);
        Brush brush = textLayoutResult.getLayoutInput().getStyle().getBrush();
        if (brush != null) {
            if (color == Color.INSTANCE.m2983getUnspecified0d7_KjU()) {
                textLayoutResult.getMultiParagraph().m4616painthn5TExg(drawText.getDrawContext().getCanvas(), brush, !Float.isNaN(alpha) ? alpha : textLayoutResult.getLayoutInput().getStyle().getAlpha(), newShadow, newTextDecoration, newDrawStyle, blendMode);
                $this$withTransform_u24lambda_u246$iv.getCanvas().restore();
                $this$withTransform_u24lambda_u246$iv.mo3416setSizeuvyYCjk(previousSize$iv);
            }
        }
        ...
        if (!($this$takeOrElse_u2dDxMtmZc$iv != Color.INSTANCE.m2983getUnspecified0d7_KjU())) {
            $this$takeOrElse_u2dDxMtmZc$iv = textLayoutResult.getLayoutInput().getStyle().m4745getColor0d7_KjU();
        }
        multiParagraph.m4614paintLG529CI(canvas, TextDrawStyleKt.m5106modulateDxMtmZc($this$takeOrElse_u2dDxMtmZc$iv, alpha), newShadow, newTextDecoration, newDrawStyle, blendMode);
        $this$withTransform_u24lambda_u246$iv.getCanvas().restore();
        $this$withTransform_u24lambda_u246$iv.mo3416setSizeuvyYCjk(previousSize$iv);
    }

    /* renamed from: drawText-LVfH_YU, reason: not valid java name */
    public static final void m4705drawTextLVfH_YU(DrawScope drawText, TextLayoutResult textLayoutResult, Brush brush, long topLeft, float alpha, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(drawText, "$this$drawText");
        Intrinsics.checkNotNullParameter(textLayoutResult, "textLayoutResult");
    ...
    private static final void clip(DrawTransform $this$clip, TextLayoutResult textLayoutResult) {
        if (textLayoutResult.getHasVisualOverflow() && !TextOverflow.m5128equalsimpl0(textLayoutResult.getLayoutInput().getOverflow(), TextOverflow.INSTANCE.m5137getVisiblegIe3tQ8())) {
            DrawTransform.m3541clipRectN_I0leg$default($this$clip, 0.0f, 0.0f, IntSize.m5376getWidthimpl(textLayoutResult.getSize()), IntSize.m5375getHeightimpl(textLayoutResult.getSize()), 0, 16, null);
        }
    }

    /* renamed from: textLayoutConstraints-v_w8tDc, reason: not valid java name */
    private static final long m4711textLayoutConstraintsv_w8tDc(DrawScope $this$textLayoutConstraints_u2dv_w8tDc, long size, long topLeft) {
        int minWidth;
        int maxWidth;
        int minHeight;
        int maxHeight;
        ...
        if (isWidthNaN) {
            minWidth = 0;
            maxWidth = MathKt.roundToInt((float) Math.ceil(Size.m2777getWidthimpl($this$textLayoutConstraints_u2dv_w8tDc.mo3490getSizeNHjbRc()) - Offset.m2708getXimpl(topLeft)));
        } else {
        ...
        if (isHeightNaN) {
            minHeight = 0;
            maxHeight = MathKt.roundToInt((float) Math.ceil(Size.m2774getHeightimpl($this$textLayoutConstraints_u2dv_w8tDc.mo3490getSizeNHjbRc()) - Offset.m2709getYimpl(topLeft)));
        } else {
