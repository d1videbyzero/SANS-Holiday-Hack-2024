...
public final /* data */ class PointerInputEventData {
    ...
    public final PointerInputEventData m4078copygYeeOSc(long id, long uptime, long positionOnScreen, long position, boolean down, float pressure, int type, boolean issuesEnterExit, List<HistoricalChange> historical, long scrollDelta) {
    ...
    public boolean equals(Object other) {
        ...
        return PointerId.m4049equalsimpl0(this.id, pointerInputEventData.id) && this.uptime == pointerInputEventData.uptime && Offset.m2705equalsimpl0(this.positionOnScreen, pointerInputEventData.positionOnScreen) && Offset.m2705equalsimpl0(this.position, pointerInputEventData.position) && this.down == pointerInputEventData.down && Float.compare(this.pressure, pointerInputEventData.pressure) == 0 && PointerType.m4137equalsimpl0(this.type, pointerInputEventData.type) && this.issuesEnterExit == pointerInputEventData.issuesEnterExit && Intrinsics.areEqual(this.historical, pointerInputEventData.historical) && Offset.m2705equalsimpl0(this.scrollDelta, pointerInputEventData.scrollDelta);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public int hashCode() {
        int m4050hashCodeimpl = ((((((PointerId.m4050hashCodeimpl(this.id) * 31) + Long.hashCode(this.uptime)) * 31) + Offset.m2710hashCodeimpl(this.positionOnScreen)) * 31) + Offset.m2710hashCodeimpl(this.position)) * 31;
        boolean z = this.down;
        int i = z;
        if (z != 0) {
            i = 1;
        }
        int hashCode = (((((m4050hashCodeimpl + i) * 31) + Float.hashCode(this.pressure)) * 31) + PointerType.m4138hashCodeimpl(this.type)) * 31;
        boolean z2 = this.issuesEnterExit;
        return ((((hashCode + (z2 ? 1 : z2 ? 1 : 0)) * 31) + this.historical.hashCode()) * 31) + Offset.m2710hashCodeimpl(this.scrollDelta);
    }

    public String toString() {
        return "PointerInputEventData(id=" + ((Object) PointerId.m4051toStringimpl(this.id)) + ", uptime=" + this.uptime + ", positionOnScreen=" + ((Object) Offset.m2716toStringimpl(this.positionOnScreen)) + ", position=" + ((Object) Offset.m2716toStringimpl(this.position)) + ", down=" + this.down + ", pressure=" + this.pressure + ", type=" + ((Object) PointerType.m4139toStringimpl(this.type)) + ", issuesEnterExit=" + this.issuesEnterExit + ", historical=" + this.historical + ", scrollDelta=" + ((Object) Offset.m2716toStringimpl(this.scrollDelta)) + ')';
    }
    ...
    public final long m4079getIdJ3iCeTQ() {
        return this.id;
    }
    ...
    public final long m4080getPositionF1C5BW0() {
        return this.position;
    }
    ...
    public final int m4083getTypeT8wyACA() {
        return this.type;
    }
    ...
    public final long m4082getScrollDeltaF1C5BW0() {
        return this.scrollDelta;
    }
}
