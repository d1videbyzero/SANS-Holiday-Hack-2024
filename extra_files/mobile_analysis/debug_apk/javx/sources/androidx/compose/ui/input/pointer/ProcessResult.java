...
public final class ProcessResult {
    ...
    public static final /* synthetic */ ProcessResult m4148boximpl(int i) {
    ...
    public static boolean m4150equalsimpl(int i, Object obj) {
        return (obj instanceof ProcessResult) && i == ((ProcessResult) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4151equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4154hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m4155toStringimpl(int i) {
        return "ProcessResult(value=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m4150equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m4154hashCodeimpl(this.value);
    }

    public String toString() {
        return m4155toStringimpl(this.value);
    }
    ...
    public static final boolean m4153getDispatchedToAPointerInputModifierimpl(int arg0) {
        return (arg0 & 1) != 0;
    }

    /* renamed from: getAnyMovementConsumed-impl, reason: not valid java name */
    public static final boolean m4152getAnyMovementConsumedimpl(int arg0) {
        return (arg0 & 2) != 0;
    }
}
