...
public interface ContentScale {
    ...
    long mo4175computeScaleFactorH7hwNQA(long srcSize, long dstSize);
    ...
    public static final class Companion {
        ...
        private static final ContentScale Crop = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Crop$1
            ...
            public long mo4175computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float it;
                it = ContentScaleKt.m4181computeFillMaxDimensioniLBOSCw(srcSize, dstSize);
        ...
        private static final ContentScale Fit = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Fit$1
            ...
            public long mo4175computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float it;
                it = ContentScaleKt.m4182computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(it, it);
            }
        };
        private static final ContentScale FillHeight = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillHeight$1
            ...
            public long mo4175computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float it;
                it = ContentScaleKt.m4180computeFillHeightiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(it, it);
            }
        };
        private static final ContentScale FillWidth = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillWidth$1
            ...
            public long mo4175computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float it;
                it = ContentScaleKt.m4183computeFillWidthiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(it, it);
            }
        };
        ...
        private static final ContentScale FillBounds = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillBounds$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo4175computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m4183computeFillWidthiLBOSCw;
                float m4180computeFillHeightiLBOSCw;
                m4183computeFillWidthiLBOSCw = ContentScaleKt.m4183computeFillWidthiLBOSCw(srcSize, dstSize);
                m4180computeFillHeightiLBOSCw = ContentScaleKt.m4180computeFillHeightiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(m4183computeFillWidthiLBOSCw, m4180computeFillHeightiLBOSCw);
            }
        };
