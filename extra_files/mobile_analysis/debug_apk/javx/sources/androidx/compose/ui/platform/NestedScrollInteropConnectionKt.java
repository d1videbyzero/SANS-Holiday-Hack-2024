...
public final class NestedScrollInteropConnectionKt {
    ...
    public static final long m4537toOffsetUv8p0NA(int[] consumed, long available) {
        float offsetX;
        float offsetY;
    ...
    public static final int m4538toViewTypeGyEprt8(int $this$toViewType_u2dGyEprt8) {
        return NestedScrollSource.m3958equalsimpl0($this$toViewType_u2dGyEprt8, NestedScrollSource.INSTANCE.m3963getDragWNlRxjI()) ? 0 : 1;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: getScrollAxes-k-4lQ0M, reason: not valid java name */
    public static final int m4536getScrollAxesk4lQ0M(long $this$scrollAxes) {
        int axes = 0;
