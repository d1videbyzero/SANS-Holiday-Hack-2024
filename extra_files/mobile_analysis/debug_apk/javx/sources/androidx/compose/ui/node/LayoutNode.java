...
public final class LayoutNode implements ComposeNodeLifecycleCallback, Remeasurement, OwnerScope, LayoutInfo, ComposeUiNode, InteroperableComposeUiNode, Owner.OnLayoutCompletedListener {
    ...
    private static final NoIntrinsicsMeasurePolicy ErrorMeasurePolicy = new NoIntrinsicsMeasurePolicy() { // from class: androidx.compose.ui.node.LayoutNode$Companion$ErrorMeasurePolicy$1
        ...
        public /* bridge */ /* synthetic */ MeasureResult mo13measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List measurables, long constraints) {
    ...
    private static final ViewConfiguration DummyViewConfiguration = new ViewConfiguration() { // from class: androidx.compose.ui.node.LayoutNode$Companion$DummyViewConfiguration$1
        ...
        public long mo4327getMinimumTouchTargetSizeMYxV2XQ() {
            return DpSize.INSTANCE.m5324getZeroMYxV2XQ();
        }
    };
    ...
    */
    ...
    public final boolean getHasFixedInnerContentConstraints$ui_release() {
        ...
        return Constraints.m5170getHasFixedWidthimpl(innerContentConstraints) && Constraints.m5169getHasFixedHeightimpl(innerContentConstraints);
    }
            ...
            if ((it$iv$iv.getKindSet() & type$iv4) == 0) {
                ...
                while (node != null) {
                    if (node instanceof GlobalPositionAwareModifierNode) {
                        ...
                        this_$iv2 = this_$iv3;
                        i2 = i3;
                        it.onGloballyPositioned(DelegatableNodeKt.m4297requireCoordinator64DMado(it, NodeKind.m4398constructorimpl(256)));
                        type$iv2 = type$iv4;
                    } else {
                        this_$iv2 = this_$iv3;
                        i2 = i3;
                ...
                if ((it$iv$iv.getKindSet() & type$iv4) == 0) {
                    ...
                    while (node != null) {
                        if (node instanceof LayoutModifierNode) {
                            ...
                            c2 = 2;
                            OwnedLayer layer = DelegatableNodeKt.m4297requireCoordinator64DMado(it, NodeKind.m4398constructorimpl(2)).getLayer();
                            if (layer != null) {
                                layer.invalidate();
                            }
                            this_$iv2 = this_$iv4;
    ...
    private final boolean shouldInvalidateParentLayer() {
        ...
        for (Modifier.Node node$iv = this_$iv.getHead(); node$iv != null; node$iv = node$iv.getChild()) {
            ...
            if (kind$iv != 0 && DelegatableNodeKt.m4297requireCoordinator64DMado(it, NodeKind.m4398constructorimpl(2)).getLayer() != null) {
                return false;
            }
