...
public final class IntRectKt {
    ...
    public static final IntRect m5366IntRectVbeCjmY(long offset, long size) {
        return new IntRect(IntOffset.m5334getXimpl(offset), IntOffset.m5335getYimpl(offset), IntOffset.m5334getXimpl(offset) + IntSize.m5376getWidthimpl(size), IntOffset.m5335getYimpl(offset) + IntSize.m5375getHeightimpl(size));
    }

    /* renamed from: IntRect-E1MhUcY, reason: not valid java name */
    public static final IntRect m5365IntRectE1MhUcY(long topLeft, long bottomRight) {
        return new IntRect(IntOffset.m5334getXimpl(topLeft), IntOffset.m5335getYimpl(topLeft), IntOffset.m5334getXimpl(bottomRight), IntOffset.m5335getYimpl(bottomRight));
    }

    /* renamed from: IntRect-ar5cAso, reason: not valid java name */
    public static final IntRect m5367IntRectar5cAso(long center, int radius) {
        return new IntRect(IntOffset.m5334getXimpl(center) - radius, IntOffset.m5335getYimpl(center) - radius, IntOffset.m5334getXimpl(center) + radius, IntOffset.m5335getYimpl(center) + radius);
    }
