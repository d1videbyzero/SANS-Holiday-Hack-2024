...
public final class NestedScrollInteropConnection implements NestedScrollConnection {
    ...
    public long mo336onPreScrollOzD1aCk(long available, int source) {
        int m4536getScrollAxesk4lQ0M;
        int m4538toViewTypeGyEprt8;
        int m4538toViewTypeGyEprt82;
        long m4537toOffsetUv8p0NA;
        NestedScrollingChildHelper nestedScrollingChildHelper = this.nestedScrollChildHelper;
        m4536getScrollAxesk4lQ0M = NestedScrollInteropConnectionKt.m4536getScrollAxesk4lQ0M(available);
        m4538toViewTypeGyEprt8 = NestedScrollInteropConnectionKt.m4538toViewTypeGyEprt8(source);
        if (!nestedScrollingChildHelper.startNestedScroll(m4536getScrollAxesk4lQ0M, m4538toViewTypeGyEprt8)) {
        ...
        int composeToViewOffset = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2708getXimpl(available));
        int composeToViewOffset2 = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2709getYimpl(available));
        int[] iArr = this.consumedScrollCache;
        m4538toViewTypeGyEprt82 = NestedScrollInteropConnectionKt.m4538toViewTypeGyEprt8(source);
        nestedScrollingChildHelper2.dispatchNestedPreScroll(composeToViewOffset, composeToViewOffset2, iArr, null, m4538toViewTypeGyEprt82);
        m4537toOffsetUv8p0NA = NestedScrollInteropConnectionKt.m4537toOffsetUv8p0NA(this.consumedScrollCache, available);
        return m4537toOffsetUv8p0NA;
    }
    ...
    public long mo335onPostScrollDzOQY0M(long consumed, long available, int source) {
        ...
        ArraysKt.fill$default(this.consumedScrollCache, 0, 0, 0, 6, (Object) null);
        NestedScrollingChildHelper nestedScrollingChildHelper2 = this.nestedScrollChildHelper;
        int composeToViewOffset = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2708getXimpl(consumed));
        int composeToViewOffset2 = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2709getYimpl(consumed));
        int composeToViewOffset3 = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2708getXimpl(available));
        int composeToViewOffset4 = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2709getYimpl(available));
        m4538toViewTypeGyEprt82 = NestedScrollInteropConnectionKt.m4538toViewTypeGyEprt8(source);
        nestedScrollingChildHelper2.dispatchNestedScroll(composeToViewOffset, composeToViewOffset2, composeToViewOffset3, composeToViewOffset4, null, m4538toViewTypeGyEprt82, this.consumedScrollCache);
        m4537toOffsetUv8p0NA = NestedScrollInteropConnectionKt.m4537toOffsetUv8p0NA(this.consumedScrollCache, available);
        return m4537toOffsetUv8p0NA;
    }
    ...
    public Object mo559onPreFlingQWom1Mo(long available, Continuation<? super Velocity> continuation) {
        float viewVelocity;
        float viewVelocity2;
        long result;
        NestedScrollingChildHelper nestedScrollingChildHelper = this.nestedScrollChildHelper;
        viewVelocity = NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m5441getXimpl(available));
        viewVelocity2 = NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m5442getYimpl(available));
        if (nestedScrollingChildHelper.dispatchNestedPreFling(viewVelocity, viewVelocity2)) {
            result = available;
        } else {
            result = Velocity.INSTANCE.m5452getZero9UxMQ8M();
        }
        interruptOngoingScrolls();
        return Velocity.m5432boximpl(result);
    }
