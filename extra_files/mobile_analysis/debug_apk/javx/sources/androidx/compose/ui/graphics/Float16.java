...
public final class Float16 implements Comparable<Float16> {
    ...
    private static final short Epsilon = m3052constructorimpl((short) 5120);
    private static final short LowestValue = m3052constructorimpl((short) -1025);
    private static final short MaxValue = m3052constructorimpl((short) 31743);
    private static final short MinNormal = m3052constructorimpl((short) 1024);
    private static final short MinValue = m3052constructorimpl((short) 1);
    private static final short NaN = m3052constructorimpl((short) 32256);
    private static final short NegativeInfinity = m3052constructorimpl((short) -1024);
    private static final short NegativeZero = m3052constructorimpl(ShortCompanionObject.MIN_VALUE);
    private static final short PositiveInfinity = m3052constructorimpl((short) 31744);
    private static final short PositiveZero = m3052constructorimpl((short) 0);
    private static final short One = m3051constructorimpl(1.0f);
    private static final short NegativeOne = m3051constructorimpl(-1.0f);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ Float16 m3047boximpl(short s) {
        return new Float16(s);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static short m3052constructorimpl(short s) {
        return s;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3053equalsimpl(short s, Object obj) {
        return (obj instanceof Float16) && s == ((Float16) obj).m3078unboximpl();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3054equalsimpl0(short s, short s2) {
        return s == s2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m3059hashCodeimpl(short s) {
        return Short.hashCode(s);
    }

    public boolean equals(Object obj) {
        return m3053equalsimpl(this.halfValue, obj);
    }

    public int hashCode() {
        return m3059hashCodeimpl(this.halfValue);
    }

    /* renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ short m3078unboximpl() {
        return this.halfValue;
    }

    @Override // java.lang.Comparable
    public /* bridge */ /* synthetic */ int compareTo(Float16 float16) {
        return m3077compareTo41bOqos(float16.m3078unboximpl());
    }
    ...
    /* renamed from: constructor-impl, reason: not valid java name */
    public static short m3051constructorimpl(float value) {
        return m3052constructorimpl(INSTANCE.floatToHalf(value));
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static short m3050constructorimpl(double value) {
        return m3051constructorimpl((float) value);
    }

    /* renamed from: toByte-impl, reason: not valid java name */
    public static final byte m3066toByteimpl(short arg0) {
        return (byte) m3068toFloatimpl(arg0);
    }

    /* renamed from: toShort-impl, reason: not valid java name */
    public static final short m3073toShortimpl(short arg0) {
        return (short) m3068toFloatimpl(arg0);
    }

    /* renamed from: toInt-impl, reason: not valid java name */
    public static final int m3070toIntimpl(short arg0) {
        return (int) m3068toFloatimpl(arg0);
    }

    /* renamed from: toLong-impl, reason: not valid java name */
    public static final long m3071toLongimpl(short arg0) {
        return (long) m3068toFloatimpl(arg0);
    }

    /* renamed from: toFloat-impl, reason: not valid java name */
    public static final float m3068toFloatimpl(short arg0) {
        int bits = 65535 & arg0;
        int s = 32768 & bits;
        int e = (bits >>> 10) & 31;
    ...
    public static final double m3067toDoubleimpl(short arg0) {
        return m3068toFloatimpl(arg0);
    }

    /* renamed from: toBits-impl, reason: not valid java name */
    public static final int m3065toBitsimpl(short arg0) {
        if (m3062isNaNimpl(arg0)) {
            return NaN;
        }
        return 65535 & arg0;
    }
    ...
    public static final int m3072toRawBitsimpl(short arg0) {
        return 65535 & arg0;
    }

    public String toString() {
        return m3074toStringimpl(this.halfValue);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3074toStringimpl(short arg0) {
        return String.valueOf(m3068toFloatimpl(arg0));
    }

    /* renamed from: compareTo-41bOqos, reason: not valid java name */
    public int m3077compareTo41bOqos(short other) {
        return m3049compareTo41bOqos(this.halfValue, other);
    }

    /* renamed from: compareTo-41bOqos, reason: not valid java name */
    public static int m3049compareTo41bOqos(short s, short s2) {
        if (m3062isNaNimpl(s)) {
            return !m3062isNaNimpl(s2) ? 1 : 0;
        }
        if (m3062isNaNimpl(s2)) {
            return -1;
        }
    ...
    public static final short m3057getSignslo4al4(short arg0) {
        if (m3062isNaNimpl(arg0)) {
            return NaN;
        }
        return m3049compareTo41bOqos(arg0, NegativeZero) < 0 ? NegativeOne : m3049compareTo41bOqos(arg0, PositiveZero) > 0 ? One : arg0;
    }

    /* renamed from: withSign-qCeQghg, reason: not valid java name */
    public static final short m3076withSignqCeQghg(short arg0, short sign) {
        return m3052constructorimpl((short) ((32768 & sign) | (arg0 & ShortCompanionObject.MAX_VALUE)));
    }

    /* renamed from: absoluteValue-slo4al4, reason: not valid java name */
    public static final short m3046absoluteValueslo4al4(short arg0) {
        return m3052constructorimpl((short) (arg0 & ShortCompanionObject.MAX_VALUE));
    }

    /* renamed from: round-slo4al4, reason: not valid java name */
    public static final short m3064roundslo4al4(short arg0) {
        ...
        return m3052constructorimpl((short) result);
    }

    /* renamed from: ceil-slo4al4, reason: not valid java name */
    public static final short m3048ceilslo4al4(short arg0) {
        int bits = 65535 & arg0;
        int e = bits & FP16_COMBINED;
        int result = bits;
        if (e < 15360) {
    ...
    public static final short m3055floorslo4al4(short arg0) {
        int i = SupportMenu.USER_MASK;
        int bits = arg0 & UShort.MAX_VALUE;
        int e = bits & FP16_COMBINED;
        int result = bits;
    ...
    public static final short m3075truncslo4al4(short arg0) {
        int bits = 65535 & arg0;
        int e = bits & FP16_COMBINED;
        int result = bits;
        if (e < 15360) {
    ...
    public static final int m3056getExponentimpl(short arg0) {
        return ((arg0 >>> 10) & 31) - 15;
    }

    /* renamed from: getSignificand-impl, reason: not valid java name */
    public static final int m3058getSignificandimpl(short arg0) {
        return arg0 & 1023;
    }

    /* renamed from: isNaN-impl, reason: not valid java name */
    public static final boolean m3062isNaNimpl(short arg0) {
        return (arg0 & ShortCompanionObject.MAX_VALUE) > FP16_EXPONENT_MAX;
    }

    /* renamed from: isInfinite-impl, reason: not valid java name */
    public static final boolean m3061isInfiniteimpl(short arg0) {
        return (arg0 & ShortCompanionObject.MAX_VALUE) == FP16_EXPONENT_MAX;
    }

    /* renamed from: isFinite-impl, reason: not valid java name */
    public static final boolean m3060isFiniteimpl(short arg0) {
        return (arg0 & ShortCompanionObject.MAX_VALUE) != FP16_EXPONENT_MAX;
    }

    /* renamed from: isNormalized-impl, reason: not valid java name */
    public static final boolean m3063isNormalizedimpl(short arg0) {
        return ((arg0 & 31744) == 0 || (arg0 & 31744) == FP16_EXPONENT_MAX) ? false : true;
    }

    /* renamed from: toHexString-impl, reason: not valid java name */
    public static final String m3069toHexStringimpl(short arg0) {
