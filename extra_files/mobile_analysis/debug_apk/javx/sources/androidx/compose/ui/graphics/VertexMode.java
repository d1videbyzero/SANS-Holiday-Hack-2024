...
public final class VertexMode {
    ...
    private static final int Triangles = m3333constructorimpl(0);
    private static final int TriangleStrip = m3333constructorimpl(1);
    private static final int TriangleFan = m3333constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ VertexMode m3332boximpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m3341getTrianglesc2xauaI() {
            return VertexMode.Triangles;
        }

        /* renamed from: getTriangleStrip-c2xauaI, reason: not valid java name */
        public final int m3340getTriangleStripc2xauaI() {
            return VertexMode.TriangleStrip;
        }

        /* renamed from: getTriangleFan-c2xauaI, reason: not valid java name */
        public final int m3339getTriangleFanc2xauaI() {
            return VertexMode.TriangleFan;
        }
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3337toStringimpl(int arg0) {
        return m3335equalsimpl0(arg0, Triangles) ? "Triangles" : m3335equalsimpl0(arg0, TriangleStrip) ? "TriangleStrip" : m3335equalsimpl0(arg0, TriangleFan) ? "TriangleFan" : "Unknown";
    }
