...
public final /* data */ class BiasAbsoluteAlignment implements Alignment {
    ...
    public long mo2598alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        ...
        long remaining = IntSizeKt.IntSize(IntSize.m5376getWidthimpl(space) - IntSize.m5376getWidthimpl(size), IntSize.m5375getHeightimpl(space) - IntSize.m5375getHeightimpl(size));
        float centerX = IntSize.m5376getWidthimpl(remaining) / 2.0f;
        float centerY = IntSize.m5375getHeightimpl(remaining) / 2.0f;
        float f = 1;
