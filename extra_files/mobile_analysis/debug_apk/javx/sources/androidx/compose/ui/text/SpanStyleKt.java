...
public final class SpanStyleKt {
    ...
    public static final long m4689lerpTextUnitInheritableC3pnCVY(long a, long b, float t) {
        if (TextUnitKt.m5415isUnspecifiedR2X_6o(a) || TextUnitKt.m5415isUnspecifiedR2X_6o(b)) {
            return ((TextUnit) lerpDiscrete(TextUnit.m5387boximpl(a), TextUnit.m5387boximpl(b), t)).getPackedValue();
        }
        return TextUnitKt.m5417lerpC3pnCVY(a, b, t);
    }
    ...
    public static final SpanStyle lerp(SpanStyle start, SpanStyle stop, float fraction) {
        ...
        long m4689lerpTextUnitInheritableC3pnCVY = m4689lerpTextUnitInheritableC3pnCVY(start.getFontSize(), stop.getFontSize(), fraction);
        ...
        long m4689lerpTextUnitInheritableC3pnCVY2 = m4689lerpTextUnitInheritableC3pnCVY(start.getLetterSpacing(), stop.getLetterSpacing(), fraction);
        BaselineShift baselineShift = start.getBaselineShift();
        float m4987unboximpl = baselineShift != null ? baselineShift.m4987unboximpl() : BaselineShift.m4982constructorimpl(0.0f);
        BaselineShift baselineShift2 = stop.getBaselineShift();
        float m4994lerpjWV1Mfo = BaselineShiftKt.m4994lerpjWV1Mfo(m4987unboximpl, baselineShift2 != null ? baselineShift2.m4987unboximpl() : BaselineShift.m4982constructorimpl(0.0f), fraction);
        ...
        long m2998lerpjxsXWHM = ColorKt.m2998lerpjxsXWHM(start.getBackground(), stop.getBackground(), fraction);
        ...
        return new SpanStyle(lerp, m4689lerpTextUnitInheritableC3pnCVY, lerp2, fontStyle, fontSynthesis, fontFamily, str, m4689lerpTextUnitInheritableC3pnCVY2, BaselineShift.m4981boximpl(m4994lerpjWV1Mfo), lerp3, localeList, m2998lerpjxsXWHM, textDecoration, ShadowKt.lerp(shadow, shadow2, fraction), lerpPlatformStyle(start.getPlatformStyle(), stop.getPlatformStyle(), fraction), (DrawStyle) lerpDiscrete(start.getDrawStyle(), stop.getDrawStyle(), fraction), (DefaultConstructorMarker) null);
    }
    ...
    public static final SpanStyle resolveSpanStyleDefaults(SpanStyle style) {
        ...
        TextForegroundStyle takeOrElse = style.getTextForegroundStyle().takeOrElse(new Function0<TextForegroundStyle>() { // from class: androidx.compose.ui.text.SpanStyleKt$resolveSpanStyleDefaults$1
            ...
            public final TextForegroundStyle invoke() {
                ...
                return companion.m5107from8_81llA(j);
            }
        });
        long fontSize = TextUnitKt.m5415isUnspecifiedR2X_6o(style.getFontSize()) ? DefaultFontSize : style.getFontSize();
        ...
        FontSynthesis m4825boximpl = FontSynthesis.m4825boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m4834getAllGVVA2EU());
        ...
        if (TextUnitKt.m5415isUnspecifiedR2X_6o(style.getLetterSpacing())) {
            letterSpacing = DefaultLetterSpacing;
        } else {
            letterSpacing = style.getLetterSpacing();
        }
        BaselineShift baselineShift = style.getBaselineShift();
        BaselineShift m4981boximpl = BaselineShift.m4981boximpl(baselineShift != null ? baselineShift.m4987unboximpl() : BaselineShift.INSTANCE.m4991getNoney9eOQZs());
        ...
        return new SpanStyle(takeOrElse, fontSize, fontWeight2, m4816boximpl, m4825boximpl, fontFamily2, str, letterSpacing, m4981boximpl, textGeometricTransform2, localeList2, j, textDecoration2, shadow2, platformStyle, drawStyle, (DefaultConstructorMarker) null);
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:67:0x0059, code lost:
        ...
        if (r40 == androidx.compose.ui.graphics.Color.INSTANCE.m2983getUnspecified0d7_KjU()) goto L13;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:71:0x006d, code lost:
        ...
        if (androidx.compose.ui.graphics.Color.m2948equalsimpl0(r40, r39.getTextForegroundStyle().mo4995getColor0d7_KjU()) == false) goto L18;
     */
