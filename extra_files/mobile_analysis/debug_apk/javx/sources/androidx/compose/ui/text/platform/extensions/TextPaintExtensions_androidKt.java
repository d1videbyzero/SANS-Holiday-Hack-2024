...
public final class TextPaintExtensions_androidKt {
    ...
    public static final SpanStyle applySpanStyle(AndroidTextPaint $this$applySpanStyle, SpanStyle style, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> resolveTypeface, Density density, boolean requiresLetterSpacing) {
        ...
        long m5396getTypeUIouoOA = TextUnit.m5396getTypeUIouoOA(style.getFontSize());
        if (TextUnitType.m5425equalsimpl0(m5396getTypeUIouoOA, TextUnitType.INSTANCE.m5430getSpUIouoOA())) {
            ...
            $this$applySpanStyle.setTextSize($this$applySpanStyle.getTextSize() * TextUnit.m5397getValueimpl(style.getFontSize()));
        }
        if (hasFontAttributes(style)) {
            ...
            $this$applySpanStyle.setTypeface(resolveTypeface.invoke(fontFamily, fontWeight, m4816boximpl, FontSynthesis.m4825boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m4834getAllGVVA2EU())));
        }
        ...
        $this$applySpanStyle.m4962setColor8_81llA(style.m4683getColor0d7_KjU());
        $this$applySpanStyle.m4961setBrush12SF9DM(style.getBrush(), Size.INSTANCE.m2785getUnspecifiedNHjbRc(), style.getAlpha());
        ...
        if (TextUnitType.m5425equalsimpl0(TextUnit.m5396getTypeUIouoOA(style.getLetterSpacing()), TextUnitType.INSTANCE.m5430getSpUIouoOA())) {
            if (!(TextUnit.m5397getValueimpl(style.getLetterSpacing()) == 0.0f)) {
                ...
                return m4976generateFallbackSpanStyle62GTOB8(style.getLetterSpacing(), requiresLetterSpacing, style.getBackground(), style.getBaselineShift());
            }
        }
        if (TextUnitType.m5425equalsimpl0(TextUnit.m5396getTypeUIouoOA(style.getLetterSpacing()), TextUnitType.INSTANCE.m5429getEmUIouoOA())) {
            $this$applySpanStyle.setLetterSpacing(TextUnit.m5397getValueimpl(style.getLetterSpacing()));
        }
        return m4976generateFallbackSpanStyle62GTOB8(style.getLetterSpacing(), requiresLetterSpacing, style.getBackground(), style.getBaselineShift());
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:17:0x0053, code lost:
        ...
        if (androidx.compose.ui.text.style.BaselineShift.m4984equalsimpl0(r36.m4987unboximpl(), androidx.compose.ui.text.style.BaselineShift.INSTANCE.m4991getNoney9eOQZs()) == false) goto L24;
     */
    ...
    */
    private static final androidx.compose.ui.text.SpanStyle m4976generateFallbackSpanStyle62GTOB8(long r31, boolean r33, long r34, androidx.compose.ui.text.style.BaselineShift r36) {
        /*
            r0 = r34
            r2 = 1
            r3 = 0
            if (r33 == 0) goto L26
            long r4 = androidx.compose.ui.unit.TextUnit.m5396getTypeUIouoOA(r31)
            androidx.compose.ui.unit.TextUnitType$Companion r6 = androidx.compose.ui.unit.TextUnitType.INSTANCE
            long r6 = r6.m5430getSpUIouoOA()
            boolean r4 = androidx.compose.ui.unit.TextUnitType.m5425equalsimpl0(r4, r6)
            if (r4 == 0) goto L26
            float r4 = androidx.compose.ui.unit.TextUnit.m5397getValueimpl(r31)
            r5 = 0
        ...
        L43:
            ...
            float r6 = r6.m4991getNoney9eOQZs()
            float r7 = r36.m4987unboximpl()
            boolean r6 = androidx.compose.ui.text.style.BaselineShift.m4984equalsimpl0(r7, r6)
            if (r6 != 0) goto L56
            goto L57
        L56:
            r2 = r3
        ...
        L64:
            ...
            long r6 = r6.m5408getUnspecifiedXSAIIZE()
            r18 = r6
        L6c:
            if (r5 == 0) goto L71
            r23 = r0
        ...
        La6:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.text.platform.extensions.TextPaintExtensions_androidKt.m4976generateFallbackSpanStyle62GTOB8(long, boolean, long, androidx.compose.ui.text.style.BaselineShift):androidx.compose.ui.text.SpanStyle");
    }
    ...
    public static final void setTextMotion(AndroidTextPaint $this$setTextMotion, TextMotion textMotion) {
        ...
        if (TextMotion.Linearity.m5118equalsimpl0(linearity, TextMotion.Linearity.INSTANCE.m5123getLinear4e0Vf04())) {
            $this$setTextMotion.setFlags($this$setTextMotion.getFlags() | 64);
            $this$setTextMotion.setHinting(0);
        } else if (TextMotion.Linearity.m5118equalsimpl0(linearity, TextMotion.Linearity.INSTANCE.m5122getFontHinting4e0Vf04())) {
            $this$setTextMotion.getFlags();
            $this$setTextMotion.setHinting(1);
        } else if (TextMotion.Linearity.m5118equalsimpl0(linearity, TextMotion.Linearity.INSTANCE.m5124getNone4e0Vf04())) {
            $this$setTextMotion.getFlags();
            $this$setTextMotion.setHinting(0);
        } else {
            $this$setTextMotion.getFlags();
