...
public final class MotionEventAdapter {
    ...
    private final long m3997getComposePointerId_I2yYro(int motionEventPointerId) {
        long newId;
        ...
        return PointerId.m4047constructorimpl(newId);
    }
    ...
    private final PointerInputEventData createPointerInputEventData(PositionCalculator positionCalculator, MotionEvent motionEvent, int index, boolean pressed) {
        ...
        long pointerId = m3997getComposePointerId_I2yYro(motionEventPointerId);
        ...
        if (index == 0) {
            ...
            position = positionCalculator.mo4147screenToLocalMKHz9U(rawPosition2);
            rawPosition = rawPosition2;
        } else if (Build.VERSION.SDK_INT >= 29) {
            long rawPosition3 = MotionEventHelper.INSTANCE.m3998toRawOffsetdBAh8RU(motionEvent, index);
            position = positionCalculator.mo4147screenToLocalMKHz9U(rawPosition3);
            rawPosition = rawPosition3;
        } else {
            long rawPosition4 = positionCalculator.mo4146localToScreenMKHz9U(position2);
            position = position2;
            rawPosition = rawPosition4;
        }
        switch (motionEvent.getToolType(index)) {
            case 0:
                toolType = PointerType.INSTANCE.m4145getUnknownT8wyACA();
                break;
            case 1:
                toolType = PointerType.INSTANCE.m4144getTouchT8wyACA();
                break;
            case 2:
                toolType = PointerType.INSTANCE.m4143getStylusT8wyACA();
                break;
            case 3:
                toolType = PointerType.INSTANCE.m4142getMouseT8wyACA();
                break;
            case 4:
                toolType = PointerType.INSTANCE.m4141getEraserT8wyACA();
                break;
            default:
                toolType = PointerType.INSTANCE.m4145getUnknownT8wyACA();
                break;
