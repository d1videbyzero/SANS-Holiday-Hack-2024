...
public final class MeasureAndLayoutDelegate {
    ...
    public final void m4355updateRootConstraintsBRTryo0(long constraints) {
        ...
        if (!(constraints2 == null ? false : Constraints.m5165equalsimpl0(constraints2.getValue(), constraints))) {
            ...
            this.rootConstraints = Constraints.m5160boximpl(constraints);
    ...
    public final void m4354measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        ...
        if (this.rootConstraints != null) {
            ...
            try {
                ...
                boolean lookaheadSizeChanged = m4352doLookaheadRemeasuresdFAvZA(layoutNode, Constraints.m5160boximpl(constraints));
                m4353doRemeasuresdFAvZA(layoutNode, Constraints.m5160boximpl(constraints));
