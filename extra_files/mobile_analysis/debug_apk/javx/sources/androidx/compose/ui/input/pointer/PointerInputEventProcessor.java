...
public final class PointerInputEventProcessor {
    ...
    public static /* synthetic */ int m4084processBIzXfog$default(PointerInputEventProcessor pointerInputEventProcessor, PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator, boolean z, int i, Object obj) {
        if ((i & 4) != 0) {
            z = true;
        }
        return pointerInputEventProcessor.m4085processBIzXfog(pointerInputEvent, positionCalculator, z);
    }
    ...
    */
    public final int m4085processBIzXfog(androidx.compose.ui.input.pointer.PointerInputEvent r24, androidx.compose.ui.input.pointer.PositionCalculator r25, boolean r26) {
        /*
            Method dump skipped, instructions count: 325
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.input.pointer.PointerInputEventProcessor.m4085processBIzXfog(androidx.compose.ui.input.pointer.PointerInputEvent, androidx.compose.ui.input.pointer.PositionCalculator, boolean):int");
    }
