...
public interface Canvas {
    ...
    static /* synthetic */ void m2919clipRectN_I0leg$default(Canvas canvas, float f, float f2, float f3, float f4, int i, int i2, Object obj) {
        ...
        if ((i2 & 16) == 0) {
            ...
            i3 = ClipOp.INSTANCE.m2936getIntersectrtfAjoo();
        }
        canvas.mo2803clipRectN_I0leg(f, f2, f3, f4, i3);
    }
    ...
    static /* synthetic */ void m2921drawImageRectHPBpro0$default(Canvas canvas, ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint, int i, Object obj) {
        ...
        long m5344getZeronOccac = (i & 2) != 0 ? IntOffset.INSTANCE.m5344getZeronOccac() : j;
        long IntSize = (i & 4) != 0 ? IntSizeKt.IntSize(imageBitmap.getWidth(), imageBitmap.getHeight()) : j2;
        canvas.mo2807drawImageRectHPBpro0(imageBitmap, m5344getZeronOccac, IntSize, (i & 8) != 0 ? IntOffset.INSTANCE.m5344getZeronOccac() : j3, (i & 16) != 0 ? IntSize : j4, paint);
    }
}
