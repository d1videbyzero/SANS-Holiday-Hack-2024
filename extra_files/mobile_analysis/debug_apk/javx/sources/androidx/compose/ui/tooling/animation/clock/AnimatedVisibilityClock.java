...
public final class AnimatedVisibilityClock implements ComposeAnimationClock<AnimatedVisibilityComposeAnimation, AnimatedVisibilityState> {
    ...
    public AnimatedVisibilityClock(AnimatedVisibilityComposeAnimation animation) {
        String m5158getEnterjXw82LU;
        Intrinsics.checkNotNullParameter(animation, "animation");
        this.animation = animation;
        if (getAnimation().m5144getAnimationObject().getCurrentState().booleanValue()) {
            m5158getEnterjXw82LU = AnimatedVisibilityState.INSTANCE.m5159getExitjXw82LU();
        } else {
            m5158getEnterjXw82LU = AnimatedVisibilityState.INSTANCE.m5158getEnterjXw82LU();
        }
        this.state = m5158getEnterjXw82LU;
    }
    ...
    public /* bridge */ /* synthetic */ AnimatedVisibilityState getState() {
        return AnimatedVisibilityState.m5151boximpl(getState());
    }

    @Override // androidx.compose.ui.tooling.animation.clock.ComposeAnimationClock
    public /* bridge */ /* synthetic */ void setState(AnimatedVisibilityState animatedVisibilityState) {
        m5150setState7IW2chM(animatedVisibilityState.m5157unboximpl());
    }
    ...
    public void m5150setState7IW2chM(String value) {
    ...
    public void setStateParameters(Object par1, Object par2) {
        ...
        m5150setState7IW2chM(((AnimatedVisibilityState) par1).m5157unboximpl());
    }
    ...
    public void setClockTime(long animationTimeNanos) {
        Transition it = getAnimation().m5144getAnimationObject();
        Pair<Boolean, Boolean> m5148toCurrentTargetPair7IW2chM = m5148toCurrentTargetPair7IW2chM(getState());
        boolean current = m5148toCurrentTargetPair7IW2chM.component1().booleanValue();
        boolean target = m5148toCurrentTargetPair7IW2chM.component2().booleanValue();
    ...
    private final Pair<Boolean, Boolean> m5148toCurrentTargetPair7IW2chM(String $this$toCurrentTargetPair_u2d7IW2chM) {
        return AnimatedVisibilityState.m5154equalsimpl0($this$toCurrentTargetPair_u2d7IW2chM, AnimatedVisibilityState.INSTANCE.m5158getEnterjXw82LU()) ? TuplesKt.to(false, true) : TuplesKt.to(true, false);
    }
}
