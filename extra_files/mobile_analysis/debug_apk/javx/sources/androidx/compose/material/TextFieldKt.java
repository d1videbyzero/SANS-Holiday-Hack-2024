...
public final class TextFieldKt {
    private static final float FirstBaselineOffset = Dp.m5216constructorimpl(20);
    private static final float TextFieldBottomPadding = Dp.m5216constructorimpl(10);
    private static final float TextFieldTopPadding = Dp.m5216constructorimpl(4);
    ...
    */
    ...
    public static final int m1252calculateHeightO3s9Psw(int textFieldHeight, boolean hasLabel, int labelBaseline, int leadingHeight, int trailingHeight, int placeholderHeight, long constraints, float density, PaddingValues paddingValues) {
        ...
        return Math.max(MathKt.roundToInt(middleSectionHeight), Math.max(Math.max(leadingHeight, trailingHeight), Constraints.m5173getMinHeightimpl(constraints)));
    }
