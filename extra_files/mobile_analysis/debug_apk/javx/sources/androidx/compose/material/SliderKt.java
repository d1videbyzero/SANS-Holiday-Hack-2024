...
public final class SliderKt {
    private static final float ThumbRadius = Dp.m5216constructorimpl(10);
    private static final float ThumbRippleRadius = Dp.m5216constructorimpl(24);
    private static final float ThumbDefaultElevation = Dp.m5216constructorimpl(1);
    private static final float ThumbPressedElevation = Dp.m5216constructorimpl(6);
    private static final float TrackHeight = Dp.m5216constructorimpl(4);
    private static final float SliderHeight = Dp.m5216constructorimpl(48);
    private static final float SliderMinWidth = Dp.m5216constructorimpl(144);
    private static final Modifier DefaultSliderConstraints = SizeKt.m517heightInVpY3zN4$default(SizeKt.m536widthInVpY3zN4$default(Modifier.INSTANCE, SliderMinWidth, 0.0f, 2, null), 0.0f, SliderHeight, 1, null);
    ...
    */
    ...
    public static final void RangeSlider(final ClosedFloatingPointRange<Float> value, final Function1<? super ClosedFloatingPointRange<Float>, Unit> onValueChange, Modifier modifier, boolean enabled, ClosedFloatingPointRange<Float> closedFloatingPointRange, int steps, Function0<Unit> function0, SliderColors colors, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty2 & 23967451) == 4793490 && $composer3.getSkipping()) {
            ...
            float arg0$iv2 = Dp.m5216constructorimpl(4 * arg0$iv);
            float arg0$iv3 = ThumbRadius;
            $composer2 = $composer3;
            BoxWithConstraintsKt.BoxWithConstraints(SizeKt.m525requiredSizeInqDBjuR0$default(minimumInteractiveComponentSize, arg0$iv2, Dp.m5216constructorimpl(2 * arg0$iv3), 0.0f, 0.0f, 12, null), null, false, ComposableLambdaKt.composableLambda($composer2, 652589923, true, new SliderKt$RangeSlider$2(valueRange2, value, $dirty, onValueChangeState, startInteractionSource, endInteractionSource, enabled3, steps3, onValueChangeFinished2, tickFractions, colors2)), $composer2, 3072, 6);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void Track(final Modifier modifier, final SliderColors colors, final boolean enabled, final float positionFractionStart, final float positionFractionEnd, final List<Float> list, final float thumbPx, final float trackStrokeWidth, Composer $composer, final int $changed) {
        ...
        CanvasKt.Canvas(modifier, new Function1<DrawScope, Unit>() { // from class: androidx.compose.material.SliderKt$Track$1
            ...
            public final void invoke2(DrawScope Canvas) {
                ...
                long sliderLeft = OffsetKt.Offset(thumbPx, Offset.m2709getYimpl(Canvas.mo3489getCenterF1C5BW0()));
                long sliderRight = OffsetKt.Offset(Size.m2777getWidthimpl(Canvas.mo3490getSizeNHjbRc()) - thumbPx, Offset.m2709getYimpl(Canvas.mo3489getCenterF1C5BW0()));
                ...
                long sliderValueEnd = OffsetKt.Offset(Offset.m2708getXimpl(sliderStart2) + ((Offset.m2708getXimpl(sliderEnd2) - Offset.m2708getXimpl(sliderStart2)) * positionFractionEnd), Offset.m2709getYimpl(Canvas.mo3489getCenterF1C5BW0()));
                long sliderValueStart = OffsetKt.Offset(Offset.m2708getXimpl(sliderStart2) + ((Offset.m2708getXimpl(sliderEnd2) - Offset.m2708getXimpl(sliderStart2)) * positionFractionStart), Offset.m2709getYimpl(Canvas.mo3489getCenterF1C5BW0()));
                ...
                for (Map.Entry element$iv : destination$iv$iv.entrySet()) {
                    ...
                    for (Object item$iv$iv : $this$map$iv) {
                        ...
                        destination$iv$iv2.add(Offset.m2697boximpl(OffsetKt.Offset(Offset.m2708getXimpl(OffsetKt.m2731lerpWko1d7g(sliderStart3, sliderEnd3, ((Number) item$iv$iv).floatValue())), Offset.m2709getYimpl(Canvas.mo3489getCenterF1C5BW0()))));
                    ...
                    DrawScope.m3482drawPointsF8ZwMP8$default(Canvas, (List) destination$iv$iv2, PointMode.INSTANCE.m3246getPointsr_lszbg(), (outsideFraction ? state5 : state4).getValue().m2957unboximpl(), f3, StrokeCap.INSTANCE.m3294getRoundKaPHkGw(), null, 0.0f, null, 0, 480, null);
                    f3 = f3;
                    state2 = state4;
                    state = state5;
                    isRtl = isRtl2;
