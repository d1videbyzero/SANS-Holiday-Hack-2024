...
public final class ButtonDefaults {
    ...
    private static final float ButtonHorizontalPadding = Dp.m5216constructorimpl(16);
    ...
    private static final float MinWidth = Dp.m5216constructorimpl(64);
    private static final float MinHeight = Dp.m5216constructorimpl(36);
    private static final float IconSize = Dp.m5216constructorimpl(18);
    ...
    private static final float TextButtonHorizontalPadding = Dp.m5216constructorimpl(8);
    ...
    public final /* synthetic */ ButtonElevation m1001elevationyajeYGU(float defaultElevation, float pressedElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        ...
        float defaultElevation2 = (i & 1) != 0 ? Dp.m5216constructorimpl(2) : defaultElevation;
        float pressedElevation2 = (i & 2) != 0 ? Dp.m5216constructorimpl(8) : pressedElevation;
        float disabledElevation2 = (i & 4) != 0 ? Dp.m5216constructorimpl(0) : disabledElevation;
        ...
        ButtonElevation m1000elevationR_JCAzs = m1000elevationR_JCAzs(defaultElevation2, pressedElevation2, disabledElevation2, Dp.m5216constructorimpl(4), Dp.m5216constructorimpl(4), $composer, $this$dp$iv | 27648 | ($changed & 112) | ($changed & 896) | (($changed << 6) & 458752), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
        return m1000elevationR_JCAzs;
    }
    ...
    public final ButtonElevation m1000elevationR_JCAzs(float defaultElevation, float pressedElevation, float disabledElevation, float hoveredElevation, float focusedElevation, Composer $composer, int $changed, int i) {
        ...
        float pressedElevation2 = (i & 2) != 0 ? Dp.m5216constructorimpl(8) : pressedElevation;
        float disabledElevation2 = (i & 4) != 0 ? Dp.m5216constructorimpl(0) : disabledElevation;
        float hoveredElevation2 = (i & 8) != 0 ? Dp.m5216constructorimpl(4) : hoveredElevation;
        float focusedElevation2 = (i & 16) != 0 ? Dp.m5216constructorimpl(4) : focusedElevation;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-737170518, $changed, -1, "androidx.compose.material.ButtonDefaults.elevation (Button.kt:371)");
        }
        Object[] keys$iv = {Dp.m5214boximpl(defaultElevation2), Dp.m5214boximpl(pressedElevation2), Dp.m5214boximpl(disabledElevation2), Dp.m5214boximpl(hoveredElevation2), Dp.m5214boximpl(focusedElevation2)};
    ...
    public final ButtonColors m999buttonColorsro_MJ88(long backgroundColor, long contentColor, long disabledBackgroundColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        ...
        if ((i & 4) != 0) {
            m2945copywmQWz5c = Color.m2945copywmQWz5c(r7, (r12 & 1) != 0 ? Color.m2949getAlphaimpl(r7) : 0.12f, (r12 & 2) != 0 ? Color.m2953getRedimpl(r7) : 0.0f, (r12 & 4) != 0 ? Color.m2952getGreenimpl(r7) : 0.0f, (r12 & 8) != 0 ? Color.m2950getBlueimpl(MaterialTheme.INSTANCE.getColors($composer, 6).m1033getOnSurface0d7_KjU()) : 0.0f);
            disabledBackgroundColor2 = ColorKt.m2992compositeOverOWjLjI(m2945copywmQWz5c, MaterialTheme.INSTANCE.getColors($composer, 6).m1038getSurface0d7_KjU());
        } else {
            disabledBackgroundColor2 = disabledBackgroundColor;
        }
        long disabledContentColor2 = (i & 8) != 0 ? Color.m2945copywmQWz5c(r7, (r12 & 1) != 0 ? Color.m2949getAlphaimpl(r7) : ContentAlpha.INSTANCE.getDisabled($composer, 6), (r12 & 2) != 0 ? Color.m2953getRedimpl(r7) : 0.0f, (r12 & 4) != 0 ? Color.m2952getGreenimpl(r7) : 0.0f, (r12 & 8) != 0 ? Color.m2950getBlueimpl(MaterialTheme.INSTANCE.getColors($composer, 6).m1033getOnSurface0d7_KjU()) : 0.0f) : disabledContentColor;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final ButtonColors m1007outlinedButtonColorsRGew2ao(long backgroundColor, long contentColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        ...
        long disabledContentColor2 = (i & 4) != 0 ? Color.m2945copywmQWz5c(r6, (r12 & 1) != 0 ? Color.m2949getAlphaimpl(r6) : ContentAlpha.INSTANCE.getDisabled($composer, 6), (r12 & 2) != 0 ? Color.m2953getRedimpl(r6) : 0.0f, (r12 & 4) != 0 ? Color.m2952getGreenimpl(r6) : 0.0f, (r12 & 8) != 0 ? Color.m2950getBlueimpl(MaterialTheme.INSTANCE.getColors($composer, 6).m1033getOnSurface0d7_KjU()) : 0.0f) : disabledContentColor;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final ButtonColors m1008textButtonColorsRGew2ao(long backgroundColor, long contentColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        ...
        long contentColor2 = (i & 2) != 0 ? MaterialTheme.INSTANCE.getColors($composer, 6).m1034getPrimary0d7_KjU() : contentColor;
        if ((i & 4) != 0) {
            m2945copywmQWz5c = Color.m2945copywmQWz5c(r6, (r12 & 1) != 0 ? Color.m2949getAlphaimpl(r6) : ContentAlpha.INSTANCE.getDisabled($composer, 6), (r12 & 2) != 0 ? Color.m2953getRedimpl(r6) : 0.0f, (r12 & 4) != 0 ? Color.m2952getGreenimpl(r6) : 0.0f, (r12 & 8) != 0 ? Color.m2950getBlueimpl(MaterialTheme.INSTANCE.getColors($composer, 6).m1033getOnSurface0d7_KjU()) : 0.0f);
