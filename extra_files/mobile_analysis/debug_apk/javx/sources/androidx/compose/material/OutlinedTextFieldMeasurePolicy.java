...
final class OutlinedTextFieldMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo13measure3p2s80s(final MeasureScope measure, List<? extends Measurable> list, long constraints) {
        ...
        Object obj4;
        final int width;
        int m1143calculateHeightO3s9Psw;
        ...
        final Placeable trailingPlaceable = measurable2 != null ? measurable2.mo4184measureBRTryo0(ConstraintsKt.m5189offsetNN6EwU$default(relaxedConstraints, -occupiedSpaceHorizontally2, 0, 2, null)) : null;
        ...
        long labelConstraints = ConstraintsKt.m5188offsetNN6EwU(relaxedConstraints, MathHelpersKt.lerp((-occupiedSpaceHorizontally) - labelHorizontalPaddingOffset, -labelHorizontalPaddingOffset, this.animationProgress), -bottomPadding);
        ...
        final Placeable labelPlaceable = measurable3 != null ? measurable3.mo4184measureBRTryo0(labelConstraints) : null;
        ...
        while (true) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it9), "TextField")) {
                final Placeable textFieldPlaceable = ((Measurable) element$iv).mo4184measureBRTryo0(textConstraints2);
                placeholderConstraints = Constraints.m5162copyZbe2FdA(r23, (r12 & 1) != 0 ? Constraints.m5174getMinWidthimpl(r23) : 0, (r12 & 2) != 0 ? Constraints.m5172getMaxWidthimpl(r23) : 0, (r12 & 4) != 0 ? Constraints.m5173getMinHeightimpl(r23) : 0, (r12 & 8) != 0 ? Constraints.m5171getMaxHeightimpl(textConstraints2) : 0);
                ...
                final Placeable placeholderPlaceable = measurable4 != null ? measurable4.mo4184measureBRTryo0(placeholderConstraints) : null;
                width = OutlinedTextFieldKt.m1144calculateWidthO3s9Psw(TextFieldImplKt.widthOrZero(leadingPlaceable), TextFieldImplKt.widthOrZero(trailingPlaceable), textFieldPlaceable.getWidth(), TextFieldImplKt.widthOrZero(labelPlaceable), TextFieldImplKt.widthOrZero(placeholderPlaceable), this.animationProgress, constraints, measure.getDensity(), this.paddingValues);
                m1143calculateHeightO3s9Psw = OutlinedTextFieldKt.m1143calculateHeightO3s9Psw(TextFieldImplKt.heightOrZero(leadingPlaceable), TextFieldImplKt.heightOrZero(trailingPlaceable), textFieldPlaceable.getHeight(), TextFieldImplKt.heightOrZero(labelPlaceable), TextFieldImplKt.heightOrZero(placeholderPlaceable), this.animationProgress, constraints, measure.getDensity(), this.paddingValues);
                int bottomPadding2 = m1143calculateHeightO3s9Psw;
                ...
                for (Object element$iv2 : $this$first$iv3) {
                    ...
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it12), OutlinedTextFieldKt.BorderId)) {
                        final Placeable borderPlaceable = ((Measurable) element$iv2).mo4184measureBRTryo0(ConstraintsKt.Constraints(width != Integer.MAX_VALUE ? width : 0, width, bottomPadding2 != Integer.MAX_VALUE ? bottomPadding2 : 0, bottomPadding2));
    ...
    private final int intrinsicWidth(IntrinsicMeasureScope $this$intrinsicWidth, List<? extends IntrinsicMeasurable> list, int height, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        Object obj3;
        Object obj4;
        int m1144calculateWidthO3s9Psw;
        ...
        for (Object element$iv : $this$first$iv) {
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) element$iv), "TextField")) {
                ...
                m1144calculateWidthO3s9Psw = OutlinedTextFieldKt.m1144calculateWidthO3s9Psw(leadingWidth, trailingWidth, textFieldWidth, labelWidth, placeholderWidth, this.animationProgress, TextFieldImplKt.getZeroConstraints(), $this$intrinsicWidth.getDensity(), this.paddingValues);
                return m1144calculateWidthO3s9Psw;
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
    ...
    private final int intrinsicHeight(IntrinsicMeasureScope $this$intrinsicHeight, List<? extends IntrinsicMeasurable> list, int width, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        for (Object element$iv : $this$first$iv) {
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) element$iv), "TextField")) {
                ...
                m1143calculateHeightO3s9Psw = OutlinedTextFieldKt.m1143calculateHeightO3s9Psw(leadingHeight, trailingHeight, textFieldHeight, labelHeight, placeholderHeight, this.animationProgress, TextFieldImplKt.getZeroConstraints(), $this$intrinsicHeight.getDensity(), this.paddingValues);
                return m1143calculateHeightO3s9Psw;
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
