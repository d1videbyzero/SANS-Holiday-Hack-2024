...
final class TwoLine {
    ...
    private static final float MinHeight = Dp.m5216constructorimpl(64);
    private static final float MinHeightWithIcon = Dp.m5216constructorimpl(72);
    private static final float IconMinPaddedWidth = Dp.m5216constructorimpl(40);
    private static final float IconLeftPadding = Dp.m5216constructorimpl(16);
    private static final float IconVerticalPadding = Dp.m5216constructorimpl(16);
    private static final float ContentLeftPadding = Dp.m5216constructorimpl(16);
    private static final float ContentRightPadding = Dp.m5216constructorimpl(16);
    private static final float OverlineBaselineOffset = Dp.m5216constructorimpl(24);
    private static final float OverlineToPrimaryBaselineOffset = Dp.m5216constructorimpl(20);
    private static final float PrimaryBaselineOffsetNoIcon = Dp.m5216constructorimpl(28);
    private static final float PrimaryBaselineOffsetWithIcon = Dp.m5216constructorimpl(32);
    private static final float PrimaryToSecondaryBaselineOffsetNoIcon = Dp.m5216constructorimpl(20);
    private static final float PrimaryToSecondaryBaselineOffsetWithIcon = Dp.m5216constructorimpl(20);
    private static final float TrailingRightPadding = Dp.m5216constructorimpl(16);
