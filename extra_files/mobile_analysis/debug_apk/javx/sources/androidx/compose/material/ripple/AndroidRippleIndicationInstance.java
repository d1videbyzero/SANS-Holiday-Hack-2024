...
public final class AndroidRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver {
    ...
    public void drawIndication(ContentDrawScope $this$drawIndication) {
        ...
        this.rippleSize = $this$drawIndication.mo3490getSizeNHjbRc();
        float $this$isUnspecified$iv = this.radius;
        if (Float.isNaN($this$isUnspecified$iv)) {
            i = MathKt.roundToInt(RippleAnimationKt.m1278getRippleEndRadiuscSwnlzA($this$drawIndication, this.bounded, $this$drawIndication.mo3490getSizeNHjbRc()));
        } else {
        ...
        if ($this$drawIndication_u24lambda_u241_u24lambda_u240 != null) {
            $this$drawIndication_u24lambda_u241_u24lambda_u240.m1282updateRipplePropertiesbiQXAtU($this$drawIndication.mo3490getSizeNHjbRc(), this.rippleRadius, color, alpha);
