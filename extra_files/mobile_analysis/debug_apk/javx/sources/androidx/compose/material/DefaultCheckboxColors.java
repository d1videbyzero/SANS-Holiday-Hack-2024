...
final class DefaultCheckboxColors implements CheckboxColors {
    ...
    public State<Color> checkmarkColor(ToggleableState state, Composer $composer, int $changed) {
        ...
        State<Color> m70animateColorAsStateeuL9pac = SingleValueAnimationKt.m70animateColorAsStateeuL9pac(target, AnimationSpecKt.tween$default(duration, 0, null, 6, null), null, null, $composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public State<Color> boxColor(boolean enabled, ToggleableState state, Composer $composer, int $changed) {
        ...
        if (enabled) {
            ...
            int duration = state == ToggleableState.Off ? 100 : 50;
            rememberUpdatedState = SingleValueAnimationKt.m70animateColorAsStateeuL9pac(target, AnimationSpecKt.tween$default(duration, 0, null, 6, null), null, null, $composer, 0, 12);
            $composer.endReplaceableGroup();
        } else {
