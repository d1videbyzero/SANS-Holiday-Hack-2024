...
final class DefaultElevationOverlay implements ElevationOverlay {
    ...
    public long mo1068apply7g2Lkgo(long color, float elevation, Composer $composer, int $changed) {
        ...
        int $this$dp$iv = Dp.m5215compareTo0680j_4(elevation, Dp.m5216constructorimpl(0));
        if ($this$dp$iv > 0 && !colors.isLight()) {
            foregroundColor2 = ElevationOverlayKt.m1093calculateForegroundColorCLU3JFs(color, elevation, $composer, ($changed & 14) | ($changed & 112));
