...
public final class BackdropScaffoldKt {
    private static final float AnimationSlideOffset = Dp.m5216constructorimpl(20);
            ...
            if (color != Color.INSTANCE.m2983getUnspecified0d7_KjU()) {
                ...
                value$iv$iv2 = (Function1) new Function1<DrawScope, Unit>() { // from class: androidx.compose.material.BackdropScaffoldKt$Scrim$1$1
                    ...
                    public final void invoke2(DrawScope Canvas) {
                        ...
                        DrawScope.m3485drawRectnJ9OG0$default(Canvas, j, 0L, 0L, Scrim_3J_VO9M$lambda$4, null, null, 0, 118, null);
                    }
                };
            ...
            if (invalid$iv$iv || it$iv$iv == Composer.INSTANCE.getEmpty()) {
                value$iv$iv = new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.BackdropScaffoldKt$BackdropStack$1$1
                    ...
                    public final MeasureResult m977invoke0kLqBqw(SubcomposeMeasureScope SubcomposeLayout, final long constraints) {
                        ...
                        final Placeable backLayerPlaceable = ((Measurable) CollectionsKt.first((List) SubcomposeLayout.subcompose(BackdropLayers.Back, function2))).mo4184measureBRTryo0(function1.invoke(Constraints.m5160boximpl(constraints)).getValue());
                        ...
                        List $this$fastMap$iv = SubcomposeLayout.subcompose(backdropLayers, ComposableLambdaKt.composableLambdaInstance(-1222642649, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.BackdropScaffoldKt$BackdropStack$1$1$placeables$1
                            ...
                            public final void invoke(Composer $composer3, int $changed2) {
                                ...
                                function42.invoke(Constraints.m5160boximpl(constraints), Float.valueOf(backLayerHeight), $composer3, Integer.valueOf((i2 >> 3) & 896));
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventEnd();
                                }
                            }
                        ...
                        while (index$iv$iv < size) {
                            ...
                            target$iv.add(((Measurable) item$iv$iv).mo4184measureBRTryo0(constraints));
                            index$iv$iv++;
                            backLayerHeight = backLayerHeight;
                            $this$fastMap$iv = $this$fastMap$iv;
                        }
                        final List placeables = target$iv;
                        int maxWidth = Math.max(Constraints.m5174getMinWidthimpl(constraints), backLayerPlaceable.getWidth());
                        int maxHeight = Math.max(Constraints.m5173getMinHeightimpl(constraints), backLayerPlaceable.getHeight());
