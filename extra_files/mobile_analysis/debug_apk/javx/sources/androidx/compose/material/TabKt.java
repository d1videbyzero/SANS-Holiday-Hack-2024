...
public final class TabKt {
    ...
    private static final float SmallTabHeight = Dp.m5216constructorimpl(48);
    ...
    public static final void m1213Tab0nDMI0(final boolean selected, final Function0<Unit> onClick, Modifier modifier, boolean enabled, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, MutableInteractionSource interactionSource, long selectedContentColor, long unselectedContentColor, Composer $composer, final int $changed, final int i) {
        ...
        if ((191739611 & $dirty2) == 38347922 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if ((i & 256) != 0) {
                    unselectedContentColor3 = Color.m2945copywmQWz5c(r25, (r12 & 1) != 0 ? Color.m2949getAlphaimpl(r25) : ContentAlpha.INSTANCE.getMedium($composer3, 6), (r12 & 2) != 0 ? Color.m2953getRedimpl(r25) : 0.0f, (r12 & 4) != 0 ? Color.m2952getGreenimpl(r25) : 0.0f, (r12 & 8) != 0 ? Color.m2950getBlueimpl(selectedContentColor2) : 0.0f);
                    enabled3 = enabled2;
            ...
            final Function2 styledText = text != null ? ComposableLambdaKt.composableLambda($composer3, -1729014781, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabKt$Tab$styledText$1$1
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer4.getSkipping()) {
                        ...
                        TextStyle style = TextStyle.m4736copyv2rsoow$default(MaterialTheme.INSTANCE.getTypography($composer4, 6).getButton(), 0L, 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, TextAlign.m5081boximpl(TextAlign.INSTANCE.m5088getCentere0LSkKk()), null, 0L, null, null, null, null, null, null, 16744447, null);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabKt$Tab$3
            ...
            public final void invoke(Composer composer, int i9) {
                TabKt.m1213Tab0nDMI0(selected, onClick, modifier4, z2, function24, function25, mutableInteractionSource, j2, j3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    public static final void m1212LeadingIconTab0nDMI0(final boolean selected, final Function0<Unit> onClick, final Function2<? super Composer, ? super Integer, Unit> text, final Function2<? super Composer, ? super Integer, Unit> icon, Modifier modifier, boolean enabled, MutableInteractionSource interactionSource, long selectedContentColor, long unselectedContentColor, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 191739611) == 38347922 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 256) != 0) {
                    unselectedContentColor3 = Color.m2945copywmQWz5c(r20, (r12 & 1) != 0 ? Color.m2949getAlphaimpl(r20) : ContentAlpha.INSTANCE.getMedium($composer2, 6), (r12 & 2) != 0 ? Color.m2953getRedimpl(r20) : 0.0f, (r12 & 4) != 0 ? Color.m2952getGreenimpl(r20) : 0.0f, (r12 & 8) != 0 ? Color.m2950getBlueimpl(selectedContentColor2) : 0.0f);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabKt$LeadingIconTab$3
            ...
            public final void invoke(Composer composer, int i7) {
                TabKt.m1212LeadingIconTab0nDMI0(selected, onClick, text, icon, modifier5, z2, mutableInteractionSource2, j, j2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    */
    ...
    public static final void m1215TabTransitionKlgxPg(final long activeColor, final long inactiveColor, final boolean selected, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            $composer2.endReplaceableGroup();
            ProvidableCompositionLocal<Color> localContentColor = ContentColorKt.getLocalContentColor();
            m2945copywmQWz5c = Color.m2945copywmQWz5c(r9, (r12 & 1) != 0 ? Color.m2949getAlphaimpl(r9) : 1.0f, (r12 & 2) != 0 ? Color.m2953getRedimpl(r9) : 0.0f, (r12 & 4) != 0 ? Color.m2952getGreenimpl(r9) : 0.0f, (r12 & 8) != 0 ? Color.m2950getBlueimpl(TabTransition_Klgx_Pg$lambda$5(color$delegate)) : 0.0f);
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{localContentColor.provides(Color.m2937boximpl(m2945copywmQWz5c)), ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(Color.m2949getAlphaimpl(TabTransition_Klgx_Pg$lambda$5(color$delegate))))}, function2, $composer2, (($dirty >> 6) & 112) | 8);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    */
    ...
    public static final void placeTextAndIcon(Placeable.PlacementScope $this$placeTextAndIcon, Density density, Placeable textPlaceable, Placeable iconPlaceable, int tabWidth, int tabHeight, int firstBaseline, int lastBaseline) {
        ...
        int textOffset = density.mo321roundToPx0680j_4(baselineOffset) + density.mo321roundToPx0680j_4(TabRowDefaults.INSTANCE.m1223getIndicatorHeightD9Ej5fM());
