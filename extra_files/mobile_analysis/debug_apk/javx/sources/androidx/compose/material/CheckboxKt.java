...
public final class CheckboxKt {
    ...
    private static final float CheckboxRippleRadius = Dp.m5216constructorimpl(24);
    ...
    public static final void TriStateCheckbox(final ToggleableState state, final Function0<Unit> function0, Modifier modifier, boolean enabled, MutableInteractionSource interactionSource, CheckboxColors colors, Composer $composer, final int $changed, final int i) {
        ...
        if ((374491 & $dirty3) == 74898 && $composer2.getSkipping()) {
            ...
            if (function0 != null) {
                $dirty2 = $dirty;
                companion = ToggleableKt.m714triStateToggleableO2vRcR0(Modifier.INSTANCE, state, interactionSource3, RippleKt.m1284rememberRipple9IZ8Weo(false, CheckboxRippleRadius, 0L, $composer2, 54, 4), enabled2, Role.m4559boximpl(Role.INSTANCE.m4567getCheckboxo7Vup1c()), function0);
            } else {
                $dirty2 = $dirty;
            ...
            CheckboxImpl(enabled2, state, PaddingKt.m482padding3ABfNKs(modifier3.then(function0 != null ? InteractiveComponentSizeKt.minimumInteractiveComponentSize(Modifier.INSTANCE) : Modifier.INSTANCE).then(toggleableModifier), CheckboxDefaultPadding), colors2, $composer2, (($dirty2 >> 9) & 14) | (($dirty2 << 3) & 112) | (($dirty2 >> 6) & 7168));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
                    ...
                    if (invalid$iv || value$iv$iv2 == Composer.INSTANCE.getEmpty()) {
                        value$iv$iv2 = new Function1<DrawScope, Unit>() { // from class: androidx.compose.material.CheckboxKt$CheckboxImpl$1$1
                            ...
                            public final void invoke2(DrawScope Canvas) {
                                ...
                                CheckboxKt.m1015drawBox1wkBAMs(Canvas, CheckboxImpl$lambda$9, CheckboxImpl$lambda$10, Canvas.mo327toPx0680j_4(f6), strokeWidthPx);
                                ...
                                CheckboxKt.m1016drawCheck3IgeMak(Canvas, CheckboxImpl$lambda$8, CheckboxImpl$lambda$4, CheckboxImpl$lambda$6, strokeWidthPx, CheckDrawingCache.this);
                            }
                        };
                        $composer2.updateRememberedValue(value$iv$iv2);
                    }
