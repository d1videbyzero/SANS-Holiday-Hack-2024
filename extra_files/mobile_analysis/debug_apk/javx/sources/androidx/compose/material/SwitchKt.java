...
public final class SwitchKt {
    ...
    private static final float TrackWidth = Dp.m5216constructorimpl(34);
    private static final float TrackStrokeWidth = Dp.m5216constructorimpl(14);
    private static final float ThumbDiameter = Dp.m5216constructorimpl(20);
    private static final float ThumbRippleRadius = Dp.m5216constructorimpl(24);
    private static final float DefaultSwitchPadding = Dp.m5216constructorimpl(2);
    ...
    */
    ...
    public static final void m1210drawTrackRPmYEkk(DrawScope $this$drawTrack_u2dRPmYEkk, long trackColor, float trackWidth, float strokeWidth) {
        ...
        DrawScope.m3477drawLineNGM6Ib0$default($this$drawTrack_u2dRPmYEkk, trackColor, OffsetKt.Offset(strokeRadius, Offset.m2709getYimpl($this$drawTrack_u2dRPmYEkk.mo3489getCenterF1C5BW0())), OffsetKt.Offset(trackWidth - strokeRadius, Offset.m2709getYimpl($this$drawTrack_u2dRPmYEkk.mo3489getCenterF1C5BW0())), strokeWidth, StrokeCap.INSTANCE.m3294getRoundKaPHkGw(), null, 0.0f, null, 0, 480, null);
    }

    static {
        float arg0$iv = TrackWidth;
        float other$iv = ThumbDiameter;
        ThumbPathLength = Dp.m5216constructorimpl(arg0$iv - other$iv);
        AnimationSpec = new TweenSpec<>(100, 0, null, 6, null);
        ThumbDefaultElevation = Dp.m5216constructorimpl(1);
        ThumbPressedElevation = Dp.m5216constructorimpl(6);
        SwitchVelocityThreshold = Dp.m5216constructorimpl(125);
    }
