...
public final class ChipKt {
    ...
    private static final float HorizontalPadding = Dp.m5216constructorimpl(12);
    private static final float LeadingIconStartSpacing = Dp.m5216constructorimpl(4);
    private static final float LeadingIconEndSpacing = Dp.m5216constructorimpl(8);
    private static final float TrailingIconSpacing = Dp.m5216constructorimpl(8);
    private static final float SelectedIconContainerSize = Dp.m5216constructorimpl(24);
    ...
    */
    ...
    public static final void FilterChip(final boolean selected, final Function0<Unit> onClick, Modifier modifier, boolean enabled, MutableInteractionSource interactionSource, Shape shape, BorderStroke border, SelectableChipColors colors, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, Function2<? super Composer, ? super Integer, Unit> function23, final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if ((1533916891 & $dirty2) == 306783378 && ($dirty12 & 91) == 18 && $composer3.getSkipping()) {
            ...
            long m2957unboximpl = colors3.backgroundColor(enabled3, selected, $composer3, (($dirty >> 9) & 14) | (($dirty << 3) & 112) | (($dirty >> 15) & 896)).getValue().m2957unboximpl();
            m2945copywmQWz5c = Color.m2945copywmQWz5c(r0, (r12 & 1) != 0 ? Color.m2949getAlphaimpl(r0) : 1.0f, (r12 & 2) != 0 ? Color.m2953getRedimpl(r0) : 0.0f, (r12 & 4) != 0 ? Color.m2952getGreenimpl(r0) : 0.0f, (r12 & 8) != 0 ? Color.m2950getBlueimpl(contentColor.getValue().m2957unboximpl()) : 0.0f);
            ...
            modifier4 = modifier2;
            $composer2 = $composer3;
            SurfaceKt.m1198SurfaceNy5ogXk(selected, onClick, semantics$default, enabled4, shape3, m2957unboximpl, m2945copywmQWz5c, border2, 0.0f, interactionSource3, ComposableLambdaKt.composableLambda($composer3, 722126431, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ChipKt$FilterChip$3
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer4.getSkipping()) {
                        ...
                        ProvidedValue[] providedValueArr = {ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(Color.m2949getAlphaimpl(contentColor.getValue().m2957unboximpl())))};
