...
final class StateLayer {
    ...
    public final void m1287drawStateLayerH2RKhps(DrawScope drawStateLayer, float radius, long color) {
        ...
        float targetRadius = Float.isNaN(radius) ? RippleAnimationKt.m1278getRippleEndRadiuscSwnlzA(drawStateLayer, this.bounded, drawStateLayer.mo3490getSizeNHjbRc()) : drawStateLayer.mo327toPx0680j_4(radius);
        float alpha = this.animatedAlpha.getValue().floatValue();
        if (alpha > 0.0f) {
            modulatedColor = Color.m2945copywmQWz5c(color, (r12 & 1) != 0 ? Color.m2949getAlphaimpl(color) : alpha, (r12 & 2) != 0 ? Color.m2953getRedimpl(color) : 0.0f, (r12 & 4) != 0 ? Color.m2952getGreenimpl(color) : 0.0f, (r12 & 8) != 0 ? Color.m2950getBlueimpl(color) : 0.0f);
            if (!this.bounded) {
                DrawScope.m3472drawCircleVaOC9Bg$default(drawStateLayer, modulatedColor, targetRadius, 0L, 0.0f, null, null, 0, 124, null);
                return;
            }
            float right$iv = Size.m2777getWidthimpl(drawStateLayer.mo3490getSizeNHjbRc());
            float bottom$iv = Size.m2774getHeightimpl(drawStateLayer.mo3490getSizeNHjbRc());
