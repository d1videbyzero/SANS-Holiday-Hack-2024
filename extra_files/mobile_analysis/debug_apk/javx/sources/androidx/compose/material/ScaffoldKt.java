...
public final class ScaffoldKt {
    ...
    private static final float FabSpacing = Dp.m5216constructorimpl(16);
            ...
            if (invalid$iv || value$iv$iv == Composer.INSTANCE.getEmpty()) {
                ...
                value$iv$iv = new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.ScaffoldKt$ScaffoldLayout$1$1
                    ...
                    public final MeasureResult m1170invoke0kLqBqw(final SubcomposeMeasureScope SubcomposeLayout, long constraints) {
                        ...
                        final int layoutWidth = Constraints.m5172getMaxWidthimpl(constraints);
                        ...
                        return MeasureScope.layout$default(SubcomposeLayout, layoutWidth, layoutHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.ScaffoldKt$ScaffoldLayout$1$1.1
                            ...
                            public final void invoke2(Placeable.PlacementScope layout) {
                                ...
                                for (int index$iv$iv = 0; index$iv$iv < size; index$iv$iv++) {
                                    ...
                                    target$iv.add(it.mo4184measureBRTryo0(j));
                                }
                                ...
                                for (int index$iv$iv2 = 0; index$iv$iv2 < size2; index$iv$iv2++) {
                                    ...
                                    target$iv2.add(it4.mo4184measureBRTryo0(j2));
                                }
                                ...
                                while (index$iv$iv3 < size3) {
                                    ...
                                    target$iv3.add(measurable.mo4184measureBRTryo0(j3));
                                    index$iv$iv3++;
                                ...
                                if (!fabPlaceables.isEmpty()) {
                                    ...
                                    if (fabWidth == 0 || fabHeight == 0) {
                                        ...
                                        if (!FabPosition.m1100equalsimpl0(i3, FabPosition.INSTANCE.m1105getEnd5ygKITE())) {
                                            ...
                                            fabLeftOffset = (i6 - subcomposeMeasureScope.mo321roundToPx0680j_4(f4)) - fabWidth;
                                        } else {
                                ...
                                while (index$iv$iv4 < size4) {
                                    ...
                                    target$iv4.add(it11.mo4184measureBRTryo0(j4));
                                    index$iv$iv4++;
                                    size4 = size4;
                                ...
                                List $this$fastMap$iv5 = subcomposeMeasureScope5.subcompose(scaffoldLayoutContent2, ComposableLambdaKt.composableLambdaInstance(-1132241596, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ScaffoldKt$ScaffoldLayout$1$1$1$bodyContentPlaceables$1
                                    ...
                                    public final void invoke(Composer $composer3, int $changed2) {
                                        ...
                                        if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                                            ...
                                            PaddingValues innerPadding = PaddingKt.m479PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, SubcomposeMeasureScope.this.mo324toDpu2uoSUM(bottomBarHeight), 7, null);
                                ...
                                while ($i$f$fastMap5 < size5) {
                                    ...
                                    long j6 = j5;
                                    m5162copyZbe2FdA = Constraints.m5162copyZbe2FdA(r20, (r12 & 1) != 0 ? Constraints.m5174getMinWidthimpl(r20) : 0, (r12 & 2) != 0 ? Constraints.m5172getMaxWidthimpl(r20) : 0, (r12 & 4) != 0 ? Constraints.m5173getMinHeightimpl(r20) : 0, (r12 & 8) != 0 ? Constraints.m5171getMaxHeightimpl(j5) : bodyContentHeight);
                                    target$iv5.add(it14.mo4184measureBRTryo0(m5162copyZbe2FdA));
                                    $i$f$fastMap5++;
                                    size5 = size5;
