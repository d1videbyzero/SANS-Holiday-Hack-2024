...
public final class AppBarKt {
    private static final float AppBarHeight = Dp.m5216constructorimpl(56);
    private static final float AppBarHorizontalPadding = Dp.m5216constructorimpl(4);
    ...
    public static final void m966TopAppBarxWeB9s(final Function2<? super Composer, ? super Integer, Unit> title, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, long backgroundColor, long contentColor, float elevation, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty2 & 2995931) == 599186 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if (i6 != 0) {
                    actions = ComposableSingletons$AppBarKt.INSTANCE.m1057getLambda1$material_release();
                }
                if ((i & 16) != 0) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$2
            ...
            public final void invoke(Composer composer, int i8) {
                AppBarKt.m966TopAppBarxWeB9s(title, modifier4, function22, function32, j, j2, f, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    */
    ...
    static {
        ...
        TitleInsetWithoutIcon = SizeKt.m534width3ABfNKs(companion, Dp.m5216constructorimpl(arg0$iv - other$iv));
        Modifier fillMaxHeight$default = SizeKt.fillMaxHeight$default(Modifier.INSTANCE, 0.0f, 1, null);
        float arg0$iv2 = Dp.m5216constructorimpl(72);
        float other$iv2 = AppBarHorizontalPadding;
        TitleIconModifier = SizeKt.m534width3ABfNKs(fillMaxHeight$default, Dp.m5216constructorimpl(arg0$iv2 - other$iv2));
        BottomAppBarCutoutOffset = Dp.m5216constructorimpl(8);
        BottomAppBarRoundedEdgeRadius = Dp.m5216constructorimpl(4);
    }
}
