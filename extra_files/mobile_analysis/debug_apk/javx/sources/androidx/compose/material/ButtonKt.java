...
public final class ButtonKt {
    public static final void Button(final Function0<Unit> onClick, Modifier modifier, boolean enabled, MutableInteractionSource interactionSource, ButtonElevation elevation, Shape shape, BorderStroke border, ButtonColors colors, PaddingValues contentPadding, final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed, final int i) {
        ...
        if ((1533916891 & $dirty3) == 306783378 && $composer3.getSkipping()) {
            ...
            long m2957unboximpl = colors3.backgroundColor(enabled2, $composer3, (($dirty >> 6) & 14) | (($dirty >> 18) & 112)).getValue().m2957unboximpl();
            m2945copywmQWz5c = Color.m2945copywmQWz5c(r20, (r12 & 1) != 0 ? Color.m2949getAlphaimpl(r20) : 1.0f, (r12 & 2) != 0 ? Color.m2953getRedimpl(r20) : 0.0f, (r12 & 4) != 0 ? Color.m2952getGreenimpl(r20) : 0.0f, (r12 & 8) != 0 ? Color.m2950getBlueimpl(Button$lambda$1(contentColor$delegate)) : 0.0f);
            ...
            modifier3 = modifier2;
            $composer2 = $composer3;
            SurfaceKt.m1197SurfaceLPr_se0(onClick, semantics$default, enabled2, shape3, m2957unboximpl, m2945copywmQWz5c, border2, elevation5 != null ? elevation5.getValue().m5230unboximpl() : Dp.m5216constructorimpl(0), interactionSource2, ComposableLambdaKt.composableLambda($composer3, 7524271, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ButtonKt$Button$3
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer4.getSkipping()) {
                        ...
                        ProvidedValue[] providedValueArr = {localContentAlpha.provides(Float.valueOf(Color.m2949getAlphaimpl(Button$lambda$1)))};
