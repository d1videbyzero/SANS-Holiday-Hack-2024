...
public final class BackdropScaffoldDefaults {
    ...
    private static final float PeekHeight = Dp.m5216constructorimpl(56);
    private static final float HeaderHeight = Dp.m5216constructorimpl(48);
    private static final float FrontLayerElevation = Dp.m5216constructorimpl(1);
    ...
    public final Shape getFrontLayerShape(Composer $composer, int $changed) {
        ...
        CornerBasedShape copy$default = CornerBasedShape.copy$default(MaterialTheme.INSTANCE.getShapes($composer, 6).getLarge(), CornerSizeKt.m727CornerSize0680j_4(Dp.m5216constructorimpl(16)), CornerSizeKt.m727CornerSize0680j_4(Dp.m5216constructorimpl(16)), null, null, 12, null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final long getFrontLayerScrimColor(Composer $composer, int $changed) {
        ...
        m2945copywmQWz5c = Color.m2945copywmQWz5c(r1, (r12 & 1) != 0 ? Color.m2949getAlphaimpl(r1) : 0.6f, (r12 & 2) != 0 ? Color.m2953getRedimpl(r1) : 0.0f, (r12 & 4) != 0 ? Color.m2952getGreenimpl(r1) : 0.0f, (r12 & 8) != 0 ? Color.m2950getBlueimpl(MaterialTheme.INSTANCE.getColors($composer, 6).m1038getSurface0d7_KjU()) : 0.0f);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
