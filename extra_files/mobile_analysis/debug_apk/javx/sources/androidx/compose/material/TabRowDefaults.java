...
public final class TabRowDefaults {
    ...
    private static final float DividerThickness = Dp.m5216constructorimpl(1);
    private static final float IndicatorHeight = Dp.m5216constructorimpl(2);
    private static final float ScrollableTabRowPadding = Dp.m5216constructorimpl(52);
    ...
    public final void m1220Divider9IZ8Weo(Modifier modifier, float thickness, long color, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 4) != 0) {
                    ...
                    color3 = Color.m2945copywmQWz5c(r16, (r12 & 1) != 0 ? Color.m2949getAlphaimpl(r16) : 0.12f, (r12 & 2) != 0 ? Color.m2953getRedimpl(r16) : 0.0f, (r12 & 4) != 0 ? Color.m2952getGreenimpl(r16) : 0.0f, (r12 & 8) != 0 ? Color.m2950getBlueimpl(((Color) consume).m2957unboximpl()) : 0.0f);
                    $dirty &= -897;
                    color2 = color3;
                }
            } else {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowDefaults$Divider$1
            ...
            public final void invoke(Composer composer, int i5) {
                TabRowDefaults.this.m1220Divider9IZ8Weo(modifier5, f2, j, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    public final void m1221Indicator9IZ8Weo(Modifier modifier, float height, long color, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 4) != 0) {
                    ...
                    ComposerKt.sourceInformationMarkerEnd($composer2);
                    $dirty &= -897;
                    color2 = ((Color) consume).m2957unboximpl();
                }
            } else {
                $composer2.skipToGroupEnd();
                if ((i & 2) != 0) {
            ...
            BoxKt.Box(BackgroundKt.m161backgroundbw27NRU$default(SizeKt.m515height3ABfNKs(SizeKt.fillMaxWidth$default(modifier3, 0.0f, 1, null), height2), color2, null, 2, null), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowDefaults$Indicator$1
            ...
            public final void invoke(Composer composer, int i5) {
                TabRowDefaults.this.m1221Indicator9IZ8Weo(modifier5, f2, j, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    public final Modifier tabIndicatorOffset(Modifier $this$tabIndicatorOffset, final TabPosition currentTabPosition) {
        ...
        return ComposedModifierKt.composed($this$tabIndicatorOffset, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.material.TabRowDefaults$tabIndicatorOffset$$inlined$debugInspectorInfo$1
            ...
            private static final float invoke$lambda$0(State<Dp> state) {
                ...
                return ((Dp) thisObj$iv).m5230unboximpl();
            }
            ...
            public final Modifier invoke(Modifier composed, Composer $composer, int $changed) {
                ...
                State currentTabWidth$delegate = AnimateAsStateKt.m82animateDpAsStateAjpBEmI(TabPosition.this.getWidth(), AnimationSpecKt.tween$default(250, 0, EasingKt.getFastOutSlowInEasing(), 2, null), null, null, $composer, 0, 12);
                State indicatorOffset$delegate = AnimateAsStateKt.m82animateDpAsStateAjpBEmI(TabPosition.this.getLeft(), AnimationSpecKt.tween$default(250, 0, EasingKt.getFastOutSlowInEasing(), 2, null), null, null, $composer, 0, 12);
                Modifier m534width3ABfNKs = SizeKt.m534width3ABfNKs(OffsetKt.m443offsetVpY3zN4$default(SizeKt.wrapContentSize$default(SizeKt.fillMaxWidth$default(composed, 0.0f, 1, null), Alignment.INSTANCE.getBottomStart(), false, 2, null), invoke$lambda$1(indicatorOffset$delegate), 0.0f, 2, null), invoke$lambda$0(currentTabWidth$delegate));
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                $composer.endReplaceableGroup();
                return m534width3ABfNKs;
            }
