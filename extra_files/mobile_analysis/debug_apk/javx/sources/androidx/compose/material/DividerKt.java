    ...
    public static final void m1069DivideroMI9zvI(Modifier modifier, long color, float thickness, float startIndent, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 2) != 0) {
                    color2 = Color.m2945copywmQWz5c(r12, (r12 & 1) != 0 ? Color.m2949getAlphaimpl(r12) : 0.12f, (r12 & 2) != 0 ? Color.m2953getRedimpl(r12) : 0.0f, (r12 & 4) != 0 ? Color.m2952getGreenimpl(r12) : 0.0f, (r12 & 8) != 0 ? Color.m2950getBlueimpl(MaterialTheme.INSTANCE.getColors($composer2, 6).m1033getOnSurface0d7_KjU()) : 0.0f);
                    $dirty &= -113;
                } else {
                    color2 = j;
                }
                thickness2 = i4 != 0 ? Dp.m5216constructorimpl(1) : f;
                startIndent2 = i5 != 0 ? Dp.m5216constructorimpl(0) : f2;
            } else {
                $composer2.skipToGroupEnd();
                if ((i & 2) != 0) {
                    $dirty &= -113;
            ...
            Modifier.Companion indentMod = !((startIndent2 > 0.0f ? 1 : (startIndent2 == 0.0f ? 0 : -1)) == 0) ? PaddingKt.m486paddingqDBjuR0$default(Modifier.INSTANCE, startIndent2, 0.0f, 0.0f, 0.0f, 14, null) : Modifier.INSTANCE;
            $composer2.startReplaceableGroup(1228914189);
            ComposerKt.sourceInformation($composer2, "*55@2139L7");
            if (Dp.m5221equalsimpl0(thickness2, Dp.INSTANCE.m5234getHairlineD9Ej5fM())) {
                ProvidableCompositionLocal<Density> localDensity = CompositionLocalsKt.getLocalDensity();
                ComposerKt.sourceInformationMarkerStart($composer2, 2023513938, "CC:CompositionLocal.kt#9igjgp");
                Object consume = $composer2.consume(localDensity);
                ComposerKt.sourceInformationMarkerEnd($composer2);
                float $this$dp$iv = 1.0f / ((Density) consume).getDensity();
                targetThickness = Dp.m5216constructorimpl($this$dp$iv);
            } else {
                targetThickness = thickness2;
            }
            $composer2.endReplaceableGroup();
            BoxKt.Box(BackgroundKt.m161backgroundbw27NRU$default(SizeKt.m515height3ABfNKs(SizeKt.fillMaxWidth$default(modifier3.then(indentMod), 0.0f, 1, null), targetThickness), color2, null, 2, null), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.DividerKt$Divider$1
            ...
            public final void invoke(Composer composer, int i6) {
                DividerKt.m1069DivideroMI9zvI(Modifier.this, j2, f3, f4, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
}
