...
public final class ProgressIndicatorKt {
    ...
    private static final float LinearIndicatorWidth = Dp.m5216constructorimpl(240);
    private static final float CircularIndicatorDiameter = Dp.m5216constructorimpl(40);
    ...
    */
    public static final void m1153LinearProgressIndicator_5eSRE(final float r23, androidx.compose.ui.Modifier r24, long r25, long r27, int r29, androidx.compose.runtime.Composer r30, final int r31, final int r32) {
        /*
            Method dump skipped, instructions count: 507
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.ProgressIndicatorKt.m1153LinearProgressIndicator_5eSRE(float, androidx.compose.ui.Modifier, long, long, int, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    public static final void m1151LinearProgressIndicator2cYBFYY(Modifier modifier, long color, long backgroundColor, int strokeCap, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 4) != 0) {
                    backgroundColor2 = Color.m2945copywmQWz5c(r11, (r12 & 1) != 0 ? Color.m2949getAlphaimpl(r11) : 0.24f, (r12 & 2) != 0 ? Color.m2953getRedimpl(r11) : 0.0f, (r12 & 4) != 0 ? Color.m2952getGreenimpl(r11) : 0.0f, (r12 & 8) != 0 ? Color.m2950getBlueimpl(color2) : 0.0f);
                    $dirty &= -897;
                } else {
                    backgroundColor2 = j2;
                }
                if ((i & 8) != 0) {
                    ...
                    strokeCap2 = StrokeCap.INSTANCE.m3293getButtKaPHkGw();
                } else {
                    modifier3 = modifier4;
                    color3 = color2;
                    backgroundColor3 = backgroundColor2;
            ...
            final State firstLineHead$delegate = InfiniteTransitionKt.animateFloat(infiniteTransition, 0.0f, 1.0f, AnimationSpecKt.m93infiniteRepeatable9IiC70o$default(AnimationSpecKt.keyframes(new Function1<KeyframesSpec.KeyframesSpecConfig<Float>, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$LinearProgressIndicator$firstLineHead$2
            ...
            final State firstLineTail$delegate = InfiniteTransitionKt.animateFloat(infiniteTransition, 0.0f, 1.0f, AnimationSpecKt.m93infiniteRepeatable9IiC70o$default(AnimationSpecKt.keyframes(new Function1<KeyframesSpec.KeyframesSpecConfig<Float>, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$LinearProgressIndicator$firstLineTail$2
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ Unit invoke(KeyframesSpec.KeyframesSpecConfig<Float> keyframesSpecConfig) {
                    invoke2(keyframesSpecConfig);
                    return Unit.INSTANCE;
            ...
            final State secondLineHead$delegate = InfiniteTransitionKt.animateFloat(infiniteTransition, 0.0f, 1.0f, AnimationSpecKt.m93infiniteRepeatable9IiC70o$default(AnimationSpecKt.keyframes(new Function1<KeyframesSpec.KeyframesSpecConfig<Float>, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$LinearProgressIndicator$secondLineHead$2
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ Unit invoke(KeyframesSpec.KeyframesSpecConfig<Float> keyframesSpecConfig) {
                    invoke2(keyframesSpecConfig);
                    return Unit.INSTANCE;
            ...
            final State secondLineTail$delegate = InfiniteTransitionKt.animateFloat(infiniteTransition, 0.0f, 1.0f, AnimationSpecKt.m93infiniteRepeatable9IiC70o$default(AnimationSpecKt.keyframes(new Function1<KeyframesSpec.KeyframesSpecConfig<Float>, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$LinearProgressIndicator$secondLineTail$2
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ Unit invoke(KeyframesSpec.KeyframesSpecConfig<Float> keyframesSpecConfig) {
                    invoke2(keyframesSpecConfig);
                    return Unit.INSTANCE;
            ...
            Modifier m531sizeVpY3zN4 = SizeKt.m531sizeVpY3zN4(ProgressSemanticsKt.progressSemantics(modifier3), LinearIndicatorWidth, LinearIndicatorHeight);
            Object[] keys$iv = {Color.m2937boximpl(backgroundColor3), StrokeCap.m3286boximpl(strokeCap2), firstLineHead$delegate, firstLineTail$delegate, Color.m2937boximpl(color3), secondLineHead$delegate, secondLineTail$delegate};
            ...
            if (invalid$iv || value$iv$iv == Composer.INSTANCE.getEmpty()) {
                ...
                value$iv$iv = new Function1<DrawScope, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$LinearProgressIndicator$3$1
                    ...
                    public final void invoke2(DrawScope Canvas) {
                        ...
                        float strokeWidth = Size.m2774getHeightimpl(Canvas.mo3490getSizeNHjbRc());
                        ProgressIndicatorKt.m1165drawLinearIndicatorBackgroundAZGd3zU(Canvas, j3, strokeWidth, i9);
                        ...
                        if (LinearProgressIndicator_2cYBFYY$lambda$1 - LinearProgressIndicator_2cYBFYY$lambda$2 > 0.0f) {
                            ...
                            ProgressIndicatorKt.m1164drawLinearIndicatorqYKTg0g(Canvas, LinearProgressIndicator_2cYBFYY$lambda$12, LinearProgressIndicator_2cYBFYY$lambda$22, j4, strokeWidth, i9);
                        }
                        ...
                        if (LinearProgressIndicator_2cYBFYY$lambda$3 - LinearProgressIndicator_2cYBFYY$lambda$4 > 0.0f) {
                            ...
                            ProgressIndicatorKt.m1164drawLinearIndicatorqYKTg0g(Canvas, LinearProgressIndicator_2cYBFYY$lambda$32, LinearProgressIndicator_2cYBFYY$lambda$42, j4, strokeWidth, i9);
                        }
                    }
                };
            ...
            CanvasKt.Canvas(m531sizeVpY3zN4, (Function1) value$iv$iv, $composer2, i3);
            if (ComposerKt.isTraceInProgress()) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$LinearProgressIndicator$4
            ...
            public final void invoke(Composer composer, int i11) {
                ProgressIndicatorKt.m1151LinearProgressIndicator2cYBFYY(Modifier.this, j5, j6, i10, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    public static final /* synthetic */ void m1154LinearProgressIndicatoreaDK9VM(final float progress, Modifier modifier, long color, long backgroundColor, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 8) != 0) {
                    backgroundColor2 = Color.m2945copywmQWz5c(r12, (r12 & 1) != 0 ? Color.m2949getAlphaimpl(r12) : 0.24f, (r12 & 2) != 0 ? Color.m2953getRedimpl(r12) : 0.0f, (r12 & 4) != 0 ? Color.m2952getGreenimpl(r12) : 0.0f, (r12 & 8) != 0 ? Color.m2950getBlueimpl(color2) : 0.0f);
                    $dirty &= -7169;
                } else {
                    backgroundColor2 = j2;
                }
            ...
            m1153LinearProgressIndicator_5eSRE(progress, modifier3, color2, backgroundColor2, StrokeCap.INSTANCE.m3293getButtKaPHkGw(), $composer2, ($dirty & 14) | ($dirty & 112) | ($dirty & 896) | ($dirty & 7168), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$LinearProgressIndicator$5
            ...
            public final void invoke(Composer composer, int i5) {
                ProgressIndicatorKt.m1154LinearProgressIndicatoreaDK9VM(progress, modifier5, j3, j4, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    public static final /* synthetic */ void m1152LinearProgressIndicatorRIQooxk(Modifier modifier, long color, long backgroundColor, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 731) == 146 && $composer2.getSkipping()) {
            ...
            m1151LinearProgressIndicator2cYBFYY(modifier3, color2, backgroundColor2, StrokeCap.INSTANCE.m3293getButtKaPHkGw(), $composer2, ($dirty & 14) | ($dirty & 112) | ($dirty & 896), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$LinearProgressIndicator$6
            ...
            public final void invoke(Composer composer, int i5) {
                ProgressIndicatorKt.m1152LinearProgressIndicatorRIQooxk(Modifier.this, j3, j4, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    public static final void m1164drawLinearIndicatorqYKTg0g(DrawScope $this$drawLinearIndicator_u2dqYKTg0g, float startFraction, float endFraction, long color, float strokeWidth, int strokeCap) {
        float width = Size.m2777getWidthimpl($this$drawLinearIndicator_u2dqYKTg0g.mo3490getSizeNHjbRc());
        float height = Size.m2774getHeightimpl($this$drawLinearIndicator_u2dqYKTg0g.mo3490getSizeNHjbRc());
        float f = 2;
        ...
        if (StrokeCap.m3289equalsimpl0(strokeCap, StrokeCap.INSTANCE.m3293getButtKaPHkGw()) || height > width) {
            DrawScope.m3477drawLineNGM6Ib0$default($this$drawLinearIndicator_u2dqYKTg0g, color, OffsetKt.Offset(barStart, yOffset), OffsetKt.Offset(barEnd, yOffset), strokeWidth, 0, null, 0.0f, null, 0, 496, null);
            return;
        }
        ...
        if (Math.abs(endFraction - startFraction) > 0.0f) {
            DrawScope.m3477drawLineNGM6Ib0$default($this$drawLinearIndicator_u2dqYKTg0g, color, OffsetKt.Offset(adjustedBarStart, yOffset), OffsetKt.Offset(adjustedBarEnd, yOffset), strokeWidth, strokeCap, null, 0.0f, null, 0, 480, null);
        }
    }
    ...
    public static final void m1147CircularProgressIndicatorDUhRLBM(final float progress, Modifier modifier, long color, float strokeWidth, long backgroundColor, int strokeCap, Composer $composer, final int $changed, final int i) {
        ...
        if ((374491 & $dirty2) == 74898 && $composer2.getSkipping()) {
            ...
            final long j3 = color3;
            CanvasKt.Canvas(SizeKt.m529size3ABfNKs(ProgressSemanticsKt.progressSemantics$default(modifier5, coercedProgress, null, 0, 6, null), CircularIndicatorDiameter), new Function1<DrawScope, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$CircularProgressIndicator$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
    ...
    public static final void m1148CircularProgressIndicatorLxG7B9w(Modifier modifier, long color, float strokeWidth, long backgroundColor, int strokeCap, Composer $composer, final int $changed, final int i) {
        ...
        if ((46811 & $dirty) == 9362 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 16) != 0) {
                    ...
                    modifier3 = modifier4;
                    color3 = color2;
                    strokeCap2 = StrokeCap.INSTANCE.m3295getSquareKaPHkGw();
                    backgroundColor3 = backgroundColor2;
                    strokeWidth3 = strokeWidth2;
                } else {
                    modifier3 = modifier4;
            ...
            final State currentRotation$delegate = InfiniteTransitionKt.animateValue(transition, 0, 5, VectorConvertersKt.getVectorConverter(IntCompanionObject.INSTANCE), AnimationSpecKt.m93infiniteRepeatable9IiC70o$default(AnimationSpecKt.tween$default(6660, 0, EasingKt.getLinearEasing(), 2, null), null, 0L, 6, null), null, $composer2, InfiniteTransition.$stable | 4528 | (InfiniteRepeatableSpec.$stable << 12), 16);
            final State baseRotation$delegate = InfiniteTransitionKt.animateFloat(transition, 0.0f, BaseRotationAngle, AnimationSpecKt.m93infiniteRepeatable9IiC70o$default(AnimationSpecKt.tween$default(RotationDuration, 0, EasingKt.getLinearEasing(), 2, null), null, 0L, 6, null), null, $composer2, InfiniteTransition.$stable | 432 | (InfiniteRepeatableSpec.$stable << 9), 8);
            final State endAngle$delegate = InfiniteTransitionKt.animateFloat(transition, 0.0f, JumpRotationAngle, AnimationSpecKt.m93infiniteRepeatable9IiC70o$default(AnimationSpecKt.keyframes(new Function1<KeyframesSpec.KeyframesSpecConfig<Float>, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$CircularProgressIndicator$endAngle$2
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ Unit invoke(KeyframesSpec.KeyframesSpecConfig<Float> keyframesSpecConfig) {
                    invoke2(keyframesSpecConfig);
                    return Unit.INSTANCE;
            ...
            final long j2 = backgroundColor3;
            final long j3 = color3;
            CanvasKt.Canvas(SizeKt.m529size3ABfNKs(ProgressSemanticsKt.progressSemantics(modifier3), CircularIndicatorDiameter), new Function1<DrawScope, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$CircularProgressIndicator$3
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(DrawScope Canvas) {
                    ...
                    ProgressIndicatorKt.m1163drawIndeterminateCircularIndicatorhrjfTZI(Canvas, CircularProgressIndicator_LxG7B9w$lambda$112 + offset, strokeWidth5, sweep, j3, stroke);
                }
            }, $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$CircularProgressIndicator$4
            ...
            public final void invoke(Composer composer, int i11) {
                ProgressIndicatorKt.m1148CircularProgressIndicatorLxG7B9w(Modifier.this, j4, f, j5, i10, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    public static final /* synthetic */ void m1149CircularProgressIndicatorMBs18nI(final float progress, Modifier modifier, long color, float strokeWidth, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            m1147CircularProgressIndicatorDUhRLBM(progress, modifier3, color2, strokeWidth2, Color.INSTANCE.m2982getTransparent0d7_KjU(), StrokeCap.INSTANCE.m3293getButtKaPHkGw(), $composer2, ($dirty & 14) | 24576 | ($dirty & 112) | ($dirty & 896) | ($dirty & 7168), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
    ...
    public static final /* synthetic */ void m1150CircularProgressIndicatoraMcp0Q(Modifier modifier, long color, float strokeWidth, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 731) == 146 && $composer2.getSkipping()) {
            ...
            m1148CircularProgressIndicatorLxG7B9w(modifier3, color2, strokeWidth2, Color.INSTANCE.m2982getTransparent0d7_KjU(), StrokeCap.INSTANCE.m3295getSquareKaPHkGw(), $composer2, ($dirty & 14) | 3072 | ($dirty & 112) | ($dirty & 896), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$CircularProgressIndicator$6
            ...
            public final void invoke(Composer composer, int i5) {
                ProgressIndicatorKt.m1150CircularProgressIndicatoraMcp0Q(Modifier.this, j2, f2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    private static final void m1160drawCircularIndicator42QJj7c(DrawScope $this$drawCircularIndicator_u2d42QJj7c, float startAngle, float sweep, long color, Stroke stroke) {
        ...
        float arcDimen = Size.m2777getWidthimpl($this$drawCircularIndicator_u2d42QJj7c.mo3490getSizeNHjbRc()) - (f * diameterOffset);
        DrawScope.m3470drawArcyD3GUKo$default($this$drawCircularIndicator_u2d42QJj7c, color, startAngle, sweep, false, OffsetKt.Offset(diameterOffset, diameterOffset), androidx.compose.ui.geometry.SizeKt.Size(arcDimen, arcDimen), 0.0f, stroke, null, 0, 832, null);
    }
    ...
    public static final void m1163drawIndeterminateCircularIndicatorhrjfTZI(DrawScope $this$drawIndeterminateCircularIndicator_u2dhrjfTZI, float startAngle, float strokeWidth, float sweep, long color, Stroke stroke) {
        ...
        if (StrokeCap.m3289equalsimpl0(stroke.getCap(), StrokeCap.INSTANCE.m3293getButtKaPHkGw())) {
            strokeCapOffset = 0.0f;
        } else {
            float arg0$iv = CircularIndicatorDiameter;
            float other$iv = strokeWidth / Dp.m5216constructorimpl(arg0$iv / 2);
