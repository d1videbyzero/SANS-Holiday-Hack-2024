...
public final class NavigationRailKt {
    ...
    private static final float NavigationRailItemSize = Dp.m5216constructorimpl(72);
    private static final float NavigationRailItemCompactSize = Dp.m5216constructorimpl(56);
    private static final float NavigationRailPadding = Dp.m5216constructorimpl(8);
    private static final float HeaderPadding = Dp.m5216constructorimpl(8);
    private static final float ItemLabelBaselineBottomOffset = Dp.m5216constructorimpl(16);
    private static final float ItemIconTopOffset = Dp.m5216constructorimpl(14);
    ...
    */
    ...
    public static final void m1135NavigationRailTransitionKlgxPg(final long activeColor, final long inactiveColor, final boolean selected, final Function3<? super Float, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed) {
        ...
        if (($dirty2 & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            long color = ColorKt.m2998lerpjxsXWHM(inactiveColor, activeColor, NavigationRailTransition_Klgx_Pg$lambda$3(animationProgress$delegate));
            ProvidableCompositionLocal<Color> localContentColor = ContentColorKt.getLocalContentColor();
            m2945copywmQWz5c = Color.m2945copywmQWz5c(color, (r12 & 1) != 0 ? Color.m2949getAlphaimpl(color) : 1.0f, (r12 & 2) != 0 ? Color.m2953getRedimpl(color) : 0.0f, (r12 & 4) != 0 ? Color.m2952getGreenimpl(color) : 0.0f, (r12 & 8) != 0 ? Color.m2950getBlueimpl(color) : 0.0f);
    ...
    */
    ...
    public static final MeasureResult m1139placeIcon3p2s80s(MeasureScope $this$placeIcon_u2d3p2s80s, final Placeable iconPlaceable, long constraints) {
        final int iconX = Math.max(0, (Constraints.m5172getMaxWidthimpl(constraints) - iconPlaceable.getWidth()) / 2);
        final int iconY = Math.max(0, (Constraints.m5171getMaxHeightimpl(constraints) - iconPlaceable.getHeight()) / 2);
        return MeasureScope.layout$default($this$placeIcon_u2d3p2s80s, Constraints.m5172getMaxWidthimpl(constraints), Constraints.m5171getMaxHeightimpl(constraints), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.NavigationRailKt$placeIcon$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
    ...
    public static final MeasureResult m1140placeLabelAndIconDIyivk0(MeasureScope $this$placeLabelAndIcon_u2dDIyivk0, final Placeable labelPlaceable, final Placeable iconPlaceable, long constraints, final float iconPositionAnimationProgress) {
        ...
        final int labelY = (Constraints.m5171getMaxHeightimpl(constraints) - baseline) - labelBaselineOffset;
        final int labelX = (Constraints.m5172getMaxWidthimpl(constraints) - labelPlaceable.getWidth()) / 2;
        final int selectedIconY = $this$placeLabelAndIcon_u2dDIyivk0.mo321roundToPx0680j_4(ItemIconTopOffset);
        int unselectedIconY = (Constraints.m5171getMaxHeightimpl(constraints) - iconPlaceable.getHeight()) / 2;
        final int iconX = (Constraints.m5172getMaxWidthimpl(constraints) - iconPlaceable.getWidth()) / 2;
        ...
        return MeasureScope.layout$default($this$placeLabelAndIcon_u2dDIyivk0, Constraints.m5172getMaxWidthimpl(constraints), Constraints.m5171getMaxHeightimpl(constraints), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.NavigationRailKt$placeLabelAndIcon$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
