...
final class MaterialRippleTheme implements RippleTheme {
    ...
    public long mo1119defaultColorWaAFU9c(Composer $composer, int $changed) {
        ...
        long m1286defaultRippleColor5vOe2sY = companion.m1286defaultRippleColor5vOe2sY(((Color) consume).m2957unboximpl(), MaterialTheme.INSTANCE.getColors($composer, 6).isLight());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
        return m1286defaultRippleColor5vOe2sY;
    }
    ...
    public RippleAlpha rippleAlpha(Composer $composer, int $changed) {
        ...
        Object consume = $composer.consume(localContentColor);
        ComposerKt.sourceInformationMarkerEnd($composer);
        RippleAlpha m1285defaultRippleAlphaDxMtmZc = companion.m1285defaultRippleAlphaDxMtmZc(((Color) consume).m2957unboximpl(), MaterialTheme.INSTANCE.getColors($composer, 6).isLight());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
        return m1285defaultRippleAlphaDxMtmZc;
    }
}
