...
public final class TextFieldImplKt {
    ...
    private static final float TextFieldPadding = Dp.m5216constructorimpl(16);
    private static final float HorizontalIconPadding = Dp.m5216constructorimpl(12);
    private static final Modifier IconDefaultSizeModifier = SizeKt.m513defaultMinSizeVpY3zN4(Modifier.INSTANCE, Dp.m5216constructorimpl(48), Dp.m5216constructorimpl(48));
        ...
        if (($dirty & 1533916891) == 306783378 && (46811 & $dirty1) == 9362 && $composer3.getSkipping()) {
            ...
            Function3 labelColor = new Function3<InputPhase, Composer, Integer, Color>() { // from class: androidx.compose.material.TextFieldImplKt$CommonDecorationBox$labelColor$1
                ...
                public final long m1249invokeXeAY9LY(InputPhase it, Composer $composer4, int $changed2) {
                    ...
                    long m2957unboximpl = TextFieldColors.this.labelColor(z2, it == InputPhase.UnfocusedEmpty ? false : z3, interactionSource, $composer4, (($dirty2 >> 27) & 14) | (($dirty12 << 3) & 896) | ($dirty12 & 7168)).getValue().m2957unboximpl();
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    $composer4.endReplaceableGroup();
                    return m2957unboximpl;
                }
            };
            ...
            final boolean shouldOverrideTextStyleColor = (Color.m2948equalsimpl0(subtitle1.m4745getColor0d7_KjU(), Color.INSTANCE.m2983getUnspecified0d7_KjU()) && !Color.m2948equalsimpl0(caption.m4745getColor0d7_KjU(), Color.INSTANCE.m2983getUnspecified0d7_KjU())) || (!Color.m2948equalsimpl0(subtitle1.m4745getColor0d7_KjU(), Color.INSTANCE.m2983getUnspecified0d7_KjU()) && Color.m2948equalsimpl0(caption.m4745getColor0d7_KjU(), Color.INSTANCE.m2983getUnspecified0d7_KjU()));
            TextFieldTransitionScope textFieldTransitionScope = TextFieldTransitionScope.INSTANCE;
            $composer3.startReplaceableGroup(2129141006);
            ComposerKt.sourceInformation($composer3, "*110@4363L10,111@4455L22");
            long $this$CommonDecorationBox_u24lambda_u242 = MaterialTheme.INSTANCE.getTypography($composer3, 6).getCaption().m4745getColor0d7_KjU();
            if (shouldOverrideTextStyleColor) {
                ...
                if (!($this$takeOrElse_u2dDxMtmZc$iv != Color.INSTANCE.m2983getUnspecified0d7_KjU())) {
                    $this$takeOrElse_u2dDxMtmZc$iv = labelColor.invoke(inputState, $composer3, 0).m2957unboximpl();
                }
            ...
            long $this$CommonDecorationBox_u24lambda_u244 = MaterialTheme.INSTANCE.getTypography($composer3, 6).getSubtitle1().m4745getColor0d7_KjU();
            if (shouldOverrideTextStyleColor) {
                ...
                if ($this$takeOrElse_u2dDxMtmZc$iv2 != Color.INSTANCE.m2983getUnspecified0d7_KjU()) {
                    ...
                    z = false;
                    $this$takeOrElse_u2dDxMtmZc$iv2 = labelColor.invoke(inputState, $composer3, 0).m2957unboximpl();
                }
            ...
            $composer2 = $composer3;
            textFieldTransitionScope.m1254TransitionDTcfvLk(inputState, j, j2, labelColor, z4, ComposableLambdaKt.composableLambda($composer2, 341865432, true, new Function6<Float, Color, Color, Float, Composer, Integer, Unit>() { // from class: androidx.compose.material.TextFieldImplKt$CommonDecorationBox$3
                ...
                */
                public final void m1247invokeRIQooxk(final float r34, final long r35, final long r37, final float r39, androidx.compose.runtime.Composer r40, int r41) {
                    ...
                    */
                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.TextFieldImplKt$CommonDecorationBox$3.m1247invokeRIQooxk(float, long, long, float, androidx.compose.runtime.Composer, int):void");
                }
            }), $composer2, 1769472);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
