...
final class PopupLayout extends AbstractComposeView implements ViewRootForInspector, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    */
    ...
    public final void updatePosition() {
        IntSize m1264getPopupContentSizebOM6tXw;
        IntRect parentBounds = getParentBounds();
        if (parentBounds == null || (m1264getPopupContentSizebOM6tXw = m1264getPopupContentSizebOM6tXw()) == null) {
            return;
        }
        long popupContentSize = m1264getPopupContentSizebOM6tXw.getPackedValue();
