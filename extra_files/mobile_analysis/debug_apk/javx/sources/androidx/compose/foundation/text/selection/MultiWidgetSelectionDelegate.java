...
public final class MultiWidgetSelectionDelegate implements Selectable {
    ...
    private final synchronized int getLastVisibleOffset(TextLayoutResult $this$lastVisibleOffset) {
        ...
        if (this._previousTextLayoutResult != $this$lastVisibleOffset) {
            if ($this$lastVisibleOffset.getDidOverflowHeight() && !$this$lastVisibleOffset.getMultiParagraph().getDidExceedMaxLines()) {
                finalVisibleLine = RangesKt.coerceAtMost($this$lastVisibleOffset.getLineForVerticalPosition(IntSize.m5375getHeightimpl($this$lastVisibleOffset.getSize())), $this$lastVisibleOffset.getLineCount() - 1);
                while ($this$lastVisibleOffset.getLineTop(finalVisibleLine) >= IntSize.m5375getHeightimpl($this$lastVisibleOffset.getSize())) {
                    finalVisibleLine--;
                }
    ...
    public Pair<Selection, Boolean> mo879updateSelectionqCDeeow(long startHandlePosition, long endHandlePosition, Offset previousHandlePosition, boolean isStartHandle, LayoutCoordinates containerLayoutCoordinates, SelectionAdjustment adjustment, Selection previousSelection) {
        ...
        if (layoutCoordinates != null && (textLayoutResult = this.layoutResultCallback.invoke()) != null) {
            long relativePosition = containerLayoutCoordinates.mo4192localPositionOfR5De75A(layoutCoordinates, Offset.INSTANCE.m2724getZeroF1C5BW0());
            ...
            if (previousHandlePosition != null) {
                ...
                offset = Offset.m2697boximpl(Offset.m2712minusMKHz9U(it, relativePosition));
            }
            Offset localPreviousHandlePosition = offset;
            return MultiWidgetSelectionDelegateKt.m883getTextSelectionInfoyM0VcXU(textLayoutResult, localStartPosition, localEndPosition, localPreviousHandlePosition, getSelectableId(), adjustment, previousSelection, isStartHandle);
        }
    ...
    public Selection getSelectAllSelection() {
        ...
        m881getAssembledSelectionInfovJH6DeI = MultiWidgetSelectionDelegateKt.m881getAssembledSelectionInfovJH6DeI(newSelectionRange, false, getSelectableId(), textLayoutResult);
