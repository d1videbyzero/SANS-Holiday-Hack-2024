    ...
    private static final class DefaultDebugIndicationInstance implements IndicationInstance {
        ...
        public void drawIndication(ContentDrawScope $this$drawIndication) {
            ...
            if (!this.isPressed.getValue().booleanValue()) {
                ...
                m2945copywmQWz5c = Color.m2945copywmQWz5c(r2, (r12 & 1) != 0 ? Color.m2949getAlphaimpl(r2) : 0.1f, (r12 & 2) != 0 ? Color.m2953getRedimpl(r2) : 0.0f, (r12 & 4) != 0 ? Color.m2952getGreenimpl(r2) : 0.0f, (r12 & 8) != 0 ? Color.m2950getBlueimpl(Color.INSTANCE.m2973getBlack0d7_KjU()) : 0.0f);
                DrawScope.m3485drawRectnJ9OG0$default($this$drawIndication, m2945copywmQWz5c, 0L, $this$drawIndication.mo3490getSizeNHjbRc(), 0.0f, null, null, 0, 122, null);
                return;
            }
            m2945copywmQWz5c2 = Color.m2945copywmQWz5c(r2, (r12 & 1) != 0 ? Color.m2949getAlphaimpl(r2) : 0.3f, (r12 & 2) != 0 ? Color.m2953getRedimpl(r2) : 0.0f, (r12 & 4) != 0 ? Color.m2952getGreenimpl(r2) : 0.0f, (r12 & 8) != 0 ? Color.m2950getBlueimpl(Color.INSTANCE.m2973getBlack0d7_KjU()) : 0.0f);
            DrawScope.m3485drawRectnJ9OG0$default($this$drawIndication, m2945copywmQWz5c2, 0L, $this$drawIndication.mo3490getSizeNHjbRc(), 0.0f, null, null, 0, 122, null);
        }
    }
