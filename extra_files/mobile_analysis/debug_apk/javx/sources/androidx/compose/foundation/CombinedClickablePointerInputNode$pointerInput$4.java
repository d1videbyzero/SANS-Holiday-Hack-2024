...
final class CombinedClickablePointerInputNode$pointerInput$4 extends SuspendLambda implements Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(PressGestureScope pressGestureScope, Offset offset, Continuation<? super Unit> continuation) {
        return m214invoked4ec7I(pressGestureScope, offset.getPackedValue(), continuation);
    }
        ...
        switch (this.label) {
            case 0:
                ...
                if (this.this$0.getEnabled()) {
                    this.label = 1;
                    if (this.this$0.m149handlePressInteractiond4ec7I($this$detectTapGestures, offset, this) == coroutine_suspended) {
