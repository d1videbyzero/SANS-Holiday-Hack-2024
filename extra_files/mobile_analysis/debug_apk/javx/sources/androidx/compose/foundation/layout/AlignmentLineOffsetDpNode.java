...
final class AlignmentLineOffsetDpNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m376setBefore0680j_4(float f) {
        this.before = f;
    }
    ...
    public final void m375setAfter0680j_4(float f) {
        this.after = f;
    }
    ...
    public MeasureResult mo239measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        m362alignmentLineOffsetMeasuretjqqzMA = AlignmentLineKt.m362alignmentLineOffsetMeasuretjqqzMA(measure, this.alignmentLine, this.before, this.after, measurable, constraints);
