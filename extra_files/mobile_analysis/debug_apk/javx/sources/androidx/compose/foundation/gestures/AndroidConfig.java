...
final class AndroidConfig implements ScrollConfig {
    ...
    public long mo245calculateMouseWheelScroll8xgXZGE(Density calculateMouseWheelScroll, PointerEvent event, long bounds) {
        ...
        Offset m2697boximpl = Offset.m2697boximpl(Offset.INSTANCE.m2724getZeroF1C5BW0());
        int index$iv$iv = 0;
        ...
        while (index$iv$iv < size) {
            ...
            long acc = m2697boximpl.getPackedValue();
            m2697boximpl = Offset.m2697boximpl(Offset.m2713plusMKHz9U(acc, c.getScrollDelta()));
            index$iv$iv++;
            $this$fastFold$iv = $this$fastFold$iv;
        }
        return Offset.m2715timestuRUvjQ(m2697boximpl.getPackedValue(), -calculateMouseWheelScroll.mo327toPx0680j_4(Dp.m5216constructorimpl(64)));
    }
}
