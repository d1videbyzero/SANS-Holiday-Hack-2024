...
public final class TextStringSimpleNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public /* synthetic */ TextStringSimpleNode(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, ColorProducer colorProducer, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.INSTANCE.m5135getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, (i4 & 128) != 0 ? null : colorProducer, null);
    }
    ...
    public MeasureResult mo239measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        boolean didChangeLayout = layoutCache.m855layoutWithConstraintsK40F9xA(constraints, measure.getLayoutDirection());
        ...
        final Placeable placeable = measurable.mo4184measureBRTryo0(Constraints.INSTANCE.m5180fixedJhjzzOo(IntSize.m5376getWidthimpl(layoutSize), IntSize.m5375getHeightimpl(layoutSize)));
        int m5376getWidthimpl = IntSize.m5376getWidthimpl(layoutSize);
        int m5375getHeightimpl = IntSize.m5375getHeightimpl(layoutSize);
        Map<AlignmentLine, Integer> map = this.baselineCache;
        Intrinsics.checkNotNull(map);
        return measure.layout(m5376getWidthimpl, m5375getHeightimpl, map, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.modifiers.TextStringSimpleNode$measure$1
            {
                super(1);
            }
