...
public interface GridCells {
    ...
    public static final class Adaptive implements GridCells {
        ...
        private Adaptive(float minSize) {
            ...
            if (Dp.m5215compareTo0680j_4(this.minSize, Dp.m5216constructorimpl((float) 0)) > 0) {
            } else {
                throw new IllegalArgumentException(("Provided min size " + ((Object) Dp.m5227toStringimpl(this.minSize)) + " should be larger than zero.").toString());
            }
        }
        ...
        public int hashCode() {
            return Dp.m5222hashCodeimpl(this.minSize);
        }

        public boolean equals(Object other) {
            return (other instanceof Adaptive) && Dp.m5221equalsimpl0(this.minSize, ((Adaptive) other).minSize);
        }
    }
    ...
    public static final class FixedSize implements GridCells {
        ...
        private FixedSize(float size) {
            this.size = size;
            if (Dp.m5215compareTo0680j_4(this.size, Dp.m5216constructorimpl((float) 0)) > 0) {
            } else {
                throw new IllegalArgumentException(("Provided size " + ((Object) Dp.m5227toStringimpl(this.size)) + " should be larger than zero.").toString());
            }
        }
        ...
        public int hashCode() {
            return Dp.m5222hashCodeimpl(this.size);
        }

        public boolean equals(Object other) {
            return (other instanceof FixedSize) && Dp.m5221equalsimpl0(this.size, ((FixedSize) other).size);
        }
    }
}
