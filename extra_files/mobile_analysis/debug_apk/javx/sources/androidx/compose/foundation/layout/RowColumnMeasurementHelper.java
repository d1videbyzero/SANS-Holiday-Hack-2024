...
public final class RowColumnMeasurementHelper {
    ...
    public final RowColumnMeasureHelperResult m509measureWithoutPlacing_EkL_Y(MeasureScope measureScope, long constraints, int startIndex, int endIndex) {
        boolean z;
        int targetSpace;
        int weightedSpace;
        int fixedSpace;
        ...
        long constraints2 = OrientationIndependentConstraints.m451constructorimpl(constraints, this.orientation);
        ...
        while (true) {
            ...
            if (weight > 0.0f) {
                ...
                int m5172getMaxWidthimpl = Constraints.m5172getMaxWidthimpl(constraints2);
                Placeable placeable = this.placeables[i4];
                if (placeable == null) {
                    int weightChildrenCount2 = m5172getMaxWidthimpl != Integer.MAX_VALUE ? m5172getMaxWidthimpl - fixedSpace2 : Integer.MAX_VALUE;
                    mainAxisMax = m5172getMaxWidthimpl;
                    z3 = false;
                    m452copyyUG9Ft0 = OrientationIndependentConstraints.m452copyyUG9Ft0(constraints2, (r12 & 1) != 0 ? Constraints.m5174getMinWidthimpl(constraints2) : 0, (r12 & 2) != 0 ? Constraints.m5172getMaxWidthimpl(constraints2) : weightChildrenCount2, (r12 & 4) != 0 ? Constraints.m5173getMinHeightimpl(constraints2) : 0, (r12 & 8) != 0 ? Constraints.m5171getMaxHeightimpl(constraints2) : 0);
                    placeable = child.mo4184measureBRTryo0(OrientationIndependentConstraints.m464toBoxConstraintsOenEA2s(m452copyyUG9Ft0, this.orientation));
                } else {
                    mainAxisMax = m5172getMaxWidthimpl;
                    z3 = false;
                }
        ...
        if (weightChildrenCount == 0) {
            ...
            if (totalWeight > 0.0f && Constraints.m5172getMaxWidthimpl(constraints2) != Integer.MAX_VALUE) {
                targetSpace = Constraints.m5172getMaxWidthimpl(constraints2);
            } else {
                targetSpace = Constraints.m5174getMinWidthimpl(constraints2);
            }
            ...
            while (i6 < i2) {
                if (this.placeables[i6] != null) {
                    ...
                    remainingToTarget = remainingToTarget2;
                    weightUnitSpace = weightUnitSpace2;
                    Placeable placeable3 = child2.mo4184measureBRTryo0(OrientationIndependentConstraints.m464toBoxConstraintsOenEA2s(OrientationIndependentConstraints.m449constructorimpl(i, childMainAxisSize2, 0, Constraints.m5171getMaxHeightimpl(constraints2)), this.orientation));
            ...
            weightedSpace = RangesKt.coerceAtMost(((weightChildrenCount - 1) * i3) + weightedSpace2, Constraints.m5172getMaxWidthimpl(constraints2) - fixedSpace2);
        ...
        int mainAxisLayoutSize = Math.max(beforeCrossAxisAlignmentLine4, Constraints.m5174getMinWidthimpl(constraints2));
        if (Constraints.m5171getMaxHeightimpl(constraints2) == Integer.MAX_VALUE || this.crossAxisSize != SizeMode.Expand) {
            crossAxisLayoutSize = Math.max(crossAxisSpace, Math.max(Constraints.m5173getMinHeightimpl(constraints2), beforeCrossAxisAlignmentLine + afterCrossAxisAlignmentLine));
        } else {
            crossAxisLayoutSize = Constraints.m5171getMaxHeightimpl(constraints2);
        }
