...
public final class ParagraphLayoutCache {
    ...
    private ParagraphLayoutCache(String text, TextStyle style, FontFamily.Resolver fontFamilyResolver, int overflow, boolean softWrap, int maxLines, int minLines) {
        ...
        this.prevConstraints = Constraints.INSTANCE.m5180fixedJhjzzOo(0, 0);
    ...
    public /* synthetic */ ParagraphLayoutCache(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.INSTANCE.m5135getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, null);
    }
    ...
    public final boolean m855layoutWithConstraintsK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        if (this.minLines > 1) {
            ...
            finalConstraints = localMin.m844coerceMinLinesOh53vG4$foundation_release(constraints, this.minLines);
        } else {
            finalConstraints = constraints;
        }
        boolean z2 = false;
        if (!m853newLayoutWillBeDifferentK40F9xA(finalConstraints, layoutDirection)) {
            if (!Constraints.m5165equalsimpl0(finalConstraints, this.prevConstraints)) {
                Paragraph localParagraph = this.paragraph;
                Intrinsics.checkNotNull(localParagraph);
                long localSize = ConstraintsKt.m5183constrain4WqzIAM(finalConstraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(localParagraph.getWidth()), TextDelegateKt.ceilToIntPx(localParagraph.getHeight())));
                this.layoutSize = localSize;
                if (TextOverflow.m5128equalsimpl0(this.overflow, TextOverflow.INSTANCE.m5137getVisiblegIe3tQ8()) || (IntSize.m5376getWidthimpl(localSize) >= localParagraph.getWidth() && IntSize.m5375getHeightimpl(localSize) >= localParagraph.getHeight())) {
                    z = false;
                }
                this.didOverflow = z;
            }
        ...
        Paragraph it = m852layoutTextK40F9xA(finalConstraints, layoutDirection);
        this.prevConstraints = finalConstraints;
        long localSize2 = ConstraintsKt.m5183constrain4WqzIAM(finalConstraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(it.getWidth()), TextDelegateKt.ceilToIntPx(it.getHeight())));
        this.layoutSize = localSize2;
        if (!TextOverflow.m5128equalsimpl0(this.overflow, TextOverflow.INSTANCE.m5137getVisiblegIe3tQ8()) && (IntSize.m5376getWidthimpl(localSize2) < it.getWidth() || IntSize.m5375getHeightimpl(localSize2) < it.getHeight())) {
            z2 = true;
        }
        this.didOverflow = z2;
        this.paragraph = it;
    ...
    public final int intrinsicHeight(int width, LayoutDirection layoutDirection) {
        ...
        int result = TextDelegateKt.ceilToIntPx(m852layoutTextK40F9xA(ConstraintsKt.Constraints(0, width, 0, Integer.MAX_VALUE), layoutDirection).getHeight());
    ...
    private final Paragraph m852layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        return ParagraphKt.m4624Paragraph_EkL_Y(localParagraphIntrinsics, LayoutUtilsKt.m841finalConstraintstfFHcEY(constraints, this.softWrap, this.overflow, localParagraphIntrinsics.getMaxIntrinsicWidth()), LayoutUtilsKt.m842finalMaxLinesxdlQI24(this.softWrap, this.overflow, this.maxLines), TextOverflow.m5128equalsimpl0(this.overflow, TextOverflow.INSTANCE.m5136getEllipsisgIe3tQ8()));
    }
    ...
    private final boolean m853newLayoutWillBeDifferentK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        if (Constraints.m5165equalsimpl0(constraints, this.prevConstraints)) {
            return false;
        }
        return Constraints.m5172getMaxWidthimpl(constraints) != Constraints.m5172getMaxWidthimpl(this.prevConstraints) || ((float) Constraints.m5171getMaxHeightimpl(constraints)) < localParagraph.getHeight() || localParagraph.getDidExceedMaxLines();
    }
