...
public final class LazyStaggeredGridMeasureKt {
                        ...
                        while (i8 < length) {
                            ...
                            try {
                                ...
                                if (i8 == 0) {
                                    ...
                                    iArr = iArr3;
                                    i6 = m665maxInRangejy6DScQ(iArr2, SpanRange.m675constructorimpl(0, i8)) + 1;
                                }
                                iArr2[i8] = i6;
                                lazyStaggeredGridMeasureContext.getLaneInfo().setLane(iArr2[i8], i8);
                                i8++;
    ...
    private static final LazyStaggeredGridMeasureResult measure(final LazyStaggeredGridMeasureContext $this$measure, int initialScrollDelta, int[] initialItemIndices, int[] initialItemOffsets, boolean canRestartMeasure) {
        ...
        if (itemCount6 <= 0) {
            ...
            if ($this$measure.getLaneCount() != 0) {
                ...
                while (true) {
                    ...
                    long spanRange = lazyStaggeredGridMeasureContext2.m662getSpanRangelOCCd4c($this$measure.getItemProvider(), previousItemIndex, laneIndex);
                    ...
                    LazyStaggeredGridMeasuredItem measuredItem = $this$measure.getMeasuredItemProvider().m670getAndMeasurejy6DScQ(previousItemIndex, spanRange);
                    int offset = m665maxInRangejy6DScQ(firstItemOffsets2, spanRange);
                ...
                while (initialLaneToMeasure3 != i4 && initialItemsMeasured2 < $this$measure.getLaneCount()) {
                    ...
                    if (itemIndex2 >= 0) {
                        ...
                        long spanRange2 = lazyStaggeredGridMeasureContext2.m662getSpanRangelOCCd4c($this$measure.getItemProvider(), itemIndex2, laneIndex2);
                        LazyStaggeredGridMeasuredItem measuredItem2 = $this$measure.getMeasuredItemProvider().m670getAndMeasurejy6DScQ(itemIndex2, spanRange2);
                        ...
                        int offset2 = m665maxInRangejy6DScQ(currentItemOffsets4, spanRange2) + measuredItem2.getSizeWithSpacings();
                ...
                while (true) {
                    ...
                    long spanRange3 = $this$measure.m662getSpanRangelOCCd4c($this$measure.getItemProvider(), itemIndex3, currentLaneIndex);
                    $this$measure.getLaneInfo().setLane(itemIndex3, ((int) (spanRange3 & 4294967295L)) - ((int) (spanRange3 >> 32)) != 1 ? -2 : (int) (spanRange3 >> 32));
                    LazyStaggeredGridMeasuredItem measuredItem3 = $this$measure.getMeasuredItemProvider().m670getAndMeasurejy6DScQ(itemIndex3, spanRange3);
                    int offset3 = m665maxInRangejy6DScQ(currentItemOffsets5, spanRange3);
                ...
                if (z3) {
                    ...
                    while (true) {
                        ...
                        if (previousIndex < 0) {
                            ...
                            long spanRange4 = $this$measure.m662getSpanRangelOCCd4c($this$measure.getItemProvider(), previousIndex, laneIndex4);
                            ...
                            LazyStaggeredGridMeasuredItem measuredItem4 = $this$measure.getMeasuredItemProvider().m670getAndMeasurejy6DScQ(previousIndex, spanRange4);
                            int offset4 = m665maxInRangejy6DScQ(firstItemOffsets2, spanRange4);
                ...
                int layoutWidth = $this$measure.getIsVertical() ? Constraints.m5172getMaxWidthimpl($this$measure.getConstraints()) : ConstraintsKt.m5186constrainWidthK40F9xA($this$measure.getConstraints(), ArraysKt.maxOrThrow(currentItemOffsets) + contentPadding);
                int layoutHeight2 = $this$measure.getIsVertical() ? ConstraintsKt.m5185constrainHeightK40F9xA($this$measure.getConstraints(), ArraysKt.maxOrThrow(currentItemOffsets) + contentPadding) : Constraints.m5171getMaxHeightimpl($this$measure.getConstraints());
                ...
                while ($i$f$calculateExtraItems < extraItemOffset3) {
                    ...
                    if (z7) {
                        ...
                        long spanRange$iv = $this$measure.m662getSpanRangelOCCd4c($this$measure.getItemProvider(), index$iv, 0);
                        if (list == null) {
                            Object result$iv = new ArrayList();
                            list = (List) result$iv;
                        }
                        LazyStaggeredGridMeasuredItem measuredItem$iv = $this$measure.getMeasuredItemProvider().m670getAndMeasurejy6DScQ(index$iv, spanRange$iv);
                ...
                while (index$iv$iv < size3) {
                    ...
                    if (z6) {
                        long spanRange$iv2 = $this$measure.m662getSpanRangelOCCd4c($this$measure.getItemProvider(), index$iv3, 0);
                        if (list2 == null) {
                            Object result$iv2 = new ArrayList();
                            list2 = (List) result$iv2;
                        }
                        LazyStaggeredGridMeasuredItem measuredItem$iv2 = $this$measure.getMeasuredItemProvider().m670getAndMeasurejy6DScQ(index$iv3, spanRange$iv2);
        ...
        return new LazyStaggeredGridMeasureResult(initialItemIndices, initialItemOffsets, 0.0f, MeasureScope.layout$default(scope$iv, Constraints.m5174getMinWidthimpl($this$measure.getConstraints()), Constraints.m5173getMinHeightimpl($this$measure.getConstraints()), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasureKt$measure$1$1
            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Unit invoke(Placeable.PlacementScope placementScope) {
                invoke2(placementScope);
                return Unit.INSTANCE;
    ...
    private static final List<LazyStaggeredGridMeasuredItem> calculateVisibleItems(LazyStaggeredGridMeasureContext $this$calculateVisibleItems, ArrayDeque<LazyStaggeredGridMeasuredItem>[] arrayDequeArr, int[] itemScrollOffsets, int mainAxisLayoutSize) {
        ...
        while (true) {
            ...
            if (item.getLane() == laneIndex) {
                long spanRange = SpanRange.m675constructorimpl(item.getLane(), item.getSpan());
                int mainAxisOffset = m665maxInRangejy6DScQ(itemScrollOffsets, spanRange);
    ...
    private static final List<LazyStaggeredGridMeasuredItem> calculateExtraItems(LazyStaggeredGridMeasureContext $this$calculateExtraItems, Function1<? super LazyStaggeredGridMeasuredItem, Unit> function1, Function1<? super Integer, Boolean> function12) {
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            ...
            if (function12.invoke(Integer.valueOf(index)).booleanValue()) {
                long spanRange = $this$calculateExtraItems.m662getSpanRangelOCCd4c($this$calculateExtraItems.getItemProvider(), index, 0);
                if (arrayList == null) {
                    Object result = new ArrayList();
                    arrayList = (List) result;
                }
                LazyStaggeredGridMeasuredItem measuredItem = $this$calculateExtraItems.getMeasuredItemProvider().m670getAndMeasurejy6DScQ(index, spanRange);
    ...
    private static final void m664forEachnIS5qE8(long $this$forEach_u2dnIS5qE8, Function1<? super Integer, Unit> function1) {
    ...
    private static final int m665maxInRangejy6DScQ(int[] $this$maxInRange_u2djy6DScQ, long indexRange) {
