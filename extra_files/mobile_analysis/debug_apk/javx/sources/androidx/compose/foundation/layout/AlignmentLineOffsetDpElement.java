...
final class AlignmentLineOffsetDpElement extends ModifierNodeElement<AlignmentLineOffsetDpNode> {
    ...
    private AlignmentLineOffsetDpElement(AlignmentLine alignmentLine, float before, float after, Function1<? super InspectorInfo, Unit> inspectorInfo) {
        ...
        if ((this.before >= 0.0f || Dp.m5221equalsimpl0(this.before, Dp.INSTANCE.m5236getUnspecifiedD9Ej5fM())) && (this.after >= 0.0f || Dp.m5221equalsimpl0(this.after, Dp.INSTANCE.m5236getUnspecifiedD9Ej5fM()))) {
        } else {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.alignmentLine, otherModifier.alignmentLine) && Dp.m5221equalsimpl0(this.before, otherModifier.before) && Dp.m5221equalsimpl0(this.after, otherModifier.after);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int result = this.alignmentLine.hashCode();
        return (((result * 31) + Dp.m5222hashCodeimpl(this.before)) * 31) + Dp.m5222hashCodeimpl(this.after);
    }
}
