...
public final class TextFieldSelectionManagerKt {
    ...
    public static final boolean isSelectionHandleInVisibleBound(TextFieldSelectionManager $this$isSelectionHandleInVisibleBound, boolean isStartHandle) {
        ...
        if (state != null && (layoutCoordinates = state.getLayoutCoordinates()) != null && (visibleBounds = SelectionManagerKt.visibleBounds(layoutCoordinates)) != null) {
            return SelectionManagerKt.m929containsInclusiveUv8p0NA(visibleBounds, $this$isSelectionHandleInVisibleBound.m948getHandlePositiontuRUvjQ$foundation_release(isStartHandle));
        }
        return false;
    }
    ...
    public static final long m949calculateSelectionMagnifierCenterAndroidO0kMr_c(TextFieldSelectionManager manager, long magnifierSize) {
        ...
        switch (draggingHandle == null ? -1 : WhenMappings.$EnumSwitchMapping$0[draggingHandle.ordinal()]) {
            ...
            case 1:
            case 2:
                rawTextOffset = TextRange.m4724getStartimpl(manager.getValue$foundation_release().getSelection());
                break;
            case 3:
                rawTextOffset = TextRange.m4719getEndimpl(manager.getValue$foundation_release().getSelection());
                break;
        }
            ...
            if (layoutResult3 != null) {
                ...
                if (state2 != null && (textDelegate = state2.getTextDelegate()) != null) {
                    ...
                    if (transformedText != null) {
                        ...
                        long offsetCenter = layoutResult3.getBoundingBox(textOffset2).m2738getCenterF1C5BW0();
                        ...
                        if (state3 != null && (containerCoordinates = state3.getLayoutCoordinates()) != null) {
                            ...
                            if (state4 != null && (layoutResult2 = state4.getLayoutResult()) != null) {
                                ...
                                if (fieldCoordinates != null) {
                                    ...
                                    long it = m946getCurrentDragPosition_m7T9E.getPackedValue();
                                    float dragX = Offset.m2708getXimpl(fieldCoordinates.mo4192localPositionOfR5De75A(containerCoordinates, it));
                                    ...
                                    int m4724getStartimpl = TextRange.m4724getStartimpl(manager.getValue$foundation_release().getSelection());
                                    int rawTextOffset2 = TextRange.m4719getEndimpl(manager.getValue$foundation_release().getSelection());
                                    boolean areHandlesCrossed = m4724getStartimpl > rawTextOffset2;
                                    ...
                                    if (Math.abs(dragX - centerX) > IntSize.m5376getWidthimpl(magnifierSize) / 2) {
                                        return Offset.INSTANCE.m2723getUnspecifiedF1C5BW0();
                                    }
                                    return containerCoordinates.mo4192localPositionOfR5De75A(fieldCoordinates, OffsetKt.Offset(centerX, Offset.m2709getYimpl(offsetCenter)));
                                }
                            }
                            return Offset.INSTANCE.m2723getUnspecifiedF1C5BW0();
                        }
