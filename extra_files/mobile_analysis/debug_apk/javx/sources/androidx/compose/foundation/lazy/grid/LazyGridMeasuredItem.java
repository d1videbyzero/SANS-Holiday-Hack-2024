...
public final class LazyGridMeasuredItem implements LazyGridItemInfo {
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        while (i3 < placeablesCount) {
            ...
            if (animateNode == null) {
                ...
                if ((m619getMainAxisgyyYBs(offset) <= minOffset && m619getMainAxisgyyYBs(animatedOffset) <= minOffset) || (m619getMainAxisgyyYBs(offset) >= maxOffset && m619getMainAxisgyyYBs(animatedOffset) >= maxOffset)) {
            ...
            if (this.reverseLayout) {
                ...
                if (this.isVertical) {
                    mainAxisOffset = IntOffset.m5334getXimpl($this$copy_u2d4Tuh3kE$iv);
                } else {
                    int mainAxisOffset2 = IntOffset.m5334getXimpl($this$copy_u2d4Tuh3kE$iv);
                    mainAxisOffset = (this.mainAxisLayoutSize - mainAxisOffset2) - getMainAxisSize(placeable);
                }
                if (this.isVertical) {
                    int mainAxisOffset3 = IntOffset.m5335getYimpl($this$copy_u2d4Tuh3kE$iv);
                    m5335getYimpl = (this.mainAxisLayoutSize - mainAxisOffset3) - getMainAxisSize(placeable);
                } else {
                    m5335getYimpl = IntOffset.m5335getYimpl($this$copy_u2d4Tuh3kE$iv);
                }
                offset = IntOffsetKt.IntOffset(mainAxisOffset, m5335getYimpl);
            }
            long other$iv2 = this.visualOffset;
            long other$iv3 = IntOffsetKt.IntOffset(IntOffset.m5334getXimpl(offset) + IntOffset.m5334getXimpl(other$iv2), IntOffset.m5335getYimpl(offset) + IntOffset.m5335getYimpl(other$iv2));
            if (this.isVertical) {
                Placeable.PlacementScope.m4244placeWithLayeraW9wM$default(scope, placeable, other$iv3, 0.0f, null, 6, null);
            } else {
                Placeable.PlacementScope.m4243placeRelativeWithLayeraW9wM$default(scope, placeable, other$iv3, 0.0f, null, 6, null);
            }
            i3++;
            i2 = i;
        }
    ...
    private final int m619getMainAxisgyyYBs(long $this$mainAxis) {
    ...
    private final long m618copy4Tuh3kE(long $this$copy_u2d4Tuh3kE, Function1<? super Integer, Integer> function1) {
