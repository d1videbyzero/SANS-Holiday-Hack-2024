...
public final class BorderModifierNode extends DelegatingNode {
    ...
    private BorderModifierNode(float widthParameter, Brush brushParameter, Shape shapeParameter) {
        ...
        this.drawWithCacheModifierNode = (CacheDrawModifierNode) delegate(DrawModifierKt.CacheDrawModifierNode(new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.BorderModifierNode$drawWithCacheModifierNode$1
            ...
            public final DrawResult invoke(CacheDrawScope CacheDrawModifierNode) {
                ...
                boolean hasValidBorderParams = CacheDrawModifierNode.mo327toPx0680j_4(BorderModifierNode.this.getWidth()) >= 0.0f && Size.m2776getMinDimensionimpl(CacheDrawModifierNode.m2614getSizeNHjbRc()) > 0.0f;
                if (!hasValidBorderParams) {
                    drawContentWithoutBorder = BorderKt.drawContentWithoutBorder(CacheDrawModifierNode);
                    return drawContentWithoutBorder;
                }
                float f = 2;
                float strokeWidthPx = Math.min(Dp.m5221equalsimpl0(BorderModifierNode.this.getWidth(), Dp.INSTANCE.m5234getHairlineD9Ej5fM()) ? 1.0f : (float) Math.ceil(CacheDrawModifierNode.mo327toPx0680j_4(BorderModifierNode.this.getWidth())), (float) Math.ceil(Size.m2776getMinDimensionimpl(CacheDrawModifierNode.m2614getSizeNHjbRc()) / f));
                ...
                Outline outline = BorderModifierNode.this.getShape().mo210createOutlinePq9zytI(CacheDrawModifierNode.m2614getSizeNHjbRc(), CacheDrawModifierNode.getLayoutDirection(), CacheDrawModifierNode);
                ...
                if (outline instanceof Outline.Rounded) {
                    m178drawRoundRectBorderJqoCqck = BorderModifierNode.this.m178drawRoundRectBorderJqoCqck(CacheDrawModifierNode, BorderModifierNode.this.getBrush(), (Outline.Rounded) outline, topLeft, borderSize, fillArea, strokeWidthPx);
                    return m178drawRoundRectBorderJqoCqck;
                }
                if (outline instanceof Outline.Rectangle) {
                    m175drawRectBorderNsqcLGU = BorderKt.m175drawRectBorderNsqcLGU(CacheDrawModifierNode, BorderModifierNode.this.getBrush(), topLeft, borderSize, fillArea, strokeWidthPx);
    ...
    public final void m180setWidth0680j_4(float value) {
        if (!Dp.m5221equalsimpl0(this.width, value)) {
            this.width = value;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:23:0x00ed, code lost:
        ...
        if (androidx.compose.ui.graphics.ImageBitmapConfig.m3158equalsimpl(r13, r2 != null ? androidx.compose.ui.graphics.ImageBitmapConfig.m3156boximpl(r2.mo2816getConfig_sVssgQ()) : null) != false) goto L26;
     */
    ...
    */
    ...
    public final DrawResult m178drawRoundRectBorderJqoCqck(CacheDrawScope $this$drawRoundRectBorder_u2dJqoCqck, final Brush brush, Outline.Rounded outline, final long topLeft, final long borderSize, final boolean fillArea, final float strokeWidth) {
        ...
        if (RoundRectKt.isSimple(outline.getRoundRect())) {
            ...
            return $this$drawRoundRectBorder_u2dJqoCqck.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.BorderModifierNode$drawRoundRectBorder$1
                ...
                public final void invoke2(ContentDrawScope onDrawWithContent) {
                    ...
                    if (fillArea) {
                        DrawScope.m3486drawRoundRectZuiqVtQ$default(onDrawWithContent, brush, 0L, 0L, cornerRadius, 0.0f, null, null, 0, 246, null);
                        return;
                    }
                    if (CornerRadius.m2683getXimpl(cornerRadius) < halfStroke) {
                        ContentDrawScope $this$clipRect_u2drOu3jXo$iv = onDrawWithContent;
                        float left$iv = strokeWidth;
                        float top$iv = strokeWidth;
                        float right$iv = Size.m2777getWidthimpl(onDrawWithContent.mo3490getSizeNHjbRc()) - strokeWidth;
                        float bottom$iv = Size.m2774getHeightimpl(onDrawWithContent.mo3490getSizeNHjbRc()) - strokeWidth;
                        ...
                        $this$clipRect_rOu3jXo_u24lambda_u244$iv.mo3418clipRectN_I0leg(left$iv, top$iv, right$iv, bottom$iv, clipOp$iv);
                        DrawScope.m3486drawRoundRectZuiqVtQ$default($this$clipRect_u2drOu3jXo$iv, brush2, 0L, 0L, j, 0.0f, null, null, 0, 246, null);
                    ...
                    long j2 = topLeft;
                    long j3 = borderSize;
                    m176shrinkKibmq7A = BorderKt.m176shrinkKibmq7A(cornerRadius, halfStroke);
                    DrawScope.m3486drawRoundRectZuiqVtQ$default(onDrawWithContent, brush3, j2, j3, m176shrinkKibmq7A, 0.0f, borderStroke, null, 0, 208, null);
                }
            });
        }
        ...
        return $this$drawRoundRectBorder_u2dJqoCqck.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.BorderModifierNode$drawRoundRectBorder$2
            ...
            public final void invoke2(ContentDrawScope onDrawWithContent) {
                Intrinsics.checkNotNullParameter(onDrawWithContent, "$this$onDrawWithContent");
                onDrawWithContent.drawContent();
                DrawScope.m3480drawPathGBMwjPU$default(onDrawWithContent, Path.this, brush, 0.0f, null, null, 0, 60, null);
            }
        });
    }
}
