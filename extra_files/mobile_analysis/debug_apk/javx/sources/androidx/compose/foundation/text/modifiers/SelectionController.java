    ...
    */
    ...
    public final void draw(DrawScope drawScope) {
        ...
        if (!this.params.getShouldClip()) {
            DrawScope.m3481drawPathLG529CI$default(drawScope, selectionPath, this.backgroundSelectionColor, 0.0f, null, null, 0, 60, null);
            return;
        }
        float right$iv = Size.m2777getWidthimpl(drawScope.mo3490getSizeNHjbRc());
        float bottom$iv = Size.m2774getHeightimpl(drawScope.mo3490getSizeNHjbRc());
