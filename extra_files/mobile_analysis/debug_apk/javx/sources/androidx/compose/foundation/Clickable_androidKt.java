...
public final class Clickable_androidKt {
    ...
    public static final boolean m209isPressZmokQxo(KeyEvent isPress) {
        ...
        return KeyEventType.m3926equalsimpl0(KeyEvent_androidKt.m3934getTypeZmokQxo(isPress), KeyEventType.INSTANCE.m3930getKeyDownCS__XNY()) && m208isEnterZmokQxo(isPress);
    }

    /* renamed from: isClick-ZmokQxo, reason: not valid java name */
    public static final boolean m207isClickZmokQxo(KeyEvent isClick) {
        Intrinsics.checkNotNullParameter(isClick, "$this$isClick");
        return KeyEventType.m3926equalsimpl0(KeyEvent_androidKt.m3934getTypeZmokQxo(isClick), KeyEventType.INSTANCE.m3931getKeyUpCS__XNY()) && m208isEnterZmokQxo(isClick);
    }

    /* renamed from: isEnter-ZmokQxo, reason: not valid java name */
    private static final boolean m208isEnterZmokQxo(KeyEvent $this$isEnter) {
        switch (Key_androidKt.m3940getNativeKeyCodeYVgTNJs(KeyEvent_androidKt.m3933getKeyZmokQxo($this$isEnter))) {
            case 23:
            case 66:
            case 160:
                return true;
