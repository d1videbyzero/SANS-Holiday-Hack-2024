            ...
            public final Object invokeSuspend(Object $result) {
                ...
                switch (this.label) {
                    case 0:
                        ...
                        Offset m2697boximpl = Offset.m2697boximpl(this.$down.getPosition());
                        this.label = 1;
                        if (function3.invoke(pressGestureScopeImpl, m2697boximpl, this) != coroutine_suspended) {
                            break;
                        } else {
                            return coroutine_suspended;
                        }
            ...
            public final Object invokeSuspend(Object $result) {
                ...
                switch (this.label) {
                    case 0:
                        ...
                        Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> function3 = this.$onPress;
                        PressGestureScopeImpl pressGestureScopeImpl = this.$pressScope;
                        Offset m2697boximpl = Offset.m2697boximpl(this.$secondDown.getPosition());
                        this.label = 1;
                        if (function3.invoke(pressGestureScopeImpl, m2697boximpl, this) != coroutine_suspended) {
                            break;
                        } else {
