...
public final class SelectionControllerKt {
    ...
    public static final Modifier makeSelectionModifier(final SelectionRegistrar $this$makeSelectionModifier, final long selectableId, final Function0<? extends LayoutCoordinates> function0, final Function0<TextLayoutResult> function02, boolean isInTouchMode) {
                ...
                public void mo805onStartk4lQ0M(long startPoint) {
                    ...
                    if (it != null) {
                        ...
                        if (m863outOfBoundary2x9bVx0) {
                            ...
                            selectionRegistrar.mo937notifySelectionUpdateStartd4ec7I(it, startPoint, SelectionAdjustment.INSTANCE.getWord());
                        }
                ...
                public void mo804onDragk4lQ0M(long delta) {
                    ...
                    if (it != null) {
                        ...
                        if (it.isAttached() && SelectionRegistrarKt.hasSelection(selectionRegistrar, j)) {
                            this.dragTotalDistance = Offset.m2713plusMKHz9U(this.dragTotalDistance, delta);
                            long newPosition = Offset.m2713plusMKHz9U(this.lastPosition, this.dragTotalDistance);
                            m863outOfBoundary2x9bVx0 = SelectionControllerKt.m863outOfBoundary2x9bVx0(function03.invoke(), this.lastPosition, newPosition);
                            if (!m863outOfBoundary2x9bVx0) {
                                boolean consumed = selectionRegistrar.mo936notifySelectionUpdate5iVPX68(it, newPosition, this.lastPosition, false, SelectionAdjustment.INSTANCE.getCharacterWithWordAccelerate());
                                if (consumed) {
        ...
        ?? r1 = new MouseSelectionObserver() { // from class: androidx.compose.foundation.text.modifiers.SelectionControllerKt$makeSelectionModifier$mouseSelectionObserver$1
            ...
            public boolean mo865onExtendk4lQ0M(long downPosition) {
                ...
                boolean consumed = selectionRegistrar.mo936notifySelectionUpdate5iVPX68(layoutCoordinates, downPosition, this.lastPosition, false, SelectionAdjustment.INSTANCE.getNone());
                if (consumed) {
            ...
            public boolean mo866onExtendDragk4lQ0M(long dragPosition) {
                ...
                if (layoutCoordinates != null) {
                    ...
                    boolean consumed = selectionRegistrar.mo936notifySelectionUpdate5iVPX68(layoutCoordinates, dragPosition, this.lastPosition, false, SelectionAdjustment.INSTANCE.getNone());
                    if (consumed) {
            ...
            public boolean mo867onStart3MmeM6k(long downPosition, SelectionAdjustment adjustment) {
                ...
                selectionRegistrar.mo937notifySelectionUpdateStartd4ec7I(it, downPosition, adjustment);
                this.lastPosition = downPosition;
                return SelectionRegistrarKt.hasSelection(selectionRegistrar, j);
            }
            ...
            public boolean mo864onDrag3MmeM6k(long dragPosition, SelectionAdjustment adjustment) {
                ...
                if (it != null) {
                    ...
                    boolean consumed = selectionRegistrar.mo936notifySelectionUpdate5iVPX68(it, dragPosition, this.lastPosition, false, adjustment);
                    if (consumed) {
                        this.lastPosition = dragPosition;
                        return true;
                    }
    ...
    public static final boolean m863outOfBoundary2x9bVx0(TextLayoutResult $this$outOfBoundary_u2d2x9bVx0, long start, long end) {
        if ($this$outOfBoundary_u2d2x9bVx0 == null) {
            return false;
        }
        int lastOffset = $this$outOfBoundary_u2d2x9bVx0.getLayoutInput().getText().getText().length();
        int rawStartOffset = $this$outOfBoundary_u2d2x9bVx0.m4696getOffsetForPositionk4lQ0M(start);
        int rawEndOffset = $this$outOfBoundary_u2d2x9bVx0.m4696getOffsetForPositionk4lQ0M(end);
