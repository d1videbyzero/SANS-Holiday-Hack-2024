...
public final class PagerMeasureKt {
    ...
    public static final PagerMeasureResult m699measurePagerntgEbfI(final LazyLayoutMeasureScope measurePager, int pageCount, final PagerLazyLayoutItemProvider pagerItemProvider, int mainAxisAvailableSize, int beforeContentPadding, int afterContentPadding, int spaceBetweenPages, int firstVisiblePage, int firstVisiblePageOffset, float scrollToBeConsumed, long constraints, final Orientation orientation, final Alignment.Vertical verticalAlignment, final Alignment.Horizontal horizontalAlignment, final boolean reverseLayout, final long visualPageOffset, final int pageAvailableSize, int beyondBoundsPageCount, List<Integer> pinnedPages, Function3<? super Integer, ? super Integer, ? super Function1<? super Placeable.PlacementScope, Unit>, ? extends MeasureResult> layout) {
        ...
        if (pageCount <= 0) {
            return new PagerMeasureResult(CollectionsKt.emptyList(), 0, pageAvailableSize, spaceBetweenPages, afterContentPadding, orientation, -beforeContentPadding, mainAxisAvailableSize + afterContentPadding, false, 0.0f, null, null, 0, false, layout.invoke(Integer.valueOf(Constraints.m5174getMinWidthimpl(constraints)), Integer.valueOf(Constraints.m5173getMinHeightimpl(constraints)), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$2
        ...
        final long childConstraints = ConstraintsKt.Constraints$default(0, orientation == Orientation.Vertical ? Constraints.m5172getMaxWidthimpl(constraints) : pageAvailableSize, 0, orientation != Orientation.Vertical ? Constraints.m5171getMaxHeightimpl(constraints) : pageAvailableSize, 5, null);
        ...
        while (maxCrossAxis2 < 0 && currentFirstPage3 > 0) {
            ...
            MeasuredPage measuredPage = m698getAndMeasureSGf7dI0(measurePager, previous, childConstraints, pagerItemProvider, visualPageOffset, orientation, horizontalAlignment, verticalAlignment, measurePager.getLayoutDirection(), reverseLayout, pageAvailableSize);
        ...
        while (true) {
            ...
            MeasuredPage measuredPage2 = m698getAndMeasureSGf7dI0(measurePager, i3, childConstraints, pagerItemProvider, visualPageOffset, orientation, horizontalAlignment, verticalAlignment, measurePager.getLayoutDirection(), reverseLayout, pageAvailableSize);
        ...
        if (index < maxOffset7) {
            ...
            while (true) {
                ...
                MeasuredPage measuredPage3 = m698getAndMeasureSGf7dI0(measurePager, previousIndex, childConstraints, pagerItemProvider, visualPageOffset, orientation, horizontalAlignment, verticalAlignment, measurePager.getLayoutDirection(), reverseLayout, pageAvailableSize);
        ...
        List extraPagesBefore = createPagesBeforeList(currentFirstPage, beyondBoundsPageCount, pinnedPages, new Function1<Integer, MeasuredPage>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$extraPagesBefore$1
            ...
            public final MeasuredPage invoke(int it) {
                MeasuredPage m698getAndMeasureSGf7dI0;
                m698getAndMeasureSGf7dI0 = PagerMeasureKt.m698getAndMeasureSGf7dI0(LazyLayoutMeasureScope.this, it, childConstraints, pagerItemProvider, visualPageOffset, orientation, horizontalAlignment, verticalAlignment, LazyLayoutMeasureScope.this.getLayoutDirection(), reverseLayout, pageAvailableSize);
                return m698getAndMeasureSGf7dI0;
            }
        });
        ...
        int layoutWidth = ConstraintsKt.m5186constrainWidthK40F9xA(constraints, orientation == Orientation.Vertical ? maxCrossAxis12 : currentMainAxisOffset4);
        int layoutHeight = ConstraintsKt.m5185constrainHeightK40F9xA(constraints, orientation == Orientation.Vertical ? currentMainAxisOffset4 : maxCrossAxis12);
    ...
    public static final MeasuredPage m698getAndMeasureSGf7dI0(LazyLayoutMeasureScope $this$getAndMeasure_u2dSGf7dI0, int index, long childConstraints, PagerLazyLayoutItemProvider pagerItemProvider, long visualPageOffset, Orientation orientation, Alignment.Horizontal horizontalAlignment, Alignment.Vertical verticalAlignment, LayoutDirection layoutDirection, boolean reverseLayout, int pageAvailableSize) {
        ...
        List placeable = $this$getAndMeasure_u2dSGf7dI0.mo640measure0kLqBqw(index, childConstraints);
    ...
    private static final List<MeasuredPage> calculatePagesOffsets(LazyLayoutMeasureScope $this$calculatePagesOffsets, List<MeasuredPage> list, List<MeasuredPage> list2, List<MeasuredPage> list3, int layoutWidth, int layoutHeight, int finalMainAxisOffset, int maxOffset, int pagesScrollOffset, Orientation orientation, boolean reverseLayout, Density density, int spaceBetweenPages, int pageAvailableSize) {
        ...
        if (hasSpareSpace) {
            ...
            Arrangement.HorizontalOrVertical arrangement = Arrangement.Absolute.INSTANCE.m396spacedBy0680j_4($this$calculatePagesOffsets.mo324toDpu2uoSUM(pageAvailableSize));
