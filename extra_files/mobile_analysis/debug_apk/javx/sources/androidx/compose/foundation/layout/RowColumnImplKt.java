    ...
    public static final MeasurePolicy m507rowColumnMeasurePolicyTDGSqEk(final LayoutOrientation orientation, final Function5<? super Integer, ? super int[], ? super LayoutDirection, ? super Density, ? super int[], Unit> arrangement, final float arrangementSpacing, final SizeMode crossAxisSize, final CrossAxisAlignment crossAxisAlignment) {
        ...
        return new MeasurePolicy() { // from class: androidx.compose.foundation.layout.RowColumnImplKt$rowColumnMeasurePolicy$1
            ...
            public MeasureResult mo13measure3p2s80s(final MeasureScope measure, List<? extends Measurable> measurables, long constraints) {
                ...
                final RowColumnMeasureHelperResult measureResult = rowColumnMeasureHelper.m509measureWithoutPlacing_EkL_Y(measure, constraints, 0, measurables.size());
