...
public final class LazyGridSnapLayoutInfoProviderKt {
                ...
                if (!getSingleAxisItems().isEmpty()) {
                    if (getLayoutInfo().getOrientation() == Orientation.Vertical) {
                        ...
                        for (int index$iv$iv = 0; index$iv$iv < size; index$iv$iv++) {
                            ...
                            sum$iv += IntSize.m5375getHeightimpl(it.getSize());
                        }
                    } else {
                        ...
                        for (int index$iv$iv2 = 0; index$iv$iv2 < size2; index$iv$iv2++) {
                            ...
                            sum$iv += IntSize.m5376getWidthimpl(it2.getSize());
                        }
                    }
                    int size3 = sum$iv;
    ...
    public static final int getSingleAxisViewportSize(LazyGridLayoutInfo $this$singleAxisViewportSize) {
        ...
        if ($this$singleAxisViewportSize.getOrientation() == Orientation.Vertical) {
            return IntSize.m5375getHeightimpl($this$singleAxisViewportSize.mo596getViewportSizeYbymL2g());
        }
        return IntSize.m5376getWidthimpl($this$singleAxisViewportSize.mo596getViewportSizeYbymL2g());
    }
    ...
    public static final int sizeOnMainAxis(LazyGridItemInfo $this$sizeOnMainAxis, Orientation orientation) {
        ...
        if (orientation == Orientation.Vertical) {
            return IntSize.m5375getHeightimpl($this$sizeOnMainAxis.getSize());
        }
        return IntSize.m5376getWidthimpl($this$sizeOnMainAxis.getSize());
    }
    ...
    public static final int offsetOnMainAxis(LazyGridItemInfo $this$offsetOnMainAxis, Orientation orientation) {
        ...
        Intrinsics.checkNotNullParameter(orientation, "orientation");
        if (orientation == Orientation.Vertical) {
            return IntOffset.m5335getYimpl($this$offsetOnMainAxis.getOffset());
        }
        return IntOffset.m5334getXimpl($this$offsetOnMainAxis.getOffset());
    }
}
