...
public final class AndroidSelectionHandles_androidKt {
    ...
    public static final void m872SelectionHandle8fL75g(final long position, final boolean isStartHandle, final ResolvedTextDirection direction, final boolean handlesCrossed, final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        ...
        if ((374491 & $dirty2) != 74898 || !$composer3.getSkipping()) {
            ...
            $composer2 = $composer3;
            m871HandlePopupULxng0E(position, handleReferencePoint, ComposableLambdaKt.composableLambda($composer3, 732099485, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$SelectionHandle$1
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$SelectionHandle$2
            ...
            public final void invoke(Composer composer, int i) {
                AndroidSelectionHandles_androidKt.m872SelectionHandle8fL75g(position, isStartHandle, direction, handlesCrossed, modifier, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
    ...
    public static final void DefaultSelectionHandle(final Modifier modifier, final boolean isStartHandle, final ResolvedTextDirection direction, final boolean handlesCrossed, Composer $composer, final int $changed) {
        ...
        if (($dirty & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            SpacerKt.Spacer(drawSelectionHandle(SizeKt.m531sizeVpY3zN4(modifier, SelectionHandlesKt.getHandleWidth(), SelectionHandlesKt.getHandleHeight()), isStartHandle, direction, handlesCrossed), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
                            ...
                            return drawWithCache.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$drawSelectionHandle$1$1$1.1
                                ...
                                public final void invoke2(ContentDrawScope onDrawWithContent) {
                                    ...
                                    if (isLeft) {
                                        ...
                                        long pivot$iv = $this$scale_u2dFgt4K4Q_u24default$iv.mo3489getCenterF1C5BW0();
                                        ...
                                        $this$scale_Fgt4K4Q_u24lambda_u242$iv.mo3422scale0AR0LA0(-1.0f, 1.0f, pivot$iv);
                                        DrawScope.m3475drawImagegbVJVH8$default($this$scale_u2dFgt4K4Q_u24default$iv, imageBitmap, 0L, 0.0f, null, colorFilter2, 0, 46, null);
                                        $this$withTransform_u24lambda_u246$iv$iv.getCanvas().restore();
                                        $this$withTransform_u24lambda_u246$iv$iv.mo3416setSizeuvyYCjk(previousSize$iv$iv);
                                        return;
                                    }
                                    DrawScope.m3475drawImagegbVJVH8$default(onDrawWithContent, handleImage, 0L, 0.0f, null, colorFilter, 0, 46, null);
                                }
                            });
                        }
                    };
    ...
    public static final ImageBitmap createHandleImage(CacheDrawScope $this$createHandleImage, float radius) {
        ...
        if (imageBitmap2 == null || canvas2 == null || edge > imageBitmap2.getWidth() || edge > imageBitmap2.getHeight()) {
            ImageBitmap imageBitmap3 = ImageBitmapKt.m3169ImageBitmapx__hDU$default(edge, edge, ImageBitmapConfig.INSTANCE.m3163getAlpha8_sVssgQ(), false, null, 24, null);
        ...
        $this$draw_yzxVdVo_u24lambda_u240$iv.m3414setSizeuvyYCjk(size$iv);
        canvas.save();
        CanvasDrawScope $this$createHandleImage_u24lambda_u240 = this_$iv;
        DrawScope.m3485drawRectnJ9OG0$default($this$createHandleImage_u24lambda_u240, Color.INSTANCE.m2973getBlack0d7_KjU(), 0L, $this$createHandleImage_u24lambda_u240.mo3490getSizeNHjbRc(), 0.0f, null, null, BlendMode.INSTANCE.m2864getClear0nO6VwU(), 58, null);
        DrawScope.m3485drawRectnJ9OG0$default($this$createHandleImage_u24lambda_u240, ColorKt.Color(4278190080L), Offset.INSTANCE.m2724getZeroF1C5BW0(), androidx.compose.ui.geometry.SizeKt.Size(radius, radius), 0.0f, null, null, 0, 120, null);
        DrawScope.m3472drawCircleVaOC9Bg$default($this$createHandleImage_u24lambda_u240, ColorKt.Color(4278190080L), radius, OffsetKt.Offset(radius, radius), 0.0f, null, null, 0, 120, null);
        canvas.restore();
