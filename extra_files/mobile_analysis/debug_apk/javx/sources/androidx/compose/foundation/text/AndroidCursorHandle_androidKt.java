...
public final class AndroidCursorHandle_androidKt {
    private static final float CursorHandleHeight = Dp.m5216constructorimpl(25);
    private static final float CursorHandleWidth;
    private static final float Sqrt2 = 1.4142135f;

    static {
        float arg0$iv = CursorHandleHeight;
        CursorHandleWidth = Dp.m5216constructorimpl(Dp.m5216constructorimpl(arg0$iv * 2.0f) / 2.4142137f);
    }
    ...
    public static final void m738CursorHandleULxng0E(final long handlePosition, final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        ...
        if (($dirty2 & 731) != 146 || !$composer2.getSkipping()) {
            ...
            AndroidSelectionHandles_androidKt.m871HandlePopupULxng0E(handlePosition, HandleReferencePoint.TopMiddle, ComposableLambdaKt.composableLambda($composer2, -1458480226, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$CursorHandle$1
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$CursorHandle$2
            ...
            public final void invoke(Composer composer, int i) {
                AndroidCursorHandle_androidKt.m738CursorHandleULxng0E(handlePosition, modifier, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
    ...
    public static final void DefaultCursorHandle(final Modifier modifier, Composer $composer, final int $changed) {
        ...
        if (($dirty & 11) != 2 || !$composer2.getSkipping()) {
            ...
            SpacerKt.Spacer(drawCursorHandle(SizeKt.m531sizeVpY3zN4(modifier, CursorHandleWidth, CursorHandleHeight)), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
                        ...
                        public final DrawResult invoke(CacheDrawScope drawWithCache) {
                            ...
                            return drawWithCache.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$drawCursorHandle$1$1$1.1
                                ...
                                public final void invoke2(ContentDrawScope onDrawWithContent) {
                                    ...
                                    $this$invoke_u24lambda_u240.mo3421rotateUv8p0NA(45.0f, Offset.INSTANCE.m2724getZeroF1C5BW0());
                                    DrawScope.m3475drawImagegbVJVH8$default($this$withTransform$iv, imageBitmap2, 0L, 0.0f, null, colorFilter2, 0, 46, null);
