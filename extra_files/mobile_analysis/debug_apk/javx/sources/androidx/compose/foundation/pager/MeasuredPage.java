    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        while (i3 < size) {
            ...
            if (!this.reverseLayout) {
                ...
                if (this.isVertical) {
                    mainAxisOffset = IntOffset.m5334getXimpl(offset);
                    i = i2;
                } else {
                    int mainAxisOffset2 = IntOffset.m5334getXimpl(offset);
                    i = i2;
                    mainAxisOffset = (this.mainAxisLayoutSize - mainAxisOffset2) - getMainAxisSize(placeable);
                }
                if (this.isVertical) {
                    int mainAxisOffset3 = IntOffset.m5335getYimpl(offset);
                    m5335getYimpl = (this.mainAxisLayoutSize - mainAxisOffset3) - getMainAxisSize(placeable);
                } else {
                    m5335getYimpl = IntOffset.m5335getYimpl(offset);
                }
                offset = IntOffsetKt.IntOffset(mainAxisOffset, m5335getYimpl);
            }
            long other$iv = this.visualOffset;
            long other$iv2 = IntOffsetKt.IntOffset(IntOffset.m5334getXimpl(offset) + IntOffset.m5334getXimpl(other$iv), IntOffset.m5335getYimpl(offset) + IntOffset.m5335getYimpl(other$iv));
            if (this.isVertical) {
                Placeable.PlacementScope.m4244placeWithLayeraW9wM$default(scope, placeable, other$iv2, 0.0f, null, 6, null);
            } else {
                Placeable.PlacementScope.m4243placeRelativeWithLayeraW9wM$default(scope, placeable, other$iv2, 0.0f, null, 6, null);
            }
            i3++;
            i2 = i;
        }
