...
final class MarqueeModifierNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, FocusEventModifierNode {
    ...
    public final void m241updatelWfNwf4(int iterations, int animationMode, int delayMillis, int initialDelayMillis, MarqueeSpacing spacing, float velocity) {
        ...
        if (this.iterations != iterations || this.delayMillis != delayMillis || this.initialDelayMillis != initialDelayMillis || !Dp.m5221equalsimpl0(this.velocity, velocity)) {
            this.iterations = iterations;
            this.delayMillis = delayMillis;
            this.initialDelayMillis = initialDelayMillis;
            this.velocity = velocity;
    ...
    public MeasureResult mo239measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        childConstraints = Constraints.m5162copyZbe2FdA(constraints, (r12 & 1) != 0 ? Constraints.m5174getMinWidthimpl(constraints) : 0, (r12 & 2) != 0 ? Constraints.m5172getMaxWidthimpl(constraints) : Integer.MAX_VALUE, (r12 & 4) != 0 ? Constraints.m5173getMinHeightimpl(constraints) : 0, (r12 & 8) != 0 ? Constraints.m5171getMaxHeightimpl(constraints) : 0);
        final Placeable placeable = measurable.mo4184measureBRTryo0(childConstraints);
        setContainerWidth(ConstraintsKt.m5186constrainWidthK40F9xA(constraints, placeable.getWidth()));
    ...
    public void draw(ContentDrawScope $this$draw) {
        ...
        float bottom$iv = Size.m2774getHeightimpl($this$clipRect_u2drOu3jXo_u24default$iv.mo3490getSizeNHjbRc());
        ...
        $this$clipRect_rOu3jXo_u24lambda_u244$iv.mo3418clipRectN_I0leg(clipOffset, 0.0f, right$iv, bottom$iv, clipOp$iv);
        if (firstCopyVisible) {
