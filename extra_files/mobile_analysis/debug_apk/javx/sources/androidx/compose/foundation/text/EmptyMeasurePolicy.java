...
final class EmptyMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo13measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long constraints) {
        ...
        return MeasureScope.layout$default(measure, Constraints.m5172getMaxWidthimpl(constraints), Constraints.m5171getMaxHeightimpl(constraints), null, placementBlock, 4, null);
    }
}
