...
final class ParentSizeNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo239measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        int height = i2;
        long childConstraints = ConstraintsKt.Constraints(width != Integer.MAX_VALUE ? width : Constraints.m5174getMinWidthimpl(constraints), width != Integer.MAX_VALUE ? width : Constraints.m5172getMaxWidthimpl(constraints), height != Integer.MAX_VALUE ? height : Constraints.m5173getMinHeightimpl(constraints), height != Integer.MAX_VALUE ? height : Constraints.m5171getMaxHeightimpl(constraints));
