...
public final class LazyListMeasureKt {
    ...
    public static final LazyListMeasureResult m589measureLazyListCD5nmq0(int itemsCount, LazyListMeasuredItemProvider measuredItemProvider, int mainAxisAvailableSize, int beforeContentPadding, int afterContentPadding, int spaceBetweenItems, int firstVisibleItemIndex, int firstVisibleItemScrollOffset, float scrollToBeConsumed, long constraints, boolean isVertical, List<Integer> headerIndexes, Arrangement.Vertical verticalArrangement, Arrangement.Horizontal horizontalArrangement, boolean reverseLayout, Density density, LazyListItemPlacementAnimator placementAnimator, int beyondBoundsItemCount, List<Integer> pinnedItems, Function3<? super Integer, ? super Integer, ? super Function1<? super Placeable.PlacementScope, Unit>, ? extends MeasureResult> layout) {
        ...
        if (itemsCount <= 0) {
            return new LazyListMeasureResult(null, 0, false, 0.0f, layout.invoke(Integer.valueOf(Constraints.m5174getMinWidthimpl(constraints)), Integer.valueOf(Constraints.m5173getMinHeightimpl(constraints)), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.LazyListMeasureKt$measureLazyList$1
        ...
        int layoutWidth = ConstraintsKt.m5186constrainWidthK40F9xA(constraints, isVertical ? maxCrossAxis8 : maxCrossAxis2);
        int layoutHeight = ConstraintsKt.m5185constrainHeightK40F9xA(constraints, isVertical ? maxCrossAxis2 : maxCrossAxis8);
