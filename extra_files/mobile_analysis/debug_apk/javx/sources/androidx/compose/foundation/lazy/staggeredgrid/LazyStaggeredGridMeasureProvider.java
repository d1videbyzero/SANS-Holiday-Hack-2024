...
public abstract class LazyStaggeredGridMeasureProvider {
    ...
    private final long m669childConstraintsJhjzzOo(int requestedSlot, int requestedSpan) {
        ...
        if (this.isVertical) {
            return Constraints.INSTANCE.m5182fixedWidthOenEA2s(end);
        }
        return Constraints.INSTANCE.m5181fixedHeightOenEA2s(end);
    }
    ...
    public final LazyStaggeredGridMeasuredItem m670getAndMeasurejy6DScQ(int index, long span) {
        ...
        List placeables = this.measureScope.mo640measure0kLqBqw(index, m669childConstraintsJhjzzOo((int) (span >> 32), $i$f$unpackInt2 - ((int) (span >> 32))));
