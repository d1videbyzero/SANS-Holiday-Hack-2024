...
public class StaticTextSelectionParams {
    ...
    public boolean getShouldClip() {
        ...
        TextLayoutResult textLayoutResult = this.textLayoutResult;
        TextOverflow m5125boximpl = (textLayoutResult == null || (layoutInput = textLayoutResult.getLayoutInput()) == null) ? null : TextOverflow.m5125boximpl(layoutInput.getOverflow());
        int m5137getVisiblegIe3tQ8 = TextOverflow.INSTANCE.m5137getVisiblegIe3tQ8();
        if (m5125boximpl == null) {
            return false;
        }
        return TextOverflow.m5128equalsimpl0(m5125boximpl.getValue(), m5137getVisiblegIe3tQ8);
    }
