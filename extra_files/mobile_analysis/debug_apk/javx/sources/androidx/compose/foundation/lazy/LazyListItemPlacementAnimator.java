...
public final class LazyListItemPlacementAnimator {
    ...
    */
    ...
    private final void initializeNode(LazyListMeasuredItem item, int mainAxisOffset) {
        ...
        int i = 0;
        long firstPlaceableOffset = lazyListMeasuredItem.m592getOffsetBjo55l4(0);
        ...
        while (i < placeablesCount) {
            ...
            if (it$iv != null) {
                long arg0$iv = lazyListMeasuredItem.m592getOffsetBjo55l4(index$iv);
                $this$forEachNode$iv = $this$forEachNode$iv2;
                long arg0$iv2 = IntOffsetKt.IntOffset(IntOffset.m5334getXimpl(arg0$iv) - IntOffset.m5334getXimpl(firstPlaceableOffset), IntOffset.m5335getYimpl(arg0$iv) - IntOffset.m5335getYimpl(firstPlaceableOffset));
                targetFirstPlaceableOffset2 = targetFirstPlaceableOffset;
                long targetFirstPlaceableOffset3 = IntOffsetKt.IntOffset(IntOffset.m5334getXimpl(targetFirstPlaceableOffset) + IntOffset.m5334getXimpl(arg0$iv2), IntOffset.m5335getYimpl(targetFirstPlaceableOffset) + IntOffset.m5335getYimpl(arg0$iv2));
                it$iv.m629setRawOffsetgyyYBs(targetFirstPlaceableOffset3);
            } else {
                targetFirstPlaceableOffset2 = targetFirstPlaceableOffset;
                $this$forEachNode$iv = $this$forEachNode$iv2;
            }
    ...
    private final void startAnimationsIfNeeded(LazyListMeasuredItem item) {
        ...
        while (i2 < placeablesCount) {
            ...
            if (it$iv != null) {
                long newTarget = item.m592getOffsetBjo55l4(index$iv);
                $this$forEachNode$iv = $this$forEachNode$iv2;
                this_$iv = this_$iv2;
                ...
                if (!IntOffset.m5333equalsimpl0(currentTarget, LazyLayoutAnimateItemModifierNode.INSTANCE.m630getNotInitializednOccac()) && !IntOffset.m5333equalsimpl0(currentTarget, newTarget)) {
                    it$iv.m626animatePlacementDeltagyyYBs(IntOffsetKt.IntOffset(IntOffset.m5334getXimpl(newTarget) - IntOffset.m5334getXimpl(currentTarget), IntOffset.m5335getYimpl(newTarget) - IntOffset.m5335getYimpl(currentTarget)));
                }
                it$iv.m629setRawOffsetgyyYBs(newTarget);
            } else {
                $this$forEachNode$iv = $this$forEachNode$iv2;
                this_$iv = this_$iv2;
                $i$f$forEachNode = $i$f$forEachNode2;
