...
final class BackgroundNode extends Modifier.Node implements DrawModifierNode {
    ...
    private final void drawRect(ContentDrawScope $this$drawRect) {
        if (!Color.m2948equalsimpl0(this.color, Color.INSTANCE.m2983getUnspecified0d7_KjU())) {
            DrawScope.m3485drawRectnJ9OG0$default($this$drawRect, this.color, 0L, 0L, 0.0f, null, null, 0, 126, null);
        }
        Brush it = this.brush;
        if (it != null) {
            DrawScope.m3484drawRectAsUm42w$default($this$drawRect, it, 0L, 0L, this.alpha, null, null, 0, 118, null);
        }
    }

    private final void drawOutline(ContentDrawScope $this$drawOutline) {
        Outline outline;
        if (Size.m2772equalsimpl($this$drawOutline.mo3490getSizeNHjbRc(), this.lastSize) && $this$drawOutline.getLayoutDirection() == this.lastLayoutDirection && Intrinsics.areEqual(this.lastShape, this.shape)) {
            outline = this.lastOutline;
            Intrinsics.checkNotNull(outline);
        } else {
            outline = this.shape.mo210createOutlinePq9zytI($this$drawOutline.mo3490getSizeNHjbRc(), $this$drawOutline.getLayoutDirection(), $this$drawOutline);
        }
        if (!Color.m2948equalsimpl0(this.color, Color.INSTANCE.m2983getUnspecified0d7_KjU())) {
            OutlineKt.m3199drawOutlinewDX37Ww($this$drawOutline, outline, this.color, (r17 & 4) != 0 ? 1.0f : 0.0f, (r17 & 8) != 0 ? Fill.INSTANCE : null, (r17 & 16) != 0 ? null : null, (r17 & 32) != 0 ? DrawScope.INSTANCE.m3491getDefaultBlendMode0nO6VwU() : 0);
        }
        Brush it = this.brush;
        if (it != null) {
            OutlineKt.m3197drawOutlinehn5TExg($this$drawOutline, outline, it, (r14 & 4) != 0 ? 1.0f : this.alpha, (r14 & 8) != 0 ? Fill.INSTANCE : null, (r14 & 16) != 0 ? null : null, (r14 & 32) != 0 ? DrawScope.INSTANCE.m3491getDefaultBlendMode0nO6VwU() : 0);
        }
        this.lastOutline = outline;
        this.lastSize = Size.m2765boximpl($this$drawOutline.mo3490getSizeNHjbRc());
