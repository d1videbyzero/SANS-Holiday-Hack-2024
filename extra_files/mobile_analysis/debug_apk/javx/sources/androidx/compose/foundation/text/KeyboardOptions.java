...
public final class KeyboardOptions {
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m4909getNoneIUNYP9k() : i, (i4 & 2) != 0 ? true : z, (i4 & 4) != 0 ? KeyboardType.INSTANCE.m4935getTextPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.INSTANCE.m4882getDefaulteUduSuo() : i3, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof KeyboardOptions) && KeyboardCapitalization.m4900equalsimpl0(this.capitalization, ((KeyboardOptions) other).capitalization) && this.autoCorrect == ((KeyboardOptions) other).autoCorrect && KeyboardType.m4915equalsimpl0(this.keyboardType, ((KeyboardOptions) other).keyboardType) && ImeAction.m4870equalsimpl0(this.imeAction, ((KeyboardOptions) other).imeAction);
    }

    public int hashCode() {
        int result = KeyboardCapitalization.m4901hashCodeimpl(this.capitalization);
        return (((((result * 31) + Boolean.hashCode(this.autoCorrect)) * 31) + KeyboardType.m4916hashCodeimpl(this.keyboardType)) * 31) + ImeAction.m4871hashCodeimpl(this.imeAction);
    }

    public String toString() {
        return "KeyboardOptions(capitalization=" + ((Object) KeyboardCapitalization.m4902toStringimpl(this.capitalization)) + ", autoCorrect=" + this.autoCorrect + ", keyboardType=" + ((Object) KeyboardType.m4917toStringimpl(this.keyboardType)) + ", imeAction=" + ((Object) ImeAction.m4872toStringimpl(this.imeAction)) + ')';
    }
}
