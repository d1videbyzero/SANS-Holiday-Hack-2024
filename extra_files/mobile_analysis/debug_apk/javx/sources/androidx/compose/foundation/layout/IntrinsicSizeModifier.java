...
interface IntrinsicSizeModifier extends LayoutModifier {
    ...
    default MeasureResult mo39measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        Intrinsics.checkNotNullParameter(measure, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        long contentConstraints = mo436calculateContentConstraintsl58MMJ0(measure, measurable, constraints);
        final Placeable placeable = measurable.mo4184measureBRTryo0(getEnforceIncoming() ? ConstraintsKt.m5184constrainN9IONVI(constraints, contentConstraints) : contentConstraints);
        return MeasureScope.layout$default(measure, placeable.getWidth(), placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.IntrinsicSizeModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.m4242placeRelative70tqf50$default(layout, Placeable.this, IntOffset.INSTANCE.m5344getZeronOccac(), 0.0f, 2, null);
            }
        }, 4, null);
    }
