...
public final class BorderKt {
    ...
    public static final Modifier border(Modifier $this$border, BorderStroke border, Shape shape) {
        ...
        return m174borderziNgDLE($this$border, border.getWidth(), border.getBrush(), shape);
    }
    ...
    public static final Modifier m172borderxT4_qwU(Modifier border, float width, long color, Shape shape) {
        Intrinsics.checkNotNullParameter(border, "$this$border");
        Intrinsics.checkNotNullParameter(shape, "shape");
        return m174borderziNgDLE(border, width, new SolidColor(color, null), shape);
    }

    /* renamed from: border-ziNgDLE, reason: not valid java name */
    public static final Modifier m174borderziNgDLE(Modifier border, float width, Brush brush, Shape shape) {
        Intrinsics.checkNotNullParameter(border, "$this$border");
    ...
    public static final DrawResult m175drawRectBorderNsqcLGU(CacheDrawScope $this$drawRectBorder_u2dNsqcLGU, final Brush brush, long topLeft, long borderSize, boolean fillArea, float strokeWidthPx) {
        ...
        return $this$drawRectBorder_u2dNsqcLGU.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.BorderKt$drawRectBorder$1
            ...
            public final void invoke2(ContentDrawScope onDrawWithContent) {
                Intrinsics.checkNotNullParameter(onDrawWithContent, "$this$onDrawWithContent");
                onDrawWithContent.drawContent();
                DrawScope.m3484drawRectAsUm42w$default(onDrawWithContent, Brush.this, rectTopLeft, size, 0.0f, style, null, 0, LocationRequestCompat.QUALITY_LOW_POWER, null);
            }
        });
    }
    ...
    public static final Path createRoundRectPath(Path targetPath, RoundRect roundedRect, float strokeWidth, boolean fillArea) {
        ...
        if (!fillArea) {
            ...
            targetPath.mo2841opN5in7k0(targetPath, insetPath, PathOperation.INSTANCE.m3232getDifferenceb3I0S0c());
        }
        return targetPath;
    }

    private static final RoundRect createInsetRoundedRect(float widthPx, RoundRect roundedRect) {
        return new RoundRect(widthPx, widthPx, roundedRect.getWidth() - widthPx, roundedRect.getHeight() - widthPx, m176shrinkKibmq7A(roundedRect.m2758getTopLeftCornerRadiuskKHJgLs(), widthPx), m176shrinkKibmq7A(roundedRect.m2759getTopRightCornerRadiuskKHJgLs(), widthPx), m176shrinkKibmq7A(roundedRect.m2757getBottomRightCornerRadiuskKHJgLs(), widthPx), m176shrinkKibmq7A(roundedRect.m2756getBottomLeftCornerRadiuskKHJgLs(), widthPx), null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: shrink-Kibmq7A, reason: not valid java name */
    public static final long m176shrinkKibmq7A(long $this$shrink_u2dKibmq7A, float value) {
