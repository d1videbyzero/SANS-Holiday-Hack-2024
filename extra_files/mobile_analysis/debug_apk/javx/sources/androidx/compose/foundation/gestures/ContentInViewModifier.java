...
public final class ContentInViewModifier implements BringIntoViewResponder, OnRemeasuredModifier, OnPlacedModifier {
    ...
    public ContentInViewModifier(CoroutineScope scope, Orientation orientation, ScrollableState scrollState, boolean reverseDirection) {
        ...
        this.viewportSize = IntSize.INSTANCE.m5381getZeroYbymL2g();
    ...
    public Rect calculateRectForParent(Rect localRect) {
        ...
        if (!(!IntSize.m5374equalsimpl0(this.viewportSize, IntSize.INSTANCE.m5381getZeroYbymL2g()))) {
    ...
    public final float calculateScrollDelta() {
        ...
        long size = IntSizeKt.m5386toSizeozmzZPI(this.viewportSize);
        ...
        if (size$iv$iv > 0) {
            ...
            while (true) {
                ...
                if (bounds != null) {
                    ...
                    if (m247compareToiLBOSCw(bounds.m2741getSizeNHjbRc(), IntSizeKt.m5386toSizeozmzZPI(this.viewportSize)) <= 0) {
                        rect = bounds;
                    } else {
                        return rect;
                    }
    ...
    private final Rect m248computeDestinationO0kMr_c(Rect childBounds, long containerSize) {
        return childBounds.m2745translatek4lQ0M(Offset.m2717unaryMinusF1C5BW0(m251relocationOffsetBMxPBkI(childBounds, containerSize)));
    }
    ...
    private final boolean m249isMaxVisibleO0kMr_c(Rect $this$isMaxVisible_u2dO0kMr_c, long size) {
        return Offset.m2705equalsimpl0(m251relocationOffsetBMxPBkI($this$isMaxVisible_u2dO0kMr_c, size), Offset.INSTANCE.m2724getZeroF1C5BW0());
    }

    /* renamed from: relocationOffset-BMxPBkI, reason: not valid java name */
    private final long m251relocationOffsetBMxPBkI(Rect childBounds, long containerSize) {
        long size = IntSizeKt.m5386toSizeozmzZPI(containerSize);
        switch (WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()]) {
            case 1:
    ...
    private final int m246compareToTemP2vQ(long $this$compareTo_u2dTemP2vQ, long other) {
        switch (WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()]) {
            case 1:
                return Intrinsics.compare(IntSize.m5375getHeightimpl($this$compareTo_u2dTemP2vQ), IntSize.m5375getHeightimpl(other));
            case 2:
                return Intrinsics.compare(IntSize.m5376getWidthimpl($this$compareTo_u2dTemP2vQ), IntSize.m5376getWidthimpl(other));
            default:
                throw new NoWhenBranchMatchedException();
        }
    }
