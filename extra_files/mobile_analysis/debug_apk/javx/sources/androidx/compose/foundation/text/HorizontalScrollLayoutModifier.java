...
final /* data */ class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo39measure3p2s80s(final MeasureScope measure, Measurable measurable, long constraints) {
        long m5162copyZbe2FdA;
        Intrinsics.checkNotNullParameter(measure, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        int maxIntrinsicWidth = measurable.maxIntrinsicWidth(Constraints.m5171getMaxHeightimpl(constraints));
        if (maxIntrinsicWidth >= Constraints.m5172getMaxWidthimpl(constraints)) {
            m5162copyZbe2FdA = Constraints.m5162copyZbe2FdA(constraints, (r12 & 1) != 0 ? Constraints.m5174getMinWidthimpl(constraints) : 0, (r12 & 2) != 0 ? Constraints.m5172getMaxWidthimpl(constraints) : Integer.MAX_VALUE, (r12 & 4) != 0 ? Constraints.m5173getMinHeightimpl(constraints) : 0, (r12 & 8) != 0 ? Constraints.m5171getMaxHeightimpl(constraints) : 0);
        } else {
            m5162copyZbe2FdA = constraints;
        }
        long childConstraints = m5162copyZbe2FdA;
        final Placeable placeable = measurable.mo4184measureBRTryo0(childConstraints);
        final int width = Math.min(placeable.getWidth(), Constraints.m5172getMaxWidthimpl(constraints));
