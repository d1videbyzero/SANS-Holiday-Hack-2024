...
public final class FlowLayoutKt {
    ...
    public static final void FlowRow(Modifier modifier, Arrangement.Horizontal horizontalArrangement, Arrangement.Vertical verticalArrangement, int maxItemsInEachRow, Function3<? super FlowRowScope, ? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i) {
        ...
        if (!$this$Layout_u24lambda_u240$iv.getInserting() && Intrinsics.areEqual($this$Layout_u24lambda_u240$iv.rememberedValue(), Integer.valueOf(compositeKeyHash$iv))) {
            skippableUpdate$iv$iv.invoke(SkippableUpdater.m2572boximpl(SkippableUpdater.m2573constructorimpl($composer)), $composer, Integer.valueOf(($changed$iv$iv >> 3) & 112));
    ...
    public static final MeasurePolicy rowMeasurementHelper(Arrangement.Horizontal horizontalArrangement, Arrangement.Vertical verticalArrangement, int maxItemsInMainAxis, Composer $composer, int $changed) {
        ...
        if (invalid$iv$iv || it$iv$iv == Composer.INSTANCE.getEmpty()) {
            value$iv$iv = m430flowMeasurePolicybs7tms(LayoutOrientation.Horizontal, getHorizontalArrangement(horizontalArrangement), horizontalArrangement.getSpacing(), SizeMode.Wrap, CROSS_AXIS_ALIGNMENT_TOP, getVerticalArrangement(verticalArrangement), verticalArrangement.getSpacing(), maxItemsInMainAxis);
    ...
    public static final MeasurePolicy columnMeasurementHelper(Arrangement.Vertical verticalArrangement, Arrangement.Horizontal horizontalArrangement, int maxItemsInMainAxis, Composer $composer, int $changed) {
        ...
        Object it$iv$iv = $composer.rememberedValue();
        if (invalid$iv$iv || it$iv$iv == Composer.INSTANCE.getEmpty()) {
            value$iv$iv = m430flowMeasurePolicybs7tms(LayoutOrientation.Vertical, getVerticalArrangement(verticalArrangement), verticalArrangement.getSpacing(), SizeMode.Wrap, CROSS_AXIS_ALIGNMENT_START, getHorizontalArrangement(horizontalArrangement), horizontalArrangement.getSpacing(), maxItemsInMainAxis);
            $composer.updateRememberedValue(value$iv$iv);
        } else {
            value$iv$iv = it$iv$iv;
        }
    ...
    public static final MeasurePolicy m430flowMeasurePolicybs7tms(final LayoutOrientation orientation, final Function5<? super Integer, ? super int[], ? super LayoutDirection, ? super Density, ? super int[], Unit> function5, final float mainAxisArrangementSpacing, final SizeMode crossAxisSize, final CrossAxisAlignment crossAxisAlignment, final Function5<? super Integer, ? super int[], ? super LayoutDirection, ? super Density, ? super int[], Unit> function52, final float crossAxisArrangementSpacing, final int maxItemsInMainAxis) {
        return new MeasurePolicy(function5, mainAxisArrangementSpacing, crossAxisSize, crossAxisAlignment, maxItemsInMainAxis, crossAxisArrangementSpacing, function52) { // from class: androidx.compose.foundation.layout.FlowLayoutKt$flowMeasurePolicy$1
            ...
            public MeasureResult mo13measure3p2s80s(final MeasureScope measure, List<? extends Measurable> measurables, long constraints) {
                int layoutWidth;
                int layoutHeight;
                ...
                long orientationIndependentConstraints = OrientationIndependentConstraints.m451constructorimpl(constraints, LayoutOrientation.this);
                final FlowResult flowResult = FlowLayoutKt.m429breakDownItemsw1Onq5I(measure, measureHelper, LayoutOrientation.this, orientationIndependentConstraints, this.$maxItemsInMainAxis);
                ...
                return MeasureScope.layout$default(measure, ConstraintsKt.m5186constrainWidthK40F9xA(constraints, layoutWidth), ConstraintsKt.m5185constrainHeightK40F9xA(constraints, layoutHeight), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutKt$flowMeasurePolicy$1$measure$2
    ...
    public static final FlowResult m429breakDownItemsw1Onq5I(MeasureScope breakDownItems, RowColumnMeasurementHelper measureHelper, LayoutOrientation orientation, long constraints, int maxItemsInMainAxis) {
        long m452copyyUG9Ft0;
        int mainAxisMin;
        Integer nextSize;
        ...
        int mainAxisMin2 = Constraints.m5174getMinWidthimpl(constraints);
        int crossAxisMax = Constraints.m5171getMaxHeightimpl(constraints);
        ...
        long subsetConstraints = OrientationIndependentConstraints.m449constructorimpl(mainAxisMin2, m5172getMaxWidthimpl, 0, crossAxisMax);
        Measurable measurable = (Measurable) CollectionsKt.getOrNull(measurables, 0);
        Integer nextSize2 = measurable != null ? Integer.valueOf(m431measureAndCache6m2dt9o(measurable, subsetConstraints, orientation, new Function1<Placeable, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutKt$breakDownItems$nextSize$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
        ...
        int leftOver = m5172getMaxWidthimpl;
        ...
        while (index < size) {
            ...
            if (measurable2 != null) {
                ...
                nextSize = Integer.valueOf(m431measureAndCache6m2dt9o(measurable2, subsetConstraints, orientation, new Function1<Placeable, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutKt$breakDownItems$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
            ...
            mainAxisTotalSize = Math.min(Math.max(mainAxisTotalSize, currentLineMainAxisSize2), m5172getMaxWidthimpl);
            ...
            leftOver = m5172getMaxWidthimpl;
            index++;
            size = i;
            mainAxisMin2 = mainAxisMin;
            crossAxisMax = crossAxisMax2;
        }
        m452copyyUG9Ft0 = OrientationIndependentConstraints.m452copyyUG9Ft0(subsetConstraints, (r12 & 1) != 0 ? Constraints.m5174getMinWidthimpl(subsetConstraints) : mainAxisTotalSize, (r12 & 2) != 0 ? Constraints.m5172getMaxWidthimpl(subsetConstraints) : 0, (r12 & 4) != 0 ? Constraints.m5173getMinHeightimpl(subsetConstraints) : 0, (r12 & 8) != 0 ? Constraints.m5171getMaxHeightimpl(subsetConstraints) : 0);
        long subsetBoxConstraints = OrientationIndependentConstraints.m464toBoxConstraintsOenEA2s(m452copyyUG9Ft0, orientation);
        ...
        while (endIndex != null) {
            ...
            RowColumnMeasureHelperResult result = measureHelper.m509measureWithoutPlacing_EkL_Y(breakDownItems, subsetBoxConstraints, startBreakLineIndex2, endIndex.intValue());
        ...
        return new FlowResult(Math.max(mainAxisTotalSize2, Constraints.m5174getMinWidthimpl(constraints)), Math.max(crossAxisTotalSize, Constraints.m5173getMinHeightimpl(constraints)), items);
    }
    ...
    private static final int m431measureAndCache6m2dt9o(Measurable $this$measureAndCache_u2d6m2dt9o, long constraints, LayoutOrientation orientation, Function1<? super Placeable, Unit> function1) {
        long m452copyyUG9Ft0;
        ...
        m452copyyUG9Ft0 = OrientationIndependentConstraints.m452copyyUG9Ft0(constraints, (r12 & 1) != 0 ? Constraints.m5174getMinWidthimpl(constraints) : 0, (r12 & 2) != 0 ? Constraints.m5172getMaxWidthimpl(constraints) : 0, (r12 & 4) != 0 ? Constraints.m5173getMinHeightimpl(constraints) : 0, (r12 & 8) != 0 ? Constraints.m5171getMaxHeightimpl(constraints) : 0);
        Placeable placeable = $this$measureAndCache_u2d6m2dt9o.mo4184measureBRTryo0(OrientationIndependentConstraints.m464toBoxConstraintsOenEA2s(m452copyyUG9Ft0, orientation));
