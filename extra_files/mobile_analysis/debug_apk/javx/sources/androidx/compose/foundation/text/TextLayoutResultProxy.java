...
public final class TextLayoutResultProxy {
    ...
    public final int m837getOffsetForPosition3MmeM6k(long position, boolean coerceInVisibleBounds) {
        ...
        if (coerceInVisibleBounds) {
            it = m834coercedInVisibleBoundsOfInputTextMKHz9U(it);
        }
        long relativePosition = m836relativeToInputTextMKHz9U(it);
        return this.value.m4696getOffsetForPositionk4lQ0M(relativePosition);
    }

    public final int getLineForVerticalPosition(float vertical) {
        float relativeVertical = Offset.m2709getYimpl(m836relativeToInputTextMKHz9U(m834coercedInVisibleBoundsOfInputTextMKHz9U(OffsetKt.Offset(0.0f, vertical))));
    ...
    public final boolean m838isPositionOnTextk4lQ0M(long offset) {
        long relativeOffset = m836relativeToInputTextMKHz9U(m834coercedInVisibleBoundsOfInputTextMKHz9U(offset));
    ...
    private final long m836relativeToInputTextMKHz9U(long $this$relativeToInputText_u2dMK_u2dHz9U) {
        Offset offset;
        long j;
        ...
        if (innerTextFieldCoordinates != null) {
            ...
            if (decorationBoxCoordinates != null) {
                if (innerTextFieldCoordinates.isAttached() && decorationBoxCoordinates.isAttached()) {
                    j = innerTextFieldCoordinates.mo4192localPositionOfR5De75A(decorationBoxCoordinates, $this$relativeToInputText_u2dMK_u2dHz9U);
                } else {
                    j = $this$relativeToInputText_u2dMK_u2dHz9U;
                }
                offset = Offset.m2697boximpl(j);
            } else {
                offset = null;
            }
            if (offset != null) {
    ...
    */
    private final long m834coercedInVisibleBoundsOfInputTextMKHz9U(long r7) {
        /*
            r6 = this;
        ...
        L26:
            r0 = r3
            long r1 = androidx.compose.foundation.text.TextLayoutResultProxyKt.m839access$coerceIn3MmeM6k(r7, r0)
            return r1
        */
