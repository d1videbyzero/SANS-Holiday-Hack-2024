...
final class TextMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo13measure3p2s80s(MeasureScope measure, List<? extends Measurable> list, long constraints) {
        ArrayList arrayList;
        ...
        if ($this$fastMapIndexedNotNull$iv2 == null) {
            ...
            while (index$iv$iv < size) {
                ...
                if (rect != null) {
                    ...
                    pair = new Pair(measurables.get(index$iv).mo4184measureBRTryo0(ConstraintsKt.Constraints$default(0, (int) Math.floor(rect.getWidth()), 0, (int) Math.floor(rect.getHeight()), 5, null)), IntOffset.m5325boximpl(IntOffsetKt.IntOffset(MathKt.roundToInt(rect.getLeft()), MathKt.roundToInt(rect.getTop()))));
                } else {
                    $this$fastMapIndexedNotNull$iv = $this$fastMapIndexedNotNull$iv2;
                    $this$fastForEachIndexed$iv$iv = $this$fastForEachIndexed$iv$iv2;
                    $i$f$fastForEachIndexed = $i$f$fastForEachIndexed2;
        ...
        return MeasureScope.layout$default(measure, Constraints.m5172getMaxWidthimpl(constraints), Constraints.m5171getMaxHeightimpl(constraints), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.TextMeasurePolicy$measure$1
