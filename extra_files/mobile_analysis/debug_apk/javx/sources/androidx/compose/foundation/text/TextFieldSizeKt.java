        ...
        return ComposedModifierKt.composed$default($this$textFieldMinSize, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.TextFieldSizeKt$textFieldMinSize$1
            ...
            public final Modifier invoke(Modifier composed, Composer $composer, int $changed) {
                ...
                if (invalid$iv$iv2 || it$iv$iv2 == Composer.INSTANCE.getEmpty()) {
                    ...
                    FontStyle m4747getFontStyle4Lr2A7w = resolvedStyle.m4747getFontStyle4Lr2A7w();
                    int $changed$iv = m4747getFontStyle4Lr2A7w != null ? m4747getFontStyle4Lr2A7w.m4822unboximpl() : FontStyle.INSTANCE.m4824getNormal_LCdwA();
                    FontSynthesis m4748getFontSynthesisZQGJjVo = resolvedStyle.m4748getFontSynthesisZQGJjVo();
                    int $i$f$remember = m4748getFontSynthesisZQGJjVo != null ? m4748getFontSynthesisZQGJjVo.getValue() : FontSynthesis.INSTANCE.m4834getAllGVVA2EU();
                    value$iv$iv2 = fontFamilyResolver.mo4794resolveDPcqOEQ(fontFamily, fontWeight2, $changed$iv, $i$f$remember);
                ...
                Modifier layout = LayoutModifierKt.layout(Modifier.INSTANCE, new Function3<MeasureScope, Measurable, Constraints, MeasureResult>() { // from class: androidx.compose.foundation.text.TextFieldSizeKt$textFieldMinSize$1.1
                    ...
                    public /* bridge */ /* synthetic */ MeasureResult invoke(MeasureScope measureScope, Measurable measurable, Constraints constraints) {
                        return m828invoke3p2s80s(measureScope, measurable, constraints.getValue());
                    }

                    /* renamed from: invoke-3p2s80s, reason: not valid java name */
                    public final MeasureResult m828invoke3p2s80s(MeasureScope layout2, Measurable measurable, long constraints) {
                        long childConstraints;
                        Intrinsics.checkNotNullParameter(layout2, "$this$layout");
                        Intrinsics.checkNotNullParameter(measurable, "measurable");
                        SizeKt.m514defaultMinSizeVpY3zN4$default(Modifier.INSTANCE, 0.0f, 0.0f, 3, null);
                        long minSize = TextFieldSize.this.getMinSize();
                        childConstraints = Constraints.m5162copyZbe2FdA(constraints, (r12 & 1) != 0 ? Constraints.m5174getMinWidthimpl(constraints) : RangesKt.coerceIn(IntSize.m5376getWidthimpl(minSize), Constraints.m5174getMinWidthimpl(constraints), Constraints.m5172getMaxWidthimpl(constraints)), (r12 & 2) != 0 ? Constraints.m5172getMaxWidthimpl(constraints) : 0, (r12 & 4) != 0 ? Constraints.m5173getMinHeightimpl(constraints) : RangesKt.coerceIn(IntSize.m5375getHeightimpl(minSize), Constraints.m5173getMinHeightimpl(constraints), Constraints.m5171getMaxHeightimpl(constraints)), (r12 & 8) != 0 ? Constraints.m5171getMaxHeightimpl(constraints) : 0);
                        final Placeable measured = measurable.mo4184measureBRTryo0(childConstraints);
