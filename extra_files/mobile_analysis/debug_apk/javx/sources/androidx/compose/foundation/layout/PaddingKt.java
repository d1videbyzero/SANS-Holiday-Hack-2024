...
public final class PaddingKt {
    ...
    public static /* synthetic */ Modifier m486paddingqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m485paddingqDBjuR0(modifier, f, f2, f3, f4);
    }

    /* renamed from: padding-qDBjuR0, reason: not valid java name */
    public static final Modifier m485paddingqDBjuR0(Modifier padding, final float start, final float top, final float end, final float bottom) {
        ...
        return padding.then(new PaddingElement(start, top, end, bottom, true, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.PaddingKt$padding$1
            ...
            public final void invoke2(InspectorInfo $receiver) {
                ...
                $receiver.getProperties().set("start", Dp.m5214boximpl(start));
                $receiver.getProperties().set("top", Dp.m5214boximpl(top));
                $receiver.getProperties().set("end", Dp.m5214boximpl(end));
                $receiver.getProperties().set("bottom", Dp.m5214boximpl(bottom));
            }
        }, null));
    }

    /* renamed from: padding-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m484paddingVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.m5216constructorimpl(0);
        }
        if ((i & 2) != 0) {
        ...
        return m483paddingVpY3zN4(modifier, f, f2);
    }

    /* renamed from: padding-VpY3zN4, reason: not valid java name */
    public static final Modifier m483paddingVpY3zN4(Modifier padding, final float horizontal, final float vertical) {
        Intrinsics.checkNotNullParameter(padding, "$this$padding");
        return padding.then(new PaddingElement(horizontal, vertical, horizontal, vertical, true, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.PaddingKt$padding$2
            ...
            public final void invoke2(InspectorInfo $receiver) {
                Intrinsics.checkNotNullParameter($receiver, "$this$$receiver");
                $receiver.setName("padding");
                $receiver.getProperties().set("horizontal", Dp.m5214boximpl(horizontal));
                $receiver.getProperties().set("vertical", Dp.m5214boximpl(vertical));
            }
        }, null));
    }

    /* renamed from: padding-3ABfNKs, reason: not valid java name */
    public static final Modifier m482padding3ABfNKs(Modifier padding, final float all) {
        Intrinsics.checkNotNullParameter(padding, "$this$padding");
        return padding.then(new PaddingElement(all, all, all, all, true, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.PaddingKt$padding$3
            ...
            public final void invoke2(InspectorInfo $receiver) {
                Intrinsics.checkNotNullParameter($receiver, "$this$$receiver");
                $receiver.setName("padding");
                $receiver.setValue(Dp.m5214boximpl(all));
            }
        }, null));
    }
    ...
    public static /* synthetic */ Modifier m481absolutePaddingqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.m5216constructorimpl(0);
        }
        int $i$f$getDp = i & 2;
        ...
        return m480absolutePaddingqDBjuR0(modifier, f, f2, f3, f4);
    }

    /* renamed from: absolutePadding-qDBjuR0, reason: not valid java name */
    public static final Modifier m480absolutePaddingqDBjuR0(Modifier absolutePadding, final float left, final float top, final float right, final float bottom) {
        ...
        return absolutePadding.then(new PaddingElement(left, top, right, bottom, false, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.PaddingKt$absolutePadding$1
            ...
            public final void invoke2(InspectorInfo $receiver) {
                ...
                $receiver.getProperties().set("left", Dp.m5214boximpl(left));
                $receiver.getProperties().set("top", Dp.m5214boximpl(top));
                $receiver.getProperties().set("right", Dp.m5214boximpl(right));
                $receiver.getProperties().set("bottom", Dp.m5214boximpl(bottom));
            }
        }, null));
    }
    ...
    public static final float calculateStartPadding(PaddingValues $this$calculateStartPadding, LayoutDirection layoutDirection) {
        ...
        if (layoutDirection == LayoutDirection.Ltr) {
            return $this$calculateStartPadding.mo433calculateLeftPaddingu2uoSUM(layoutDirection);
        }
        return $this$calculateStartPadding.mo434calculateRightPaddingu2uoSUM(layoutDirection);
    }
    ...
    public static final float calculateEndPadding(PaddingValues $this$calculateEndPadding, LayoutDirection layoutDirection) {
        ...
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        if (layoutDirection == LayoutDirection.Ltr) {
            return $this$calculateEndPadding.mo434calculateRightPaddingu2uoSUM(layoutDirection);
        }
        return $this$calculateEndPadding.mo433calculateLeftPaddingu2uoSUM(layoutDirection);
    }

    /* renamed from: PaddingValues-0680j_4, reason: not valid java name */
    public static final PaddingValues m475PaddingValues0680j_4(float all) {
        return new PaddingValues(all, all, all, all, null);
    }

    /* renamed from: PaddingValues-YgX7TsA$default, reason: not valid java name */
    public static /* synthetic */ PaddingValues m477PaddingValuesYgX7TsA$default(float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.m5216constructorimpl(0);
        }
        if ((i & 2) != 0) {
        ...
        return m476PaddingValuesYgX7TsA(f, f2);
    }

    /* renamed from: PaddingValues-YgX7TsA, reason: not valid java name */
    public static final PaddingValues m476PaddingValuesYgX7TsA(float horizontal, float vertical) {
        return new PaddingValues(horizontal, vertical, horizontal, vertical, null);
    }

    /* renamed from: PaddingValues-a9UjIt4$default, reason: not valid java name */
    public static /* synthetic */ PaddingValues m479PaddingValuesa9UjIt4$default(float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.m5216constructorimpl(0);
        }
        int $i$f$getDp = i & 2;
        ...
        return m478PaddingValuesa9UjIt4(f, f2, f3, f4);
    }

    /* renamed from: PaddingValues-a9UjIt4, reason: not valid java name */
    public static final PaddingValues m478PaddingValuesa9UjIt4(float start, float top, float end, float bottom) {
