...
final class ScrollingLogic$doFlingAnimation$2 extends SuspendLambda implements Function2<ScrollScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
            ...
            case 0:
                ...
                final Function1 outerScopeScroll = new Function1<Offset, Offset>() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$outerScopeScroll$1
                    ...
                    public /* bridge */ /* synthetic */ Offset invoke(Offset offset) {
                        return Offset.m2697boximpl(m349invokeMKHz9U(offset.getPackedValue()));
                    }

                    /* renamed from: invoke-MK-Hz9U, reason: not valid java name */
                    public final long m349invokeMKHz9U(long delta) {
                        return ScrollingLogic.this.m341reverseIfNeededMKHz9U(ScrollingLogic.this.m337dispatchScroll3eAAhYA($this$scroll, ScrollingLogic.this.m341reverseIfNeededMKHz9U(delta), NestedScrollSource.INSTANCE.m3964getFlingWNlRxjI()));
                    }
                };
                ...
                ScrollScope scrollScope = new ScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$scope$1
                    ...
                    public float scrollBy(float pixels) {
                        return ScrollingLogic.this.m345toFloatk4lQ0M(outerScopeScroll.invoke(Offset.m2697boximpl(ScrollingLogic.this.m346toOffsettuRUvjQ(pixels))).getPackedValue());
                    }
                };
                ...
                float reverseIfNeeded = scrollingLogic.reverseIfNeeded(scrollingLogic.m344toFloatTH1AsA0(j2));
        ...
        longRef.element = scrollingLogic.m347updateQWom1Mo(j, scrollingLogic2.reverseIfNeeded(((Number) $result).floatValue()));
