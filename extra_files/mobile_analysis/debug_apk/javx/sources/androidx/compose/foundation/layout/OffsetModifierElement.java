...
final class OffsetModifierElement extends ModifierNodeElement<OffsetNode> {
    ...
    public void update(OffsetNode node) {
        ...
        node.m446setX0680j_4(this.x);
        node.m447setY0680j_4(this.y);
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5221equalsimpl0(this.x, otherModifierElement.x) && Dp.m5221equalsimpl0(this.y, otherModifierElement.y) && this.rtlAware == otherModifierElement.rtlAware;
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int result = Dp.m5222hashCodeimpl(this.x);
        return (((result * 31) + Dp.m5222hashCodeimpl(this.y)) * 31) + Boolean.hashCode(this.rtlAware);
    }

    public String toString() {
        return "OffsetModifierElement(x=" + ((Object) Dp.m5227toStringimpl(this.x)) + ", y=" + ((Object) Dp.m5227toStringimpl(this.y)) + ", rtlAware=" + this.rtlAware + ')';
    }
