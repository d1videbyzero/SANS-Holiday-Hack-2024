...
final class RequiredMinIntrinsicHeightModifier implements IntrinsicSizeModifier {
    ...
    public long mo436calculateContentConstraintsl58MMJ0(MeasureScope calculateContentConstraints, Measurable measurable, long constraints) {
        Intrinsics.checkNotNullParameter(calculateContentConstraints, "$this$calculateContentConstraints");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        int height = measurable.minIntrinsicHeight(Constraints.m5172getMaxWidthimpl(constraints));
        return Constraints.INSTANCE.m5181fixedHeightOenEA2s(height);
    }
