...
public final class DragGestureDetectorKt {
    ...
    private static final float mouseSlop = Dp.m5216constructorimpl((float) 0.125d);
    private static final float defaultTouchSlop = Dp.m5216constructorimpl(18);
        ...
        while (true) {
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    i = i2;
                    $this$awaitDragOrUp_u2djO51t88$iv = $this$awaitDragOrUp_u2djO51t88$iv2;
                    if (Boolean.valueOf(PointerId.m4049equalsimpl0(it$iv.getId(), pointer$iv.element)).booleanValue()) {
                        break;
                    }
                    index$iv$iv$iv++;
                    i2 = i;
    ...
    private static final Object m259awaitDragOrUpjO51t88(AwaitPointerEventScope $this$awaitDragOrUp_u2djO51t88, long pointerId, Function1<? super PointerInputChange, Boolean> function1, Continuation<? super PointerInputChange> continuation) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                event = event2;
                if (Boolean.valueOf(PointerId.m4049equalsimpl0(it.getId(), pointer.element)).booleanValue()) {
                    break;
                }
                index$iv$iv++;
                event2 = event;
    ...
    public static /* synthetic */ Object m266awaitPointerSlopOrCancellationwtdNQyU$default(AwaitPointerEventScope $this$awaitPointerSlopOrCancellation_u2dwtdNQyU_u24default, long pointerId, int pointerType, PointerDirectionConfig pointerDirectionConfig, boolean triggerOnMainAxisSlop, Function2 onPointerSlopReached, Continuation $completion, int i, Object obj) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                it$iv = item$iv$iv;
                PointerInputChange it = (PointerInputChange) it$iv;
                if (PointerId.m4049equalsimpl0(it.getId(), pointer)) {
                    break;
                }
                index$iv$iv++;
            ...
            if (PointerEventKt.changedToUpIgnoreConsumed(dragEvent)) {
                ...
                float inDirection2 = triggerOnMainAxisSlop2 ? Math.abs(totalMainPositionChange) : Offset.m2706getDistanceimpl(pointerDirectionConfig2.mo280offsetFromChangesdBAh8RU(totalMainPositionChange, totalCrossPositionChange));
    ...
    private static final Object m265awaitPointerSlopOrCancellationwtdNQyU$$forInline(AwaitPointerEventScope $this$awaitPointerSlopOrCancellation_u2dwtdNQyU, long pointerId, int pointerType, PointerDirectionConfig pointerDirectionConfig, boolean triggerOnMainAxisSlop, Function2<? super PointerInputChange, ? super Offset, Unit> function2, Continuation<? super PointerInputChange> continuation) {
        ...
        while (true) {
            ...
            if (PointerEventKt.changedToUpIgnoreConsumed(dragEvent)) {
                ...
                totalMainPositionChange += mainPositionChange;
                totalCrossPositionChange += crossPositionChange;
                float inDirection = triggerOnMainAxisSlop ? Math.abs(totalMainPositionChange) : Offset.m2706getDistanceimpl(pointerDirectionConfig.mo280offsetFromChangesdBAh8RU(totalMainPositionChange, totalCrossPositionChange));
    ...
    */
    public static final java.lang.Object m263awaitLongPressOrCancellationrnUCldI(androidx.compose.ui.input.pointer.AwaitPointerEventScope r17, long r18, kotlin.coroutines.Continuation<? super androidx.compose.ui.input.pointer.PointerInputChange> r20) {
        ...
        L66:
            ...
            r17 = r8
            long r7 = r15.getId()
            boolean r7 = androidx.compose.ui.input.pointer.PointerId.m4049equalsimpl0(r7, r5)
            if (r7 == 0) goto L82
            goto L90
        L82:
            int r10 = r10 + 1
    ...
    public static final boolean m275isPointerUpDmW0f2w(PointerEvent $this$isPointerUp_u2dDmW0f2w, long pointerId) {
        ...
        while (true) {
            if (index$iv$iv < size) {
                ...
                it$iv = item$iv$iv;
                PointerInputChange it = (PointerInputChange) it$iv;
                if (PointerId.m4049equalsimpl0(it.getId(), pointerId)) {
                    break;
                }
                index$iv$iv++;
            } else {
    ...
    public static final float m276pointerSlopE8SPZFQ(ViewConfiguration pointerSlop, int pointerType) {
        ...
        return PointerType.m4137equalsimpl0(pointerType, PointerType.INSTANCE.m4142getMouseT8wyACA()) ? pointerSlop.getTouchSlop() * mouseToTouchSlopRatio : pointerSlop.getTouchSlop();
    }
}
