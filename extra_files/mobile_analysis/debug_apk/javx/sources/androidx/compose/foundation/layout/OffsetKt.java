...
public final class OffsetKt {
    ...
    public static final Modifier m442offsetVpY3zN4(Modifier offset, final float x, final float y) {
        ...
        return offset.then(new OffsetModifierElement(x, y, true, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.OffsetKt$offset$1
            ...
            public final void invoke2(InspectorInfo $receiver) {
                ...
                $receiver.getProperties().set("x", Dp.m5214boximpl(x));
                $receiver.getProperties().set("y", Dp.m5214boximpl(y));
            }
        }, null));
    }
    ...
    public static final Modifier m440absoluteOffsetVpY3zN4(Modifier absoluteOffset, final float x, final float y) {
