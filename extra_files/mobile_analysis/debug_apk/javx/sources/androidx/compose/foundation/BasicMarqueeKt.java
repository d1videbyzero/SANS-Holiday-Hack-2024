...
public final class BasicMarqueeKt {
    ...
    private static final float DefaultMarqueeVelocity = Dp.m5216constructorimpl(30);
    ...
    public static /* synthetic */ Modifier m167basicMarquee1Mj1MLw$default(Modifier modifier, int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f, int i5, Object obj) {
        ...
        return m166basicMarquee1Mj1MLw(modifier, i, m232getImmediatelyZbEOnfQ, i7, i6, (i5 & 16) != 0 ? DefaultMarqueeSpacing : marqueeSpacing, (i5 & 32) != 0 ? DefaultMarqueeVelocity : f);
    }

    /* renamed from: basicMarquee-1Mj1MLw, reason: not valid java name */
    public static final Modifier m166basicMarquee1Mj1MLw(Modifier basicMarquee, int iterations, int animationMode, int delayMillis, int initialDelayMillis, MarqueeSpacing spacing, float velocity) {
    ...
    public static final AnimationSpec<Float> m168createMarqueeAnimationSpecZ4HSEVQ(int iterations, float targetValue, int initialDelayMillis, int delayMillis, float velocity, Density density) {
        ...
        long startOffset = StartOffset.m113constructorimpl$default((-delayMillis) + initialDelayMillis, 0, 2, null);
        if (iterations == Integer.MAX_VALUE) {
            return AnimationSpecKt.m93infiniteRepeatable9IiC70o$default(singleSpec, null, startOffset, 2, null);
        }
        return AnimationSpecKt.m95repeatable91I0pcU$default(iterations, singleSpec, null, startOffset, 4, null);
    }
    ...
    public static final MarqueeSpacing m164MarqueeSpacing0680j_4(final float spacing) {
