...
final class WindowInsetsNestedScrollConnection implements NestedScrollConnection, WindowInsetsAnimationControlListener {
    ...
    public long mo336onPreScrollOzD1aCk(long available, int source) {
        return m558scroll8S9VItk(available, this.sideCalculator.hideMotion(Offset.m2708getXimpl(available), Offset.m2709getYimpl(available)));
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostScroll-DzOQY0M */
    public long mo335onPostScrollDzOQY0M(long consumed, long available, int source) {
        return m558scroll8S9VItk(available, this.sideCalculator.showMotion(Offset.m2708getXimpl(available), Offset.m2709getYimpl(available)));
    }
    ...
    public Object mo559onPreFlingQWom1Mo(long available, Continuation<? super Velocity> continuation) {
        return m557flinghuYlsQE(available, this.sideCalculator.hideMotion(Velocity.m5441getXimpl(available), Velocity.m5442getYimpl(available)), false, continuation);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostFling-RZ2iAVY */
    public Object mo334onPostFlingRZ2iAVY(long consumed, long available, Continuation<? super Velocity> continuation) {
        return m557flinghuYlsQE(available, this.sideCalculator.showMotion(Velocity.m5441getXimpl(available), Velocity.m5442getYimpl(available)), true, continuation);
    }
    ...
    */
    public final java.lang.Object m557flinghuYlsQE(long r27, float r29, boolean r30, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r31) {
        /*
