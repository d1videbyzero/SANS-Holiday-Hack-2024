...
final class ConsumeAllFlingOnDirection implements NestedScrollConnection {
    ...
    public final long m686consumeOnOrientationQWom1Mo(long $this$consumeOnOrientation_u2dQWom1Mo, Orientation orientation) {
        ...
        if (orientation == Orientation.Vertical) {
            return Velocity.m5437copyOhffZ5M$default($this$consumeOnOrientation_u2dQWom1Mo, 0.0f, 0.0f, 2, null);
        }
        return Velocity.m5437copyOhffZ5M$default($this$consumeOnOrientation_u2dQWom1Mo, 0.0f, 0.0f, 1, null);
    }
    ...
    public long mo335onPostScrollDzOQY0M(long consumed, long available, int source) {
        return NestedScrollSource.m3958equalsimpl0(source, NestedScrollSource.INSTANCE.m3964getFlingWNlRxjI()) ? m685consumeOnOrientation8S9VItk(available, this.orientation) : Offset.INSTANCE.m2724getZeroF1C5BW0();
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostFling-RZ2iAVY */
    public Object mo334onPostFlingRZ2iAVY(long consumed, long available, Continuation<? super Velocity> continuation) {
        return Velocity.m5432boximpl(m686consumeOnOrientationQWom1Mo(available, this.orientation));
    }
}
