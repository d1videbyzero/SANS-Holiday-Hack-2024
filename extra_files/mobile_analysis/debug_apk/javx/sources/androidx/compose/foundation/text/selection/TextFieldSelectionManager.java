...
public final class TextFieldSelectionManager {
    ...
    public TextFieldSelectionManager(UndoManager undoManager) {
        ...
        this.touchSelectionObserver = new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$touchSelectionObserver$1
            ...
            public void mo805onStartk4lQ0M(long startPoint) {
                ...
                if (!((state2 == null || (layoutResult3 = state2.getLayoutResult()) == null || !layoutResult3.m838isPositionOnTextk4lQ0M(startPoint)) ? false : true) && (state = TextFieldSelectionManager.this.getState()) != null && (layoutResult2 = state.getLayoutResult()) != null) {
                    ...
                    if (hapticFeedBack != null) {
                        hapticFeedBack.mo3596performHapticFeedbackCdsT49E(HapticFeedbackType.INSTANCE.m3605getTextHandleMove5zf0vsI());
                    }
                    newValue = textFieldSelectionManager.m941createTextFieldValueFDrldGo(textFieldSelectionManager.getValue$foundation_release().getText(), TextRangeKt.TextRange(offset, offset));
                ...
                if (state3 != null && (layoutResult = state3.getLayoutResult()) != null) {
                    ...
                    int offset2 = TextLayoutResultProxy.m835getOffsetForPosition3MmeM6k$default(layoutResult, startPoint, false, 2, null);
                ...
                textFieldSelectionManager3.m943setCurrentDragPosition_kEHs6E(Offset.m2697boximpl(j));
                TextFieldSelectionManager.this.dragTotalDistance = Offset.INSTANCE.m2724getZeroF1C5BW0();
            }
            ...
            public void mo804onDragk4lQ0M(long delta) {
                ...
                textFieldSelectionManager.dragTotalDistance = Offset.m2713plusMKHz9U(j, delta);
                ...
                if (state != null && (layoutResult = state.getLayoutResult()) != null) {
                    ...
                    textFieldSelectionManager2.m943setCurrentDragPosition_kEHs6E(Offset.m2697boximpl(Offset.m2713plusMKHz9U(j2, j3)));
                    ...
                    int startOffset = m837getOffsetForPosition3MmeM6k;
                    ...
                    int endOffset = layoutResult.m837getOffsetForPosition3MmeM6k(m946getCurrentDragPosition_m7T9E.getPackedValue(), false);
        ...
        this.mouseSelectionObserver = new MouseSelectionObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$mouseSelectionObserver$1
            ...
            public boolean mo865onExtendk4lQ0M(long downPosition) {
                ...
                if (state != null && (layoutResult = state.getLayoutResult()) != null) {
                    TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                    int startOffset = textFieldSelectionManager.getOffsetMapping().originalToTransformed(TextRange.m4724getStartimpl(textFieldSelectionManager.getValue$foundation_release().getSelection()));
                    int clickOffset = TextLayoutResultProxy.m835getOffsetForPosition3MmeM6k$default(layoutResult, downPosition, false, 2, null);
            ...
            public boolean mo866onExtendDragk4lQ0M(long dragPosition) {
                ...
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                int startOffset = textFieldSelectionManager.getOffsetMapping().originalToTransformed(TextRange.m4724getStartimpl(textFieldSelectionManager.getValue$foundation_release().getSelection()));
                int dragOffset = layoutResult.m837getOffsetForPosition3MmeM6k(dragPosition, false);
            ...
            public boolean mo867onStart3MmeM6k(long downPosition, SelectionAdjustment adjustment) {
                ...
                if (state != null && (layoutResult = state.getLayoutResult()) != null) {
                    ...
                    int clickOffset = TextLayoutResultProxy.m835getOffsetForPosition3MmeM6k$default(layoutResult, j, false, 2, null);
    ...
    public final TextDragObserver handleDragObserver$foundation_release(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$handleDragObserver$1
            ...
            public void mo803onDownk4lQ0M(long point) {
                ...
                TextFieldSelectionManager.this.m943setCurrentDragPosition_kEHs6E(Offset.m2697boximpl(SelectionHandlesKt.m896getAdjustedCoordinatesk4lQ0M(TextFieldSelectionManager.this.m948getHandlePositiontuRUvjQ$foundation_release(isStartHandle))));
            }
            ...
            public void mo805onStartk4lQ0M(long startPoint) {
                long j;
                TextFieldSelectionManager.this.dragBeginPosition = SelectionHandlesKt.m896getAdjustedCoordinatesk4lQ0M(TextFieldSelectionManager.this.m948getHandlePositiontuRUvjQ$foundation_release(isStartHandle));
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                j = TextFieldSelectionManager.this.dragBeginPosition;
                textFieldSelectionManager.m943setCurrentDragPosition_kEHs6E(Offset.m2697boximpl(j));
                TextFieldSelectionManager.this.dragTotalDistance = Offset.INSTANCE.m2724getZeroF1C5BW0();
                TextFieldSelectionManager.this.setDraggingHandle(isStartHandle ? Handle.SelectionStart : Handle.SelectionEnd);
                TextFieldState state = TextFieldSelectionManager.this.getState();
                if (state == null) {
            ...
            public void mo804onDragk4lQ0M(long delta) {
                ...
                if (state != null && (layoutResult = state.getLayoutResult()) != null && (layoutResult2 = layoutResult.getValue()) != null) {
                    ...
                    if (z) {
                        Offset m946getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m946getCurrentDragPosition_m7T9E();
                        Intrinsics.checkNotNull(m946getCurrentDragPosition_m7T9E);
                        startOffset = layoutResult2.m4696getOffsetForPositionk4lQ0M(m946getCurrentDragPosition_m7T9E.getPackedValue());
                    } else {
                        startOffset = textFieldSelectionManager2.getOffsetMapping().originalToTransformed(TextRange.m4724getStartimpl(textFieldSelectionManager2.getValue$foundation_release().getSelection()));
                    }
                    if (z) {
                        endOffset = textFieldSelectionManager2.getOffsetMapping().originalToTransformed(TextRange.m4719getEndimpl(textFieldSelectionManager2.getValue$foundation_release().getSelection()));
                    } else {
                        ...
                        endOffset = layoutResult2.m4696getOffsetForPositionk4lQ0M(m946getCurrentDragPosition_m7T9E2.getPackedValue());
                    }
    ...
    public final TextDragObserver cursorDragObserver$foundation_release() {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$cursorDragObserver$1
            ...
            public void mo803onDownk4lQ0M(long point) {
                ...
                TextFieldSelectionManager.this.m943setCurrentDragPosition_kEHs6E(Offset.m2697boximpl(SelectionHandlesKt.m896getAdjustedCoordinatesk4lQ0M(TextFieldSelectionManager.this.m948getHandlePositiontuRUvjQ$foundation_release(true))));
            }
            ...
            public void mo805onStartk4lQ0M(long startPoint) {
                long j;
                TextFieldSelectionManager.this.dragBeginPosition = SelectionHandlesKt.m896getAdjustedCoordinatesk4lQ0M(TextFieldSelectionManager.this.m948getHandlePositiontuRUvjQ$foundation_release(true));
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                j = TextFieldSelectionManager.this.dragBeginPosition;
                textFieldSelectionManager.m943setCurrentDragPosition_kEHs6E(Offset.m2697boximpl(j));
                TextFieldSelectionManager.this.dragTotalDistance = Offset.INSTANCE.m2724getZeroF1C5BW0();
            ...
            public void mo804onDragk4lQ0M(long delta) {
                ...
                if (state != null && (layoutResult = state.getLayoutResult()) != null && (layoutResult2 = layoutResult.getValue()) != null) {
                    ...
                    Offset m946getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m946getCurrentDragPosition_m7T9E();
                    Intrinsics.checkNotNull(m946getCurrentDragPosition_m7T9E);
                    int offset = offsetMapping.transformedToOriginal(layoutResult2.m4696getOffsetForPositionk4lQ0M(m946getCurrentDragPosition_m7T9E.getPackedValue()));
                    long newSelection = TextRangeKt.TextRange(offset, offset);
                    if (TextRange.m4717equalsimpl0(newSelection, textFieldSelectionManager2.getValue$foundation_release().getSelection())) {
                        return;
                    }
                    ...
                    m941createTextFieldValueFDrldGo = textFieldSelectionManager2.m941createTextFieldValueFDrldGo(textFieldSelectionManager2.getValue$foundation_release().getText(), newSelection);
    ...
    public final void m945deselect_kEHs6E$foundation_release(Offset position) {
        ...
        int newCursorOffset;
        if (!TextRange.m4718getCollapsedimpl(getValue$foundation_release().getSelection())) {
            TextFieldState textFieldState = this.state;
            ...
            if (position != null && layoutResult != null) {
                newCursorOffset = this.offsetMapping.transformedToOriginal(TextLayoutResultProxy.m835getOffsetForPosition3MmeM6k$default(layoutResult, position.getPackedValue(), false, 2, null));
            } else {
                newCursorOffset = TextRange.m4721getMaximpl(getValue$foundation_release().getSelection());
            }
            TextFieldValue newValue = TextFieldValue.m4937copy3r_uNRQ$default(getValue$foundation_release(), (AnnotatedString) null, TextRangeKt.TextRange(newCursorOffset), (TextRange) null, 5, (Object) null);
    ...
    public final void copy$foundation_release(boolean cancelSelection) {
        ...
        if (cancelSelection) {
            int newCursorOffset = TextRange.m4721getMaximpl(getValue$foundation_release().getSelection());
    ...
    public final void paste$foundation_release() {
        ...
        int newCursorOffset = TextRange.m4722getMinimpl(getValue$foundation_release().getSelection()) + text.length();
    ...
    public final void cut$foundation_release() {
        ...
        int newCursorOffset = TextRange.m4722getMinimpl(getValue$foundation_release().getSelection());
        TextFieldValue newValue = m941createTextFieldValueFDrldGo(newText, TextRangeKt.TextRange(newCursorOffset, newCursorOffset));
        this.onValueChange.invoke(newValue);
        setHandleState(HandleState.None);
        UndoManager undoManager = this.undoManager;
    ...
    public final void selectAll$foundation_release() {
        ...
        this.onValueChange.invoke(newValue);
        this.oldValue = TextFieldValue.m4937copy3r_uNRQ$default(this.oldValue, (AnnotatedString) null, newValue.getSelection(), (TextRange) null, 5, (Object) null);
        TextFieldState textFieldState = this.state;
        if (textFieldState == null) {
            return;
        }
    ...
    public final long m948getHandlePositiontuRUvjQ$foundation_release(boolean isStartHandle) {
        ...
        int offset = isStartHandle ? TextRange.m4724getStartimpl(selection) : TextRange.m4719getEndimpl(selection);
        TextFieldState textFieldState = this.state;
        TextLayoutResultProxy layoutResult = textFieldState != null ? textFieldState.getLayoutResult() : null;
        Intrinsics.checkNotNull(layoutResult);
        return TextSelectionDelegateKt.getSelectionHandleCoordinates(layoutResult.getValue(), this.offsetMapping.originalToTransformed(offset), isStartHandle, TextRange.m4723getReversedimpl(getValue$foundation_release().getSelection()));
    }

    /* renamed from: getCursorPosition-tuRUvjQ$foundation_release, reason: not valid java name */
    public final long m947getCursorPositiontuRUvjQ$foundation_release(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        int offset = this.offsetMapping.originalToTransformed(TextRange.m4724getStartimpl(getValue$foundation_release().getSelection()));
        TextFieldState textFieldState = this.state;
        TextLayoutResultProxy layoutResult = textFieldState != null ? textFieldState.getLayoutResult() : null;
        Intrinsics.checkNotNull(layoutResult);
    ...
    */
    public final void showSelectionToolbar$foundation_release() {
        /*
            ...
            boolean r1 = androidx.compose.ui.text.TextRange.m4718getCollapsedimpl(r1)
            r2 = 0
            if (r1 != 0) goto L1e
            if (r0 != 0) goto L1e
        ...
        L1f:
            ...
            boolean r1 = androidx.compose.ui.text.TextRange.m4718getCollapsedimpl(r3)
            if (r1 != 0) goto L3f
        ...
        L60:
            androidx.compose.ui.text.input.TextFieldValue r1 = r9.getValue$foundation_release()
            long r3 = r1.getSelection()
            int r1 = androidx.compose.ui.text.TextRange.m4720getLengthimpl(r3)
    ...
    public final void m944contextMenuOpenAdjustmentk4lQ0M(long position) {
        ...
        if (textFieldState != null && (layoutResult = textFieldState.getLayoutResult()) != null) {
            int offset = TextLayoutResultProxy.m835getOffsetForPosition3MmeM6k$default(layoutResult, position, false, 2, null);
            if (!TextRange.m4715containsimpl(getValue$foundation_release().getSelection(), offset)) {
    ...
    private final Rect getContentRect() {
        ...
        if (it != null) {
            ...
            if (it != null) {
                int transformedStart = this.offsetMapping.originalToTransformed(TextRange.m4724getStartimpl(getValue$foundation_release().getSelection()));
                int transformedEnd = this.offsetMapping.originalToTransformed(TextRange.m4719getEndimpl(getValue$foundation_release().getSelection()));
                TextFieldState textFieldState = this.state;
                long startOffset = (textFieldState == null || (layoutCoordinates4 = textFieldState.getLayoutCoordinates()) == null) ? Offset.INSTANCE.m2724getZeroF1C5BW0() : layoutCoordinates4.mo4193localToRootMKHz9U(m948getHandlePositiontuRUvjQ$foundation_release(true));
                TextFieldState textFieldState2 = this.state;
                long endOffset = (textFieldState2 == null || (layoutCoordinates3 = textFieldState2.getLayoutCoordinates()) == null) ? Offset.INSTANCE.m2724getZeroF1C5BW0() : layoutCoordinates3.mo4193localToRootMKHz9U(m948getHandlePositiontuRUvjQ$foundation_release(false));
                ...
                if (textFieldState3 == null || (layoutCoordinates2 = textFieldState3.getLayoutCoordinates()) == null) {
                    ...
                    startTop = Offset.m2709getYimpl(layoutCoordinates2.mo4193localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult == null || (value2 = layoutResult.getValue()) == null || (cursorRect2 = value2.getCursorRect(transformedStart)) == null) ? 0.0f : cursorRect2.getTop())));
                }
                ...
                if (textFieldState4 != null && (layoutCoordinates = textFieldState4.getLayoutCoordinates()) != null) {
                    ...
                    endTop = Offset.m2709getYimpl(layoutCoordinates.mo4193localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult2 == null || (value = layoutResult2.getValue()) == null || (cursorRect = value.getCursorRect(transformedEnd)) == null) ? 0.0f : cursorRect.getTop())));
                }
                ...
                float bottom = Math.max(Offset.m2709getYimpl(startOffset), Offset.m2709getYimpl(endOffset)) + (Dp.m5216constructorimpl(25) * it.getTextDelegate().getDensity().getDensity());
    ...
    public final void updateSelection(TextFieldValue value, int transformedStartOffset, int transformedEndOffset, boolean isStartHandle, SelectionAdjustment adjustment) {
        TextLayoutResultProxy layoutResult;
        long transformedSelection = TextRangeKt.TextRange(this.offsetMapping.originalToTransformed(TextRange.m4724getStartimpl(value.getSelection())), this.offsetMapping.originalToTransformed(TextRange.m4719getEndimpl(value.getSelection())));
        TextFieldState textFieldState = this.state;
        long newTransformedSelection = TextFieldSelectionDelegateKt.m938getTextFieldSelectionbb3KNj8((textFieldState == null || (layoutResult = textFieldState.getLayoutResult()) == null) ? null : layoutResult.getValue(), transformedStartOffset, transformedEndOffset, TextRange.m4718getCollapsedimpl(transformedSelection) ? null : TextRange.m4712boximpl(transformedSelection), isStartHandle, adjustment);
        long originalSelection = TextRangeKt.TextRange(this.offsetMapping.transformedToOriginal(TextRange.m4724getStartimpl(newTransformedSelection)), this.offsetMapping.transformedToOriginal(TextRange.m4719getEndimpl(newTransformedSelection)));
        if (TextRange.m4717equalsimpl0(originalSelection, value.getSelection())) {
            return;
        }
