        ...
        return ComposedModifierKt.composed($this$heightInLines, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.text.HeightInLinesModifierKt$heightInLines$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier composed, Composer $composer, int $changed) {
                ...
                if (invalid$iv$iv2 || it$iv$iv2 == Composer.INSTANCE.getEmpty()) {
                    ...
                    int m4822unboximpl = m4747getFontStyle4Lr2A7w != null ? m4747getFontStyle4Lr2A7w.m4822unboximpl() : FontStyle.INSTANCE.m4824getNormal_LCdwA();
                    FontSynthesis m4748getFontSynthesisZQGJjVo = resolvedStyle.m4748getFontSynthesisZQGJjVo();
                    int $changed$iv = m4748getFontSynthesisZQGJjVo != null ? m4748getFontSynthesisZQGJjVo.getValue() : FontSynthesis.INSTANCE.m4834getAllGVVA2EU();
                    value$iv$iv2 = fontFamilyResolver.mo4794resolveDPcqOEQ(fontFamily, fontWeight2, m4822unboximpl, $changed$iv);
                ...
                if (invalid$iv || it$iv$iv3 == Composer.INSTANCE.getEmpty()) {
                    value$iv$iv3 = Integer.valueOf(IntSize.m5375getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText(resolvedStyle, density, fontFamilyResolver, TextFieldDelegateKt.getEmptyTextReplacement(), 1)));
                ...
                if (invalid$iv2 || it$iv$iv4 == Composer.INSTANCE.getEmpty()) {
                    ...
                    value$iv$iv4 = Integer.valueOf(IntSize.m5375getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText(resolvedStyle, density, fontFamilyResolver, twoLines, 2)));
                ...
                Modifier m516heightInVpY3zN4 = SizeKt.m516heightInVpY3zN4(Modifier.INSTANCE, precomputedMinLinesHeight != null ? density.mo324toDpu2uoSUM(precomputedMinLinesHeight.intValue()) : Dp.INSTANCE.m5236getUnspecifiedD9Ej5fM(), precomputedMaxLinesHeight != null ? density.mo324toDpu2uoSUM(precomputedMaxLinesHeight.intValue()) : Dp.INSTANCE.m5236getUnspecifiedD9Ej5fM());
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                $composer.endReplaceableGroup();
                return m516heightInVpY3zN4;
            }
        });
    }
