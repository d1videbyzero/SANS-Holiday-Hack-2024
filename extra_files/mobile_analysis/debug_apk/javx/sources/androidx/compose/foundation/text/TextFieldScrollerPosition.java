...
public final class TextFieldScrollerPosition {
    ...
    public TextFieldScrollerPosition(Orientation initialOrientation, float initial) {
        ...
        this.previousSelection = TextRange.INSTANCE.m4729getZerod9O1mEE();
    ...
    */
    ...
    public final int m823getOffsetToFollow5zctL8(long selection) {
        return TextRange.m4724getStartimpl(selection) != TextRange.m4724getStartimpl(this.previousSelection) ? TextRange.m4724getStartimpl(selection) : TextRange.m4719getEndimpl(selection) != TextRange.m4719getEndimpl(this.previousSelection) ? TextRange.m4719getEndimpl(selection) : TextRange.m4722getMinimpl(selection);
    }
