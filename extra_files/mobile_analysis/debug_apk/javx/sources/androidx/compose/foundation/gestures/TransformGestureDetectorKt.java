...
public final class TransformGestureDetectorKt {
    ...
    public static final float calculateRotation(PointerEvent $this$calculateRotation) {
        ...
        while (index$iv < size2) {
            ...
            if (!change.getPressed() || !change.getPreviousPressed()) {
                ...
                float previousAngle = m353anglek4lQ0M(previousOffset);
                float currentAngle = m353anglek4lQ0M(currentOffset);
    ...
    private static final float m353anglek4lQ0M(long $this$angle_u2dk_u2d4lQ0M) {
