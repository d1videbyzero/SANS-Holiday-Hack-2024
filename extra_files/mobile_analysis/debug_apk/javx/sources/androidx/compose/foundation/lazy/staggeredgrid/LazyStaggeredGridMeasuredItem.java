...
public final class LazyStaggeredGridMeasuredItem implements LazyStaggeredGridItemInfo {
    ...
    public LazyStaggeredGridMeasuredItem(int index, Object key, List<? extends Placeable> placeables, boolean isVertical, int spacing, int lane, int span, int beforeContentPadding, int afterContentPadding, Object contentType) {
        ...
        this.size = IntSize;
        this.offset = IntOffset.INSTANCE.m5344getZeronOccac();
    }
    ...
    public final int getCrossAxisOffset() {
        return this.isVertical ? IntOffset.m5334getXimpl(getOffset()) : IntOffset.m5335getYimpl(getOffset());
    }
    ...
    public final void place(Placeable.PlacementScope scope, LazyStaggeredGridMeasureContext context) {
        ...
        for (int size = $this$fastForEachIndexed$iv.size(); index$iv < size; size = i) {
            ...
            if (animateNode != null) {
                long other$iv = animateNode.m627getPlacementDeltanOccac();
                i = size;
                long animatedOffset = IntOffsetKt.IntOffset(IntOffset.m5334getXimpl(offset) + IntOffset.m5334getXimpl(other$iv), IntOffset.m5335getYimpl(offset) + IntOffset.m5335getYimpl(other$iv));
                if ((lazyStaggeredGridMeasuredItem.m672getMainAxisgyyYBs(offset) <= minOffset2 && lazyStaggeredGridMeasuredItem.m672getMainAxisgyyYBs(animatedOffset) <= minOffset2) || (lazyStaggeredGridMeasuredItem.m672getMainAxisgyyYBs(offset) >= maxOffset2 && lazyStaggeredGridMeasuredItem.m672getMainAxisgyyYBs(animatedOffset) >= maxOffset2)) {
            ...
            if (context.getReverseLayout()) {
                ...
                if (this.isVertical) {
                    height = IntOffset.m5334getXimpl($this$copy_u2d4Tuh3kE$iv);
                    minOffset = minOffset2;
                } else {
                    int mainAxisOffset = IntOffset.m5334getXimpl($this$copy_u2d4Tuh3kE$iv);
                    minOffset = minOffset2;
                ...
                if (this.isVertical) {
                    int mainAxisOffset2 = IntOffset.m5335getYimpl($this$copy_u2d4Tuh3kE$iv);
                    m5335getYimpl = (lazyStaggeredGridMeasuredItem.mainAxisLayoutSize - mainAxisOffset2) - (this.isVertical ? placeable.getHeight() : placeable.getWidth());
                } else {
                    m5335getYimpl = IntOffset.m5335getYimpl($this$copy_u2d4Tuh3kE$iv);
                }
                offset = IntOffsetKt.IntOffset(height, m5335getYimpl);
            } else {
                maxOffset = maxOffset2;
                minOffset = minOffset2;
            }
            long other$iv2 = context.getContentOffset();
            Placeable.PlacementScope.m4243placeRelativeWithLayeraW9wM$default(scope, placeable, IntOffsetKt.IntOffset(IntOffset.m5334getXimpl(offset) + IntOffset.m5334getXimpl(other$iv2), IntOffset.m5335getYimpl(offset) + IntOffset.m5335getYimpl(other$iv2)), 0.0f, null, 6, null);
    ...
    private final int m672getMainAxisgyyYBs(long $this$mainAxis) {
        return this.isVertical ? IntOffset.m5335getYimpl($this$mainAxis) : IntOffset.m5334getXimpl($this$mainAxis);
    }
    ...
    private final long m671copy4Tuh3kE(long $this$copy_u2d4Tuh3kE, Function1<? super Integer, Integer> function1) {
        return IntOffsetKt.IntOffset(this.isVertical ? IntOffset.m5334getXimpl($this$copy_u2d4Tuh3kE) : function1.invoke(Integer.valueOf(IntOffset.m5334getXimpl($this$copy_u2d4Tuh3kE))).intValue(), this.isVertical ? function1.invoke(Integer.valueOf(IntOffset.m5335getYimpl($this$copy_u2d4Tuh3kE))).intValue() : IntOffset.m5335getYimpl($this$copy_u2d4Tuh3kE));
    }
