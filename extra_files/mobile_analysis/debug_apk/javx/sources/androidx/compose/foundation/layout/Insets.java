...
final class Insets implements WindowInsets {
    ...
    public String toString() {
        return "Insets(left=" + ((Object) Dp.m5227toStringimpl(this.left)) + ", top=" + ((Object) Dp.m5227toStringimpl(this.top)) + ", right=" + ((Object) Dp.m5227toStringimpl(this.right)) + ", bottom=" + ((Object) Dp.m5227toStringimpl(this.bottom)) + ')';
    }
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof Insets) {
            return Dp.m5221equalsimpl0(this.left, ((Insets) other).left) && Dp.m5221equalsimpl0(this.top, ((Insets) other).top) && Dp.m5221equalsimpl0(this.right, ((Insets) other).right) && Dp.m5221equalsimpl0(this.bottom, ((Insets) other).bottom);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((result * 31) + Dp.m5222hashCodeimpl(this.top)) * 31) + Dp.m5222hashCodeimpl(this.right)) * 31) + Dp.m5222hashCodeimpl(this.bottom);
    }
}
