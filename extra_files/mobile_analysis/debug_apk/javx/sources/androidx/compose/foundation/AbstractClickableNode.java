...
abstract class AbstractClickableNode extends DelegatingNode implements PointerInputModifierNode, KeyInputModifierNode {
    ...
    public static /* synthetic */ void m142updateCommonXHw0xAI$default(AbstractClickableNode abstractClickableNode, MutableInteractionSource mutableInteractionSource, boolean z, String str, Role role, Function0 function0, int i, Object obj) {
        ...
        abstractClickableNode.m146updateCommonXHw0xAI(mutableInteractionSource, z, str, role2, function0);
    }
    ...
    public boolean mo143onKeyEventZmokQxo(KeyEvent event) {
        ...
        if (this.enabled && Clickable_androidKt.m209isPressZmokQxo(event)) {
            if (this.interactionData.getCurrentKeyPressInteractions().containsKey(Key.m3622boximpl(KeyEvent_androidKt.m3933getKeyZmokQxo(event)))) {
                return false;
            }
            PressInteraction.Press press = new PressInteraction.Press(this.interactionData.getCentreOffset(), null);
            this.interactionData.getCurrentKeyPressInteractions().put(Key.m3622boximpl(KeyEvent_androidKt.m3933getKeyZmokQxo(event)), press);
        ...
        if (!this.enabled || !Clickable_androidKt.m207isClickZmokQxo(event)) {
            return false;
        }
        PressInteraction.Press it = this.interactionData.getCurrentKeyPressInteractions().remove(Key.m3622boximpl(KeyEvent_androidKt.m3933getKeyZmokQxo(event)));
        if (it != null) {
