...
public final class SelectionManager {
    ...
    public SelectionManager(SelectionRegistrarImpl selectionRegistrar) {
        ...
        this.selectionRegistrar.setOnSelectionUpdateStartCallback$foundation_release(new Function3<LayoutCoordinates, Offset, SelectionAdjustment, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.2
            ...
            public final void m924invoked4ec7I(LayoutCoordinates layoutCoordinates, long position, SelectionAdjustment selectionMode) {
                Intrinsics.checkNotNullParameter(layoutCoordinates, "layoutCoordinates");
                Intrinsics.checkNotNullParameter(selectionMode, "selectionMode");
                Offset positionInContainer = SelectionManager.this.m909convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, position);
                if (positionInContainer != null) {
                    SelectionManager.this.m915startSelection9KIMszo(positionInContainer.getPackedValue(), false, selectionMode);
        ...
        this.selectionRegistrar.setOnSelectionUpdateCallback$foundation_release(new Function5<LayoutCoordinates, Offset, Offset, Boolean, SelectionAdjustment, Boolean>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.4
            ...
            public final Boolean m925invoke5iVPX68(LayoutCoordinates layoutCoordinates, long newPosition, long previousPosition, boolean isStartHandle, SelectionAdjustment selectionMode) {
                Intrinsics.checkNotNullParameter(layoutCoordinates, "layoutCoordinates");
                Intrinsics.checkNotNullParameter(selectionMode, "selectionMode");
                Offset newPositionInContainer = SelectionManager.this.m909convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, newPosition);
                Offset previousPositionInContainer = SelectionManager.this.m909convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, previousPosition);
                return Boolean.valueOf(SelectionManager.this.m923updateSelectionRHHTvR4$foundation_release(newPositionInContainer, previousPositionInContainer, isStartHandle, selectionMode));
            }
        });
    ...
    public final Modifier getModifier() {
        return KeyInputModifierKt.onKeyEvent(FocusableKt.focusable$default(FocusChangedModifierKt.onFocusChanged(FocusRequesterModifierKt.focusRequester(OnGloballyPositionedModifierKt.onGloballyPositioned(onClearSelectionRequested(Modifier.INSTANCE, new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager$modifier$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m926invokeZmokQxo(keyEvent.m3922unboximpl());
            }
    ...
    */
    public final void updateHandleOffsets() {
        ...
        L49:
            r8 = 1
            long r9 = r4.mo877getHandlePositiondBAh8RU(r1, r8)
            long r9 = r2.mo4192localPositionOfR5De75A(r6, r9)
            r11 = 0
            long r12 = r5.mo877getHandlePositiondBAh8RU(r1, r11)
            long r12 = r2.mo4192localPositionOfR5De75A(r7, r12)
            androidx.compose.ui.geometry.Rect r14 = androidx.compose.foundation.text.selection.SelectionManagerKt.visibleBounds(r2)
            androidx.compose.ui.geometry.Offset r15 = androidx.compose.ui.geometry.Offset.m2697boximpl(r9)
            long r16 = r15.getPackedValue()
            r18 = 0
            boolean r19 = androidx.compose.foundation.text.selection.SelectionManagerKt.m929containsInclusiveUv8p0NA(r14, r9)
            if (r19 != 0) goto L84
        ...
        L89:
            r15 = 0
        L8a:
            r0.m914setStartHandlePosition_kEHs6E(r15)
            androidx.compose.ui.geometry.Offset r8 = androidx.compose.ui.geometry.Offset.m2697boximpl(r12)
            long r15 = r8.getPackedValue()
            r11 = 0
            boolean r17 = androidx.compose.foundation.text.selection.SelectionManagerKt.m929containsInclusiveUv8p0NA(r14, r12)
            if (r17 != 0) goto Laa
        ...
        Lb3:
            r3 = 0
        Lb4:
            r0.m913setEndHandlePosition_kEHs6E(r3)
            return
        Lb8:
            r18 = r1
            goto Lc3
        ...
        Lc3:
            r1 = 0
            r0.m914setStartHandlePosition_kEHs6E(r1)
            r0.m913setEndHandlePosition_kEHs6E(r1)
            return
        */
        ...
        if (startSelectable != null && (startLayoutCoordinates = startSelectable.getLayoutCoordinates()) != null) {
            if (endSelectable != null && (endLayoutCoordinates = endSelectable.getLayoutCoordinates()) != null) {
                ...
                if (localLayoutCoordinates != null && localLayoutCoordinates.isAttached()) {
                    long startOffset = localLayoutCoordinates.mo4192localPositionOfR5De75A(startLayoutCoordinates, startSelectable.mo877getHandlePositiondBAh8RU(selection, true));
                    long endOffset = localLayoutCoordinates.mo4192localPositionOfR5De75A(endLayoutCoordinates, endSelectable.mo877getHandlePositiondBAh8RU(selection, false));
                    long startOffset2 = localLayoutCoordinates.mo4193localToRootMKHz9U(startOffset);
                    long endOffset2 = localLayoutCoordinates.mo4193localToRootMKHz9U(endOffset);
                    ...
                    long startTop = localLayoutCoordinates.mo4192localPositionOfR5De75A(startLayoutCoordinates, OffsetKt.Offset(0.0f, startSelectable.getBoundingBox(selection.getStart().getOffset()).getTop()));
                    long endTop = localLayoutCoordinates.mo4192localPositionOfR5De75A(endLayoutCoordinates, OffsetKt.Offset(0.0f, endSelectable.getBoundingBox(selection.getEnd().getOffset()).getTop()));
                    float top = Math.min(Offset.m2709getYimpl(localLayoutCoordinates.mo4193localToRootMKHz9U(startTop)), Offset.m2709getYimpl(localLayoutCoordinates.mo4193localToRootMKHz9U(endTop)));
                    float bottom = Math.max(Offset.m2709getYimpl(startOffset2), Offset.m2709getYimpl(endOffset2)) + ((float) (SelectionHandlesKt.getHandleHeight() * 4.0d));
    ...
    public final TextDragObserver handleDragObserver(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.SelectionManager$handleDragObserver$1
            ...
            public void mo803onDownk4lQ0M(long point) {
                ...
                long beginCoordinates = SelectionHandlesKt.m896getAdjustedCoordinatesk4lQ0M(selectable.mo877getHandlePositiondBAh8RU(selection, isStartHandle));
                SelectionManager.this.m910setCurrentDragPosition_kEHs6E(Offset.m2697boximpl(SelectionManager.this.requireContainerCoordinates$foundation_release().mo4192localPositionOfR5De75A(beginLayoutCoordinates, beginCoordinates)));
            ...
            public void mo805onStartk4lQ0M(long startPoint) {
                ...
                if (isStartHandle) {
                    ...
                    mo877getHandlePositiondBAh8RU = startSelectable.mo877getHandlePositiondBAh8RU(selection, true);
                } else {
                    Intrinsics.checkNotNull(endSelectable);
                    mo877getHandlePositiondBAh8RU = endSelectable.mo877getHandlePositiondBAh8RU(selection, false);
                }
                long beginCoordinates = SelectionHandlesKt.m896getAdjustedCoordinatesk4lQ0M(mo877getHandlePositiondBAh8RU);
                SelectionManager.this.m911setDragBeginPositionk4lQ0M(SelectionManager.this.requireContainerCoordinates$foundation_release().mo4192localPositionOfR5De75A(beginLayoutCoordinates, beginCoordinates));
                SelectionManager.this.m912setDragTotalDistancek4lQ0M(Offset.INSTANCE.m2724getZeroF1C5BW0());
            }
            ...
            public void mo804onDragk4lQ0M(long delta) {
                ...
                selectionManager.m912setDragTotalDistancek4lQ0M(Offset.m2713plusMKHz9U(selectionManager.m919getDragTotalDistanceF1C5BW0$foundation_release(), delta));
                long endPosition = Offset.m2713plusMKHz9U(SelectionManager.this.m918getDragBeginPositionF1C5BW0$foundation_release(), SelectionManager.this.m919getDragTotalDistanceF1C5BW0$foundation_release());
                boolean consumed = SelectionManager.this.m923updateSelectionRHHTvR4$foundation_release(Offset.m2697boximpl(endPosition), Offset.m2697boximpl(SelectionManager.this.m918getDragBeginPositionF1C5BW0$foundation_release()), isStartHandle, SelectionAdjustment.INSTANCE.getCharacterWithWordAccelerate());
                if (consumed) {
                    SelectionManager.this.m911setDragBeginPositionk4lQ0M(endPosition);
                    SelectionManager.this.m912setDragTotalDistancek4lQ0M(Offset.INSTANCE.m2724getZeroF1C5BW0());
                }
            }
    ...
    public final Offset m909convertToContainerCoordinatesQ7Q5hAU(LayoutCoordinates layoutCoordinates, long offset) {
        ...
        return Offset.m2697boximpl(requireContainerCoordinates$foundation_release().mo4192localPositionOfR5De75A(layoutCoordinates, offset));
    }
    ...
    public final boolean m923updateSelectionRHHTvR4$foundation_release(Offset newPosition, Offset previousPosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        ...
        if (newPosition != null && (selection = getSelection()) != null) {
            ...
            if (otherSelectable == null) {
                ...
                Intrinsics.checkNotNull(layoutCoordinates);
                m909convertToContainerCoordinatesQ7Q5hAU = m909convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, SelectionHandlesKt.m896getAdjustedCoordinatesk4lQ0M(otherSelectable.mo877getHandlePositiondBAh8RU(selection, !isStartHandle)));
            }
            if (m909convertToContainerCoordinatesQ7Q5hAU != null) {
                long otherHandlePosition = m909convertToContainerCoordinatesQ7Q5hAU.getPackedValue();
                ...
                return m922updateSelection3R_tFg$foundation_release(startHandlePosition, endHandlePosition, previousPosition, isStartHandle, adjustment);
            }
        }
        return false;
    }
    ...
    public final boolean m922updateSelection3R_tFg$foundation_release(long startHandlePosition, long endHandlePosition, Offset previousHandlePosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        ...
        m910setCurrentDragPosition_kEHs6E(isStartHandle ? Offset.m2697boximpl(startHandlePosition) : Offset.m2697boximpl(endHandlePosition));
        ...
        while (index$iv$iv < size) {
            ...
            Pair<Selection, Boolean> mo879updateSelectionqCDeeow = selectable.mo879updateSelectionqCDeeow(startHandlePosition, endHandlePosition, previousHandlePosition, isStartHandle, requireContainerCoordinates$foundation_release(), adjustment, previousSubselection);
            Selection selection2 = mo879updateSelectionqCDeeow.component1();
            boolean consumed = mo879updateSelectionqCDeeow.component2().booleanValue();
    ...
    public final void m916contextMenuOpenAdjustmentk4lQ0M(long position) {
        Selection selection = getSelection();
        boolean isEmptySelection = selection != null ? TextRange.m4718getCollapsedimpl(selection.m886toTextRanged9O1mEE()) : true;
        if (isEmptySelection) {
