...
public final class TextFieldCursorKt {
    ...
    private static final float DefaultCursorThickness = Dp.m5216constructorimpl(2);
        ...
        return enabled ? ComposedModifierKt.composed$default($this$cursor, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.TextFieldCursorKt$cursor$1
            ...
            public final Modifier invoke(Modifier composed, Composer $composer, int $changed) {
                ...
                if (Brush.this instanceof SolidColor) {
                    ...
                    if (($this$isUnspecified$iv == Color.INSTANCE.m2983getUnspecified0d7_KjU() ? 1 : 0) != 0) {
                        z = false;
                    }
                }
                boolean isBrushSpecified = z;
                if (state.getHasFocus() && TextRange.m4718getCollapsedimpl(value.getSelection()) && isBrushSpecified) {
                    EffectsKt.LaunchedEffect(value.getText(), TextRange.m4712boximpl(value.getSelection()), new AnonymousClass1(cursorAlpha, null), $composer, 512);
                    ...
                    companion = DrawModifierKt.drawWithContent(composed, new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.TextFieldCursorKt$cursor$1.2
                        ...
                        public final void invoke2(ContentDrawScope drawWithContent) {
                            ...
                            if (!(cursorAlphaValue == 0.0f)) {
                                int transformedOffset = offsetMapping2.originalToTransformed(TextRange.m4724getStartimpl(textFieldValue.getSelection()));
                                ...
                                float f = 2;
                                float cursorX = RangesKt.coerceAtMost(cursorRect.getLeft() + (cursorWidth / f), Size.m2777getWidthimpl(drawWithContent.mo3490getSizeNHjbRc()) - (cursorWidth / f));
                                DrawScope.m3476drawLine1RTmtNc$default(drawWithContent, brush, OffsetKt.Offset(cursorX, cursorRect.getTop()), OffsetKt.Offset(cursorX, cursorRect.getBottom()), cursorWidth, 0, null, cursorAlphaValue, null, 0, 432, null);
                            }
                        }
                    });
                } else {
