...
final class AnimatedContentMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo13measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long constraints) {
        ...
        while (true) {
            ...
            if (z) {
                placeables[index] = measurable.mo4184measureBRTryo0(constraints);
            }
            index$iv++;
        }
        ...
        for (int index$iv2 = 0; index$iv2 < size2; index$iv2++) {
            ...
            if (placeables[index2] == null) {
                placeables[index2] = measurable2.mo4184measureBRTryo0(constraints);
            }
        }
        ...
        this.rootScope.m38setMeasuredSizeozmzZPI$animation_release(IntSizeKt.IntSize(maxWidth, maxHeight));
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                for (Placeable placeable5 : placeableArr) {
                    if (placeable5 != null) {
                        ...
                        Placeable.PlacementScope.place$default(layout, placeable5, IntOffset.m5334getXimpl(offset), IntOffset.m5335getYimpl(offset), 0.0f, 4, null);
                    }
                }
            }
        }, 4, null);
