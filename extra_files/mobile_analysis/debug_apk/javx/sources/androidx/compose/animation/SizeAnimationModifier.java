...
final class SizeAnimationModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public MeasureResult mo39measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        long m71animateTomzRDjE0 = m71animateTomzRDjE0(measuredSize);
        int width = IntSize.m5376getWidthimpl(m71animateTomzRDjE0);
        int height = IntSize.m5375getHeightimpl(m71animateTomzRDjE0);
    ...
    public final long m71animateTomzRDjE0(long targetSize) {
        ...
        if ($this$animateTo_mzRDjE0_u24lambda_u240 != null) {
            if (!IntSize.m5374equalsimpl0(targetSize, $this$animateTo_mzRDjE0_u24lambda_u240.getAnim().getTargetValue().getPackedValue())) {
                $this$animateTo_mzRDjE0_u24lambda_u240.m76setStartSizeozmzZPI($this$animateTo_mzRDjE0_u24lambda_u240.getAnim().getValue().getPackedValue());
            ...
            $this$animateTo_mzRDjE0_u24lambda_u240 = new AnimData(new Animatable(IntSize.m5368boximpl(targetSize), VectorConvertersKt.getVectorConverter(IntSize.INSTANCE), IntSize.m5368boximpl(IntSizeKt.IntSize(1, 1)), null, 8, null), targetSize, null);
        }
