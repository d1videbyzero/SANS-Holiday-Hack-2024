...
final class ExpandShrinkModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public final long m60sizeByStateUzc_VyU(EnterExitState targetState, long fullSize) {
        ...
        long preEnterSize = it != null ? it.getSize().invoke(IntSize.m5368boximpl(fullSize)).getPackedValue() : fullSize;
        ChangeSize it2 = this.shrink.getValue();
        long postExitSize = it2 != null ? it2.getSize().invoke(IntSize.m5368boximpl(fullSize)).getPackedValue() : fullSize;
    ...
    public final long m61targetOffsetByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        ...
        if (this.currentAlignment != null && this.alignment.getValue() != null && !Intrinsics.areEqual(this.currentAlignment, this.alignment.getValue())) {
            switch (WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()]) {
                case 1:
                    return IntOffset.INSTANCE.m5344getZeronOccac();
                case 2:
                    return IntOffset.INSTANCE.m5344getZeronOccac();
                case 3:
                    ChangeSize it = this.shrink.getValue();
                    if (it != null) {
                        long endSize = it.getSize().invoke(IntSize.m5368boximpl(fullSize)).getPackedValue();
                        ...
                        return IntOffsetKt.IntOffset(IntOffset.m5334getXimpl(targetOffset) - IntOffset.m5334getXimpl(currentOffset), IntOffset.m5335getYimpl(targetOffset) - IntOffset.m5335getYimpl(currentOffset));
                    }
                    return IntOffset.INSTANCE.m5344getZeronOccac();
                default:
                    throw new NoWhenBranchMatchedException();
    ...
    public MeasureResult mo39measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        Intrinsics.checkNotNullParameter(measure, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        final Placeable placeable = measurable.mo4184measureBRTryo0(constraints);
        ...
        long currentSize = this.sizeAnimation.animate(this.sizeTransitionSpec, new Function1<EnterExitState, IntSize>() { // from class: androidx.compose.animation.ExpandShrinkModifier$measure$currentSize$1
            ...
            public /* bridge */ /* synthetic */ IntSize invoke(EnterExitState enterExitState) {
                return IntSize.m5368boximpl(m62invokeYEO4UFw(enterExitState));
            }

            /* renamed from: invoke-YEO4UFw, reason: not valid java name */
            public final long m62invokeYEO4UFw(EnterExitState it) {
                Intrinsics.checkNotNullParameter(it, "it");
                return ExpandShrinkModifier.this.m60sizeByStateUzc_VyU(it, measuredSize);
            }
        ...
        final long offsetDelta = this.offsetAnimation.animate(new Function1<Transition.Segment<EnterExitState>, FiniteAnimationSpec<IntOffset>>() { // from class: androidx.compose.animation.ExpandShrinkModifier$measure$offsetDelta$1
            ...
            public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                return IntOffset.m5325boximpl(m63invokeBjo55l4(enterExitState));
            }

            /* renamed from: invoke-Bjo55l4, reason: not valid java name */
            public final long m63invokeBjo55l4(EnterExitState it) {
                Intrinsics.checkNotNullParameter(it, "it");
                return ExpandShrinkModifier.this.m61targetOffsetByStateoFUgxo0(it, measuredSize);
            }
        }).getValue().getPackedValue();
        Alignment alignment = this.currentAlignment;
        final long offset = alignment != null ? alignment.mo2598alignKFBX0sM(measuredSize, currentSize, LayoutDirection.Ltr) : IntOffset.INSTANCE.m5344getZeronOccac();
        return MeasureScope.layout$default(measure, IntSize.m5376getWidthimpl(currentSize), IntSize.m5375getHeightimpl(currentSize), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.ExpandShrinkModifier$measure$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.place$default(layout, Placeable.this, IntOffset.m5334getXimpl(offset) + IntOffset.m5334getXimpl(offsetDelta), IntOffset.m5335getYimpl(offset) + IntOffset.m5335getYimpl(offsetDelta), 0.0f, 4, null);
            }
        }, 4, null);
    }
}
