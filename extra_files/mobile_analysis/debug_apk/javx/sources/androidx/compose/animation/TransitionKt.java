...
public final class TransitionKt {
    ...
    public static final State<Color> m80animateColorDTcfvLk(InfiniteTransition animateColor, long initialValue, long targetValue, InfiniteRepeatableSpec<Color> animationSpec, String label, Composer $composer, int $changed, int i) {
        Object value$iv$iv;
        ...
        State<Color> animateValue = InfiniteTransitionKt.animateValue(animateColor, Color.m2937boximpl(initialValue), Color.m2937boximpl(targetValue), converter, animationSpec, label2, $composer, InfiniteTransition.$stable | 4096 | ($changed & 14) | ($changed & 112) | ($changed & 896) | (InfiniteRepeatableSpec.$stable << 12) | (($changed << 3) & 57344) | (458752 & ($changed << 3)), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public static final /* synthetic */ State m81animateColorRIQooxk(InfiniteTransition animateColor, long initialValue, long targetValue, InfiniteRepeatableSpec animationSpec, Composer $composer, int $changed) {
        Intrinsics.checkNotNullParameter(animateColor, "$this$animateColor");
        Intrinsics.checkNotNullParameter(animationSpec, "animationSpec");
        ...
        State<Color> m80animateColorDTcfvLk = m80animateColorDTcfvLk(animateColor, initialValue, targetValue, animationSpec, "ColorAnimation", $composer, InfiniteTransition.$stable | 24576 | ($changed & 14) | ($changed & 112) | ($changed & 896) | (InfiniteRepeatableSpec.$stable << 9) | ($changed & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
