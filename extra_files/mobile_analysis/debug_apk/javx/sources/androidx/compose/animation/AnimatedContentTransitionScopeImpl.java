...
public final class AnimatedContentTransitionScopeImpl<S> implements AnimatedContentTransitionScope<S> {
    ...
    public AnimatedContentTransitionScopeImpl(Transition<S> transition, Alignment contentAlignment, LayoutDirection layoutDirection) {
        ...
        this.measuredSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m5368boximpl(IntSize.INSTANCE.m5381getZeroYbymL2g()), null, 2, null);
    ...
    public EnterTransition mo16slideIntoContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> initialOffset) {
        Intrinsics.checkNotNullParameter(animationSpec, "animationSpec");
        Intrinsics.checkNotNullParameter(initialOffset, "initialOffset");
        return m35isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$1
            ...
            public final Integer invoke(int it) {
                long m34getCurrentSizeYbymL2g;
                long m34getCurrentSizeYbymL2g2;
                long m33calculateOffsetemnUabE;
                Function1<Integer, Integer> function1 = initialOffset;
                m34getCurrentSizeYbymL2g = this.m34getCurrentSizeYbymL2g();
                int m5376getWidthimpl = IntSize.m5376getWidthimpl(m34getCurrentSizeYbymL2g);
                AnimatedContentTransitionScopeImpl<S> animatedContentTransitionScopeImpl = this;
                long IntSize = IntSizeKt.IntSize(it, it);
                m34getCurrentSizeYbymL2g2 = this.m34getCurrentSizeYbymL2g();
                m33calculateOffsetemnUabE = animatedContentTransitionScopeImpl.m33calculateOffsetemnUabE(IntSize, m34getCurrentSizeYbymL2g2);
                return function1.invoke(Integer.valueOf(m5376getWidthimpl - IntOffset.m5334getXimpl(m33calculateOffsetemnUabE)));
            }
        }) : m36isRightgWo6LJ4(towards) ? EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int it) {
                ...
                long IntSize = IntSizeKt.IntSize(it, it);
                m34getCurrentSizeYbymL2g = this.m34getCurrentSizeYbymL2g();
                m33calculateOffsetemnUabE = animatedContentTransitionScopeImpl.m33calculateOffsetemnUabE(IntSize, m34getCurrentSizeYbymL2g);
                return function1.invoke(Integer.valueOf((-IntOffset.m5334getXimpl(m33calculateOffsetemnUabE)) - it));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m21equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m30getUpDKzdypw()) ? EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$3
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int it) {
                ...
                Function1<Integer, Integer> function1 = initialOffset;
                m34getCurrentSizeYbymL2g = this.m34getCurrentSizeYbymL2g();
                int m5375getHeightimpl = IntSize.m5375getHeightimpl(m34getCurrentSizeYbymL2g);
                AnimatedContentTransitionScopeImpl<S> animatedContentTransitionScopeImpl = this;
                long IntSize = IntSizeKt.IntSize(it, it);
                m34getCurrentSizeYbymL2g2 = this.m34getCurrentSizeYbymL2g();
                m33calculateOffsetemnUabE = animatedContentTransitionScopeImpl.m33calculateOffsetemnUabE(IntSize, m34getCurrentSizeYbymL2g2);
                return function1.invoke(Integer.valueOf(m5375getHeightimpl - IntOffset.m5335getYimpl(m33calculateOffsetemnUabE)));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m21equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m25getDownDKzdypw()) ? EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$4
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int it) {
                ...
                m34getCurrentSizeYbymL2g = this.m34getCurrentSizeYbymL2g();
                m33calculateOffsetemnUabE = animatedContentTransitionScopeImpl.m33calculateOffsetemnUabE(IntSize, m34getCurrentSizeYbymL2g);
                return function1.invoke(Integer.valueOf((-IntOffset.m5335getYimpl(m33calculateOffsetemnUabE)) - it));
            }
        }) : EnterTransition.INSTANCE.getNone();
    }

    /* renamed from: isLeft-gWo6LJ4, reason: not valid java name */
    private final boolean m35isLeftgWo6LJ4(int $this$isLeft) {
        return AnimatedContentTransitionScope.SlideDirection.m21equalsimpl0($this$isLeft, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m27getLeftDKzdypw()) || (AnimatedContentTransitionScope.SlideDirection.m21equalsimpl0($this$isLeft, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m29getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr) || (AnimatedContentTransitionScope.SlideDirection.m21equalsimpl0($this$isLeft, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m26getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl);
    }

    /* renamed from: isRight-gWo6LJ4, reason: not valid java name */
    private final boolean m36isRightgWo6LJ4(int $this$isRight) {
        return AnimatedContentTransitionScope.SlideDirection.m21equalsimpl0($this$isRight, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m28getRightDKzdypw()) || (AnimatedContentTransitionScope.SlideDirection.m21equalsimpl0($this$isRight, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m29getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl) || (AnimatedContentTransitionScope.SlideDirection.m21equalsimpl0($this$isRight, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m26getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr);
    }
    ...
    public ExitTransition mo17slideOutOfContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> targetOffset) {
        Intrinsics.checkNotNullParameter(animationSpec, "animationSpec");
        Intrinsics.checkNotNullParameter(targetOffset, "targetOffset");
        return m35isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$1
            ...
            public final Integer invoke(int it) {
                ...
                long targetSize = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m5381getZeroYbymL2g();
                Function1<Integer, Integer> function1 = targetOffset;
                m33calculateOffsetemnUabE = this.this$0.m33calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), targetSize);
                return function1.invoke(Integer.valueOf((-IntOffset.m5334getXimpl(m33calculateOffsetemnUabE)) - it));
            }
        }) : m36isRightgWo6LJ4(towards) ? EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$2
            final /* synthetic */ AnimatedContentTransitionScopeImpl<S> this$0;
            ...
            public final Integer invoke(int it) {
                ...
                Function1<Integer, Integer> function1 = targetOffset;
                m33calculateOffsetemnUabE = this.this$0.m33calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), targetSize);
                return function1.invoke(Integer.valueOf((-IntOffset.m5334getXimpl(m33calculateOffsetemnUabE)) + IntSize.m5376getWidthimpl(targetSize)));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m21equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m30getUpDKzdypw()) ? EnterExitTransitionKt.slideOutVertically(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$3
            final /* synthetic */ AnimatedContentTransitionScopeImpl<S> this$0;
            ...
            public final Integer invoke(int it) {
                ...
                Function1<Integer, Integer> function1 = targetOffset;
                m33calculateOffsetemnUabE = this.this$0.m33calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), targetSize);
                return function1.invoke(Integer.valueOf((-IntOffset.m5335getYimpl(m33calculateOffsetemnUabE)) + IntSize.m5375getHeightimpl(targetSize)));
            }
        }) : ExitTransition.INSTANCE.getNone();
    }

    /* renamed from: getMeasuredSize-YbymL2g$animation_release, reason: not valid java name */
    public final long m37getMeasuredSizeYbymL2g$animation_release() {
        State $this$getValue$iv = this.measuredSize;
        return ((IntSize) $this$getValue$iv.getValue()).getPackedValue();
    }

    /* renamed from: setMeasuredSize-ozmzZPI$animation_release, reason: not valid java name */
    public final void m38setMeasuredSizeozmzZPI$animation_release(long j) {
        MutableState $this$setValue$iv = this.measuredSize;
        $this$setValue$iv.setValue(IntSize.m5368boximpl(j));
    }
    ...
    public final long m34getCurrentSizeYbymL2g() {
        ...
        return state != null ? state.getValue().getPackedValue() : m37getMeasuredSizeYbymL2g$animation_release();
    }
    ...
    final class SizeModifier extends LayoutModifierWithPassThroughIntrinsics {
        ...
        public MeasureResult mo39measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
            Intrinsics.checkNotNullParameter(measure, "$this$measure");
            Intrinsics.checkNotNullParameter(measurable, "measurable");
            final Placeable mo4184measureBRTryo0 = measurable.mo4184measureBRTryo0(j);
            ...
            Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>> function1 = new Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$1
                ...
                public final FiniteAnimationSpec<IntSize> invoke(Transition.Segment<S> animate) {
                    FiniteAnimationSpec<IntSize> mo77createAnimationSpecTemP2vQ;
                    ...
                    long initial = state != null ? state.getValue().getPackedValue() : IntSize.INSTANCE.m5381getZeroYbymL2g();
                    State<IntSize> state2 = animatedContentTransitionScopeImpl.getTargetSizeMap$animation_release().get(animate.getTargetState());
                    long target = state2 != null ? state2.getValue().getPackedValue() : IntSize.INSTANCE.m5381getZeroYbymL2g();
                    SizeTransform value = this.getSizeTransform().getValue();
                    return (value == null || (mo77createAnimationSpecTemP2vQ = value.mo77createAnimationSpecTemP2vQ(initial, target)) == null) ? AnimationSpecKt.spring$default(0.0f, 0.0f, null, 7, null) : mo77createAnimationSpecTemP2vQ;
                }
            };
            ...
            State<IntSize> animate = deferredAnimation.animate(function1, new Function1<S, IntSize>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$2
                ...
                public /* bridge */ /* synthetic */ IntSize invoke(Object obj) {
                    return IntSize.m5368boximpl(m40invokeYEO4UFw(obj));
                }

                /* renamed from: invoke-YEO4UFw, reason: not valid java name */
                public final long m40invokeYEO4UFw(S s) {
                    State<IntSize> state = animatedContentTransitionScopeImpl2.getTargetSizeMap$animation_release().get(s);
                    return state != null ? state.getValue().getPackedValue() : IntSize.INSTANCE.m5381getZeroYbymL2g();
                }
            });
            this.this$0.setAnimatedSize$animation_release(animate);
            final long mo2598alignKFBX0sM = this.this$0.getContentAlignment().mo2598alignKFBX0sM(IntSizeKt.IntSize(mo4184measureBRTryo0.getWidth(), mo4184measureBRTryo0.getHeight()), animate.getValue().getPackedValue(), LayoutDirection.Ltr);
            return MeasureScope.layout$default(measure, IntSize.m5376getWidthimpl(animate.getValue().getPackedValue()), IntSize.m5375getHeightimpl(animate.getValue().getPackedValue()), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(Placeable.PlacementScope layout) {
                    ...
                    Placeable.PlacementScope.m4241place70tqf50$default(layout, Placeable.this, mo2598alignKFBX0sM, 0.0f, 2, null);
                }
            }, 4, null);
        }
    }
