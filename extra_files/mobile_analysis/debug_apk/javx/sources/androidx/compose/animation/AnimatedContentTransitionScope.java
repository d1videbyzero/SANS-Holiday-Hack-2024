...
public interface AnimatedContentTransitionScope<S> extends Transition.Segment<S> {
    ...
    public static final class SlideDirection {
        ...
        public static String m23toStringimpl(int arg0) {
            return m21equalsimpl0(arg0, Left) ? "Left" : m21equalsimpl0(arg0, Right) ? "Right" : m21equalsimpl0(arg0, Up) ? "Up" : m21equalsimpl0(arg0, Down) ? "Down" : m21equalsimpl0(arg0, Start) ? "Start" : m21equalsimpl0(arg0, End) ? "End" : "Invalid";
        }
    }
    ...
    static /* synthetic */ EnterTransition m14slideIntoContainermOhB8PU$default(AnimatedContentTransitionScope animatedContentTransitionScope, int i, FiniteAnimationSpec finiteAnimationSpec, Function1 function1, int i2, Object obj) {
        ...
        if ((i2 & 2) != 0) {
            finiteAnimationSpec = AnimationSpecKt.spring$default(0.0f, 0.0f, IntOffset.m5325boximpl(VisibilityThresholdsKt.getVisibilityThreshold(IntOffset.INSTANCE)), 3, null);
        }
        if ((i2 & 4) != 0) {
