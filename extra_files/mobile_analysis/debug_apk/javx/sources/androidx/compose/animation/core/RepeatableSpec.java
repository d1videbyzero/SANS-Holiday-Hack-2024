...
public final class RepeatableSpec<T> implements FiniteAnimationSpec<T> {
    ...
    */
    ...
    public boolean equals(Object other) {
        return (other instanceof RepeatableSpec) && ((RepeatableSpec) other).iterations == this.iterations && Intrinsics.areEqual(((RepeatableSpec) other).animation, this.animation) && ((RepeatableSpec) other).repeatMode == this.repeatMode && StartOffset.m115equalsimpl0(((RepeatableSpec) other).initialStartOffset, this.initialStartOffset);
    }
