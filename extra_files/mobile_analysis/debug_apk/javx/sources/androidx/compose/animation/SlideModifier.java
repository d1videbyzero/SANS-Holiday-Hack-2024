...
final class SlideModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public final long m78targetValueByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        ...
        long preEnter = (value == null || (slideOffset2 = value.getSlideOffset()) == null) ? IntOffset.INSTANCE.m5344getZeronOccac() : slideOffset2.invoke(IntSize.m5368boximpl(fullSize)).getPackedValue();
        Slide value2 = this.slideOut.getValue();
        long postExit = (value2 == null || (slideOffset = value2.getSlideOffset()) == null) ? IntOffset.INSTANCE.m5344getZeronOccac() : slideOffset.invoke(IntSize.m5368boximpl(fullSize)).getPackedValue();
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                State slideOffset = lazyAnimation.animate(transitionSpec, new Function1<EnterExitState, IntOffset>() { // from class: androidx.compose.animation.SlideModifier$measure$1$slideOffset$1
                    ...
                    public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                        return IntOffset.m5325boximpl(m79invokeBjo55l4(enterExitState));
                    }

                    /* renamed from: invoke-Bjo55l4, reason: not valid java name */
                    public final long m79invokeBjo55l4(EnterExitState it) {
                        Intrinsics.checkNotNullParameter(it, "it");
                        return SlideModifier.this.m78targetValueByStateoFUgxo0(it, j);
                    }
                });
                Placeable.PlacementScope.m4244placeWithLayeraW9wM$default(layout, placeable, slideOffset.getValue().getPackedValue(), 0.0f, null, 6, null);
            }
        }, 4, null);
    }
}
