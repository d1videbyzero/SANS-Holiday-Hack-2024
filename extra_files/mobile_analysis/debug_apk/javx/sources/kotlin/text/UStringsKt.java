...
public final class UStringsKt {
    ...
    public static final String m6819toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m6821toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m6820toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m6818toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        if (Integer.compareUnsigned(data, UInt.m5602constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m5519boximpl(UByte.m5525constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m5602constructorimpl(SupportMenu.USER_MASK)) > 0) {
            return null;
        }
        return UShort.m5782boximpl(UShort.m5788constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m5602constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m5602constructorimpl(result * uradix);
            result = UInt.m5602constructorimpl(UInt.m5602constructorimpl(digit) + result2);
            if (Integer.compareUnsigned(result, result2) < 0) {
                return null;
            }
        }
        return UInt.m5596boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m5681constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            long result2 = ULong.m5681constructorimpl(result * uradix);
            result = ULong.m5681constructorimpl(ULong.m5681constructorimpl(UInt.m5602constructorimpl(digit) & 4294967295L) + result2);
        ...
        return ULong.m5675boximpl(result);
    }
}
