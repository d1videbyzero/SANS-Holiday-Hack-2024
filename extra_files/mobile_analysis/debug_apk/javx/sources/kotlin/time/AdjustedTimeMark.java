...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo6823minusLRDsOJo(long duration) {
        return TimeMark.DefaultImpls.m6969minusLRDsOJo(this, duration);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo6822elapsedNowUwyO8pc() {
        return Duration.m6867minusLRDsOJo(this.mark.mo6822elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo6825plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m6868plusLRDsOJo(this.adjustment, duration), null);
    }
}
