...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public long mo6822elapsedNowUwyO8pc() {
            return Duration.m6867minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.TimeMark
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public ComparableTimeMark mo6825plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m6868plusLRDsOJo(this.offset, duration), null);
        }
        ...
        public long mo6824minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (Duration.m6837equalsimpl0(this.offset, ((DoubleTimeMark) other).offset) && Duration.m6864isInfiniteimpl(this.offset)) {
                return Duration.INSTANCE.m6935getZEROUwyO8pc();
            }
            long offsetDiff = Duration.m6867minusLRDsOJo(this.offset, ((DoubleTimeMark) other).offset);
            long startedAtDiff = DurationKt.toDuration(this.startedAt - ((DoubleTimeMark) other).startedAt, this.timeSource.getUnit());
            return Duration.m6837equalsimpl0(startedAtDiff, Duration.m6885unaryMinusUwyO8pc(offsetDiff)) ? Duration.INSTANCE.m6935getZEROUwyO8pc() : Duration.m6868plusLRDsOJo(startedAtDiff, offsetDiff);
        }

        @Override // kotlin.time.ComparableTimeMark
        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) other).timeSource) && Duration.m6837equalsimpl0(mo6824minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m6935getZEROUwyO8pc());
        }

        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return Duration.m6860hashCodeimpl(Duration.m6868plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m6881toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }

    @Override // kotlin.time.TimeSource
    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.INSTANCE.m6935getZEROUwyO8pc(), null);
    }
}
